...
import{n as e,o as t,t as n}from"./cardCatalog-AnvdLb5p.js";import{i as r,r as i,u as a}from"./deckRules-B0ev_ycV.js";import{A as o,At as s,Ct as c,D as l,Dt as u,Et as d,G as f,H as p,Ot as m,P as h,St as g,Tt as _,_t as v,a as y,bt as ee,c as b,ct as x,d as S,dt as C,f as w,ft as te,g as ne,gt as re,ht as ie,i as ae,j as oe,kt as se,l as ce,lt as le,m as T,mt as ue,o as de,ot as fe,p as pe,pt as me,r as he,s as ge,st as _e,t as ve,u as E,ut as ye,vt as be,wt as xe,xt as Se,yt as Ce,z as we}from"./storage-D9Rz-LDI.js";import{l as Te,p as Ee,r as De}from"./mageTitles-BPvsmJqw.js";import{t as D}from"./preload-helper-CV77j2BA.js";import{a as Oe,c as ke,d as Ae,g as je,h as Me,l as Ne,o as O,p as Pe,s as Fe,t as Ie,v as Le}from"./auth-DHasSuFN.js";var Re=Object.defineProperty,ze=(e,t)=>{let n={};for(var r in e)Re(n,r,{get:e[r],enumerable:!0});return t||Re(n,Symbol.toStringTag,{value:`Module`}),n};function Be(){let e=window.visualViewport;return e?Math.max(0,Math.round(e.offsetTop)):0}function Ve(){let e=window.visualViewport;return e?Math.max(0,Math.round(window.innerHeight-e.offsetTop-e.height)):0}function He(){let e=document.documentElement,t=()=>{e.style.setProperty(`--viewport-inset-top`,`${Be()}px`),e.style.setProperty(`--viewport-inset-bottom`,`${Ve()}px`)};t(),window.visualViewport?.addEventListener(`resize`,t),window.visualViewport?.addEventListener(`scroll`,t),window.addEventListener(`resize`,t),window.addEventListener(`orientationchange`,t)}He();var Ue=1100,We=120;function Ge(){let e=document.getElementById(`app-splash`);if(!e||e.classList.contains(`app-splash--hide`))return;e.classList.add(`app-splash--hide`),document.body.classList.remove(`splash-active`);let t=()=>{e.remove()};e.addEventListener(`transitionend`,t,{once:!0}),window.setTimeout(t,600)}function Ke(){Ge()}function qe(){let e=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches?We:Ue,t=performance.now(),n=()=>{let n=performance.now()-t,r=Math.max(0,e-n);window.setTimeout(Ge,r)};document.readyState===`interactive`||document.readyState===`complete`?n():document.addEventListener(`DOMContentLoaded`,n,{once:!0})}document.body.classList.add(`splash-active`),qe();var Je=`(max-width: 768px)`,Ye=null;function Xe(){return document.getElementById(`mobile-confirm`)}function Ze(e){let t=Xe();if(!t)return;t.classList.add(`hidden`),document.body.classList.remove(`mobile-confirm-open`);let n=Ye;Ye=null,n?.(e)}function Qe(e,t={}){if(!window.matchMedia(Je).matches)return Promise.resolve(window.confirm(e));let n=Xe();if(!n)return Promise.resolve(window.confirm(e));let{title:r=`Confirm`,confirmLabel:i=`OK`,cancelLabel:a=`Cancel`,destructive:o=!1}=t;return new Promise(t=>{Ye&&Ze(!1),Ye=t,n.querySelector(`#mobile-confirm-title`).textContent=r,n.querySelector(`#mobile-confirm-body`).textContent=e;let s=n.querySelector(`#mobile-confirm-ok`),c=n.querySelector(`#mobile-confirm-cancel`);s.textContent=i,c.textContent=a,s.classList.toggle(`btn-danger`,o),s.classList.toggle(`btn-primary`,!o),n.classList.remove(`hidden`),document.body.classList.add(`mobile-confirm-open`),c.focus()})}function $e(){let e=Xe();!e||e.dataset.bound||(e.dataset.bound=`1`,e.querySelector(`#mobile-confirm-ok`)?.addEventListener(`click`,()=>Ze(!0)),e.querySelector(`#mobile-confirm-cancel`)?.addEventListener(`click`,()=>Ze(!1)),e.querySelector(`[data-mobile-confirm-backdrop]`)?.addEventListener(`click`,()=>Ze(!1)))}var et=`cc_install_banner_dismissed`;function tt(){return window.matchMedia(`(display-mode: standalone)`).matches||window.navigator.standalone===!0}function nt(){let e=window.navigator.userAgent;return/iphone|ipad|ipod/i.test(e)&&!/crios|fxios/i.test(e)}function rt(){if(tt()||localStorage.getItem(et)===`1`)return;let e=document.getElementById(`install-banner`);if(!e)return;let t=null,n=()=>{e.classList.remove(`hidden`),document.body.classList.add(`install-banner-visible`)},r=()=>{e.classList.add(`hidden`),document.body.classList.remove(`install-banner-visible`)};window.addEventListener(`beforeinstallprompt`,r=>{r.preventDefault(),t=r,e.querySelector(`#install-banner-ios-hint`)?.classList.add(`hidden`),e.querySelector(`.install-banner__hint--default`)?.classList.remove(`hidden`),e.querySelector(`#install-banner-btn`)?.classList.remove(`hidden`),n()}),nt()&&(e.querySelector(`#install-banner-ios-hint`)?.classList.remove(`hidden`),e.querySelector(`.install-banner__hint--default`)?.classList.add(`hidden`),e.querySelector(`#install-banner-btn`)?.classList.add(`hidden`),window.setTimeout(n,2500)),e.querySelector(`#install-banner-btn`)?.addEventListener(`click`,async()=>{t&&(t.prompt(),await t.userChoice,t=null,r())}),e.querySelector(`#install-banner-dismiss`)?.addEventListener(`click`,()=>{localStorage.setItem(et,`1`),r()})}var it=[`attack`,`control`,`defense`,`movement`,`trap`,`special`],at={attack:`Attack`,control:`Control`,defense:`Defense`,movement:`Movement`,trap:`Trap`,special:`Special`},ot={aegis:`defense`,anchor:`defense`,backpedal:`control`,backstab:`attack`,backstep:`movement`,barrier:`defense`,bishops_mark:`movement`,blind:`control`,blizzard:`control`,snowball:`control`,berserk:`movement`,bomb:`attack`,shockwave:`control`,plague:`control`,bulwark:`defense`,create_foe:`special`,call_forward:`movement`,chain_lightning:`attack`,clone:`special`,coin_flip:`attack`,collapse:`special`,confusion:`control`,constitution:`defense`,counterspell:`trap`,crown:`special`,cryo_bolt:`attack`,cull:`attack`,darkness:`defense`,dash:`movement`,deep_freeze:`control`,deflect:`trap`,demote:`control`,deport:`movement`,displacement:`movement`,dominion:`special`,duel:`attack`,earthquake:`special`,execution:`attack`,extract:`control`,pyromancy:`attack`,fusion:`special`,hibernation:`special`,hostile_swap:`movement`,ignore:`special`,iron_will:`defense`,landmine:`trap`,last_king:`special`,bounty:`special`,link_fate:`special`,last_stand:`trap`,martyr:`trap`,leapfrog:`movement`,long_step:`movement`,magnet:`movement`,nudge:`movement`,offering:`special`,panic:`control`,poison:`attack`,mind_control:`special`,mulligan:`special`,zombify:`special`,press:`control`,purify:`special`,quick_march:`movement`,quicksand:`trap`,rally:`defense`,recall:`movement`,repel:`movement`,random_teleport:`movement`,retreat:`movement`,revive:`defense`,rooks_mark:`movement`,root:`control`,sacrifice:`attack`,sanctuary:`defense`,scatter:`movement`,shadow_swap:`movement`,sidestep:`movement`,shatter:`attack`,snipe:`attack`,snowball:`control`,stab:`attack`,stall:`defense`,tangle:`control`,teleport:`movement`,trickster:`special`,vengeance:`trap`,ward:`defense`};function st(e){let t=ot[e?.id];if(t)return t;let n=`${e?.id||``} ${e?.effect||``} ${e?.name||``} ${e?.desc||``}`.toLowerCase();return/trap|mine|quicksand|counterspell|vengeance|last.?stand|martyr/.test(n)?`trap`:/shield|ward|aegis|sanctuary|barrier|anchor|deflect|stall|iron_will|rally|darkness/.test(n)?`defense`:/move|nudge|teleport|recall|leap|step|displace|swap|scatter|retreat|bishop|rook|overrun|promote|pull|push|shift|earthquake|magnet|repel/.test(n)?`movement`:/freeze|blind|confusion|hex|root|panic|press|silence|paraly|control|cannot play|random|mark|poison|die in \d+ turn/.test(n)?`control`:/\bdestroy\b|\bkills?\b|fireball|bolt|stab|snipe|duel|sacrifice|execution|shatter|cull|lightning/.test(n)?`attack`:`special`}var ct=[{id:`bronze`,name:`Bronze Chest`,cost:25,cards:3,weights:{common:70,uncommon:25,rare:5,epic:0}},{id:`silver`,name:`Silver Chest`,cost:50,cards:5,weights:{common:50,uncommon:35,rare:12,epic:3}},{id:`gold`,name:`Gold Chest`,cost:100,cards:8,weights:{common:32,uncommon:38,rare:22,epic:6,legendary:2}}];function lt(e){let t=Math.random()*100,n=0;for(let r of[`common`,`uncommon`,`rare`,`epic`,`legendary`])if(n+=e[r]||0,t<=n)return r;return`common`}function ut(t){let n=e().filter(e=>e.rarity===t);return n.length?n[Math.floor(Math.random()*n.length)]:e()[0]}function dt(e,t){return ut(lt(t.weights))}function ft(e,n,r={}){let{starRefundChance:i=0}=r;if(ae(e,n.id)<t(n))return ve(e,n.id,1),{...n,duplicate:!1};let a=we[n.rarity]||10;if(i>0&&Math.random()<i){let e=Math.random()<.5?1:2;return{...n,duplicate:!0,starRefund:e}}return{...n,duplicate:!0,gemRefund:a}}function pt(e,t){let n=ct.find(e=>e.id===t);if(!n)return{success:!1,message:`Unknown chest.`};if(e.gems<n.cost)return{success:!1,message:`Not enough gems.`};e.gems-=n.cost;let r=[],i=0;for(let t=0;t<n.cards;t++){let t=ft(e,dt(e,n));r.push(t),t.gemRefund&&(i+=t.gemRefund)}return i&&(e.gems+=i),fe(e,`boxes_opened`,1),T(e),{success:!0,pulls:r,chest:n,bonusGems:i}}var mt=[`common`,`uncommon`,`rare`,`epic`,`legendary`];function ht(e,{minPct:t=1}={}){return mt.filter(n=>(e[n]??0)>=t).map(t=>`${e[t]}% ${t}`).join(` · `)}var gt={bronze:{label:`Bronze`,tagline:`Mostly common cards`,accent:`#cd7f32`,glow:`rgba(205, 127, 50, 0.45)`},silver:{label:`Silver`,tagline:`Balanced card mix`,accent:`#a8b8d8`,glow:`rgba(168, 184, 216, 0.5)`},gold:{label:`Gold`,tagline:`Higher rare & epic odds`,accent:`#e8c547`,glow:`rgba(232, 197, 71, 0.55)`}};function _t(e){let t=gt[e]||gt.bronze;return{t,lid:e===`gold`?`#f5e6a8`:e===`silver`?`#e8eef8`:`#d4954a`,body:e===`gold`?`#7a5c12`:e===`silver`?`#4a5568`:`#5c3a1e`,trim:e===`gold`?`#ffe566`:e===`silver`?`#c8d8f0`:t.accent}}function vt(e,t){let{lid:n,body:r,trim:i}=_t(e);return`
  ...
  <path d="M14 54 L18 50 M50 54 L46 50 M54 14 L50 18 M10 14 L14 18" stroke="#d6d3d1" stroke-width="1.8" stroke-linecap="round" opacity="0.65"/>
    ...
    ${P([[22,20,.8],[36,28,.7],[36,36,.7]],`#e9d5ff`,.6)}`}function ni(){return`${N(32,54,22,4)}
    ${I(48,34,6)}
    ...
    ${P([[24,18,.75],[36,30,.65],[40,38,.55]],`#86efac`,.55)}`}function ri(){return`${N(32,54,18,4)}
    ${I(32,36,6)}
    ...
    ${P([[16,20,.8],[48,38,.7],[32,10,.9]],`#e9d5ff`,.6)}`}function ii(){return`${N(32,54,22,4)}
    ...
    ${P([[30,6,.9],[12,18,.6],[50,36,.5]],`#e9d5ff`,.55)}`}function ai(){return`${N(32,54,20,4)}
    ...
    ${P([[14,14,.8],[48,16,.7],[32,8,.9]],`#e9d5ff`,.6)}`}function oi(){return`${N(32,54,22,4)}
    ${F(32,50,5)}
    ...
    ${P([[50,10,1],[12,52,.8],[40,20,.7]],`#e0f2fe`,.7)}`}function si(){return`${N(32,54,22,4)}
    ...
    ${P([[32,32,.8],[28,28,.6],[36,36,.6]],`#fde68a`,.55)}`}function ci(){return`${N(32,54,22,4)}
    ...
    ${P([[20,12,.9],[44,12,.8],[32,4,1],[14,28,.7],[50,28,.7]],`#fff`,.55)}`}function li(){return`${N(32,56,18,4)}
    ...
    ${P([[14,10,.7],[50,10,.7],[32,28,.8]],`#fde68a`,.6)}`}function ui(){return`${N(32,54,22,4)}
    ...
    ${Fr(32,36,4,`#e9d5ff`)}
    ${P([[32,28,.8],[32,44,.7]],`#e9d5ff`,.6)}`}function di(){return`${N(32,54,20,4)}
    ${F(22,38,5.5)}
    ...
    ${P([[36,32,.7],[48,34,.6],[42,28,.8]],`#e9d5ff`,.55)}`}function fi(){return`${N(32,56,18,4)}
    ${F(32,42,6)}
  ...
  ${jr(14,50,3.2)}${Lr(50,50,3.2)}`)}`}function mi(){return`${N(24,54,20,4)}
    ${I(48,20,5.5)}
    ...
    ${P([[18,32,.8],[28,28,.6]],`#e9d5ff`,.55)}`}function hi(){return`${N(32,54,22,4)}
    ...
    ${P([[12,18,.8],[50,8,.75],[32,44,.6]],`#e9d5ff`,.6)}`}function gi(){return`${N(28,54,18,4)}
    ${F(22,44,5.5)}
    ...
    ${P([[30,8,.8],[52,6,.7],[24,28,.6]],`#e9d5ff`,.6)}`}function _i(){return`${N(32,52,22,4)}
    ...
    ${P([[32,34,.9],[16,14,.7],[48,14,.7]],`#e0f2fe`,.6)}`}function vi(){return`${N(32,54,18,4)}
    ${F(32,48,5.5)}
    ...
    ${P([[12,18,.7],[52,18,.7],[32,36,.6]],`#e9d5ff`,.55)}`}function yi(){return`${N(32,54,18,4)}
    ${F(32,48,5.5)}
    ...
    ${P([[32,6,.7],[4,44,.6],[60,44,.6]],`#e9d5ff`,.55)}`}function bi(){return`${N(30,52,20,4)}
    ${I(46,20,5.5)}
    ...
    ${P([[36,26,.7],[22,38,.6]],`#fca5a5`,.5)}`}function xi(){return`${N(30,54,18,4)}
    ${F(18,50,5)}
    ${I(44,28,5)}
    ...
    ${P([[38,34,.7]],`#e9d5ff`,.5)}`}function Si(){return`${N(32,54,26,4)}
    ...
    ${P([[8,10,.8],[56,12,.9],[32,18,.7]],`#e0f2fe`,.65)}`}function Ci(){return`${N(32,54,22,4)}
    ...
    ${P([[20,40,.7],[44,24,.7],[32,28,.8]],`#e9d5ff`,.55)}`}function wi(){return`${N(32,54,24,4)}
    ...
    ${P([[16,10,.7],[48,10,.7],[10,32,.6],[54,32,.6]],`#c4b5fd`,.45)}`}function Ti(){return`${N(32,56,16,4)}
    ${F(32,34,6)}
    ...
    ${P([[32,12,.8],[12,34,.6],[52,34,.6]],`#e9d5ff`,.5)}`}function Ei(){return`${N(32,56,16,4)}
    ${F(32,38,6)}
    ...
    ${P([[12,12,.7],[46,18,.6]],`#fca5a5`,.5)}`}function Oi(){return`${N(32,54,20,4)}
    ...
    ${P([[32,8,.8],[14,28,.6],[50,28,.6]],`#e9d5ff`,.5)}`}function ki(){return`${N(32,54,20,4)}
    ...
    <path d="M24 50 C30 44 34 44 40 50" stroke="#fde68a" stroke-width="2" fill="none" opacity="0.7"/>
    ${M(32,14,5,`#fde68a`,`#b45309`)}
    ${P([[24,36,.7],[40,36,.7],[32,8,.9]],`#fde68a`,.6)}`}function Ai(){return`${N(32,54,18,4)}
    ${F(32,34,6)}
    ...
    ${P([[32,12,.8],[8,34,.6],[56,34,.6]],`#e9d5ff`,.55)}`}function ji(){return`${N(32,54,20,4)}
    ...
    ${P([[46,16,.7],[24,20,.5]],`#c4b5fd`,.45)}`}function Mi(){return`${N(32,54,24,4)}
    ...
    ${P([[8,8,.7],[56,8,.7],[8,56,.7],[56,56,.7]],`#fde68a`,.6)}`}function Ni(){return`${N(28,54,18,4)}
    ${F(18,44,5.5)}
    ${L(42,24,6,`#cbd5e1`)}
    ...
    ${P([[40,20,.7],[22,36,.5]],`#e2e8f0`,.45)}`}function Pi(){return`${N(32,54,16,4)}
    ${F(32,20,5.5)}
    ${L(32,48,6,`#cbd5e1`)}
    ...
    ${P([[32,16,.6],[32,44,.5]],`#cbd5e1`,.4)}`}function Fi(){return`${N(32,54,16,4)}
    ${F(32,26,5.5)}
    ...
    ${P([[32,22,.6]],`#93c5fd`,.4)}`}function Ii(){return`${N(32,54,20,4)}
    ...
    ${P([[32,6,.7]],`#cbd5e1`,.4)}`}function Li(){return`${N(32,54,22,4)}
    ${F(32,24,5.5)}
    ...
    ${P([[20,40,.5],[44,40,.5]],`#93c5fd`,.4)}`}function Ri(){return`${N(30,54,20,4)}
    ${F(20,36,5)}${I(40,36,5)}
    ${L(54,36,5,`#fca5a5`)}
    ...
    ${P([[48,32,.6]],`#fde68a`,.45)}`}function zi(){return`${N(28,54,20,4)}
    ...
    ${P([[30,14,.8],[20,38,.5]],`#bae6fd`,.5)}`}function Bi(){return`${N(32,54,18,4)}
    ${F(32,40,5.5)}
    ...
    ${P([[24,12,.8],[48,20,.7],[32,6,.9]],`#e9d5ff`,.55)}`}function Vi(){return`${N(32,54,22,4)}
    ...
    ${P([[32,10,.8],[16,40,.5],[48,40,.5]],`#93c5fd`,.45)}`}function Hi(){return`${N(32,54,16,4)}
    ${F(32,36,6)}
    ...
    ${P([[16,12,.6]],`#fca5a5`,.4)}`}function Ui(){return`${N(32,54,18,4)}
    ${F(32,34,6)}
    ...
    ${P([[32,20,.7]],`#e2e8f0`,.4)}`}function Wi(){return`${N(32,54,16,4)}
    ${I(32,40,6)}
    ...
    ${P([[24,4,.6],[40,4,.6]],`#fde68a`,.45)}`}function Gi(){return`${N(32,54,18,4)}
    ${Pr(32,36,32)}
    ...
    ${P([[30,36,.5]],`#d6d3d1`,.35)}`}function Ki(){return`${N(32,54,16,4)}
    ...
    ${P([[46,10,.7]],`#fca5a5`,.5)}`}function qi(){return`${N(32,54,16,4)}
    ...
    ${P([[32,20,.5],[32,40,.5]],`#cbd5e1`,.35)}`}function Ji(){return`${N(32,54,16,4)}
    ${I(32,22,6)}
    ...
    ${P([[28,16,.6],[36,16,.6]],`#fca5a5`,.45)}`}function Yi(){return`${N(32,54,20,4)}
    ...
    ${Fr(32,34,4,`#c4b5fd`)}
    ${P([[32,30,.7]],`#e9d5ff`,.45)}`}function Xi(){return`${N(28,54,18,4)}
    ${F(12,34,5.5)}
    ${L(50,34,6,`#cbd5e1`)}
    ...
    ${P([[46,30,.6]],`#e2e8f0`,.4)}`}function Zi(){return`${N(32,54,18,4)}
    ${I(32,28,6)}
    ...
    ${M(32,52,5,`#fca5a5`,`#dc2626`)}`}function Qi(){return`${N(32,56,16,4)}
    ${F(32,38,6)}
    ...
    ${P([[32,18,.7],[20,32,.5],[44,32,.5]],`#bae6fd`,.4)}`}function $i(){return`${N(32,54,18,4)}
    ${F(32,36,6)}
    ...
    ${P([[14,10,.7],[20,22,.5]],`#e0f2fe`,.5)}`}function ea(){return`${N(30,54,20,4)}
    ${F(14,50,5.5)}
    ${L(50,14,6,`#7dd3fc`)}
    ...
    ${P([[48,12,.7],[24,38,.5]],`#bae6fd`,.45)}`}function ta(){return`${N(32,56,16,4)}
    ${F(32,38,6)}
    ...
    ${P([[32,14,.8],[14,34,.5],[50,34,.5]],`#bae6fd`,.45)}`}function na(){return`${N(32,54,16,4)}
    ${I(32,34,6)}
    ...
    ${P([[32,10,.7],[28,44,.5],[36,44,.5]],`#86efac`,.45)}`}function ra(){return`${N(26,54,16,4)}
    ${F(24,38,5.5)}
    ...
    ${P([[48,10,.6]],`#fde68a`,.45)}`}function ia(){return`${N(30,54,18,4)}
    ...
    ${P([[42,20,.7]],`#fde68a`,.5)}`}function aa(){return`${N(32,56,16,4)}
    ${F(32,40,6)}
    ...
    ${P([[22,4,.7],[32,0,.8],[42,4,.7]],`#fde68a`,.6)}`}function oa(){return`${N(30,54,20,4)}
    ...
    ${P([[46,12,.8],[24,40,.5]],`#e0f2fe`,.5)}`}function sa(){return`${N(32,54,16,4)}
    ${Pr(32,36,32)}
    ...
    ${P([[32,24,.6]],`#fca5a5`,.4)}`}function ca(){return`${N(32,54,18,4)}
    ${I(32,20,6)}
    ...
    ${P([[32,44,.5]],`#fca5a5`,.4)}`}function la(){return`${N(32,54,16,4)}
    ${I(32,24,6)}
  ...
  <path d="M28 48 L24 54 M36 48 L40 54" stroke="#86efac" stroke-width="1.4" stroke-linecap="round" opacity="0.35"/>
    ${P([[20,40,.5],[44,40,.5]],`#86efac`,.4)}`}function ua(){return`${N(30,54,20,4)}
    ...
    ${M(48,22,5,`#ef4444`,`#991b1b`)}`}function da(){return`${N(32,54,18,4)}
    ...
    ${P([[32,8,.6],[56,32,.6],[32,56,.6],[8,32,.6]],`#bae6fd`,.4)}`}function fa(){return`${N(26,54,20,4)}
    ...
    ${P([[8,20,.6],[42,20,.6]],`#bae6fd`,.4)}`}function pa(){return`${N(32,54,22,4)}
    ...
    ${P([[44,10,.75],[30,28,.55],[20,46,.5]],`#e9d5ff`,.5)}`}function ma(){return`${N(32,54,24,4)}
    ...
    ${P([[32,28,.7],[12,38,.5],[52,38,.5]],`#bae6fd`,.45)}`}function ha(){return`${N(32,56,14,3)}
    ${F(32,34,6)}
    ${Nr(32,28,`#38bdf8`,`#7dd3fc`)}
    ...
    <text x="10" y="18" font-size="6" fill="#e9d5ff" opacity="0.55">?</text>`}function ga(){return`${N(30,56,16,3.5)}
    ${F(24,40,5.5)}
    ...
    ${P([[30,12,.7],[50,10,.6]],`#fecaca`,.55)}`}function _a(){return`${N(30,54,18,3.5)}
    ...
    <circle cx="42" cy="22" r="8" fill="#7dd3fc" opacity="0.12"/>`}function va(){return`${N(32,54,14,3.5)}
    ${Pr(32,36,30,!1)}
    ${Lr(32,34,4)}
    ...
    <path d="M24 38 L28 42 M36 38 L40 42" stroke="#d6d3d1" stroke-width="1.2" stroke-linecap="round" opacity="0.4"/>`}function ya(){return`${N(32,56,14,3)}
    ${F(32,38,7)}
    ...
    <circle cx="32" cy="12" r="4" fill="#fde68a" opacity="0.3"/>`}function ba(){return`${N(32,54,20,4)}
    ...
    <path d="M18 44 L22 40 M46 18 L50 14" stroke="#fbbf24" stroke-width="1.2" stroke-linecap="round" opacity="0.45"/>`}function xa(){return`${N(32,54,18,3.5)}
    ...
    <circle cx="32" cy="40" r="14" fill="none" stroke="#60a5fa" stroke-width="0.8" opacity="0.2"/>`}var Sa={nudge:()=>z(`nu`,`#94a3b8`,`#1e293b`,Ni()),backstep:()=>z(`bs`,`#9ca3af`,`#1f2937`,Pi()),retreat_3:()=>z(`ret`,`#93c5fd`,`#1e3a5f`,Fi()),leapfrog:()=>z(`lf`,`#94a3b8`,`#1e293b`,zi()),long_step:()=>B(`ls`,`#7dd3fc`,`#1e3a5f`,ea()),sidestep:()=>z(`ss`,`#9ca3af`,`#1f2937`,Xi()),blink_2:()=>B(`bl`,`#38bdf8`,`#0c4a6e`,oa()),random_teleport:()=>z(`rtp`,`#a78bfa`,`#312e81`,Bi()),recall:()=>z(`rc`,`#93c5fd`,`#1e3a5f`,Li()),repel:()=>z(`rp`,`#94a3b8`,`#1e293b`,Ri()),mass_nudge:()=>B(`mn`,`#7dd3fc`,`#1e3a5f`,fa()),displacement:()=>V(`dp`,`#b794f4`,`#553c7a`,pa()),swap_friendly:()=>z(`sw`,`#a78bfa`,`#312e81`,Yi()),dominion:()=>B(`dm`,`#60a5fa`,`#1e3a5f`,xa()),shield_1:()=>z(`s1`,`#60a5fa`,`#1e3a5f`,Qi()),shield_2:()=>B(`s2`,`#38bdf8`,`#0c4a6e`,ta()),bulwark:()=>V(`bw`,`#b794f4`,`#553c7a`,Ci()),barrier:()=>z(`br`,`#94a3b8`,`#1f2937`,qi()),last_stand:()=>V(`ls`,`#38bdf8`,`#0c4a6e`,ha()),martyr:()=>H(`my`,`#fca5a5`,`#4c0519`,ga()),fortify:()=>B(`fo`,`#a78bfa`,`#4c1d95`,Ti()),sanctuary_pulse:()=>B(`sp`,`#7dd3fc`,`#1e3a5f`,ma()),sanctuary:()=>V(`sa`,`#c4b5fd`,`#4c1d95`,Oi()),deflect_1:()=>B(`df`,`#38bdf8`,`#0c4a6e`,ra()),anchor_2:()=>z(`an`,`#94a3b8`,`#1f2937`,Ii()),iron_will:()=>z(`iw`,`#9ca3af`,`#1f2937`,Ui()),vengeance:()=>V(`vg`,`#9f7aea`,`#3b0764`,Di()),rally:()=>z(`rl`,`#60a5fa`,`#1e3a5f`,Vi()),forward_bolt:()=>B(`fb`,`#fde68a`,`#1e3a5f`,ia()),destroy_unshielded:()=>Ir(`sh`,`#4338ca`,`#1e1b4b`,Ur()),pyromancy:()=>Ir(`py`,`#ea580c`,`#431407`,Wr()),snipe:()=>B(`sn`,`#fde68a`,`#1e3a5f`,ba()),duel:()=>z(`du`,`#d4b896`,`#3d2817`,Yr()),sacrifice:()=>B(`sc`,`#fca5a5`,`#1e3a5f`,ua()),cull:()=>H(`cu`,`#a78bfa`,`#2e1065`,Jr()),execution:()=>V(`ex`,`#6ee7b7`,`#14532d`,Xr()),chain_lightning:()=>Ir(`cl`,`#2563eb`,`#0c1929`,Hr()),backstab:()=>B(`bk`,`#c4a574`,`#2d4a6e`,Br()),cryo_bolt:()=>B(`cb`,`#7dd3fc`,`#0c4a6e`,_a()),bomb:()=>Ir(`bm`,`#f59e0b`,`#78350f`,Vr()),shockwave:()=>H(`sw`,`#c4b5fd`,`#3b1f6e`,$r()),plague:()=>H(`pg`,`#86efac`,`#14532d`,ei()),magnet:()=>H(`mg`,`#6ee7b7`,`#14532d`,Zr()),poison_3:()=>B(`po`,`#86efac`,`#14532d`,na()),root_2:()=>B(`ro`,`#86efac`,`#14532d`,la()),panic:()=>z(`pn`,`#fca5a5`,`#1f2937`,Ji()),blizzard:()=>V(`bz`,`#7dd3fc`,`#1e3a5f`,Si()),snowball:()=>z(`sb`,`#bae6fd`,`#0c4a6e`,$i()),berserk:()=>Ir(`bk`,`#991b1b`,`#450a0a`,qr()),create_foe:()=>z(`cf`,`#78716c`,`#292524`,Ki()),deep_freeze:()=>H(`df`,`#7dd3fc`,`#0c4a6e`,oi()),reverse_only_2:()=>B(`rv`,`#fca5a5`,`#1e3a5f`,ca()),press:()=>z(`pr`,`#fca5a5`,`#1f2937`,Zi()),tangle:()=>V(`tg`,`#93c5fd`,`#312e81`,_i()),blind:()=>V(`bl`,`#a78bfa`,`#4c1d95`,ji()),confusion:()=>H(`cf`,`#c4b5fd`,`#4c1d95`,ri()),extract:()=>V(`ex`,`#c4b5fd`,`#4c1d95`,ii()),fog_2:()=>Dr(`${Or(32,34,6)}<ellipse cx="32" cy="24" rx="16" ry="8" fill="currentColor" opacity="0.22"/>`),crown:()=>B(`cr`,`#fbbf24`,`#451a03`,aa()),demote:()=>z(`dm`,`#fca5a5`,`#1f2937`,Wi()),fusion:()=>V(`fu`,`#8b5cf6`,`#4c1d95`,ki()),clone:()=>H(`cln`,`#93c5fd`,`#312e81`,di()),chameleon:()=>V(`ch`,`#86efac`,`#312e81`,Ai()),hibernation:()=>H(`hi`,`#c4b5fd`,`#4c1d95`,Ei()),quicksand:()=>z(`qs`,`#a8a29e`,`#292524`,Gi()),landmine:()=>B(`lm`,`#78716c`,`#292524`,sa()),collapse:()=>z(`co`,`#78716c`,`#292524`,va()),darkness:()=>V(`dk`,`#6d28d9`,`#1e1b4b`,wi()),scatter:()=>B(`st`,`#7dd3fc`,`#1e3a5f`,da()),call_forward:()=>V(`cfw`,`#fca5a5`,`#4c1d95`,bi()),dash:()=>V(`ds`,`#c4b5fd`,`#4c1d95`,xi()),earthquake:()=>H(`eq`,`#78716c`,`#292524`,Kr()),coin_flip:()=>pi(),ignore:()=>z(`ig`,`#94a3b8`,`#1f2937`,Hi()),counterspell:()=>H(`cs`,`#a78bfa`,`#2e1065`,ai()),purify:()=>B(`pu`,`#6ee7b7`,`#14532d`,ci()),trickster:()=>V(`tr`,`#c4b5fd`,`#553c7a`,Mi()),offering:()=>V(`of`,`#d8b4fe`,`#553c7a`,gi()),mulligan:()=>V(`mu`,`#c4b5fd`,`#4c1d95`,hi()),quick_march:()=>H(`qm`,`#60a5fa`,`#1e3a5f`,Qr()),constitution:()=>H(`co`,`#4ade80`,`#14532d`,fi()),last_king:()=>B(`lk`,`#fbbf24`,`#1e3a5f`,ya()),revive:()=>Ir(`rv`,`#15803d`,`#052e16`,Gr()),mind_control:()=>H(`mc`,`#c4b5fd`,`#3b0764`,ti()),zombify:()=>Ir(`zb`,`#4ade80`,`#14532d`,ni()),bounty:()=>H(`bo`,`#4ade80`,`#14532d`,li()),link_fate:()=>H(`lf`,`#a78bfa`,`#2e1065`,ui()),bishop_2:()=>B(`bp`,`#b794f4`,`#4c1d95`,vi()),rook_2:()=>B(`rk`,`#a78bfa`,`#4c1d95`,yi()),hostile_swap:()=>H(`hs`,`#93c5fd`,`#312e81`,si()),deport:()=>V(`dp`,`#c4b5fd`,`#1e1b4b`,mi())};function Ca(e,t=0){let n=Sa[e.effect];return n?n(t):null}var wa={movement:{symbol:`↗`,label:`Motion`,anim:`movement`},combat:{symbol:`⚔`,label:`Strike`,anim:`combat`},defense:{symbol:`🛡`,label:`Ward`,anim:`defense`},debuff:{symbol:`❄`,label:`Curse`,anim:`debuff`},transform:{symbol:`✦`,label:`Morph`,anim:`transform`},board:{symbol:`◇`,label:`Terrain`,anim:`board`},crown:{symbol:`♔`,label:`Royal`,anim:`crown`},arcane:{symbol:`✧`,label:`Arcane`,anim:`arcane`}},Ta=[[`movement`,[`nudge`,`backstep`,`long_step`,`leapfrog`,`recall`,`teleport`,`random_teleport`,`displacement`,`berserk`,`dash`]],[`combat`,[`stab`,`shatter`,`destroy`,`snipe`,`duel`,`execution`,`cull`,`pyromancy`,`backstab`,`sacrifice`,`chain_lightning`,`cryo`,`bomb`,`magnet`]],[`special`,[`create_foe`,`clone`,`earthquake`]],[`defense`,[`shield`,`ward`,`aegis`,`bulwark`,`stall`,`sanctuary`,`barrier`,`anchor`,`iron_will`,`hibernation`,`constitution`]],[`debuff`,[`root`,`panic`,`backpedal`,`blizzard`,`deep_freeze`,`snowball`,`blind`,`confusion`,`extract`,`press`,`tangle`,`shockwave`]],[`board`,[`quicksand`,`landmine`,`collapse`,`darkness`,`earthquake`,`scatter`,`call_forward`]],[`meta`,[`counterspell`,`vengeance`,`last_stand`,`martyr`,`purify`,`trickster`,`ignore`,`offering`,`mulligan`,`quick_march`,`dominion`,`last_king`,`revive`,`mind_control`,`zombify`]]];function Ea(e){let t=0;for(let n=0;n<e.length;n++)t=(t+e.charCodeAt(n)*41)%360;return t}function Da(e){let t=0;for(let n=0;n<e.length;n++)t=(t+e.charCodeAt(n)*13)%3;return t}function Oa(e){let t=`${e.id} ${e.effect} ${e.name}`.toLowerCase();for(let[e,n]of Ta)if(Array.isArray(n)&&n.some(e=>t.includes(e)))return e;return`arcane`}function ka(e){return`ca${String(e).replace(/[^a-zA-Z0-9]/g,``)}`}function Aa(e,t,n){let r=[[12,18,.35],[48,12,.5],[52,44,.25],[18,50,.4],[38,28,.55]],i=n*4;return r.map(([e,n,r],a)=>`<circle cx="${(e+i+a*7)%56+4}" cy="${(n+i*2+a*5)%52+6}" r="1.2" fill="hsl(${t} 90% 85% / ${r})"/>`).join(``)}function ja(e,t){let n=t,r={movement:`
      ...
      </g>`};return r[e]||r.arcane}function Ma(e,t,n,r){return Na(e,t,n,r)}function Na(e,t,n,r){let i=ka(n),a=(t+42)%360,o=Da(n),s=r&&Ca(r,o)||ja(e,o);return r?.effect&&zr(r.effect)&&s?`<svg class="spell-card__svg spell-card__svg--full-bleed" viewBox="0 0 70 60" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid meet">${s}</svg>`:`<svg class="spell-card__svg" viewBox="0 0 70 60" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
  ...
  `,t.onClick&&l.addEventListener(`click`,n=>t.onClick(n,e)),La(l),l}function za(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function Ba(e){return document.getElementById(e)}function Va(){let e=Ba(`card-preview-modal`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function Ha(e){document.body.classList.toggle(`card-preview-open`,e),window.dispatchEvent(new CustomEvent(`card-preview-change`,{detail:{open:e}}))}function Ua(){Ba(`card-preview-modal`)?.classList.add(`hidden`),Ba(`card-preview-mount`)?.classList.remove(`card-preview-mount--reveal-only`),Ha(!1)}function Wa(e,t={}){Va();let n=Ba(`card-preview-modal`),r=Ba(`card-preview-mount`),i=Ba(`card-preview-actions`);if(!(!n||!r||!e)){if(r.innerHTML=``,r.classList.toggle(`card-preview-mount--reveal-only`,!!t.hideDesc),r.appendChild(Ra(e,{static:!0,hideDesc:t.hideDesc})),i){if(i.innerHTML=``,t.meta){let e=document.createElement(`p`);e.className=`card-preview-meta`,e.textContent=t.meta,i.appendChild(e)}let e=document.createElement(`div`);if(e.className=`card-preview-actions-row`,t.onPlay){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=`Cast spell`,n.addEventListener(`click`,()=>{Ua(),t.onPlay()}),e.appendChild(n)}if(t.onAdd){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=`Add to deck`,n.disabled=!!t.addDisabled,n.addEventListener(`click`,()=>{t.addDisabled||t.onAdd()}),e.appendChild(n)}if(t.onBuy){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=t.buyLabel||`Buy copy`,n.disabled=!!t.buyDisabled,n.addEventListener(`click`,()=>{t.buyDisabled||t.onBuy()}),e.appendChild(n)}if(t.onRemove){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-secondary`,n.textContent=`Remove all from deck`,n.addEventListener(`click`,()=>{t.onRemove(),Ua()}),e.appendChild(n)}e.children.length&&i.appendChild(e)}n.classList.remove(`hidden`),Ha(!0)}}function Ga(){Ba(`card-preview-close`)?.addEventListener(`click`,Ua),Ba(`card-preview-backdrop`)?.addEventListener(`click`,Ua),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&Ua()})}function Ka(e,t=`.spell-card`){e&&e.querySelectorAll(t).forEach((e,t)=>{e.classList.add(`spell-card--deal`),e.style.animationDelay=`${t*.1}s`})}function qa(e){e&&(e.classList.add(`spell-card--rare-burst`),setTimeout(()=>e.classList.remove(`spell-card--rare-burst`),900))}function Ja(e){e&&(e.classList.add(`spell-card--epic-burst`),setTimeout(()=>e.classList.remove(`spell-card--epic-burst`),1200))}function Ya(e){e&&(e.classList.add(`spell-card--legendary-burst`),setTimeout(()=>e.classList.remove(`spell-card--legendary-burst`),1500))}function Xa(e,t){t===`legendary`?Ya(e):t===`epic`?Ja(e):t===`rare`&&qa(e)}var Za={common:10,uncommon:20,rare:30,epic:40,legendary:50};function Qa(e){return Za[e]??30}function $a(e,r){let i=ae(e,r);if(i<1)return{success:!1,message:`Get this spell from a chest first.`};let a=n(r);if(!a)return{success:!1,message:`Unknown card.`};let o=t(r);if(i>=o)return{success:!1,message:`You already own the maximum (${o} copies).`};let s=Qa(a.rarity);if(e.gems<s)return{success:!1,message:`Need ${s} gems (${e.gems} available).`};e.gems-=s;let c=ve(e,r,1);return c?{success:!0,cost:s,message:`+1 ${a.name} for ${s} gems (${i+c} owned).`}:(e.gems+=s,T(e),{success:!1,message:`You already own the maximum copies for this rarity.`})}var eo={deck:`<svg class="nav-icon-svg" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    </div>`,t.style.animationDelay=`0s`,t}function ts(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function ns(e,t=``){let n=f(e),r=(t||`P`).charAt(0).toUpperCase(),i=Ko(n.equipped.avatar)||`<span class="profile-avatar-fallback">${ts(r)}</span>`;return`<span class="profile-avatar-stack header-profile-btn__stack ${Xo(n.equipped.frame)}"><span class="profile-avatar-inner header-profile-btn__inner">${i}</span></span>`}async function rs(e){if(!e)return``;try{return(await Oe(e.id))?.username||e.user_metadata?.display_name||e.email?.split(`@`)[0]||``}catch{return e.user_metadata?.display_name||e.email?.split(`@`)[0]||``}}var is=null;function as(){return is||=Promise.all([D(()=>import(`./match-hHCy0ir0.js`),[],import.meta.url),D(()=>import(`./matchView-DEgIiRZw.js`),[],import.meta.url),D(()=>Promise.resolve({}),__vite__mapDeps([0]),import.meta.url),D(()=>Promise.resolve({}),__vite__mapDeps([1]),import.meta.url)]).then(([e,t])=>({MatchSession:e.MatchSession,getMatchHtml:t.getMatchHtml})),is}var os=null;function ss(){return os||=Promise.all([D(()=>import(`./pvpUI-3RoQrjpN.js`),[],import.meta.url),D(()=>import(`./pvp-DtWoa5F9.js`),[],import.meta.url)]).then(([e,t])=>({initPvpUI:e.initPvpUI,clearAllWaitingRoomsOnce:t.clearAllWaitingRoomsOnce})),os}var cs=null;function ls(){return cs||=D(()=>import(`./profileUI-ghQQIUWa.js`),[],import.meta.url),cs}function us(){cs=null}var ds=null;function fs(){return ds||=Promise.all([D(()=>import(`./settingsUI-DsLbIWAh.js`),[],import.meta.url),D(()=>Promise.resolve({}),__vite__mapDeps([2]),import.meta.url)]).then(([e])=>e),ds}var ps=null;function ms(){return ps||=Promise.all([D(()=>import(`./chestOpenAnimation-DAEZ-ncK.js`),[],import.meta.url),D(()=>import(`./cosmeticOpenAnimation-BSAcRCdP.js`),[],import.meta.url),D(()=>import(`./titleOpenAnimation-DBJ8bC5S.js`),[],import.meta.url)]).then(([e,t,n])=>({playChestOpenAnimation:e.playChestOpenAnimation,playCosmeticOpenAnimation:t.playCosmeticOpenAnimation,playTitleOpenAnimation:n.playTitleOpenAnimation})),ps}var hs=null;function gs(){return hs||=D(()=>import(`./socialUI-K1XPg-N6.js`),[],import.meta.url),hs}var _s=null;function vs(){return _s||=D(()=>import(`./tutorialMeta-DyABx23e.js`),[],import.meta.url),_s}var ys=null;function bs(){return ys||=D(()=>import(`./tutorialUnlocks-CAOqeLhj.js`),[],import.meta.url),ys}var xs=null;function Ss(){return xs||=D(()=>import(`./tutorialMatch-Bl2Cy0zl.js`),[],import.meta.url),xs}function Cs(e,t){vs().then(n=>n.notifyMetaTutorial(e,t)).catch(e=>console.warn(`[Tutorial] meta notify failed`,e))}function ws(e,t){bs().then(n=>n.notifyUnlockTutorial(e,t))}var W;try{W=E()}catch(e){console.error(`Failed to load profile, resetting save:`,e),localStorage.removeItem(`cardCheckersProfile_v7`),localStorage.removeItem(`cardCheckersProfile_v5`),W=E()}var G=`deck`,Ts={deck:`Decks`,chests:`Shop`,play:`Play`,social:`Social`,quests:`Quests`,profile:`Profile`,settings:`Settings`},Es=new Set(Object.keys(Ts)),Ds=null,Os=null,ks=!1,As=`cards`,js=`list`,K=null,q=[],Ms=null,Ns=``,Ps=`all`,Fs=`all`,Is=!0,Ls={legendary:5,epic:4,rare:3,uncommon:2,common:1};function Rs(e){return[...e].sort((e,t)=>{let n=Ls[e.rarity]??0,r=Ls[t.rarity]??0;return n===r?e.name.localeCompare(t.name):r-n})}var J=null,zs=null,Bs=null,Vs=null,Hs=null;function Us(){return zs?Promise.resolve(zs):(Bs||=ss().then(({initPvpUI:e,clearAllWaitingRoomsOnce:t})=>(t(),zs=e({arenaRoot:document.getElementById(`play-arena-root`),leaderboardRoot:document.getElementById(`play-leaderboard-root`),getProfile:()=>W,openAuthModal:()=>Ks?.open(`signin`,{forced:!0}),onNavigateTab:Z,onNavigatePlayTab:gc,onNavigatePlayMenu:hc,onOpenDeckEdit:gl}),zs)),Bs)}function Ws(){return Vs?Promise.resolve(Vs):(Hs||=gs().then(({initSocialUI:e})=>(Vs=e({root:document.getElementById(`view-social`),getProfile:()=>W,saveProfile:T,openAuthModal:()=>Ks?.open(`signin`,{forced:!0})}),Vs)),Hs)}var Gs=null,Ks=null,Y=!1,qs=!1,Js=!1,Ys=!1,Xs=!1,Zs=null,Qs=null,$s=null,ec=1,tc=null;function nc(e){return Ls[e?.rarity]??0}function rc(e){let t=r(e);return Object.entries(t).map(([e,t])=>({def:n(e),count:t})).filter(e=>e.def).sort((e,t)=>{let n=nc(t.def)-nc(e.def);return n===0?e.def.name.localeCompare(t.def.name):n})}function ic(e){let t=q.indexOf(e);t<0||(q.splice(t,1),bl(),Cs(`card-removed-from-deck`,{cardId:e}))}function ac(e){let t=q.length;q=q.filter(t=>t!==e),q.length!==t&&(bl(),Cs(`card-removed-from-deck`,{cardId:e}))}function oc(){let n=e().map(e=>({def:e,owned:ae(W,e.id)})).filter(e=>e.owned>0).sort((e,t)=>{let n=nc(t.def)-nc(e.def);return n===0?e.def.name.localeCompare(t.def.name):n});q=[];for(let{def:e,owned:r}of n){let n=Math.min(r,t(e));for(let t=0;t<n&&q.length<30;t++)q.push(e.id);if(q.length>=30)break}bl()}var X=e=>document.getElementById(e);function sc(){let e=document.getElementById(`adventure-prebattle`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function cc(){let e=document.querySelector(`nav.game-nav.tabs`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function lc(){return window.matchMedia(`(min-width: 1000px) and (max-width: 1400px)`).matches?2.5:window.matchMedia(`(min-width: 600px) and (max-width: 999px)`).matches?1.85:1}function uc(){sc(),document.getElementById(`adventure-prebattle`)?.classList.remove(`hidden`),document.body.classList.add(`adventure-floor-open`)}function dc(){document.getElementById(`adventure-prebattle`)?.classList.add(`hidden`),document.body.classList.remove(`adventure-floor-open`)}function fc(e=le,t=`Locked`){Wn({title:t,bodyHtml:e,autoCloseMs:4500})}function pc(){document.body.classList.toggle(`main-tab-active`,Es.has(G)),document.body.classList.toggle(`play-sub-active`,G===`play`&&Ds!==null),document.body.classList.toggle(`adventure-active`,G===`play`&&Ds===`adventure`)}function mc(){let e=d(W);for(let t of[`arena`,`leaderboard`]){let n=document.querySelector(`.play-tab[data-play-tab="${t}"]`);n&&(n.classList.toggle(`play-tab--locked`,!e),n.setAttribute(`aria-disabled`,e?`false`:`true`),n.title=e?``:m(`PvP`))}}function hc(){Ds=null,X(`play-menu`)?.classList.remove(`hidden`),document.querySelectorAll(`.play-tab-panel`).forEach(e=>{e.classList.add(`hidden`),e.hidden=!0}),pc(),mc()}async function gc(e){if(!ks&&(e===`arena`||e===`leaderboard`)&&!d(W)){let e=Qt(),t=Xt;await Qe(e?`${m(`PvP`)}\n\n${t}.`:m(`PvP`),{title:`PvP locked`,confirmLabel:`Go to Adventure`,cancelLabel:e?`Sign in`:`Not now`})?(ks=!0,gc(`adventure`),ks=!1):e&&Ks?.open(`signin`,{forced:!0});return}Ds=e,X(`play-menu`)?.classList.add(`hidden`),document.querySelectorAll(`.play-tab`).forEach(t=>{let n=t.dataset.playTab===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,n?`true`:`false`)}),document.querySelectorAll(`.play-tab-panel`).forEach(t=>{let n=t.id===`play-tab-${e}`;t.classList.toggle(`hidden`,!n),t.hidden=!n}),pc(),ws(`play-tab-changed`,{tab:e}),e===`adventure`?Tl():e===`arena`?Us().then(e=>{e?.setScreen?.(`arena`),e?.render({resume:!0})}):e===`leaderboard`&&Us().then(e=>{e?.setScreen?.(`leaderboard`),e?.render()})}function _c(e,t,n){let r=e.querySelector(`.tab-btn__sign-in-badge`);t?(r||(r=document.createElement(`span`),r.className=`tab-btn__sign-in-badge`,r.setAttribute(`aria-hidden`,`true`),e.appendChild(r)),r.textContent=n,e.classList.add(`tab-btn--sign-in-nudge`)):(r?.remove(),e.classList.remove(`tab-btn--sign-in-nudge`))}function vc(){let e=d(W),t=Qt();mc();let n=document.querySelector(`.tab-btn[data-tab="quests"]`);if(n){let r=!e,i=Zt;n.classList.toggle(`tab-btn--locked`,r),n.setAttribute(`aria-disabled`,r?`true`:`false`),r?(n.title=t?`${m(`Quests`)} ${i}.`:m(`Quests`),_c(n,t,`Sign in`)):t?(n.title=i,_c(n,!1)):(n.title=``,_c(n,!1))}let r=document.querySelector(`.tab-btn[data-tab="social"]`);r&&(t?(r.title=Zt,_c(r,!0,`Sign in`)):(r.title=``,_c(r,!1)));let i=c(W),a=document.querySelector(`.vault-tab[data-vault-tab="cosmetics"]`);a&&(a.classList.toggle(`vault-tab--locked`,!i),a.title=i?``:_e,a.setAttribute(`aria-disabled`,i?`false`:`true`))}async function Z(e){let t=document.getElementById(`view-match`);if(!(Y&&t&&!t.classList.contains(`hidden`))&&!(t&&!t.classList.contains(`hidden`)&&t.querySelector(`.pvp-loading`)&&e!==G)){if(!qs&&e===`quests`&&!d(W)){let e=Qt(),t=Zt;await Qe(e?`${m(`Quests`)}\n\n${t}.`:m(`Quests`),{title:`Quests locked`,confirmLabel:`Go to Adventure`,cancelLabel:e?`Sign in`:`Not now`})?(qs=!0,Z(`play`),qs=!1):e&&Ks?.open(`signin`,{forced:!0});return}if(sr(),Qn()&&er()){if(e===G||t?.querySelector(`.pvp-loading`)||!await Qe(`Leave your current match to open ${Ts[e]||e}?`,{title:`Leave match?`,confirmLabel:`Leave`,cancelLabel:`Stay`,destructive:!0}))return;tr(e),e===`play`&&(Os=`arena`),ir(),document.querySelector(`#btn-leave-match`)?.click();return}if(js===`edit`&&(e!==`deck`||e===`deck`&&G===`deck`)){if(!await ml())return;hl()}if(e!==`deck`&&js===`edit`&&(qc(),document.body.classList.remove(`deck-editing`)),G=e,pc(),Es.has(e)&&Gc(),document.querySelectorAll(`.tab-btn`).forEach(t=>{t.classList.toggle(`active`,t.dataset.tab===e)}),document.querySelectorAll(`.view`).forEach(t=>{t.classList.toggle(`hidden`,t.id!==`view-${e}`)}),e===`chests`&&(rl(As),al()),e===`deck`&&(js=`list`,Yc(`list`)),e===`profile`&&wc(),e===`settings`&&Tc(),e===`quests`&&(Ac(),Pc()),e===`play`){let e=Os;Os=null,e?gc(e):hc()}e===`social`&&(Vs?Vs.refresh?.()??Vs.render():(Mc(),Ws().then(e=>e?.render()).catch(e=>{console.error(`[Social] init failed`,e),Nc()}))),Cs(`tab-changed`,{tab:e}),ws(`tab-changed`,{tab:e}),Qn()||(xo(`hub`),await ko())}}var Q=``;function yc(e=Q){e&&(Q=e);let t=document.getElementById(`header-profile-menu`),n=document.getElementById(`header-profile-btn`),r=document.getElementById(`header-username`),i=document.getElementById(`auth-header-btn`),a=!!O();if(i&&(i.classList.toggle(`hidden`,a),i.hidden=a),t&&(t.classList.toggle(`hidden`,!a),t.hidden=!a),r){let e=a&&Q;r.textContent=e?Q:``,r.classList.toggle(`hidden`,!e),r.hidden=!e}n&&a&&(n.innerHTML=ns(W,Q),n.title=Q?`Account — ${Q}`:`Account menu`)}function bc(){let e=document.getElementById(`header-profile-btn`),t=document.getElementById(`header-profile-dropdown`);!e||!t||(t.classList.add(`hidden`),t.hidden=!0,e.setAttribute(`aria-expanded`,`false`))}function xc(){let e=document.getElementById(`header-profile-menu`),t=document.getElementById(`header-profile-btn`),n=document.getElementById(`header-profile-dropdown`);if(!e||!t||!n)return;let r=e=>{n.classList.toggle(`hidden`,!e),n.hidden=!e,t.setAttribute(`aria-expanded`,e?`true`:`false`)};t.addEventListener(`click`,e=>{e.stopPropagation();let t=!n.hidden;r(!t)}),n.querySelectorAll(`[data-profile-menu-action]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.profileMenuAction;bc(),t===`settings`?Z(`settings`):Cc()})}),document.addEventListener(`click`,t=>{n.hidden||e.contains(t.target)||bc()}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&!n.hidden&&bc()})}async function Sc(){let e=O();if(!e){Q=``,yc();return}Q=await rs(e),yc()}function Cc(){bc(),Z(`profile`),ws(`profile-opened`)}async function wc(){let{renderProfileTab:e}=await ls(),t=X(`view-profile`);e(W,t,{onGemsChange:Fc,onTitleChanged:()=>yc()})}async function Tc(){let{renderSettingsTab:e}=await fs();e(X(`view-settings`),{onUsernameChanged:e=>{Q=e,yc(e)}})}var Ec=`
  ...
  </section>`;function Ac(){let e=X(`view-quests`);e&&(e.innerHTML=Ec)}function jc(e=X(`view-quests`)){e&&(e.innerHTML=Dc,e.querySelector(`.quests-retry-btn`)?.addEventListener(`click`,()=>{us(),Ac(),Pc()}))}function Mc(){let e=X(`view-social`);e&&(e.innerHTML=Oc)}function Nc(e=X(`view-social`)){e&&(e.innerHTML=kc,e.querySelector(`.social-retry-btn`)?.addEventListener(`click`,()=>{Vs=null,Hs=null,Mc(),Ws().then(e=>e?.render()).catch(t=>{console.error(`[Social] retry failed`,t),Nc(e)})}))}async function Pc(){let e=X(`view-quests`);if(e)try{let{renderQuestsTab:t}=await ls();t(W,e,{onTitleChanged:()=>yc(),onCurrencyChange:()=>$()})}catch(t){console.error(`[Quests] render failed`,t),jc(e)}}function $(){let e=X(`header-gems`);e&&(e.textContent=String(W.gems??0));let t=X(`header-stars`);t&&(t.textContent=String(W.stars??0)),document.querySelector(`.hud-gems`)?.classList.toggle(`hud-gems--low`,(W.gems??0)<50),document.querySelector(`.hud-stars`)?.classList.toggle(`hud-stars--low`,(W.stars??0)<10)}function Fc(){$()}function Ic(){document.querySelectorAll(`.collection-owned-only-toggle`).forEach(e=>{e.checked=Is});for(let e of[`collection-search`]){let t=X(e);t&&(t.value=Ns)}for(let e of[`collection-rarity`]){let t=vr(e);t&&(t.value=Ps)}let e=vr(`collection-category`);e&&(e.value=Fs)}var Lc=`(max-width: 899px)`,Rc=`(max-width: 1280px)`,zc=null;function Bc(){return window.matchMedia(Lc).matches}function Vc(){return document.body.classList.contains(`main-tab-active`)&&!document.body.classList.contains(`match-active`)&&!document.body.classList.contains(`deck-editing`)&&window.matchMedia(Rc).matches}function Hc(){return document.querySelector(`.game-main`)}function Uc(){let e=Hc();return Vc()&&e?e.scrollTop:window.scrollY||document.documentElement.scrollTop||0}function Wc(e){let t=Hc();if(Vc()&&t){t.scrollTop=e;return}window.scrollTo(0,e)}function Gc(){let e=Hc();if(Vc()&&e){e.scrollTop=0;return}window.scrollTo(0,0)}function Kc(){Bc()&&(zc=Uc(),document.body.style.position=`fixed`,document.body.style.top=`0`,document.body.style.left=`0`,document.body.style.right=`0`,document.body.style.width=`100%`)}function qc(){if(zc==null)return;let e=zc;zc=null,document.body.style.position=``,document.body.style.top=``,document.body.style.left=``,document.body.style.right=``,document.body.style.width=``,Wc(e)}function Jc(){Gc(),document.documentElement.scrollTop=0,document.body.scrollTop=0,document.querySelector(`.game-shell`)?.scrollTo?.(0,0),Hc()?.scrollTo?.(0,0),document.querySelector(`#view-deck`)?.scrollTo?.(0,0),document.querySelectorAll(`#deck-subview-edit, #deck-subview-edit .deck-editor, #deck-subview-edit .deck-editor__body, #deck-subview-edit .deck-editor__grid, #deck-subview-edit .deck-editor__grid-cards`).forEach(e=>{e.scrollTop=0})}function Yc(e){e!==`edit`&&qc(),js=e,document.body.classList.toggle(`deck-editing`,e===`edit`),X(`deck-subview-list`)?.classList.toggle(`hidden`,e!==`list`),X(`deck-subview-edit`)?.classList.toggle(`hidden`,e!==`edit`),e===`edit`&&(Kc(),w(W),T(W),Ps=`all`,Ns=``,Fs=`all`,Is=!0,Ic(),fl()),e===`list`&&yl(),e===`edit`&&(bl(),Jc(),requestAnimationFrame(()=>{Jc(),requestAnimationFrame(Jc)}))}function Xc({id:e,title:t,desc:n,cost:r,variant:i=`mystery`}){let a=(W.stars??0)>=r,o=i===`title`?zt():Vt();return`
  ...
  `;let t=e.querySelectorAll(`.mystery-box`);Zc(t[0],()=>el()),Zc(t[1],()=>tl())}function rl(e){if(!Js&&e===`cosmetics`&&!c(W)){fc(_e,`Cosmetics locked`),Js=!0,rl(`cards`),Js=!1;return}As=e,document.querySelectorAll(`.vault-tab`).forEach(t=>{let n=t.dataset.vaultTab===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,n?`true`:`false`)}),document.querySelectorAll(`.vault-tab-panel`).forEach(t=>{let n=t.id===`vault-tab-${e}`;t.classList.toggle(`hidden`,!n),t.hidden=!n}),ws(`vault-tab-changed`,{tab:e})}function il(){ls().then(({renderCosmeticBoxes:e})=>{e(W,X(`cosmetic-box-list`),{logEl:X(`cosmetic-box-log`),onGemsChange:Fc,cosmeticsUnlocked:c(W),onOpened:()=>{G===`profile`&&wc(),G===`quests`&&Pc()}})}).catch(e=>{console.error(`[Shop] cosmetics render failed`,e);let t=X(`cosmetic-box-log`);t&&(t.textContent=`Couldn't load cosmetic boxes — try again from the Shop tab.`,t.classList.add(`chest-log--error`))})}function al(e={}){let{clearPulls:t=!0}=e;$(),il(),nl();let n=X(`chest-list`),r=X(`chest-pulls`);if(r&&t&&(r.innerHTML=``,r.classList.add(`chest-pulls--hidden`),r.classList.remove(`chest-pulls--reveal`)),n){n.innerHTML=``;for(let e of ct){let t=gt[e.id]||gt.bronze,i=W.gems>=e.cost,a=document.createElement(`article`);a.className=`chest-card chest-card--${e.id}${i?``:` chest-card--locked`}`,a.innerHTML=`
    ...
    `;let o=a.querySelector(`.chest-open`);o.disabled=!i,o.addEventListener(`click`,async()=>{if(o.disabled)return;let n=pt(W,e.id),i=X(`chest-log`);if(!n.success){i&&(i.textContent=n.message,i.classList.add(`chest-log--error`));return}T(W),$(),o.disabled=!0;let{playChestOpenAnimation:a}=await ms();if(await a({tier:e.id,tierLabel:t.label,pulls:n.pulls}),Cs(`chest-opened`,{chestId:e.id}),i){let t=n.bonusGems?` (+${n.bonusGems} gems from duplicates)`:``;i.textContent=`Got ${n.pulls.length} spells from ${e.name}.${t}`,i.classList.remove(`chest-log--error`)}if(r){r.classList.remove(`chest-pulls--hidden`),r.classList.add(`chest-pulls--reveal`),r.innerHTML=`<p class="chest-pulls__label">Chest opened</p><div class="chest-pulls__grid"></div>`;let e=r.querySelector(`.chest-pulls__grid`);n.pulls.forEach((t,n)=>{let r=Ra(t,{button:!0,deal:!0,gallery:!0,onClick:()=>Wa(t)});if(r.style.animationDelay=`${n*.12}s`,t.duplicate){r.classList.add(`spell-card--duplicate-pull`);let e=document.createElement(`span`);e.className=`chest-pull-dup-badge`,e.textContent=t.starRefund?`Duplicate · +${t.starRefund} ★`:`Duplicate · +${t.gemRefund} ◆`,r.appendChild(e)}e.appendChild(r),Xa(r,t.rarity)}),Ka(e),r.scrollIntoView({behavior:`smooth`,block:`nearest`})}al()}),n.appendChild(a)}}}function ol(){return Rs(e().filter(e=>{if(Fs!==`all`&&st(e)!==Fs||Ps!==`all`&&e.rarity!==Ps)return!1;if(Ns){let t=Ns.toLowerCase();if(!e.name.toLowerCase().includes(t)&&!e.desc.toLowerCase().includes(t))return!1}return!(Is&&ae(W,e.id)<=0)}))}function sl(e,t){let n=$a(W,e);return t&&(t.textContent=n.message,t.className=n.success?`deck-status ok`:`deck-status warn`),n.success&&(T(W),$(),js===`list`&&yl(),js===`edit`&&bl()),n}function cl(e,t){let n=$a(W,e);return n.success?(T(W),$(),q.push(e),he(W,e),T(W),bl(),t&&(t.hidden=!1,t.textContent=`Bought and added to deck.`,t.className=`deck-editor__error deck-status ok`),!0):(t&&(t.hidden=!1,t.textContent=n.message,t.className=`deck-editor__error deck-status warn`),!1)}function ll(e){return i(q,e,W).ok?(q.push(e),he(W,e),T(W),bl(),Cs(`card-added-to-deck`,{cardId:e}),!0):!1}function ul(e,n,a={}){let{deckEdit:o=!1,statusEl:s=null}=a,c=ae(W,n.id),l=t(n),u=c>=l,d=Qa(n.rarity),f=W.gems>=d&&!u,p=o?i(q,n.id,W):{ok:!1},m=o&&r(q)[n.id]||0,h=q.length<30,g=m<l,_=c>=1&&c<=m,v=c>=1&&!u,y=o&&!p.ok&&h&&g&&_&&v,ee=()=>sl(n.id,s),x=()=>{let e=ae(W,n.id),t=o&&r(q)[n.id]||0,a=e>=l,s=W.gems>=d&&!a,c=o?i(q,n.id,W):{ok:!1};Wa(n,{meta:o?`Owned ${e}/${l} · In deck ${t}/${l} · ${a?`max copies`:`${d} gems per copy`}`:`Owned ${e}/${l}${a?` · max copies`:` · ${d} gems per copy`}`,buyLabel:a?`Max copies owned`:`Buy copy (${d} gems)`,buyDisabled:!s||a||e<1,onBuy:()=>{ee(),Ua()},addDisabled:!c.ok,onAdd:o?()=>{ll(n.id)&&x()}:void 0})};if(o){let t=document.createElement(`div`);t.className=`deck-editor-tile`+(b(W,n.id)?` deck-editor-tile--new`:``);let r=Ra(n,{button:!0,gallery:!0,onClick:()=>x()});r.classList.add(`deck-editor-tile__card`),r.title=`${n.name} — tap for full card`;let i=c>0?`Owned ${c}/${l}`:`Not in collection`,a=document.createElement(`div`);a.className=`deck-editor-tile__meta`,a.innerHTML=`${i} · In deck ${m}/${l}${b(W,n.id)?`<span class="deck-editor-tile__new">New</span>`:``}`,a.addEventListener(`click`,()=>x());let o=document.createElement(`button`);o.type=`button`,o.className=`deck-editor-tile__action`,p.ok?(o.classList.add(`deck-editor-tile__action--add`),o.textContent=`+ Add to deck`,o.addEventListener(`click`,e=>{e.stopPropagation(),ll(n.id)})):y?(o.classList.add(`deck-editor-tile__action--buy`),o.textContent=f?`Add for ${d} gems`:`Need ${d} gems`,o.disabled=!f,o.addEventListener(`click`,e=>{e.stopPropagation(),cl(n.id,s)})):(o.classList.add(`deck-editor-tile__action--disabled`),o.disabled=!0,q.length>=30?o.textContent=`Deck full (30/30)`:m>=l?o.textContent=`Max copies in deck`:c<1?o.textContent=`Open Shop chests to unlock`:p.reason?o.textContent=p.reason:o.textContent=`Can't add`),t.append(r,a,o),e.appendChild(t);return}let S=document.createElement(`div`);S.className=`collection-card-wrap`+(c<1?` collection-card-wrap--unowned`:``);let C=Ra(n,{button:!0,compact:!0,disabled:c<1||u,onClick:e=>{if(e.shiftKey||c<1||u){x();return}ee()}});C.title=u?`${n.name} — max ${l} copies owned. Tap to view full card.`:c<1?`${n.name} — not owned. Tap to view full card.`:`${n.name} — tap to buy (${d} gems). Shift+click to inspect.`,S.appendChild(C);let w=document.createElement(`span`);w.className=`collection-owned-count`,w.textContent=c>0?`×${c}`:`—`,S.appendChild(w);let te=document.createElement(`span`);te.className=`collection-buy-cost`,te.textContent=u?`MAX`:`${d} ◆`,(!f||u)&&te.classList.add(`collection-buy-cost--cant`),S.appendChild(te),e.appendChild(S)}function dl(e,t={}){if(!e)return;let{deckEdit:n=!1,statusEl:r=null}=t;e.innerHTML=``;let i=ol();if(!i.length){e.className=`deck-editor__grid collection-grid`;let t=document.createElement(`p`);t.className=`collection-grid-empty muted`,t.textContent=n?`No spells match your filters. Try “All types”, clear search, or uncheck Owned only.`:`No cards match your filters. Open chests in the Shop to get more spells.`,e.appendChild(t);return}let a=0,o={deckEdit:n,statusEl:r};if(n||Fs!==`all`){e.className=`deck-editor__grid collection-grid`;for(let t of i)try{ul(e,t,o),a+=1}catch(e){console.error(`Failed to render card:`,t?.id,e)}}else{e.className=`deck-editor__grid collection-categories`;let t=Object.fromEntries(it.map(e=>[e,[]]));for(let e of i)t[st(e)].push(e);for(let n of it){let r=t[n];if(!r.length)continue;let i=document.createElement(`section`);i.className=`collection-category-section`,i.dataset.category=n;let s=document.createElement(`h3`);s.className=`collection-category-title`,s.textContent=at[n],i.appendChild(s);let c=document.createElement(`div`);c.className=`collection-grid deck-editor__grid-cards`;for(let e of r)try{ul(c,e,o),a+=1}catch(t){console.error(`Failed to render card:`,e?.id,t)}i.appendChild(c),e.appendChild(i)}}if(i.length>0&&a===0){e.className=`deck-editor__grid collection-grid`;let t=document.createElement(`p`);t.className=`collection-grid-empty collection-grid-empty--error`,t.textContent=`Spells failed to display. Hard refresh the page (Ctrl+Shift+R).`,e.appendChild(t)}}function fl(){Ms={name:X(`deck-name-input`)?.value?.trim()??``,cardIds:[...q]}}function pl(){return Ms?(X(`deck-name-input`)?.value?.trim()??``)!==Ms.name||q.length!==Ms.cardIds.length?!0:q.some((e,t)=>e!==Ms.cardIds[t]):!1}async function ml(){return pl()?Qe(`Discard unsaved changes to this deck?`,{title:`Unsaved changes`,confirmLabel:`Discard`,cancelLabel:`Keep editing`,destructive:!0}):!0}function hl(){K=null,q=[],Ms=null}function gl(e){let t=W.decks.find(t=>t.id===e);if(!t)return;K=t.id,q=[...t.cardIds];let n=X(`deck-name-input`);n&&(n.value=t.name),Yc(`edit`),Cs(`deck-edit-opened`,{deckId:e})}function _l(e){let t=Object.fromEntries(it.map(e=>[e,0]));for(let r of e){let e=n(r);e&&(t[st(e)]+=1)}return t}function vl(e){let t=_l(e),n=[];for(let e of it){let r=t[e];if(r<=0)continue;let i=at[e];n.push(`<span class="deck-row__cat" title="${za(i)}: ${r}"><span class="deck-row__cat-dot deck-row__cat-dot--${e}" aria-hidden="true"></span><span class="deck-row__cat-n">${r}</span></span>`)}return n.length?`<div class="deck-row__cats">${n.join(``)}</div>`:``}function yl(){w(W)&&T(W),$();let e=X(`deck-list`);if(!e)return;e.innerHTML=``;let t=X(`deck-list-count`);if(t){let e=W.decks.length;t.textContent=e?`${e} deck${e===1?``:`s`}`:``}if(!W.decks.length){if(w(W)&&T(W),W.decks.length){yl();return}e.innerHTML=`
      ...
      </div>`;return}for(let t of W.decks){let n=a(t.cardIds,W).valid,r=Math.min(100,Math.round(t.cardIds.length/30*100)),i=document.createElement(`button`);i.type=`button`,i.className=`deck-row deck-row--open${n?` deck-row--ready`:``}`,i.innerHTML=`
    ...
    `,i.addEventListener(`click`,()=>gl(t.id)),e.appendChild(i)}}function bl(){$();let e=X(`collection-grid`),t=X(`deck-slots`),n=X(`deck-status`),r=X(`edit-deck-heading`),i=X(`deck-count-badge`),o=X(`deck-progress-bar`);if(!e||!t)return;let s=X(`btn-delete-deck`);s&&(s.hidden=!(K&&K!==`new`&&K!==`deck-starter`)),r&&(r.textContent=K===`new`?`New deck`:`In your deck`);let c=a(q,W),l=`${q.length}/30`;i&&(i.textContent=l,i.classList.toggle(`deck-editor__count--ready`,c.valid));let u=X(`deck-progress-fill`),d=Math.min(100,q.length/30*100);u&&(u.style.width=`${d}%`),o&&(o.hidden=c.valid,c.valid||(o.setAttribute(`aria-valuenow`,String(q.length)),o.setAttribute(`aria-valuemax`,`30`))),n&&(c.valid?(n.textContent=``,n.hidden=!0,n.className=`deck-editor__error deck-status ok`):(n.hidden=!1,n.textContent=c.errors[0]||`${l} — keep adding spells`,n.className=`deck-editor__error deck-status warn`));let f=X(`deck-collection-hint`);f&&(f.hidden=!1,f.innerHTML=q.length>=30?`Deck is full. Remove a card from the strip above, or save when ready.`:`Tap <strong>+ Add to deck</strong> for copies you own. When all owned copies are in the deck, tap <strong>Add for X gems</strong> to buy another.`),dl(e,{deckEdit:!0,statusEl:n}),t.innerHTML=``;let p=rc(q);if(!p.length){let e=document.createElement(`p`);e.className=`deck-editor__strip-empty`,e.textContent=`Empty deck — tap + Add to deck below`,t.appendChild(e)}for(let{def:e,count:n}of p){let r=document.createElement(`div`);r.className=`deck-slot-wrap deck-slot-wrap--strip`;let i=Ra(e,{button:!0,tiny:!0,onClick:()=>{Wa(e,{meta:n>1?`${n} copies in deck`:`In your deck`,onRemove:()=>ac(e.id)})}});if(r.appendChild(i),n>1){let e=document.createElement(`span`);e.className=`deck-stack-count`,e.textContent=`×${n}`,r.appendChild(e)}let a=document.createElement(`button`);a.type=`button`,a.className=`deck-slot-remove deck-slot-remove--visible`,a.setAttribute(`aria-label`,`Remove one ${e.name} from deck`),a.textContent=`−`,a.addEventListener(`click`,t=>{t.stopPropagation(),ic(e.id)}),r.appendChild(a),t.appendChild(r)}}function xl(){let e=X(`deck-name-input`)?.value?.trim()||`My Deck`,t=a(q,W);if(!t.valid){X(`deck-status`).textContent=t.errors.join(` `);return}let n;K&&K!==`new`?(n=W.decks.find(e=>e.id===K),n?(n.name=e,n.cardIds=[...q],n.updatedAt=Date.now()):n=y(e,q)):n=y(e,q),ne(W,n),W.selectedDeckId=n.id,T(W),Cs(`deck-saved`,{deckId:n.id}),hl(),Yc(`list`)}function Sl(e=[]){let t=`New Deck`,n=new Set(e.map(e=>e.name?.trim()).filter(Boolean));if(!n.has(t))return t;let r=2;for(;n.has(`${t} ${r}`);)r++;return`${t} ${r}`}function Cl(){K=`new`,q=[];let e=X(`deck-name-input`);e&&(e.value=Sl(W.decks)),Yc(`edit`)}function wl(){dc(),$s=null}function Tl(){W.adventure=s(W.adventure),X(`adventure-map-view`)?.classList.remove(`hidden`),wl(),tc=null,jl()}function El(e){let t=x[e]||x.verdant,n=`map-${e}`;return`<svg class="adventure-map-scenery-svg" viewBox="0 0 100 120" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
    <defs>
  ...
  </svg>`}function Ol(e){let t=x[e]||x.verdant;return`<svg class="adventure-map-tile__banner-svg" viewBox="0 0 24 20" aria-hidden="true">
    <defs>
    ...
    <div class="adventure-map-tower">
      ...
      <span class="adventure-map-tile__stone" aria-hidden="true">
        ...
        ${a>0?`<span class="adventure-floor-row__stars">${C(a)}</span>`:``}`,o.addEventListener(`click`,()=>zl(t.id)),y.appendChild(o)}}let b=r.querySelector(`.adventure-map-tile--next`);kl(r),b&&requestAnimationFrame(()=>{requestAnimationFrame(()=>b.scrollIntoView({behavior:`smooth`,block:`nearest`}))});let S=y?.querySelector(`.adventure-floor-row--next`);S&&requestAnimationFrame(()=>S.scrollIntoView({behavior:`smooth`,block:`end`})),r.querySelector(`.adventure-challenge-toggle`)?.addEventListener(`click`,t=>{t.preventDefault(),t.stopPropagation(),e.challengeMode=!e.challengeMode,W.adventure=e,T(W),zo(),To.tap(),jl()})}function Ml(e){let t=ue(e);if(!t||!_(W.adventure,e))return;$s=e,uc();let n=X(`prebattle-title`),r=X(`prebattle-flavor`),i=X(`prebattle-opponent`);n&&(n.textContent=`Tower ${t.worldId} · Floor ${t.floorInWorld}`),r&&(r.textContent=t.flavor||``),i&&(i.textContent=`Loading…`);try{tc=be(W,e),T(W)}catch(e){console.error(`Enemy deck failed`,e),i&&(i.textContent=`Could not build enemy deck. Try again.`);return}i&&(i.textContent=`Review the enemy spell deck, then choose your grimoire below.`);let o=X(`prebattle-gem-hint`);if(o){let n=te(W.adventure,e);o.textContent=(xe(W.adventure,e)?`Repeat clear: +${n} gems`:`First clear: +${n} gems`)+(t.worldId===5&&Se(W.adventure)?` · Challenge mode: enemy has an extra rank of pieces`:``)}let s=X(`enemy-deck-preview`);if(s){s.innerHTML=``;try{for(let{def:e,count:t}of me(tc)){if(!e)continue;let n=document.createElement(`button`);n.type=`button`,n.className=`enemy-deck-spell-btn`,n.title=`View ${e.name}`;let r=document.createElement(`span`);if(r.className=`enemy-deck-spell-btn__name`,r.textContent=e.name,n.appendChild(r),t>1){let e=document.createElement(`span`);e.className=`enemy-deck-spell-btn__count`,e.textContent=`×${t}`,n.appendChild(e)}n.addEventListener(`click`,()=>Wa(e,{meta:t>1?`${t} copies in enemy deck`:`Enemy deck`})),s.appendChild(n)}}catch(e){console.error(`Enemy preview failed`,e),s.innerHTML=`<p class="empty-msg">Enemy deck preview unavailable.</p>`}}w(W)&&T(W);let c=vr(`adventure-deck-select`);if(!c){i&&(i.textContent=`Deck selector missing — hard refresh the page.`);return}c.innerHTML=``;let l=W.decks.filter(e=>a(e.cardIds,W).valid);if(!l.length){let e=document.createElement(`option`);e.value=``,e.textContent=`No complete decks — build one in Decks`,c.appendChild(e),c.disabled=!0,X(`btn-start-adventure`).disabled=!0;return}c.disabled=!1;let u=W.selectedDeckId&&l.some(e=>e.id===W.selectedDeckId)?W.selectedDeckId:l[0].id;for(let e of l){let t=document.createElement(`option`);t.value=e.id,t.textContent=e.name,e.id===u&&(t.selected=!0),c.appendChild(t)}W.selectedDeckId=u,X(`btn-start-adventure`).disabled=!1}async function Nl(e,t,n,r,i=null,a=!1,o=void 0){let s=t.opponent;wl(),tc=null,document.querySelectorAll(`.view`).forEach(e=>e.classList.add(`hidden`)),X(`view-match`)?.classList.remove(`hidden`);let c=X(`view-match`);if(!c)return;let{MatchSession:u,getMatchHtml:d}=await as();c.innerHTML=d(s);let p=o??(Ce(r).id===5&&Se(W.adventure)),m={levelId:r,deckId:e.id,challengeMode:p},h={aiDeckIds:n,opponentName:s,cosmetics:f(W),profile:W,challengeMode:p,buildGameOverActions:({won:e,isTie:t})=>Fl(m,{won:e,isTie:t}),onGameOverAction:e=>{Il(e,m,c)}};i&&(h.initialState=i);try{J=new u(e.cardIds,c,()=>{J=null,dr(),ko(),xo(`hub`),c.innerHTML=``,X(`view-match`)?.classList.add(`hidden`),Z(nr()||`play`),Ys&&Vl(),Xs&&Hl()},e=>{let t=se(W,r,e),{gems:n,stars:i,starsGained:a}=t;return W.gems+=n,fe(W,`adventure_floors`,1),l(W),T(W),$(),vc(),r===1&&t.firstTime&&(Ys=!0,Vl()),r===5&&t.firstTime&&(Xs=!0),{message:`+${n} gems! · Best: ${C(i)}`,starsGained:a}},h)}catch(e){throw J=null,c.innerHTML=``,X(`view-match`)?.classList.add(`hidden`),Z(`play`),e}lr({kind:`adventure`,deckId:e.id,deckCardIds:e.cardIds,aiDeckIds:n,opponentName:s,levelId:r,challengeMode:p}),await ko(),xo(`match`),a&&(J.winRewarded=!0),fr(J),J.setMessage(``),J.render()}async function Pl(){let e=pr();if(!e)return!1;let t=W.decks.find(t=>t.id===e.deckId)||W.decks.find(e=>e.cardIds?.length===30),n=e.levelId?ue(e.levelId):null;return!t||t.cardIds.length!==30||!n||!e.aiDeckIds?.length||!await Qe(`Resume your adventure match where you left off?`,{title:`Resume match?`,confirmLabel:`Resume`,cancelLabel:`Discard`})?(ur(),!1):($s=e.levelId,await Nl(t,n,e.aiDeckIds,e.levelId,e.state,e.winRewarded,e.challengeMode),J?.setMessage(`Match resumed — pick up where you left off.`),!0)}function Fl({levelId:e},{won:t,isTie:n}){let r=e+1,i=t&&r<=50&&_(W.adventure,r);if(n)return[{id:`backToAdventure`,label:`Back to Adventure`,primary:!0}];if(t){let e=[];return i?(e.push({id:`nextFloor`,label:`Next floor`,primary:!0}),e.push({id:`retry`,label:`Retry floor`}),e.push({id:`backToAdventure`,label:`Back to Adventure`})):(e.push({id:`backToAdventure`,label:`Back to Adventure`,primary:!0}),e.push({id:`retry`,label:`Retry floor`})),e}return[{id:`retry`,label:`Retry floor`,primary:!0},{id:`backToAdventure`,label:`Back to Adventure`}]}async function Il(e,{levelId:t,deckId:n,challengeMode:r},i){let a=W.decks.find(e=>e.id===n);if(e===`backToAdventure`){J?.onExit?.();return}if(e===`nextFloor`){let e=t+1;if(!ue(e)||!_(W.adventure,e)){J?.onExit?.();return}J?.dispose(),J=null,dr({clearCheckpoint:!0}),ko(),xo(`hub`),i&&(i.innerHTML=``),X(`view-match`)?.classList.add(`hidden`),await Z(`play`),Ml(e);return}if(e===`retry`){let e=t,n=ue(e);if(!a||a.cardIds.length!==30||!n){J?.onExit?.();return}J?.dispose(),J=null,dr(),await Nl(a,n,be(W,e),e,null,!1,r)}}function Ll(){let e=vr(`adventure-deck-select`)?.value,t=W.decks.find(t=>t.id===e),n=$s,r=n?ue(n):null,i=tc?[...tc]:null;if(!t||t.cardIds.length!==30||!r||!i?.length){let e=X(`prebattle-opponent`);e&&(!t||t.cardIds.length!==30?e.textContent=`Build a complete 30-card deck in the Decks tab, then try again.`:e.textContent=`Could not start battle — close and pick the floor again.`);return}Nl(t,r,i,n)}function Rl(){if(window.__adventureMapCaptureBound)return;window.__adventureMapCaptureBound=!0;let e=null,t=!1,n=0,r=e=>e.closest?.(`#adventure-map .adventure-map-tile, #adventure-map .adventure-map-pin`),i=e=>e?.closest?.(`.adventure-map-scene`),a=()=>{t=!0,clearTimeout(n),n=setTimeout(()=>{t=!1},280)},o=(e,t)=>{if(!e||e.disabled)return;let n=Number(e.dataset.level);!Number.isFinite(n)||n<1||(t.preventDefault(),t.stopPropagation(),zl(n))};document.addEventListener(`pointerdown`,t=>{if(t.button!==0)return;let n=r(t.target);if(!n||n.disabled)return;let a=i(n);e={pin:n,pointerId:t.pointerId,startX:t.clientX,startY:t.clientY,scrollTop:a?.scrollTop??0,scrollLeft:a?.scrollLeft??0,cancelled:!1}},!0),document.addEventListener(`pointermove`,t=>{if(!e||t.pointerId!==e.pointerId||e.cancelled)return;let n=t.clientX-e.startX,r=t.clientY-e.startY;Math.hypot(n,r)>12&&(e.cancelled=!0);let a=i(e.pin);a&&(Math.abs(a.scrollTop-e.scrollTop)>3&&(e.cancelled=!0),Math.abs(a.scrollLeft-e.scrollLeft)>3&&(e.cancelled=!0))},!0),document.addEventListener(`pointerup`,t=>{if(!e||t.pointerId!==e.pointerId)return;let{pin:n,cancelled:r}=e;if(e=null,r){a();return}o(n,t),a()},!0),document.addEventListener(`pointercancel`,t=>{!e||t.pointerId!==e.pointerId||(e=null,a())},!0),document.addEventListener(`click`,e=>{if(t){e.preventDefault(),e.stopPropagation();return}let n=r(e.target);!n||n.disabled||o(n,e)},!0)}function zl(e){let t=s(W.adventure);if(W.adventure=t,!_(t,e)){fc(`Locked — beat global floor ${e-1} first, then return here.`,`Floor locked`);return}T(W),Ml(e)}function Bl(){cc(),window.addEventListener(`orientationchange`,cc),window.addEventListener(`resize`,cc),pc(),so(),to(),Po(),Co(),Ao(),Fo(),Ga(),Rl(),sc(),document.querySelector(`.adventure-map-scene`)?.addEventListener(`scroll`,Al,{passive:!0});let e;window.addEventListener(`resize`,()=>{clearTimeout(e),e=setTimeout(()=>{if(!document.body.classList.contains(`adventure-active`))return;let e=X(`adventure-map`);e&&kl(e)},120)}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&wl()}),document.querySelectorAll(`.tab-btn`).forEach(e=>{e.addEventListener(`click`,()=>{zo(),To.tap(),Z(e.dataset.tab)})}),document.querySelectorAll(`.play-tab`).forEach(e=>{e.addEventListener(`click`,()=>{if(sr(),G!==`play`){Os=e.dataset.playTab,Z(`play`);return}gc(e.dataset.playTab)})}),document.querySelectorAll(`.play-sub-back`).forEach(e=>{e.addEventListener(`click`,()=>{zo(),To.tap(),hc()})}),document.querySelectorAll(`.vault-tab`).forEach(e=>{e.addEventListener(`click`,()=>{sr(),rl(e.dataset.vaultTab)})}),X(`btn-new-deck`)?.addEventListener(`click`,Cl),X(`btn-back-from-edit`)?.addEventListener(`click`,async()=>{await ml()&&(hl(),Yc(`list`))}),X(`btn-delete-deck`)?.addEventListener(`click`,async()=>{if(!K||K===`new`)return;let e=W.decks.find(e=>e.id===K);e&&await Qe(`Delete "${e.name}"? This cannot be undone.`,{title:`Delete deck?`,confirmLabel:`Delete`,cancelLabel:`Keep`,destructive:!0})&&(de(W,e.id),hl(),Yc(`list`))});let t=()=>{js===`edit`&&bl(),js===`list`&&yl()};document.querySelectorAll(`.collection-owned-only-toggle`).forEach(e=>{e.addEventListener(`change`,e=>{Is=e.target.checked,Ic(),t()})}),document.querySelectorAll(`.btn-reset-collection-filters`).forEach(e=>{e.addEventListener(`click`,()=>{Ps=`all`,Ns=``,Fs=`all`,Is=!0,Ic(),t()})}),Ic(),yr(),X(`collection-search`)?.addEventListener(`input`,e=>{Ns=e.target.value,t()}),vr(`collection-category`)?.addEventListener(`change`,e=>{Fs=e.target.value,t()}),vr(`collection-rarity`)?.addEventListener(`change`,e=>{Ps=e.target.value,t()}),X(`btn-clear-deck`)?.addEventListener(`click`,()=>{q=[],bl()}),X(`btn-auto-finish-deck`)?.addEventListener(`click`,oc),X(`btn-save-deck`)?.addEventListener(`click`,xl),X(`btn-back-adventure`)?.addEventListener(`click`,wl),X(`adventure-floor-backdrop`)?.addEventListener(`click`,wl),X(`btn-start-adventure`)?.addEventListener(`click`,Ll),vr(`adventure-deck-select`)?.addEventListener(`change`,e=>{W.selectedDeckId=e.target.value,T(W)});let n=document.getElementById(`auth-modal`),r=document.getElementById(`auth-header-btn`);xc(),Kn(`play-help-btn`,`play-help-desc`),Kn(`adventure-help-btn`,`adventure-help-desc`),Kn(`shop-help-btn`,`shop-help-desc`),Kn(`deck-help-btn`,`deck-help-desc`),Gs=pn({onSignIn:()=>Ks?.open(`signin`,{forced:!0}),onSignUp:()=>Ks?.open(`signup`,{forced:!0}),onGuest:()=>{en(),Jl()}}),Ks=dn({authBtn:r,modal:n,onNewAccount:()=>{W=ge()?pe():E(),En(W,T)},onSignedIn:()=>{tn(),W=E(),w(W),Tn(W),$(),yl(),nl(),Gs?.hide(),Sc().then(()=>{G===`profile`&&wc(),G===`quests`&&Pc(),G===`play`&&Us().then(e=>e?.render({resume:!0})),G===`social`&&Ws().then(e=>e?.refresh?.()??e?.render())}),Us().then(e=>e?.render({resume:!0})),Kl(),ql(),Gl(),Wl(),Y||Z(G)},onSignedOut:()=>{tn(),bc(),Q=``,yc(),zs?.dispose?.(),J=null,dr({clearCheckpoint:!0}),sr(),W=pe(),vc(),$(),yl(),nl(),Gs?.show(),Z(`deck`)}}),mr(()=>J),w(W),Ic(),vc(),Yl()}function Vl(){if(!Ys||Zs!=null)return;let e=0,t=()=>{if(Zs=null,e+=1,Ys){if(er()){e<10&&(Zs=window.setTimeout(t,400));return}if(Tn(W),Gl()){Ys=!1;return}e<10&&(Zs=window.setTimeout(t,500))}};Zs=window.setTimeout(t,350)}function Hl(){if(!Xs||Qs!=null)return;let e=0,t=()=>{if(Qs=null,e+=1,Xs){if(er()){e<10&&(Qs=window.setTimeout(t,400));return}if(Tn(W),Wl()){Xs=!1;return}e<10&&(Qs=window.setTimeout(t,500))}};Qs=window.setTimeout(t,350)}function Ul(){return Y||!fn()||!d(W)||!Pn(W)?!1:(Y=!0,Z(`play`),bs().then(({startPvpTutorial:e})=>{e({profile:W,saveProfile:T,onComplete:()=>{Y=!1,W=E(),w(W),vc(),Z(`play`),Wl()}})}),!0)}function Wl(){return Y||!fn()||!c(W)||kn(W)||An(W)||Nn(W)||Pn(W)||!In(W)?!1:(Y=!0,Z(`play`),bs().then(({startCosmeticsTutorial:e})=>{e({profile:W,saveProfile:T,onComplete:()=>{Y=!1,W=E(),w(W),vc(),Z(`play`)}})}),!0)}function Gl(){return Y||!fn()||!d(W)?!1:(Tn(W),Nn(W)?(Y=!0,Z(`play`),bs().then(({startQuestsTutorial:e})=>{e({profile:W,saveProfile:T,onComplete:()=>{Y=!1,W=E(),w(W),vc(),Ul(),Wl()}})}),!0):Ul())}function Kl(){return Y||!fn()||!kn(W)?!1:(Y=!0,Ss().then(({startInteractiveTutorial:e})=>{e({profile:W,saveProfile:T,onComplete:()=>{Y=!1,W=E(),w(W),$(),yl(),nl(),ql()||Z(`deck`),Gl(),Wl()}})}),!0)}function ql(){return Y||!fn()||!An(W)?!1:(Y=!0,Z(`deck`),vs().then(({startMetaTutorial:e})=>{e({profile:W,saveProfile:T,onComplete:()=>{Y=!1,W=E(),w(W),$(),yl(),nl(),Z(`deck`),Gl(),Wl()}})}),!0)}async function Jl(){Gs?.hide(),!Kl()&&(ql()||Gl()||Wl()||Y||(await Pl()||await Z(`deck`),sr(),xo(`hub`)))}async function Yl(){try{if(await Fe()){try{let e=await cn();e&&(W=e)}catch(e){console.warn(`Cloud sync on load failed`,e)}w(W),$(),yl(),nl()}}catch(e){console.warn(`Auth init failed`,e)}if(Tn(W),await Sc(),zs&&G===`play`&&(Ds===`arena`||Ds===`leaderboard`)&&zs.render(),sr(),mn()){Gs?.show();return}await Jl()}Bl(),D(async()=>{let{registerSW:e}=await import(`./virtual_pwa-register-CpSsV7JG.js`);return{registerSW:e}},[],import.meta.url).then(({registerSW:e})=>{e({immediate:!0})}),$e(),rt();export{er as A,nn as B,_r as C,nr as D,ar as E,Dn as F,St as G,Zt as H,On as I,Ke as J,ht as K,Mn as L,fr as M,Kn as N,lr as O,Fn as P,jn as R,Sr as S,rr as T,Rt as U,Xt as V,gt as W,oo as _,Jo as a,Wa as b,Yo as c,Qo as d,es as f,U as g,xo as h,Bo as i,sr as j,dr as k,Xo as l,So as m,ns as n,Wo as o,ko as p,Qe as q,rs as r,Go as s,as as t,Ko as u,Xa as v,ur as w,Ra as x,Ka as y,Ln as z};