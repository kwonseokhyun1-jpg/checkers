import{$ as e,C as t,F as n,I as r,O as i,P as a,Q as o,T as s,U as c,W as l,Z as u,_ as d,b as f,et as p,it as m,m as h,nt as g,ot as _,q as v,rt as y,tt as b,v as x,w as S,x as C,y as w}from"./storage-Dd_qaSWq.js";import{a as T,c as E,d as D,l as O,o as k,t as A,u as j}from"./mageTitles-BPvsmJqw.js";import{a as ee,c as te,o as ne}from"./auth-DXSr7Yp4.js";import{W as re,c as M,i as N,l as P,n as F,o as I,r as L,s as R,t as z,u as B}from"./index-D3KN74Ok.js";import{playCosmeticOpenAnimation as V}from"./cosmeticOpenAnimation-DFZbarZn.js";import{notifyUnlockTutorial as H}from"./tutorialUnlocks-6Y6dBNCO.js";var U=null;function W(){U!=null&&(clearInterval(U),U=null)}function G(e){if(!e)return;W();let t=()=>{e.textContent=`Resets in: ${b(m())}`};t(),U=setInterval(t,1e3)}function K(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}var q={common:`rarity-common`,uncommon:`rarity-uncommon`,rare:`rarity-rare`,epic:`rarity-epic`,legendary:`rarity-legendary`};function J(e){if(e===`pieceSkin`)return`Piece skins`;if(e===`frame`)return`Frames`;let t=R(e);return t.endsWith(`s`)?t:`${t}s`}function Y(e){let t=E(e);return t?D(t):``}var ie={pvp:`<svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
