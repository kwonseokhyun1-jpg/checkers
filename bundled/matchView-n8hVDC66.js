import{c as e}from"./board-DhzwZmXz.js";function t(t=`Opponent`,n={}){let r=String(t).replace(/</g,``),i=n.exitLabel||`← Leave match`,a=!!n.spectator,o=a?String(n.localName||`Red`).replace(/</g,``):`You`,s=a?` match-wrap--spectator`:``,c=a?`<p class="hand-hidden-note">Hands hidden in spectate mode</p>`:``;return`
