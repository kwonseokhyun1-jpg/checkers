...
import{n as e,o as t,t as n}from"./cardCatalog-AYo7Vx9E.js";import{d as r,i,r as a}from"./deckRules-t-dVXs5T.js";import{A as o,At as s,Ct as c,D as l,Dt as u,Et as d,G as f,H as p,Ot as m,P as h,St as ee,Tt as g,_t as _,a as v,bt as te,c as y,ct as b,d as x,dt as S,f as C,ft as ne,g as re,gt as ie,ht as ae,i as oe,j as se,kt as ce,l as le,lt as ue,m as w,mt as de,o as fe,ot as pe,p as me,pt as he,r as ge,s as _e,st as ve,t as ye,u as T,ut as be,vt as xe,wt as Se,xt as Ce,yt as we,z as Te}from"./storage-IAeLD73r.js";import{l as Ee,p as De,r as Oe}from"./mageTitles-BPvsmJqw.js";import{t as E}from"./preload-helper-CV77j2BA.js";import{S as ke,a as Ae,c as je,d as Me,g as Ne,h as Pe,l as Fe,o as D,p as Ie,s as Le,t as Re,v as ze,x as Be}from"./auth-DlZTxNmp.js";var Ve=Object.defineProperty,He=(e,t)=>{let n={};for(var r in e)Ve(n,r,{get:e[r],enumerable:!0});return t||Ve(n,Symbol.toStringTag,{value:`Module`}),n};function Ue(){let e=window.visualViewport;return e?Math.max(0,Math.round(e.offsetTop)):0}function We(){let e=window.visualViewport;return e?Math.max(0,Math.round(window.innerHeight-e.offsetTop-e.height)):0}function Ge(){let e=document.documentElement,t=()=>{e.style.setProperty(`--viewport-inset-top`,`${Ue()}px`),e.style.setProperty(`--viewport-inset-bottom`,`${We()}px`)};t(),window.visualViewport?.addEventListener(`resize`,t),window.visualViewport?.addEventListener(`scroll`,t),window.addEventListener(`resize`,t),window.addEventListener(`orientationchange`,t)}Ge();var Ke=1100,qe=120;function Je(){let e=document.getElementById(`app-splash`);if(!e||e.classList.contains(`app-splash--hide`))return;e.classList.add(`app-splash--hide`),document.body.classList.remove(`splash-active`);let t=()=>{e.remove()};e.addEventListener(`transitionend`,t,{once:!0}),window.setTimeout(t,600)}function Ye(){Je()}function Xe(){let e=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches?qe:Ke,t=performance.now(),n=()=>{let n=performance.now()-t,r=Math.max(0,e-n);window.setTimeout(Je,r)};document.readyState===`interactive`||document.readyState===`complete`?n():document.addEventListener(`DOMContentLoaded`,n,{once:!0})}document.body.classList.add(`splash-active`),Xe();var Ze=`(max-width: 768px)`,Qe=null;function $e(){return document.getElementById(`mobile-confirm`)}function et(e){let t=$e();if(!t)return;t.classList.add(`hidden`),document.body.classList.remove(`mobile-confirm-open`);let n=Qe;Qe=null,n?.(e)}function tt(e,t={}){if(!window.matchMedia(Ze).matches)return Promise.resolve(window.confirm(e));let n=$e();if(!n)return Promise.resolve(window.confirm(e));let{title:r=`Confirm`,confirmLabel:i=`OK`,cancelLabel:a=`Cancel`,destructive:o=!1}=t;return new Promise(t=>{Qe&&et(!1),Qe=t,n.querySelector(`#mobile-confirm-title`).textContent=r,n.querySelector(`#mobile-confirm-body`).textContent=e;let s=n.querySelector(`#mobile-confirm-ok`),c=n.querySelector(`#mobile-confirm-cancel`);s.textContent=i,c.textContent=a,s.classList.toggle(`btn-danger`,o),s.classList.toggle(`btn-primary`,!o),n.classList.remove(`hidden`),document.body.classList.add(`mobile-confirm-open`),c.focus()})}function nt(){let e=$e();!e||e.dataset.bound||(e.dataset.bound=`1`,e.querySelector(`#mobile-confirm-ok`)?.addEventListener(`click`,()=>et(!0)),e.querySelector(`#mobile-confirm-cancel`)?.addEventListener(`click`,()=>et(!1)),e.querySelector(`[data-mobile-confirm-backdrop]`)?.addEventListener(`click`,()=>et(!1)))}var rt=`cc_install_banner_dismissed`;function it(){return window.matchMedia(`(display-mode: standalone)`).matches||window.navigator.standalone===!0}function at(){let e=window.navigator.userAgent;return/iphone|ipad|ipod/i.test(e)&&!/crios|fxios/i.test(e)}function ot(){if(it()||localStorage.getItem(rt)===`1`)return;let e=document.getElementById(`install-banner`);if(!e)return;let t=null,n=()=>{e.classList.remove(`hidden`),document.body.classList.add(`install-banner-visible`)},r=()=>{e.classList.add(`hidden`),document.body.classList.remove(`install-banner-visible`)};window.addEventListener(`beforeinstallprompt`,r=>{r.preventDefault(),t=r,e.querySelector(`#install-banner-ios-hint`)?.classList.add(`hidden`),e.querySelector(`.install-banner__hint--default`)?.classList.remove(`hidden`),e.querySelector(`#install-banner-btn`)?.classList.remove(`hidden`),n()}),at()&&(e.querySelector(`#install-banner-ios-hint`)?.classList.remove(`hidden`),e.querySelector(`.install-banner__hint--default`)?.classList.add(`hidden`),e.querySelector(`#install-banner-btn`)?.classList.add(`hidden`),window.setTimeout(n,2500)),e.querySelector(`#install-banner-btn`)?.addEventListener(`click`,async()=>{t&&(t.prompt(),await t.userChoice,t=null,r())}),e.querySelector(`#install-banner-dismiss`)?.addEventListener(`click`,()=>{localStorage.setItem(rt,`1`),r()})}var st=[`attack`,`control`,`defense`,`movement`,`trap`,`special`],ct={attack:`Attack`,control:`Control`,defense:`Defense`,movement:`Movement`,trap:`Trap`,special:`Special`},lt={aegis:`defense`,anchor:`defense`,backpedal:`control`,backstab:`attack`,backstep:`movement`,barrier:`defense`,bishops_mark:`movement`,blind:`control`,blizzard:`control`,snowball:`control`,berserk:`movement`,bomb:`attack`,shockwave:`control`,plague:`control`,bulwark:`defense`,create_foe:`special`,call_forward:`movement`,chain_lightning:`attack`,clone:`special`,coin_flip:`attack`,collapse:`special`,confusion:`control`,constitution:`defense`,counterspell:`trap`,crown:`special`,cryo_bolt:`attack`,cull:`attack`,darkness:`defense`,dash:`movement`,deep_freeze:`control`,deflect:`trap`,demote:`control`,deport:`movement`,displacement:`movement`,dominion:`special`,duel:`attack`,earthquake:`special`,execution:`attack`,extract:`control`,pyromancy:`attack`,fusion:`special`,hibernation:`special`,hostile_swap:`movement`,ignore:`special`,iron_will:`defense`,landmine:`trap`,last_king:`special`,bounty:`special`,link_fate:`special`,last_stand:`trap`,martyr:`trap`,leapfrog:`movement`,long_step:`movement`,magnet:`movement`,nudge:`movement`,offering:`special`,panic:`control`,poison:`attack`,mind_control:`special`,mulligan:`special`,zombify:`special`,press:`control`,purify:`special`,quick_march:`movement`,quicksand:`trap`,rally:`defense`,recall:`movement`,repel:`movement`,random_teleport:`movement`,retreat:`movement`,revive:`defense`,rooks_mark:`movement`,root:`control`,sacrifice:`attack`,sanctuary:`defense`,scatter:`movement`,shadow_swap:`movement`,sidestep:`movement`,shatter:`attack`,snipe:`attack`,snowball:`control`,stab:`attack`,stall:`defense`,tangle:`control`,teleport:`movement`,trickster:`special`,toll:`special`,vengeance:`trap`,ward:`defense`};function ut(e){let t=lt[e?.id];if(t)return t;let n=`${e?.id||``} ${e?.effect||``} ${e?.name||``} ${e?.desc||``}`.toLowerCase();return/trap|mine|quicksand|counterspell|vengeance|last.?stand|martyr/.test(n)?`trap`:/shield|ward|aegis|sanctuary|barrier|anchor|deflect|stall|iron_will|rally|darkness/.test(n)?`defense`:/move|nudge|teleport|recall|leap|step|displace|swap|scatter|retreat|bishop|rook|overrun|promote|pull|push|shift|earthquake|magnet|repel/.test(n)?`movement`:/freeze|blind|confusion|hex|root|panic|press|silence|paraly|control|cannot play|random|mark|poison|die in \d+ turn/.test(n)?`control`:/\bdestroy\b|\bkills?\b|fireball|bolt|stab|snipe|duel|sacrifice|execution|shatter|cull|lightning/.test(n)?`attack`:`special`}var dt=[{id:`bronze`,name:`Bronze Chest`,cost:25,cards:3,weights:{common:70,uncommon:25,rare:5,epic:0}},{id:`silver`,name:`Silver Chest`,cost:50,cards:5,weights:{common:50,uncommon:35,rare:12,epic:3}},{id:`gold`,name:`Gold Chest`,cost:100,cards:8,weights:{common:32,uncommon:38,rare:22,epic:6,legendary:2}}];function ft(e){let t=Math.random()*100,n=0;for(let r of[`common`,`uncommon`,`rare`,`epic`,`legendary`])if(n+=e[r]||0,t<=n)return r;return`common`}function pt(t){let n=e().filter(e=>e.rarity===t);return n.length?n[Math.floor(Math.random()*n.length)]:e()[0]}function mt(e,t){return pt(ft(t.weights))}function ht(e,n,r={}){let{starRefundChance:i=0}=r;if(oe(e,n.id)<t(n))return ye(e,n.id,1),{...n,duplicate:!1};let a=Te[n.rarity]||10;if(i>0&&Math.random()<i){let e=Math.random()<.5?1:2;return{...n,duplicate:!0,starRefund:e}}return{...n,duplicate:!0,gemRefund:a}}function gt(e,t){let n=dt.find(e=>e.id===t);if(!n)return{success:!1,message:`Unknown chest.`};if(e.gems<n.cost)return{success:!1,message:`Not enough gems.`};e.gems-=n.cost;let r=[],i=0;for(let t=0;t<n.cards;t++){let t=ht(e,mt(e,n));r.push(t),t.gemRefund&&(i+=t.gemRefund)}return i&&(e.gems+=i),pe(e,`boxes_opened`,1),w(e),{success:!0,pulls:r,chest:n,bonusGems:i}}var _t=[`common`,`uncommon`,`rare`,`epic`,`legendary`];function vt(e,{minPct:t=1}={}){return _t.filter(n=>(e[n]??0)>=t).map(t=>`${e[t]}% ${t}`).join(` · `)}var yt={bronze:{label:`Bronze`,tagline:`Mostly common cards`,accent:`#cd7f32`,glow:`rgba(205, 127, 50, 0.45)`},silver:{label:`Silver`,tagline:`Balanced card mix`,accent:`#a8b8d8`,glow:`rgba(168, 184, 216, 0.5)`},gold:{label:`Gold`,tagline:`Higher rare & epic odds`,accent:`#e8c547`,glow:`rgba(232, 197, 71, 0.55)`}};function bt(e){let t=yt[e]||yt.bronze;return{t,lid:e===`gold`?`#f5e6a8`:e===`silver`?`#e8eef8`:`#d4954a`,body:e===`gold`?`#7a5c12`:e===`silver`?`#4a5568`:`#5c3a1e`,trim:e===`gold`?`#ffe566`:e===`silver`?`#c8d8f0`:t.accent}}function xt(e,t){let{lid:n,body:r,trim:i}=bt(e);return`
  ...
  <path d="M14 54 L18 50 M50 54 L46 50 M54 14 L50 18 M10 14 L14 18" stroke="#d6d3d1" stroke-width="1.8" stroke-linecap="round" opacity="0.65"/>
    ...
    ${N([[20,12,.9],[44,12,.8],[32,4,1],[14,28,.7],[50,28,.7]],`#fff`,.55)}`}function Si(){return`${M(32,56,18,4)}
    ...
    ${N([[14,10,.7],[50,10,.7],[32,28,.8]],`#fde68a`,.6)}`}function Ci(){return`${M(32,54,22,4)}
    ...
    ${Jr(32,36,4,`#e9d5ff`)}
    ${N([[32,28,.8],[32,44,.7]],`#e9d5ff`,.6)}`}function wi(){return`${M(32,54,20,4)}
    ${P(22,38,5.5)}
    ...
    ${N([[36,32,.7],[48,34,.6],[42,28,.8]],`#e9d5ff`,.55)}`}function Ti(){return`${M(32,56,18,4)}
    ${P(32,42,6)}
  ...
  ${Wr(14,50,3.2)}${Xr(50,50,3.2)}`)}`}function Di(){return`${M(24,54,20,4)}
    ${F(48,20,5.5)}
    ...
    ${N([[18,32,.8],[28,28,.6]],`#e9d5ff`,.55)}`}function Oi(){return`${M(32,54,22,4)}
    ...
    ${N([[12,18,.8],[50,8,.75],[32,44,.6]],`#e9d5ff`,.6)}`}function ki(){return`${M(28,54,18,4)}
    ${P(22,44,5.5)}
    ...
    ${N([[30,8,.8],[52,6,.7],[24,28,.6]],`#e9d5ff`,.6)}`}function Ai(){return`${M(32,52,22,4)}
    ...
    ${N([[32,34,.9],[16,14,.7],[48,14,.7]],`#e0f2fe`,.6)}`}function ji(){return`${M(32,54,18,4)}
    ${P(32,48,5.5)}
    ...
    ${N([[12,18,.7],[52,18,.7],[32,36,.6]],`#e9d5ff`,.55)}`}function Mi(){return`${M(32,54,18,4)}
    ${P(32,48,5.5)}
    ...
    ${N([[32,6,.7],[4,44,.6],[60,44,.6]],`#e9d5ff`,.55)}`}function Ni(){return`${M(30,52,20,4)}
    ${F(46,20,5.5)}
    ...
    ${N([[36,26,.7],[22,38,.6]],`#fca5a5`,.5)}`}function Pi(){return`${M(30,54,18,4)}
    ${P(18,50,5)}
    ${F(44,28,5)}
    ...
    ${N([[38,34,.7]],`#e9d5ff`,.5)}`}function Fi(){return`${M(32,54,26,4)}
    ...
    ${N([[8,10,.8],[56,12,.9],[32,18,.7]],`#e0f2fe`,.65)}`}function Ii(){return`${M(32,54,22,4)}
    ...
    ${N([[16,10,.7],[48,10,.7],[10,32,.6],[54,32,.6]],`#c4b5fd`,.45)}`}function Ri(){return`${M(32,56,16,4)}
    ${P(32,34,6)}
    ...
    ${N([[32,12,.8],[12,34,.6],[52,34,.6]],`#e9d5ff`,.5)}`}function zi(){return`${M(32,56,16,4)}
    ${P(32,38,6)}
    ...
    ${N([[32,4,.8],[18,8,.6],[46,8,.6]],`#fde68a`,.55)}`}function Bi(){return`${M(30,54,18,4)}
    ${P(28,36,6)}
    ...
    ${N([[12,12,.7],[46,18,.6]],`#fca5a5`,.5)}`}function Vi(){return`${M(32,54,20,4)}
    ...
    ${N([[32,8,.8],[14,28,.6],[50,28,.6]],`#e9d5ff`,.5)}`}function Hi(){return`${M(32,54,20,4)}
    ...
    <path d="M24 50 C30 44 34 44 40 50" stroke="#fde68a" stroke-width="2" fill="none" opacity="0.7"/>
    ${j(32,14,5,`#fde68a`,`#b45309`)}
    ${N([[24,36,.7],[40,36,.7],[32,8,.9]],`#fde68a`,.6)}`}function Ui(){return`${M(32,54,18,4)}
    ${P(32,34,6)}
    ...
    ${N([[32,12,.8],[8,34,.6],[56,34,.6]],`#e9d5ff`,.55)}`}function Wi(){return`${M(32,54,20,4)}
    ...
    ${N([[46,16,.7],[24,20,.5]],`#c4b5fd`,.45)}`}function Gi(){return`${M(32,54,24,4)}
    ...
    ${N([[8,8,.7],[56,8,.7],[8,56,.7],[56,56,.7]],`#fde68a`,.6)}`}function Ki(){return`${M(28,54,18,4)}
    ${P(18,44,5.5)}
    ${I(42,24,6,`#cbd5e1`)}
    ...
    ${N([[40,20,.7],[22,36,.5]],`#e2e8f0`,.45)}`}function qi(){return`${M(32,54,16,4)}
    ${P(32,20,5.5)}
    ${I(32,48,6,`#cbd5e1`)}
    ...
    ${N([[32,16,.6],[32,44,.5]],`#cbd5e1`,.4)}`}function Ji(){return`${M(32,54,16,4)}
    ${P(32,26,5.5)}
    ...
    ${N([[32,22,.6]],`#93c5fd`,.4)}`}function Yi(){return`${M(32,54,20,4)}
    ...
    ${N([[32,6,.7]],`#cbd5e1`,.4)}`}function Xi(){return`${M(32,54,22,4)}
    ${P(32,24,5.5)}
    ...
    ${N([[48,32,.6]],`#fde68a`,.45)}`}function Qi(){return`${M(28,54,20,4)}
    ...
    ${N([[30,14,.8],[20,38,.5]],`#bae6fd`,.5)}`}function $i(){return`${M(32,54,18,4)}
    ${P(32,40,5.5)}
    ...
    ${N([[24,12,.8],[48,20,.7],[32,6,.9]],`#e9d5ff`,.55)}`}function ea(){return`${M(32,54,22,4)}
    ...
    ${N([[32,10,.8],[16,40,.5],[48,40,.5]],`#93c5fd`,.45)}`}function ta(){return`${M(32,54,16,4)}
    ${P(32,36,6)}
    ...
    ${N([[16,12,.6]],`#fca5a5`,.4)}`}function na(){return`${M(32,54,18,4)}
    ${P(32,34,6)}
    ...
    ${N([[32,20,.7]],`#e2e8f0`,.4)}`}function ra(){return`${M(32,54,16,4)}
    ${F(32,40,6)}
    ...
    ${N([[24,4,.6],[40,4,.6]],`#fde68a`,.45)}`}function ia(){return`${M(32,54,18,4)}
    ${qr(32,36,32)}
    ...
    ${N([[30,36,.5]],`#d6d3d1`,.35)}`}function aa(){return`${M(32,54,16,4)}
    ...
    ${N([[46,10,.7]],`#fca5a5`,.5)}`}function oa(){return`${M(32,54,16,4)}
    ...
    ${N([[32,20,.5],[32,40,.5]],`#cbd5e1`,.35)}`}function sa(){return`${M(32,54,16,4)}
    ${F(32,22,6)}
    ...
    ${N([[28,16,.6],[36,16,.6]],`#fca5a5`,.45)}`}function ca(){return`${M(32,54,20,4)}
    ...
    ${Jr(32,34,4,`#c4b5fd`)}
    ${N([[32,30,.7]],`#e9d5ff`,.45)}`}function la(){return`${M(28,54,18,4)}
    ${P(12,34,5.5)}
    ${I(50,34,6,`#cbd5e1`)}
    ...
    ${N([[46,30,.6]],`#e2e8f0`,.4)}`}function ua(){return`${M(32,54,18,4)}
    ${F(32,28,6)}
    ...
    ${j(32,52,5,`#fca5a5`,`#dc2626`)}`}function da(){return`${M(32,56,16,4)}
    ${P(32,38,6)}
    ...
    ${N([[32,18,.7],[20,32,.5],[44,32,.5]],`#bae6fd`,.4)}`}function fa(){return`${M(32,54,18,4)}
    ${P(32,36,6)}
    ...
    ${N([[14,10,.7],[20,22,.5]],`#e0f2fe`,.5)}`}function pa(){return`${M(30,54,20,4)}
    ${P(14,50,5.5)}
    ${I(50,14,6,`#7dd3fc`)}
    ...
    ${N([[48,12,.7],[24,38,.5]],`#bae6fd`,.45)}`}function ma(){return`${M(32,56,16,4)}
    ${P(32,38,6)}
    ...
    ${N([[32,14,.8],[14,34,.5],[50,34,.5]],`#bae6fd`,.45)}`}function ha(){return`${M(32,54,16,4)}
    ${F(32,34,6)}
    ...
    ${N([[32,10,.7],[28,44,.5],[36,44,.5]],`#86efac`,.45)}`}function ga(){return`${M(26,54,16,4)}
    ${P(24,38,5.5)}
    ...
    ${N([[48,10,.6]],`#fde68a`,.45)}`}function _a(){return`${M(30,54,18,4)}
    ...
    ${N([[42,20,.7]],`#fde68a`,.5)}`}function va(){return`${M(32,56,16,4)}
    ${P(32,40,6)}
    ...
    ${N([[22,4,.7],[32,0,.8],[42,4,.7]],`#fde68a`,.6)}`}function ya(){return`${M(30,54,20,4)}
    ...
    ${N([[46,12,.8],[24,40,.5]],`#e0f2fe`,.5)}`}function ba(){return`${M(32,54,16,4)}
    ${qr(32,36,32)}
    ...
    ${N([[32,24,.6]],`#fca5a5`,.4)}`}function xa(){return`${M(32,54,18,4)}
    ${F(32,20,6)}
  ...
  <path d="M28 48 L24 54 M36 48 L40 54" stroke="#86efac" stroke-width="1.4" stroke-linecap="round" opacity="0.35"/>
    ...
    ${j(48,22,5,`#ef4444`,`#991b1b`)}`}function wa(){return`${M(32,54,18,4)}
    ...
    ${N([[32,8,.6],[56,32,.6],[32,56,.6],[8,32,.6]],`#bae6fd`,.4)}`}function Ta(){return`${M(26,54,20,4)}
    ...
    ${N([[8,20,.6],[42,20,.6]],`#bae6fd`,.4)}`}function Ea(){return`${M(32,54,22,4)}
    ...
    ${N([[44,10,.75],[30,28,.55],[20,46,.5]],`#e9d5ff`,.5)}`}function Da(){return`${M(32,54,24,4)}
    ...
    <text x="10" y="18" font-size="6" fill="#e9d5ff" opacity="0.55">?</text>`}function ka(){return`${M(30,56,16,3.5)}
    ${P(24,40,5.5)}
    ...
    ${N([[30,12,.7],[50,10,.6]],`#fecaca`,.55)}`}function Aa(){return`${M(30,54,18,3.5)}
    ...
    <circle cx="42" cy="22" r="8" fill="#7dd3fc" opacity="0.12"/>`}function ja(){return`${M(32,54,14,3.5)}
    ${qr(32,36,30,!1)}
    ${Xr(32,34,4)}
    ...
    <path d="M24 38 L28 42 M36 38 L40 42" stroke="#d6d3d1" stroke-width="1.2" stroke-linecap="round" opacity="0.4"/>`}function Ma(){return`${M(32,56,14,3)}
    ${P(32,38,7)}
    ...
    <circle cx="32" cy="12" r="4" fill="#fde68a" opacity="0.3"/>`}function Na(){return`${M(32,54,20,4)}
    ...
    <path d="M18 44 L22 40 M46 18 L50 14" stroke="#fbbf24" stroke-width="1.2" stroke-linecap="round" opacity="0.45"/>`}function Pa(){return`${M(32,54,18,3.5)}
    ...
    <circle cx="32" cy="40" r="14" fill="none" stroke="#60a5fa" stroke-width="0.8" opacity="0.2"/>`}function Fa(){return`${M(32,54,20,4)}
    ...
    ${N([[22,16,.75],[44,14,.7],[32,44,.55]],`#fde68a`,.55)}`}var Ia={nudge:()=>R(`nu`,`#94a3b8`,`#1e293b`,Ki()),backstep:()=>R(`bs`,`#9ca3af`,`#1f2937`,qi()),retreat_3:()=>R(`ret`,`#93c5fd`,`#1e3a5f`,Ji()),leapfrog:()=>R(`lf`,`#94a3b8`,`#1e293b`,Qi()),long_step:()=>z(`ls`,`#7dd3fc`,`#1e3a5f`,pa()),sidestep:()=>R(`ss`,`#9ca3af`,`#1f2937`,la()),blink_2:()=>z(`bl`,`#38bdf8`,`#0c4a6e`,ya()),random_teleport:()=>R(`rtp`,`#a78bfa`,`#312e81`,$i()),recall:()=>R(`rc`,`#93c5fd`,`#1e3a5f`,Xi()),repel:()=>R(`rp`,`#94a3b8`,`#1e293b`,Zi()),mass_nudge:()=>z(`mn`,`#7dd3fc`,`#1e3a5f`,Ta()),displacement:()=>B(`dp`,`#b794f4`,`#553c7a`,Ea()),swap_friendly:()=>R(`sw`,`#a78bfa`,`#312e81`,ca()),dominion:()=>z(`dm`,`#60a5fa`,`#1e3a5f`,Pa()),toll:()=>z(`tl`,`#fbbf24`,`#1e3a5f`,Fa()),shield_1:()=>R(`s1`,`#60a5fa`,`#1e3a5f`,da()),shield_2:()=>z(`s2`,`#38bdf8`,`#0c4a6e`,ma()),bulwark:()=>B(`bw`,`#b794f4`,`#553c7a`,Ii()),barrier:()=>R(`br`,`#94a3b8`,`#1f2937`,oa()),last_stand:()=>B(`ls`,`#38bdf8`,`#0c4a6e`,Oa()),martyr:()=>V(`my`,`#fca5a5`,`#4c0519`,ka()),fortify:()=>z(`fo`,`#a78bfa`,`#4c1d95`,Ri()),sanctuary_pulse:()=>z(`sp`,`#7dd3fc`,`#1e3a5f`,Da()),sanctuary:()=>B(`sa`,`#c4b5fd`,`#4c1d95`,Vi()),deflect_1:()=>z(`df`,`#38bdf8`,`#0c4a6e`,ga()),anchor_2:()=>R(`an`,`#94a3b8`,`#1f2937`,Yi()),iron_will:()=>R(`iw`,`#9ca3af`,`#1f2937`,na()),vengeance:()=>B(`vg`,`#9f7aea`,`#3b0764`,Bi()),rally:()=>R(`rl`,`#60a5fa`,`#1e3a5f`,ea()),forward_bolt:()=>z(`fb`,`#fde68a`,`#1e3a5f`,_a()),destroy_unshielded:()=>Yr(`sh`,`#4338ca`,`#1e1b4b`,ni()),pyromancy:()=>Yr(`py`,`#ea580c`,`#431407`,ri()),snipe:()=>z(`sn`,`#fde68a`,`#1e3a5f`,Na()),duel:()=>R(`du`,`#d4b896`,`#3d2817`,ci()),sacrifice:()=>z(`sc`,`#fca5a5`,`#1e3a5f`,Ca()),cull:()=>V(`cu`,`#a78bfa`,`#2e1065`,si()),execution:()=>B(`ex`,`#6ee7b7`,`#14532d`,li()),chain_lightning:()=>Yr(`cl`,`#2563eb`,`#0c1929`,ti()),backstab:()=>z(`bk`,`#c4a574`,`#2d4a6e`,$r()),cryo_bolt:()=>z(`cb`,`#7dd3fc`,`#0c4a6e`,Aa()),bomb:()=>Yr(`bm`,`#f59e0b`,`#78350f`,ei()),shockwave:()=>V(`sw`,`#c4b5fd`,`#3b1f6e`,fi()),plague:()=>V(`pg`,`#86efac`,`#14532d`,pi()),magnet:()=>V(`mg`,`#6ee7b7`,`#14532d`,ui()),poison_3:()=>z(`po`,`#86efac`,`#14532d`,ha()),root_2:()=>z(`ro`,`#86efac`,`#14532d`,Sa()),panic:()=>R(`pn`,`#fca5a5`,`#1f2937`,sa()),blizzard:()=>B(`bz`,`#7dd3fc`,`#1e3a5f`,Fi()),snowball:()=>R(`sb`,`#bae6fd`,`#0c4a6e`,fa()),berserk:()=>Yr(`bk`,`#991b1b`,`#450a0a`,oi()),create_foe:()=>R(`cf`,`#78716c`,`#292524`,aa()),deep_freeze:()=>V(`df`,`#7dd3fc`,`#0c4a6e`,yi()),reverse_only_2:()=>z(`rv`,`#fca5a5`,`#1e3a5f`,xa()),press:()=>R(`pr`,`#fca5a5`,`#1f2937`,ua()),tangle:()=>B(`tg`,`#93c5fd`,`#312e81`,Ai()),blind:()=>B(`bl`,`#a78bfa`,`#4c1d95`,Wi()),confusion:()=>V(`cf`,`#c4b5fd`,`#4c1d95`,gi()),extract:()=>B(`ex`,`#c4b5fd`,`#4c1d95`,_i()),fog_2:()=>Br(`${Vr(32,34,6)}<ellipse cx="32" cy="24" rx="16" ry="8" fill="currentColor" opacity="0.22"/>`),crown:()=>z(`cr`,`#fbbf24`,`#451a03`,va()),demote:()=>R(`dm`,`#fca5a5`,`#1f2937`,ra()),fusion:()=>B(`fu`,`#8b5cf6`,`#4c1d95`,Hi()),clone:()=>V(`cln`,`#93c5fd`,`#312e81`,wi()),chameleon:()=>B(`ch`,`#86efac`,`#312e81`,Ui()),hibernation:()=>V(`hi`,`#c4b5fd`,`#4c1d95`,zi()),quicksand:()=>R(`qs`,`#a8a29e`,`#292524`,ia()),landmine:()=>z(`lm`,`#78716c`,`#292524`,ba()),collapse:()=>R(`co`,`#78716c`,`#292524`,ja()),darkness:()=>B(`dk`,`#6d28d9`,`#1e1b4b`,Li()),scatter:()=>z(`st`,`#7dd3fc`,`#1e3a5f`,wa()),call_forward:()=>B(`cfw`,`#fca5a5`,`#4c1d95`,Ni()),dash:()=>B(`ds`,`#c4b5fd`,`#4c1d95`,Pi()),earthquake:()=>V(`eq`,`#78716c`,`#292524`,ai()),coin_flip:()=>Ei(),ignore:()=>R(`ig`,`#94a3b8`,`#1f2937`,ta()),counterspell:()=>V(`cs`,`#a78bfa`,`#2e1065`,vi()),purify:()=>z(`pu`,`#6ee7b7`,`#14532d`,xi()),trickster:()=>B(`tr`,`#c4b5fd`,`#553c7a`,Gi()),offering:()=>B(`of`,`#d8b4fe`,`#553c7a`,ki()),mulligan:()=>B(`mu`,`#c4b5fd`,`#4c1d95`,Oi()),quick_march:()=>V(`qm`,`#60a5fa`,`#1e3a5f`,di()),constitution:()=>V(`co`,`#4ade80`,`#14532d`,Ti()),last_king:()=>z(`lk`,`#fbbf24`,`#1e3a5f`,Ma()),revive:()=>Yr(`rv`,`#15803d`,`#052e16`,ii()),mind_control:()=>V(`mc`,`#c4b5fd`,`#3b0764`,mi()),zombify:()=>Yr(`zb`,`#4ade80`,`#14532d`,hi()),bounty:()=>V(`bo`,`#4ade80`,`#14532d`,Si()),link_fate:()=>V(`lf`,`#a78bfa`,`#2e1065`,Ci()),bishop_2:()=>z(`bp`,`#b794f4`,`#4c1d95`,ji()),rook_2:()=>z(`rk`,`#a78bfa`,`#4c1d95`,Mi()),hostile_swap:()=>V(`hs`,`#93c5fd`,`#312e81`,bi()),deport:()=>B(`dp`,`#c4b5fd`,`#1e1b4b`,Di())};function La(e,t=0){let n=Ia[e.effect];return n?n(t):null}var Ra={movement:{symbol:`↗`,label:`Motion`,anim:`movement`},combat:{symbol:`⚔`,label:`Strike`,anim:`combat`},defense:{symbol:`🛡`,label:`Ward`,anim:`defense`},debuff:{symbol:`❄`,label:`Curse`,anim:`debuff`},transform:{symbol:`✦`,label:`Morph`,anim:`transform`},board:{symbol:`◇`,label:`Terrain`,anim:`board`},crown:{symbol:`♔`,label:`Royal`,anim:`crown`},arcane:{symbol:`✧`,label:`Arcane`,anim:`arcane`}},za=[[`movement`,[`nudge`,`backstep`,`long_step`,`leapfrog`,`recall`,`teleport`,`random_teleport`,`displacement`,`berserk`,`dash`]],[`combat`,[`stab`,`shatter`,`destroy`,`snipe`,`duel`,`execution`,`cull`,`pyromancy`,`backstab`,`sacrifice`,`chain_lightning`,`cryo`,`bomb`,`magnet`]],[`special`,[`create_foe`,`clone`,`earthquake`]],[`defense`,[`shield`,`ward`,`aegis`,`bulwark`,`stall`,`sanctuary`,`barrier`,`anchor`,`iron_will`,`hibernation`,`constitution`]],[`debuff`,[`root`,`panic`,`backpedal`,`blizzard`,`deep_freeze`,`snowball`,`blind`,`confusion`,`extract`,`press`,`tangle`,`shockwave`]],[`board`,[`quicksand`,`landmine`,`collapse`,`darkness`,`earthquake`,`scatter`,`call_forward`]],[`meta`,[`counterspell`,`vengeance`,`last_stand`,`martyr`,`purify`,`trickster`,`ignore`,`offering`,`mulligan`,`quick_march`,`dominion`,`toll`,`last_king`,`revive`,`mind_control`,`zombify`]]];function Ba(e){let t=0;for(let n=0;n<e.length;n++)t=(t+e.charCodeAt(n)*41)%360;return t}function Va(e){let t=0;for(let n=0;n<e.length;n++)t=(t+e.charCodeAt(n)*13)%3;return t}function Ha(e){let t=`${e.id} ${e.effect} ${e.name}`.toLowerCase();for(let[e,n]of za)if(Array.isArray(n)&&n.some(e=>t.includes(e)))return e;return`arcane`}function Ua(e){return`ca${String(e).replace(/[^a-zA-Z0-9]/g,``)}`}function Wa(e,t,n){let r=[[12,18,.35],[48,12,.5],[52,44,.25],[18,50,.4],[38,28,.55]],i=n*4;return r.map(([e,n,r],a)=>`<circle cx="${(e+i+a*7)%56+4}" cy="${(n+i*2+a*5)%52+6}" r="1.2" fill="hsl(${t} 90% 85% / ${r})"/>`).join(``)}function Ga(e,t){let n=t,r={movement:`
      ...
      </g>`};return r[e]||r.arcane}function Ka(e,t,n,r){return qa(e,t,n,r)}function qa(e,t,n,r){let i=Ua(n),a=(t+42)%360,o=Va(n),s=r&&La(r,o)||Ga(e,o);return r?.effect&&Qr(r.effect)&&s?`<svg class="spell-card__svg spell-card__svg--full-bleed" viewBox="0 0 70 60" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid meet">${s}</svg>`:`<svg class="spell-card__svg" viewBox="0 0 70 60" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
    ...
    <div class="spell-card__frame">
      ...
      <div class="spell-card__type-frame${s?` spell-card__type-frame--with-hint`:``}">
        ...
        ${t.meta?`<span class="spell-card__meta">${$a(t.meta)}</span>`:``}
      </div>
      ${o?`<div class="spell-card__text-frame"><p class="spell-card__desc">${$a(e.desc)}</p></div>`:``}
    </div>
    <div class="spell-card__tooltip" role="tooltip">
      <strong>${$a(e.name)}</strong>
      ${Ya(e)}
    </div>
  `,t.onClick&&l.addEventListener(`click`,n=>t.onClick(n,e)),Za(l),l}function $a(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function eo(e){return document.getElementById(e)}function to(){let e=eo(`card-preview-modal`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function no(e){document.body.classList.toggle(`card-preview-open`,e),window.dispatchEvent(new CustomEvent(`card-preview-change`,{detail:{open:e}}))}function ro(){eo(`card-preview-modal`)?.classList.add(`hidden`),eo(`card-preview-mount`)?.classList.remove(`card-preview-mount--reveal-only`),no(!1)}function io(e,t={}){to();let n=eo(`card-preview-modal`),r=eo(`card-preview-mount`),i=eo(`card-preview-actions`);if(!(!n||!r||!e)){if(r.innerHTML=``,r.classList.toggle(`card-preview-mount--reveal-only`,!!t.hideDesc),r.appendChild(Qa(e,{static:!0,hideDesc:t.hideDesc})),i){if(i.innerHTML=``,t.meta){let e=document.createElement(`p`);e.className=`card-preview-meta`,e.textContent=t.meta,i.appendChild(e)}let e=document.createElement(`div`);if(e.className=`card-preview-actions-row`,t.onPlay){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=`Cast spell`,n.addEventListener(`click`,()=>{ro(),t.onPlay()}),e.appendChild(n)}if(t.onAdd){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=`Add to deck`,n.disabled=!!t.addDisabled,n.addEventListener(`click`,()=>{t.addDisabled||t.onAdd()}),e.appendChild(n)}if(t.onBuy){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=t.buyLabel||`Buy copy`,n.disabled=!!t.buyDisabled,n.addEventListener(`click`,()=>{t.buyDisabled||t.onBuy()}),e.appendChild(n)}if(t.onRemove){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-secondary`,n.textContent=`Remove all from deck`,n.addEventListener(`click`,()=>{t.onRemove(),ro()}),e.appendChild(n)}e.children.length&&i.appendChild(e)}n.classList.remove(`hidden`),no(!0)}}function ao(){eo(`card-preview-close`)?.addEventListener(`click`,ro),eo(`card-preview-backdrop`)?.addEventListener(`click`,ro),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&ro()})}function oo(e,t=`.spell-card`){e&&e.querySelectorAll(t).forEach((e,t)=>{e.classList.add(`spell-card--deal`),e.style.animationDelay=`${t*.1}s`})}function so(e){e&&(e.classList.add(`spell-card--rare-burst`),setTimeout(()=>e.classList.remove(`spell-card--rare-burst`),900))}function co(e){e&&(e.classList.add(`spell-card--epic-burst`),setTimeout(()=>e.classList.remove(`spell-card--epic-burst`),1200))}function lo(e){e&&(e.classList.add(`spell-card--legendary-burst`),setTimeout(()=>e.classList.remove(`spell-card--legendary-burst`),1500))}function uo(e,t){t===`legendary`?lo(e):t===`epic`?co(e):t===`rare`&&so(e)}var fo={common:10,uncommon:20,rare:30,epic:40,legendary:50};function po(e){return fo[e]??30}function mo(e,r){let i=oe(e,r);if(i<1)return{success:!1,message:`Get this spell from a chest first.`};let a=n(r);if(!a)return{success:!1,message:`Unknown card.`};let o=t(r);if(i>=o)return{success:!1,message:`You already own the maximum (${o} copies).`};let s=po(a.rarity);if(e.gems<s)return{success:!1,message:`Need ${s} gems (${e.gems} available).`};e.gems-=s;let c=ye(e,r,1);return c?{success:!0,cost:s,message:`+1 ${a.name} for ${s} gems (${i+c} owned).`}:(e.gems+=s,w(e),{success:!1,message:`You already own the maximum copies for this rarity.`})}var ho={deck:`<svg class="nav-icon-svg" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  </svg>`};function go(){let e={deck:ho.deck,chests:ho.chests,play:ho.play,social:ho.social,quests:ho.quests};for(let t of document.querySelectorAll(`.game-nav .tab-btn[data-tab]`)){let n=t.querySelector(`.tab-btn__icon`),r=t.dataset.tab;n&&e[r]&&(n.innerHTML=e[r])}}var _o=`arcaneCheckersSettings_v1`,vo={musicEnabled:!0,musicVolume:.45,sfxEnabled:!0,sfxVolume:.7,hapticsEnabled:!0},yo={...vo};function bo(){try{let e=localStorage.getItem(_o);return e?{...vo,...JSON.parse(e)}:{...vo}}catch{return{...vo}}}function H(){return{...yo}}function xo(e){yo={...yo,...e};try{localStorage.setItem(_o,JSON.stringify(yo))}catch{}return window.dispatchEvent(new CustomEvent(`arcane-settings-changed`,{detail:H()})),H()}function So(){return yo=bo(),H()}var Co={hub:`assets/audio/background.m4a`,match:`assets/audio/background.m4a`},wo={tap:`assets/audio/sfx/tap.mp3`,spell:`assets/audio/sfx/spell.mp3`,capture:`assets/audio/sfx/capture.mp3`,win:`assets/audio/sfx/win.mp3`,chest:`assets/audio/sfx/chest.mp3`},To=null,Eo=null,Do=`hub`,Oo=!1;function ko(){return typeof Audio<`u`}function Ao(e,t){if(!(!ko()||!H().sfxEnabled))try{let n=new Audio(e);n.volume=Math.max(0,Math.min(1,t*H().sfxVolume)),n.play().catch(()=>{})}catch{}}function jo(e){let t=Co[e];if(!t||!ko())return null;let n=e===`hub`?To:Eo;return n||(n=new Audio(t),n.loop=!0,n.preload=`auto`,e===`hub`?To=n:Eo=n),n}function Mo(e){e&&(e.volume=Math.max(0,Math.min(1,H().musicVolume)))}function No(){To?.pause(),Eo?.pause()}function Po(){Oo||!ko()||(Oo=!0,[To,Eo].forEach(e=>{e&&e.play().then(()=>e.pause()).catch(()=>{})}))}function Fo(e){if(Do=e,!H().musicEnabled){No();return}let t=jo(`hub`),n=jo(`match`);e===`match`?(t?.pause(),n&&(Mo(n),n.play().catch(()=>{}))):(n?.pause(),t&&(Mo(t),t.play().catch(()=>{})))}function Io(){if(!H().musicEnabled){No();return}Mo(To),Mo(Eo),Fo(Do)}function Lo(){if(!ko())return;window.addEventListener(`arcane-settings-changed`,()=>Io());let e=()=>{Po(),H().musicEnabled&&Fo(Do),window.removeEventListener(`pointerdown`,e),window.removeEventListener(`keydown`,e)};window.addEventListener(`pointerdown`,e,{once:!0}),window.addEventListener(`keydown`,e,{once:!0})}function Ro(e){let t=wo[e];t&&Ao(t,1)}var zo={tap:()=>Ro(`tap`),spell:()=>Ro(`spell`),capture:()=>Ro(`capture`),win:()=>Ro(`win`),chest:()=>Ro(`chest`)},Bo=null,Vo=!1;async function Ho(){if(Vo)return Bo;Vo=!0;try{let{Capacitor:e}=await E(async()=>{let{Capacitor:e}=await import(`./dist-DM6qMOWp.js`);return{Capacitor:e}},[],import.meta.url);if(!e.isNativePlatform())return null;Bo=(await E(()=>import(`./esm-TGGH6JYM.js`),[],import.meta.url)).ScreenOrientation}catch{Bo=null}return Bo}async function Uo(){document.body.classList.remove(`orientation-match`),document.body.classList.add(`orientation-portrait`);let e=await Ho();if(e)try{await e.lock({orientation:`portrait`})}catch{}}async function Wo(){await Uo()}var Go=null;function Ko(){return Go||(Go=document.createElement(`div`),Go.id=`network-banner`,Go.className=`network-banner hidden`,Go.setAttribute(`role`,`status`),Go.setAttribute(`aria-live`,`polite`),document.body.appendChild(Go),Go)}function qo(){let e=Ko(),t=!navigator.onLine;e.textContent=t?`No connection — some features need internet`:``,e.classList.toggle(`hidden`,!t)}function Jo(){qo(),window.addEventListener(`online`,qo),window.addEventListener(`offline`,qo)}async function Yo(){try{let{Capacitor:e}=await E(async()=>{let{Capacitor:e}=await import(`./dist-DM6qMOWp.js`);return{Capacitor:e}},[],import.meta.url);if(!e.isNativePlatform())return;let{StatusBar:t,Style:n}=await E(async()=>{let{StatusBar:e,Style:t}=await import(`./esm-C-SIlwqj.js`);return{StatusBar:e,Style:t}},[],import.meta.url);await t.setOverlaysWebView({overlay:!0}),await t.setStyle({style:n.Dark}),await t.setBackgroundColor({color:`#080a12`});let{SplashScreen:r}=await E(async()=>{let{SplashScreen:e}=await import(`./esm-Ck_AT-RK.js`);return{SplashScreen:e}},[],import.meta.url);await r.hide()}catch(e){console.warn(`Capacitor init skipped`,e)}}var Xo=null,Zo=!1;async function Qo(){if(Zo)return Xo;Zo=!0;try{let{Capacitor:e}=await E(async()=>{let{Capacitor:e}=await import(`./dist-DM6qMOWp.js`);return{Capacitor:e}},[],import.meta.url);if(!e.isNativePlatform())return null;let{Haptics:t,ImpactStyle:n}=await E(async()=>{let{Haptics:e,ImpactStyle:t}=await import(`./esm-D_it6P9V.js`);return{Haptics:e,ImpactStyle:t}},[],import.meta.url);Xo={Haptics:t,ImpactStyle:n}}catch{Xo=null}return Xo}async function $o(){if(!H().hapticsEnabled)return;let e=await Qo();if(e)try{await e.Haptics.impact({style:e.ImpactStyle.Light})}catch{}}var es={bronze:{label:`Bronze`,tagline:`Same odds as Bronze Chest`,visual:`bronze`,accent:`#c77dff`,glow:`rgba(199, 125, 255, 0.45)`},silver:{label:`Silver`,tagline:`Same odds as Silver Chest`,visual:`silver`,accent:`#7dd3fc`,glow:`rgba(125, 211, 252, 0.5)`},gold:{label:`Gold`,tagline:`Same odds as Gold Chest`,visual:`gold`,accent:`#ffd87a`,glow:`rgba(255, 216, 122, 0.55)`}};function ts(e){let t=es[e]||es.style_crate,n=t.visual;return{tier:t,lid:n===`gold`?`#f0e6c8`:n===`silver`?`#e4ecf8`:`#e8c4f8`,body:n===`gold`?`#5a4518`:n===`silver`?`#3d4a62`:`#4a2860`,trim:t.accent,ribbon:n===`gold`?`#ff9de2`:n===`silver`?`#a5f3fc`:`#d8b4fe`}}function ns(e,t){let{lid:n,body:r,trim:i,ribbon:a}=ts(e);return`
    <defs>
      <linearGradient id="${t}-body" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stop-color="${r}"/>
    ...
    </defs>`}function rs(e,t,n){let{trim:r,ribbon:i,tier:a}=ts(e);return`
    ${n?`<g class="chest-stage__interior">
    ...
    </g>`}function is(e){let t=`vanityStage-${e}`;return`<svg class="chest-stage-svg vanity-box-svg" viewBox="0 0 120 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ${ns(e,t)}
    <ellipse class="chest-stage__shadow" cx="60" cy="90" rx="42" ry="8" fill="rgba(0,0,0,0.5)"/>
    ${rs(e,t,!0)}
  </svg>`}function as(e){let t=`vanityCard-${e}`;return`<svg class="chest-svg vanity-box-svg" viewBox="0 0 120 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ${ns(e,t)}
    <ellipse cx="60" cy="90" rx="42" ry="8" fill="rgba(0,0,0,0.5)"/>
    ${rs(e,t,!1)}
  </svg>`}function os(e){let t=ss[e]||ss.avatar_default,n=`av-${e.replace(/[^a-z0-9]/gi,``)}`;return`<svg viewBox="0 0 64 64" class="cosmetic-avatar-svg cosmetic-avatar-svg--${e.replace(`avatar_`,``)}" aria-hidden="true">
    <defs>
    ...
    ${t.svg}
  </svg>`}var ss={avatar_default:{bg:[`#4a5f7a`,`#1e2a3a`],glow:`#8fa4c4`,svg:`<ellipse cx="32" cy="38" rx="14" ry="16" fill="#2a3548"/>
      ...
      <circle cx="36" cy="26" r="2" fill="#0a1628"/>`}};function cs(e){let t={banner_default:`linear-gradient(135deg,#1e2a44,#2d4a6e)`,banner_nebula:`linear-gradient(135deg,#2a1f4e,#6b4fd4 55%,#1a1030)`,banner_crimson:`linear-gradient(135deg,#3a1018,#8b2030 50%,#1a0a10)`,banner_storm:`linear-gradient(135deg,#1a2840,#3d7ab8 45%,#9ad4ff)`,banner_aurora:`linear-gradient(135deg,#0f3d3a,#5ce1e6 40%,#9f7aea 80%,#1a0a20)`,banner_forest:`linear-gradient(135deg,#1a2e0e,#2d5016 50%,#0f1a08)`,banner_sunset:`linear-gradient(135deg,#431407,#c2410c 45%,#fdba74 75%,#1a0a04)`,banner_midnight:`linear-gradient(135deg,#0f172a,#1e3a5f 50%,#020617)`,banner_ocean:`linear-gradient(135deg,#042f2e,#0e7490 45%,#164e63 80%,#020617)`,banner_eclipse:`linear-gradient(135deg,#0a0a0a,#1a1a2e 35%,#fbbf24 50%,#0a0a0a 65%,#312e81)`,banner_sand:`linear-gradient(135deg,#78350f,#d97706 45%,#fcd34d 75%,#451a03)`,banner_mist:`linear-gradient(135deg,#374151,#6b7280 50%,#9ca3af 80%,#1f2937)`,banner_dawn:`linear-gradient(135deg,#4a1942,#ec4899 40%,#fbbf24 70%,#1a0a20)`};return t[e]||t.banner_default}function ls(e){return e===`pieceSkin`?`Piece skin`:e===`frame`?`Frame`:e===`avatar`?`Avatar`:e===`banner`?`Banner`:e}function us(e){return`profile-frame profile-frame--${(e||`frame_default`).replace(/^frame_/,``)}`}function ds(e){return(e||`frame_default`).replace(/^frame_/,``),`<div class="cosmetic-frame-preview ${us(e)}">
    <div class="cosmetic-frame-preview__inner">${os(`avatar_default`)}</div>
  </div>`}function fs(e,t){return t===`avatar`?os(e):t===`frame`?ds(e):t===`banner`?`<div class="cosmetic-preview-banner" style="background:${cs(e)}"></div>`:t===`pieceSkin`?ps(e):``}function ps(e){let t=e.replace(`skin_`,``);return`<div class="cosmetic-skin-preview">
    <span class="piece red piece-skin-${t} king"></span>
    <span class="piece black piece-skin-${t}"></span>
  </div>`}function ms(e){let t=document.createElement(`article`);t.className=`cosmetic-reveal-card rarity-${e.rarity} cosmetic-reveal-card--${e.type}`,e.duplicate&&t.classList.add(`cosmetic-reveal-card--duplicate`);let n=fs(e.id,e.type),r=ls(e.type);return t.innerHTML=`
    ...
    </div>`,t.style.animationDelay=`0s`,t}function hs(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function gs(e,t=``){let n=f(e),r=(t||`P`).charAt(0).toUpperCase(),i=os(n.equipped.avatar)||`<span class="profile-avatar-fallback">${hs(r)}</span>`;return`<span class="profile-avatar-stack header-profile-btn__stack ${us(n.equipped.frame)}"><span class="profile-avatar-inner header-profile-btn__inner">${i}</span></span>`}async function _s(e){if(!e)return``;try{return(await Ae(e.id))?.username||e.user_metadata?.display_name||e.email?.split(`@`)[0]||``}catch{return e.user_metadata?.display_name||e.email?.split(`@`)[0]||``}}var vs=null;function ys(){return vs||=Promise.all([E(()=>import(`./match-tfwppkSr.js`),[],import.meta.url),E(()=>import(`./matchView-X_5jfI9g.js`),[],import.meta.url),E(()=>Promise.resolve({}),__vite__mapDeps([0]),import.meta.url),E(()=>Promise.resolve({}),__vite__mapDeps([1]),import.meta.url)]).then(([e,t])=>({MatchSession:e.MatchSession,getMatchHtml:t.getMatchHtml})),vs}var bs=null;function xs(){return bs||=Promise.all([E(()=>import(`./pvpUI-CNmGtH-D.js`),[],import.meta.url),E(()=>import(`./pvp-B77RieyH.js`),[],import.meta.url)]).then(([e,t])=>({initPvpUI:e.initPvpUI,clearAllWaitingRoomsOnce:t.clearAllWaitingRoomsOnce})),bs}var Ss=null;function Cs(){return Ss||=E(()=>import(`./profileUI-DrE7dPeE.js`),[],import.meta.url),Ss}function ws(){Ss=null}var Ts=null;function Es(){return Ts||=Promise.all([E(()=>import(`./settingsUI-vJfURYi1.js`),[],import.meta.url),E(()=>Promise.resolve({}),__vite__mapDeps([2]),import.meta.url)]).then(([e])=>e),Ts}var Ds=null;function Os(){return Ds||=Promise.all([E(()=>import(`./chestOpenAnimation-CE6lTc6M.js`),[],import.meta.url),E(()=>import(`./cosmeticOpenAnimation-DISxcXZ5.js`),[],import.meta.url),E(()=>import(`./titleOpenAnimation-DOiuFImj.js`),[],import.meta.url)]).then(([e,t,n])=>({playChestOpenAnimation:e.playChestOpenAnimation,playCosmeticOpenAnimation:t.playCosmeticOpenAnimation,playTitleOpenAnimation:n.playTitleOpenAnimation})),Ds}var ks=null;function As(){return ks||=E(()=>import(`./socialUI-aechSy5-.js`),[],import.meta.url),ks}var js=null;function Ms(){return js||=E(()=>import(`./tutorialMeta-D7msoGKe.js`),[],import.meta.url),js}var Ns=null;function Ps(){return Ns||=E(()=>import(`./tutorialUnlocks-DHCEelJp.js`),[],import.meta.url),Ns}var Fs=null;function Is(){return Fs||=E(()=>import(`./tutorialMatch-BdMTx0pi.js`),[],import.meta.url),Fs}function Ls(e,t){Ms().then(n=>n.notifyMetaTutorial(e,t)).catch(e=>console.warn(`[Tutorial] meta notify failed`,e))}function Rs(e,t){Ps().then(n=>n.notifyUnlockTutorial(e,t))}var U;try{U=T()}catch(e){console.error(`Failed to load profile, resetting save:`,e),localStorage.removeItem(`cardCheckersProfile_v7`),localStorage.removeItem(`cardCheckersProfile_v5`),U=T()}var W=`deck`,zs={deck:`Decks`,chests:`Shop`,play:`Play`,social:`Social`,quests:`Quests`,profile:`Profile`,settings:`Settings`},Bs=new Set(Object.keys(zs)),Vs=null,Hs=null,Us=!1,Ws=`cards`,Gs=`list`,G=null,K=[],Ks=null,qs=``,Js=`all`,Ys=`all`,Xs=!0,Zs={legendary:5,epic:4,rare:3,uncommon:2,common:1};function Qs(e){return[...e].sort((e,t)=>{let n=Zs[e.rarity]??0,r=Zs[t.rarity]??0;return n===r?e.name.localeCompare(t.name):r-n})}var q=null,$s=null,ec=null,tc=null,nc=null;function rc(){return $s?Promise.resolve($s):(ec||=xs().then(({initPvpUI:e,clearAllWaitingRoomsOnce:t})=>(t(),$s=e({arenaRoot:document.getElementById(`play-arena-root`),leaderboardRoot:document.getElementById(`play-leaderboard-root`),getProfile:()=>U,openAuthModal:()=>oc?.open(`signin`,{forced:!0}),onNavigateTab:Z,onNavigatePlayTab:kc,onNavigatePlayMenu:Oc,onOpenDeckEdit:kl}),$s)),ec)}function ic(){return tc?Promise.resolve(tc):(nc||=As().then(({initSocialUI:e})=>(tc=e({root:document.getElementById(`view-social`),getProfile:()=>U,saveProfile:w,openAuthModal:()=>oc?.open(`signin`,{forced:!0})}),tc)),nc)}var ac=null,oc=null,J=!1,sc=!1,cc=!1,lc=!1,uc=!1,dc=null,fc=null,pc=null,Y=1,mc=null;function hc(e){return Zs[e?.rarity]??0}function gc(e){let t=i(e);return Object.entries(t).map(([e,t])=>({def:n(e),count:t})).filter(e=>e.def).sort((e,t)=>{let n=hc(t.def)-hc(e.def);return n===0?e.def.name.localeCompare(t.def.name):n})}function _c(e){let t=K.indexOf(e);t<0||(K.splice(t,1),Nl(),Ls(`card-removed-from-deck`,{cardId:e}))}function vc(e){let t=K.length;K=K.filter(t=>t!==e),K.length!==t&&(Nl(),Ls(`card-removed-from-deck`,{cardId:e}))}function yc(){let n=e().map(e=>({def:e,owned:oe(U,e.id)})).filter(e=>e.owned>0).sort((e,t)=>{let n=hc(t.def)-hc(e.def);return n===0?e.def.name.localeCompare(t.def.name):n});K=[];for(let{def:e,owned:r}of n){let n=Math.min(r,t(e));for(let t=0;t<n&&K.length<30;t++)K.push(e.id);if(K.length>=30)break}Nl()}var X=e=>document.getElementById(e);function bc(){let e=document.getElementById(`adventure-prebattle`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function xc(){let e=document.querySelector(`nav.game-nav.tabs`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function Sc(){return window.matchMedia(`(min-width: 1000px) and (max-width: 1400px)`).matches?2.5:window.matchMedia(`(min-width: 600px) and (max-width: 999px)`).matches?1.85:1}function Cc(){bc(),document.getElementById(`adventure-prebattle`)?.classList.remove(`hidden`),document.body.classList.add(`adventure-floor-open`)}function wc(){document.getElementById(`adventure-prebattle`)?.classList.add(`hidden`),document.body.classList.remove(`adventure-floor-open`)}function Tc(e=ue,t=`Locked`){qn({title:t,bodyHtml:e,autoCloseMs:4500})}function Ec(){document.body.classList.toggle(`main-tab-active`,Bs.has(W)),document.body.classList.toggle(`play-sub-active`,W===`play`&&Vs!==null),document.body.classList.toggle(`adventure-active`,W===`play`&&Vs===`adventure`)}function Dc(){let e=d(U);for(let t of[`arena`,`leaderboard`]){let n=document.querySelector(`.play-tab[data-play-tab="${t}"]`);n&&(n.classList.toggle(`play-tab--locked`,!e),n.setAttribute(`aria-disabled`,e?`false`:`true`),n.title=e?``:m(`PvP`))}}function Oc(){Vs=null,X(`play-menu`)?.classList.remove(`hidden`),document.querySelectorAll(`.play-tab-panel`).forEach(e=>{e.classList.add(`hidden`),e.hidden=!0}),Ec(),Dc()}async function kc(e){if(!Us&&(e===`arena`||e===`leaderboard`)&&!d(U)){let e=tn(),t=$t;await tt(e?`${m(`PvP`)}\n\n${t}.`:m(`PvP`),{title:`PvP locked`,confirmLabel:`Go to Adventure`,cancelLabel:e?`Sign in`:`Not now`})?(Us=!0,kc(`adventure`),Us=!1):e&&oc?.open(`signin`,{forced:!0});return}Vs=e,X(`play-menu`)?.classList.add(`hidden`),document.querySelectorAll(`.play-tab`).forEach(t=>{let n=t.dataset.playTab===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,n?`true`:`false`)}),document.querySelectorAll(`.play-tab-panel`).forEach(t=>{let n=t.id===`play-tab-${e}`;t.classList.toggle(`hidden`,!n),t.hidden=!n}),Ec(),Rs(`play-tab-changed`,{tab:e}),e===`adventure`?Rl():e===`arena`?rc().then(e=>{e?.setScreen?.(`arena`),e?.render({resume:!0})}):e===`leaderboard`&&rc().then(e=>{e?.setScreen?.(`leaderboard`),e?.render()})}function Ac(e,t,n){let r=e.querySelector(`.tab-btn__sign-in-badge`);t?(r||(r=document.createElement(`span`),r.className=`tab-btn__sign-in-badge`,r.setAttribute(`aria-hidden`,`true`),e.appendChild(r)),r.textContent=n,e.classList.add(`tab-btn--sign-in-nudge`)):(r?.remove(),e.classList.remove(`tab-btn--sign-in-nudge`))}function jc(){let e=d(U),t=tn();Dc();let n=document.querySelector(`.tab-btn[data-tab="quests"]`);if(n){let r=!e,i=en;n.classList.toggle(`tab-btn--locked`,r),n.setAttribute(`aria-disabled`,r?`true`:`false`),r?(n.title=t?`${m(`Quests`)} ${i}.`:m(`Quests`),Ac(n,t,`Sign in`)):t?(n.title=i,Ac(n,!1)):(n.title=``,Ac(n,!1))}let r=document.querySelector(`.tab-btn[data-tab="social"]`);r&&(t?(r.title=en,Ac(r,!0,`Sign in`)):(r.title=``,Ac(r,!1)));let i=c(U),a=document.querySelector(`.vault-tab[data-vault-tab="cosmetics"]`);a&&(a.classList.toggle(`vault-tab--locked`,!i),a.title=i?``:ve,a.setAttribute(`aria-disabled`,i?`false`:`true`))}async function Z(e){let t=document.getElementById(`view-match`);if(!(J&&t&&!t.classList.contains(`hidden`))&&!(t&&!t.classList.contains(`hidden`)&&t.querySelector(`.pvp-loading`)&&e!==W)){if(!sc&&e===`quests`&&!d(U)){let e=tn(),t=en;await tt(e?`${m(`Quests`)}\n\n${t}.`:m(`Quests`),{title:`Quests locked`,confirmLabel:`Go to Adventure`,cancelLabel:e?`Sign in`:`Not now`})?(sc=!0,Z(`play`),sc=!1):e&&oc?.open(`signin`,{forced:!0});return}if(ur(),tr()&&rr()){if(e===W||t?.querySelector(`.pvp-loading`)||!await tt(`Leave your current match to open ${zs[e]||e}?`,{title:`Leave match?`,confirmLabel:`Leave`,cancelLabel:`Stay`,destructive:!0}))return;ir(e),e===`play`&&(Hs=`arena`),sr(),document.querySelector(`#btn-leave-match`)?.click();return}if(Gs===`edit`&&(e!==`deck`||e===`deck`&&W===`deck`)){if(!await Dl())return;Ol()}if(e!==`deck`&&Gs===`edit`&&(ol(),document.body.classList.remove(`deck-editing`)),W=e,Ec(),Bs.has(e)&&il(),document.querySelectorAll(`.tab-btn`).forEach(t=>{t.classList.toggle(`active`,t.dataset.tab===e)}),document.querySelectorAll(`.view`).forEach(t=>{t.classList.toggle(`hidden`,t.id!==`view-${e}`)}),e===`chests`&&(gl(Ws),vl()),e===`deck`&&(Gs=`list`,cl(`list`)),e===`profile`&&Lc(),e===`settings`&&Rc(),e===`quests`&&(Uc(),qc()),e===`play`){let e=Hs??Vs;Hs=null,e?kc(e):Oc()}e===`social`&&(tc?tc.refresh?.()??tc.render():(Gc(),ic().then(e=>e?.render()).catch(e=>{console.error(`[Social] init failed`,e),Kc()}))),Ls(`tab-changed`,{tab:e}),Rs(`tab-changed`,{tab:e}),tr()||(Fo(`hub`),await Uo())}}var Q=``;function Mc(e=Q){e&&(Q=e);let t=document.getElementById(`header-profile-menu`),n=document.getElementById(`header-profile-btn`),r=document.getElementById(`header-username`),i=document.getElementById(`auth-header-btn`),a=!!D();if(i&&(i.classList.toggle(`hidden`,a),i.hidden=a),t&&(t.classList.toggle(`hidden`,!a),t.hidden=!a),r){let e=a&&Q;r.textContent=e?Q:``,r.classList.toggle(`hidden`,!e),r.hidden=!e}n&&a&&(n.innerHTML=gs(U,Q),n.title=Q?`Account — ${Q}`:`Account menu`)}function Nc(){let e=document.getElementById(`header-profile-btn`),t=document.getElementById(`header-profile-dropdown`);!e||!t||(t.classList.add(`hidden`),t.hidden=!0,e.setAttribute(`aria-expanded`,`false`))}function Pc(){let e=document.getElementById(`header-profile-menu`),t=document.getElementById(`header-profile-btn`),n=document.getElementById(`header-profile-dropdown`);if(!e||!t||!n)return;let r=e=>{n.classList.toggle(`hidden`,!e),n.hidden=!e,t.setAttribute(`aria-expanded`,e?`true`:`false`)};t.addEventListener(`click`,e=>{e.stopPropagation();let t=!n.hidden;r(!t)}),n.querySelectorAll(`[data-profile-menu-action]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.profileMenuAction;Nc(),t===`settings`?Z(`settings`):Ic()})}),document.addEventListener(`click`,t=>{n.hidden||e.contains(t.target)||Nc()}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&!n.hidden&&Nc()})}async function Fc(){let e=D();if(!e){Q=``,Mc();return}Q=await _s(e),Mc()}function Ic(){Nc(),Z(`profile`),Rs(`profile-opened`)}async function Lc(){let{renderProfileTab:e}=await Cs(),t=X(`view-profile`);e(U,t,{onGemsChange:Jc,onTitleChanged:()=>Mc()})}async function Rc(){let{renderSettingsTab:e}=await Es();e(X(`view-settings`),{onUsernameChanged:e=>{Q=e,Mc(e)}})}var zc=`
  ...
  <section class="panel game-panel social-panel social-panel--error">
  ...
  </section>`;function Uc(){let e=X(`view-quests`);e&&(e.innerHTML=zc)}function Wc(e=X(`view-quests`)){e&&(e.innerHTML=Bc,e.querySelector(`.quests-retry-btn`)?.addEventListener(`click`,()=>{ws(),Uc(),qc()}))}function Gc(){let e=X(`view-social`);e&&(e.innerHTML=Vc)}function Kc(e=X(`view-social`)){e&&(e.innerHTML=Hc,e.querySelector(`.social-retry-btn`)?.addEventListener(`click`,()=>{tc=null,nc=null,Gc(),ic().then(e=>e?.render()).catch(t=>{console.error(`[Social] retry failed`,t),Kc(e)})}))}async function qc(){let e=X(`view-quests`);if(e)try{let{renderQuestsTab:t}=await Cs();t(U,e,{onTitleChanged:()=>Mc(),onCurrencyChange:()=>$()})}catch(t){console.error(`[Quests] render failed`,t),Wc(e)}}function $(){let e=X(`header-gems`);e&&(e.textContent=String(U.gems??0));let t=X(`header-stars`);t&&(t.textContent=String(U.stars??0)),document.querySelector(`.hud-gems`)?.classList.toggle(`hud-gems--low`,(U.gems??0)<50),document.querySelector(`.hud-stars`)?.classList.toggle(`hud-stars--low`,(U.stars??0)<10)}function Jc(){$()}function Yc(){document.querySelectorAll(`.collection-owned-only-toggle`).forEach(e=>{e.checked=Xs});for(let e of[`collection-search`]){let t=X(e);t&&(t.value=qs)}for(let e of[`collection-rarity`]){let t=xr(e);t&&(t.value=Js)}let e=xr(`collection-category`);e&&(e.value=Ys)}var Xc=`(max-width: 899px)`,Zc=`(max-width: 1280px)`,Qc=null;function $c(){return window.matchMedia(Xc).matches}function el(){return document.body.classList.contains(`main-tab-active`)&&!document.body.classList.contains(`match-active`)&&!document.body.classList.contains(`deck-editing`)&&window.matchMedia(Zc).matches}function tl(){return document.querySelector(`.game-main`)}function nl(){let e=tl();return el()&&e?e.scrollTop:window.scrollY||document.documentElement.scrollTop||0}function rl(e){let t=tl();if(el()&&t){t.scrollTop=e;return}window.scrollTo(0,e)}function il(){let e=tl();if(el()&&e){e.scrollTop=0;return}window.scrollTo(0,0)}function al(){$c()&&(Qc=nl(),document.body.style.position=`fixed`,document.body.style.top=`0`,document.body.style.left=`0`,document.body.style.right=`0`,document.body.style.width=`100%`)}function ol(){if(Qc==null)return;let e=Qc;Qc=null,document.body.style.position=``,document.body.style.top=``,document.body.style.left=``,document.body.style.right=``,document.body.style.width=``,rl(e)}function sl(){il(),document.documentElement.scrollTop=0,document.body.scrollTop=0,document.querySelector(`.game-shell`)?.scrollTo?.(0,0),tl()?.scrollTo?.(0,0),document.querySelector(`#view-deck`)?.scrollTo?.(0,0),document.querySelectorAll(`#deck-subview-edit, #deck-subview-edit .deck-editor, #deck-subview-edit .deck-editor__body, #deck-subview-edit .deck-editor__grid, #deck-subview-edit .deck-editor__grid-cards`).forEach(e=>{e.scrollTop=0})}function cl(e){e!==`edit`&&ol(),Gs=e,document.body.classList.toggle(`deck-editing`,e===`edit`),X(`deck-subview-list`)?.classList.toggle(`hidden`,e!==`list`),X(`deck-subview-edit`)?.classList.toggle(`hidden`,e!==`edit`),e===`edit`&&(al(),C(U),w(U),Js=`all`,qs=``,Ys=`all`,Xs=!0,Yc(),Tl()),e===`list`&&Ml(),e===`edit`&&(Nl(),sl(),requestAnimationFrame(()=>{sl(),requestAnimationFrame(sl)}))}function ll({id:e,title:t,desc:n,cost:r,variant:i=`mystery`}){let a=(U.stars??0)>=r,o=i===`title`?Ht():Wt();return`
    ...
    </article>`}function ul(e,t){e.querySelector(`[data-mystery-open]`)?.addEventListener(`click`,e=>{e.stopPropagation(),t()}),e.addEventListener(`click`,t),e.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),t())})}function dl({bonusGems:e=0,bonusStars:t=0}={}){let n=[];return e&&n.push(`+${e} gem refund`),t&&n.push(`+${t} ★ from duplicates`),n.length?` (${n.join(`, `)})`:``}async function fl(e,t){let{playChestOpenAnimation:n,playCosmeticOpenAnimation:r,playTitleOpenAnimation:i}=await Os();e.kind===`card`?(await n({tier:`silver`,tierLabel:`Mystery Box`,pulls:e.cardPulls}),t&&(t.textContent=`Got ${e.cardPulls.length} spells.${dl(e)}`)):e.kind===`cosmetic`?(await r({boxId:`silver`,boxLabel:`Mystery Box`,pulls:e.cosPulls}),t&&(t.textContent=e.message+dl(e))):e.kind===`mixed`?(e.cardPulls.length&&await n({tier:`silver`,tierLabel:`Mystery Box — Spells`,pulls:e.cardPulls}),e.cosPulls.length&&await r({boxId:`silver`,boxLabel:`Mystery Box — Cosmetics`,pulls:e.cosPulls}),t&&(t.textContent=`${e.message}${dl(e)}`)):e.kind===`title`&&(await i({boxLabel:`Title Box`,pulls:e.pulls}),t&&(t.textContent=e.message))}async function pl(){let e=X(`mystery-box-log`);if(!((U.stars??0)>=10)){e&&(e.textContent=`Need 10 ★ stars. Clear Adventure floors to earn stars.`,e.classList.add(`chest-log--error`));return}let t=Xt(U);if(!t.success){e&&(e.textContent=t.message,e.classList.add(`chest-log--error`));return}w(U),$(),e&&e.classList.remove(`chest-log--error`),X(`mystery-box-list`)?.querySelectorAll(`.mystery-box__btn`).forEach(e=>{e.disabled=!0});try{await fl(t,e)}catch(n){console.error(`Mystery box animation failed:`,n),e&&(e.textContent=t.message)}vl({clearPulls:!1}),Lc()}async function ml(){let e=X(`mystery-box-log`);if(!((U.stars??0)>=10)){e&&(e.textContent=`Need 10 ★ stars. Clear Adventure floors to earn stars.`,e.classList.add(`chest-log--error`));return}let t=Zt(U);if(!t.success){e&&(e.textContent=t.message,e.classList.add(`chest-log--error`));return}w(U),$(),e&&e.classList.remove(`chest-log--error`),X(`mystery-box-list`)?.querySelectorAll(`.mystery-box__btn`).forEach(e=>{e.disabled=!0});try{await fl(t,e)}catch(n){console.error(`Title box animation failed:`,n),e&&(e.textContent=t.message)}vl({clearPulls:!1}),Lc()}function hl(){let e=X(`mystery-box-list`);if(!e)return;e.innerHTML=`
    ${ll({id:`mystery`,title:`Mystery Box`,desc:`6 random pulls — mix of spells and cosmetics (${Math.round(Gt*100)}% cosmetic per slot when unlocked).`,cost:10})}
    ${ll({id:`title`,title:`Title Box`,desc:`Box-exclusive mage titles only — The Brave, Ruthless, Omnipotent, and more.`,cost:10,variant:`title`})}
  `;let t=e.querySelectorAll(`.mystery-box`);ul(t[0],()=>pl()),ul(t[1],()=>ml())}function gl(e){if(!cc&&e===`cosmetics`&&!c(U)){Tc(ve,`Cosmetics locked`),cc=!0,gl(`cards`),cc=!1;return}Ws=e,document.querySelectorAll(`.vault-tab`).forEach(t=>{let n=t.dataset.vaultTab===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,n?`true`:`false`)}),document.querySelectorAll(`.vault-tab-panel`).forEach(t=>{let n=t.id===`vault-tab-${e}`;t.classList.toggle(`hidden`,!n),t.hidden=!n}),Rs(`vault-tab-changed`,{tab:e})}function _l(){Cs().then(({renderCosmeticBoxes:e})=>{e(U,X(`cosmetic-box-list`),{logEl:X(`cosmetic-box-log`),onGemsChange:Jc,cosmeticsUnlocked:c(U),onOpened:()=>{W===`profile`&&Lc(),W===`quests`&&qc()}})}).catch(e=>{console.error(`[Shop] cosmetics render failed`,e);let t=X(`cosmetic-box-log`);t&&(t.textContent=`Couldn't load cosmetic boxes — try again from the Shop tab.`,t.classList.add(`chest-log--error`))})}function vl(e={}){let{clearPulls:t=!0}=e;$(),_l(),hl();let n=X(`chest-list`),r=X(`chest-pulls`);if(r&&t&&(r.innerHTML=``,r.classList.add(`chest-pulls--hidden`),r.classList.remove(`chest-pulls--reveal`)),n){n.innerHTML=``;for(let e of dt){let t=yt[e.id]||yt.bronze,i=U.gems>=e.cost,a=document.createElement(`article`);a.className=`chest-card chest-card--${e.id}${i?``:` chest-card--locked`}`,a.innerHTML=`
    ...
    `;let o=a.querySelector(`.chest-open`);o.disabled=!i,o.addEventListener(`click`,async()=>{if(o.disabled)return;let n=gt(U,e.id),i=X(`chest-log`);if(!n.success){i&&(i.textContent=n.message,i.classList.add(`chest-log--error`));return}w(U),$(),o.disabled=!0;let{playChestOpenAnimation:a}=await Os();if(await a({tier:e.id,tierLabel:t.label,pulls:n.pulls}),Ls(`chest-opened`,{chestId:e.id}),i){let t=n.bonusGems?` (+${n.bonusGems} gems from duplicates)`:``;i.textContent=`Got ${n.pulls.length} spells from ${e.name}.${t}`,i.classList.remove(`chest-log--error`)}if(r){r.classList.remove(`chest-pulls--hidden`),r.classList.add(`chest-pulls--reveal`),r.innerHTML=`<p class="chest-pulls__label">Chest opened</p><div class="chest-pulls__grid"></div>`;let e=r.querySelector(`.chest-pulls__grid`);n.pulls.forEach((t,n)=>{let r=Qa(t,{button:!0,deal:!0,gallery:!0,onClick:()=>io(t)});if(r.style.animationDelay=`${n*.12}s`,t.duplicate){r.classList.add(`spell-card--duplicate-pull`);let e=document.createElement(`span`);e.className=`chest-pull-dup-badge`,e.textContent=t.starRefund?`Duplicate · +${t.starRefund} ★`:`Duplicate · +${t.gemRefund} ◆`,r.appendChild(e)}e.appendChild(r),uo(r,t.rarity)}),oo(e),r.scrollIntoView({behavior:`smooth`,block:`nearest`})}vl()}),n.appendChild(a)}}}function yl(){return Qs(e().filter(e=>{if(Ys!==`all`&&ut(e)!==Ys||Js!==`all`&&e.rarity!==Js)return!1;if(qs){let t=qs.toLowerCase();if(!e.name.toLowerCase().includes(t)&&!e.desc.toLowerCase().includes(t))return!1}return!(Xs&&oe(U,e.id)<=0)}))}function bl(e,t){let n=mo(U,e);return t&&(t.textContent=n.message,t.className=n.success?`deck-status ok`:`deck-status warn`),n.success&&(w(U),$(),Gs===`list`&&Ml(),Gs===`edit`&&Nl()),n}function xl(e,t){let n=mo(U,e);return n.success?(w(U),$(),K.push(e),ge(U,e),w(U),Nl(),t&&(t.hidden=!1,t.textContent=`Bought and added to deck.`,t.className=`deck-editor__error deck-status ok`),!0):(t&&(t.hidden=!1,t.textContent=n.message,t.className=`deck-editor__error deck-status warn`),!1)}function Sl(e){return a(K,e,U).ok?(K.push(e),ge(U,e),w(U),Nl(),Ls(`card-added-to-deck`,{cardId:e}),!0):!1}function Cl(e,n,r={}){let{deckEdit:o=!1,statusEl:s=null}=r,c=oe(U,n.id),l=t(n),u=c>=l,d=po(n.rarity),f=U.gems>=d&&!u,p=o?a(K,n.id,U):{ok:!1},m=o&&i(K)[n.id]||0,h=K.length<30,ee=m<l,g=c>=1&&c<=m,_=c>=1&&!u,v=o&&!p.ok&&h&&ee&&g&&_,te=()=>bl(n.id,s),b=()=>{let e=oe(U,n.id),t=o&&i(K)[n.id]||0,r=e>=l,s=U.gems>=d&&!r,c=o?a(K,n.id,U):{ok:!1};io(n,{meta:o?`Owned ${e}/${l} · In deck ${t}/${l} · ${r?`max copies`:`${d} gems per copy`}`:`Owned ${e}/${l}${r?` · max copies`:` · ${d} gems per copy`}`,buyLabel:r?`Max copies owned`:`Buy copy (${d} gems)`,buyDisabled:!s||r||e<1,onBuy:()=>{te(),ro()},addDisabled:!c.ok,onAdd:o?()=>{Sl(n.id)&&b()}:void 0})};if(o){let t=document.createElement(`div`);t.className=`deck-editor-tile`+(y(U,n.id)?` deck-editor-tile--new`:``);let r=Qa(n,{button:!0,gallery:!0,onClick:()=>b()});r.classList.add(`deck-editor-tile__card`),r.title=`${n.name} — tap for full card`;let i=c>0?`Owned ${c}/${l}`:`Not in collection`,a=document.createElement(`div`);a.className=`deck-editor-tile__meta`,a.innerHTML=`${i} · In deck ${m}/${l}${y(U,n.id)?`<span class="deck-editor-tile__new">New</span>`:``}`,a.addEventListener(`click`,()=>b());let o=document.createElement(`button`);o.type=`button`,o.className=`deck-editor-tile__action`,p.ok?(o.classList.add(`deck-editor-tile__action--add`),o.textContent=`+ Add to deck`,o.addEventListener(`click`,e=>{e.stopPropagation(),Sl(n.id)})):v?(o.classList.add(`deck-editor-tile__action--buy`),o.textContent=f?`Add for ${d} gems`:`Need ${d} gems`,o.disabled=!f,o.addEventListener(`click`,e=>{e.stopPropagation(),xl(n.id,s)})):(o.classList.add(`deck-editor-tile__action--disabled`),o.disabled=!0,K.length>=30?o.textContent=`Deck full (30/30)`:m>=l?o.textContent=`Max copies in deck`:c<1?o.textContent=`Open Shop chests to unlock`:p.reason?o.textContent=p.reason:o.textContent=`Can't add`),t.append(r,a,o),e.appendChild(t);return}let x=document.createElement(`div`);x.className=`collection-card-wrap`+(c<1?` collection-card-wrap--unowned`:``);let S=Qa(n,{button:!0,compact:!0,disabled:c<1||u,onClick:e=>{if(e.shiftKey||c<1||u){b();return}te()}});S.title=u?`${n.name} — max ${l} copies owned. Tap to view full card.`:c<1?`${n.name} — not owned. Tap to view full card.`:`${n.name} — tap to buy (${d} gems). Shift+click to inspect.`,x.appendChild(S);let C=document.createElement(`span`);C.className=`collection-owned-count`,C.textContent=c>0?`×${c}`:`—`,x.appendChild(C);let ne=document.createElement(`span`);ne.className=`collection-buy-cost`,ne.textContent=u?`MAX`:`${d} ◆`,(!f||u)&&ne.classList.add(`collection-buy-cost--cant`),x.appendChild(ne),e.appendChild(x)}function wl(e,t={}){if(!e)return;let{deckEdit:n=!1,statusEl:r=null}=t;e.innerHTML=``;let i=yl();if(!i.length){e.className=`deck-editor__grid collection-grid`;let t=document.createElement(`p`);t.className=`collection-grid-empty muted`,t.textContent=n?`No spells match your filters. Try “All types”, clear search, or uncheck Owned only.`:`No cards match your filters. Open chests in the Shop to get more spells.`,e.appendChild(t);return}let a=0,o={deckEdit:n,statusEl:r};if(n||Ys!==`all`){e.className=`deck-editor__grid collection-grid`;for(let t of i)try{Cl(e,t,o),a+=1}catch(e){console.error(`Failed to render card:`,t?.id,e)}}else{e.className=`deck-editor__grid collection-categories`;let t=Object.fromEntries(st.map(e=>[e,[]]));for(let e of i)t[ut(e)].push(e);for(let n of st){let r=t[n];if(!r.length)continue;let i=document.createElement(`section`);i.className=`collection-category-section`,i.dataset.category=n;let s=document.createElement(`h3`);s.className=`collection-category-title`,s.textContent=ct[n],i.appendChild(s);let c=document.createElement(`div`);c.className=`collection-grid deck-editor__grid-cards`;for(let e of r)try{Cl(c,e,o),a+=1}catch(t){console.error(`Failed to render card:`,e?.id,t)}i.appendChild(c),e.appendChild(i)}}if(i.length>0&&a===0){e.className=`deck-editor__grid collection-grid`;let t=document.createElement(`p`);t.className=`collection-grid-empty collection-grid-empty--error`,t.textContent=`Spells failed to display. Hard refresh the page (Ctrl+Shift+R).`,e.appendChild(t)}}function Tl(){Ks={name:X(`deck-name-input`)?.value?.trim()??``,cardIds:[...K]}}function El(){return Ks?(X(`deck-name-input`)?.value?.trim()??``)!==Ks.name||K.length!==Ks.cardIds.length?!0:K.some((e,t)=>e!==Ks.cardIds[t]):!1}async function Dl(){return El()?tt(`Discard unsaved changes to this deck?`,{title:`Unsaved changes`,confirmLabel:`Discard`,cancelLabel:`Keep editing`,destructive:!0}):!0}function Ol(){G=null,K=[],Ks=null}function kl(e){let t=U.decks.find(t=>t.id===e);if(!t)return;G=t.id,K=[...t.cardIds];let n=X(`deck-name-input`);n&&(n.value=t.name),cl(`edit`),Ls(`deck-edit-opened`,{deckId:e})}function Al(e){let t=Object.fromEntries(st.map(e=>[e,0]));for(let r of e){let e=n(r);e&&(t[ut(e)]+=1)}return t}function jl(e){let t=Al(e),n=[];for(let e of st){let r=t[e];if(r<=0)continue;let i=ct[e];n.push(`<span class="deck-row__cat" title="${$a(i)}: ${r}"><span class="deck-row__cat-dot deck-row__cat-dot--${e}" aria-hidden="true"></span><span class="deck-row__cat-n">${r}</span></span>`)}return n.length?`<div class="deck-row__cats">${n.join(``)}</div>`:``}function Ml(){C(U)&&w(U),$();let e=X(`deck-list`);if(!e)return;e.innerHTML=``;let t=X(`deck-list-count`);if(t){let e=U.decks.length;t.textContent=e?`${e} deck${e===1?``:`s`}`:``}if(!U.decks.length){if(C(U)&&w(U),U.decks.length){Ml();return}e.innerHTML=`
      ...
      <h3 class="deck-row-name">${$a(t.name)}</h3>
      <div class="deck-row__progress">
        <div class="deck-progress-bar deck-row__progress-bar" role="progressbar" aria-valuemin="0" aria-valuemax="30" aria-valuenow="${t.cardIds.length}" aria-label="${$a(t.name)} progress">
  ...
  </svg>`}function Bl(e=`#e8c547`){return`<svg class="adventure-map-tile__pawn-svg" viewBox="0 0 28 36" aria-hidden="true">
    <defs>
  ...
  </svg>`}function Vl(e){let t=b[e]||b.verdant;return`<svg class="adventure-map-tile__banner-svg" viewBox="0 0 24 20" aria-hidden="true">
    <defs>
    ...
    <div class="adventure-map-canvas__bg" aria-hidden="true">
      <div class="adventure-map-scenery adventure-map-scenery--${i}" aria-hidden="true">${zl(i)}</div>
    ...
    <div class="adventure-map-tower">
      ...
      <span class="adventure-map-tile__stone" aria-hidden="true">
        ...
        ${a>0?`<span class="adventure-floor-row__stars">${S(a)}</span>`:``}`,o.addEventListener(`click`,()=>Ql(t.id)),v.appendChild(o)}}let y=r.querySelector(`.adventure-map-tile--next`);Hl(r),y&&requestAnimationFrame(()=>{requestAnimationFrame(()=>y.scrollIntoView({behavior:`smooth`,block:`nearest`}))});let x=v?.querySelector(`.adventure-floor-row--next`);x&&requestAnimationFrame(()=>x.scrollIntoView({behavior:`smooth`,block:`end`})),r.querySelector(`.adventure-challenge-toggle`)?.addEventListener(`click`,t=>{t.preventDefault(),t.stopPropagation(),e.challengeMode=!e.challengeMode,U.adventure=e,w(U),$o(),zo.tap(),Wl()})}function Gl(e){let t=de(e);if(!t||!g(U.adventure,e))return;pc=e,Cc();let n=X(`prebattle-title`),i=X(`prebattle-flavor`),a=X(`prebattle-opponent`);n&&(n.textContent=`Tower ${t.worldId} · Floor ${t.floorInWorld}`),i&&(i.textContent=t.flavor||``),a&&(a.textContent=`Loading…`);try{mc=xe(U,e),w(U)}catch(e){console.error(`Enemy deck failed`,e),a&&(a.textContent=`Could not build enemy deck. Try again.`);return}a&&(a.textContent=`Review the enemy spell deck, then choose your grimoire below.`);let o=X(`prebattle-gem-hint`);if(o){let n=ne(U.adventure,e);o.textContent=(Se(U.adventure,e)?`Repeat clear: +${n} gems`:`First clear: +${n} gems`)+(t.worldId===5&&Ce(U.adventure)?` · Challenge mode: enemy has an extra rank of pieces`:``)}let s=X(`enemy-deck-preview`);if(s){s.innerHTML=``;try{for(let{def:e,count:t}of he(mc)){if(!e)continue;let n=document.createElement(`button`);n.type=`button`,n.className=`enemy-deck-spell-btn`,n.title=`View ${e.name}`;let r=document.createElement(`span`);if(r.className=`enemy-deck-spell-btn__name`,r.textContent=e.name,n.appendChild(r),t>1){let e=document.createElement(`span`);e.className=`enemy-deck-spell-btn__count`,e.textContent=`×${t}`,n.appendChild(e)}n.addEventListener(`click`,()=>io(e,{meta:t>1?`${t} copies in enemy deck`:`Enemy deck`})),s.appendChild(n)}}catch(e){console.error(`Enemy preview failed`,e),s.innerHTML=`<p class="empty-msg">Enemy deck preview unavailable.</p>`}}C(U)&&w(U);let c=xr(`adventure-deck-select`);if(!c){a&&(a.textContent=`Deck selector missing — hard refresh the page.`);return}c.innerHTML=``;let l=U.decks.filter(e=>r(e.cardIds,U).valid);if(!l.length){let e=document.createElement(`option`);e.value=``,e.textContent=`No complete decks — build one in Decks`,c.appendChild(e),c.disabled=!0,X(`btn-start-adventure`).disabled=!0;return}c.disabled=!1;let u=U.selectedDeckId&&l.some(e=>e.id===U.selectedDeckId)?U.selectedDeckId:l[0].id;for(let e of l){let t=document.createElement(`option`);t.value=e.id,t.textContent=e.name,e.id===u&&(t.selected=!0),c.appendChild(t)}U.selectedDeckId=u,X(`btn-start-adventure`).disabled=!1}async function Kl(e,t,n,r,i=null,a=!1,o=void 0){let s=t.opponent;Ll(),mc=null,document.querySelectorAll(`.view`).forEach(e=>e.classList.add(`hidden`)),X(`view-match`)?.classList.remove(`hidden`);let c=X(`view-match`);if(!c)return;let{MatchSession:u,getMatchHtml:d}=await ys();c.innerHTML=d(s);let p=o??(we(r).id===5&&Ce(U.adventure)),m={levelId:r,deckId:e.id,challengeMode:p},h={aiDeckIds:n,opponentName:s,cosmetics:f(U),profile:U,challengeMode:p,buildGameOverActions:({won:e,isTie:t})=>Jl(m,{won:e,isTie:t}),onGameOverAction:e=>{Yl(e,m,c)}};i&&(h.initialState=i);try{q=new u(e.cardIds,c,()=>{q=null,mr(),Uo(),Fo(`hub`),c.innerHTML=``,X(`view-match`)?.classList.add(`hidden`);let e=ar();e?Z(e):(Hs=`adventure`,Z(`play`)),lc&&eu(),uc&&tu()},e=>{let t=ce(U,r,e),{gems:n,stars:i,starsGained:a}=t;return U.gems+=n,pe(U,`adventure_floors`,1),l(U),w(U),$(),jc(),r===1&&t.firstTime&&(lc=!0,eu()),r===5&&t.firstTime&&(uc=!0),{message:`+${n} gems! · Best: ${S(i)}`,starsGained:a}},h)}catch(e){throw q=null,c.innerHTML=``,X(`view-match`)?.classList.add(`hidden`),Z(`play`),e}fr({kind:`adventure`,deckId:e.id,deckCardIds:e.cardIds,aiDeckIds:n,opponentName:s,levelId:r,challengeMode:p}),await Uo(),Fo(`match`),a&&(q.winRewarded=!0),hr(q),q.setMessage(``),q.render()}async function ql(){let e=gr();if(!e)return!1;let t=U.decks.find(t=>t.id===e.deckId)||U.decks.find(e=>e.cardIds?.length===30),n=e.levelId?de(e.levelId):null;return!t||t.cardIds.length!==30||!n||!e.aiDeckIds?.length||!await tt(`Resume your adventure match where you left off?`,{title:`Resume match?`,confirmLabel:`Resume`,cancelLabel:`Discard`})?(pr(),!1):(pc=e.levelId,await Kl(t,n,e.aiDeckIds,e.levelId,e.state,e.winRewarded,e.challengeMode),q?.setMessage(`Match resumed — pick up where you left off.`),!0)}function Jl({levelId:e},{won:t,isTie:n}){let r=e+1,i=t&&r<=50&&g(U.adventure,r);if(n)return[{id:`backToAdventure`,label:`Back to Adventure`,primary:!0}];if(t){let e=[];return i?(e.push({id:`nextFloor`,label:`Next floor`,primary:!0}),e.push({id:`retry`,label:`Retry floor`}),e.push({id:`backToAdventure`,label:`Back to Adventure`})):(e.push({id:`backToAdventure`,label:`Back to Adventure`,primary:!0}),e.push({id:`retry`,label:`Retry floor`})),e}return[{id:`retry`,label:`Retry floor`,primary:!0},{id:`backToAdventure`,label:`Back to Adventure`}]}async function Yl(e,{levelId:t,deckId:n,challengeMode:r},i){let a=U.decks.find(e=>e.id===n);if(e===`backToAdventure`){q?.onExit?.();return}if(e===`nextFloor`){let e=t+1;if(!de(e)||!g(U.adventure,e)){q?.onExit?.();return}q?.dispose(),q=null,mr({clearCheckpoint:!0}),Uo(),Fo(`hub`),i&&(i.innerHTML=``),X(`view-match`)?.classList.add(`hidden`),await Z(`play`),Gl(e);return}if(e===`retry`){let e=t,n=de(e);if(!a||a.cardIds.length!==30||!n){q?.onExit?.();return}q?.dispose(),q=null,mr(),await Kl(a,n,xe(U,e),e,null,!1,r)}}function Xl(){let e=xr(`adventure-deck-select`)?.value,t=U.decks.find(t=>t.id===e),n=pc,r=n?de(n):null,i=mc?[...mc]:null;if(!t||t.cardIds.length!==30||!r||!i?.length){let e=X(`prebattle-opponent`);e&&(!t||t.cardIds.length!==30?e.textContent=`Build a complete 30-card deck in the Decks tab, then try again.`:e.textContent=`Could not start battle — close and pick the floor again.`);return}Kl(t,r,i,n)}function Zl(){if(window.__adventureMapCaptureBound)return;window.__adventureMapCaptureBound=!0;let e=null,t=!1,n=0,r=e=>e.closest?.(`#adventure-map .adventure-map-tile, #adventure-map .adventure-map-pin`),i=e=>e?.closest?.(`.adventure-map-scene`),a=()=>{t=!0,clearTimeout(n),n=setTimeout(()=>{t=!1},280)},o=(e,t)=>{if(!e||e.disabled)return;let n=Number(e.dataset.level);!Number.isFinite(n)||n<1||(t.preventDefault(),t.stopPropagation(),Ql(n))};document.addEventListener(`pointerdown`,t=>{if(t.button!==0)return;let n=r(t.target);if(!n||n.disabled)return;let a=i(n);e={pin:n,pointerId:t.pointerId,startX:t.clientX,startY:t.clientY,scrollTop:a?.scrollTop??0,scrollLeft:a?.scrollLeft??0,cancelled:!1}},!0),document.addEventListener(`pointermove`,t=>{if(!e||t.pointerId!==e.pointerId||e.cancelled)return;let n=t.clientX-e.startX,r=t.clientY-e.startY;Math.hypot(n,r)>12&&(e.cancelled=!0);let a=i(e.pin);a&&(Math.abs(a.scrollTop-e.scrollTop)>3&&(e.cancelled=!0),Math.abs(a.scrollLeft-e.scrollLeft)>3&&(e.cancelled=!0))},!0),document.addEventListener(`pointerup`,t=>{if(!e||t.pointerId!==e.pointerId)return;let{pin:n,cancelled:r}=e;if(e=null,r){a();return}o(n,t),a()},!0),document.addEventListener(`pointercancel`,t=>{!e||t.pointerId!==e.pointerId||(e=null,a())},!0),document.addEventListener(`click`,e=>{if(t){e.preventDefault(),e.stopPropagation();return}let n=r(e.target);!n||n.disabled||o(n,e)},!0)}function Ql(e){let t=s(U.adventure);if(U.adventure=t,!g(t,e)){Tc(`Locked — beat global floor ${e-1} first, then return here.`,`Floor locked`);return}w(U),Gl(e)}function $l(){xc(),window.addEventListener(`orientationchange`,xc),window.addEventListener(`resize`,xc),Ec(),So(),go(),Jo(),Lo(),Wo(),Yo(),ao(),Zl(),bc(),document.querySelector(`.adventure-map-scene`)?.addEventListener(`scroll`,Ul,{passive:!0});let e;window.addEventListener(`resize`,()=>{clearTimeout(e),e=setTimeout(()=>{if(!document.body.classList.contains(`adventure-active`))return;let e=X(`adventure-map`);e&&Hl(e)},120)}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&Ll()}),document.querySelectorAll(`.tab-btn`).forEach(e=>{e.addEventListener(`click`,()=>{$o(),zo.tap(),Z(e.dataset.tab)})}),document.querySelectorAll(`.play-tab`).forEach(e=>{e.addEventListener(`click`,()=>{if(ur(),W!==`play`){Hs=e.dataset.playTab,Z(`play`);return}kc(e.dataset.playTab)})}),document.querySelectorAll(`.play-sub-back`).forEach(e=>{e.addEventListener(`click`,()=>{$o(),zo.tap(),Oc()})}),document.querySelectorAll(`.vault-tab`).forEach(e=>{e.addEventListener(`click`,()=>{ur(),gl(e.dataset.vaultTab)})}),X(`btn-new-deck`)?.addEventListener(`click`,Il),X(`btn-back-from-edit`)?.addEventListener(`click`,async()=>{await Dl()&&(Ol(),cl(`list`))}),X(`btn-delete-deck`)?.addEventListener(`click`,async()=>{if(!G||G===`new`)return;let e=U.decks.find(e=>e.id===G);e&&await tt(`Delete "${e.name}"? This cannot be undone.`,{title:`Delete deck?`,confirmLabel:`Delete`,cancelLabel:`Keep`,destructive:!0})&&(fe(U,e.id),Ol(),cl(`list`))});let t=()=>{Gs===`edit`&&Nl(),Gs===`list`&&Ml()};document.querySelectorAll(`.collection-owned-only-toggle`).forEach(e=>{e.addEventListener(`change`,e=>{Xs=e.target.checked,Yc(),t()})}),document.querySelectorAll(`.btn-reset-collection-filters`).forEach(e=>{e.addEventListener(`click`,()=>{Js=`all`,qs=``,Ys=`all`,Xs=!0,Yc(),t()})}),Yc(),Sr(),X(`collection-search`)?.addEventListener(`input`,e=>{qs=e.target.value,t()}),xr(`collection-category`)?.addEventListener(`change`,e=>{Ys=e.target.value,t()}),xr(`collection-rarity`)?.addEventListener(`change`,e=>{Js=e.target.value,t()}),X(`btn-clear-deck`)?.addEventListener(`click`,()=>{K=[],Nl()}),X(`btn-auto-finish-deck`)?.addEventListener(`click`,yc),X(`btn-save-deck`)?.addEventListener(`click`,Pl),X(`btn-back-adventure`)?.addEventListener(`click`,Ll),X(`adventure-floor-backdrop`)?.addEventListener(`click`,Ll),X(`btn-start-adventure`)?.addEventListener(`click`,Xl),xr(`adventure-deck-select`)?.addEventListener(`change`,e=>{U.selectedDeckId=e.target.value,w(U)});let n=document.getElementById(`auth-modal`),r=document.getElementById(`auth-header-btn`);Pc(),Yn(`play-help-btn`,`play-help-desc`),Yn(`adventure-help-btn`,`adventure-help-desc`),Yn(`shop-help-btn`,`shop-help-desc`),Yn(`deck-help-btn`,`deck-help-desc`),ac=gn({onSignIn:()=>oc?.open(`signin`,{forced:!0}),onSignUp:()=>oc?.open(`signup`,{forced:!0}),onGuest:()=>{rn(),su()}}),oc=mn({authBtn:r,modal:n,onNewAccount:()=>{U=_e()?me():T(),kn(U,w)},onSignedIn:()=>{an(),jr(),U=T(),C(U),On(U),$(),Ml(),hl(),ac?.hide(),Fc().then(()=>{W===`profile`&&Lc(),W===`quests`&&qc(),W===`play`&&rc().then(e=>e?.render({resume:!0})),W===`social`&&ic().then(e=>e?.refresh?.()??e?.render())}),rc().then(e=>e?.render({resume:!0})),au(),ou(),iu(),ru(),J||Z(W)},onSignedOut:()=>{an(),Mr(),Nc(),Q=``,Mc(),$s?.dispose?.(),q=null,mr({clearCheckpoint:!0}),ur(),U=me(),jc(),$(),Ml(),hl(),ac?.show(),Z(`deck`)}}),_r(()=>q),C(U),Yc(),jc(),cu()}function eu(){if(!lc||dc!=null)return;let e=0,t=()=>{if(dc=null,e+=1,lc){if(rr()){e<10&&(dc=window.setTimeout(t,400));return}if(On(U),iu()){lc=!1;return}e<10&&(dc=window.setTimeout(t,500))}};dc=window.setTimeout(t,350)}function tu(){if(!uc||fc!=null)return;let e=0,t=()=>{if(fc=null,e+=1,uc){if(rr()){e<10&&(fc=window.setTimeout(t,400));return}if(On(U),ru()){uc=!1;return}e<10&&(fc=window.setTimeout(t,500))}};fc=window.setTimeout(t,350)}function nu(){return J||!hn()||!d(U)||!Ln(U)?!1:(J=!0,Z(`play`),Ps().then(({startPvpTutorial:e})=>{e({profile:U,saveProfile:w,onComplete:()=>{J=!1,U=T(),C(U),jc(),Z(`play`),ru()}})}),!0)}function ru(){return J||!hn()||!c(U)||Mn(U)||Nn(U)||In(U)||Ln(U)||!zn(U)?!1:(J=!0,Z(`play`),Ps().then(({startCosmeticsTutorial:e})=>{e({profile:U,saveProfile:w,onComplete:()=>{J=!1,U=T(),C(U),jc(),Z(`play`)}})}),!0)}function iu(){return J||!hn()||!d(U)?!1:(On(U),In(U)?(J=!0,Z(`play`),Ps().then(({startQuestsTutorial:e})=>{e({profile:U,saveProfile:w,onComplete:()=>{J=!1,U=T(),C(U),jc(),nu(),ru()}})}),!0):nu())}function au(){return J||!hn()||!Mn(U)?!1:(J=!0,Is().then(({startInteractiveTutorial:e})=>{e({profile:U,saveProfile:w,onComplete:()=>{J=!1,U=T(),C(U),$(),Ml(),hl(),ou()||Z(`deck`),iu(),ru()}})}),!0)}function ou(){return J||!hn()||!Nn(U)?!1:(J=!0,Z(`deck`),Ms().then(({startMetaTutorial:e})=>{e({profile:U,saveProfile:w,onComplete:()=>{J=!1,U=T(),C(U),$(),Ml(),hl(),Z(`deck`),iu(),ru()}})}),!0)}async function su(){ac?.hide(),!au()&&(ou()||iu()||ru()||J||(await ql()||await Z(`deck`),ur(),Fo(`hub`)))}async function cu(){try{if(await Le()){jr();try{let e=await dn();e&&(U=e)}catch(e){console.warn(`Cloud sync on load failed`,e)}C(U),$(),Ml(),hl()}}catch(e){console.warn(`Auth init failed`,e)}if(On(U),await Fc(),$s&&W===`play`&&(Vs===`arena`||Vs===`leaderboard`)&&$s.render(),ur(),_n()){ac?.show();return}await su()}$l(),E(async()=>{let{registerSW:e}=await import(`./virtual_pwa-register-CpSsV7JG.js`);return{registerSW:e}},[],import.meta.url).then(({registerSW:e})=>{e({immediate:!0})}),nt(),ot();export{ar as A,Fn as B,kr as C,pr as D,xr as E,hr as F,en as G,Bn as H,Yn as I,Tt as J,Vt as K,Rn as L,mr as M,rr as N,or as O,ur as P,An as R,Fr as S,br as T,on as U,Pn as V,$t as W,tt as X,vt as Y,Ye as Z,xo as _,cs as a,io as b,ls as c,fs as d,ms as f,H as g,Fo as h,es as i,fr as j,cr as k,us as l,Io as m,gs as n,is as o,Uo as p,yt as q,_s as r,as as s,ys as t,os as u,uo as v,Ar as w,Qa as x,oo as y,jn as z};