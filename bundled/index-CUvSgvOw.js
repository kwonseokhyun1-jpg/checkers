...
import{n as e,o as t,t as n}from"./cardCatalog-CkqiHXhM.js";import{c as r,i,r as a}from"./deckRules-CoHxIYsM.js";import{$ as o,Ct as s,Dt as c,Et as l,H as u,I as d,Ot as f,R as p,St as m,T as h,Tt as g,X as _,_t as v,a as y,bt as ee,c as b,ct as x,d as S,dt as te,f as C,ft as ne,g as re,gt as ie,ht as ae,i as oe,kt as se,l as ce,lt as le,m as w,mt as ue,o as de,ot as fe,p as pe,pt as me,q as he,r as ge,s as _e,st as ve,t as ye,u as T,ut as be,vt as xe,wt as Se,xt as Ce,yt as we,z as Te}from"./storage-DWQ_vGAQ.js";import{l as Ee,p as De,r as Oe}from"./mageTitles-BPvsmJqw.js";import{t as E}from"./preload-helper-CV77j2BA.js";import{_ as ke,a as Ae,c as je,d as Me,f as Ne,h as Pe,l as Fe,m as Ie,o as D,s as Le,t as Re}from"./auth-sCrcMfYD.js";var ze=Object.defineProperty,Be=(e,t)=>{let n={};for(var r in e)ze(n,r,{get:e[r],enumerable:!0});return t||ze(n,Symbol.toStringTag,{value:`Module`}),n};function Ve(){let e=window.visualViewport;return e?Math.max(0,Math.round(e.offsetTop)):0}function He(){let e=window.visualViewport;return e?Math.max(0,Math.round(window.innerHeight-e.offsetTop-e.height)):0}function Ue(){let e=document.documentElement,t=()=>{e.style.setProperty(`--viewport-inset-top`,`${Ve()}px`),e.style.setProperty(`--viewport-inset-bottom`,`${He()}px`)};t(),window.visualViewport?.addEventListener(`resize`,t),window.visualViewport?.addEventListener(`scroll`,t),window.addEventListener(`resize`,t),window.addEventListener(`orientationchange`,t)}Ue();var We=1100,Ge=120;function Ke(){let e=document.getElementById(`app-splash`);if(!e||e.classList.contains(`app-splash--hide`))return;e.classList.add(`app-splash--hide`),document.body.classList.remove(`splash-active`);let t=()=>{e.remove()};e.addEventListener(`transitionend`,t,{once:!0}),window.setTimeout(t,600)}function qe(){Ke()}function Je(){let e=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches?Ge:We,t=performance.now(),n=()=>{let n=performance.now()-t,r=Math.max(0,e-n);window.setTimeout(Ke,r)};document.readyState===`interactive`||document.readyState===`complete`?n():document.addEventListener(`DOMContentLoaded`,n,{once:!0})}document.body.classList.add(`splash-active`),Je();var Ye=`(max-width: 768px)`,Xe=null;function Ze(){return document.getElementById(`mobile-confirm`)}function Qe(e){let t=Ze();if(!t)return;t.classList.add(`hidden`),document.body.classList.remove(`mobile-confirm-open`);let n=Xe;Xe=null,n?.(e)}function $e(e,t={}){if(!window.matchMedia(Ye).matches)return Promise.resolve(window.confirm(e));let n=Ze();if(!n)return Promise.resolve(window.confirm(e));let{title:r=`Confirm`,confirmLabel:i=`OK`,cancelLabel:a=`Cancel`,destructive:o=!1}=t;return new Promise(t=>{Xe&&Qe(!1),Xe=t,n.querySelector(`#mobile-confirm-title`).textContent=r,n.querySelector(`#mobile-confirm-body`).textContent=e;let s=n.querySelector(`#mobile-confirm-ok`),c=n.querySelector(`#mobile-confirm-cancel`);s.textContent=i,c.textContent=a,s.classList.toggle(`btn-danger`,o),s.classList.toggle(`btn-primary`,!o),n.classList.remove(`hidden`),document.body.classList.add(`mobile-confirm-open`),c.focus()})}function et(){let e=Ze();!e||e.dataset.bound||(e.dataset.bound=`1`,e.querySelector(`#mobile-confirm-ok`)?.addEventListener(`click`,()=>Qe(!0)),e.querySelector(`#mobile-confirm-cancel`)?.addEventListener(`click`,()=>Qe(!1)),e.querySelector(`[data-mobile-confirm-backdrop]`)?.addEventListener(`click`,()=>Qe(!1)))}var tt=`cc_install_banner_dismissed`;function nt(){return window.matchMedia(`(display-mode: standalone)`).matches||window.navigator.standalone===!0}function rt(){let e=window.navigator.userAgent;return/iphone|ipad|ipod/i.test(e)&&!/crios|fxios/i.test(e)}function it(){if(nt()||localStorage.getItem(tt)===`1`)return;let e=document.getElementById(`install-banner`);if(!e)return;let t=null,n=()=>{e.classList.remove(`hidden`),document.body.classList.add(`install-banner-visible`)},r=()=>{e.classList.add(`hidden`),document.body.classList.remove(`install-banner-visible`)};window.addEventListener(`beforeinstallprompt`,r=>{r.preventDefault(),t=r,e.querySelector(`#install-banner-ios-hint`)?.classList.add(`hidden`),e.querySelector(`.install-banner__hint--default`)?.classList.remove(`hidden`),e.querySelector(`#install-banner-btn`)?.classList.remove(`hidden`),n()}),rt()&&(e.querySelector(`#install-banner-ios-hint`)?.classList.remove(`hidden`),e.querySelector(`.install-banner__hint--default`)?.classList.add(`hidden`),e.querySelector(`#install-banner-btn`)?.classList.add(`hidden`),window.setTimeout(n,2500)),e.querySelector(`#install-banner-btn`)?.addEventListener(`click`,async()=>{t&&(t.prompt(),await t.userChoice,t=null,r())}),e.querySelector(`#install-banner-dismiss`)?.addEventListener(`click`,()=>{localStorage.setItem(tt,`1`),r()})}var at=[`attack`,`control`,`defense`,`movement`,`trap`,`special`],ot={attack:`Attack`,control:`Control`,defense:`Defense`,movement:`Movement`,trap:`Trap`,special:`Special`},st={aegis:`defense`,anchor:`defense`,backpedal:`control`,backstab:`attack`,backstep:`movement`,barrier:`defense`,bishops_mark:`movement`,blind:`control`,blizzard:`control`,snowball:`control`,berserk:`movement`,bomb:`attack`,shockwave:`control`,plague:`control`,bulwark:`defense`,create_foe:`special`,call_forward:`movement`,chain_lightning:`attack`,clone:`special`,coin_flip:`attack`,collapse:`special`,confusion:`control`,constitution:`defense`,counterspell:`trap`,crown:`special`,cryo_bolt:`attack`,cull:`attack`,darkness:`defense`,dash:`movement`,deep_freeze:`control`,deflect:`trap`,demote:`control`,deport:`movement`,displacement:`movement`,dominion:`special`,duel:`attack`,earthquake:`special`,execution:`attack`,pyromancy:`attack`,fusion:`special`,hibernation:`special`,hostile_swap:`movement`,ignore:`special`,iron_will:`defense`,landmine:`trap`,last_king:`special`,bounty:`special`,link_fate:`special`,last_stand:`trap`,leapfrog:`movement`,long_step:`movement`,magnet:`movement`,nudge:`movement`,offering:`special`,panic:`control`,poison:`attack`,mind_control:`special`,press:`control`,purify:`special`,quick_march:`movement`,quicksand:`trap`,rally:`defense`,recall:`movement`,repel:`movement`,random_teleport:`movement`,retreat:`movement`,revive:`defense`,rooks_mark:`movement`,root:`control`,sacrifice:`attack`,sanctuary:`defense`,scatter:`movement`,shadow_swap:`movement`,sidestep:`movement`,shatter:`attack`,snipe:`attack`,snowball:`control`,stab:`attack`,stall:`defense`,tangle:`control`,teleport:`movement`,trickster:`special`,vengeance:`trap`,ward:`defense`};function ct(e){let t=st[e?.id];if(t)return t;let n=`${e?.id||``} ${e?.effect||``} ${e?.name||``} ${e?.desc||``}`.toLowerCase();return/trap|mine|quicksand|counterspell|vengeance|last.?stand/.test(n)?`trap`:/shield|ward|aegis|sanctuary|barrier|anchor|deflect|stall|iron_will|rally|darkness/.test(n)?`defense`:/move|nudge|teleport|recall|leap|step|displace|swap|scatter|retreat|bishop|rook|overrun|promote|pull|push|shift|earthquake|magnet|repel/.test(n)?`movement`:/freeze|blind|confusion|hex|root|panic|press|silence|paraly|control|cannot play|random|mark|poison|die in \d+ turn/.test(n)?`control`:/\bdestroy\b|\bkills?\b|fireball|bolt|stab|snipe|duel|sacrifice|execution|shatter|cull|lightning/.test(n)?`attack`:`special`}var lt=[{id:`bronze`,name:`Bronze Chest`,cost:25,cards:3,weights:{common:70,uncommon:25,rare:5,epic:0}},{id:`silver`,name:`Silver Chest`,cost:50,cards:5,weights:{common:50,uncommon:35,rare:12,epic:3}},{id:`gold`,name:`Gold Chest`,cost:100,cards:8,weights:{common:32,uncommon:38,rare:22,epic:6,legendary:2}}];function ut(e){let t=Math.random()*100,n=0;for(let r of[`common`,`uncommon`,`rare`,`epic`,`legendary`])if(n+=e[r]||0,t<=n)return r;return`common`}function dt(t){let n=e().filter(e=>e.rarity===t);return n.length?n[Math.floor(Math.random()*n.length)]:e()[0]}function ft(e,t){return dt(ut(t.weights))}function pt(e,n,r={}){let{starRefundChance:i=0}=r;if(oe(e,n.id)<t(n))return ye(e,n.id,1),{...n,duplicate:!1};let a=he[n.rarity]||5;if(i>0&&Math.random()<i){let e=Math.random()<.5?1:2;return{...n,duplicate:!0,starRefund:e}}return{...n,duplicate:!0,gemRefund:a}}function mt(e,t){let n=lt.find(e=>e.id===t);if(!n)return{success:!1,message:`Unknown chest.`};if(e.gems<n.cost)return{success:!1,message:`Not enough gems.`};e.gems-=n.cost;let r=[],i=0;for(let t=0;t<n.cards;t++){let t=pt(e,ft(e,n));r.push(t),t.gemRefund&&(i+=t.gemRefund)}return i&&(e.gems+=i),w(e),{success:!0,pulls:r,chest:n,bonusGems:i}}var ht=[`common`,`uncommon`,`rare`,`epic`,`legendary`];function gt(e,{minPct:t=1}={}){return ht.filter(n=>(e[n]??0)>=t).map(t=>`${e[t]}% ${t}`).join(` · `)}var _t={bronze:{label:`Bronze`,tagline:`Mostly common cards`,accent:`#cd7f32`,glow:`rgba(205, 127, 50, 0.45)`},silver:{label:`Silver`,tagline:`Balanced card mix`,accent:`#a8b8d8`,glow:`rgba(168, 184, 216, 0.5)`},gold:{label:`Gold`,tagline:`Higher rare & epic odds`,accent:`#e8c547`,glow:`rgba(232, 197, 71, 0.55)`}};function vt(e){let t=_t[e]||_t.bronze;return{t,lid:e===`gold`?`#f5e6a8`:e===`silver`?`#e8eef8`:`#d4954a`,body:e===`gold`?`#7a5c12`:e===`silver`?`#4a5568`:`#5c3a1e`,trim:e===`gold`?`#ffe566`:e===`silver`?`#c8d8f0`:t.accent}}function yt(e,t){let{lid:n,body:r,trim:i}=vt(e);return`
  ...
  <path d="M14 54 L18 50 M50 54 L46 50 M54 14 L50 18 M10 14 L14 18" stroke="#d6d3d1" stroke-width="1.8" stroke-linecap="round" opacity="0.65"/>
    ...
    ${N([[22,20,.8],[36,28,.7],[36,36,.7]],`#e9d5ff`,.6)}`}function ri(){return`${M(32,54,18,4)}
    ${F(32,36,6)}
    ...
    ${N([[16,20,.8],[48,38,.7],[32,10,.9]],`#e9d5ff`,.6)}`}function ii(){return`${M(32,54,20,4)}
    ...
    ${N([[14,14,.8],[48,16,.7],[32,8,.9]],`#e9d5ff`,.6)}`}function ai(){return`${M(32,54,22,4)}
    ${P(32,50,5)}
    ...
    ${N([[50,10,1],[12,52,.8],[40,20,.7]],`#e0f2fe`,.7)}`}function oi(){return`${M(32,54,22,4)}
    ...
    ${N([[32,32,.8],[28,28,.6],[36,36,.6]],`#fde68a`,.55)}`}function si(){return`${M(32,54,22,4)}
    ...
    ${N([[20,12,.9],[44,12,.8],[32,4,1],[14,28,.7],[50,28,.7]],`#fff`,.55)}`}function ci(){return`${M(32,56,18,4)}
    ...
    ${N([[14,10,.7],[50,10,.7],[32,28,.8]],`#fde68a`,.6)}`}function li(){return`${M(32,54,22,4)}
    ...
    ${Ir(32,36,4,`#e9d5ff`)}
    ${N([[32,28,.8],[32,44,.7]],`#e9d5ff`,.6)}`}function ui(){return`${M(32,54,20,4)}
    ${P(22,38,5.5)}
    ...
    ${N([[36,32,.7],[48,34,.6],[42,28,.8]],`#e9d5ff`,.55)}`}function di(){return`${M(32,56,18,4)}
    ${P(32,42,6)}
  ...
  ${Mr(14,50,3.2)}${Rr(50,50,3.2)}`)}`}function pi(){return`${M(24,54,20,4)}
    ${F(48,20,5.5)}
    ...
    ${N([[18,32,.8],[28,28,.6]],`#e9d5ff`,.55)}`}function mi(){return`${M(28,54,18,4)}
    ${P(22,44,5.5)}
    ...
    ${N([[30,8,.8],[52,6,.7],[24,28,.6]],`#e9d5ff`,.6)}`}function hi(){return`${M(32,52,22,4)}
    ...
    ${N([[32,34,.9],[16,14,.7],[48,14,.7]],`#e0f2fe`,.6)}`}function gi(){return`${M(32,54,18,4)}
    ${P(32,48,5.5)}
    ...
    ${N([[12,18,.7],[52,18,.7],[32,36,.6]],`#e9d5ff`,.55)}`}function _i(){return`${M(32,54,18,4)}
    ${P(32,48,5.5)}
    ...
    ${N([[32,6,.7],[4,44,.6],[60,44,.6]],`#e9d5ff`,.55)}`}function vi(){return`${M(30,52,20,4)}
    ${F(46,20,5.5)}
    ...
    ${N([[36,26,.7],[22,38,.6]],`#fca5a5`,.5)}`}function yi(){return`${M(30,54,18,4)}
    ${P(18,50,5)}
    ${F(44,28,5)}
    ...
    ${N([[38,34,.7]],`#e9d5ff`,.5)}`}function bi(){return`${M(32,54,26,4)}
    ...
    ${N([[8,10,.8],[56,12,.9],[32,18,.7]],`#e0f2fe`,.65)}`}function xi(){return`${M(32,54,22,4)}
    ...
    ${N([[20,40,.7],[44,24,.7],[32,28,.8]],`#e9d5ff`,.55)}`}function Si(){return`${M(32,54,24,4)}
    ...
    ${N([[16,10,.7],[48,10,.7],[10,32,.6],[54,32,.6]],`#c4b5fd`,.45)}`}function Ci(){return`${M(32,56,16,4)}
    ${P(32,34,6)}
    ...
    ${N([[32,12,.8],[12,34,.6],[52,34,.6]],`#e9d5ff`,.5)}`}function wi(){return`${M(32,56,16,4)}
    ${P(32,38,6)}
    ...
    ${N([[32,4,.8],[18,8,.6],[46,8,.6]],`#fde68a`,.55)}`}function Ti(){return`${M(30,54,18,4)}
    ${P(28,36,6)}
    ...
    ${N([[12,12,.7],[46,18,.6]],`#fca5a5`,.5)}`}function Ei(){return`${M(32,54,20,4)}
    ...
    ${N([[32,8,.8],[14,28,.6],[50,28,.6]],`#e9d5ff`,.5)}`}function Di(){return`${M(32,54,20,4)}
    ...
    <path d="M24 50 C30 44 34 44 40 50" stroke="#fde68a" stroke-width="2" fill="none" opacity="0.7"/>
    ${j(32,14,5,`#fde68a`,`#b45309`)}
    ${N([[24,36,.7],[40,36,.7],[32,8,.9]],`#fde68a`,.6)}`}function Oi(){return`${M(32,54,18,4)}
    ${P(32,34,6)}
    ...
    ${N([[32,12,.8],[8,34,.6],[56,34,.6]],`#e9d5ff`,.55)}`}function ki(){return`${M(32,54,20,4)}
    ...
    ${N([[46,16,.7],[24,20,.5]],`#c4b5fd`,.45)}`}function Ai(){return`${M(32,54,24,4)}
    ...
    ${N([[8,8,.7],[56,8,.7],[8,56,.7],[56,56,.7]],`#fde68a`,.6)}`}function ji(){return`${M(28,54,18,4)}
    ${P(18,44,5.5)}
    ${I(42,24,6,`#cbd5e1`)}
    ...
    ${N([[40,20,.7],[22,36,.5]],`#e2e8f0`,.45)}`}function Mi(){return`${M(32,54,16,4)}
    ${P(32,20,5.5)}
    ${I(32,48,6,`#cbd5e1`)}
    ...
    ${N([[32,16,.6],[32,44,.5]],`#cbd5e1`,.4)}`}function Ni(){return`${M(32,54,16,4)}
    ${P(32,26,5.5)}
    ...
    ${N([[32,22,.6]],`#93c5fd`,.4)}`}function Pi(){return`${M(32,54,20,4)}
    ...
    ${N([[32,6,.7]],`#cbd5e1`,.4)}`}function Fi(){return`${M(32,54,22,4)}
    ${P(32,24,5.5)}
    ...
    ${N([[20,40,.5],[44,40,.5]],`#93c5fd`,.4)}`}function Ii(){return`${M(30,54,20,4)}
    ${P(20,36,5)}${F(40,36,5)}
    ${I(54,36,5,`#fca5a5`)}
    ...
    ${N([[48,32,.6]],`#fde68a`,.45)}`}function Li(){return`${M(28,54,20,4)}
    ...
    ${N([[30,14,.8],[20,38,.5]],`#bae6fd`,.5)}`}function Ri(){return`${M(32,54,18,4)}
    ${P(32,40,5.5)}
    ...
    ${N([[24,12,.8],[48,20,.7],[32,6,.9]],`#e9d5ff`,.55)}`}function zi(){return`${M(32,54,22,4)}
    ...
    ${N([[32,10,.8],[16,40,.5],[48,40,.5]],`#93c5fd`,.45)}`}function Bi(){return`${M(32,54,16,4)}
    ${P(32,36,6)}
    ...
    ${N([[16,12,.6]],`#fca5a5`,.4)}`}function Vi(){return`${M(32,54,18,4)}
    ${P(32,34,6)}
    ...
    ${N([[32,20,.7]],`#e2e8f0`,.4)}`}function Hi(){return`${M(32,54,16,4)}
    ${F(32,40,6)}
    ...
    ${N([[24,4,.6],[40,4,.6]],`#fde68a`,.45)}`}function Ui(){return`${M(32,54,18,4)}
    ${Fr(32,36,32)}
    ...
    ${N([[30,36,.5]],`#d6d3d1`,.35)}`}function Wi(){return`${M(32,54,16,4)}
    ...
    ${N([[46,10,.7]],`#fca5a5`,.5)}`}function Gi(){return`${M(32,54,16,4)}
    ...
    ${N([[32,20,.5],[32,40,.5]],`#cbd5e1`,.35)}`}function Ki(){return`${M(32,54,16,4)}
    ${F(32,22,6)}
    ...
    ${N([[28,16,.6],[36,16,.6]],`#fca5a5`,.45)}`}function qi(){return`${M(32,54,20,4)}
    ...
    ${Ir(32,34,4,`#c4b5fd`)}
    ${N([[32,30,.7]],`#e9d5ff`,.45)}`}function Ji(){return`${M(28,54,18,4)}
    ${P(12,34,5.5)}
    ${I(50,34,6,`#cbd5e1`)}
    ...
    ${N([[46,30,.6]],`#e2e8f0`,.4)}`}function Yi(){return`${M(32,54,18,4)}
    ${F(32,28,6)}
    ...
    ${j(32,52,5,`#fca5a5`,`#dc2626`)}`}function Xi(){return`${M(32,56,16,4)}
    ${P(32,38,6)}
    ...
    ${N([[32,18,.7],[20,32,.5],[44,32,.5]],`#bae6fd`,.4)}`}function Zi(){return`${M(32,54,18,4)}
    ${P(32,36,6)}
    ...
    ${N([[14,10,.7],[20,22,.5]],`#e0f2fe`,.5)}`}function Qi(){return`${M(30,54,20,4)}
    ${P(14,50,5.5)}
    ${I(50,14,6,`#7dd3fc`)}
    ...
    ${N([[48,12,.7],[24,38,.5]],`#bae6fd`,.45)}`}function $i(){return`${M(32,56,16,4)}
    ${P(32,38,6)}
    ...
    ${N([[32,14,.8],[14,34,.5],[50,34,.5]],`#bae6fd`,.45)}`}function ea(){return`${M(32,54,16,4)}
    ${F(32,34,6)}
    ...
    ${N([[32,10,.7],[28,44,.5],[36,44,.5]],`#86efac`,.45)}`}function ta(){return`${M(26,54,16,4)}
    ${P(24,38,5.5)}
    ...
    ${N([[48,10,.6]],`#fde68a`,.45)}`}function na(){return`${M(30,54,18,4)}
    ...
    ${N([[42,20,.7]],`#fde68a`,.5)}`}function ra(){return`${M(32,56,16,4)}
    ${P(32,40,6)}
    ...
    ${N([[22,4,.7],[32,0,.8],[42,4,.7]],`#fde68a`,.6)}`}function ia(){return`${M(30,54,20,4)}
    ...
    ${N([[46,12,.8],[24,40,.5]],`#e0f2fe`,.5)}`}function aa(){return`${M(32,54,16,4)}
    ${Fr(32,36,32)}
    ...
    ${N([[32,24,.6]],`#fca5a5`,.4)}`}function oa(){return`${M(32,54,18,4)}
    ${F(32,20,6)}
    ...
    ${N([[32,44,.5]],`#fca5a5`,.4)}`}function sa(){return`${M(32,54,16,4)}
    ${F(32,24,6)}
  ...
  <path d="M28 48 L24 54 M36 48 L40 54" stroke="#86efac" stroke-width="1.4" stroke-linecap="round" opacity="0.35"/>
    ${N([[20,40,.5],[44,40,.5]],`#86efac`,.4)}`}function ca(){return`${M(30,54,20,4)}
    ...
    ${j(48,22,5,`#ef4444`,`#991b1b`)}`}function la(){return`${M(32,54,18,4)}
    ...
    ${N([[32,8,.6],[56,32,.6],[32,56,.6],[8,32,.6]],`#bae6fd`,.4)}`}function ua(){return`${M(26,54,20,4)}
    ...
    ${N([[44,10,.75],[30,28,.55],[20,46,.5]],`#e9d5ff`,.5)}`}function fa(){return`${M(32,54,24,4)}
    ...
    ${N([[32,28,.7],[12,38,.5],[52,38,.5]],`#bae6fd`,.45)}`}function pa(){return`${M(32,56,14,3)}
    ${P(32,34,6)}
    ${Pr(32,28,`#38bdf8`,`#7dd3fc`)}
    ...
    <text x="10" y="18" font-size="6" fill="#e9d5ff" opacity="0.55">?</text>`}function ma(){return`${M(30,54,18,3.5)}
    ...
    <circle cx="42" cy="22" r="8" fill="#7dd3fc" opacity="0.12"/>`}function ha(){return`${M(32,54,14,3.5)}
    ${Fr(32,36,30,!1)}
    ${Rr(32,34,4)}
    ...
    <path d="M24 38 L28 42 M36 38 L40 42" stroke="#d6d3d1" stroke-width="1.2" stroke-linecap="round" opacity="0.4"/>`}function ga(){return`${M(32,56,14,3)}
    ${P(32,38,7)}
    ...
    <circle cx="32" cy="12" r="4" fill="#fde68a" opacity="0.3"/>`}function _a(){return`${M(32,54,20,4)}
    ...
    <path d="M18 44 L22 40 M46 18 L50 14" stroke="#fbbf24" stroke-width="1.2" stroke-linecap="round" opacity="0.45"/>`}function va(){return`${M(32,54,18,3.5)}
    ...
    <circle cx="32" cy="40" r="14" fill="none" stroke="#60a5fa" stroke-width="0.8" opacity="0.2"/>`}var ya={nudge:()=>R(`nu`,`#94a3b8`,`#1e293b`,ji()),backstep:()=>R(`bs`,`#9ca3af`,`#1f2937`,Mi()),retreat_3:()=>R(`ret`,`#93c5fd`,`#1e3a5f`,Ni()),leapfrog:()=>R(`lf`,`#94a3b8`,`#1e293b`,Li()),long_step:()=>z(`ls`,`#7dd3fc`,`#1e3a5f`,Qi()),sidestep:()=>R(`ss`,`#9ca3af`,`#1f2937`,Ji()),blink_2:()=>z(`bl`,`#38bdf8`,`#0c4a6e`,ia()),random_teleport:()=>R(`rtp`,`#a78bfa`,`#312e81`,Ri()),recall:()=>R(`rc`,`#93c5fd`,`#1e3a5f`,Fi()),repel:()=>R(`rp`,`#94a3b8`,`#1e293b`,Ii()),mass_nudge:()=>z(`mn`,`#7dd3fc`,`#1e3a5f`,ua()),displacement:()=>B(`dp`,`#b794f4`,`#553c7a`,da()),swap_friendly:()=>R(`sw`,`#a78bfa`,`#312e81`,qi()),dominion:()=>z(`dm`,`#60a5fa`,`#1e3a5f`,va()),shield_1:()=>R(`s1`,`#60a5fa`,`#1e3a5f`,Xi()),shield_2:()=>z(`s2`,`#38bdf8`,`#0c4a6e`,$i()),bulwark:()=>B(`bw`,`#b794f4`,`#553c7a`,xi()),barrier:()=>R(`br`,`#94a3b8`,`#1f2937`,Gi()),last_stand:()=>z(`ls`,`#38bdf8`,`#0c4a6e`,pa()),fortify:()=>B(`fo`,`#a78bfa`,`#4c1d95`,Ci()),sanctuary_pulse:()=>z(`sp`,`#7dd3fc`,`#1e3a5f`,fa()),sanctuary:()=>B(`sa`,`#c4b5fd`,`#4c1d95`,Ei()),deflect_1:()=>z(`df`,`#38bdf8`,`#0c4a6e`,ta()),anchor_2:()=>R(`an`,`#94a3b8`,`#1f2937`,Pi()),iron_will:()=>R(`iw`,`#9ca3af`,`#1f2937`,Vi()),vengeance:()=>B(`vg`,`#9f7aea`,`#3b0764`,Ti()),rally:()=>R(`rl`,`#60a5fa`,`#1e3a5f`,zi()),forward_bolt:()=>z(`fb`,`#fde68a`,`#1e3a5f`,na()),destroy_unshielded:()=>Lr(`sh`,`#4338ca`,`#1e1b4b`,Wr()),pyromancy:()=>Lr(`py`,`#ea580c`,`#431407`,Gr()),snipe:()=>z(`sn`,`#fde68a`,`#1e3a5f`,_a()),duel:()=>R(`du`,`#d4b896`,`#3d2817`,Xr()),sacrifice:()=>z(`sc`,`#fca5a5`,`#1e3a5f`,ca()),cull:()=>V(`cu`,`#a78bfa`,`#2e1065`,Yr()),execution:()=>V(`ex`,`#6ee7b7`,`#14532d`,Zr()),chain_lightning:()=>Lr(`cl`,`#2563eb`,`#0c1929`,Ur()),backstab:()=>z(`bk`,`#c4a574`,`#2d4a6e`,Vr()),cryo_bolt:()=>z(`cb`,`#7dd3fc`,`#0c4a6e`,ma()),bomb:()=>Lr(`bm`,`#f59e0b`,`#78350f`,Hr()),shockwave:()=>V(`sw`,`#c4b5fd`,`#3b1f6e`,ei()),plague:()=>V(`pg`,`#86efac`,`#14532d`,ti()),magnet:()=>V(`mg`,`#6ee7b7`,`#14532d`,Qr()),poison_3:()=>z(`po`,`#86efac`,`#14532d`,ea()),root_2:()=>z(`ro`,`#86efac`,`#14532d`,sa()),panic:()=>R(`pn`,`#fca5a5`,`#1f2937`,Ki()),blizzard:()=>B(`bz`,`#7dd3fc`,`#1e3a5f`,bi()),snowball:()=>R(`sb`,`#bae6fd`,`#0c4a6e`,Zi()),berserk:()=>Lr(`bk`,`#991b1b`,`#450a0a`,Jr()),create_foe:()=>R(`cf`,`#78716c`,`#292524`,Wi()),deep_freeze:()=>V(`df`,`#7dd3fc`,`#0c4a6e`,ai()),reverse_only_2:()=>z(`rv`,`#fca5a5`,`#1e3a5f`,oa()),press:()=>R(`pr`,`#fca5a5`,`#1f2937`,Yi()),tangle:()=>B(`tg`,`#93c5fd`,`#312e81`,hi()),blind:()=>B(`bl`,`#a78bfa`,`#4c1d95`,ki()),confusion:()=>V(`cf`,`#c4b5fd`,`#4c1d95`,ri()),fog_2:()=>Or(`${kr(32,34,6)}<ellipse cx="32" cy="24" rx="16" ry="8" fill="currentColor" opacity="0.22"/>`),crown:()=>z(`cr`,`#fbbf24`,`#451a03`,ra()),demote:()=>R(`dm`,`#fca5a5`,`#1f2937`,Hi()),fusion:()=>B(`fu`,`#8b5cf6`,`#4c1d95`,Di()),clone:()=>V(`cln`,`#93c5fd`,`#312e81`,ui()),chameleon:()=>B(`ch`,`#86efac`,`#312e81`,Oi()),hibernation:()=>B(`hi`,`#c4b5fd`,`#4c1d95`,wi()),quicksand:()=>R(`qs`,`#a8a29e`,`#292524`,Ui()),landmine:()=>z(`lm`,`#78716c`,`#292524`,aa()),collapse:()=>R(`co`,`#78716c`,`#292524`,ha()),darkness:()=>B(`dk`,`#6d28d9`,`#1e1b4b`,Si()),scatter:()=>z(`st`,`#7dd3fc`,`#1e3a5f`,la()),call_forward:()=>B(`cfw`,`#fca5a5`,`#4c1d95`,vi()),dash:()=>B(`ds`,`#c4b5fd`,`#4c1d95`,yi()),earthquake:()=>Lr(`eq`,`#78716c`,`#292524`,qr()),coin_flip:()=>fi(),ignore:()=>R(`ig`,`#94a3b8`,`#1f2937`,Bi()),counterspell:()=>V(`cs`,`#a78bfa`,`#2e1065`,ii()),purify:()=>V(`pu`,`#6ee7b7`,`#14532d`,si()),trickster:()=>B(`tr`,`#c4b5fd`,`#553c7a`,Ai()),offering:()=>B(`of`,`#d8b4fe`,`#553c7a`,mi()),quick_march:()=>V(`qm`,`#60a5fa`,`#1e3a5f`,$r()),constitution:()=>V(`co`,`#4ade80`,`#14532d`,di()),last_king:()=>z(`lk`,`#fbbf24`,`#1e3a5f`,ga()),revive:()=>Lr(`rv`,`#15803d`,`#052e16`,Kr()),mind_control:()=>V(`mc`,`#c4b5fd`,`#3b0764`,ni()),bounty:()=>V(`bo`,`#4ade80`,`#14532d`,ci()),link_fate:()=>V(`lf`,`#a78bfa`,`#2e1065`,li()),bishop_2:()=>B(`bp`,`#b794f4`,`#4c1d95`,gi()),rook_2:()=>B(`rk`,`#a78bfa`,`#4c1d95`,_i()),hostile_swap:()=>V(`hs`,`#93c5fd`,`#312e81`,oi()),deport:()=>V(`dp`,`#c4b5fd`,`#1e1b4b`,pi())};function ba(e,t=0){let n=ya[e.effect];return n?n(t):null}var xa={movement:{symbol:`↗`,label:`Motion`,anim:`movement`},combat:{symbol:`⚔`,label:`Strike`,anim:`combat`},defense:{symbol:`🛡`,label:`Ward`,anim:`defense`},debuff:{symbol:`❄`,label:`Curse`,anim:`debuff`},transform:{symbol:`✦`,label:`Morph`,anim:`transform`},board:{symbol:`◇`,label:`Terrain`,anim:`board`},crown:{symbol:`♔`,label:`Royal`,anim:`crown`},arcane:{symbol:`✧`,label:`Arcane`,anim:`arcane`}},Sa=[[`movement`,[`nudge`,`backstep`,`long_step`,`leapfrog`,`recall`,`teleport`,`random_teleport`,`displacement`,`berserk`,`dash`]],[`combat`,[`stab`,`shatter`,`destroy`,`snipe`,`duel`,`execution`,`cull`,`pyromancy`,`backstab`,`sacrifice`,`chain_lightning`,`cryo`,`bomb`,`magnet`]],[`special`,[`create_foe`,`clone`,`earthquake`]],[`defense`,[`shield`,`ward`,`aegis`,`bulwark`,`stall`,`sanctuary`,`barrier`,`anchor`,`iron_will`,`hibernation`,`constitution`]],[`debuff`,[`root`,`panic`,`backpedal`,`blizzard`,`deep_freeze`,`snowball`,`blind`,`confusion`,`press`,`tangle`,`shockwave`]],[`board`,[`quicksand`,`landmine`,`collapse`,`darkness`,`earthquake`,`scatter`,`call_forward`]],[`meta`,[`counterspell`,`vengeance`,`last_stand`,`purify`,`trickster`,`ignore`,`offering`,`quick_march`,`dominion`,`last_king`,`revive`,`mind_control`]]];function Ca(e){let t=0;for(let n=0;n<e.length;n++)t=(t+e.charCodeAt(n)*41)%360;return t}function wa(e){let t=0;for(let n=0;n<e.length;n++)t=(t+e.charCodeAt(n)*13)%3;return t}function Ta(e){let t=`${e.id} ${e.effect} ${e.name}`.toLowerCase();for(let[e,n]of Sa)if(Array.isArray(n)&&n.some(e=>t.includes(e)))return e;return`arcane`}function Ea(e){return`ca${String(e).replace(/[^a-zA-Z0-9]/g,``)}`}function Da(e,t,n){let r=[[12,18,.35],[48,12,.5],[52,44,.25],[18,50,.4],[38,28,.55]],i=n*4;return r.map(([e,n,r],a)=>`<circle cx="${(e+i+a*7)%56+4}" cy="${(n+i*2+a*5)%52+6}" r="1.2" fill="hsl(${t} 90% 85% / ${r})"/>`).join(``)}function Oa(e,t){let n=t,r={movement:`
      ...
      </g>`};return r[e]||r.arcane}function ka(e,t,n,r){return Aa(e,t,n,r)}function Aa(e,t,n,r){let i=Ea(n),a=(t+42)%360,o=wa(n),s=r&&ba(r,o)||Oa(e,o);return r?.effect&&Br(r.effect)&&s?`<svg class="spell-card__svg spell-card__svg--full-bleed" viewBox="0 0 70 60" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid meet">${s}</svg>`:`<svg class="spell-card__svg" viewBox="0 0 70 60" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
    ...
    <div class="spell-card__frame">
      ...
      <div class="spell-card__type-frame${s?` spell-card__type-frame--with-hint`:``}">
        ...
        ${t.meta?`<span class="spell-card__meta">${Ia(t.meta)}</span>`:``}
      </div>
      ${o?`<div class="spell-card__text-frame"><p class="spell-card__desc">${Ia(e.desc)}</p></div>`:``}
    </div>
    <div class="spell-card__tooltip" role="tooltip">
      <strong>${Ia(e.name)}</strong>
      ${Ma(e)}
    </div>
  `,t.onClick&&l.addEventListener(`click`,n=>t.onClick(n,e)),Pa(l),l}function Ia(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function La(e){return document.getElementById(e)}function Ra(){let e=La(`card-preview-modal`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function za(e){document.body.classList.toggle(`card-preview-open`,e),window.dispatchEvent(new CustomEvent(`card-preview-change`,{detail:{open:e}}))}function Ba(){La(`card-preview-modal`)?.classList.add(`hidden`),La(`card-preview-mount`)?.classList.remove(`card-preview-mount--reveal-only`),za(!1)}function Va(e,t={}){Ra();let n=La(`card-preview-modal`),r=La(`card-preview-mount`),i=La(`card-preview-actions`);if(!(!n||!r||!e)){if(r.innerHTML=``,r.classList.toggle(`card-preview-mount--reveal-only`,!!t.hideDesc),r.appendChild(Fa(e,{static:!0,hideDesc:t.hideDesc})),i){if(i.innerHTML=``,t.meta){let e=document.createElement(`p`);e.className=`card-preview-meta`,e.textContent=t.meta,i.appendChild(e)}let e=document.createElement(`div`);if(e.className=`card-preview-actions-row`,t.onPlay){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=`Cast spell`,n.addEventListener(`click`,()=>{Ba(),t.onPlay()}),e.appendChild(n)}if(t.onAdd){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=`Add to deck`,n.disabled=!!t.addDisabled,n.addEventListener(`click`,()=>{t.addDisabled||t.onAdd()}),e.appendChild(n)}if(t.onBuy){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=t.buyLabel||`Buy copy`,n.disabled=!!t.buyDisabled,n.addEventListener(`click`,()=>{t.buyDisabled||t.onBuy()}),e.appendChild(n)}if(t.onRemove){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-secondary`,n.textContent=`Remove all from deck`,n.addEventListener(`click`,()=>{t.onRemove(),Ba()}),e.appendChild(n)}e.children.length&&i.appendChild(e)}n.classList.remove(`hidden`),za(!0)}}function Ha(){La(`card-preview-close`)?.addEventListener(`click`,Ba),La(`card-preview-backdrop`)?.addEventListener(`click`,Ba),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&Ba()})}function Ua(e,t=`.spell-card`){e&&e.querySelectorAll(t).forEach((e,t)=>{e.classList.add(`spell-card--deal`),e.style.animationDelay=`${t*.1}s`})}function Wa(e){e&&(e.classList.add(`spell-card--rare-burst`),setTimeout(()=>e.classList.remove(`spell-card--rare-burst`),900))}function Ga(e){e&&(e.classList.add(`spell-card--epic-burst`),setTimeout(()=>e.classList.remove(`spell-card--epic-burst`),1200))}function Ka(e){e&&(e.classList.add(`spell-card--legendary-burst`),setTimeout(()=>e.classList.remove(`spell-card--legendary-burst`),1500))}function qa(e,t){t===`legendary`?Ka(e):t===`epic`?Ga(e):t===`rare`&&Wa(e)}var Ja={common:10,uncommon:20,rare:30,epic:40,legendary:50};function Ya(e){return Ja[e]??30}function Xa(e,r){let i=oe(e,r);if(i<1)return{success:!1,message:`Get this spell from a chest first.`};let a=n(r);if(!a)return{success:!1,message:`Unknown card.`};let o=t(r);if(i>=o)return{success:!1,message:`You already own the maximum (${o} copies).`};let s=Ya(a.rarity);if(e.gems<s)return{success:!1,message:`Need ${s} gems (${e.gems} available).`};e.gems-=s;let c=ye(e,r,1);return c?{success:!0,cost:s,message:`+1 ${a.name} for ${s} gems (${i+c} owned).`}:(e.gems+=s,w(e),{success:!1,message:`You already own the maximum copies for this rarity.`})}var Za={deck:`<svg class="nav-icon-svg" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  </svg>`};function Qa(){let e={deck:Za.deck,chests:Za.chests,play:Za.play,pvp:Za.pvp,quests:Za.quests};for(let t of document.querySelectorAll(`.game-nav .tab-btn[data-tab]`)){let n=t.querySelector(`.tab-btn__icon`),r=t.dataset.tab;n&&e[r]&&(n.innerHTML=e[r])}}var $a=`arcaneCheckersSettings_v1`,eo={musicEnabled:!0,musicVolume:.45,sfxEnabled:!0,sfxVolume:.7,hapticsEnabled:!0},to={...eo};function no(){try{let e=localStorage.getItem($a);return e?{...eo,...JSON.parse(e)}:{...eo}}catch{return{...eo}}}function H(){return{...to}}function ro(e){to={...to,...e};try{localStorage.setItem($a,JSON.stringify(to))}catch{}return window.dispatchEvent(new CustomEvent(`arcane-settings-changed`,{detail:H()})),H()}function io(){return to=no(),H()}var ao={hub:`assets/audio/background.m4a`,match:`assets/audio/background.m4a`},oo={tap:`assets/audio/sfx/tap.mp3`,spell:`assets/audio/sfx/spell.mp3`,capture:`assets/audio/sfx/capture.mp3`,win:`assets/audio/sfx/win.mp3`,chest:`assets/audio/sfx/chest.mp3`},so=null,co=null,lo=`hub`,uo=!1;function fo(){return typeof Audio<`u`}function po(e,t){if(!(!fo()||!H().sfxEnabled))try{let n=new Audio(e);n.volume=Math.max(0,Math.min(1,t*H().sfxVolume)),n.play().catch(()=>{})}catch{}}function mo(e){let t=ao[e];if(!t||!fo())return null;let n=e===`hub`?so:co;return n||(n=new Audio(t),n.loop=!0,n.preload=`auto`,e===`hub`?so=n:co=n),n}function ho(e){e&&(e.volume=Math.max(0,Math.min(1,H().musicVolume)))}function go(){so?.pause(),co?.pause()}function _o(){uo||!fo()||(uo=!0,[so,co].forEach(e=>{e&&e.play().then(()=>e.pause()).catch(()=>{})}))}function vo(e){if(lo=e,!H().musicEnabled){go();return}let t=mo(`hub`),n=mo(`match`);e===`match`?(t?.pause(),n&&(ho(n),n.play().catch(()=>{}))):(n?.pause(),t&&(ho(t),t.play().catch(()=>{})))}function yo(){if(!H().musicEnabled){go();return}ho(so),ho(co),vo(lo)}function bo(){if(!fo())return;window.addEventListener(`arcane-settings-changed`,()=>yo());let e=()=>{_o(),H().musicEnabled&&vo(lo),window.removeEventListener(`pointerdown`,e),window.removeEventListener(`keydown`,e)};window.addEventListener(`pointerdown`,e,{once:!0}),window.addEventListener(`keydown`,e,{once:!0})}function xo(e){let t=oo[e];t&&po(t,1)}var So={tap:()=>xo(`tap`),spell:()=>xo(`spell`),capture:()=>xo(`capture`),win:()=>xo(`win`),chest:()=>xo(`chest`)},Co=null,wo=!1;async function To(){if(wo)return Co;wo=!0;try{let{Capacitor:e}=await E(async()=>{let{Capacitor:e}=await import(`./dist-DM6qMOWp.js`);return{Capacitor:e}},[],import.meta.url);if(!e.isNativePlatform())return null;Co=(await E(()=>import(`./esm-TGGH6JYM.js`),[],import.meta.url)).ScreenOrientation}catch{Co=null}return Co}async function Eo(){document.body.classList.remove(`orientation-match`),document.body.classList.add(`orientation-portrait`);let e=await To();if(e)try{await e.lock({orientation:`portrait`})}catch{}}async function Do(){await Eo()}var Oo=null;function ko(){return Oo||(Oo=document.createElement(`div`),Oo.id=`network-banner`,Oo.className=`network-banner hidden`,Oo.setAttribute(`role`,`status`),Oo.setAttribute(`aria-live`,`polite`),document.body.appendChild(Oo),Oo)}function Ao(){let e=ko(),t=!navigator.onLine;e.textContent=t?`No connection — some features need internet`:``,e.classList.toggle(`hidden`,!t)}function jo(){Ao(),window.addEventListener(`online`,Ao),window.addEventListener(`offline`,Ao)}async function Mo(){try{let{Capacitor:e}=await E(async()=>{let{Capacitor:e}=await import(`./dist-DM6qMOWp.js`);return{Capacitor:e}},[],import.meta.url);if(!e.isNativePlatform())return;let{StatusBar:t,Style:n}=await E(async()=>{let{StatusBar:e,Style:t}=await import(`./esm-C-SIlwqj.js`);return{StatusBar:e,Style:t}},[],import.meta.url);await t.setOverlaysWebView({overlay:!0}),await t.setStyle({style:n.Dark}),await t.setBackgroundColor({color:`#080a12`});let{SplashScreen:r}=await E(async()=>{let{SplashScreen:e}=await import(`./esm-Ck_AT-RK.js`);return{SplashScreen:e}},[],import.meta.url);await r.hide()}catch(e){console.warn(`Capacitor init skipped`,e)}}var No=null,Po=!1;async function Fo(){if(Po)return No;Po=!0;try{let{Capacitor:e}=await E(async()=>{let{Capacitor:e}=await import(`./dist-DM6qMOWp.js`);return{Capacitor:e}},[],import.meta.url);if(!e.isNativePlatform())return null;let{Haptics:t,ImpactStyle:n}=await E(async()=>{let{Haptics:e,ImpactStyle:t}=await import(`./esm-D_it6P9V.js`);return{Haptics:e,ImpactStyle:t}},[],import.meta.url);No={Haptics:t,ImpactStyle:n}}catch{No=null}return No}async function Io(){if(!H().hapticsEnabled)return;let e=await Fo();if(e)try{await e.Haptics.impact({style:e.ImpactStyle.Light})}catch{}}var Lo={bronze:{label:`Bronze`,tagline:`Same odds as Bronze Chest`,visual:`bronze`,accent:`#c77dff`,glow:`rgba(199, 125, 255, 0.45)`},silver:{label:`Silver`,tagline:`Same odds as Silver Chest`,visual:`silver`,accent:`#7dd3fc`,glow:`rgba(125, 211, 252, 0.5)`},gold:{label:`Gold`,tagline:`Same odds as Gold Chest`,visual:`gold`,accent:`#ffd87a`,glow:`rgba(255, 216, 122, 0.55)`}};function Ro(e){let t=Lo[e]||Lo.style_crate,n=t.visual;return{tier:t,lid:n===`gold`?`#f0e6c8`:n===`silver`?`#e4ecf8`:`#e8c4f8`,body:n===`gold`?`#5a4518`:n===`silver`?`#3d4a62`:`#4a2860`,trim:t.accent,ribbon:n===`gold`?`#ff9de2`:n===`silver`?`#a5f3fc`:`#d8b4fe`}}function zo(e,t){let{lid:n,body:r,trim:i,ribbon:a}=Ro(e);return`
    <defs>
      <linearGradient id="${t}-body" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stop-color="${r}"/>
    ...
    </defs>`}function Bo(e,t,n){let{trim:r,ribbon:i,tier:a}=Ro(e);return`
    ${n?`<g class="chest-stage__interior">
    ...
    </g>`}function Vo(e){let t=`vanityStage-${e}`;return`<svg class="chest-stage-svg vanity-box-svg" viewBox="0 0 120 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ${zo(e,t)}
    <ellipse class="chest-stage__shadow" cx="60" cy="90" rx="42" ry="8" fill="rgba(0,0,0,0.5)"/>
    ${Bo(e,t,!0)}
  </svg>`}function Ho(e){let t=`vanityCard-${e}`;return`<svg class="chest-svg vanity-box-svg" viewBox="0 0 120 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ${zo(e,t)}
    <ellipse cx="60" cy="90" rx="42" ry="8" fill="rgba(0,0,0,0.5)"/>
    ${Bo(e,t,!1)}
  </svg>`}function Uo(e){let t=Wo[e]||Wo.avatar_default,n=`av-${e.replace(/[^a-z0-9]/gi,``)}`;return`<svg viewBox="0 0 64 64" class="cosmetic-avatar-svg cosmetic-avatar-svg--${e.replace(`avatar_`,``)}" aria-hidden="true">
    <defs>
    ...
    ${t.svg}
  </svg>`}var Wo={avatar_default:{bg:[`#4a5f7a`,`#1e2a3a`],glow:`#8fa4c4`,svg:`<ellipse cx="32" cy="38" rx="14" ry="16" fill="#2a3548"/>
      ...
      <circle cx="36" cy="26" r="2" fill="#0a1628"/>`}};function Go(e){let t={banner_default:`linear-gradient(135deg,#1e2a44,#2d4a6e)`,banner_nebula:`linear-gradient(135deg,#2a1f4e,#6b4fd4 55%,#1a1030)`,banner_crimson:`linear-gradient(135deg,#3a1018,#8b2030 50%,#1a0a10)`,banner_storm:`linear-gradient(135deg,#1a2840,#3d7ab8 45%,#9ad4ff)`,banner_aurora:`linear-gradient(135deg,#0f3d3a,#5ce1e6 40%,#9f7aea 80%,#1a0a20)`,banner_forest:`linear-gradient(135deg,#1a2e0e,#2d5016 50%,#0f1a08)`,banner_sunset:`linear-gradient(135deg,#431407,#c2410c 45%,#fdba74 75%,#1a0a04)`,banner_midnight:`linear-gradient(135deg,#0f172a,#1e3a5f 50%,#020617)`,banner_ocean:`linear-gradient(135deg,#042f2e,#0e7490 45%,#164e63 80%,#020617)`,banner_eclipse:`linear-gradient(135deg,#0a0a0a,#1a1a2e 35%,#fbbf24 50%,#0a0a0a 65%,#312e81)`,banner_sand:`linear-gradient(135deg,#78350f,#d97706 45%,#fcd34d 75%,#451a03)`,banner_mist:`linear-gradient(135deg,#374151,#6b7280 50%,#9ca3af 80%,#1f2937)`,banner_dawn:`linear-gradient(135deg,#4a1942,#ec4899 40%,#fbbf24 70%,#1a0a20)`};return t[e]||t.banner_default}function Ko(e){return e===`pieceSkin`?`Piece skin`:e===`frame`?`Frame`:e===`avatar`?`Avatar`:e===`banner`?`Banner`:e}function qo(e){return`profile-frame profile-frame--${(e||`frame_default`).replace(/^frame_/,``)}`}function Jo(e){return(e||`frame_default`).replace(/^frame_/,``),`<div class="cosmetic-frame-preview ${qo(e)}">
    <div class="cosmetic-frame-preview__inner">${Uo(`avatar_default`)}</div>
  </div>`}function Yo(e,t){return t===`avatar`?Uo(e):t===`frame`?Jo(e):t===`banner`?`<div class="cosmetic-preview-banner" style="background:${Go(e)}"></div>`:t===`pieceSkin`?Xo(e):``}function Xo(e){let t=e.replace(`skin_`,``);return`<div class="cosmetic-skin-preview">
    <span class="piece red piece-skin-${t} king"></span>
    <span class="piece black piece-skin-${t}"></span>
  </div>`}function Zo(e){let t=document.createElement(`article`);t.className=`cosmetic-reveal-card rarity-${e.rarity} cosmetic-reveal-card--${e.type}`,e.duplicate&&t.classList.add(`cosmetic-reveal-card--duplicate`);let n=Yo(e.id,e.type),r=Ko(e.type);return t.innerHTML=`
    ...
    </div>`,t.style.animationDelay=`0s`,t}function Qo(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function $o(e,t=``){let n=o(e),r=(t||`P`).charAt(0).toUpperCase(),i=Uo(n.equipped.avatar)||`<span class="profile-avatar-fallback">${Qo(r)}</span>`;return`<span class="profile-avatar-stack header-profile-btn__stack ${qo(n.equipped.frame)}"><span class="profile-avatar-inner header-profile-btn__inner">${i}</span></span>`}async function es(e){if(!e)return``;try{return(await Ae(e.id))?.username||e.user_metadata?.display_name||e.email?.split(`@`)[0]||``}catch{return e.user_metadata?.display_name||e.email?.split(`@`)[0]||``}}var ts=null;function ns(){return ts||=Promise.all([E(()=>import(`./match-CsnvGKoI.js`),[],import.meta.url),E(()=>import(`./matchView-DTNtUwB2.js`),[],import.meta.url),E(()=>Promise.resolve({}),__vite__mapDeps([0]),import.meta.url),E(()=>Promise.resolve({}),__vite__mapDeps([1]),import.meta.url)]).then(([e,t])=>({MatchSession:e.MatchSession,getMatchHtml:t.getMatchHtml})),ts}var rs=null;function is(){return rs||=Promise.all([E(()=>import(`./pvpUI-CVHC3nIw.js`),[],import.meta.url),E(()=>import(`./pvp-Bx0g6H9u.js`),[],import.meta.url)]).then(([e,t])=>({initPvpUI:e.initPvpUI,clearAllWaitingRoomsOnce:t.clearAllWaitingRoomsOnce})),rs}var as=null;function os(){return as||=E(()=>import(`./profileUI-DMCylJTq.js`),[],import.meta.url),as}function ss(){as=null}var cs=null;function ls(){return cs||=Promise.all([E(()=>import(`./settingsUI-CORgg1bs.js`),[],import.meta.url),E(()=>Promise.resolve({}),__vite__mapDeps([2]),import.meta.url)]).then(([e])=>e),cs}var us=null;function ds(){return us||=Promise.all([E(()=>import(`./chestOpenAnimation-B79P7kf6.js`),[],import.meta.url),E(()=>import(`./cosmeticOpenAnimation-DgD-wFzo.js`),[],import.meta.url),E(()=>import(`./titleOpenAnimation-ClhX_AvC.js`),[],import.meta.url)]).then(([e,t,n])=>({playChestOpenAnimation:e.playChestOpenAnimation,playCosmeticOpenAnimation:t.playCosmeticOpenAnimation,playTitleOpenAnimation:n.playTitleOpenAnimation})),us}var fs=null;function ps(){return fs||=E(()=>import(`./tutorialMeta-B4JKqQe2.js`),[],import.meta.url),fs}var ms=null;function hs(){return ms||=E(()=>import(`./tutorialUnlocks-BmtsIyvl.js`),[],import.meta.url),ms}var gs=null;function _s(){return gs||=E(()=>import(`./tutorialMatch-Be19-R8Y.js`),[],import.meta.url),gs}function vs(e,t){ps().then(n=>n.notifyMetaTutorial(e,t))}function ys(e,t){hs().then(n=>n.notifyUnlockTutorial(e,t))}var U;try{U=T()}catch(e){console.error(`Failed to load profile, resetting save:`,e),localStorage.removeItem(`cardCheckersProfile_v7`),localStorage.removeItem(`cardCheckersProfile_v5`),U=T()}var W=`deck`,bs={deck:`Decks`,chests:`Shop`,play:`Play`,pvp:`PvP`,quests:`Quests`,profile:`Profile`,settings:`Settings`},xs=new Set(Object.keys(bs)),Ss=`cards`,Cs=`list`,G=null,K=[],ws=null,Ts=``,Es=`all`,Ds=`all`,Os=!0,ks={legendary:5,epic:4,rare:3,uncommon:2,common:1};function As(e){return[...e].sort((e,t)=>{let n=ks[e.rarity]??0,r=ks[t.rarity]??0;return n===r?e.name.localeCompare(t.name):r-n})}var q=null,js=null,Ms=null;function Ns(){return js?Promise.resolve(js):(Ms||=is().then(({initPvpUI:e,clearAllWaitingRoomsOnce:t})=>(t(),js=e({root:document.getElementById(`view-pvp`),getProfile:()=>U,openAuthModal:()=>Fs?.open(`signin`,{forced:!0}),onNavigateTab:Z,onOpenDeckEdit:Zc,onPvpViewShown:()=>{W=`pvp`,tc()}}),js)),Ms)}var Ps=null,Fs=null,J=!1,Is=!1,Ls=!1,Rs=!1,zs=!1,Bs=null,Vs=null,Hs=null,Y=1,Us=null;function Ws(e){return ks[e?.rarity]??0}function Gs(e){let t=i(e);return Object.entries(t).map(([e,t])=>({def:n(e),count:t})).filter(e=>e.def).sort((e,t)=>{let n=Ws(t.def)-Ws(e.def);return n===0?e.def.name.localeCompare(t.def.name):n})}function Ks(e){let t=K.indexOf(e);t<0||(K.splice(t,1),tl(),vs(`card-removed-from-deck`,{cardId:e}))}function qs(e){let t=K.length;K=K.filter(t=>t!==e),K.length!==t&&(tl(),vs(`card-removed-from-deck`,{cardId:e}))}function Js(){let n=e().map(e=>({def:e,owned:oe(U,e.id)})).filter(e=>e.owned>0).sort((e,t)=>{let n=Ws(t.def)-Ws(e.def);return n===0?e.def.name.localeCompare(t.def.name):n});K=[];for(let{def:e,owned:r}of n){let n=Math.min(r,t(e));for(let t=0;t<n&&K.length<30;t++)K.push(e.id);if(K.length>=30)break}tl()}var X=e=>document.getElementById(e);function Ys(){let e=document.getElementById(`adventure-prebattle`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function Xs(){let e=document.querySelector(`nav.game-nav.tabs`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function Zs(){return window.matchMedia(`(min-width: 1000px) and (max-width: 1400px)`).matches?2.5:window.matchMedia(`(min-width: 600px) and (max-width: 999px)`).matches?1.85:1}function Qs(){Ys(),document.getElementById(`adventure-prebattle`)?.classList.remove(`hidden`),document.body.classList.add(`adventure-floor-open`)}function $s(){document.getElementById(`adventure-prebattle`)?.classList.add(`hidden`),document.body.classList.remove(`adventure-floor-open`)}function ec(e=x,t=`Locked`){Gn({title:t,bodyHtml:e,autoCloseMs:4500})}function tc(){document.body.classList.toggle(`main-tab-active`,xs.has(W)),document.body.classList.toggle(`adventure-active`,W===`play`)}function nc(e,t,n){let r=e.querySelector(`.tab-btn__sign-in-badge`);t?(r||(r=document.createElement(`span`),r.className=`tab-btn__sign-in-badge`,r.setAttribute(`aria-hidden`,`true`),e.appendChild(r)),r.textContent=n,e.classList.add(`tab-btn--sign-in-nudge`)):(r?.remove(),e.classList.remove(`tab-btn--sign-in-nudge`))}function rc(){let e=g(U),t=$t();for(let n of[`quests`,`pvp`]){let r=document.querySelector(`.tab-btn[data-tab="${n}"]`);if(!r)continue;let i=n===`pvp`?`PvP`:`Quests`,a=!e,o=n===`pvp`?Zt:Qt;r.classList.toggle(`tab-btn--locked`,a),r.setAttribute(`aria-disabled`,a?`true`:`false`),a?(r.title=t?`${c(i)} ${o}.`:c(i),nc(r,t,`Sign in`)):t?(r.title=o,nc(r,n===`pvp`,`Sign in`)):(r.title=``,nc(r,!1))}let n=m(U),r=document.querySelector(`.vault-tab[data-vault-tab="cosmetics"]`);r&&(r.classList.toggle(`vault-tab--locked`,!n),r.title=n?``:fe,r.setAttribute(`aria-disabled`,n?`false`:`true`))}async function Z(e){let t=document.getElementById(`view-match`);if(!(J&&t&&!t.classList.contains(`hidden`))){if(!Is&&(e===`quests`||e===`pvp`)&&!g(U)){let t=e===`pvp`?`PvP`:`Quests`,n=$t(),r=e===`pvp`?Zt:Qt;await $e(n?`${c(t)}\n\n${r}.`:c(t),{title:`${t} locked`,confirmLabel:`Go to Adventure`,cancelLabel:n?`Sign in`:`Not now`})?(Is=!0,Z(`play`),Is=!1):n&&Fs?.open(`signin`,{forced:!0});return}if(cr(),$n()&&tr()){if(e===W)return;if(!(e===`pvp`&&document.getElementById(`pvp-match-root`))){if(!await $e(`Leave your current match to open ${bs[e]||e}?`,{title:`Leave match?`,confirmLabel:`Leave`,cancelLabel:`Stay`,destructive:!0}))return;nr(e),ar(),document.querySelector(`#btn-leave-match`)?.click();return}}if(Cs===`edit`&&(e!==`deck`||e===`deck`&&W===`deck`)){if(!await Yc())return;Xc()}e!==`deck`&&Cs===`edit`&&(Oc(),document.body.classList.remove(`deck-editing`)),W=e,tc(),xs.has(e)&&Ec(),document.querySelectorAll(`.tab-btn`).forEach(t=>{t.classList.toggle(`active`,t.dataset.tab===e)}),document.querySelectorAll(`.view`).forEach(t=>{t.classList.toggle(`hidden`,t.id!==`view-${e}`)}),vs(`tab-changed`,{tab:e}),ys(`tab-changed`,{tab:e}),e===`chests`&&(Rc(Ss),Bc()),e===`deck`&&(Cs=`list`,Ac(`list`)),e===`profile`&&lc(),e===`settings`&&uc(),e===`quests`&&(pc(),hc()),e===`play`&&ol(),e===`pvp`&&Ns().then(e=>e?.render({resume:!0})).catch(e=>{console.error(`[PvP] init failed`,e);let t=document.getElementById(`view-pvp`);t&&!t.innerHTML.trim()&&(t.innerHTML=`<section class="panel game-panel pvp-panel"><p class="pvp-status pvp-status--error">Couldn't load PvP — please reload the page.</p></section>`)}),$n()||(vo(`hub`),await Eo())}}var Q=``;function ic(e=Q){e&&(Q=e);let t=document.getElementById(`header-profile-menu`),n=document.getElementById(`header-profile-btn`),r=document.getElementById(`header-username`),i=document.getElementById(`auth-header-btn`),a=!!D();if(i&&(i.classList.toggle(`hidden`,a),i.hidden=a),t&&(t.classList.toggle(`hidden`,!a),t.hidden=!a),r){let e=a&&Q;r.textContent=e?Q:``,r.classList.toggle(`hidden`,!e),r.hidden=!e}n&&a&&(n.innerHTML=$o(U,Q),n.title=Q?`Account — ${Q}`:`Account menu`)}function ac(){let e=document.getElementById(`header-profile-btn`),t=document.getElementById(`header-profile-dropdown`);!e||!t||(t.classList.add(`hidden`),t.hidden=!0,e.setAttribute(`aria-expanded`,`false`))}function oc(){let e=document.getElementById(`header-profile-menu`),t=document.getElementById(`header-profile-btn`),n=document.getElementById(`header-profile-dropdown`);if(!e||!t||!n)return;let r=e=>{n.classList.toggle(`hidden`,!e),n.hidden=!e,t.setAttribute(`aria-expanded`,e?`true`:`false`)};t.addEventListener(`click`,e=>{e.stopPropagation();let t=!n.hidden;r(!t)}),n.querySelectorAll(`[data-profile-menu-action]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.profileMenuAction;ac(),t===`settings`?Z(`settings`):cc()})}),document.addEventListener(`click`,t=>{n.hidden||e.contains(t.target)||ac()}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&!n.hidden&&ac()})}async function sc(){let e=D();if(!e){Q=``,ic();return}Q=await es(e),ic()}function cc(){ac(),Z(`profile`),ys(`profile-opened`)}async function lc(){let{renderProfileTab:e}=await os(),t=X(`view-profile`);e(U,t,{onGemsChange:gc,onTitleChanged:()=>ic()})}async function uc(){let{renderSettingsTab:e}=await ls();e(X(`view-settings`),{onUsernameChanged:e=>{Q=e,ic(e)}})}var dc=`
  ...
  </section>`;function pc(){let e=X(`view-quests`);e&&(e.innerHTML=dc)}function mc(e=X(`view-quests`)){e&&(e.innerHTML=fc,e.querySelector(`.quests-retry-btn`)?.addEventListener(`click`,()=>{ss(),pc(),hc()}))}async function hc(){let e=X(`view-quests`);if(e)try{let{renderQuestsTab:t}=await os();t(U,e,{onTitleChanged:()=>ic(),onCurrencyChange:()=>$()})}catch(t){console.error(`[Quests] render failed`,t),mc(e)}}function $(){let e=X(`header-gems`);e&&(e.textContent=String(U.gems??0));let t=X(`header-stars`);t&&(t.textContent=String(U.stars??0)),document.querySelector(`.hud-gems`)?.classList.toggle(`hud-gems--low`,(U.gems??0)<50),document.querySelector(`.hud-stars`)?.classList.toggle(`hud-stars--low`,(U.stars??0)<10)}function gc(){$()}function _c(){document.querySelectorAll(`.collection-owned-only-toggle`).forEach(e=>{e.checked=Os});for(let e of[`collection-search`]){let t=X(e);t&&(t.value=Ts)}for(let e of[`collection-rarity`]){let t=yr(e);t&&(t.value=Es)}let e=yr(`collection-category`);e&&(e.value=Ds)}var vc=`(max-width: 899px)`,yc=`(max-width: 1280px)`,bc=null;function xc(){return window.matchMedia(vc).matches}function Sc(){return document.body.classList.contains(`main-tab-active`)&&!document.body.classList.contains(`match-active`)&&!document.body.classList.contains(`deck-editing`)&&window.matchMedia(yc).matches}function Cc(){return document.querySelector(`.game-main`)}function wc(){let e=Cc();return Sc()&&e?e.scrollTop:window.scrollY||document.documentElement.scrollTop||0}function Tc(e){let t=Cc();if(Sc()&&t){t.scrollTop=e;return}window.scrollTo(0,e)}function Ec(){let e=Cc();if(Sc()&&e){e.scrollTop=0;return}window.scrollTo(0,0)}function Dc(){xc()&&(bc=wc(),document.body.style.position=`fixed`,document.body.style.top=`0`,document.body.style.left=`0`,document.body.style.right=`0`,document.body.style.width=`100%`)}function Oc(){if(bc==null)return;let e=bc;bc=null,document.body.style.position=``,document.body.style.top=``,document.body.style.left=``,document.body.style.right=``,document.body.style.width=``,Tc(e)}function kc(){Ec(),document.documentElement.scrollTop=0,document.body.scrollTop=0,document.querySelector(`.game-shell`)?.scrollTo?.(0,0),Cc()?.scrollTo?.(0,0),document.querySelector(`#view-deck`)?.scrollTo?.(0,0),document.querySelectorAll(`#deck-subview-edit, #deck-subview-edit .deck-editor, #deck-subview-edit .deck-editor__body, #deck-subview-edit .deck-editor__grid, #deck-subview-edit .deck-editor__grid-cards`).forEach(e=>{e.scrollTop=0})}function Ac(e){e!==`edit`&&Oc(),Cs=e,document.body.classList.toggle(`deck-editing`,e===`edit`),X(`deck-subview-list`)?.classList.toggle(`hidden`,e!==`list`),X(`deck-subview-edit`)?.classList.toggle(`hidden`,e!==`edit`),e===`edit`&&(Dc(),C(U),w(U),Es=`all`,Ts=``,Ds=`all`,Os=!0,_c(),qc()),e===`list`&&el(),e===`edit`&&(tl(),kc(),requestAnimationFrame(()=>{kc(),requestAnimationFrame(kc)}))}function jc({id:e,title:t,desc:n,cost:r,variant:i=`mystery`}){let a=(U.stars??0)>=r,o=i===`title`?Bt():Ht();return`
  ...
  `;let t=e.querySelectorAll(`.mystery-box`);Mc(t[0],()=>Fc()),Mc(t[1],()=>Ic())}function Rc(e){if(!Ls&&e===`cosmetics`&&!m(U)){ec(fe,`Cosmetics locked`),Ls=!0,Rc(`cards`),Ls=!1;return}Ss=e,document.querySelectorAll(`.vault-tab`).forEach(t=>{let n=t.dataset.vaultTab===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,n?`true`:`false`)}),document.querySelectorAll(`.vault-tab-panel`).forEach(t=>{let n=t.id===`vault-tab-${e}`;t.classList.toggle(`hidden`,!n),t.hidden=!n}),ys(`vault-tab-changed`,{tab:e})}function zc(){os().then(({renderCosmeticBoxes:e})=>{e(U,X(`cosmetic-box-list`),{logEl:X(`cosmetic-box-log`),onGemsChange:gc,cosmeticsUnlocked:m(U),onOpened:()=>{W===`profile`&&lc(),W===`quests`&&hc()}})})}function Bc(e={}){let{clearPulls:t=!0}=e;$(),zc(),Lc();let n=X(`chest-list`),r=X(`chest-pulls`);if(r&&t&&(r.innerHTML=``,r.classList.add(`chest-pulls--hidden`),r.classList.remove(`chest-pulls--reveal`)),n){n.innerHTML=``;for(let e of lt){let t=_t[e.id]||_t.bronze,i=U.gems>=e.cost,a=document.createElement(`article`);a.className=`chest-card chest-card--${e.id}${i?``:` chest-card--locked`}`,a.innerHTML=`
    ...
    `;let o=a.querySelector(`.chest-open`);o.disabled=!i,o.addEventListener(`click`,async()=>{if(o.disabled)return;let n=mt(U,e.id),i=X(`chest-log`);if(!n.success){i&&(i.textContent=n.message,i.classList.add(`chest-log--error`));return}w(U),$(),o.disabled=!0;let{playChestOpenAnimation:a}=await ds();if(await a({tier:e.id,tierLabel:t.label,pulls:n.pulls}),vs(`chest-opened`,{chestId:e.id}),i){let t=n.bonusGems?` (+${n.bonusGems} gems from duplicates)`:``;i.textContent=`Got ${n.pulls.length} spells from ${e.name}.${t}`,i.classList.remove(`chest-log--error`)}if(r){r.classList.remove(`chest-pulls--hidden`),r.classList.add(`chest-pulls--reveal`),r.innerHTML=`<p class="chest-pulls__label">Chest opened</p><div class="chest-pulls__grid"></div>`;let e=r.querySelector(`.chest-pulls__grid`);n.pulls.forEach((t,n)=>{let r=Fa(t,{button:!0,deal:!0,gallery:!0,onClick:()=>Va(t)});if(r.style.animationDelay=`${n*.12}s`,t.duplicate){r.classList.add(`spell-card--duplicate-pull`);let e=document.createElement(`span`);e.className=`chest-pull-dup-badge`,e.textContent=t.starRefund?`Duplicate · +${t.starRefund} ★`:`Duplicate · +${t.gemRefund} ◆`,r.appendChild(e)}e.appendChild(r),qa(r,t.rarity)}),Ua(e),r.scrollIntoView({behavior:`smooth`,block:`nearest`})}Bc()}),n.appendChild(a)}}}function Vc(){return As(e().filter(e=>{if(Ds!==`all`&&ct(e)!==Ds||Es!==`all`&&e.rarity!==Es)return!1;if(Ts){let t=Ts.toLowerCase();if(!e.name.toLowerCase().includes(t)&&!e.desc.toLowerCase().includes(t))return!1}return!(Os&&oe(U,e.id)<=0)}))}function Hc(e,t){let n=Xa(U,e);return t&&(t.textContent=n.message,t.className=n.success?`deck-status ok`:`deck-status warn`),n.success&&(w(U),$(),Cs===`list`&&el(),Cs===`edit`&&tl()),n}function Uc(e,t){let n=Xa(U,e);return n.success?(w(U),$(),K.push(e),ge(U,e),w(U),tl(),t&&(t.hidden=!1,t.textContent=`Bought and added to deck.`,t.className=`deck-editor__error deck-status ok`),!0):(t&&(t.hidden=!1,t.textContent=n.message,t.className=`deck-editor__error deck-status warn`),!1)}function Wc(e){return a(K,e,U).ok?(K.push(e),ge(U,e),w(U),tl(),vs(`card-added-to-deck`,{cardId:e}),!0):!1}function Gc(e,n,r={}){let{deckEdit:o=!1,statusEl:s=null}=r,c=oe(U,n.id),l=t(n),u=c>=l,d=Ya(n.rarity),f=U.gems>=d&&!u,p=o?a(K,n.id,U):{ok:!1},m=o&&i(K)[n.id]||0,h=K.length<30,g=m<l,_=c>=1&&c<=m,v=c>=1&&!u,y=o&&!p.ok&&h&&g&&_&&v,ee=()=>Hc(n.id,s),x=()=>{let e=oe(U,n.id),t=o&&i(K)[n.id]||0,r=e>=l,s=U.gems>=d&&!r,c=o?a(K,n.id,U):{ok:!1};Va(n,{meta:o?`Owned ${e}/${l} · In deck ${t}/${l} · ${r?`max copies`:`${d} gems per copy`}`:`Owned ${e}/${l}${r?` · max copies`:` · ${d} gems per copy`}`,buyLabel:r?`Max copies owned`:`Buy copy (${d} gems)`,buyDisabled:!s||r||e<1,onBuy:()=>{ee(),Ba()},addDisabled:!c.ok,onAdd:o?()=>{Wc(n.id)&&x()}:void 0})};if(o){let t=document.createElement(`div`);t.className=`deck-editor-tile`+(b(U,n.id)?` deck-editor-tile--new`:``);let r=Fa(n,{button:!0,gallery:!0,onClick:()=>x()});r.classList.add(`deck-editor-tile__card`),r.title=`${n.name} — tap for full card`;let i=c>0?`Owned ${c}/${l}`:`Not in collection`,a=document.createElement(`div`);a.className=`deck-editor-tile__meta`,a.innerHTML=`${i} · In deck ${m}/${l}${b(U,n.id)?`<span class="deck-editor-tile__new">New</span>`:``}`,a.addEventListener(`click`,()=>x());let o=document.createElement(`button`);o.type=`button`,o.className=`deck-editor-tile__action`,p.ok?(o.classList.add(`deck-editor-tile__action--add`),o.textContent=`+ Add to deck`,o.addEventListener(`click`,e=>{e.stopPropagation(),Wc(n.id)})):y?(o.classList.add(`deck-editor-tile__action--buy`),o.textContent=f?`Add for ${d} gems`:`Need ${d} gems`,o.disabled=!f,o.addEventListener(`click`,e=>{e.stopPropagation(),Uc(n.id,s)})):(o.classList.add(`deck-editor-tile__action--disabled`),o.disabled=!0,K.length>=30?o.textContent=`Deck full (30/30)`:m>=l?o.textContent=`Max copies in deck`:c<1?o.textContent=`Open Shop chests to unlock`:p.reason?o.textContent=p.reason:o.textContent=`Can't add`),t.append(r,a,o),e.appendChild(t);return}let S=document.createElement(`div`);S.className=`collection-card-wrap`+(c<1?` collection-card-wrap--unowned`:``);let te=Fa(n,{button:!0,compact:!0,disabled:c<1||u,onClick:e=>{if(e.shiftKey||c<1||u){x();return}ee()}});te.title=u?`${n.name} — max ${l} copies owned. Tap to view full card.`:c<1?`${n.name} — not owned. Tap to view full card.`:`${n.name} — tap to buy (${d} gems). Shift+click to inspect.`,S.appendChild(te);let C=document.createElement(`span`);C.className=`collection-owned-count`,C.textContent=c>0?`×${c}`:`—`,S.appendChild(C);let ne=document.createElement(`span`);ne.className=`collection-buy-cost`,ne.textContent=u?`MAX`:`${d} ◆`,(!f||u)&&ne.classList.add(`collection-buy-cost--cant`),S.appendChild(ne),e.appendChild(S)}function Kc(e,t={}){if(!e)return;let{deckEdit:n=!1,statusEl:r=null}=t;e.innerHTML=``;let i=Vc();if(!i.length){e.className=`deck-editor__grid collection-grid`;let t=document.createElement(`p`);t.className=`collection-grid-empty muted`,t.textContent=n?`No spells match your filters. Try “All types”, clear search, or uncheck Owned only.`:`No cards match your filters. Open chests in the Shop to get more spells.`,e.appendChild(t);return}let a=0,o={deckEdit:n,statusEl:r};if(n||Ds!==`all`){e.className=`deck-editor__grid collection-grid`;for(let t of i)try{Gc(e,t,o),a+=1}catch(e){console.error(`Failed to render card:`,t?.id,e)}}else{e.className=`deck-editor__grid collection-categories`;let t=Object.fromEntries(at.map(e=>[e,[]]));for(let e of i)t[ct(e)].push(e);for(let n of at){let r=t[n];if(!r.length)continue;let i=document.createElement(`section`);i.className=`collection-category-section`,i.dataset.category=n;let s=document.createElement(`h3`);s.className=`collection-category-title`,s.textContent=ot[n],i.appendChild(s);let c=document.createElement(`div`);c.className=`collection-grid deck-editor__grid-cards`;for(let e of r)try{Gc(c,e,o),a+=1}catch(t){console.error(`Failed to render card:`,e?.id,t)}i.appendChild(c),e.appendChild(i)}}if(i.length>0&&a===0){e.className=`deck-editor__grid collection-grid`;let t=document.createElement(`p`);t.className=`collection-grid-empty collection-grid-empty--error`,t.textContent=`Spells failed to display. Hard refresh the page (Ctrl+Shift+R).`,e.appendChild(t)}}function qc(){ws={name:X(`deck-name-input`)?.value?.trim()??``,cardIds:[...K]}}function Jc(){return ws?(X(`deck-name-input`)?.value?.trim()??``)!==ws.name||K.length!==ws.cardIds.length?!0:K.some((e,t)=>e!==ws.cardIds[t]):!1}async function Yc(){return Jc()?$e(`Discard unsaved changes to this deck?`,{title:`Unsaved changes`,confirmLabel:`Discard`,cancelLabel:`Keep editing`,destructive:!0}):!0}function Xc(){G=null,K=[],ws=null}function Zc(e){let t=U.decks.find(t=>t.id===e);if(!t)return;G=t.id,K=[...t.cardIds];let n=X(`deck-name-input`);n&&(n.value=t.name),Ac(`edit`),vs(`deck-edit-opened`,{deckId:e})}function Qc(e){let t=Object.fromEntries(at.map(e=>[e,0]));for(let r of e){let e=n(r);e&&(t[ct(e)]+=1)}return t}function $c(e){let t=Qc(e),n=[];for(let e of at){let r=t[e];if(r<=0)continue;let i=ot[e];n.push(`<span class="deck-row__cat" title="${Ia(i)}: ${r}"><span class="deck-row__cat-dot deck-row__cat-dot--${e}" aria-hidden="true"></span><span class="deck-row__cat-n">${r}</span></span>`)}return n.length?`<div class="deck-row__cats">${n.join(``)}</div>`:``}function el(){C(U)&&w(U),$();let e=X(`deck-list`);if(!e)return;e.innerHTML=``;let t=X(`deck-list-count`);if(t){let e=U.decks.length;t.textContent=e?`${e} deck${e===1?``:`s`}`:``}if(!U.decks.length){if(C(U)&&w(U),U.decks.length){el();return}e.innerHTML=`
      ...
      <h3 class="deck-row-name">${Ia(t.name)}</h3>
      <div class="deck-row__progress">
        <div class="deck-progress-bar deck-row__progress-bar" role="progressbar" aria-valuemin="0" aria-valuemax="30" aria-valuenow="${t.cardIds.length}" aria-label="${Ia(t.name)} progress">
    ...
    <div class="adventure-map-tower">
      ...
      <span class="adventure-map-tile__stone" aria-hidden="true">
        ...
        ${a>0?`<span class="adventure-floor-row__stars">${be(a)}</span>`:``}`,o.addEventListener(`click`,()=>bl(t.id)),g.appendChild(o)}}let _=r.querySelector(`.adventure-map-tile--next`);ul(r),_&&requestAnimationFrame(()=>{requestAnimationFrame(()=>_.scrollIntoView({behavior:`smooth`,block:`nearest`}))});let v=g?.querySelector(`.adventure-floor-row--next`);v&&requestAnimationFrame(()=>v.scrollIntoView({behavior:`smooth`,block:`end`})),r.querySelector(`.adventure-challenge-toggle`)?.addEventListener(`click`,t=>{t.preventDefault(),t.stopPropagation(),e.challengeMode=!e.challengeMode,U.adventure=e,w(U),Io(),So.tap(),fl()})}function pl(e){let t=me(e);if(!t||!Se(U.adventure,e))return;Hs=e,Qs();let n=X(`prebattle-title`),i=X(`prebattle-flavor`),a=X(`prebattle-opponent`);n&&(n.textContent=`Tower ${t.worldId} · Floor ${t.floorInWorld}`),i&&(i.textContent=t.flavor||``),a&&(a.textContent=`Loading…`);try{Us=v(U,e),w(U)}catch(e){console.error(`Enemy deck failed`,e),a&&(a.textContent=`Could not build enemy deck. Try again.`);return}a&&(a.textContent=`Review the enemy spell deck, then choose your grimoire below.`);let o=X(`prebattle-gem-hint`);if(o){let n=te(U.adventure,e);o.textContent=(s(U.adventure,e)?`Repeat clear: +${n} gems`:`First clear: +${n} gems`)+(t.worldId===5&&ee(U.adventure)?` · Challenge mode: enemy has an extra rank of pieces`:``)}let c=X(`enemy-deck-preview`);if(c){c.innerHTML=``;try{for(let{def:e,count:t}of ne(Us)){if(!e)continue;let n=document.createElement(`button`);n.type=`button`,n.className=`enemy-deck-spell-btn`,n.title=`View ${e.name}`;let r=document.createElement(`span`);if(r.className=`enemy-deck-spell-btn__name`,r.textContent=e.name,n.appendChild(r),t>1){let e=document.createElement(`span`);e.className=`enemy-deck-spell-btn__count`,e.textContent=`×${t}`,n.appendChild(e)}n.addEventListener(`click`,()=>Va(e,{meta:t>1?`${t} copies in enemy deck`:`Enemy deck`})),c.appendChild(n)}}catch(e){console.error(`Enemy preview failed`,e),c.innerHTML=`<p class="empty-msg">Enemy deck preview unavailable.</p>`}}C(U)&&w(U);let l=yr(`adventure-deck-select`);if(!l){a&&(a.textContent=`Deck selector missing — hard refresh the page.`);return}l.innerHTML=``;let u=U.decks.filter(e=>r(e.cardIds,U).valid);if(!u.length){let e=document.createElement(`option`);e.value=``,e.textContent=`No complete decks — build one in Decks`,l.appendChild(e),l.disabled=!0,X(`btn-start-adventure`).disabled=!0;return}l.disabled=!1;let d=U.selectedDeckId&&u.some(e=>e.id===U.selectedDeckId)?U.selectedDeckId:u[0].id;for(let e of u){let t=document.createElement(`option`);t.value=e.id,t.textContent=e.name,e.id===d&&(t.selected=!0),l.appendChild(t)}U.selectedDeckId=d,X(`btn-start-adventure`).disabled=!1}async function ml(e,t,n,r,i=null,a=!1,s=void 0){let c=t.opponent;al(),Us=null,document.querySelectorAll(`.view`).forEach(e=>e.classList.add(`hidden`)),X(`view-match`)?.classList.remove(`hidden`);let l=X(`view-match`);if(!l)return;let{MatchSession:u,getMatchHtml:p}=await ns();l.innerHTML=p(c);let m=s??(xe(r).id===5&&ee(U.adventure)),g={levelId:r,deckId:e.id,challengeMode:m},_={aiDeckIds:n,opponentName:c,cosmetics:o(U),profile:U,challengeMode:m,buildGameOverActions:({won:e,isTie:t})=>gl(g,{won:e,isTie:t}),onGameOverAction:e=>{_l(e,g,l)}};i&&(_.initialState=i);try{q=new u(e.cardIds,l,()=>{q=null,fr(),Eo(),vo(`hub`),l.innerHTML=``,X(`view-match`)?.classList.add(`hidden`),Z(rr()||`play`),Rs&&Sl(),zs&&Cl()},e=>{let t=f(U,r,e),{gems:n,stars:i,starsGained:a}=t;return U.gems+=n,h(U,`adventure_floors`,1),d(U),w(U),$(),rc(),r===1&&t.firstTime&&(Rs=!0,Sl()),r===5&&t.firstTime&&(zs=!0),{message:`+${n} gems! · Best: ${be(i)}`,starsGained:a}},_)}catch(e){throw q=null,l.innerHTML=``,X(`view-match`)?.classList.add(`hidden`),Z(`play`),e}ur({kind:`adventure`,deckId:e.id,deckCardIds:e.cardIds,aiDeckIds:n,opponentName:c,levelId:r,challengeMode:m}),await Eo(),vo(`match`),a&&(q.winRewarded=!0),pr(q),q.setMessage(``),q.render()}async function hl(){let e=mr();if(!e)return!1;let t=U.decks.find(t=>t.id===e.deckId)||U.decks.find(e=>e.cardIds?.length===30),n=e.levelId?me(e.levelId):null;return!t||t.cardIds.length!==30||!n||!e.aiDeckIds?.length||!await $e(`Resume your adventure match where you left off?`,{title:`Resume match?`,confirmLabel:`Resume`,cancelLabel:`Discard`})?(dr(),!1):(Hs=e.levelId,await ml(t,n,e.aiDeckIds,e.levelId,e.state,e.winRewarded,e.challengeMode),q?.setMessage(`Match resumed — pick up where you left off.`),!0)}function gl({levelId:e},{won:t,isTie:n}){let r=e+1,i=t&&r<=50&&Se(U.adventure,r);if(n)return[{id:`backToAdventure`,label:`Back to Adventure`,primary:!0}];if(t){let e=[];return i?(e.push({id:`nextFloor`,label:`Next floor`,primary:!0}),e.push({id:`retry`,label:`Retry floor`}),e.push({id:`backToAdventure`,label:`Back to Adventure`})):(e.push({id:`backToAdventure`,label:`Back to Adventure`,primary:!0}),e.push({id:`retry`,label:`Retry floor`})),e}return[{id:`retry`,label:`Retry floor`,primary:!0},{id:`backToAdventure`,label:`Back to Adventure`}]}async function _l(e,{levelId:t,deckId:n,challengeMode:r},i){let a=U.decks.find(e=>e.id===n);if(e===`backToAdventure`){q?.onExit?.();return}if(e===`retry`||e===`nextFloor`){let n=e===`nextFloor`?t+1:t,i=me(n);if(!a||a.cardIds.length!==30||!i){q?.onExit?.();return}q?.dispose(),q=null,fr(),await ml(a,i,v(U,n),n,null,!1,e===`retry`?r:void 0)}}function vl(){let e=yr(`adventure-deck-select`)?.value,t=U.decks.find(t=>t.id===e),n=Hs,r=n?me(n):null,i=Us?[...Us]:null;if(!t||t.cardIds.length!==30||!r||!i?.length){let e=X(`prebattle-opponent`);e&&(!t||t.cardIds.length!==30?e.textContent=`Build a complete 30-card deck in the Decks tab, then try again.`:e.textContent=`Could not start battle — close and pick the floor again.`);return}ml(t,r,i,n)}function yl(){if(window.__adventureMapCaptureBound)return;window.__adventureMapCaptureBound=!0;let e=null,t=!1,n=0,r=e=>e.closest?.(`#adventure-map .adventure-map-tile, #adventure-map .adventure-map-pin`),i=e=>e?.closest?.(`.adventure-map-scene`),a=()=>{t=!0,clearTimeout(n),n=setTimeout(()=>{t=!1},280)},o=(e,t)=>{if(!e||e.disabled)return;let n=Number(e.dataset.level);!Number.isFinite(n)||n<1||(t.preventDefault(),t.stopPropagation(),bl(n))};document.addEventListener(`pointerdown`,t=>{if(t.button!==0)return;let n=r(t.target);if(!n||n.disabled)return;let a=i(n);e={pin:n,pointerId:t.pointerId,startX:t.clientX,startY:t.clientY,scrollTop:a?.scrollTop??0,scrollLeft:a?.scrollLeft??0,cancelled:!1}},!0),document.addEventListener(`pointermove`,t=>{if(!e||t.pointerId!==e.pointerId||e.cancelled)return;let n=t.clientX-e.startX,r=t.clientY-e.startY;Math.hypot(n,r)>12&&(e.cancelled=!0);let a=i(e.pin);a&&(Math.abs(a.scrollTop-e.scrollTop)>3&&(e.cancelled=!0),Math.abs(a.scrollLeft-e.scrollLeft)>3&&(e.cancelled=!0))},!0),document.addEventListener(`pointerup`,t=>{if(!e||t.pointerId!==e.pointerId)return;let{pin:n,cancelled:r}=e;if(e=null,r){a();return}o(n,t),a()},!0),document.addEventListener(`pointercancel`,t=>{!e||t.pointerId!==e.pointerId||(e=null,a())},!0),document.addEventListener(`click`,e=>{if(t){e.preventDefault(),e.stopPropagation();return}let n=r(e.target);!n||n.disabled||o(n,e)},!0)}function bl(e){let t=se(U.adventure);if(U.adventure=t,!Se(t,e)){ec(`Locked — beat global floor ${e-1} first, then return here.`,`Floor locked`);return}w(U),pl(e)}function xl(){Xs(),window.addEventListener(`orientationchange`,Xs),window.addEventListener(`resize`,Xs),tc(),io(),Qa(),jo(),bo(),Do(),Mo(),Ha(),yl(),Ys(),document.querySelector(`.adventure-map-scene`)?.addEventListener(`scroll`,dl,{passive:!0});let e;window.addEventListener(`resize`,()=>{clearTimeout(e),e=setTimeout(()=>{if(!document.body.classList.contains(`adventure-active`))return;let e=X(`adventure-map`);e&&ul(e)},120)}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&al()}),document.querySelectorAll(`.tab-btn`).forEach(e=>{e.addEventListener(`click`,()=>{Io(),So.tap(),Z(e.dataset.tab)})}),document.querySelectorAll(`.vault-tab`).forEach(e=>{e.addEventListener(`click`,()=>{cr(),Rc(e.dataset.vaultTab)})}),X(`btn-new-deck`)?.addEventListener(`click`,il),X(`btn-back-from-edit`)?.addEventListener(`click`,async()=>{await Yc()&&(Xc(),Ac(`list`))}),X(`btn-delete-deck`)?.addEventListener(`click`,async()=>{if(!G||G===`new`)return;let e=U.decks.find(e=>e.id===G);e&&await $e(`Delete "${e.name}"? This cannot be undone.`,{title:`Delete deck?`,confirmLabel:`Delete`,cancelLabel:`Keep`,destructive:!0})&&(de(U,e.id),Xc(),Ac(`list`))});let t=()=>{Cs===`edit`&&tl(),Cs===`list`&&el()};document.querySelectorAll(`.collection-owned-only-toggle`).forEach(e=>{e.addEventListener(`change`,e=>{Os=e.target.checked,_c(),t()})}),document.querySelectorAll(`.btn-reset-collection-filters`).forEach(e=>{e.addEventListener(`click`,()=>{Es=`all`,Ts=``,Ds=`all`,Os=!0,_c(),t()})}),_c(),br(),X(`collection-search`)?.addEventListener(`input`,e=>{Ts=e.target.value,t()}),yr(`collection-category`)?.addEventListener(`change`,e=>{Ds=e.target.value,t()}),yr(`collection-rarity`)?.addEventListener(`change`,e=>{Es=e.target.value,t()}),X(`btn-clear-deck`)?.addEventListener(`click`,()=>{K=[],tl()}),X(`btn-auto-finish-deck`)?.addEventListener(`click`,Js),X(`btn-save-deck`)?.addEventListener(`click`,nl),X(`btn-back-adventure`)?.addEventListener(`click`,al),X(`adventure-floor-backdrop`)?.addEventListener(`click`,al),X(`btn-start-adventure`)?.addEventListener(`click`,vl),yr(`adventure-deck-select`)?.addEventListener(`change`,e=>{U.selectedDeckId=e.target.value,w(U)});let n=document.getElementById(`auth-modal`),r=document.getElementById(`auth-header-btn`);oc(),qn(`adventure-help-btn`,`adventure-help-desc`),qn(`shop-help-btn`,`shop-help-desc`),qn(`deck-help-btn`,`deck-help-desc`),Ps=mn({onSignIn:()=>Fs?.open(`signin`,{forced:!0}),onSignUp:()=>Fs?.open(`signup`,{forced:!0}),onGuest:()=>{tn(),kl()}}),Fs=fn({authBtn:r,modal:n,onNewAccount:()=>{U=_e()?pe():T(),Dn(U,w)},onSignedIn:()=>{nn(),U=T(),C(U),En(U),$(),el(),Lc(),Ps?.hide(),sc().then(()=>{W===`profile`&&lc(),W===`quests`&&hc(),W===`pvp`&&Ns().then(e=>e?.render({resume:!0}))}),Ns().then(e=>e?.render({resume:!0})),Dl(),Ol(),El(),Tl(),J||Z(W)},onSignedOut:()=>{nn(),ac(),Q=``,ic(),js?.dispose?.(),q=null,fr({clearCheckpoint:!0}),cr(),U=pe(),rc(),$(),el(),Lc(),Ps?.show(),Z(`deck`)}}),hr(()=>q),C(U),_c(),rc(),Al()}function Sl(){if(!Rs||Bs!=null)return;let e=0,t=()=>{if(Bs=null,e+=1,Rs){if(tr()){e<10&&(Bs=window.setTimeout(t,400));return}if(En(U),El()){Rs=!1;return}e<10&&(Bs=window.setTimeout(t,500))}};Bs=window.setTimeout(t,350)}function Cl(){if(!zs||Vs!=null)return;let e=0,t=()=>{if(Vs=null,e+=1,zs){if(tr()){e<10&&(Vs=window.setTimeout(t,400));return}if(En(U),Tl()){zs=!1;return}e<10&&(Vs=window.setTimeout(t,500))}};Vs=window.setTimeout(t,350)}function wl(){return J||!pn()||!g(U)||!Fn(U)?!1:(J=!0,hs().then(({startPvpTutorial:e})=>{e({profile:U,saveProfile:w,onComplete:()=>{J=!1,U=T(),C(U),rc(),Z(`play`),Tl()}})}),!0)}function Tl(){return J||!pn()||!m(U)||An(U)||jn(U)||Pn(U)||Fn(U)||!Ln(U)?!1:(J=!0,Z(`play`),hs().then(({startCosmeticsTutorial:e})=>{e({profile:U,saveProfile:w,onComplete:()=>{J=!1,U=T(),C(U),rc(),Z(`play`)}})}),!0)}function El(){return J||!pn()||!g(U)?!1:(En(U),Pn(U)?(J=!0,Z(`play`),hs().then(({startQuestsTutorial:e})=>{e({profile:U,saveProfile:w,onComplete:()=>{J=!1,U=T(),C(U),rc(),wl(),Tl()}})}),!0):wl())}function Dl(){return J||!pn()||!An(U)?!1:(J=!0,_s().then(({startInteractiveTutorial:e})=>{e({profile:U,saveProfile:w,onComplete:()=>{J=!1,U=T(),C(U),$(),el(),Lc(),Ol()||Z(`deck`),El(),Tl()}})}),!0)}function Ol(){return J||!pn()||!jn(U)?!1:(J=!0,Z(`deck`),ps().then(({startMetaTutorial:e})=>{e({profile:U,saveProfile:w,onComplete:()=>{J=!1,U=T(),C(U),$(),el(),Lc(),Z(`deck`),El(),Tl()}})}),!0)}async function kl(){Ps?.hide(),!Dl()&&(Ol()||El()||Tl()||J||(await hl()||await Z(`deck`),cr(),vo(`hub`)))}async function Al(){try{if(await Le()){try{let e=await ln();e&&(U=e)}catch(e){console.warn(`Cloud sync on load failed`,e)}C(U),$(),el(),Lc()}}catch(e){console.warn(`Auth init failed`,e)}if(En(U),await sc(),js&&js.render(),cr(),hn()){Ps?.show();return}await kl()}xl(),E(async()=>{let{registerSW:e}=await import(`./virtual_pwa-register-CpSsV7JG.js`);return{registerSW:e}},[],import.meta.url).then(({registerSW:e})=>{e({immediate:!0})}),et(),it();export{cr as A,Zt as B,dr as C,ur as D,rr as E,kn as F,$e as G,_t as H,Nn as I,qe as K,Mn as L,qn as M,In as N,fr as O,On as P,Rn as R,vr as S,or as T,Ct as U,zt as V,gt as W,qa as _,Vo as a,Fa as b,qo as c,Zo as d,Eo as f,ro as g,H as h,Go as i,pr as j,tr as k,Uo as l,vo as m,es as n,Ho as o,yo as p,Lo as r,Ko as s,$o as t,Yo as u,Ua as v,ir as w,Cr as x,Va as y,rn as z};