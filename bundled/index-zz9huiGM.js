...
import{n as e,o as t,t as n}from"./cardCatalog-3QIc7B30.js";import{c as r,i,r as a}from"./deckRules-CrN-8L1s.js";import{At as o,Ct as s,Dt as c,Et as l,Ft as u,H as d,I as f,Mt as p,Nt as m,Ot as h,Pt as g,R as ee,St as _,T as v,Tt as te,_t as y,a as b,at as x,bt as S,c as ne,d as re,f as C,ft as ie,g as ae,gt as oe,ht as se,i as ce,jt as le,kt as ue,l as de,m as w,mt as fe,nt as pe,o as me,p as he,pt as ge,r as _e,s as ve,t as ye,u as T,vt as be,wt as xe,xt as Se,yt as Ce,z as we}from"./storage-DDiHESi1.js";import{t as E}from"./preload-helper-CV77j2BA.js";import{a as D,c as Te,d as Ee,g as De,i as Oe,m as ke,o as Ae,p as je,s as Me,t as Ne,u as Pe}from"./auth-DMlgfqMe.js";var Fe=Object.defineProperty,Ie=(e,t)=>{let n={};for(var r in e)Fe(n,r,{get:e[r],enumerable:!0});return t||Fe(n,Symbol.toStringTag,{value:`Module`}),n};function Le(){let e=window.visualViewport;return e?Math.max(0,Math.round(e.offsetTop)):0}function Re(){let e=window.visualViewport;return e?Math.max(0,Math.round(window.innerHeight-e.offsetTop-e.height)):0}function ze(){let e=document.documentElement,t=()=>{e.style.setProperty(`--viewport-inset-top`,`${Le()}px`),e.style.setProperty(`--viewport-inset-bottom`,`${Re()}px`)};t(),window.visualViewport?.addEventListener(`resize`,t),window.visualViewport?.addEventListener(`scroll`,t),window.addEventListener(`resize`,t),window.addEventListener(`orientationchange`,t)}ze();var Be=1100,Ve=120;function He(){let e=document.getElementById(`app-splash`);if(!e||e.classList.contains(`app-splash--hide`))return;e.classList.add(`app-splash--hide`),document.body.classList.remove(`splash-active`);let t=()=>{e.remove()};e.addEventListener(`transitionend`,t,{once:!0}),window.setTimeout(t,600)}function Ue(){He()}function We(){let e=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches?Ve:Be,t=performance.now(),n=()=>{let n=performance.now()-t,r=Math.max(0,e-n);window.setTimeout(He,r)};document.readyState===`interactive`||document.readyState===`complete`?n():document.addEventListener(`DOMContentLoaded`,n,{once:!0})}document.body.classList.add(`splash-active`),We();var Ge=`(max-width: 768px)`,Ke=null;function qe(){return document.getElementById(`mobile-confirm`)}function Je(e){let t=qe();if(!t)return;t.classList.add(`hidden`),document.body.classList.remove(`mobile-confirm-open`);let n=Ke;Ke=null,n?.(e)}function Ye(e,t={}){if(!window.matchMedia(Ge).matches)return Promise.resolve(window.confirm(e));let n=qe();if(!n)return Promise.resolve(window.confirm(e));let{title:r=`Confirm`,confirmLabel:i=`OK`,cancelLabel:a=`Cancel`,destructive:o=!1}=t;return new Promise(t=>{Ke&&Je(!1),Ke=t,n.querySelector(`#mobile-confirm-title`).textContent=r,n.querySelector(`#mobile-confirm-body`).textContent=e;let s=n.querySelector(`#mobile-confirm-ok`),c=n.querySelector(`#mobile-confirm-cancel`);s.textContent=i,c.textContent=a,s.classList.toggle(`btn-danger`,o),s.classList.toggle(`btn-primary`,!o),n.classList.remove(`hidden`),document.body.classList.add(`mobile-confirm-open`),c.focus()})}function Xe(){let e=qe();!e||e.dataset.bound||(e.dataset.bound=`1`,e.querySelector(`#mobile-confirm-ok`)?.addEventListener(`click`,()=>Je(!0)),e.querySelector(`#mobile-confirm-cancel`)?.addEventListener(`click`,()=>Je(!1)),e.querySelector(`[data-mobile-confirm-backdrop]`)?.addEventListener(`click`,()=>Je(!1)))}var Ze=`cc_install_banner_dismissed`;function Qe(){return window.matchMedia(`(display-mode: standalone)`).matches||window.navigator.standalone===!0}function $e(){let e=window.navigator.userAgent;return/iphone|ipad|ipod/i.test(e)&&!/crios|fxios/i.test(e)}function et(){if(Qe()||localStorage.getItem(Ze)===`1`)return;let e=document.getElementById(`install-banner`);if(!e)return;let t=null,n=()=>{e.classList.remove(`hidden`),document.body.classList.add(`install-banner-visible`)},r=()=>{e.classList.add(`hidden`),document.body.classList.remove(`install-banner-visible`)};window.addEventListener(`beforeinstallprompt`,r=>{r.preventDefault(),t=r,e.querySelector(`#install-banner-ios-hint`)?.classList.add(`hidden`),e.querySelector(`.install-banner__hint--default`)?.classList.remove(`hidden`),e.querySelector(`#install-banner-btn`)?.classList.remove(`hidden`),n()}),$e()&&(e.querySelector(`#install-banner-ios-hint`)?.classList.remove(`hidden`),e.querySelector(`.install-banner__hint--default`)?.classList.add(`hidden`),e.querySelector(`#install-banner-btn`)?.classList.add(`hidden`),window.setTimeout(n,2500)),e.querySelector(`#install-banner-btn`)?.addEventListener(`click`,async()=>{t&&(t.prompt(),await t.userChoice,t=null,r())}),e.querySelector(`#install-banner-dismiss`)?.addEventListener(`click`,()=>{localStorage.setItem(Ze,`1`),r()})}var tt=[`attack`,`control`,`defense`,`movement`,`trap`,`special`],nt={attack:`Attack`,control:`Control`,defense:`Defense`,movement:`Movement`,trap:`Trap`,special:`Special`},rt={aegis:`defense`,anchor:`defense`,backpedal:`control`,backrank_protection:`defense`,backstab:`attack`,backstep:`movement`,barrier:`defense`,bishops_mark:`movement`,blind:`control`,blizzard:`control`,snowball:`control`,berserk:`movement`,bomb:`attack`,shockwave:`control`,plague:`control`,bulwark:`defense`,create_foe:`special`,call_forward:`movement`,chain_lightning:`attack`,clone:`special`,coin_flip:`attack`,collapse:`special`,confusion:`control`,constitution:`defense`,counterspell:`trap`,crown:`special`,cryo_bolt:`attack`,cull:`attack`,darkness:`defense`,dash:`movement`,deep_freeze:`control`,deflect:`trap`,demote:`control`,deport:`movement`,displacement:`movement`,dominion:`special`,duel:`attack`,earthquake:`special`,execution:`attack`,pyromancy:`attack`,fusion:`special`,hibernation:`special`,hostile_swap:`movement`,ignore:`special`,iron_will:`defense`,landmine:`trap`,last_king:`special`,bounty:`special`,link_fate:`special`,last_stand:`trap`,leapfrog:`movement`,long_step:`movement`,magnet:`movement`,nudge:`movement`,offering:`special`,panic:`control`,poison:`attack`,mind_control:`special`,press:`control`,purify:`special`,quick_march:`movement`,quicksand:`trap`,rally:`defense`,recall:`movement`,repel:`movement`,random_teleport:`movement`,retreat:`movement`,revive:`defense`,rooks_mark:`movement`,root:`control`,sacrifice:`attack`,sanctuary:`defense`,scatter:`movement`,shadow_swap:`movement`,sidestep:`movement`,shatter:`attack`,snipe:`attack`,snowball:`control`,stab:`attack`,stall:`defense`,tangle:`control`,teleport:`movement`,trickster:`special`,vengeance:`trap`,ward:`defense`};function it(e){let t=rt[e?.id];if(t)return t;let n=`${e?.id||``} ${e?.effect||``} ${e?.name||``} ${e?.desc||``}`.toLowerCase();return/trap|mine|quicksand|counterspell|vengeance|last.?stand/.test(n)?`trap`:/shield|ward|aegis|sanctuary|barrier|anchor|deflect|stall|iron_will|rally|darkness/.test(n)?`defense`:/move|nudge|teleport|recall|leap|step|displace|swap|scatter|retreat|bishop|rook|overrun|promote|pull|push|shift|earthquake|magnet|repel/.test(n)?`movement`:/freeze|blind|confusion|hex|root|panic|press|silence|paraly|control|cannot play|random|mark|poison|die in \d+ turn/.test(n)?`control`:/\bdestroy\b|\bkills?\b|fireball|bolt|stab|snipe|duel|sacrifice|execution|shatter|cull|lightning/.test(n)?`attack`:`special`}var at=[{id:`bronze`,name:`Bronze Chest`,cost:25,cards:3,weights:{common:70,uncommon:25,rare:5,epic:0}},{id:`silver`,name:`Silver Chest`,cost:50,cards:5,weights:{common:50,uncommon:35,rare:12,epic:3}},{id:`gold`,name:`Gold Chest`,cost:100,cards:8,weights:{common:32,uncommon:38,rare:22,epic:6,legendary:2}}];function ot(e){let t=Math.random()*100,n=0;for(let r of[`common`,`uncommon`,`rare`,`epic`,`legendary`])if(n+=e[r]||0,t<=n)return r;return`common`}function st(t){let n=e().filter(e=>e.rarity===t);return n.length?n[Math.floor(Math.random()*n.length)]:e()[0]}function ct(n,r){let i=e=>(n.collection[e.id]||0)<t(e);for(let e=0;e<48;e++){let e=st(ot(r.weights));if(i(e))return e}let a=e().filter(i);return a.length?a[Math.floor(Math.random()*a.length)]:st(ot(r.weights))}function lt(e,t){let n=at.find(e=>e.id===t);if(!n)return{success:!1,message:`Unknown chest.`};if(e.gems<n.cost)return{success:!1,message:`Not enough gems.`};e.gems-=n.cost;let r=[];for(let t=0;t<n.cards;t++){let t=ct(e,n);r.push(t),ye(e,t.id,1)}return w(e),{success:!0,pulls:r,chest:n}}var ut=[`common`,`uncommon`,`rare`,`epic`,`legendary`];function dt(e,{minPct:t=1}={}){return ut.filter(n=>(e[n]??0)>=t).map(t=>`${e[t]}% ${t}`).join(` · `)}var ft={bronze:{label:`Bronze`,tagline:`Mostly common cards`,accent:`#cd7f32`,glow:`rgba(205, 127, 50, 0.45)`},silver:{label:`Silver`,tagline:`Balanced card mix`,accent:`#a8b8d8`,glow:`rgba(168, 184, 216, 0.5)`},gold:{label:`Gold`,tagline:`Higher rare & epic odds`,accent:`#e8c547`,glow:`rgba(232, 197, 71, 0.55)`}};function pt(e){let t=ft[e]||ft.bronze;return{t,lid:e===`gold`?`#f5e6a8`:e===`silver`?`#e8eef8`:`#d4954a`,body:e===`gold`?`#7a5c12`:e===`silver`?`#4a5568`:`#5c3a1e`,trim:e===`gold`?`#ffe566`:e===`silver`?`#c8d8f0`:t.accent}}function mt(e,t){let{lid:n,body:r,trim:i}=pt(e);return`
    ...
    <g${a}>
      ...
      ${s}
    </g>`}function vt(e){let{trim:t}=pt(e),n=`chestStage-${e}`;return`<svg class="chest-stage-svg" viewBox="0 0 120 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ${mt(e,n)}
    <ellipse class="chest-stage__shadow" cx="60" cy="90" rx="44" ry="9" fill="rgba(0,0,0,0.5)"/>
    ${_t(n,t,e,!0)}
  </svg>`}function yt(e){let{trim:t}=pt(e),n=`chestCard-${e}`;return`<svg class="chest-svg" viewBox="0 0 120 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ${mt(e,n)}
    <ellipse cx="60" cy="90" rx="44" ry="9" fill="rgba(0,0,0,0.5)"/>
    ${_t(n,t,e,!1)}
  </svg>`}var bt={accent:`#c4b5fd`,glow:`rgba(167, 139, 250, 0.55)`,body:`#2a1848`,bodyHi:`#4c2d7a`,lid:`#6b46c1`,trim:`#e9d5ff`,gold:`#fbbf24`,gemSpell:`#7dd3fc`,gemCosmetic:`#f0abfc`},xt={accent:`#fde68a`,glow:`rgba(251, 191, 36, 0.6)`,body:`#3d2810`,bodyHi:`#6b4420`,lid:`#b45309`,trim:`#fef3c7`,gold:`#fcd34d`,gemSpell:`#38bdf8`,gemCosmetic:`#e879f9`};function St(e,t){let{body:n,bodyHi:r,lid:i,trim:a,gold:o,gemSpell:s,gemCosmetic:c,glow:l}=e;return`
    <defs>
      <linearGradient id="${t}-body" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stop-color="${r}"/>
    ...
    </defs>`}function Ct(e,t,n,r,i=1){return`
    ...
    </g>`}function O(e,t,n,r,i=.9){return`<path d="M${e} ${t-n} L${e+n*.28} ${t-n*.28} L${e+n} ${t} L${e+n*.28} ${t+n*.28} L${e} ${t+n} L${e-n*.28} ${t+n*.28} L${e-n} ${t} L${e-n*.28} ${t-n*.28} Z" fill="${r}" opacity="${i}"/>`}function wt(e,t){let{trim:n,gold:r}=t;return`
    ...
    <g class="mystery-box-svg__float">
      ...
      ${O(86,32,3.5,n,.55)}
      ${O(60,18,3,r,.85)}
    </g>`}function Tt(e,t){let{trim:n,gold:r}=t;return`
    ...
    <g class="mystery-box-svg__float">
      ...
      ${O(48,86,3.5,r,.8)}
      ${O(72,86,3.5,r,.8)}
    </g>`}function Et(e){let t=e===`big`,n=t?xt:bt,r=t?`mysteryBig`:`mysterySmall`,i=t?Tt(r,n):wt(r,n);return`<svg class="mystery-box-svg ${t?`mystery-box-svg--big`:`mystery-box-svg--small`}" viewBox="0 0 120 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ${St(n,r)}
    ${i}
  </svg>`}function Dt(){return Et(`small`)}function Ot(){return Et(`big`)}var kt=.5,At=[{id:`bronze`,name:`Bronze Chest`,cards:3,weights:{common:70,uncommon:25,rare:5,epic:0}},{id:`silver`,name:`Silver Chest`,cards:5,weights:{common:50,uncommon:35,rare:12,epic:3}},{id:`gold`,name:`Gold Chest`,cards:8,weights:{common:32,uncommon:38,rare:22,epic:6,legendary:2}}],jt=[{id:`bronze`,name:`Bronze Cosmetic Box`,pulls:3,weights:{common:70,uncommon:25,rare:5,epic:0}},{id:`silver`,name:`Silver Cosmetic Box`,pulls:5,weights:{common:50,uncommon:35,rare:12,epic:3}},{id:`gold`,name:`Gold Cosmetic Box`,pulls:8,weights:{common:32,uncommon:38,rare:22,epic:6,legendary:2}}];function Mt(e,{premium:t=!1}={}){let n=Math.random()*100;return t?n>50?e[2]:n>15?e[1]:e[0]:n>70?e[2]:n>35?e[1]:e[0]}function Nt(e,t){let n=[];for(let r=0;r<t.cards;r++){let r=ct(e,t);n.push(r),ye(e,r.id,1)}return n}function Pt(e,t){e.cosmetics=e.cosmetics||{};let n=[],r=0;for(let i=0;i<t.pulls;i++){let i=pe(e,t.weights);i&&(n.push(i),i.duplicate&&(r+=i.gemRefund||5))}return r&&(e.gems=(e.gems||0)+r),{pulls:n,bonusGems:r}}function Ft(e){if((e.stars??0)<10)return{success:!1,message:`Not enough stars.`};if(e.stars=(e.stars??0)-10,!(h(e)&&Math.random()<.5)){let t=Mt(At),n=Nt(e,t);return w(e),{success:!0,kind:`card`,tier:t,pulls:n,message:`Cards from ${t.name}`}}let t=Mt(jt),{pulls:n,bonusGems:r}=Pt(e,t);return w(e),{success:!0,kind:`cosmetic`,tier:t,pulls:n,bonusGems:r,message:`Cosmetics from ${t.name}`}}function It(e){if((e.stars??0)<20)return{success:!1,message:`Not enough stars.`};e.stars=(e.stars??0)-20;let t=Mt(At,{premium:!0}),n=Nt(e,t),r=[],i=0,a=null;return h(e)&&(a=Mt(jt,{premium:!0}),{pulls:r,bonusGems:i}=Pt(e,a)),w(e),{success:!0,kind:r.length?`both`:`card`,cardTier:t,cardPulls:n,cosTier:a,cosPulls:r,bonusGems:i,message:r.length?`Big haul: ${n.length} spells + ${r.length} cosmetics`:`Cards from ${t.name}`}}var Lt=`arcane_checkers_guest_mode_v1`,Rt=`Sign in to save progress / play PvP`,zt=`Sign in to save progress`;function Bt(){return Vt()&&!D()}function Vt(){try{return localStorage.getItem(Lt)===`1`}catch{return!1}}function Ht(){try{localStorage.setItem(Lt,`1`)}catch{}}function Ut(){try{localStorage.removeItem(Lt)}catch{}}var Wt=Ie({pullCloudProfile:()=>Yt,scheduleCloudSave:()=>Xt}),Gt=null;function Kt(e){if(!e||typeof e!=`object`)return!0;let t=Object.keys(e);if(t.length===0||t.every(e=>e===`loginEmail`||e===`login_email`||e===`savedAt`))return!0;let n=e.collection&&Object.keys(e.collection).length>0,r=Array.isArray(e.decks)&&e.decks.length>0,i=e.adventure?.cleared,a=(Array.isArray(i)?i.length:Object.keys(i||{}).length)>0,o=typeof e.gems==`number`||typeof e.stars==`number`,s=typeof e.pvpWins==`number`&&e.pvpWins>0||typeof e.spellsPlayed==`number`&&e.spellsPlayed>0;return!(n||r||a||o||s)}function qt(e){return C(e),w(e,{bumpTimestamp:!1}),e}function Jt(e,t){let n=ve();return!(n!==e&&n!==null||n===null&&Vt()&&t&&!Kt(t))}async function Yt(){let e=D();if(!e||!Me())return null;let t=await Oe(e.id),n=re(),r=t?.profile_json,i=Jt(e.id,r);if(!r||typeof r!=`object`||Kt(r)){if(!de(n)&&i)qt(n);else if(!de(n)&&!i)return qt(he());return re()}if(de(n)||!i){let e={...r};return i&&ee(e,n),we(e),qt(e)}return(r.savedAt||0)>=(n.savedAt||0)?qt(d(n,r)):(ee(n,r),w(n),n)}function Xt(e){let t=D();!t||!Me()||(clearTimeout(Gt),Gt=setTimeout(async()=>{try{await De(t.id,{profile_json:e,display_name:t.user_metadata?.display_name||t.email?.split(`@`)[0]})}catch(e){console.warn(`Cloud save failed`,e)}},800))}var Zt=Ne;function Qt({authBtn:e,modal:t,onSignedIn:n,onSignedOut:r,onNewAccount:i}){if(!e||!t)return;let a=t.querySelector(`#auth-form`),o=t.querySelector(`#auth-modal-title`),s=t.querySelector(`#auth-toggle-mode`),c=t.querySelector(`#auth-error`),l=t.querySelector(`#auth-username-hint`),u=t.querySelector(`#auth-close`),d=t.querySelector(`.auth-modal-backdrop`),f=a?.querySelector(`button[type="submit"]`),p=`signin`,m=null,h=!1,g=!1;function ee(){a?.querySelectorAll(`.auth-field-signup`).forEach(e=>{e.classList.toggle(`hidden`,p!==`signup`)});let e=a?.querySelector(`#auth-identifier`),t=a?.querySelector(`label[for="auth-identifier"]`);t&&(t.textContent=p===`signup`?`Email`:`Username or email`),e&&(e.placeholder=p===`signup`?`you@email.com`:`username or email`,e.type=p===`signup`?`email`:`text`,e.autocomplete=p===`signup`?`email`:`username`),f&&(f.textContent=p===`signup`?`Create account`:`Sign in`),l&&(l.textContent=``),l?.classList.remove(`auth-username-hint--ok`,`auth-username-hint--bad`)}function _(e){c&&(c.textContent=e||``)}function v(e,t=``){l&&(l.textContent=e||``,l.classList.remove(`auth-username-hint--ok`,`auth-username-hint--bad`),t===`ok`&&l.classList.add(`auth-username-hint--ok`),t===`bad`&&l.classList.add(`auth-username-hint--bad`))}async function te(){if(p!==`signup`)return;let e=a?.querySelector(`#auth-username`)?.value?.trim();if(!e){v(``);return}if(!Zt.test(e)){v(`3–24 letters, numbers, or underscore`,`bad`);return}if(v(`Checking…`),!await Te(e)){let t=await ke(e);v(t?`Taken — try "${t}"`:`That username is taken`,`bad`),t&&l&&(l.dataset.suggestion=t);return}l&&delete l.dataset.suggestion,v(`Available`,`ok`)}function y(e,n={}){if(h=!!n.forced,!Me()){_(`Add Supabase anon key in js/supabaseConfig.js`),t.classList.remove(`hidden`),u?.classList.toggle(`hidden`,h);return}p=e||p,o&&(o.textContent=p===`signup`?`Create account`:`Sign in`),s&&(s.textContent=p===`signup`?`Already have an account? Sign in`:`Need an account? Sign up`),_(``),ee(),u?.classList.toggle(`hidden`,h),d?.classList.toggle(`auth-modal-backdrop--locked`,h),t.classList.remove(`hidden`)}function b(){h||(t.classList.add(`hidden`),_(``),v(``))}function x(t){if(e){if(!Me()){e.textContent=`Setup cloud`,e.title=`Configure Supabase`,e.classList.remove(`hidden`),e.hidden=!1;return}t?(e.classList.add(`hidden`),e.hidden=!0):(e.textContent=`Sign in`,e.title=`Sign in or sign up`,e.classList.remove(`hidden`),e.hidden=!1)}}e.addEventListener(`click`,()=>{D()||y(`signin`)}),s?.addEventListener(`click`,e=>{e.preventDefault(),p=p===`signup`?`signin`:`signup`,y(p)}),u?.addEventListener(`click`,b),d?.addEventListener(`click`,()=>{h||b()});let S=a?.querySelector(`#auth-username`);S?.addEventListener(`input`,()=>{clearTimeout(m),m=setTimeout(()=>{te().catch(()=>v(``))},350)}),l?.addEventListener(`click`,()=>{let e=l?.dataset?.suggestion;!e||!S||(S.value=e,delete l.dataset.suggestion,te().catch(()=>{}))}),a?.addEventListener(`submit`,async e=>{e.preventDefault(),_(``);let t=a.querySelector(`#auth-identifier`)?.value?.trim(),r=a.querySelector(`#auth-username`)?.value?.trim(),o=a.querySelector(`#auth-password`)?.value;if(!t||!o){_(p===`signup`?`Email and password required.`:`Username or email and password required.`);return}f&&(f.disabled=!0),g=!0;try{if(p===`signup`){if(!t.includes(`@`)){_(`Use your email address to sign up.`);return}if(!r||!Zt.test(r)){_(`Choose a username (3–24 letters, numbers, underscore).`);return}let e=r;if(!await Te(e)){let t=await ke(e);if(t){_(`"${e}" is taken. Try "${t}" or tap the hint below.`),v(`Tap to use "${t}"`,`bad`),l&&(l.dataset.suggestion=t);return}_(`Username "${e}" is already taken. Pick another.`);return}i?.();let a=(await je(t,o,e,e)).session?.user??D();if(a){let r=await Oe(a.id),i=r?.profile_json&&typeof r.profile_json==`object`?{...r.profile_json}:{};i.loginEmail=t.toLowerCase();try{await De(a.id,{username:e,display_name:e,profile_json:i})}catch(t){if((t?.code||t?.details?.code)===`23505`){let t=await ke(e);_(t?`Account created but "${e}" was taken. Sign in and change your name to "${t}", or try sign up again with that username.`:`Account created but that username was just taken. Sign in with your email and pick another name in Profile.`),p=`signin`,y(`signin`);return}throw t}try{await Yt()}catch(e){console.warn(`Profile sync after signup failed`,e)}n?.(),h=!1,u?.classList.remove(`hidden`),d?.classList.remove(`auth-modal-backdrop--locked`),b();return}_(`Account created. Check your email to confirm, then sign in.`),p=`signin`,y(`signin`);return}await Ee(t,o);let e=D();if(!e){_(`Sign-in failed — no session returned. Try again or confirm your email.`);return}try{await Yt()}catch(e){console.warn(`Profile sync after sign-in failed`,e)}n?.(),h=!1,u?.classList.remove(`hidden`),d?.classList.remove(`auth-modal-backdrop--locked`),x(e),b()}catch(e){let t=e?.message||`Authentication failed`;if(t.includes(`Database error saving new user`)||t.includes(`username_taken`)||e?.code===`23505`){let e=r&&Zt.test(r)?await ke(r):null;t=e?`Sign-up failed (username conflict). Try "${e}" instead.`:`Sign-up failed on the server. Try a different username, or sign in if you already have an account.`}else t.includes(`over_email_send_rate_limit`)||t.includes(`rate limit`)?t=`Too many sign-up attempts. Wait a few minutes or sign in with an existing account.`:t.includes(`User already registered`)&&(t=`That email is already registered. Try Sign in instead.`);t.includes(`Invalid login credentials`)?_(`Wrong email/username or password.`):t.includes(`Email not confirmed`)?_(`Confirm your email first (check inbox), or disable email confirmation in Supabase for testing.`):_(t)}finally{g=!1,f&&(f.disabled=!1)}});let ne=!1;return Pe(async e=>{if(x(e),e){if(ne=!0,g)return;try{await Yt()}catch(e){console.warn(`Profile sync failed`,e)}n?.(),h=!1,u?.classList.remove(`hidden`),d?.classList.remove(`auth-modal-backdrop--locked`),b()}else ne&&(ne=!1,r?.())}),Ae().then(x),{open:y,close:b}}function $t(){return!!D()||Vt()}function en({onSignIn:e,onSignUp:t,onGuest:n}){let r=document.getElementById(`auth-gate`);if(!r)return{show:()=>{},hide:()=>{},sync:()=>{}};let i=r.querySelector(`#auth-gate-signin`),a=r.querySelector(`#auth-gate-signup`),o=r.querySelector(`#auth-gate-guest`),s=r.querySelector(`#auth-gate-notice`);i?.addEventListener(`click`,()=>e?.()),a?.addEventListener(`click`,()=>t?.()),o?.addEventListener(`click`,()=>n?.());function c(){Me()?s&&(s.textContent=`Create an account to sync decks, stars, and collection — or continue as guest to play Adventure on this device.`):s&&(s.textContent=`Cloud sign-in is not configured. Add your Supabase keys in js/supabaseConfig.js.`),r.classList.remove(`hidden`),document.body.classList.add(`auth-gate-active`)}function l(){r.classList.add(`hidden`),document.body.classList.remove(`auth-gate-active`)}function u(){$t()?l():c()}return{show:c,hide:l,sync:u}}function tn(){return Me()&&!$t()}var nn=`arcane_checkers_tutorial_v1`,rn=`arcane_checkers_interactive_tutorial_v1`,an=`arcane_checkers_meta_tutorial_v1`,on=`arcane_checkers_quests_tutorial_v1`,sn=`arcane_checkers_pvp_tutorial_v1`,cn=`arcane_checkers_cosmetics_tutorial_v1`,ln=`arcane_checkers_pending_signup_tutorial_v1`;function un(){try{sessionStorage.setItem(ln,`1`)}catch{}}function dn(){try{sessionStorage.removeItem(ln)}catch{}}function fn(){try{return sessionStorage.getItem(ln)===`1`}catch{return!1}}function pn(e){if(!e)return;let t=[[rn,e.interactiveTutorialDone||e.tutorialDone],[an,e.metaTutorialDone||e.tutorialDone],[on,e.questsTutorialDone],[sn,e.pvpTutorialDone],[cn,e.cosmeticsTutorialDone]];try{for(let[e,n]of t)n?localStorage.setItem(e,`done`):localStorage.getItem(e)===`done`&&localStorage.removeItem(e)}catch{}}function mn(e,t){un();try{localStorage.removeItem(rn),localStorage.removeItem(an),localStorage.removeItem(on),localStorage.removeItem(sn),localStorage.removeItem(cn),localStorage.removeItem(nn)}catch{}e&&(delete e.interactiveTutorialDone,delete e.metaTutorialDone,delete e.questsTutorialDone,delete e.pvpTutorialDone,delete e.cosmeticsTutorialDone,delete e.tutorialDone,t?.(e))}function hn(e={}){if(dn(),e.persist){try{localStorage.setItem(rn,`done`)}catch{}e.profile&&(e.profile.interactiveTutorialDone=!0),e.saveProfile?.(e.profile)}}function gn(e={}){if(e.persist){try{localStorage.setItem(an,`done`),localStorage.setItem(nn,`done`)}catch{}e.profile&&(e.profile.metaTutorialDone=!0,e.profile.tutorialDone=!0),e.saveProfile?.(e.profile)}}function _n(e){if(fn())return!0;if(e?.interactiveTutorialDone||e?.tutorialDone)return!1;try{return localStorage.getItem(rn)!==`done`}catch{return!0}}function vn(e){if(e?.metaTutorialDone||e?.tutorialDone)return!1;if(!e?.interactiveTutorialDone)try{if(localStorage.getItem(rn)!==`done`)return!1}catch{return!1}try{return localStorage.getItem(an)!==`done`}catch{return!0}}function yn(e={}){if(e.persist){try{localStorage.setItem(on,`done`)}catch{}e.profile&&(e.profile.questsTutorialDone=!0),e.saveProfile?.(e.profile)}}function bn(e={}){if(e.persist){try{localStorage.setItem(sn,`done`)}catch{}e.profile&&(e.profile.pvpTutorialDone=!0),e.saveProfile?.(e.profile)}}function xn(e){if(e?.questsTutorialDone)return!1;try{return localStorage.getItem(on)!==`done`}catch{return!0}}function Sn(e){if(e?.pvpTutorialDone)return!1;if(!e?.questsTutorialDone)try{if(localStorage.getItem(on)!==`done`)return!1}catch{return!1}try{return localStorage.getItem(sn)!==`done`}catch{return!0}}function Cn(e={}){if(e.persist){try{localStorage.setItem(cn,`done`)}catch{}e.profile&&(e.profile.cosmeticsTutorialDone=!0),e.saveProfile?.(e.profile)}}function wn(e){if(e?.cosmeticsTutorialDone)return!1;try{return localStorage.getItem(cn)!==`done`}catch{return!0}}function Tn(e){return e instanceof Element?!!e.closest(`#mobile-confirm, #tutorial-meta-overlay, #tutorial-match-overlay, .card-preview-modal`):!1}var En=new WeakSet,Dn=!1,On=null,kn=null;function An(){return document.getElementById(`panel-help-popup`)}function jn(){let e=An();!e||e.classList.contains(`hidden`)||(e.classList.add(`hidden`),document.body.classList.remove(`panel-help-open`),On&&=(On.setAttribute(`aria-expanded`,`false`),On.classList.remove(`panel-help-btn--active`),null),kn&&=(clearTimeout(kn),null))}function Mn({title:e,bodyHtml:t,triggerBtn:n=null,autoCloseMs:r=0}){let i=An();if(!i)return;jn();let a=i.querySelector(`#panel-help-popup-title`),o=i.querySelector(`#panel-help-popup-body`);a&&(a.textContent=e||`Help`),o&&(o.innerHTML=t||``),i.classList.remove(`hidden`),document.body.classList.add(`panel-help-open`),n&&(On=n,n.setAttribute(`aria-expanded`,`true`),n.classList.add(`panel-help-btn--active`)),r>0&&(kn=setTimeout(jn,r)),i.querySelector(`.panel-help-popup__dismiss`)?.focus()}function Nn(){if(Dn)return;Dn=!0;let e=An();e&&(e.querySelectorAll(`[data-panel-help-close]`).forEach(e=>{e.addEventListener(`click`,jn)}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&jn()}))}function Pn(e,t){let n=typeof e==`string`?document.getElementById(e):e,r=typeof t==`string`?document.getElementById(t):t;!n||!r||En.has(n)||(En.add(n),Nn(),n.addEventListener(`click`,e=>{e.stopPropagation();let t=An();if(t&&!t.classList.contains(`hidden`)&&On===n){jn();return}Mn({title:n.getAttribute(`aria-label`)||`Help`,bodyHtml:r.innerHTML,triggerBtn:n})}))}var Fn=`cc_match_checkpoint`,In=1440*60*1e3,Ln=null,Rn=!1,zn=null;function Bn(){return document.body.classList.contains(`match-active`)}function Vn(e){if(!e||!(e instanceof Element)||e.closest(`.hidden`))return!1;let t=getComputedStyle(e);return!(t.display===`none`||t.visibility===`hidden`)}function Hn(){let e=document.querySelector(`#btn-leave-match`);if(!e)return!1;if(Vn(e))return!0;if(!Bn())return!1;let t=document.getElementById(`view-match`),n=document.getElementById(`view-pvp`);return!!(t?.contains(e)||n?.contains(e))}function Un(e){Ln=e}function Wn(){let e=Ln;return Ln=null,e}function Gn(){Ln=null}function Kn(){Rn=!0}function qn(){let e=Rn;return Rn=!1,e}function Jn(){let e=document.getElementById(`view-match`);e?.classList.contains(`hidden`)&&e.innerHTML.trim()&&(e.innerHTML=``);let t=document.getElementById(`pvp-match-root`);t&&(Vn(t.querySelector(`#btn-leave-match`))||t.remove())}function Yn(){return!Bn()||Hn()?!1:(Jn(),$n({clearCheckpoint:!1}),window.dispatchEvent(new CustomEvent(`cc-match-shell-reconciled`)),!0)}function Xn(e){document.querySelector(`.game-shell`)?.classList.toggle(`game-shell--in-match`,e)}function Zn(e){zn=e,document.body.classList.add(`match-active`),Xn(!0)}function Qn(){try{sessionStorage.removeItem(Fn)}catch{}}function $n(e={}){zn=null,document.body.classList.remove(`match-active`),Xn(!1),e.clearCheckpoint&&Qn()}function er(e){if(!(!zn||!e?.state||zn.kind!==`adventure`||e.state.gameOver))try{sessionStorage.setItem(Fn,JSON.stringify({...zn,state:e.state,winRewarded:!!e.winRewarded,savedAt:Date.now()}))}catch{}}function tr(){try{let e=sessionStorage.getItem(Fn);if(!e)return null;let t=JSON.parse(e);return!t?.state||t.state.gameOver||t.kind!==`adventure`||t.savedAt&&Date.now()-t.savedAt>In?(Qn(),null):t}catch{return Qn(),null}}function nr(e){if(window.__ccMatchVisibilityBound)return;window.__ccMatchVisibilityBound=!0;let t=()=>{let t=e();t&&er(t)};document.addEventListener(`visibilitychange`,()=>{let n=e();document.hidden?(t(),n?.pauseForBackground?.()):n?.resumeFromBackground?.()}),window.addEventListener(`pagehide`,t)}var rr=new Set;function ir(e){for(let t of rr)t!==e&&t.close()}function ar(e){if(!e||e.dataset.customSelectEnhanced)return e?._customSelectApi??null;e.dataset.customSelectEnhanced=`1`;let t=document.createElement(`div`);t.className=`custom-select`;let n=document.createElement(`button`);n.type=`button`,n.className=`custom-select__trigger select-input`,n.setAttribute(`aria-haspopup`,`listbox`),n.setAttribute(`aria-expanded`,`false`);let r=document.createElement(`span`);r.className=`custom-select__chevron`,r.setAttribute(`aria-hidden`,`true`),r.textContent=`▾`;let i=document.createElement(`span`);i.className=`custom-select__label`;let a=document.createElement(`div`);a.className=`custom-select__list hidden`,a.setAttribute(`role`,`listbox`);let o=e.id;o&&(n.id=o,e.removeAttribute(`id`));let s=e.getAttribute(`aria-label`)?null:document.querySelector(`label[for="${o}"]`)?.id;s?n.setAttribute(`aria-labelledby`,s):e.getAttribute(`aria-label`)&&n.setAttribute(`aria-label`,e.getAttribute(`aria-label`)),e.classList.add(`custom-select__native`),e.tabIndex=-1,e.setAttribute(`aria-hidden`,`true`),e.parentNode.insertBefore(t,e),t.appendChild(e),t.appendChild(n),n.appendChild(i),n.appendChild(r),t.appendChild(a);let c=!1,l=-1;function u(){return[...e.options]}function d(){return e.options[e.selectedIndex]??null}function f(){let r=d();i.textContent=r?.textContent?.trim()||`Select…`,n.disabled=e.disabled,t.classList.toggle(`custom-select--disabled`,e.disabled),a.querySelectorAll(`.custom-select__option`).forEach(t=>{let n=t.dataset.value===e.value;t.classList.toggle(`custom-select__option--selected`,n),t.setAttribute(`aria-selected`,n?`true`:`false`)})}function p(t){let n=Object.getOwnPropertyDescriptor(HTMLSelectElement.prototype,t);!n?.set||!n?.get||Object.defineProperty(e,t,{configurable:!0,enumerable:n.enumerable,get(){return n.get.call(this)},set(e){n.set.call(this,e),f()}})}p(`value`),p(`selectedIndex`),p(`disabled`);function m(t){e.disabled||(e.value=t.value,e.dispatchEvent(new Event(`change`,{bubbles:!0})),f(),v())}function h(){a.innerHTML=``;for(let e of u()){let t=document.createElement(`button`);t.type=`button`,t.className=`custom-select__option`,t.setAttribute(`role`,`option`),t.dataset.value=e.value,t.textContent=e.textContent?.trim()||e.value,t.addEventListener(`click`,t=>{t.stopPropagation(),m(e)}),a.appendChild(t)}f()}function g(e){let t=[...a.querySelectorAll(`.custom-select__option`)];t.length&&(l=Math.max(0,Math.min(e,t.length-1)),t.forEach((e,t)=>{e.classList.toggle(`custom-select__option--active`,t===l)}),t[l]?.scrollIntoView({block:`nearest`}))}function ee(){a.classList.remove(`custom-select__list--above`);let e=n.getBoundingClientRect(),t=Math.min(256,window.innerHeight*.5),r=window.innerHeight-e.bottom,i=e.top;r<t*.65&&i>r&&a.classList.add(`custom-select__list--above`)}function _(){c||e.disabled||(ir(y),c=!0,rr.add(y),a.classList.remove(`hidden`),t.classList.add(`custom-select--open`),n.setAttribute(`aria-expanded`,`true`),ee(),g(Math.max(0,e.selectedIndex)),document.addEventListener(`click`,b),document.addEventListener(`keydown`,x))}function v(){c&&(c=!1,rr.delete(y),a.classList.add(`hidden`),t.classList.remove(`custom-select--open`),n.setAttribute(`aria-expanded`,`false`),l=-1,a.querySelectorAll(`.custom-select__option--active`).forEach(e=>{e.classList.remove(`custom-select__option--active`)}),document.removeEventListener(`click`,b),document.removeEventListener(`keydown`,x))}function te(){return c}let y={close:v,rebuild:h,isOpen:te};e._customSelectApi=y,n.addEventListener(`click`,t=>{t.stopPropagation(),!e.disabled&&(c?v():_())}),n.addEventListener(`keydown`,t=>{e.disabled||((t.key===`ArrowDown`||t.key===`ArrowUp`||t.key===`Enter`||t.key===` `)&&(t.preventDefault(),c||_(),t.key===`ArrowDown`&&g(l+1),t.key===`ArrowUp`&&g(l<=0?0:l-1),(t.key===`Enter`||t.key===` `)&&l>=0&&[...a.querySelectorAll(`.custom-select__option`)][l]?.click()),t.key===`Escape`&&v())});let b=e=>{if(!t.isConnected){v();return}t.contains(e.target)||v()},x=e=>{e.key===`Escape`&&v()},S=new MutationObserver(()=>{h()});S.observe(e,{childList:!0,subtree:!0,attributes:!0,attributeFilter:[`disabled`,`value`,`selected`]}),e.addEventListener(`change`,f);let ne=e.remove.bind(e);return e.remove=function(){v(),S.disconnect(),ne(),t.isConnected&&t.remove()},h(),y}function or(e){if(!e)return null;let t=typeof e==`string`?document.getElementById(e):e;return t?t.tagName===`SELECT`?t:t.closest(`.custom-select`)?.querySelector(`select.custom-select__native`)??null:null}function sr(e=document){e.querySelectorAll(`select.select-input:not([data-custom-select-enhanced]):not([data-no-custom-select])`).forEach(e=>{ar(e)})}var cr={nudge:[`Move your piece 1 square forward-diagonally`],shield_1:[`Shield 1 turn — blocks one capture or spell hit`],shield_2:[`Shield 2 turns — cannot be captured`],forward_bolt:[`Destroy first enemy on forward diagonal (Stab)`],trickster:[`Swap up to 6 random pieces (not on back ranks)`],purify:[`Removes all debuffs from your pieces, including burn and freeze`],chain_lightning:[`Strike adjacent enemies only`,`Up to 2 kills if enemies touch each other`,`Your piece is paralyzed 2 turns`],pyromancy:[`Enemy piece + empty dark square — both burn 2 turns; fire tiles block enemies`,`You cannot cast spells on your next turn`],freeze_1:[`Enemy cannot move on their next turn`],snowball:[`Freeze an enemy piece — cannot move on its owner's next turn`],freeze_2:[`Enemy cannot move on their next turn`],deep_freeze:[`Freeze all enemies on one diagonal through your piece for 2 turns`],retreat_3:[`Backward movement for 3 turns`],bishop_2:[`Diagonal slide over empty dark squares for 2 turns`],rook_2:[`Rank/file slide over empty dark squares for 2 turns`],crown:[`Instantly crown a friendly piece`],swap_friendly:[`Swap two friendly pieces`],quick_march:[`Same piece moves again; either step may capture`],offering:[`Sacrifice a friendly piece`,`Draw 2 cards`,`Cast another spell immediately`],destroy_unshielded:[`Destroy any unshielded enemy`,`You cannot cast spells on your next turn`],revive:[`Requires a captured friendly piece`,`Place on any empty dark square on your side of the board`,`Revived piece cannot capture this turn`],blink_2:[`Teleport within 2 squares`],random_teleport:[`Jump to a random empty dark square`,`Crowned if you land on the back rank`],long_step:[`Epic: leap 2 squares diagonally (no capture)`],dash:[`Move 1 square forward-diagonally`,`Destroy enemy on landing square`],sidestep:[`Skip 2 columns on the same row`],landmine:[`Hidden trap 2 turns — destroys enemy lander`],quicksand:[`Hidden trap — freezes the next piece to land there`],detonate:[`Destroy self + adjacent enemies`],venom:[`Poison — 2 ticks destroys target`],bomb:[`Arm friendly piece`,`On next move: explodes`,`Kills all adjacent pieces`],shockwave:[`Arm friendly piece`,`On next move: paralyzes all adjacent pieces`,`1 turn — does not kill`],plague:[`Infect your piece + adjacent pieces`,`Seed spreads plague on every move`,`All infected die in 2 owner turns`],press:[`Opponent must move again after their normal move on their next turn`],mind_control:[`Convert an enemy man to your color for 2 of your turns`,`Reverts to the enemy afterward`],barrier:[`Place on any dark square`,`Blocks enemies for 2 turn cycles`],vengeance:[`Hidden trap — destroys the next enemy who captures your piece`,`Your piece survives 2 turns (blood counters), then dies`],hibernation:[`Sleep 2 turns (immobile)`,`Wake as king + Awoken Bear`,`Extra move every turn after`],fusion:[`Merge two adjacent men into one`,`Becomes king + Awoken Bear`,`Extra move every turn after`],root_2:[`Enemy cannot jump/capture next turn`],silence_3:[`Suppress special movement 3 turns`],poison_3:[`Enemy dies in 3 turns — 3-turn poison bar`],deflect_1:[`Hidden trap — spell hit within 2 turns kills closest enemy instead`],last_stand:[`Hidden trap — ultra shield on capture or destroy for 3 turns`],clone:[`Your man, then adjacent empty square — copy cannot capture or be taken this turn; dies to freeze/poison/burn/plague`],deport:[`Send an enemy back to its game-start square`,`Destroys any piece already on that square`],bounty:[`Mark an enemy piece`,`When you jump-capture it, draw 2 cards`,`Spell destroys do not count`],link_fate:[`Link two enemies — when one is destroyed, the other dies too`]},lr={instant:[`Instant — no board target`],friendly:[`Target your piece`],enemy:[`Target enemy piece`],empty:[`Target empty dark square`],f_empty:[`Your piece, then destination`],f_f:[`Two friendly pieces`],f_e:[`Your piece, then enemy`],f_e_adj:[`Your piece, then adjacent enemy`],diagonal:[`Your piece, then diagonal strike`],discard_pick:[`Choose a card to discard`],e_e:[`Two enemy pieces`],column:[`Pick a board file (a–h)`]};function ur(e){let t=[];return cr[e.effect]?t.push(...cr[e.effect]):e.desc&&t.push(e.desc),lr[e.mode]&&t.push(...lr[e.mode]),(e.rarity===`epic`||e.rarity===`legendary`)&&t.push(`${e.rarity.charAt(0).toUpperCase()+e.rarity.slice(1)} spell`),[...new Set(t)]}function dr(e){return ur(e).join(` · `)}var k=70,A=60,fr=k/64,pr=A/64;function mr(e){return`<g transform="scale(${fr}, ${pr})">${e}</g>`}function hr(e){return`<g class="card-motif" opacity="0.98">${e}</g>`}function gr(e,t,n=5,r=.88){return`<circle cx="${e}" cy="${t}" r="${n}" fill="currentColor" opacity="${r}" stroke="#0f172a" stroke-width="0.8"/>`}function _r(e,t,n=4){return`<circle cx="${e}" cy="${t}" r="${n}" fill="none" stroke="currentColor" stroke-width="1.6" stroke-dasharray="3 2" opacity="0.5"/>
    <ellipse cx="${e}" cy="${t+n*.5}" rx="${n*.8}" ry="${n*.3}" fill="currentColor" opacity="0.12"/>`}function vr(e,t,n=6){return`<path d="M${e-n} ${t-n} L${e+n} ${t+n} M${e+n} ${t-n} L${e-n} ${t+n}" stroke="#0f172a" stroke-width="3.6" stroke-linecap="round" opacity="0.4"/>
    <path d="M${e-n} ${t-n} L${e+n} ${t+n} M${e+n} ${t-n} L${e-n} ${t+n}" stroke="currentColor" stroke-width="2.6" stroke-linecap="round"/>`}function yr(e,t,n=5){return`<ellipse cx="${e}" cy="${t+n*.55}" rx="${n*1.1}" ry="${n*.35}" fill="#000" opacity="0.28"/>
  ...
  <ellipse cx="${e-n*.28}" cy="${t-n*.32}" rx="${n*.42}" ry="${n*.28}" fill="#fca5a5" opacity="0.55"/>
    ...
    <ellipse cx="${e}" cy="${t}" rx="${n}" ry="${r}" fill="#000" opacity="0.32"/>`}function N(e,t=`#e2e8f0`,n=.55){return e.map(([e,r,i=1])=>{let a=i*2.2;return`<path d="M${e} ${r-a} L${e+a*.3} ${r-a*.3} L${e+a} ${r} L${e+a*.3} ${r+a*.3} L${e} ${r+a} L${e-a*.3} ${r+a*.3} L${e-a} ${r} L${e-a*.3} ${r-a*.3} Z" fill="${t}" opacity="${n}"/>`}).join(``)}function P(e,t,n=5.5){return`${Tr(e,t,n)}
    ...
    <circle cx="${e}" cy="${t}" r="${n+4.5}" fill="none" stroke="#93c5fd" stroke-width="0.7" opacity="0.15"/>`}function F(e,t,n=5.5){return`${yr(e,t,n)}
    ...
    <path d="M${n} ${r} L${n-l*7+d*4} ${r-u*7+f*4} M${n} ${r} L${n-l*7-d*4} ${r-u*7-f*4}" stroke="${i}" stroke-width="${a}" fill="none" stroke-linecap="round"/>`}function br(e,t,n,r,i=`#93c5fd`,a=2){let o=(e+n)/2,s=(t+r)/2-8;return`<path d="M${e} ${t} Q${o} ${s} ${n} ${r}" stroke="#0f172a" stroke-width="${a+2.4}" fill="none" opacity="0.22"/>
    <path d="M${e} ${t} Q${o} ${s} ${n} ${r}" stroke="${i}" stroke-width="${a+1}" fill="none" opacity="0.28"/>
    <path d="M${e} ${t} Q${o} ${s} ${n} ${r}" stroke="${i}" stroke-width="${a}" fill="none" stroke-linecap="round"/>`}function xr(e,t,n=`#60a5fa`,r=`#93c5fd`,i=``){let a=i?` filter="url(#${i})"`:``;return`<path d="M${e} ${t-14} L${e+11} ${t-6} L${e+11} ${t+8} C${e+11} ${t+16} ${e} ${t+22} ${e} ${t+22} C${e} ${t+22} ${e-11} ${t+16} ${e-11} ${t+8} L${e-11} ${t-6} Z" fill="${n}" opacity="0.48" stroke="#0f172a" stroke-width="2.2"${a}/>
    ...
    <path d="M${e-2} ${t-8} L${e+3} ${t-3}" stroke="#fff" stroke-width="1.2" opacity="0.35" stroke-linecap="round"/>`}function Sr(e,t,n=28,r=!0){return`<rect x="${e-n/2}" y="${t-n/2}" width="${n}" height="${n}" rx="3" fill="#1c1917" opacity="0.65" stroke="#57534e" stroke-width="1.6"/>
    ...
    <rect x="${e-n/2+2}" y="${t-n/2+2}" width="${n-4}" height="${n-4}" rx="1" fill="none" stroke="#78716c" stroke-width="0.9" opacity="0.35"/>`}function Cr(e,t,n=5,r=`#c4b5fd`){return`<circle cx="${e}" cy="${t}" r="${n+5}" fill="${r}" opacity="0.1"/>
    <circle cx="${e}" cy="${t}" r="${n+2}" fill="none" stroke="${r}" stroke-width="0.8" opacity="0.35"/>
    <path d="M${e} ${t-n} L${e+n*.6} ${t-n*.2} L${e+n} ${t+n*.4} L${e+n*.3} ${t+n} L${e-n*.3} ${t+n} L${e-n} ${t+n*.4} L${e-n*.6} ${t-n*.2} Z" fill="none" stroke="${r}" stroke-width="1.4" opacity="0.72"/>`}function wr(e,t,n,r){let i=`lg-${e}`;return`<defs>
  ...
  ${mr(r)}`}function R(e,t,n,r){let i=`cm-${e}`,a=`cm-vig-${e}`;return`<defs>
  ...
  <g filter="url(#${i}-glow)">${mr(r)}</g>`}function z(e,t,n,r){let i=`uc-${e}`,a=`uc-vig-${e}`;return`<defs>
  ...
  <rect width="${k}" height="${A}" fill="url(#${a})"/>
  <g filter="url(#${i}-glow)">${mr(r)}</g>`}function B(e,t,n,r){let i=`ra-${e}`,a=`ra-vig-${e}`;return`<defs>
  ...
  <rect width="${k}" height="${A}" fill="url(#${a})"/>
  <g filter="url(#${i}-glow)">${mr(r)}</g>`}function V(e,t,n,r){let i=`ep-${e}`;return`<defs>
  ...
  <rect width="${k}" height="${A}" fill="url(#${i})"/>
  ${mr(r)}`}function Tr(e,t,n=5){return`<ellipse cx="${e}" cy="${t+n*.55}" rx="${n*1.1}" ry="${n*.35}" fill="#000" opacity="0.28"/>
    ...
    <path d="M${e-n*.35} ${t+n*.15} Q${e} ${t+n*.45} ${e+n*.35} ${t+n*.15}" fill="none" stroke="#1e40af" stroke-width="1.2" opacity="0.45"/>`}var Er=new Set(`nudge.backstep.retreat_3.anchor_2.recall.repel.leapfrog.random_teleport.rally.coin_flip.ignore.iron_will.demote.quicksand.create_foe.barrier.panic.swap_friendly.sidestep.press.shield_1.snowball.long_step.shield_2.poison_3.deflect_1.forward_bolt.crown.blink_2.landmine.reverse_only_2.root_2.sacrifice.scatter.mass_nudge.sanctuary_pulse.last_stand.cryo_bolt.collapse.last_king.snipe.dominion.backstab.bomb.berserk.bounty.chain_lightning.clone.confusion.constitution.counterspell.cull.deep_freeze.deport.destroy_unshielded.duel.earthquake.execution.hostile_swap.link_fate.magnet.mind_control.purify.pyromancy.quick_march.revive.shockwave.plague.bishop_2.rook_2.offering.tangle.call_forward.dash.blizzard.bulwark.darkness.fortify.hibernation.vengeance.sanctuary.fusion.chameleon.blind.trickster.displacement`.split(`.`));function Dr(e){return Er.has(e)}function Or(){return`${M(32,54,20,4)}
    ...
    <path d="M14 20 L18 16 M50 18 L54 14" stroke="#fca5a5" stroke-width="1.4" stroke-linecap="round" opacity="0.55"/>`}function kr(){return`${M(32,56,20,4)}
    ...
    <circle cx="14" cy="14" r="2" fill="#fbbf24" opacity="0.6"/><circle cx="54" cy="16" r="1.5" fill="#fde68a" opacity="0.5"/>`}function Ar(){return`${M(32,56,24,5)}
    ...
    ${N([[48,8,.8],[10,10,.7],[56,20,.9],[6,24,.6]],`#e0f2fe`,.7)}`}function jr(){return`${M(32,54,18,4)}
    ...
    <path d="M10 24 L14 28 L8 32 M54 26 L50 30 L56 34" stroke="#a5b4fc" stroke-width="1.4" fill="none" opacity="0.7"/>`}function Mr(){return`${M(32,54,18,4)}
    ...
    ${N([[16,12,.7],[52,14,.8],[44,8,.6]],`#fde68a`,.65)}`}function Nr(){return`${M(32,54,22,4)}
    ...
    ${N([[20,10,.9],[44,12,.8],[32,6,1.1],[14,24,.7],[50,22,.7]],`#bbf7d0`,.65)}`}function Pr(){return`${M(32,56,24,5)}
  ...
  <path d="M14 54 L18 50 M50 54 L46 50 M54 14 L50 18 M10 14 L14 18" stroke="#d6d3d1" stroke-width="1.8" stroke-linecap="round" opacity="0.65"/>
    <path d="M8 32 L14 32 M50 32 L56 32 M32 8 L32 14 M32 50 L32 56" stroke="#a8a29e" stroke-width="1.4" stroke-linecap="round" opacity="0.4"/>`}function Fr(){return`${M(32,54,22,4)}
    ${F(46,28,5.5)} ${vr(46,28,6)}
    ${P(18,46,5.5)}
    ...
    ${N([[34,14,.9],[40,20,.7],[28,18,.8]],`#fca5a5`,.6)}`}function Ir(){return`${M(32,56,16,4)}
    ${F(32,52,6)}
    ...
    ${Cr(50,10,4,`#e9d5ff`)}
    ${N([[12,6,.8],[48,8,1],[22,4,.7],[36,44,.9]],`#e9d5ff`,.65)}`}function Lr(){let e=(e,t,n)=>`<g transform="translate(${e}, 40) scale(${t?-1:1}, 1)">
    ...
    ${N([[32,24,1],[26,20,.7],[38,20,.7]],`#fde68a`,.7)}`}function Rr(){return`${M(36,56,18,4)}
    ${F(42,52,6)}
    ...
    ${N([[38,38,.7],[46,46,.6]],`#fca5a5`,.55)}`}function zr(){return`${M(32,54,22,4)}
    ...
    ${N([[34,36,.7],[38,44,.6],[32,22,.8]],`#fde68a`,.6)}`}function Br(){return`${M(32,54,20,4)}
    ${P(32,42,6)}
    ...
    ${N([[32,8,.8],[20,32,.6],[44,32,.6]],`#bae6fd`,.55)}`}function Vr(){return`${M(32,54,22,4)}
    ${P(32,36,6)}
    ...
    ${N([[32,14,.9],[8,36,.7],[56,36,.7]],`#e9d5ff`,.6)}`}function Hr(){return`${M(32,54,22,4)}
    ${P(32,36,6)}
    ...
    ${N([[32,22,.85],[10,24,.6],[54,24,.6]],`#86efac`,.55)}`}function Ur(){return`${M(32,54,22,4)}
    ${F(48,32,6)}
    ...
    ${N([[22,20,.8],[36,28,.7],[36,36,.7]],`#e9d5ff`,.6)}`}function Wr(){return`${M(32,54,18,4)}
    ${F(32,36,6)}
    ...
    ${N([[16,20,.8],[48,38,.7],[32,10,.9]],`#e9d5ff`,.6)}`}function Gr(){return`${M(32,54,20,4)}
    ...
    ${N([[14,14,.8],[48,16,.7],[32,8,.9]],`#e9d5ff`,.6)}`}function Kr(){return`${M(32,54,22,4)}
    ${P(32,50,5)}
    ...
    ${N([[50,10,1],[12,52,.8],[40,20,.7]],`#e0f2fe`,.7)}`}function qr(){return`${M(32,54,22,4)}
    ...
    ${N([[20,12,.9],[44,12,.8],[32,4,1],[14,28,.7],[50,28,.7]],`#fff`,.55)}`}function Yr(){return`${M(32,56,18,4)}
    ...
    ${N([[14,10,.7],[50,10,.7],[32,28,.8]],`#fde68a`,.6)}`}function Xr(){return`${M(32,54,22,4)}
    ...
    ${Cr(32,36,4,`#e9d5ff`)}
    ${N([[32,28,.8],[32,44,.7]],`#e9d5ff`,.6)}`}function Zr(){return`${M(32,54,20,4)}
    ${P(22,38,5.5)}
    ...
    ${N([[36,32,.7],[48,34,.6],[42,28,.8]],`#e9d5ff`,.55)}`}function Qr(){return`${M(32,56,18,4)}
    ${P(32,42,6)}
  ...
  ${mr(`<ellipse cx="32" cy="56" rx="20" ry="4" fill="#000" opacity="0.35"/>
  ...
  ${yr(14,50,3.2)}${Tr(50,50,3.2)}`)}`}function ei(){return`${M(24,54,20,4)}
    ${F(48,20,5.5)}
    ...
    ${N([[18,32,.8],[28,28,.6]],`#e9d5ff`,.55)}`}function ti(){return`${M(28,54,18,4)}
    ${P(22,44,5.5)}
    ...
    ${N([[30,8,.8],[52,6,.7],[24,28,.6]],`#e9d5ff`,.6)}`}function ni(){return`${M(32,52,22,4)}
    ...
    ${N([[32,34,.9],[16,14,.7],[48,14,.7]],`#e0f2fe`,.6)}`}function ri(){return`${M(32,54,18,4)}
    ${P(32,48,5.5)}
    ...
    ${N([[32,6,.7],[4,44,.6],[60,44,.6]],`#e9d5ff`,.55)}`}function ai(){return`${M(30,52,20,4)}
    ${F(46,20,5.5)}
    ...
    ${N([[36,26,.7],[22,38,.6]],`#fca5a5`,.5)}`}function oi(){return`${M(30,54,18,4)}
    ${P(18,50,5)}
    ${F(44,28,5)}
    ...
    ${N([[38,34,.7]],`#e9d5ff`,.5)}`}function si(){return`${M(32,54,26,4)}
    ...
    ${N([[8,10,.8],[56,12,.9],[32,18,.7]],`#e0f2fe`,.65)}`}function ci(){return`${M(32,54,22,4)}
    ...
    ${xr(32,34,`#7c3aed`,`#e9d5ff`)}
    ${N([[20,40,.7],[44,24,.7],[32,28,.8]],`#e9d5ff`,.55)}`}function li(){return`${M(32,54,24,4)}
    ...
    ${N([[16,10,.7],[48,10,.7],[10,32,.6],[54,32,.6]],`#c4b5fd`,.45)}`}function ui(){return`${M(32,56,16,4)}
    ${P(32,34,6)}
    ...
    ${xr(32,30,`#7c3aed`,`#e9d5ff`)}
    <text x="18" y="54" font-size="7" fill="#ddd6fe" opacity="0.8" font-weight="700">HOLD</text>
    ${N([[32,12,.8],[12,34,.6],[52,34,.6]],`#e9d5ff`,.5)}`}function di(){return`${M(32,56,16,4)}
    ${P(32,38,6)}
    ...
    ${N([[32,4,.8],[18,8,.6],[46,8,.6]],`#fde68a`,.55)}`}function fi(){return`${M(30,54,18,4)}
    ${P(28,36,6)}
    ...
    ${N([[12,12,.7],[46,18,.6]],`#fca5a5`,.5)}`}function pi(){return`${M(32,54,20,4)}
    ...
    ${N([[32,8,.8],[14,28,.6],[50,28,.6]],`#e9d5ff`,.5)}`}function mi(){return`${M(32,54,20,4)}
    ...
    <path d="M24 50 C30 44 34 44 40 50" stroke="#fde68a" stroke-width="2" fill="none" opacity="0.7"/>
    ${j(32,14,5,`#fde68a`,`#b45309`)}
    ${N([[24,36,.7],[40,36,.7],[32,8,.9]],`#fde68a`,.6)}`}function hi(){return`${M(32,54,18,4)}
    ${P(32,34,6)}
    ...
    ${N([[46,16,.7],[24,20,.5]],`#c4b5fd`,.45)}`}function _i(){return`${M(32,54,24,4)}
    ...
    ${N([[8,8,.7],[56,8,.7],[8,56,.7],[56,56,.7]],`#fde68a`,.6)}`}function vi(){return`${M(28,54,18,4)}
    ${P(18,44,5.5)}
    ${I(42,24,6,`#cbd5e1`)}
    ...
    ${N([[40,20,.7],[22,36,.5]],`#e2e8f0`,.45)}`}function yi(){return`${M(32,54,16,4)}
    ${P(32,20,5.5)}
    ${I(32,48,6,`#cbd5e1`)}
    ...
    ${N([[32,16,.6],[32,44,.5]],`#cbd5e1`,.4)}`}function bi(){return`${M(32,54,16,4)}
    ${P(32,26,5.5)}
    ...
    ${N([[32,6,.7]],`#cbd5e1`,.4)}`}function Si(){return`${M(32,54,22,4)}
    ${P(32,24,5.5)}
    ...
    ${N([[20,40,.5],[44,40,.5]],`#93c5fd`,.4)}`}function Ci(){return`${M(30,54,20,4)}
    ${P(20,36,5)}${F(40,36,5)}
    ${I(54,36,5,`#fca5a5`)}
    ...
    ${N([[48,32,.6]],`#fde68a`,.45)}`}function wi(){return`${M(28,54,20,4)}
    ...
    ${N([[30,14,.8],[20,38,.5]],`#bae6fd`,.5)}`}function Ti(){return`${M(32,54,18,4)}
    ${P(32,40,5.5)}
    ...
    ${N([[24,12,.8],[48,20,.7],[32,6,.9]],`#e9d5ff`,.55)}`}function Ei(){return`${M(32,54,22,4)}
    ...
    ${N([[32,10,.8],[16,40,.5],[48,40,.5]],`#93c5fd`,.45)}`}function Di(){return`${M(32,54,16,4)}
    ${P(32,36,6)}
    ...
    ${N([[16,12,.6]],`#fca5a5`,.4)}`}function Oi(){return`${M(32,54,18,4)}
    ${P(32,34,6)}
    ...
    ${N([[32,20,.7]],`#e2e8f0`,.4)}`}function ki(){return`${M(32,54,16,4)}
    ${F(32,40,6)}
    ...
    ${N([[24,4,.6],[40,4,.6]],`#fde68a`,.45)}`}function Ai(){return`${M(32,54,18,4)}
    ${Sr(32,36,32)}
    ...
    ${N([[30,36,.5]],`#d6d3d1`,.35)}`}function ji(){return`${M(32,54,16,4)}
    ...
    ${N([[46,10,.7]],`#fca5a5`,.5)}`}function Mi(){return`${M(32,54,16,4)}
    ...
    ${N([[32,20,.5],[32,40,.5]],`#cbd5e1`,.35)}`}function Ni(){return`${M(32,54,16,4)}
    ${F(32,22,6)}
    ...
    ${N([[28,16,.6],[36,16,.6]],`#fca5a5`,.45)}`}function Pi(){return`${M(32,54,20,4)}
    ...
    ${Cr(32,34,4,`#c4b5fd`)}
    ${N([[32,30,.7]],`#e9d5ff`,.45)}`}function Fi(){return`${M(28,54,18,4)}
    ${P(12,34,5.5)}
    ${I(50,34,6,`#cbd5e1`)}
    ...
    ${N([[46,30,.6]],`#e2e8f0`,.4)}`}function Ii(){return`${M(32,54,18,4)}
    ${F(32,28,6)}
    ...
    ${j(32,52,5,`#fca5a5`,`#dc2626`)}`}function Li(){return`${M(32,56,16,4)}
    ${P(32,38,6)}
    ${xr(32,30,`#60a5fa`,`#93c5fd`)}
    ...
    ${N([[32,18,.7],[20,32,.5],[44,32,.5]],`#bae6fd`,.4)}`}function Ri(){return`${M(32,54,18,4)}
    ${P(32,36,6)}
    ...
    ${N([[14,10,.7],[20,22,.5]],`#e0f2fe`,.5)}`}function zi(){return`${M(30,54,20,4)}
    ${P(14,50,5.5)}
    ${I(50,14,6,`#7dd3fc`)}
    ...
    ${N([[48,12,.7],[24,38,.5]],`#bae6fd`,.45)}`}function Bi(){return`${M(32,56,16,4)}
    ${P(32,38,6)}
    ${xr(32,28,`#38bdf8`,`#7dd3fc`)}
    ...
    ${N([[32,14,.8],[14,34,.5],[50,34,.5]],`#bae6fd`,.45)}`}function Vi(){return`${M(32,54,16,4)}
    ${F(32,34,6)}
    ...
    ${N([[32,10,.7],[28,44,.5],[36,44,.5]],`#86efac`,.45)}`}function Hi(){return`${M(26,54,16,4)}
    ${P(24,38,5.5)}
    ...
    ${N([[48,10,.6]],`#fde68a`,.45)}`}function Ui(){return`${M(30,54,18,4)}
    ...
    ${N([[42,20,.7]],`#fde68a`,.5)}`}function Wi(){return`${M(32,56,16,4)}
    ${P(32,40,6)}
    ...
    ${N([[22,4,.7],[32,0,.8],[42,4,.7]],`#fde68a`,.6)}`}function Gi(){return`${M(30,54,20,4)}
    ...
    ${N([[46,12,.8],[24,40,.5]],`#e0f2fe`,.5)}`}function Ki(){return`${M(32,54,16,4)}
    ${Sr(32,36,32)}
    ...
    ${N([[32,24,.6]],`#fca5a5`,.4)}`}function qi(){return`${M(32,54,18,4)}
    ${F(32,20,6)}
    ...
    ${N([[32,44,.5]],`#fca5a5`,.4)}`}function Ji(){return`${M(32,54,16,4)}
    ${F(32,24,6)}
  ...
  <path d="M28 48 L24 54 M36 48 L40 54" stroke="#86efac" stroke-width="1.4" stroke-linecap="round" opacity="0.35"/>
    ${N([[20,40,.5],[44,40,.5]],`#86efac`,.4)}`}function Yi(){return`${M(30,54,20,4)}
    ...
    ${j(48,22,5,`#ef4444`,`#991b1b`)}`}function Xi(){return`${M(32,54,18,4)}
    ...
    ${N([[32,8,.6],[56,32,.6],[32,56,.6],[8,32,.6]],`#bae6fd`,.4)}`}function Zi(){return`${M(26,54,20,4)}
    ...
    ${N([[8,20,.6],[42,20,.6]],`#bae6fd`,.4)}`}function Qi(){return`${M(32,54,22,4)}
    ...
    ${N([[44,10,.75],[30,28,.55],[20,46,.5]],`#e9d5ff`,.5)}`}function $i(){return`${M(32,54,24,4)}
    ...
    ${N([[32,28,.7],[12,38,.5],[52,38,.5]],`#bae6fd`,.45)}`}function ea(){return`${M(32,56,14,3)}
    ${P(32,34,6)}
    ${xr(32,28,`#38bdf8`,`#7dd3fc`)}
    ...
    <text x="10" y="18" font-size="6" fill="#e9d5ff" opacity="0.55">?</text>`}function ta(){return`${M(30,54,18,3.5)}
    ...
    <circle cx="42" cy="22" r="8" fill="#7dd3fc" opacity="0.12"/>`}function na(){return`${M(32,54,14,3.5)}
    ${Sr(32,36,30,!1)}
    ${Tr(32,34,4)}
    ...
    <path d="M24 38 L28 42 M36 38 L40 42" stroke="#d6d3d1" stroke-width="1.2" stroke-linecap="round" opacity="0.4"/>`}function ra(){return`${M(32,56,14,3)}
    ${P(32,38,7)}
    ...
    ${xr(32,34,`#38bdf8`,`#7dd3fc`)}
    <circle cx="32" cy="12" r="4" fill="#fde68a" opacity="0.3"/>`}function ia(){return`${M(32,54,20,4)}
    ...
    <path d="M18 44 L22 40 M46 18 L50 14" stroke="#fbbf24" stroke-width="1.2" stroke-linecap="round" opacity="0.45"/>`}function aa(){return`${M(32,54,18,3.5)}
    ...
    <circle cx="32" cy="40" r="14" fill="none" stroke="#60a5fa" stroke-width="0.8" opacity="0.2"/>`}var oa={nudge:()=>R(`nu`,`#94a3b8`,`#1e293b`,vi()),backstep:()=>R(`bs`,`#9ca3af`,`#1f2937`,yi()),retreat_3:()=>R(`ret`,`#93c5fd`,`#1e3a5f`,bi()),leapfrog:()=>R(`lf`,`#94a3b8`,`#1e293b`,wi()),long_step:()=>z(`ls`,`#7dd3fc`,`#1e3a5f`,zi()),sidestep:()=>R(`ss`,`#9ca3af`,`#1f2937`,Fi()),blink_2:()=>z(`bl`,`#38bdf8`,`#0c4a6e`,Gi()),random_teleport:()=>R(`rtp`,`#a78bfa`,`#312e81`,Ti()),recall:()=>R(`rc`,`#93c5fd`,`#1e3a5f`,Si()),repel:()=>R(`rp`,`#94a3b8`,`#1e293b`,Ci()),mass_nudge:()=>z(`mn`,`#7dd3fc`,`#1e3a5f`,Zi()),displacement:()=>B(`dp`,`#b794f4`,`#553c7a`,Qi()),swap_friendly:()=>R(`sw`,`#a78bfa`,`#312e81`,Pi()),dominion:()=>z(`dm`,`#60a5fa`,`#1e3a5f`,aa()),shield_1:()=>R(`s1`,`#60a5fa`,`#1e3a5f`,Li()),shield_2:()=>z(`s2`,`#38bdf8`,`#0c4a6e`,Bi()),bulwark:()=>B(`bw`,`#b794f4`,`#553c7a`,ci()),barrier:()=>R(`br`,`#94a3b8`,`#1f2937`,Mi()),last_stand:()=>z(`ls`,`#38bdf8`,`#0c4a6e`,ea()),fortify:()=>B(`fo`,`#a78bfa`,`#4c1d95`,ui()),sanctuary_pulse:()=>z(`sp`,`#7dd3fc`,`#1e3a5f`,$i()),sanctuary:()=>B(`sa`,`#c4b5fd`,`#4c1d95`,pi()),deflect_1:()=>z(`df`,`#38bdf8`,`#0c4a6e`,Hi()),anchor_2:()=>R(`an`,`#94a3b8`,`#1f2937`,xi()),iron_will:()=>R(`iw`,`#9ca3af`,`#1f2937`,Oi()),vengeance:()=>B(`vg`,`#9f7aea`,`#3b0764`,fi()),rally:()=>R(`rl`,`#60a5fa`,`#1e3a5f`,Ei()),forward_bolt:()=>z(`fb`,`#fde68a`,`#1e3a5f`,Ui()),destroy_unshielded:()=>wr(`sh`,`#4338ca`,`#1e1b4b`,jr()),pyromancy:()=>wr(`py`,`#ea580c`,`#431407`,Mr()),snipe:()=>z(`sn`,`#fde68a`,`#1e3a5f`,ia()),duel:()=>R(`du`,`#d4b896`,`#3d2817`,Lr()),sacrifice:()=>z(`sc`,`#fca5a5`,`#1e3a5f`,Yi()),cull:()=>V(`cu`,`#a78bfa`,`#2e1065`,Ir()),execution:()=>V(`ex`,`#6ee7b7`,`#14532d`,Rr()),chain_lightning:()=>wr(`cl`,`#2563eb`,`#0c1929`,Ar()),backstab:()=>z(`bk`,`#c4a574`,`#2d4a6e`,Or()),cryo_bolt:()=>z(`cb`,`#7dd3fc`,`#0c4a6e`,ta()),bomb:()=>wr(`bm`,`#f59e0b`,`#78350f`,kr()),shockwave:()=>V(`sw`,`#c4b5fd`,`#3b1f6e`,Vr()),plague:()=>V(`pg`,`#86efac`,`#14532d`,Hr()),magnet:()=>V(`mg`,`#6ee7b7`,`#14532d`,zr()),poison_3:()=>z(`po`,`#86efac`,`#14532d`,Vi()),root_2:()=>z(`ro`,`#86efac`,`#14532d`,Ji()),panic:()=>R(`pn`,`#fca5a5`,`#1f2937`,Ni()),blizzard:()=>B(`bz`,`#7dd3fc`,`#1e3a5f`,si()),snowball:()=>R(`sb`,`#bae6fd`,`#0c4a6e`,Ri()),berserk:()=>wr(`bk`,`#991b1b`,`#450a0a`,Fr()),create_foe:()=>R(`cf`,`#78716c`,`#292524`,ji()),deep_freeze:()=>V(`df`,`#7dd3fc`,`#0c4a6e`,Kr()),reverse_only_2:()=>z(`rv`,`#fca5a5`,`#1e3a5f`,qi()),press:()=>R(`pr`,`#fca5a5`,`#1f2937`,Ii()),tangle:()=>B(`tg`,`#93c5fd`,`#312e81`,ni()),blind:()=>B(`bl`,`#a78bfa`,`#4c1d95`,gi()),confusion:()=>V(`cf`,`#c4b5fd`,`#4c1d95`,Wr()),fog_2:()=>hr(`${gr(32,34,6)}<ellipse cx="32" cy="24" rx="16" ry="8" fill="currentColor" opacity="0.22"/>`),crown:()=>z(`cr`,`#fbbf24`,`#451a03`,Wi()),demote:()=>R(`dm`,`#fca5a5`,`#1f2937`,ki()),fusion:()=>B(`fu`,`#8b5cf6`,`#4c1d95`,mi()),clone:()=>V(`cln`,`#93c5fd`,`#312e81`,Zr()),chameleon:()=>B(`ch`,`#86efac`,`#312e81`,hi()),hibernation:()=>B(`hi`,`#c4b5fd`,`#4c1d95`,di()),quicksand:()=>R(`qs`,`#a8a29e`,`#292524`,Ai()),landmine:()=>z(`lm`,`#78716c`,`#292524`,Ki()),collapse:()=>z(`co`,`#78716c`,`#292524`,na()),darkness:()=>B(`dk`,`#6d28d9`,`#1e1b4b`,li()),scatter:()=>z(`st`,`#7dd3fc`,`#1e3a5f`,Xi()),call_forward:()=>B(`cfw`,`#fca5a5`,`#4c1d95`,ai()),dash:()=>B(`ds`,`#c4b5fd`,`#4c1d95`,oi()),earthquake:()=>wr(`eq`,`#78716c`,`#292524`,Pr()),coin_flip:()=>$r(),ignore:()=>R(`ig`,`#94a3b8`,`#1f2937`,Di()),counterspell:()=>V(`cs`,`#a78bfa`,`#2e1065`,Gr()),purify:()=>V(`pu`,`#6ee7b7`,`#14532d`,Jr()),trickster:()=>B(`tr`,`#c4b5fd`,`#553c7a`,_i()),offering:()=>B(`of`,`#d8b4fe`,`#553c7a`,ti()),quick_march:()=>V(`qm`,`#60a5fa`,`#1e3a5f`,Br()),constitution:()=>V(`co`,`#4ade80`,`#14532d`,Qr()),last_king:()=>z(`lk`,`#fbbf24`,`#1e3a5f`,ra()),revive:()=>wr(`rv`,`#15803d`,`#052e16`,Nr()),mind_control:()=>V(`mc`,`#c4b5fd`,`#3b0764`,Ur()),bounty:()=>V(`bo`,`#4ade80`,`#14532d`,Yr()),link_fate:()=>V(`lf`,`#a78bfa`,`#2e1065`,Xr()),bishop_2:()=>B(`bp`,`#b794f4`,`#4c1d95`,ri()),rook_2:()=>B(`rk`,`#a78bfa`,`#4c1d95`,ii()),hostile_swap:()=>V(`hs`,`#93c5fd`,`#312e81`,qr()),deport:()=>V(`dp`,`#c4b5fd`,`#1e1b4b`,ei())};function sa(e,t=0){let n=oa[e.effect];return n?n(t):null}var ca={movement:{symbol:`↗`,label:`Motion`,anim:`movement`},combat:{symbol:`⚔`,label:`Strike`,anim:`combat`},defense:{symbol:`🛡`,label:`Ward`,anim:`defense`},debuff:{symbol:`❄`,label:`Curse`,anim:`debuff`},transform:{symbol:`✦`,label:`Morph`,anim:`transform`},board:{symbol:`◇`,label:`Terrain`,anim:`board`},crown:{symbol:`♔`,label:`Royal`,anim:`crown`},arcane:{symbol:`✧`,label:`Arcane`,anim:`arcane`}},la=[[`movement`,[`nudge`,`backstep`,`long_step`,`leapfrog`,`recall`,`teleport`,`random_teleport`,`displacement`,`berserk`,`dash`]],[`combat`,[`stab`,`shatter`,`destroy`,`snipe`,`duel`,`execution`,`cull`,`pyromancy`,`backstab`,`sacrifice`,`chain_lightning`,`cryo`,`bomb`,`magnet`]],[`special`,[`create_foe`,`clone`,`earthquake`]],[`defense`,[`shield`,`ward`,`aegis`,`bulwark`,`stall`,`sanctuary`,`barrier`,`anchor`,`iron_will`,`backrank_protection`,`hibernation`,`constitution`]],[`debuff`,[`root`,`panic`,`backpedal`,`blizzard`,`deep_freeze`,`snowball`,`blind`,`confusion`,`press`,`tangle`,`shockwave`]],[`board`,[`quicksand`,`landmine`,`collapse`,`darkness`,`earthquake`,`scatter`,`call_forward`]],[`meta`,[`counterspell`,`vengeance`,`last_stand`,`purify`,`trickster`,`ignore`,`offering`,`quick_march`,`dominion`,`last_king`,`revive`,`mind_control`]]];function ua(e){let t=0;for(let n=0;n<e.length;n++)t=(t+e.charCodeAt(n)*41)%360;return t}function da(e){let t=0;for(let n=0;n<e.length;n++)t=(t+e.charCodeAt(n)*13)%3;return t}function fa(e){let t=`${e.id} ${e.effect} ${e.name}`.toLowerCase();for(let[e,n]of la)if(Array.isArray(n)&&n.some(e=>t.includes(e)))return e;return`arcane`}function pa(e){return`ca${String(e).replace(/[^a-zA-Z0-9]/g,``)}`}function ma(e,t,n){let r=[[12,18,.35],[48,12,.5],[52,44,.25],[18,50,.4],[38,28,.55]],i=n*4;return r.map(([e,n,r],a)=>`<circle cx="${(e+i+a*7)%56+4}" cy="${(n+i*2+a*5)%52+6}" r="1.2" fill="hsl(${t} 90% 85% / ${r})"/>`).join(``)}function ha(e,t){let n=t,r={movement:`
      ...
      </g>`};return r[e]||r.arcane}function ga(e,t,n,r){return _a(e,t,n,r)}function _a(e,t,n,r){let i=pa(n),a=(t+42)%360,o=da(n),s=r&&sa(r,o)||ha(e,o);return r?.effect&&Dr(r.effect)&&s?`<svg class="spell-card__svg spell-card__svg--full-bleed" viewBox="0 0 70 60" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid meet">${s}</svg>`:`<svg class="spell-card__svg" viewBox="0 0 70 60" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
  ...
  </svg>`}function va(e){return e.tiny?`tiny`:e.small?`small`:e.compact?`compact`:`full`}function ya(e){let t=ur(e);return t.length?`<ul class="spell-card__effects">${t.map(e=>`<li>${Ca(e)}</li>`).join(``)}</ul>`:``}var ba=new WeakMap;function xa(e){let t=e?.querySelector?.(`.spell-card__name`),n=e?.querySelector?.(`.spell-card__title-frame`);if(!t||!n)return;let r=()=>{t.classList.add(`spell-card__name--fit`),t.style.fontSize=``,t.style.textOverflow=``,t.style.overflow=``;let e=n.clientWidth;if(e<=0)return;let r=parseFloat(getComputedStyle(t).fontSize);if(!r)return;let i=r*.55;for(;t.scrollWidth>e&&r>i;)r-=.5,t.style.fontSize=`${r}px`;t.scrollWidth>e&&(t.style.overflow=`hidden`,t.style.textOverflow=`ellipsis`)};if(r(),requestAnimationFrame(r),!ba.has(e)&&typeof ResizeObserver<`u`){let t=new ResizeObserver(()=>r());t.observe(n),ba.set(e,t)}}function Sa(e,t={}){let n=fa(e),r=ua(e.id),i=ca[n]||ca.arcane,a=va(t),o=!(t.hideDesc||t.gallery)&&a!==`tiny`,s=t.showViewFullHint||t.gallery,c=t.button?`button`:`div`,l=document.createElement(c);t.button&&(l.type=`button`);let u=e.rarity===`legendary`?`legendary`:e.rarity;l.className=[`spell-card`,`spell-card--${a}`,`spell-card--anim-${i.anim}`,u,e.rarity===`rare`?`spell-card--rare-fx`:``,e.rarity===`epic`?`spell-card--epic-fx`:``,e.rarity===`legendary`?`spell-card--legendary-fx`:``,e.rarity===`uncommon`?`spell-card--uncommon-fx`:``,e.rarity===`common`?`spell-card--common-fx`:``,`theme-${n}`,t.disabled?`disabled`:``,t.selected?`selected`:``,t.static?`static`:``,t.deal?`spell-card--deal`:``,t.fullDesc?`spell-card--full-desc`:``,t.gallery?`spell-card--gallery`:``].filter(Boolean).join(` `),l.style.setProperty(`--card-hue`,String(r)),l.dataset.cardId=e.id,l.title=dr(e);let d=e.rarity===`legendary`?`<div class="spell-card__fx spell-card__fx--legendary" aria-hidden="true"></div>`:e.rarity===`epic`?`<div class="spell-card__fx spell-card__fx--epic" aria-hidden="true"></div>`:e.rarity===`rare`?`<div class="spell-card__fx spell-card__fx--rare" aria-hidden="true"></div>`:e.rarity===`uncommon`?`<div class="spell-card__fx spell-card__fx--uncommon" aria-hidden="true"></div>`:e.rarity===`common`?`<div class="spell-card__fx spell-card__fx--common" aria-hidden="true"></div>`:``,f=e?.effect&&Dr(e.effect);return l.innerHTML=`
    ${d}
    <div class="spell-card__frame">
      <div class="spell-card__title-frame">
        <h3 class="spell-card__name">${Ca(e.name)}</h3>
      </div>
      ...
      <div class="spell-card__type-frame${s?` spell-card__type-frame--with-hint`:``}">
        ...
        ${t.meta?`<span class="spell-card__meta">${Ca(t.meta)}</span>`:``}
      </div>
      ${o?`<div class="spell-card__text-frame"><p class="spell-card__desc">${Ca(e.desc)}</p></div>`:``}
    </div>
    <div class="spell-card__tooltip" role="tooltip">
      <strong>${Ca(e.name)}</strong>
      ${ya(e)}
    </div>
  `,t.onClick&&l.addEventListener(`click`,n=>{t.disabled||t.onClick(n,e)}),xa(l),l}function Ca(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function wa(e){return document.getElementById(e)}function Ta(){let e=wa(`card-preview-modal`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function Ea(e){document.body.classList.toggle(`card-preview-open`,e),window.dispatchEvent(new CustomEvent(`card-preview-change`,{detail:{open:e}}))}function Da(){wa(`card-preview-modal`)?.classList.add(`hidden`),wa(`card-preview-mount`)?.classList.remove(`card-preview-mount--reveal-only`),Ea(!1)}function Oa(e,t={}){Ta();let n=wa(`card-preview-modal`),r=wa(`card-preview-mount`),i=wa(`card-preview-actions`);if(!(!n||!r||!e)){if(r.innerHTML=``,r.classList.toggle(`card-preview-mount--reveal-only`,!!t.hideDesc),r.appendChild(Sa(e,{static:!0,hideDesc:t.hideDesc})),i){if(i.innerHTML=``,t.meta){let e=document.createElement(`p`);e.className=`card-preview-meta`,e.textContent=t.meta,i.appendChild(e)}let e=document.createElement(`div`);if(e.className=`card-preview-actions-row`,t.onPlay){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=`Cast spell`,n.addEventListener(`click`,()=>{Da(),t.onPlay()}),e.appendChild(n)}if(t.onAdd){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=`Add to deck`,n.disabled=!!t.addDisabled,n.addEventListener(`click`,()=>{t.addDisabled||t.onAdd()}),e.appendChild(n)}if(t.onBuy){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=t.buyLabel||`Buy copy`,n.disabled=!!t.buyDisabled,n.addEventListener(`click`,()=>{t.buyDisabled||t.onBuy()}),e.appendChild(n)}if(t.onRemove){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-secondary`,n.textContent=`Remove all from deck`,n.addEventListener(`click`,()=>{t.onRemove(),Da()}),e.appendChild(n)}e.children.length&&i.appendChild(e)}n.classList.remove(`hidden`),Ea(!0)}}function ka(){wa(`card-preview-close`)?.addEventListener(`click`,Da),wa(`card-preview-backdrop`)?.addEventListener(`click`,Da),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&Da()})}function Aa(e,t=`.spell-card`){e&&e.querySelectorAll(t).forEach((e,t)=>{e.classList.add(`spell-card--deal`),e.style.animationDelay=`${t*.1}s`})}function ja(e){e&&(e.classList.add(`spell-card--rare-burst`),setTimeout(()=>e.classList.remove(`spell-card--rare-burst`),900))}function Ma(e){e&&(e.classList.add(`spell-card--epic-burst`),setTimeout(()=>e.classList.remove(`spell-card--epic-burst`),1200))}function Na(e){e&&(e.classList.add(`spell-card--legendary-burst`),setTimeout(()=>e.classList.remove(`spell-card--legendary-burst`),1500))}function Pa(e,t){t===`legendary`?Na(e):t===`epic`?Ma(e):t===`rare`&&ja(e)}var Fa={common:10,uncommon:20,rare:30,epic:40,legendary:50};function Ia(e){return Fa[e]??30}function La(e,r){let i=ce(e,r);if(i<1)return{success:!1,message:`Get this spell from a chest first.`};let a=n(r);if(!a)return{success:!1,message:`Unknown card.`};let o=t(r);if(i>=o)return{success:!1,message:`You already own the maximum (${o} copies).`};let s=Ia(a.rarity);if(e.gems<s)return{success:!1,message:`Need ${s} gems (${e.gems} available).`};e.gems-=s;let c=ye(e,r,1);return c?{success:!0,cost:s,message:`+1 ${a.name} for ${s} gems (${i+c} owned).`}:(e.gems+=s,w(e),{success:!1,message:`You already own the maximum copies for this rarity.`})}var Ra={deck:`<svg class="nav-icon-svg" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  </svg>`};function za(){let e={deck:Ra.deck,chests:Ra.chests,play:Ra.play,pvp:Ra.pvp,quests:Ra.quests};for(let t of document.querySelectorAll(`.game-nav .tab-btn[data-tab]`)){let n=t.querySelector(`.tab-btn__icon`),r=t.dataset.tab;n&&e[r]&&(n.innerHTML=e[r])}}var Ba=`arcaneCheckersSettings_v1`,Va={musicEnabled:!0,musicVolume:.45,sfxEnabled:!0,sfxVolume:.7,hapticsEnabled:!0},Ha={...Va};function Ua(){try{let e=localStorage.getItem(Ba);return e?{...Va,...JSON.parse(e)}:{...Va}}catch{return{...Va}}}function H(){return{...Ha}}function Wa(e){Ha={...Ha,...e};try{localStorage.setItem(Ba,JSON.stringify(Ha))}catch{}return window.dispatchEvent(new CustomEvent(`arcane-settings-changed`,{detail:H()})),H()}function Ga(){return Ha=Ua(),H()}var Ka={hub:`assets/audio/background.m4a`,match:`assets/audio/background.m4a`},qa={tap:`assets/audio/sfx/tap.mp3`,spell:`assets/audio/sfx/spell.mp3`,capture:`assets/audio/sfx/capture.mp3`,win:`assets/audio/sfx/win.mp3`,chest:`assets/audio/sfx/chest.mp3`},Ja=null,Ya=null,Xa=`hub`,Za=!1;function Qa(){return typeof Audio<`u`}function $a(e,t){if(!(!Qa()||!H().sfxEnabled))try{let n=new Audio(e);n.volume=Math.max(0,Math.min(1,t*H().sfxVolume)),n.play().catch(()=>{})}catch{}}function eo(e){let t=Ka[e];if(!t||!Qa())return null;let n=e===`hub`?Ja:Ya;return n||(n=new Audio(t),n.loop=!0,n.preload=`auto`,e===`hub`?Ja=n:Ya=n),n}function to(e){e&&(e.volume=Math.max(0,Math.min(1,H().musicVolume)))}function no(){Ja?.pause(),Ya?.pause()}function ro(){Za||!Qa()||(Za=!0,[Ja,Ya].forEach(e=>{e&&e.play().then(()=>e.pause()).catch(()=>{})}))}function io(e){if(Xa=e,!H().musicEnabled){no();return}let t=eo(`hub`),n=eo(`match`);e===`match`?(t?.pause(),n&&(to(n),n.play().catch(()=>{}))):(n?.pause(),t&&(to(t),t.play().catch(()=>{})))}function ao(){if(!H().musicEnabled){no();return}to(Ja),to(Ya),io(Xa)}function oo(){if(!Qa())return;window.addEventListener(`arcane-settings-changed`,()=>ao());let e=()=>{ro(),H().musicEnabled&&io(Xa),window.removeEventListener(`pointerdown`,e),window.removeEventListener(`keydown`,e)};window.addEventListener(`pointerdown`,e,{once:!0}),window.addEventListener(`keydown`,e,{once:!0})}function so(e){let t=qa[e];t&&$a(t,1)}var co={tap:()=>so(`tap`),spell:()=>so(`spell`),capture:()=>so(`capture`),win:()=>so(`win`),chest:()=>so(`chest`)},lo=null,uo=!1;async function fo(){if(uo)return lo;uo=!0;try{let{Capacitor:e}=await E(async()=>{let{Capacitor:e}=await import(`./dist-DM6qMOWp.js`);return{Capacitor:e}},[],import.meta.url);if(!e.isNativePlatform())return null;lo=(await E(()=>import(`./esm-TGGH6JYM.js`),[],import.meta.url)).ScreenOrientation}catch{lo=null}return lo}async function po(){document.body.classList.remove(`orientation-match`),document.body.classList.add(`orientation-portrait`);let e=await fo();if(e)try{await e.lock({orientation:`portrait`})}catch{}}async function mo(){await po()}var ho=null;function go(){return ho||(ho=document.createElement(`div`),ho.id=`network-banner`,ho.className=`network-banner hidden`,ho.setAttribute(`role`,`status`),ho.setAttribute(`aria-live`,`polite`),document.body.appendChild(ho),ho)}function _o(){let e=go(),t=!navigator.onLine;e.textContent=t?`No connection — some features need internet`:``,e.classList.toggle(`hidden`,!t)}function vo(){_o(),window.addEventListener(`online`,_o),window.addEventListener(`offline`,_o)}async function yo(){try{let{Capacitor:e}=await E(async()=>{let{Capacitor:e}=await import(`./dist-DM6qMOWp.js`);return{Capacitor:e}},[],import.meta.url);if(!e.isNativePlatform())return;let{StatusBar:t,Style:n}=await E(async()=>{let{StatusBar:e,Style:t}=await import(`./esm-C-SIlwqj.js`);return{StatusBar:e,Style:t}},[],import.meta.url);await t.setOverlaysWebView({overlay:!0}),await t.setStyle({style:n.Dark}),await t.setBackgroundColor({color:`#080a12`});let{SplashScreen:r}=await E(async()=>{let{SplashScreen:e}=await import(`./esm-Ck_AT-RK.js`);return{SplashScreen:e}},[],import.meta.url);await r.hide()}catch(e){console.warn(`Capacitor init skipped`,e)}}var bo=null,xo=!1;async function So(){if(xo)return bo;xo=!0;try{let{Capacitor:e}=await E(async()=>{let{Capacitor:e}=await import(`./dist-DM6qMOWp.js`);return{Capacitor:e}},[],import.meta.url);if(!e.isNativePlatform())return null;let{Haptics:t,ImpactStyle:n}=await E(async()=>{let{Haptics:e,ImpactStyle:t}=await import(`./esm-D_it6P9V.js`);return{Haptics:e,ImpactStyle:t}},[],import.meta.url);bo={Haptics:t,ImpactStyle:n}}catch{bo=null}return bo}async function Co(){if(!H().hapticsEnabled)return;let e=await So();if(e)try{await e.Haptics.impact({style:e.ImpactStyle.Light})}catch{}}var wo={bronze:{label:`Bronze`,tagline:`Same odds as Bronze Chest`,visual:`bronze`,accent:`#c77dff`,glow:`rgba(199, 125, 255, 0.45)`},silver:{label:`Silver`,tagline:`Same odds as Silver Chest`,visual:`silver`,accent:`#7dd3fc`,glow:`rgba(125, 211, 252, 0.5)`},gold:{label:`Gold`,tagline:`Same odds as Gold Chest`,visual:`gold`,accent:`#ffd87a`,glow:`rgba(255, 216, 122, 0.55)`}};function To(e){let t=wo[e]||wo.style_crate,n=t.visual;return{tier:t,lid:n===`gold`?`#f0e6c8`:n===`silver`?`#e4ecf8`:`#e8c4f8`,body:n===`gold`?`#5a4518`:n===`silver`?`#3d4a62`:`#4a2860`,trim:t.accent,ribbon:n===`gold`?`#ff9de2`:n===`silver`?`#a5f3fc`:`#d8b4fe`}}function Eo(e,t){let{lid:n,body:r,trim:i,ribbon:a}=To(e);return`
    <defs>
      <linearGradient id="${t}-body" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stop-color="${r}"/>
    ...
    </defs>`}function Do(e,t,n){let{trim:r,ribbon:i,tier:a}=To(e);return`
    ...
    </g>`}function Oo(e){let t=`vanityStage-${e}`;return`<svg class="chest-stage-svg vanity-box-svg" viewBox="0 0 120 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ${Eo(e,t)}
    <ellipse class="chest-stage__shadow" cx="60" cy="90" rx="42" ry="8" fill="rgba(0,0,0,0.5)"/>
    ${Do(e,t,!0)}
  </svg>`}function ko(e){let t=`vanityCard-${e}`;return`<svg class="chest-svg vanity-box-svg" viewBox="0 0 120 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ${Eo(e,t)}
    <ellipse cx="60" cy="90" rx="42" ry="8" fill="rgba(0,0,0,0.5)"/>
    ${Do(e,t,!1)}
  </svg>`}function Ao(e){let t=jo[e]||jo.avatar_default,n=`av-${e.replace(/[^a-z0-9]/gi,``)}`;return`<svg viewBox="0 0 64 64" class="cosmetic-avatar-svg cosmetic-avatar-svg--${e.replace(`avatar_`,``)}" aria-hidden="true">
    <defs>
    ...
    ${t.svg}
  </svg>`}var jo={avatar_default:{bg:[`#4a5f7a`,`#1e2a3a`],glow:`#8fa4c4`,svg:`<ellipse cx="32" cy="38" rx="14" ry="16" fill="#2a3548"/>
      ...
      <circle cx="38" cy="42" r="1.3" fill="#fff" opacity="0.7"/>`}};function Mo(e){let t={banner_default:`linear-gradient(135deg,#1e2a44,#2d4a6e)`,banner_nebula:`linear-gradient(135deg,#2a1f4e,#6b4fd4 55%,#1a1030)`,banner_crimson:`linear-gradient(135deg,#3a1018,#8b2030 50%,#1a0a10)`,banner_storm:`linear-gradient(135deg,#1a2840,#3d7ab8 45%,#9ad4ff)`,banner_aurora:`linear-gradient(135deg,#0f3d3a,#5ce1e6 40%,#9f7aea 80%,#1a0a20)`,banner_forest:`linear-gradient(135deg,#1a2e0e,#2d5016 50%,#0f1a08)`,banner_sunset:`linear-gradient(135deg,#431407,#c2410c 45%,#fdba74 75%,#1a0a04)`,banner_midnight:`linear-gradient(135deg,#0f172a,#1e3a5f 50%,#020617)`,banner_ocean:`linear-gradient(135deg,#042f2e,#0e7490 45%,#164e63 80%,#020617)`,banner_eclipse:`linear-gradient(135deg,#0a0a0a,#1a1a2e 35%,#fbbf24 50%,#0a0a0a 65%,#312e81)`};return t[e]||t.banner_default}function No(e){return e===`pieceSkin`?`Piece skin`:e===`frame`?`Frame`:e===`avatar`?`Avatar`:e===`banner`?`Banner`:e}function Po(e){return`profile-frame profile-frame--${(e||`frame_default`).replace(/^frame_/,``)}`}function Fo(e){return(e||`frame_default`).replace(/^frame_/,``),`<div class="cosmetic-frame-preview ${Po(e)}">
    <div class="cosmetic-frame-preview__inner">${Ao(`avatar_default`)}</div>
  </div>`}function Io(e,t){return t===`avatar`?Ao(e):t===`frame`?Fo(e):t===`banner`?`<div class="cosmetic-preview-banner" style="background:${Mo(e)}"></div>`:t===`pieceSkin`?Lo(e):``}function Lo(e){let t=e.replace(`skin_`,``);return`<div class="cosmetic-skin-preview">
    <span class="piece red piece-skin-${t} king"></span>
    <span class="piece black piece-skin-${t}"></span>
  </div>`}function Ro(e){let t=document.createElement(`article`);t.className=`cosmetic-reveal-card rarity-${e.rarity} cosmetic-reveal-card--${e.type}`,e.duplicate&&t.classList.add(`cosmetic-reveal-card--duplicate`);let n=Io(e.id,e.type),r=No(e.type);return t.innerHTML=`
    ...
    </div>`,t.style.animationDelay=`0s`,t}function zo(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function Bo(e,t=``){let n=x(e),r=(t||`P`).charAt(0).toUpperCase(),i=Ao(n.equipped.avatar)||`<span class="profile-avatar-fallback">${zo(r)}</span>`;return`<span class="profile-avatar-stack header-profile-btn__stack ${Po(n.equipped.frame)}"><span class="profile-avatar-inner header-profile-btn__inner">${i}</span></span>`}async function Vo(e){if(!e)return``;try{return(await Oe(e.id))?.username||e.user_metadata?.display_name||e.email?.split(`@`)[0]||``}catch{return e.user_metadata?.display_name||e.email?.split(`@`)[0]||``}}var Ho=null;function Uo(){return Ho||=Promise.all([E(()=>import(`./match-CyAwB8rC.js`),[],import.meta.url),E(()=>import(`./matchView-BiuI_MHI.js`),[],import.meta.url),E(()=>Promise.resolve({}),__vite__mapDeps([0]),import.meta.url),E(()=>Promise.resolve({}),__vite__mapDeps([1]),import.meta.url)]).then(([e,t])=>({MatchSession:e.MatchSession,getMatchHtml:t.getMatchHtml})),Ho}var Wo=null;function Go(){return Wo||=Promise.all([E(()=>import(`./pvpUI-zN9NReuB.js`),[],import.meta.url),E(()=>import(`./pvp-Cgjjh1iA.js`),[],import.meta.url)]).then(([e,t])=>({initPvpUI:e.initPvpUI,clearAllWaitingRoomsOnce:t.clearAllWaitingRoomsOnce})),Wo}var Ko=null;function qo(){return Ko||=E(()=>import(`./profileUI-Dsl8g_kD.js`),[],import.meta.url),Ko}var Jo=null;function Yo(){return Jo||=Promise.all([E(()=>import(`./settingsUI-Dsq-PGG0.js`),[],import.meta.url),E(()=>Promise.resolve({}),__vite__mapDeps([2]),import.meta.url)]).then(([e])=>e),Jo}var Xo=null;function Zo(){return Xo||=Promise.all([E(()=>import(`./chestOpenAnimation-BW0Bx4ot.js`),[],import.meta.url),E(()=>import(`./cosmeticOpenAnimation-Bt0_8-GI.js`),[],import.meta.url)]).then(([e,t])=>({playChestOpenAnimation:e.playChestOpenAnimation,playCosmeticOpenAnimation:t.playCosmeticOpenAnimation})),Xo}var Qo=null;function $o(){return Qo||=E(()=>import(`./tutorialMeta-JJiIOgxE.js`),[],import.meta.url),Qo}var es=null;function ts(){return es||=E(()=>import(`./tutorialUnlocks-D4onUppV.js`),[],import.meta.url),es}var ns=null;function rs(){return ns||=E(()=>import(`./tutorialMatch-Bw5vlSe4.js`),[],import.meta.url),ns}function is(e,t){$o().then(n=>n.notifyMetaTutorial(e,t))}function as(e,t){ts().then(n=>n.notifyUnlockTutorial(e,t))}var U;try{U=T()}catch(e){console.error(`Failed to load profile, resetting save:`,e),localStorage.removeItem(`cardCheckersProfile_v7`),localStorage.removeItem(`cardCheckersProfile_v5`),U=T()}var W=`deck`,os={deck:`Decks`,chests:`Shop`,play:`Play`,pvp:`PvP`,quests:`Quests`,profile:`Profile`,settings:`Settings`},ss=new Set(Object.keys(os)),cs=`cards`,ls=`list`,G=null,K=[],us=null,ds=``,fs=`all`,ps=`all`,ms=!0,hs={legendary:5,epic:4,rare:3,uncommon:2,common:1};function gs(e){return[...e].sort((e,t)=>{let n=hs[e.rarity]??0,r=hs[t.rarity]??0;return n===r?e.name.localeCompare(t.name):r-n})}var q=null,_s=null,vs=null;function ys(){return _s?Promise.resolve(_s):(vs||=Go().then(({initPvpUI:e,clearAllWaitingRoomsOnce:t})=>(t(),_s=e({root:document.getElementById(`view-pvp`),getProfile:()=>U,openAuthModal:()=>xs?.open(`signin`,{forced:!0}),onNavigateTab:X,onOpenDeckEdit:Ac,onPvpViewShown:()=>{W=`pvp`,Bs()}}),_s)),vs)}var bs=null,xs=null,J=!1,Ss=!1,Cs=!1,ws=!1,Ts=!1,Es=null,Ds=null,Os=null,ks=1,As=null;function js(e){return hs[e?.rarity]??0}function Ms(e){let t=i(e);return Object.entries(t).map(([e,t])=>({def:n(e),count:t})).filter(e=>e.def).sort((e,t)=>{let n=js(t.def)-js(e.def);return n===0?e.def.name.localeCompare(t.def.name):n})}function Ns(e){let t=K.indexOf(e);t<0||(K.splice(t,1),$(),is(`card-removed-from-deck`,{cardId:e}))}function Ps(e){let t=K.length;K=K.filter(t=>t!==e),K.length!==t&&($(),is(`card-removed-from-deck`,{cardId:e}))}function Fs(){let n=e().map(e=>({def:e,owned:ce(U,e.id)})).filter(e=>e.owned>0).sort((e,t)=>{let n=js(t.def)-js(e.def);return n===0?e.def.name.localeCompare(t.def.name):n});K=[];for(let{def:e,owned:r}of n){let n=Math.min(r,t(e));for(let t=0;t<n&&K.length<30;t++)K.push(e.id);if(K.length>=30)break}$()}var Y=e=>document.getElementById(e);function Is(){let e=document.getElementById(`adventure-prebattle`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function Ls(){Is(),document.getElementById(`adventure-prebattle`)?.classList.remove(`hidden`),document.body.classList.add(`adventure-floor-open`)}function Rs(){document.getElementById(`adventure-prebattle`)?.classList.add(`hidden`),document.body.classList.remove(`adventure-floor-open`)}function zs(e=fe){let t=Y(`adventure-help-btn`);t&&Mn({title:t.getAttribute(`aria-label`)||`Help`,bodyHtml:e,triggerBtn:t,autoCloseMs:4500})}function Bs(){document.body.classList.toggle(`main-tab-active`,ss.has(W)),document.body.classList.toggle(`adventure-active`,W===`play`)}function Vs(e,t,n){let r=e.querySelector(`.tab-btn__sign-in-badge`);t?(r||(r=document.createElement(`span`),r.className=`tab-btn__sign-in-badge`,r.setAttribute(`aria-hidden`,`true`),e.appendChild(r)),r.textContent=n,e.classList.add(`tab-btn--sign-in-nudge`)):(r?.remove(),e.classList.remove(`tab-btn--sign-in-nudge`))}function Hs(){let e=le(U),t=Bt();for(let n of[`quests`,`pvp`]){let r=document.querySelector(`.tab-btn[data-tab="${n}"]`);if(!r)continue;let i=n===`pvp`?`PvP`:`Quests`,a=!e,o=n===`pvp`?Rt:zt;r.classList.toggle(`tab-btn--locked`,a),r.setAttribute(`aria-disabled`,a?`true`:`false`),a?(r.title=t?`${m(i)} ${o}.`:m(i),Vs(r,t,`Sign in`)):t?(r.title=o,Vs(r,n===`pvp`,`Sign in`)):(r.title=``,Vs(r,!1))}let n=h(U),r=document.querySelector(`.vault-tab[data-vault-tab="cosmetics"]`);r&&(r.classList.toggle(`vault-tab--locked`,!n),r.title=n?``:ie,r.setAttribute(`aria-disabled`,n?`false`:`true`))}async function X(e){let t=document.getElementById(`view-match`);if(!(J&&t&&!t.classList.contains(`hidden`))){if(!Ss&&(e===`quests`||e===`pvp`)&&!le(U)){let t=e===`pvp`?`PvP`:`Quests`,n=Bt(),r=e===`pvp`?Rt:zt;await Ye(n?`${m(t)}\n\n${r}.`:m(t),{title:`${t} locked`,confirmLabel:`Go to Adventure`,cancelLabel:n?`Sign in`:`Not now`})?(Ss=!0,X(`play`),Ss=!1):n&&xs?.open(`signin`,{forced:!0});return}if(Yn(),Bn()&&Hn()){if(e===W)return;if(!(e===`pvp`&&document.getElementById(`pvp-match-root`))){if(!await Ye(`Leave your current match to open ${os[e]||e}?`,{title:`Leave match?`,confirmLabel:`Leave`,cancelLabel:`Stay`,destructive:!0}))return;Un(e),Kn(),document.querySelector(`#btn-leave-match`)?.click();return}}if(ls===`edit`&&(e!==`deck`||e===`deck`&&W===`deck`)){if(!await Oc())return;kc()}e!==`deck`&&ls===`edit`&&(lc(),document.body.classList.remove(`deck-editing`)),W=e,Bs(),ss.has(e)&&sc(),document.querySelectorAll(`.tab-btn`).forEach(t=>{t.classList.toggle(`active`,t.dataset.tab===e)}),document.querySelectorAll(`.view`).forEach(t=>{t.classList.toggle(`hidden`,t.id!==`view-${e}`)}),is(`tab-changed`,{tab:e}),as(`tab-changed`,{tab:e}),e===`chests`&&(_c(cs),yc()),e===`deck`&&(ls=`list`,dc(`list`)),e===`profile`&&Js(),e===`settings`&&Ys(),e===`quests`&&Xs(),e===`play`&&Rc(),e===`pvp`&&ys().then(e=>e?.render({resume:!0})).catch(e=>{console.error(`[PvP] init failed`,e);let t=document.getElementById(`view-pvp`);t&&!t.innerHTML.trim()&&(t.innerHTML=`<section class="panel game-panel pvp-panel"><p class="pvp-status pvp-status--error">Couldn't load PvP — please reload the page.</p></section>`)}),Bn()||(io(`hub`),await po())}}var Z=``;function Us(e=Z){e&&(Z=e);let t=document.getElementById(`header-profile-menu`),n=document.getElementById(`header-profile-btn`),r=document.getElementById(`header-username`),i=document.getElementById(`auth-header-btn`),a=!!D();if(i&&(i.classList.toggle(`hidden`,a),i.hidden=a),t&&(t.classList.toggle(`hidden`,!a),t.hidden=!a),r){let e=a&&Z;r.textContent=e?Z:``,r.classList.toggle(`hidden`,!e),r.hidden=!e}n&&a&&(n.innerHTML=Bo(U,Z),n.title=Z?`Account — ${Z}`:`Account menu`)}function Ws(){let e=document.getElementById(`header-profile-btn`),t=document.getElementById(`header-profile-dropdown`);!e||!t||(t.classList.add(`hidden`),t.hidden=!0,e.setAttribute(`aria-expanded`,`false`))}function Gs(){let e=document.getElementById(`header-profile-menu`),t=document.getElementById(`header-profile-btn`),n=document.getElementById(`header-profile-dropdown`);if(!e||!t||!n)return;let r=e=>{n.classList.toggle(`hidden`,!e),n.hidden=!e,t.setAttribute(`aria-expanded`,e?`true`:`false`)};t.addEventListener(`click`,e=>{e.stopPropagation();let t=!n.hidden;r(!t)}),n.querySelectorAll(`[data-profile-menu-action]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.profileMenuAction;Ws(),t===`settings`?X(`settings`):qs()})}),document.addEventListener(`click`,t=>{n.hidden||e.contains(t.target)||Ws()}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&!n.hidden&&Ws()})}async function Ks(){let e=D();if(!e){Z=``,Us();return}Z=await Vo(e),Us()}function qs(){Ws(),X(`profile`),as(`profile-opened`)}async function Js(){let{renderProfileTab:e}=await qo(),t=Y(`view-profile`);e(U,t,{onGemsChange:Zs,onTitleChanged:()=>Us()})}async function Ys(){let{renderSettingsTab:e}=await Yo();e(Y(`view-settings`),{onUsernameChanged:e=>{Z=e,Us(e)}})}async function Xs(){let{renderQuestsTab:e}=await qo();e(U,Y(`view-quests`),{onTitleChanged:()=>Us(),onCurrencyChange:()=>Q()})}function Q(){let e=Y(`header-gems`);e&&(e.textContent=String(U.gems??0));let t=Y(`header-stars`);t&&(t.textContent=String(U.stars??0)),document.querySelector(`.hud-gems`)?.classList.toggle(`hud-gems--low`,(U.gems??0)<50),document.querySelector(`.hud-stars`)?.classList.toggle(`hud-stars--low`,(U.stars??0)<10)}function Zs(){Q()}function Qs(){document.querySelectorAll(`.collection-owned-only-toggle`).forEach(e=>{e.checked=ms});for(let e of[`collection-search`]){let t=Y(e);t&&(t.value=ds)}for(let e of[`collection-rarity`]){let t=or(e);t&&(t.value=fs)}let e=or(`collection-category`);e&&(e.value=ps)}var $s=`(max-width: 899px)`,ec=`(max-width: 1280px)`,tc=null;function nc(){return window.matchMedia($s).matches}function rc(){return document.body.classList.contains(`main-tab-active`)&&!document.body.classList.contains(`match-active`)&&!document.body.classList.contains(`deck-editing`)&&window.matchMedia(ec).matches}function ic(){return document.querySelector(`.game-main`)}function ac(){let e=ic();return rc()&&e?e.scrollTop:window.scrollY||document.documentElement.scrollTop||0}function oc(e){let t=ic();if(rc()&&t){t.scrollTop=e;return}window.scrollTo(0,e)}function sc(){let e=ic();if(rc()&&e){e.scrollTop=0;return}window.scrollTo(0,0)}function cc(){nc()&&(tc=ac(),document.body.style.position=`fixed`,document.body.style.top=`0`,document.body.style.left=`0`,document.body.style.right=`0`,document.body.style.width=`100%`)}function lc(){if(tc==null)return;let e=tc;tc=null,document.body.style.position=``,document.body.style.top=``,document.body.style.left=``,document.body.style.right=``,document.body.style.width=``,oc(e)}function uc(){sc(),document.documentElement.scrollTop=0,document.body.scrollTop=0,document.querySelector(`.game-shell`)?.scrollTo?.(0,0),ic()?.scrollTo?.(0,0),document.querySelector(`#view-deck`)?.scrollTo?.(0,0),document.querySelectorAll(`#deck-subview-edit, #deck-subview-edit .deck-editor, #deck-subview-edit .deck-editor__body, #deck-subview-edit .deck-editor__grid, #deck-subview-edit .deck-editor__grid-cards`).forEach(e=>{e.scrollTop=0})}function dc(e){e!==`edit`&&lc(),ls=e,document.body.classList.toggle(`deck-editing`,e===`edit`),Y(`deck-subview-list`)?.classList.toggle(`hidden`,e!==`list`),Y(`deck-subview-edit`)?.classList.toggle(`hidden`,e!==`edit`),e===`edit`&&(cc(),C(U),w(U),fs=`all`,ds=``,ps=`all`,ms=!0,Qs(),Ec()),e===`list`&&Nc(),e===`edit`&&($(),uc(),requestAnimationFrame(()=>{uc(),requestAnimationFrame(uc)}))}function fc({id:e,title:t,desc:n,cost:r,big:i=!1}){let a=(U.stars??0)>=r,o=i?Ot():Dt();return`
    ...
    </article>`}function pc(e,t){e.querySelector(`[data-mystery-open]`)?.addEventListener(`click`,e=>{e.stopPropagation(),t()}),e.addEventListener(`click`,t),e.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),t())})}async function mc(e,t){let{playChestOpenAnimation:n,playCosmeticOpenAnimation:r}=await Zo();if(e.kind===`card`)await n({tier:e.tier.id,tierLabel:`Small Mystery Box — ${e.tier.name}`,pulls:e.pulls}),t&&(t.textContent=`Got ${e.pulls.length} spells from ${e.tier.name}.`);else if(e.kind===`cosmetic`)await r({boxId:e.tier?.id||`bronze`,boxLabel:`Small Mystery Box`,pulls:e.pulls}),t&&(t.textContent=e.message+(e.bonusGems?` (+${e.bonusGems} gem refund)`:``));else if(e.kind===`both`&&(await n({tier:e.cardTier.id,tierLabel:`Big Mystery — ${e.cardTier.name}`,pulls:e.cardPulls}),await r({boxId:e.cosTier?.id||`gold`,boxLabel:`Big Mystery Box`,pulls:e.cosPulls}),t)){let n=e.bonusGems?` (+${e.bonusGems} gem refund)`:``;t.textContent=`${e.message}${n}`}}async function hc({big:e=!1}={}){let t=Y(`mystery-box-log`),n=e?20:10;if(!((U.stars??0)>=n)){t&&(t.textContent=`Need ${n} ★ stars. Clear Adventure floors to earn stars.`,t.classList.add(`chest-log--error`));return}let r=e?It(U):Ft(U);if(!r.success){t&&(t.textContent=r.message,t.classList.add(`chest-log--error`));return}w(U),Q(),t&&t.classList.remove(`chest-log--error`),Y(`mystery-box-list`)?.querySelectorAll(`.mystery-box__btn`).forEach(e=>{e.disabled=!0});try{await mc(r,t)}catch(e){console.error(`Mystery box animation failed:`,e),t&&(t.textContent=r.message)}yc({clearPulls:!1}),Js()}function gc(){let e=Y(`mystery-box-list`);if(!e)return;e.innerHTML=`
    ${fc({id:`standard`,title:`Small Mystery Box`,desc:`${Math.round(kt*100)}% cosmetics · ${Math.round((1-kt)*100)}% spells — same tier odds as Shop chests.`,cost:10})}
    ${fc({id:`big`,title:`Big Mystery Box`,desc:`Spells and cosmetics in one open — better tier odds (50% gold).`,cost:20,big:!0})}
  `;let t=e.querySelectorAll(`.mystery-box`);pc(t[0],()=>hc({big:!1})),pc(t[1],()=>hc({big:!0}))}function _c(e){if(!Cs&&e===`cosmetics`&&!h(U)){zs(ie),Cs=!0,_c(`cards`),Cs=!1;return}cs=e,document.querySelectorAll(`.vault-tab`).forEach(t=>{let n=t.dataset.vaultTab===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,n?`true`:`false`)}),document.querySelectorAll(`.vault-tab-panel`).forEach(t=>{let n=t.id===`vault-tab-${e}`;t.classList.toggle(`hidden`,!n),t.hidden=!n}),as(`vault-tab-changed`,{tab:e})}function vc(){qo().then(({renderCosmeticBoxes:e})=>{e(U,Y(`cosmetic-box-list`),{logEl:Y(`cosmetic-box-log`),onGemsChange:Zs,cosmeticsUnlocked:h(U),onOpened:()=>{W===`profile`&&Js(),W===`quests`&&Xs()}})})}function yc(e={}){let{clearPulls:t=!0}=e;Q(),vc(),gc();let n=Y(`chest-list`),r=Y(`chest-pulls`);if(r&&t&&(r.innerHTML=``,r.classList.add(`chest-pulls--hidden`),r.classList.remove(`chest-pulls--reveal`)),n){n.innerHTML=``;for(let e of at){let t=ft[e.id]||ft.bronze,i=U.gems>=e.cost,a=document.createElement(`article`);a.className=`chest-card chest-card--${e.id}${i?``:` chest-card--locked`}`,a.innerHTML=`
      <div class="chest-card__aura" aria-hidden="true"></div>
      <div class="chest-card__visual">${yt(e.id)}</div>
      <div class="chest-card__body">
        <h3 class="chest-card__name">${e.name}</h3>
        <p class="chest-card__tagline">${dt(e.weights)}</p>
    ...
    `;let o=a.querySelector(`.chest-open`);o.disabled=!i,o.addEventListener(`click`,async()=>{if(o.disabled)return;let n=lt(U,e.id),i=Y(`chest-log`);if(!n.success){i&&(i.textContent=n.message,i.classList.add(`chest-log--error`));return}w(U),Q(),o.disabled=!0;let{playChestOpenAnimation:a}=await Zo();if(await a({tier:e.id,tierLabel:t.label,pulls:n.pulls}),is(`chest-opened`,{chestId:e.id}),i&&(i.textContent=`Got ${n.pulls.length} new cards from ${e.name}.`,i.classList.remove(`chest-log--error`)),r){r.classList.remove(`chest-pulls--hidden`),r.classList.add(`chest-pulls--reveal`),r.innerHTML=`<p class="chest-pulls__label">Chest opened</p><div class="chest-pulls__grid"></div>`;let e=r.querySelector(`.chest-pulls__grid`);n.pulls.forEach((t,n)=>{let r=Sa(t,{button:!0,deal:!0,gallery:!0,onClick:()=>Oa(t)});r.style.animationDelay=`${n*.12}s`,e.appendChild(r),Pa(r,t.rarity)}),Aa(e),r.scrollIntoView({behavior:`smooth`,block:`nearest`})}yc()}),n.appendChild(a)}}}function bc(){return gs(e().filter(e=>{if(ps!==`all`&&it(e)!==ps||fs!==`all`&&e.rarity!==fs)return!1;if(ds){let t=ds.toLowerCase();if(!e.name.toLowerCase().includes(t)&&!e.desc.toLowerCase().includes(t))return!1}return!(ms&&ce(U,e.id)<=0)}))}function xc(e,t){let n=La(U,e);return t&&(t.textContent=n.message,t.className=n.success?`deck-status ok`:`deck-status warn`),n.success&&(w(U),Q(),ls===`list`&&Nc(),ls===`edit`&&$()),n}function Sc(e,t){let n=La(U,e);return n.success?(w(U),Q(),K.push(e),_e(U,e),w(U),$(),t&&(t.hidden=!1,t.textContent=`Bought and added to deck.`,t.className=`deck-editor__error deck-status ok`),!0):(t&&(t.hidden=!1,t.textContent=n.message,t.className=`deck-editor__error deck-status warn`),!1)}function Cc(e){return a(K,e,U).ok?(K.push(e),_e(U,e),w(U),$(),is(`card-added-to-deck`,{cardId:e}),!0):!1}function wc(e,n,r={}){let{deckEdit:o=!1,statusEl:s=null}=r,c=ce(U,n.id),l=t(n),u=c>=l,d=Ia(n.rarity),f=U.gems>=d&&!u,p=o?a(K,n.id,U):{ok:!1},m=o&&i(K)[n.id]||0,h=K.length<30,g=m<l,ee=c>=1&&c<=m,_=c>=1&&!u,v=o&&!p.ok&&h&&g&&ee&&_,te=()=>xc(n.id,s),y=()=>{let e=ce(U,n.id),t=o&&i(K)[n.id]||0,r=e>=l,s=U.gems>=d&&!r,c=o?a(K,n.id,U):{ok:!1};Oa(n,{meta:o?`Owned ${e}/${l} · In deck ${t}/${l} · ${r?`max copies`:`${d} gems per copy`}`:`Owned ${e}/${l}${r?` · max copies`:` · ${d} gems per copy`}`,buyLabel:r?`Max copies owned`:`Buy copy (${d} gems)`,buyDisabled:!s||r||e<1,onBuy:()=>{te(),Da()},addDisabled:!c.ok,onAdd:o?()=>{Cc(n.id)&&y()}:void 0})};if(o){let t=document.createElement(`div`);t.className=`deck-editor-tile`+(ne(U,n.id)?` deck-editor-tile--new`:``);let r=Sa(n,{button:!0,gallery:!0,onClick:()=>y()});r.classList.add(`deck-editor-tile__card`),r.title=`${n.name} — tap for full card`;let i=c>0?`Owned ${c}/${l}`:`Not in collection`,a=document.createElement(`div`);a.className=`deck-editor-tile__meta`,a.innerHTML=`${i} · In deck ${m}/${l}${ne(U,n.id)?`<span class="deck-editor-tile__new">New</span>`:``}`,a.addEventListener(`click`,()=>y());let o=document.createElement(`button`);o.type=`button`,o.className=`deck-editor-tile__action`,p.ok?(o.classList.add(`deck-editor-tile__action--add`),o.textContent=`+ Add to deck`,o.addEventListener(`click`,e=>{e.stopPropagation(),Cc(n.id)})):v?(o.classList.add(`deck-editor-tile__action--buy`),o.textContent=f?`Add for ${d} gems`:`Need ${d} gems`,o.disabled=!f,o.addEventListener(`click`,e=>{e.stopPropagation(),Sc(n.id,s)})):(o.classList.add(`deck-editor-tile__action--disabled`),o.disabled=!0,K.length>=30?o.textContent=`Deck full (30/30)`:m>=l?o.textContent=`Max copies in deck`:c<1?o.textContent=`Open Shop chests to unlock`:p.reason?o.textContent=p.reason:o.textContent=`Can't add`),t.append(r,a,o),e.appendChild(t);return}let b=document.createElement(`div`);b.className=`collection-card-wrap`+(c<1?` collection-card-wrap--unowned`:``);let x=Sa(n,{button:!0,compact:!0,disabled:c<1||u,onClick:e=>{if(e.shiftKey){y();return}c<1||u||te()}});x.title=u?`${n.name} — max ${l} copies owned. Shift+click to inspect.`:`${n.name} — tap to buy (${d} gems). Shift+click to inspect.`,b.appendChild(x);let S=document.createElement(`span`);S.className=`collection-owned-count`,S.textContent=c>0?`×${c}`:`—`,b.appendChild(S);let re=document.createElement(`span`);re.className=`collection-buy-cost`,re.textContent=u?`MAX`:`${d} ◆`,(!f||u)&&re.classList.add(`collection-buy-cost--cant`),b.appendChild(re),e.appendChild(b)}function Tc(e,t={}){if(!e)return;let{deckEdit:n=!1,statusEl:r=null}=t;e.innerHTML=``;let i=bc();if(!i.length){e.className=`deck-editor__grid collection-grid`;let t=document.createElement(`p`);t.className=`collection-grid-empty muted`,t.textContent=n?`No spells match your filters. Try “All types”, clear search, or uncheck Owned only.`:`No cards match your filters. Open chests in the Shop to get more spells.`,e.appendChild(t);return}let a=0,o={deckEdit:n,statusEl:r};if(n||ps!==`all`){e.className=`deck-editor__grid collection-grid`;for(let t of i)try{wc(e,t,o),a+=1}catch(e){console.error(`Failed to render card:`,t?.id,e)}}else{e.className=`deck-editor__grid collection-categories`;let t=Object.fromEntries(tt.map(e=>[e,[]]));for(let e of i)t[it(e)].push(e);for(let n of tt){let r=t[n];if(!r.length)continue;let i=document.createElement(`section`);i.className=`collection-category-section`,i.dataset.category=n;let s=document.createElement(`h3`);s.className=`collection-category-title`,s.textContent=nt[n],i.appendChild(s);let c=document.createElement(`div`);c.className=`collection-grid deck-editor__grid-cards`;for(let e of r)try{wc(c,e,o),a+=1}catch(t){console.error(`Failed to render card:`,e?.id,t)}i.appendChild(c),e.appendChild(i)}}if(i.length>0&&a===0){e.className=`deck-editor__grid collection-grid`;let t=document.createElement(`p`);t.className=`collection-grid-empty collection-grid-empty--error`,t.textContent=`Spells failed to display. Hard refresh the page (Ctrl+Shift+R).`,e.appendChild(t)}}function Ec(){us={name:Y(`deck-name-input`)?.value?.trim()??``,cardIds:[...K]}}function Dc(){return us?(Y(`deck-name-input`)?.value?.trim()??``)!==us.name||K.length!==us.cardIds.length?!0:K.some((e,t)=>e!==us.cardIds[t]):!1}async function Oc(){return Dc()?Ye(`Discard unsaved changes to this deck?`,{title:`Unsaved changes`,confirmLabel:`Discard`,cancelLabel:`Keep editing`,destructive:!0}):!0}function kc(){G=null,K=[],us=null}function Ac(e){let t=U.decks.find(t=>t.id===e);if(!t)return;G=t.id,K=[...t.cardIds];let n=Y(`deck-name-input`);n&&(n.value=t.name),dc(`edit`),is(`deck-edit-opened`,{deckId:e})}function jc(e){let t=Object.fromEntries(tt.map(e=>[e,0]));for(let r of e){let e=n(r);e&&(t[it(e)]+=1)}return t}function Mc(e){let t=jc(e),n=[];for(let e of tt){let r=t[e];if(r<=0)continue;let i=nt[e];n.push(`<span class="deck-row__cat" title="${Ca(i)}: ${r}"><span class="deck-row__cat-dot deck-row__cat-dot--${e}" aria-hidden="true"></span><span class="deck-row__cat-n">${r}</span></span>`)}return n.length?`<div class="deck-row__cats">${n.join(``)}</div>`:``}function Nc(){C(U)&&w(U),Q();let e=Y(`deck-list`);if(!e)return;e.innerHTML=``;let t=Y(`deck-list-count`);if(t){let e=U.decks.length;t.textContent=e?`${e} deck${e===1?``:`s`}`:``}if(!U.decks.length){if(C(U)&&w(U),U.decks.length){Nc();return}e.innerHTML=`
      ...
      <h3 class="deck-row-name">${Ca(t.name)}</h3>
      <div class="deck-row__progress">
        <div class="deck-progress-bar deck-row__progress-bar" role="progressbar" aria-valuemin="0" aria-valuemax="30" aria-valuenow="${t.cardIds.length}" aria-label="${Ca(t.name)} progress">
    ...
    `,a.addEventListener(`click`,()=>Ac(t.id)),e.appendChild(a)}}function $(){Q();let e=Y(`collection-grid`),t=Y(`deck-slots`),n=Y(`deck-status`),i=Y(`edit-deck-heading`),a=Y(`deck-count-badge`),o=Y(`deck-progress-bar`);if(!e||!t)return;let s=Y(`btn-delete-deck`);s&&(s.hidden=!(G&&G!==`new`&&G!==`deck-starter`)),i&&(i.textContent=G===`new`?`New deck`:`In your deck`);let c=r(K,U),l=`${K.length}/30`;a&&(a.textContent=l,a.classList.toggle(`deck-editor__count--ready`,c.valid));let u=Y(`deck-progress-fill`),d=Math.min(100,K.length/30*100);u&&(u.style.width=`${d}%`),o&&(o.hidden=c.valid,c.valid||(o.setAttribute(`aria-valuenow`,String(K.length)),o.setAttribute(`aria-valuemax`,`30`))),n&&(c.valid?(n.textContent=``,n.hidden=!0,n.className=`deck-editor__error deck-status ok`):(n.hidden=!1,n.textContent=c.errors[0]||`${l} — keep adding spells`,n.className=`deck-editor__error deck-status warn`));let f=Y(`deck-collection-hint`);f&&(f.hidden=!1,f.innerHTML=K.length>=30?`Deck is full. Remove a card from the strip above, or save when ready.`:`Tap <strong>+ Add to deck</strong> for copies you own. When all owned copies are in the deck, tap <strong>Add for X gems</strong> to buy another.`),Tc(e,{deckEdit:!0,statusEl:n}),t.innerHTML=``;let p=Ms(K);if(!p.length){let e=document.createElement(`p`);e.className=`deck-editor__strip-empty`,e.textContent=`Empty deck — tap + Add to deck below`,t.appendChild(e)}for(let{def:e,count:n}of p){let r=document.createElement(`div`);r.className=`deck-slot-wrap deck-slot-wrap--strip`;let i=Sa(e,{button:!0,tiny:!0,onClick:()=>{Oa(e,{meta:n>1?`${n} copies in deck`:`In your deck`,onRemove:()=>Ps(e.id)})}});if(r.appendChild(i),n>1){let e=document.createElement(`span`);e.className=`deck-stack-count`,e.textContent=`×${n}`,r.appendChild(e)}let a=document.createElement(`button`);a.type=`button`,a.className=`deck-slot-remove deck-slot-remove--visible`,a.setAttribute(`aria-label`,`Remove one ${e.name} from deck`),a.textContent=`−`,a.addEventListener(`click`,t=>{t.stopPropagation(),Ns(e.id)}),r.appendChild(a),t.appendChild(r)}}function Pc(){let e=Y(`deck-name-input`)?.value?.trim()||`My Deck`,t=r(K,U);if(!t.valid){Y(`deck-status`).textContent=t.errors.join(` `);return}let n;G&&G!==`new`?(n=U.decks.find(e=>e.id===G),n?(n.name=e,n.cardIds=[...K],n.updatedAt=Date.now()):n=b(e,K)):n=b(e,K),ae(U,n),U.selectedDeckId=n.id,w(U),is(`deck-saved`,{deckId:n.id}),kc(),dc(`list`)}function Fc(e=[]){let t=`New Deck`,n=new Set(e.map(e=>e.name?.trim()).filter(Boolean));if(!n.has(t))return t;let r=2;for(;n.has(`${t} ${r}`);)r++;return`${t} ${r}`}function Ic(){G=`new`,K=[];let e=Y(`deck-name-input`);e&&(e.value=Fc(U.decks)),dc(`edit`)}function Lc(){Rs(),Os=null}function Rc(){U.adventure=u(U.adventure),Y(`adventure-map-view`)?.classList.remove(`hidden`),Lc(),As=null,Wc()}function zc(e){let t=ge[e]||ge.verdant,n=`map-${e}`;return`<svg class="adventure-map-scenery-svg" viewBox="0 0 100 120" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
    <defs>
  ...
  </svg>`}function Bc(e=`#e8c547`){return`<svg class="adventure-map-tile__pawn-svg" viewBox="0 0 28 36" aria-hidden="true">
    <defs>
  ...
  </svg>`}function Vc(e){let t=ge[e]||ge.verdant;return`<svg class="adventure-map-tile__banner-svg" viewBox="0 0 24 20" aria-hidden="true">
    <defs>
  ...
  </svg>`}function Hc(e){let t=e?.querySelector(`.adventure-map-tower`);if(!e||!t)return;let n=()=>[t,...t.querySelectorAll(`.adventure-map-tile, .adventure-map-tower__base, .adventure-map-tower__mist, .adventure-map-tower__beacon`)],r=()=>{let r=e.getBoundingClientRect(),i=1/0,a=-1/0;for(let e of n()){let t=e.getBoundingClientRect();!t.height&&!t.width||(i=Math.min(i,t.top),a=Math.max(a,t.bottom))}if(!Number.isFinite(i))return;let o=a-i,s=Math.max(Math.round(o*.12),32),c=parseFloat(getComputedStyle(t).bottom)||0,l=a-r.top,u=Math.ceil(Math.max(l+c,o+s+c));e.style.minHeight=`${u}px`,e.style.height=`${u}px`;let d=e.closest(`.adventure-map-scene`);if(d){let t=Math.max(0,e.offsetHeight-d.clientHeight);d.scrollTop>t&&(d.scrollTop=t)}};requestAnimationFrame(()=>{r(),requestAnimationFrame(r)})}function Uc(){let e=Y(`adventure-map`),t=e?.closest(`.adventure-map-scene`);if(!e||!t)return;let n=Math.max(0,e.offsetHeight-t.clientHeight);t.scrollTop>n&&(t.scrollTop=n)}function Wc(){Q(),Hs();let e=u(U.adventure);U.adventure=e,ks=e.selectedWorld||1;let t=Y(`adventure-world-tabs`);if(t){t.innerHTML=``;let n=te(e);for(let n of se){let r=p(e,n.id),i=document.createElement(`button`);i.type=`button`,i.className=`adventure-world-shield`,i.dataset.world=String(n.id),n.id===ks&&i.classList.add(`active`),r||i.classList.add(`adventure-world-shield--locked`),i.disabled=!r,i.innerHTML=`<span class="adventure-world-shield__icon" aria-hidden="true"></span><span class="adventure-world-shield__label">Tower ${n.id}</span>`,i.title=r?n.name:`Clear floor 30 to unlock`,i.addEventListener(`click`,()=>{p(e,n.id)&&(ks=n.id,e.selectedWorld=n.id,w(U),Wc())}),t.appendChild(i)}p(e,ks)||(ks=n[0]?.id||1,e.selectedWorld=ks)}let n=se.find(e=>e.id===ks),r=Y(`adventure-map`);if(!r)return;let i=n?.theme||`verdant`,a=ge[i]||ge.verdant;r.className=`adventure-map-canvas adventure-map-canvas--${i} adventure-map-canvas--iso`,r.style.setProperty(`--map-accent`,a.accent),r.style.setProperty(`--map-glow`,a.glow),r.style.setProperty(`--map-mist`,a.mist),r.style.setProperty(`--map-stone-light`,a.stoneLight),r.style.setProperty(`--map-stone-mid`,a.stoneMid),r.style.setProperty(`--map-stone-dark`,a.stoneDark),r.style.setProperty(`--map-stone-side`,a.stoneSide),r.style.setProperty(`--map-moss`,a.moss),r.setAttribute(`role`,`group`),r.setAttribute(`aria-label`,`Adventure floor map`);let s=c(e),d=l(e),f=ks===5&&s?`<div class="adventure-map-challenge-corner">
    ...
    <div class="adventure-map-canvas__bg" aria-hidden="true">
      <div class="adventure-map-scenery adventure-map-scenery--${i}" aria-hidden="true">${zc(i)}</div>
    ...
    <div class="adventure-map-tower">
    ...
    </div>`;let m=r.querySelector(`.adventure-map-tiles`),h=r.querySelector(`.adventure-map-tower`),g=Se(ks),ee=_(e);h?.style.setProperty(`--tower-top-ratio`,`0.72`),g.forEach((t,n)=>{let r=o(e,t.id),s=ue(e,t.id),c=t.id===ee&&r,l=S(e,t.id),u=(t.floorInWorld-1)/9,d=1-u*.26,f=1-u*.1,p=Math.sin((t.floorInWorld-1)*.62)*.32*d,h=document.createElement(`button`);h.type=`button`,h.className=`adventure-map-tile`,h.classList.add(`adventure-map-tile--floor-${t.floorInWorld}`),h.style.zIndex=String(n+10),h.style.setProperty(`--floor-scale`,d.toFixed(4)),h.style.setProperty(`--floor-height-scale`,f.toFixed(4)),h.style.setProperty(`--floor-offset-x`,`${p.toFixed(3)}rem`),h.dataset.level=String(t.id),r||h.classList.add(`adventure-map-tile--locked`),s&&h.classList.add(`adventure-map-tile--cleared`),c&&h.classList.add(`adventure-map-tile--next`),t.floorInWorld>=7&&t.floorInWorld<10&&h.classList.add(`adventure-map-tile--rampart`),t.floorInWorld===10&&h.classList.add(`adventure-map-tile--summit`),h.setAttribute(`aria-disabled`,r?`false`:`true`),r||(h.title=`Clear global floor ${t.id-1} to unlock`),h.setAttribute(`aria-label`,`Floor ${t.floorInWorld}: ${t.opponent}, ${t.flavor}`);let g=s?`<span class="adventure-map-tile__stars">${oe(l)}</span>`:``,_=c?`<span class="adventure-map-tile__pawn">${Bc(a.accent)}</span>`:``,v=t.floorInWorld===10?`<span class="adventure-map-tile__banner">${Vc(i)}</span>`:``,te=t.floorInWorld>1&&t.floorInWorld<10?`<span class="adventure-map-tile__windows" aria-hidden="true"></span>`:``,y=s?`<span class="adventure-map-tile__torch" aria-hidden="true"></span>`:``;h.innerHTML=`
      ${_}
      ${v}
      <span class="adventure-map-tile__stone" aria-hidden="true">
      ...
      </span>`,r||(h.disabled=!0),h.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),Qc(t.id))}),m?.appendChild(h)});let v=Y(`adventure-floor-list`);if(v){v.classList.add(`adventure-floor-list--sr`),v.innerHTML=``;for(let t of g){let n=o(e,t.id),r=ue(e,t.id),i=t.id===ee&&n,a=S(e,t.id),s=document.createElement(`button`);s.type=`button`,s.className=`adventure-floor-row`,n||(s.disabled=!0),r&&s.classList.add(`adventure-floor-row--cleared`),i&&s.classList.add(`adventure-floor-row--next`),s.innerHTML=`
        ...
        ${a>0?`<span class="adventure-floor-row__stars">${oe(a)}</span>`:``}`,s.addEventListener(`click`,()=>Qc(t.id)),v.appendChild(s)}}let y=r.querySelector(`.adventure-map-tile--next`);Hc(r),y&&requestAnimationFrame(()=>{requestAnimationFrame(()=>y.scrollIntoView({behavior:`smooth`,block:`nearest`}))});let b=v?.querySelector(`.adventure-floor-row--next`);b&&requestAnimationFrame(()=>b.scrollIntoView({behavior:`smooth`,block:`end`})),r.querySelector(`.adventure-challenge-toggle`)?.addEventListener(`click`,t=>{t.preventDefault(),t.stopPropagation(),e.challengeMode=!e.challengeMode,U.adventure=e,w(U),Co(),co.tap(),Wc()})}function Gc(e){let t=Ce(e);if(!t||!o(U.adventure,e))return;Os=e,Ls();let n=Y(`prebattle-title`),i=Y(`prebattle-flavor`),a=Y(`prebattle-opponent`);n&&(n.textContent=`Tower ${t.worldId} · Floor ${t.floorInWorld}`),i&&(i.textContent=t.flavor||``),a&&(a.textContent=`Loading…`);try{As=s(U,e),w(U)}catch(e){console.error(`Enemy deck failed`,e),a&&(a.textContent=`Could not build enemy deck. Try again.`);return}a&&(a.textContent=`Review the enemy spell deck, then choose your grimoire below.`);let c=Y(`prebattle-gem-hint`);if(c){let n=y(U.adventure,e);c.textContent=(ue(U.adventure,e)?`Repeat clear: +${n} gems`:`First clear: +${n} gems`)+(t.worldId===5&&l(U.adventure)?` · Challenge mode: enemy has an extra rank of pieces`:``)}let u=Y(`enemy-deck-preview`);if(u){u.innerHTML=``;try{for(let{def:e,count:t}of be(As)){if(!e)continue;let n=document.createElement(`button`);n.type=`button`,n.className=`enemy-deck-spell-btn`,n.title=`View ${e.name}`;let r=document.createElement(`span`);if(r.className=`enemy-deck-spell-btn__name`,r.textContent=e.name,n.appendChild(r),t>1){let e=document.createElement(`span`);e.className=`enemy-deck-spell-btn__count`,e.textContent=`×${t}`,n.appendChild(e)}n.addEventListener(`click`,()=>Oa(e,{meta:t>1?`${t} copies in enemy deck`:`Enemy deck`})),u.appendChild(n)}}catch(e){console.error(`Enemy preview failed`,e),u.innerHTML=`<p class="empty-msg">Enemy deck preview unavailable.</p>`}}C(U)&&w(U);let d=or(`adventure-deck-select`);if(!d){a&&(a.textContent=`Deck selector missing — hard refresh the page.`);return}d.innerHTML=``;let f=U.decks.filter(e=>r(e.cardIds,U).valid);if(!f.length){let e=document.createElement(`option`);e.value=``,e.textContent=`No complete decks — build one in Decks`,d.appendChild(e),d.disabled=!0,Y(`btn-start-adventure`).disabled=!0;return}d.disabled=!1;let p=U.selectedDeckId&&f.some(e=>e.id===U.selectedDeckId)?U.selectedDeckId:f[0].id;for(let e of f){let t=document.createElement(`option`);t.value=e.id,t.textContent=e.name,e.id===p&&(t.selected=!0),d.appendChild(t)}U.selectedDeckId=p,Y(`btn-start-adventure`).disabled=!1}async function Kc(e,t,n,r,i=null,a=!1,o=void 0){let s=t.opponent;Lc(),As=null,document.querySelectorAll(`.view`).forEach(e=>e.classList.add(`hidden`)),Y(`view-match`)?.classList.remove(`hidden`);let c=Y(`view-match`);if(!c)return;let{MatchSession:u,getMatchHtml:d}=await Uo();c.innerHTML=d(s);let p=o??(xe(r).id===5&&l(U.adventure)),m={levelId:r,deckId:e.id,challengeMode:p},h={aiDeckIds:n,opponentName:s,cosmetics:x(U),profile:U,challengeMode:p,buildGameOverActions:({won:e,isTie:t})=>Jc(m,{won:e,isTie:t}),onGameOverAction:e=>{Yc(e,m,c)}};i&&(h.initialState=i);try{q=new u(e.cardIds,c,()=>{q=null,$n(),po(),io(`hub`),c.innerHTML=``,Y(`view-match`)?.classList.add(`hidden`),X(Wn()||`play`),ws&&el(),Ts&&tl()},e=>{let t=g(U,r,e),{gems:n,stars:i,starsGained:a}=t;return U.gems+=n,v(U,`adventure_floors`,1),f(U),w(U),Q(),Hs(),r===1&&t.firstTime&&(ws=!0,el()),r===5&&t.firstTime&&(Ts=!0),{message:`+${n} gems! · Best: ${oe(i)}`,starsGained:a}},h)}catch(e){throw q=null,c.innerHTML=``,Y(`view-match`)?.classList.add(`hidden`),X(`play`),e}Zn({kind:`adventure`,deckId:e.id,deckCardIds:e.cardIds,aiDeckIds:n,opponentName:s,levelId:r,challengeMode:p}),await po(),io(`match`),a&&(q.winRewarded=!0),er(q),q.setMessage(``),q.render()}async function qc(){let e=tr();if(!e)return!1;let t=U.decks.find(t=>t.id===e.deckId)||U.decks.find(e=>e.cardIds?.length===30),n=e.levelId?Ce(e.levelId):null;return!t||t.cardIds.length!==30||!n||!e.aiDeckIds?.length||!await Ye(`Resume your adventure match where you left off?`,{title:`Resume match?`,confirmLabel:`Resume`,cancelLabel:`Discard`})?(Qn(),!1):(Os=e.levelId,await Kc(t,n,e.aiDeckIds,e.levelId,e.state,e.winRewarded,e.challengeMode),q?.setMessage(`Match resumed — pick up where you left off.`),!0)}function Jc({levelId:e},{won:t,isTie:n}){let r=e+1,i=t&&r<=50&&o(U.adventure,r);if(n)return[{id:`backToAdventure`,label:`Back to Adventure`,primary:!0}];if(t){let e=[];return i?(e.push({id:`nextFloor`,label:`Next floor`,primary:!0}),e.push({id:`retry`,label:`Retry floor`}),e.push({id:`editDeck`,label:`Edit deck`}),e.push({id:`backToAdventure`,label:`Back to Adventure`})):(e.push({id:`backToAdventure`,label:`Back to Adventure`,primary:!0}),e.push({id:`retry`,label:`Retry floor`}),e.push({id:`editDeck`,label:`Edit deck`})),e}return[{id:`retry`,label:`Retry floor`,primary:!0},{id:`editDeck`,label:`Edit deck`},{id:`backToAdventure`,label:`Back to Adventure`}]}async function Yc(e,{levelId:t,deckId:n,challengeMode:r},i){let a=U.decks.find(e=>e.id===n);if(e===`backToAdventure`){q?.onExit?.();return}if(e===`editDeck`){q?.dispose(),q=null,$n(),po(),io(`hub`),i.innerHTML=``,i.classList.add(`hidden`),X(`deck`),Ac(n);return}if(e===`retry`||e===`nextFloor`){let n=e===`nextFloor`?t+1:t,i=Ce(n);if(!a||a.cardIds.length!==30||!i){q?.onExit?.();return}q?.dispose(),q=null,$n(),await Kc(a,i,s(U,n),n,null,!1,e===`retry`?r:void 0)}}function Xc(){let e=or(`adventure-deck-select`)?.value,t=U.decks.find(t=>t.id===e),n=Os,r=n?Ce(n):null,i=As?[...As]:null;if(!t||t.cardIds.length!==30||!r||!i?.length){let e=Y(`prebattle-opponent`);e&&(!t||t.cardIds.length!==30?e.textContent=`Build a complete 30-card deck in the Decks tab, then try again.`:e.textContent=`Could not start battle — close and pick the floor again.`);return}Kc(t,r,i,n)}function Zc(){if(window.__adventureMapCaptureBound)return;window.__adventureMapCaptureBound=!0;let e=null,t=!1,n=0,r=e=>e.closest?.(`#adventure-map .adventure-map-tile, #adventure-map .adventure-map-pin`),i=e=>e?.closest?.(`.adventure-map-scene`),a=()=>{t=!0,clearTimeout(n),n=setTimeout(()=>{t=!1},280)},o=(e,t)=>{if(!e||e.disabled)return;let n=Number(e.dataset.level);!Number.isFinite(n)||n<1||(t.preventDefault(),t.stopPropagation(),Qc(n))};document.addEventListener(`pointerdown`,t=>{if(t.button!==0)return;let n=r(t.target);if(!n||n.disabled)return;let a=i(n);e={pin:n,pointerId:t.pointerId,startX:t.clientX,startY:t.clientY,scrollTop:a?.scrollTop??0,scrollLeft:a?.scrollLeft??0,cancelled:!1}},!0),document.addEventListener(`pointermove`,t=>{if(!e||t.pointerId!==e.pointerId||e.cancelled)return;let n=t.clientX-e.startX,r=t.clientY-e.startY;Math.hypot(n,r)>12&&(e.cancelled=!0);let a=i(e.pin);a&&(Math.abs(a.scrollTop-e.scrollTop)>3&&(e.cancelled=!0),Math.abs(a.scrollLeft-e.scrollLeft)>3&&(e.cancelled=!0))},!0),document.addEventListener(`pointerup`,t=>{if(!e||t.pointerId!==e.pointerId)return;let{pin:n,cancelled:r}=e;if(e=null,r){a();return}o(n,t),a()},!0),document.addEventListener(`pointercancel`,t=>{!e||t.pointerId!==e.pointerId||(e=null,a())},!0),document.addEventListener(`click`,e=>{if(t){e.preventDefault(),e.stopPropagation();return}let n=r(e.target);!n||n.disabled||o(n,e)},!0)}function Qc(e){let t=u(U.adventure);if(U.adventure=t,!o(t,e)){zs(`Locked — beat global floor ${e-1} first, then return here.`);return}w(U),Gc(e)}function $c(){Bs(),Ga(),za(),vo(),oo(),mo(),yo(),ka(),Zc(),Is(),document.querySelector(`.adventure-map-scene`)?.addEventListener(`scroll`,Uc,{passive:!0});let e;window.addEventListener(`resize`,()=>{clearTimeout(e),e=setTimeout(()=>{if(!document.body.classList.contains(`adventure-active`))return;let e=Y(`adventure-map`);e&&Hc(e)},120)}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&Lc()}),document.querySelectorAll(`.tab-btn`).forEach(e=>{e.addEventListener(`click`,()=>{Co(),co.tap(),X(e.dataset.tab)})}),document.querySelectorAll(`.vault-tab`).forEach(e=>{e.addEventListener(`click`,()=>{Yn(),_c(e.dataset.vaultTab)})}),Y(`btn-new-deck`)?.addEventListener(`click`,Ic),Y(`btn-back-from-edit`)?.addEventListener(`click`,async()=>{await Oc()&&(kc(),dc(`list`))}),Y(`btn-delete-deck`)?.addEventListener(`click`,async()=>{if(!G||G===`new`)return;let e=U.decks.find(e=>e.id===G);e&&await Ye(`Delete "${e.name}"? This cannot be undone.`,{title:`Delete deck?`,confirmLabel:`Delete`,cancelLabel:`Keep`,destructive:!0})&&(me(U,e.id),kc(),dc(`list`))});let t=()=>{ls===`edit`&&$(),ls===`list`&&Nc()};document.querySelectorAll(`.collection-owned-only-toggle`).forEach(e=>{e.addEventListener(`change`,e=>{ms=e.target.checked,Qs(),t()})}),document.querySelectorAll(`.btn-reset-collection-filters`).forEach(e=>{e.addEventListener(`click`,()=>{fs=`all`,ds=``,ps=`all`,ms=!0,Qs(),t()})}),Qs(),sr(),Y(`collection-search`)?.addEventListener(`input`,e=>{ds=e.target.value,t()}),or(`collection-category`)?.addEventListener(`change`,e=>{ps=e.target.value,t()}),or(`collection-rarity`)?.addEventListener(`change`,e=>{fs=e.target.value,t()}),Y(`btn-clear-deck`)?.addEventListener(`click`,()=>{K=[],$()}),Y(`btn-auto-finish-deck`)?.addEventListener(`click`,Fs),Y(`btn-save-deck`)?.addEventListener(`click`,Pc),Y(`btn-back-adventure`)?.addEventListener(`click`,Lc),Y(`adventure-floor-backdrop`)?.addEventListener(`click`,Lc),Y(`btn-start-adventure`)?.addEventListener(`click`,Xc),or(`adventure-deck-select`)?.addEventListener(`change`,e=>{U.selectedDeckId=e.target.value,w(U)});let n=document.getElementById(`auth-modal`),r=document.getElementById(`auth-header-btn`);Gs(),Pn(`adventure-help-btn`,`adventure-help-desc`),Pn(`shop-help-btn`,`shop-help-desc`),Pn(`deck-help-btn`,`deck-help-desc`),bs=en({onSignIn:()=>xs?.open(`signin`,{forced:!0}),onSignUp:()=>xs?.open(`signup`,{forced:!0}),onGuest:()=>{Ht(),sl()}}),xs=Qt({authBtn:r,modal:n,onNewAccount:()=>{U=ve()?he():T(),mn(U,w)},onSignedIn:()=>{Ut(),U=T(),C(U),pn(U),Q(),Nc(),gc(),bs?.hide(),Ks().then(()=>{W===`profile`&&Js(),W===`quests`&&Xs(),W===`pvp`&&ys().then(e=>e?.render({resume:!0}))}),ys().then(e=>e?.render({resume:!0})),al(),ol(),il(),rl(),J||X(W)},onSignedOut:()=>{Ut(),Ws(),Z=``,Us(),_s?.dispose?.(),q=null,$n({clearCheckpoint:!0}),Yn(),U=he(),Hs(),Q(),Nc(),gc(),bs?.show(),X(`deck`)}}),nr(()=>q),C(U),Qs(),Hs(),cl()}function el(){if(!ws||Es!=null)return;let e=0,t=()=>{if(Es=null,e+=1,ws){if(Hn()){e<10&&(Es=window.setTimeout(t,400));return}if(pn(U),il()){ws=!1;return}e<10&&(Es=window.setTimeout(t,500))}};Es=window.setTimeout(t,350)}function tl(){if(!Ts||Ds!=null)return;let e=0,t=()=>{if(Ds=null,e+=1,Ts){if(Hn()){e<10&&(Ds=window.setTimeout(t,400));return}if(pn(U),rl()){Ts=!1;return}e<10&&(Ds=window.setTimeout(t,500))}};Ds=window.setTimeout(t,350)}function nl(){return J||!$t()||!le(U)||!Sn(U)?!1:(J=!0,ts().then(({startPvpTutorial:e})=>{e({profile:U,saveProfile:w,onComplete:()=>{J=!1,U=T(),C(U),Hs(),X(`play`),rl()}})}),!0)}function rl(){return J||!$t()||!h(U)||_n(U)||vn(U)||xn(U)||Sn(U)||!wn(U)?!1:(J=!0,X(`play`),ts().then(({startCosmeticsTutorial:e})=>{e({profile:U,saveProfile:w,onComplete:()=>{J=!1,U=T(),C(U),Hs(),X(`play`)}})}),!0)}function il(){return J||!$t()||!le(U)?!1:(pn(U),xn(U)?(J=!0,X(`play`),ts().then(({startQuestsTutorial:e})=>{e({profile:U,saveProfile:w,onComplete:()=>{J=!1,U=T(),C(U),Hs(),nl(),rl()}})}),!0):nl())}function al(){return J||!$t()||!_n(U)?!1:(J=!0,rs().then(({startInteractiveTutorial:e})=>{e({profile:U,saveProfile:w,onComplete:()=>{J=!1,U=T(),C(U),Q(),Nc(),gc(),ol()||X(`deck`),il(),rl()}})}),!0)}function ol(){return J||!$t()||!vn(U)?!1:(J=!0,X(`deck`),$o().then(({startMetaTutorial:e})=>{e({profile:U,saveProfile:w,onComplete:()=>{J=!1,U=T(),C(U),Q(),Nc(),gc(),X(`deck`),il(),rl()}})}),!0)}async function sl(){bs?.hide(),!al()&&(ol()||il()||rl()||J||(await qc()||await X(`deck`),Yn(),io(`hub`)))}async function cl(){try{if(await Ae()){try{let e=await Yt();e&&(U=e)}catch(e){console.warn(`Cloud sync on load failed`,e)}C(U),Q(),Nc(),gc()}}catch(e){console.warn(`Auth init failed`,e)}if(pn(U),await Ks(),_s&&_s.render(),Yn(),tn()){bs?.show();return}await sl()}$c(),E(async()=>{let{registerSW:e}=await import(`./virtual_pwa-register-CpSsV7JG.js`);return{registerSW:e}},[],import.meta.url).then(({registerSW:e})=>{e({immediate:!0})}),Xe(),et();export{Yn as A,Rt as B,Qn as C,Zn as D,Wn as E,gn as F,Ue as G,vt as H,bn as I,yn as L,Pn as M,Cn as N,$n as O,hn as P,Tn as R,ar as S,qn as T,dt as U,ft as V,Ye as W,Pa as _,Oo as a,Sa as b,Po as c,Ro as d,po as f,Wa as g,H as h,Mo as i,er as j,Hn as k,Ao as l,io as m,Vo as n,ko as o,ao as p,wo as r,No as s,Bo as t,Io as u,Aa as v,Gn as w,ur as x,Oa as y,Wt as z};