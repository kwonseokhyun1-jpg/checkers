...
import{n as e,o as t,t as n}from"./cardCatalog-CUmgQ3qR.js";import{c as r,i,r as a}from"./deckRules-BKSPYmFT.js";import{At as o,Ct as s,Dt as c,Et as l,Ft as u,H as d,I as f,Mt as p,Nt as m,Ot as h,Pt as g,R as ee,St as _,T as v,Tt as te,_t as y,a as b,at as x,bt as S,c as ne,d as re,f as C,ft as ie,g as ae,gt as oe,ht as se,i as ce,jt as le,kt as ue,l as de,m as w,mt as fe,nt as pe,o as me,p as he,pt as ge,r as _e,s as ve,t as ye,u as T,vt as be,wt as xe,xt as Se,yt as Ce,z as we}from"./storage-BQXLILoe.js";import{t as E}from"./preload-helper-CV77j2BA.js";import{a as D,c as Te,d as Ee,g as De,i as Oe,m as ke,o as Ae,p as je,s as Me,t as Ne,u as Pe}from"./auth-CtunageD.js";var Fe=Object.defineProperty,Ie=(e,t)=>{let n={};for(var r in e)Fe(n,r,{get:e[r],enumerable:!0});return t||Fe(n,Symbol.toStringTag,{value:`Module`}),n};function Le(){let e=window.visualViewport;return e?Math.max(0,Math.round(e.offsetTop)):0}function Re(){let e=window.visualViewport;return e?Math.max(0,Math.round(window.innerHeight-e.offsetTop-e.height)):0}function ze(){let e=document.documentElement,t=()=>{e.style.setProperty(`--viewport-inset-top`,`${Le()}px`),e.style.setProperty(`--viewport-inset-bottom`,`${Re()}px`)};t(),window.visualViewport?.addEventListener(`resize`,t),window.visualViewport?.addEventListener(`scroll`,t),window.addEventListener(`resize`,t),window.addEventListener(`orientationchange`,t)}ze();var Be=1100,Ve=120;function He(){let e=document.getElementById(`app-splash`);if(!e||e.classList.contains(`app-splash--hide`))return;e.classList.add(`app-splash--hide`),document.body.classList.remove(`splash-active`);let t=()=>{e.remove()};e.addEventListener(`transitionend`,t,{once:!0}),window.setTimeout(t,600)}function Ue(){He()}function We(){let e=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches?Ve:Be,t=performance.now(),n=()=>{let n=performance.now()-t,r=Math.max(0,e-n);window.setTimeout(He,r)};document.readyState===`interactive`||document.readyState===`complete`?n():document.addEventListener(`DOMContentLoaded`,n,{once:!0})}document.body.classList.add(`splash-active`),We();var Ge=`(max-width: 768px)`,Ke=null;function qe(){return document.getElementById(`mobile-confirm`)}function Je(e){let t=qe();if(!t)return;t.classList.add(`hidden`),document.body.classList.remove(`mobile-confirm-open`);let n=Ke;Ke=null,n?.(e)}function Ye(e,t={}){if(!window.matchMedia(Ge).matches)return Promise.resolve(window.confirm(e));let n=qe();if(!n)return Promise.resolve(window.confirm(e));let{title:r=`Confirm`,confirmLabel:i=`OK`,cancelLabel:a=`Cancel`,destructive:o=!1}=t;return new Promise(t=>{Ke&&Je(!1),Ke=t,n.querySelector(`#mobile-confirm-title`).textContent=r,n.querySelector(`#mobile-confirm-body`).textContent=e;let s=n.querySelector(`#mobile-confirm-ok`),c=n.querySelector(`#mobile-confirm-cancel`);s.textContent=i,c.textContent=a,s.classList.toggle(`btn-danger`,o),s.classList.toggle(`btn-primary`,!o),n.classList.remove(`hidden`),document.body.classList.add(`mobile-confirm-open`),c.focus()})}function Xe(){let e=qe();!e||e.dataset.bound||(e.dataset.bound=`1`,e.querySelector(`#mobile-confirm-ok`)?.addEventListener(`click`,()=>Je(!0)),e.querySelector(`#mobile-confirm-cancel`)?.addEventListener(`click`,()=>Je(!1)),e.querySelector(`[data-mobile-confirm-backdrop]`)?.addEventListener(`click`,()=>Je(!1)))}var Ze=`cc_install_banner_dismissed`;function Qe(){return window.matchMedia(`(display-mode: standalone)`).matches||window.navigator.standalone===!0}function $e(){let e=window.navigator.userAgent;return/iphone|ipad|ipod/i.test(e)&&!/crios|fxios/i.test(e)}function et(){if(Qe()||localStorage.getItem(Ze)===`1`)return;let e=document.getElementById(`install-banner`);if(!e)return;let t=null,n=()=>{e.classList.remove(`hidden`),document.body.classList.add(`install-banner-visible`)},r=()=>{e.classList.add(`hidden`),document.body.classList.remove(`install-banner-visible`)};window.addEventListener(`beforeinstallprompt`,r=>{r.preventDefault(),t=r,e.querySelector(`#install-banner-ios-hint`)?.classList.add(`hidden`),e.querySelector(`.install-banner__hint--default`)?.classList.remove(`hidden`),e.querySelector(`#install-banner-btn`)?.classList.remove(`hidden`),n()}),$e()&&(e.querySelector(`#install-banner-ios-hint`)?.classList.remove(`hidden`),e.querySelector(`.install-banner__hint--default`)?.classList.add(`hidden`),e.querySelector(`#install-banner-btn`)?.classList.add(`hidden`),window.setTimeout(n,2500)),e.querySelector(`#install-banner-btn`)?.addEventListener(`click`,async()=>{t&&(t.prompt(),await t.userChoice,t=null,r())}),e.querySelector(`#install-banner-dismiss`)?.addEventListener(`click`,()=>{localStorage.setItem(Ze,`1`),r()})}var tt=[`attack`,`control`,`defense`,`movement`,`trap`,`special`],nt={attack:`Attack`,control:`Control`,defense:`Defense`,movement:`Movement`,trap:`Trap`,special:`Special`},rt={aegis:`defense`,anchor:`defense`,backpedal:`control`,backstab:`attack`,backstep:`movement`,barrier:`defense`,bishops_mark:`movement`,blind:`control`,blizzard:`control`,snowball:`control`,berserk:`movement`,bomb:`attack`,shockwave:`control`,plague:`control`,bulwark:`defense`,create_foe:`special`,call_forward:`movement`,chain_lightning:`attack`,clone:`special`,coin_flip:`attack`,collapse:`special`,confusion:`control`,constitution:`defense`,counterspell:`trap`,crown:`special`,cryo_bolt:`attack`,cull:`attack`,darkness:`defense`,dash:`movement`,deep_freeze:`control`,deflect:`trap`,demote:`control`,deport:`movement`,displacement:`movement`,dominion:`special`,duel:`attack`,earthquake:`special`,execution:`attack`,pyromancy:`attack`,fusion:`special`,hibernation:`special`,hostile_swap:`movement`,ignore:`special`,iron_will:`defense`,landmine:`trap`,last_king:`special`,bounty:`special`,link_fate:`special`,last_stand:`trap`,leapfrog:`movement`,long_step:`movement`,magnet:`movement`,nudge:`movement`,offering:`special`,panic:`control`,poison:`attack`,mind_control:`special`,press:`control`,purify:`special`,quick_march:`movement`,quicksand:`trap`,rally:`defense`,recall:`movement`,repel:`movement`,random_teleport:`movement`,retreat:`movement`,revive:`defense`,rooks_mark:`movement`,root:`control`,sacrifice:`attack`,sanctuary:`defense`,scatter:`movement`,shadow_swap:`movement`,sidestep:`movement`,shatter:`attack`,snipe:`attack`,snowball:`control`,stab:`attack`,stall:`defense`,tangle:`control`,teleport:`movement`,trickster:`special`,vengeance:`trap`,ward:`defense`};function it(e){let t=rt[e?.id];if(t)return t;let n=`${e?.id||``} ${e?.effect||``} ${e?.name||``} ${e?.desc||``}`.toLowerCase();return/trap|mine|quicksand|counterspell|vengeance|last.?stand/.test(n)?`trap`:/shield|ward|aegis|sanctuary|barrier|anchor|deflect|stall|iron_will|rally|darkness/.test(n)?`defense`:/move|nudge|teleport|recall|leap|step|displace|swap|scatter|retreat|bishop|rook|overrun|promote|pull|push|shift|earthquake|magnet|repel/.test(n)?`movement`:/freeze|blind|confusion|hex|root|panic|press|silence|paraly|control|cannot play|random|mark|poison|die in \d+ turn/.test(n)?`control`:/\bdestroy\b|\bkills?\b|fireball|bolt|stab|snipe|duel|sacrifice|execution|shatter|cull|lightning/.test(n)?`attack`:`special`}var at=[{id:`bronze`,name:`Bronze Chest`,cost:25,cards:3,weights:{common:70,uncommon:25,rare:5,epic:0}},{id:`silver`,name:`Silver Chest`,cost:50,cards:5,weights:{common:50,uncommon:35,rare:12,epic:3}},{id:`gold`,name:`Gold Chest`,cost:100,cards:8,weights:{common:32,uncommon:38,rare:22,epic:6,legendary:2}}];function ot(e){let t=Math.random()*100,n=0;for(let r of[`common`,`uncommon`,`rare`,`epic`,`legendary`])if(n+=e[r]||0,t<=n)return r;return`common`}function st(t){let n=e().filter(e=>e.rarity===t);return n.length?n[Math.floor(Math.random()*n.length)]:e()[0]}function ct(n,r){let i=e=>(n.collection[e.id]||0)<t(e);for(let e=0;e<48;e++){let e=st(ot(r.weights));if(i(e))return e}let a=e().filter(i);return a.length?a[Math.floor(Math.random()*a.length)]:st(ot(r.weights))}function lt(e,t){let n=at.find(e=>e.id===t);if(!n)return{success:!1,message:`Unknown chest.`};if(e.gems<n.cost)return{success:!1,message:`Not enough gems.`};e.gems-=n.cost;let r=[];for(let t=0;t<n.cards;t++){let t=ct(e,n);r.push(t),ye(e,t.id,1)}return w(e),{success:!0,pulls:r,chest:n}}var ut=[`common`,`uncommon`,`rare`,`epic`,`legendary`];function dt(e,{minPct:t=1}={}){return ut.filter(n=>(e[n]??0)>=t).map(t=>`${e[t]}% ${t}`).join(` · `)}var ft={bronze:{label:`Bronze`,tagline:`Mostly common cards`,accent:`#cd7f32`,glow:`rgba(205, 127, 50, 0.45)`},silver:{label:`Silver`,tagline:`Balanced card mix`,accent:`#a8b8d8`,glow:`rgba(168, 184, 216, 0.5)`},gold:{label:`Gold`,tagline:`Higher rare & epic odds`,accent:`#e8c547`,glow:`rgba(232, 197, 71, 0.55)`}};function pt(e){let t=ft[e]||ft.bronze;return{t,lid:e===`gold`?`#f5e6a8`:e===`silver`?`#e8eef8`:`#d4954a`,body:e===`gold`?`#7a5c12`:e===`silver`?`#4a5568`:`#5c3a1e`,trim:e===`gold`?`#ffe566`:e===`silver`?`#c8d8f0`:t.accent}}function mt(e,t){let{lid:n,body:r,trim:i}=pt(e);return`
  ...
  `,t.onClick&&l.addEventListener(`click`,n=>{t.disabled||t.onClick(n,e)}),xa(l),l}function Ca(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function wa(e){return document.getElementById(e)}function Ta(){let e=wa(`card-preview-modal`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function Ea(e){document.body.classList.toggle(`card-preview-open`,e),window.dispatchEvent(new CustomEvent(`card-preview-change`,{detail:{open:e}}))}function Da(){wa(`card-preview-modal`)?.classList.add(`hidden`),wa(`card-preview-mount`)?.classList.remove(`card-preview-mount--reveal-only`),Ea(!1)}function Oa(e,t={}){Ta();let n=wa(`card-preview-modal`),r=wa(`card-preview-mount`),i=wa(`card-preview-actions`);if(!(!n||!r||!e)){if(r.innerHTML=``,r.classList.toggle(`card-preview-mount--reveal-only`,!!t.hideDesc),r.appendChild(Sa(e,{static:!0,hideDesc:t.hideDesc})),i){if(i.innerHTML=``,t.meta){let e=document.createElement(`p`);e.className=`card-preview-meta`,e.textContent=t.meta,i.appendChild(e)}let e=document.createElement(`div`);if(e.className=`card-preview-actions-row`,t.onPlay){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=`Cast spell`,n.addEventListener(`click`,()=>{Da(),t.onPlay()}),e.appendChild(n)}if(t.onAdd){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=`Add to deck`,n.disabled=!!t.addDisabled,n.addEventListener(`click`,()=>{t.addDisabled||t.onAdd()}),e.appendChild(n)}if(t.onBuy){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=t.buyLabel||`Buy copy`,n.disabled=!!t.buyDisabled,n.addEventListener(`click`,()=>{t.buyDisabled||t.onBuy()}),e.appendChild(n)}if(t.onRemove){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-secondary`,n.textContent=`Remove all from deck`,n.addEventListener(`click`,()=>{t.onRemove(),Da()}),e.appendChild(n)}e.children.length&&i.appendChild(e)}n.classList.remove(`hidden`),Ea(!0)}}function ka(){wa(`card-preview-close`)?.addEventListener(`click`,Da),wa(`card-preview-backdrop`)?.addEventListener(`click`,Da),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&Da()})}function Aa(e,t=`.spell-card`){e&&e.querySelectorAll(t).forEach((e,t)=>{e.classList.add(`spell-card--deal`),e.style.animationDelay=`${t*.1}s`})}function ja(e){e&&(e.classList.add(`spell-card--rare-burst`),setTimeout(()=>e.classList.remove(`spell-card--rare-burst`),900))}function Ma(e){e&&(e.classList.add(`spell-card--epic-burst`),setTimeout(()=>e.classList.remove(`spell-card--epic-burst`),1200))}function Na(e){e&&(e.classList.add(`spell-card--legendary-burst`),setTimeout(()=>e.classList.remove(`spell-card--legendary-burst`),1500))}function Pa(e,t){t===`legendary`?Na(e):t===`epic`?Ma(e):t===`rare`&&ja(e)}var Fa={common:10,uncommon:20,rare:30,epic:40,legendary:50};function Ia(e){return Fa[e]??30}function La(e,r){let i=ce(e,r);if(i<1)return{success:!1,message:`Get this spell from a chest first.`};let a=n(r);if(!a)return{success:!1,message:`Unknown card.`};let o=t(r);if(i>=o)return{success:!1,message:`You already own the maximum (${o} copies).`};let s=Ia(a.rarity);if(e.gems<s)return{success:!1,message:`Need ${s} gems (${e.gems} available).`};e.gems-=s;let c=ye(e,r,1);return c?{success:!0,cost:s,message:`+1 ${a.name} for ${s} gems (${i+c} owned).`}:(e.gems+=s,w(e),{success:!1,message:`You already own the maximum copies for this rarity.`})}var Ra={deck:`<svg class="nav-icon-svg" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    </div>`,t.style.animationDelay=`0s`,t}function zo(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function Bo(e,t=``){let n=x(e),r=(t||`P`).charAt(0).toUpperCase(),i=Ao(n.equipped.avatar)||`<span class="profile-avatar-fallback">${zo(r)}</span>`;return`<span class="profile-avatar-stack header-profile-btn__stack ${Po(n.equipped.frame)}"><span class="profile-avatar-inner header-profile-btn__inner">${i}</span></span>`}async function Vo(e){if(!e)return``;try{return(await Oe(e.id))?.username||e.user_metadata?.display_name||e.email?.split(`@`)[0]||``}catch{return e.user_metadata?.display_name||e.email?.split(`@`)[0]||``}}var Ho=null;function Uo(){return Ho||=Promise.all([E(()=>import(`./match-BL4VpkcH.js`),[],import.meta.url),E(()=>import(`./matchView-Bgr35QYJ.js`),[],import.meta.url),E(()=>Promise.resolve({}),__vite__mapDeps([0]),import.meta.url),E(()=>Promise.resolve({}),__vite__mapDeps([1]),import.meta.url)]).then(([e,t])=>({MatchSession:e.MatchSession,getMatchHtml:t.getMatchHtml})),Ho}var Wo=null;function Go(){return Wo||=Promise.all([E(()=>import(`./pvpUI-DPwbmzlq.js`),[],import.meta.url),E(()=>import(`./pvp-C7OO66ZC.js`),[],import.meta.url)]).then(([e,t])=>({initPvpUI:e.initPvpUI,clearAllWaitingRoomsOnce:t.clearAllWaitingRoomsOnce})),Wo}var Ko=null;function qo(){return Ko||=E(()=>import(`./profileUI-Z0VReoSh.js`),[],import.meta.url),Ko}function Jo(){Ko=null}var Yo=null;function Xo(){return Yo||=Promise.all([E(()=>import(`./settingsUI-Cc9GkXUR.js`),[],import.meta.url),E(()=>Promise.resolve({}),__vite__mapDeps([2]),import.meta.url)]).then(([e])=>e),Yo}var Zo=null;function Qo(){return Zo||=Promise.all([E(()=>import(`./chestOpenAnimation-BYwoK1Kd.js`),[],import.meta.url),E(()=>import(`./cosmeticOpenAnimation-4UfRr-hH.js`),[],import.meta.url)]).then(([e,t])=>({playChestOpenAnimation:e.playChestOpenAnimation,playCosmeticOpenAnimation:t.playCosmeticOpenAnimation})),Zo}var $o=null;function es(){return $o||=E(()=>import(`./tutorialMeta-BdLI7X9R.js`),[],import.meta.url),$o}var ts=null;function ns(){return ts||=E(()=>import(`./tutorialUnlocks-4_xQIkib.js`),[],import.meta.url),ts}var rs=null;function is(){return rs||=E(()=>import(`./tutorialMatch-B9bT4dOt.js`),[],import.meta.url),rs}function as(e,t){es().then(n=>n.notifyMetaTutorial(e,t))}function os(e,t){ns().then(n=>n.notifyUnlockTutorial(e,t))}var U;try{U=T()}catch(e){console.error(`Failed to load profile, resetting save:`,e),localStorage.removeItem(`cardCheckersProfile_v7`),localStorage.removeItem(`cardCheckersProfile_v5`),U=T()}var W=`deck`,ss={deck:`Decks`,chests:`Shop`,play:`Play`,pvp:`PvP`,quests:`Quests`,profile:`Profile`,settings:`Settings`},cs=new Set(Object.keys(ss)),ls=`cards`,us=`list`,G=null,K=[],ds=null,fs=``,ps=`all`,ms=`all`,hs=!0,gs={legendary:5,epic:4,rare:3,uncommon:2,common:1};function _s(e){return[...e].sort((e,t)=>{let n=gs[e.rarity]??0,r=gs[t.rarity]??0;return n===r?e.name.localeCompare(t.name):r-n})}var q=null,vs=null,ys=null;function bs(){return vs?Promise.resolve(vs):(ys||=Go().then(({initPvpUI:e,clearAllWaitingRoomsOnce:t})=>(t(),vs=e({root:document.getElementById(`view-pvp`),getProfile:()=>U,openAuthModal:()=>Ss?.open(`signin`,{forced:!0}),onNavigateTab:Z,onOpenDeckEdit:Ic,onPvpViewShown:()=>{W=`pvp`,Hs()}}),vs)),ys)}var xs=null,Ss=null,J=!1,Cs=!1,ws=!1,Ts=!1,Es=!1,Ds=null,Os=null,ks=null,Y=1,As=null;function js(e){return gs[e?.rarity]??0}function Ms(e){let t=i(e);return Object.entries(t).map(([e,t])=>({def:n(e),count:t})).filter(e=>e.def).sort((e,t)=>{let n=js(t.def)-js(e.def);return n===0?e.def.name.localeCompare(t.def.name):n})}function Ns(e){let t=K.indexOf(e);t<0||(K.splice(t,1),Bc(),as(`card-removed-from-deck`,{cardId:e}))}function Ps(e){let t=K.length;K=K.filter(t=>t!==e),K.length!==t&&(Bc(),as(`card-removed-from-deck`,{cardId:e}))}function Fs(){let n=e().map(e=>({def:e,owned:ce(U,e.id)})).filter(e=>e.owned>0).sort((e,t)=>{let n=js(t.def)-js(e.def);return n===0?e.def.name.localeCompare(t.def.name):n});K=[];for(let{def:e,owned:r}of n){let n=Math.min(r,t(e));for(let t=0;t<n&&K.length<30;t++)K.push(e.id);if(K.length>=30)break}Bc()}var X=e=>document.getElementById(e);function Is(){let e=document.getElementById(`adventure-prebattle`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function Ls(){let e=document.querySelector(`nav.game-nav.tabs`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function Rs(){return window.matchMedia(`(min-width: 1000px) and (max-width: 1400px)`).matches?4:window.matchMedia(`(min-width: 600px) and (max-width: 999px)`).matches?2.6:1}function zs(){Is(),document.getElementById(`adventure-prebattle`)?.classList.remove(`hidden`),document.body.classList.add(`adventure-floor-open`)}function Bs(){document.getElementById(`adventure-prebattle`)?.classList.add(`hidden`),document.body.classList.remove(`adventure-floor-open`)}function Vs(e=fe,t=`Locked`){Mn({title:t,bodyHtml:e,autoCloseMs:4500})}function Hs(){document.body.classList.toggle(`main-tab-active`,cs.has(W)),document.body.classList.toggle(`adventure-active`,W===`play`)}function Us(e,t,n){let r=e.querySelector(`.tab-btn__sign-in-badge`);t?(r||(r=document.createElement(`span`),r.className=`tab-btn__sign-in-badge`,r.setAttribute(`aria-hidden`,`true`),e.appendChild(r)),r.textContent=n,e.classList.add(`tab-btn--sign-in-nudge`)):(r?.remove(),e.classList.remove(`tab-btn--sign-in-nudge`))}function Ws(){let e=le(U),t=Bt();for(let n of[`quests`,`pvp`]){let r=document.querySelector(`.tab-btn[data-tab="${n}"]`);if(!r)continue;let i=n===`pvp`?`PvP`:`Quests`,a=!e,o=n===`pvp`?Rt:zt;r.classList.toggle(`tab-btn--locked`,a),r.setAttribute(`aria-disabled`,a?`true`:`false`),a?(r.title=t?`${m(i)} ${o}.`:m(i),Us(r,t,`Sign in`)):t?(r.title=o,Us(r,n===`pvp`,`Sign in`)):(r.title=``,Us(r,!1))}let n=h(U),r=document.querySelector(`.vault-tab[data-vault-tab="cosmetics"]`);r&&(r.classList.toggle(`vault-tab--locked`,!n),r.title=n?``:ie,r.setAttribute(`aria-disabled`,n?`false`:`true`))}async function Z(e){let t=document.getElementById(`view-match`);if(!(J&&t&&!t.classList.contains(`hidden`))){if(!Cs&&(e===`quests`||e===`pvp`)&&!le(U)){let t=e===`pvp`?`PvP`:`Quests`,n=Bt(),r=e===`pvp`?Rt:zt;await Ye(n?`${m(t)}\n\n${r}.`:m(t),{title:`${t} locked`,confirmLabel:`Go to Adventure`,cancelLabel:n?`Sign in`:`Not now`})?(Cs=!0,Z(`play`),Cs=!1):n&&Ss?.open(`signin`,{forced:!0});return}if(Yn(),Bn()&&Hn()){if(e===W)return;if(!(e===`pvp`&&document.getElementById(`pvp-match-root`))){if(!await Ye(`Leave your current match to open ${ss[e]||e}?`,{title:`Leave match?`,confirmLabel:`Leave`,cancelLabel:`Stay`,destructive:!0}))return;Un(e),Kn(),document.querySelector(`#btn-leave-match`)?.click();return}}if(us===`edit`&&(e!==`deck`||e===`deck`&&W===`deck`)){if(!await Pc())return;Fc()}e!==`deck`&&us===`edit`&&(hc(),document.body.classList.remove(`deck-editing`)),W=e,Hs(),cs.has(e)&&pc(),document.querySelectorAll(`.tab-btn`).forEach(t=>{t.classList.toggle(`active`,t.dataset.tab===e)}),document.querySelectorAll(`.view`).forEach(t=>{t.classList.toggle(`hidden`,t.id!==`view-${e}`)}),as(`tab-changed`,{tab:e}),os(`tab-changed`,{tab:e}),e===`chests`&&(Cc(ls),Tc()),e===`deck`&&(us=`list`,_c(`list`)),e===`profile`&&Xs(),e===`settings`&&Zs(),e===`quests`&&(ec(),nc()),e===`play`&&Gc(),e===`pvp`&&bs().then(e=>e?.render({resume:!0})).catch(e=>{console.error(`[PvP] init failed`,e);let t=document.getElementById(`view-pvp`);t&&!t.innerHTML.trim()&&(t.innerHTML=`<section class="panel game-panel pvp-panel"><p class="pvp-status pvp-status--error">Couldn't load PvP — please reload the page.</p></section>`)}),Bn()||(io(`hub`),await po())}}var Q=``;function Gs(e=Q){e&&(Q=e);let t=document.getElementById(`header-profile-menu`),n=document.getElementById(`header-profile-btn`),r=document.getElementById(`header-username`),i=document.getElementById(`auth-header-btn`),a=!!D();if(i&&(i.classList.toggle(`hidden`,a),i.hidden=a),t&&(t.classList.toggle(`hidden`,!a),t.hidden=!a),r){let e=a&&Q;r.textContent=e?Q:``,r.classList.toggle(`hidden`,!e),r.hidden=!e}n&&a&&(n.innerHTML=Bo(U,Q),n.title=Q?`Account — ${Q}`:`Account menu`)}function Ks(){let e=document.getElementById(`header-profile-btn`),t=document.getElementById(`header-profile-dropdown`);!e||!t||(t.classList.add(`hidden`),t.hidden=!0,e.setAttribute(`aria-expanded`,`false`))}function qs(){let e=document.getElementById(`header-profile-menu`),t=document.getElementById(`header-profile-btn`),n=document.getElementById(`header-profile-dropdown`);if(!e||!t||!n)return;let r=e=>{n.classList.toggle(`hidden`,!e),n.hidden=!e,t.setAttribute(`aria-expanded`,e?`true`:`false`)};t.addEventListener(`click`,e=>{e.stopPropagation();let t=!n.hidden;r(!t)}),n.querySelectorAll(`[data-profile-menu-action]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.profileMenuAction;Ks(),t===`settings`?Z(`settings`):Ys()})}),document.addEventListener(`click`,t=>{n.hidden||e.contains(t.target)||Ks()}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&!n.hidden&&Ks()})}async function Js(){let e=D();if(!e){Q=``,Gs();return}Q=await Vo(e),Gs()}function Ys(){Ks(),Z(`profile`),os(`profile-opened`)}async function Xs(){let{renderProfileTab:e}=await qo(),t=X(`view-profile`);e(U,t,{onGemsChange:rc,onTitleChanged:()=>Gs()})}async function Zs(){let{renderSettingsTab:e}=await Xo();e(X(`view-settings`),{onUsernameChanged:e=>{Q=e,Gs(e)}})}var Qs=`
  ...
  </section>`;function ec(){let e=X(`view-quests`);e&&(e.innerHTML=Qs)}function tc(e=X(`view-quests`)){e&&(e.innerHTML=$s,e.querySelector(`.quests-retry-btn`)?.addEventListener(`click`,()=>{Jo(),ec(),nc()}))}async function nc(){let e=X(`view-quests`);if(e)try{let{renderQuestsTab:t}=await qo();t(U,e,{onTitleChanged:()=>Gs(),onCurrencyChange:()=>$()})}catch(t){console.error(`[Quests] render failed`,t),tc(e)}}function $(){let e=X(`header-gems`);e&&(e.textContent=String(U.gems??0));let t=X(`header-stars`);t&&(t.textContent=String(U.stars??0)),document.querySelector(`.hud-gems`)?.classList.toggle(`hud-gems--low`,(U.gems??0)<50),document.querySelector(`.hud-stars`)?.classList.toggle(`hud-stars--low`,(U.stars??0)<10)}function rc(){$()}function ic(){document.querySelectorAll(`.collection-owned-only-toggle`).forEach(e=>{e.checked=hs});for(let e of[`collection-search`]){let t=X(e);t&&(t.value=fs)}for(let e of[`collection-rarity`]){let t=or(e);t&&(t.value=ps)}let e=or(`collection-category`);e&&(e.value=ms)}var ac=`(max-width: 899px)`,oc=`(max-width: 1280px)`,sc=null;function cc(){return window.matchMedia(ac).matches}function lc(){return document.body.classList.contains(`main-tab-active`)&&!document.body.classList.contains(`match-active`)&&!document.body.classList.contains(`deck-editing`)&&window.matchMedia(oc).matches}function uc(){return document.querySelector(`.game-main`)}function dc(){let e=uc();return lc()&&e?e.scrollTop:window.scrollY||document.documentElement.scrollTop||0}function fc(e){let t=uc();if(lc()&&t){t.scrollTop=e;return}window.scrollTo(0,e)}function pc(){let e=uc();if(lc()&&e){e.scrollTop=0;return}window.scrollTo(0,0)}function mc(){cc()&&(sc=dc(),document.body.style.position=`fixed`,document.body.style.top=`0`,document.body.style.left=`0`,document.body.style.right=`0`,document.body.style.width=`100%`)}function hc(){if(sc==null)return;let e=sc;sc=null,document.body.style.position=``,document.body.style.top=``,document.body.style.left=``,document.body.style.right=``,document.body.style.width=``,fc(e)}function gc(){pc(),document.documentElement.scrollTop=0,document.body.scrollTop=0,document.querySelector(`.game-shell`)?.scrollTo?.(0,0),uc()?.scrollTo?.(0,0),document.querySelector(`#view-deck`)?.scrollTo?.(0,0),document.querySelectorAll(`#deck-subview-edit, #deck-subview-edit .deck-editor, #deck-subview-edit .deck-editor__body, #deck-subview-edit .deck-editor__grid, #deck-subview-edit .deck-editor__grid-cards`).forEach(e=>{e.scrollTop=0})}function _c(e){e!==`edit`&&hc(),us=e,document.body.classList.toggle(`deck-editing`,e===`edit`),X(`deck-subview-list`)?.classList.toggle(`hidden`,e!==`list`),X(`deck-subview-edit`)?.classList.toggle(`hidden`,e!==`edit`),e===`edit`&&(mc(),C(U),w(U),ps=`all`,fs=``,ms=`all`,hs=!0,ic(),Mc()),e===`list`&&zc(),e===`edit`&&(Bc(),gc(),requestAnimationFrame(()=>{gc(),requestAnimationFrame(gc)}))}function vc({id:e,title:t,desc:n,cost:r,big:i=!1}){let a=(U.stars??0)>=r,o=i?Ot():Dt();return`
  ...
  `;let t=e.querySelectorAll(`.mystery-box`);yc(t[0],()=>xc({big:!1})),yc(t[1],()=>xc({big:!0}))}function Cc(e){if(!ws&&e===`cosmetics`&&!h(U)){Vs(ie,`Cosmetics locked`),ws=!0,Cc(`cards`),ws=!1;return}ls=e,document.querySelectorAll(`.vault-tab`).forEach(t=>{let n=t.dataset.vaultTab===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,n?`true`:`false`)}),document.querySelectorAll(`.vault-tab-panel`).forEach(t=>{let n=t.id===`vault-tab-${e}`;t.classList.toggle(`hidden`,!n),t.hidden=!n}),os(`vault-tab-changed`,{tab:e})}function wc(){qo().then(({renderCosmeticBoxes:e})=>{e(U,X(`cosmetic-box-list`),{logEl:X(`cosmetic-box-log`),onGemsChange:rc,cosmeticsUnlocked:h(U),onOpened:()=>{W===`profile`&&Xs(),W===`quests`&&nc()}})})}function Tc(e={}){let{clearPulls:t=!0}=e;$(),wc(),Sc();let n=X(`chest-list`),r=X(`chest-pulls`);if(r&&t&&(r.innerHTML=``,r.classList.add(`chest-pulls--hidden`),r.classList.remove(`chest-pulls--reveal`)),n){n.innerHTML=``;for(let e of at){let t=ft[e.id]||ft.bronze,i=U.gems>=e.cost,a=document.createElement(`article`);a.className=`chest-card chest-card--${e.id}${i?``:` chest-card--locked`}`,a.innerHTML=`
    ...
    <div class="adventure-map-tower">
      ...
      <span class="adventure-map-tile__stone" aria-hidden="true">
        ...
        ${a>0?`<span class="adventure-floor-row__stars">${oe(a)}</span>`:``}`,s.addEventListener(`click`,()=>al(t.id)),y.appendChild(s)}}let b=r.querySelector(`.adventure-map-tile--next`);Yc(r),b&&requestAnimationFrame(()=>{requestAnimationFrame(()=>b.scrollIntoView({behavior:`smooth`,block:`nearest`}))});let x=y?.querySelector(`.adventure-floor-row--next`);x&&requestAnimationFrame(()=>x.scrollIntoView({behavior:`smooth`,block:`end`})),r.querySelector(`.adventure-challenge-toggle`)?.addEventListener(`click`,t=>{t.preventDefault(),t.stopPropagation(),e.challengeMode=!e.challengeMode,U.adventure=e,w(U),Co(),co.tap(),Zc()})}function Qc(e){let t=Ce(e);if(!t||!o(U.adventure,e))return;ks=e,zs();let n=X(`prebattle-title`),i=X(`prebattle-flavor`),a=X(`prebattle-opponent`);n&&(n.textContent=`Tower ${t.worldId} · Floor ${t.floorInWorld}`),i&&(i.textContent=t.flavor||``),a&&(a.textContent=`Loading…`);try{As=s(U,e),w(U)}catch(e){console.error(`Enemy deck failed`,e),a&&(a.textContent=`Could not build enemy deck. Try again.`);return}a&&(a.textContent=`Review the enemy spell deck, then choose your grimoire below.`);let c=X(`prebattle-gem-hint`);if(c){let n=y(U.adventure,e);c.textContent=(ue(U.adventure,e)?`Repeat clear: +${n} gems`:`First clear: +${n} gems`)+(t.worldId===5&&l(U.adventure)?` · Challenge mode: enemy has an extra rank of pieces`:``)}let u=X(`enemy-deck-preview`);if(u){u.innerHTML=``;try{for(let{def:e,count:t}of be(As)){if(!e)continue;let n=document.createElement(`button`);n.type=`button`,n.className=`enemy-deck-spell-btn`,n.title=`View ${e.name}`;let r=document.createElement(`span`);if(r.className=`enemy-deck-spell-btn__name`,r.textContent=e.name,n.appendChild(r),t>1){let e=document.createElement(`span`);e.className=`enemy-deck-spell-btn__count`,e.textContent=`×${t}`,n.appendChild(e)}n.addEventListener(`click`,()=>Oa(e,{meta:t>1?`${t} copies in enemy deck`:`Enemy deck`})),u.appendChild(n)}}catch(e){console.error(`Enemy preview failed`,e),u.innerHTML=`<p class="empty-msg">Enemy deck preview unavailable.</p>`}}C(U)&&w(U);let d=or(`adventure-deck-select`);if(!d){a&&(a.textContent=`Deck selector missing — hard refresh the page.`);return}d.innerHTML=``;let f=U.decks.filter(e=>r(e.cardIds,U).valid);if(!f.length){let e=document.createElement(`option`);e.value=``,e.textContent=`No complete decks — build one in Decks`,d.appendChild(e),d.disabled=!0,X(`btn-start-adventure`).disabled=!0;return}d.disabled=!1;let p=U.selectedDeckId&&f.some(e=>e.id===U.selectedDeckId)?U.selectedDeckId:f[0].id;for(let e of f){let t=document.createElement(`option`);t.value=e.id,t.textContent=e.name,e.id===p&&(t.selected=!0),d.appendChild(t)}U.selectedDeckId=p,X(`btn-start-adventure`).disabled=!1}async function $c(e,t,n,r,i=null,a=!1,o=void 0){let s=t.opponent;Wc(),As=null,document.querySelectorAll(`.view`).forEach(e=>e.classList.add(`hidden`)),X(`view-match`)?.classList.remove(`hidden`);let c=X(`view-match`);if(!c)return;let{MatchSession:u,getMatchHtml:d}=await Uo();c.innerHTML=d(s);let p=o??(xe(r).id===5&&l(U.adventure)),m={levelId:r,deckId:e.id,challengeMode:p},h={aiDeckIds:n,opponentName:s,cosmetics:x(U),profile:U,challengeMode:p,buildGameOverActions:({won:e,isTie:t})=>tl(m,{won:e,isTie:t}),onGameOverAction:e=>{nl(e,m,c)}};i&&(h.initialState=i);try{q=new u(e.cardIds,c,()=>{q=null,$n(),po(),io(`hub`),c.innerHTML=``,X(`view-match`)?.classList.add(`hidden`),Z(Wn()||`play`),Ts&&sl(),Es&&cl()},e=>{let t=g(U,r,e),{gems:n,stars:i,starsGained:a}=t;return U.gems+=n,v(U,`adventure_floors`,1),f(U),w(U),$(),Ws(),r===1&&t.firstTime&&(Ts=!0,sl()),r===5&&t.firstTime&&(Es=!0),{message:`+${n} gems! · Best: ${oe(i)}`,starsGained:a}},h)}catch(e){throw q=null,c.innerHTML=``,X(`view-match`)?.classList.add(`hidden`),Z(`play`),e}Zn({kind:`adventure`,deckId:e.id,deckCardIds:e.cardIds,aiDeckIds:n,opponentName:s,levelId:r,challengeMode:p}),await po(),io(`match`),a&&(q.winRewarded=!0),er(q),q.setMessage(``),q.render()}async function el(){let e=tr();if(!e)return!1;let t=U.decks.find(t=>t.id===e.deckId)||U.decks.find(e=>e.cardIds?.length===30),n=e.levelId?Ce(e.levelId):null;return!t||t.cardIds.length!==30||!n||!e.aiDeckIds?.length||!await Ye(`Resume your adventure match where you left off?`,{title:`Resume match?`,confirmLabel:`Resume`,cancelLabel:`Discard`})?(Qn(),!1):(ks=e.levelId,await $c(t,n,e.aiDeckIds,e.levelId,e.state,e.winRewarded,e.challengeMode),q?.setMessage(`Match resumed — pick up where you left off.`),!0)}function tl({levelId:e},{won:t,isTie:n}){let r=e+1,i=t&&r<=50&&o(U.adventure,r);if(n)return[{id:`backToAdventure`,label:`Back to Adventure`,primary:!0}];if(t){let e=[];return i?(e.push({id:`nextFloor`,label:`Next floor`,primary:!0}),e.push({id:`retry`,label:`Retry floor`}),e.push({id:`editDeck`,label:`Edit deck`}),e.push({id:`backToAdventure`,label:`Back to Adventure`})):(e.push({id:`backToAdventure`,label:`Back to Adventure`,primary:!0}),e.push({id:`retry`,label:`Retry floor`}),e.push({id:`editDeck`,label:`Edit deck`})),e}return[{id:`retry`,label:`Retry floor`,primary:!0},{id:`editDeck`,label:`Edit deck`},{id:`backToAdventure`,label:`Back to Adventure`}]}async function nl(e,{levelId:t,deckId:n,challengeMode:r},i){let a=U.decks.find(e=>e.id===n);if(e===`backToAdventure`){q?.onExit?.();return}if(e===`editDeck`){q?.dispose(),q=null,$n(),po(),io(`hub`),i.innerHTML=``,i.classList.add(`hidden`),Z(`deck`),Ic(n);return}if(e===`retry`||e===`nextFloor`){let n=e===`nextFloor`?t+1:t,i=Ce(n);if(!a||a.cardIds.length!==30||!i){q?.onExit?.();return}q?.dispose(),q=null,$n(),await $c(a,i,s(U,n),n,null,!1,e===`retry`?r:void 0)}}function rl(){let e=or(`adventure-deck-select`)?.value,t=U.decks.find(t=>t.id===e),n=ks,r=n?Ce(n):null,i=As?[...As]:null;if(!t||t.cardIds.length!==30||!r||!i?.length){let e=X(`prebattle-opponent`);e&&(!t||t.cardIds.length!==30?e.textContent=`Build a complete 30-card deck in the Decks tab, then try again.`:e.textContent=`Could not start battle — close and pick the floor again.`);return}$c(t,r,i,n)}function il(){if(window.__adventureMapCaptureBound)return;window.__adventureMapCaptureBound=!0;let e=null,t=!1,n=0,r=e=>e.closest?.(`#adventure-map .adventure-map-tile, #adventure-map .adventure-map-pin`),i=e=>e?.closest?.(`.adventure-map-scene`),a=()=>{t=!0,clearTimeout(n),n=setTimeout(()=>{t=!1},280)},o=(e,t)=>{if(!e||e.disabled)return;let n=Number(e.dataset.level);!Number.isFinite(n)||n<1||(t.preventDefault(),t.stopPropagation(),al(n))};document.addEventListener(`pointerdown`,t=>{if(t.button!==0)return;let n=r(t.target);if(!n||n.disabled)return;let a=i(n);e={pin:n,pointerId:t.pointerId,startX:t.clientX,startY:t.clientY,scrollTop:a?.scrollTop??0,scrollLeft:a?.scrollLeft??0,cancelled:!1}},!0),document.addEventListener(`pointermove`,t=>{if(!e||t.pointerId!==e.pointerId||e.cancelled)return;let n=t.clientX-e.startX,r=t.clientY-e.startY;Math.hypot(n,r)>12&&(e.cancelled=!0);let a=i(e.pin);a&&(Math.abs(a.scrollTop-e.scrollTop)>3&&(e.cancelled=!0),Math.abs(a.scrollLeft-e.scrollLeft)>3&&(e.cancelled=!0))},!0),document.addEventListener(`pointerup`,t=>{if(!e||t.pointerId!==e.pointerId)return;let{pin:n,cancelled:r}=e;if(e=null,r){a();return}o(n,t),a()},!0),document.addEventListener(`pointercancel`,t=>{!e||t.pointerId!==e.pointerId||(e=null,a())},!0),document.addEventListener(`click`,e=>{if(t){e.preventDefault(),e.stopPropagation();return}let n=r(e.target);!n||n.disabled||o(n,e)},!0)}function al(e){let t=u(U.adventure);if(U.adventure=t,!o(t,e)){Vs(`Locked — beat global floor ${e-1} first, then return here.`,`Floor locked`);return}w(U),Qc(e)}function ol(){Ls(),window.addEventListener(`orientationchange`,Ls),window.addEventListener(`resize`,Ls),Hs(),Ga(),za(),vo(),oo(),mo(),yo(),ka(),il(),Is(),document.querySelector(`.adventure-map-scene`)?.addEventListener(`scroll`,Xc,{passive:!0});let e;window.addEventListener(`resize`,()=>{clearTimeout(e),e=setTimeout(()=>{if(!document.body.classList.contains(`adventure-active`))return;let e=X(`adventure-map`);e&&Yc(e)},120)}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&Wc()}),document.querySelectorAll(`.tab-btn`).forEach(e=>{e.addEventListener(`click`,()=>{Co(),co.tap(),Z(e.dataset.tab)})}),document.querySelectorAll(`.vault-tab`).forEach(e=>{e.addEventListener(`click`,()=>{Yn(),Cc(e.dataset.vaultTab)})}),X(`btn-new-deck`)?.addEventListener(`click`,Uc),X(`btn-back-from-edit`)?.addEventListener(`click`,async()=>{await Pc()&&(Fc(),_c(`list`))}),X(`btn-delete-deck`)?.addEventListener(`click`,async()=>{if(!G||G===`new`)return;let e=U.decks.find(e=>e.id===G);e&&await Ye(`Delete "${e.name}"? This cannot be undone.`,{title:`Delete deck?`,confirmLabel:`Delete`,cancelLabel:`Keep`,destructive:!0})&&(me(U,e.id),Fc(),_c(`list`))});let t=()=>{us===`edit`&&Bc(),us===`list`&&zc()};document.querySelectorAll(`.collection-owned-only-toggle`).forEach(e=>{e.addEventListener(`change`,e=>{hs=e.target.checked,ic(),t()})}),document.querySelectorAll(`.btn-reset-collection-filters`).forEach(e=>{e.addEventListener(`click`,()=>{ps=`all`,fs=``,ms=`all`,hs=!0,ic(),t()})}),ic(),sr(),X(`collection-search`)?.addEventListener(`input`,e=>{fs=e.target.value,t()}),or(`collection-category`)?.addEventListener(`change`,e=>{ms=e.target.value,t()}),or(`collection-rarity`)?.addEventListener(`change`,e=>{ps=e.target.value,t()}),X(`btn-clear-deck`)?.addEventListener(`click`,()=>{K=[],Bc()}),X(`btn-auto-finish-deck`)?.addEventListener(`click`,Fs),X(`btn-save-deck`)?.addEventListener(`click`,Vc),X(`btn-back-adventure`)?.addEventListener(`click`,Wc),X(`adventure-floor-backdrop`)?.addEventListener(`click`,Wc),X(`btn-start-adventure`)?.addEventListener(`click`,rl),or(`adventure-deck-select`)?.addEventListener(`change`,e=>{U.selectedDeckId=e.target.value,w(U)});let n=document.getElementById(`auth-modal`),r=document.getElementById(`auth-header-btn`);qs(),Pn(`adventure-help-btn`,`adventure-help-desc`),Pn(`shop-help-btn`,`shop-help-desc`),Pn(`deck-help-btn`,`deck-help-desc`),xs=en({onSignIn:()=>Ss?.open(`signin`,{forced:!0}),onSignUp:()=>Ss?.open(`signup`,{forced:!0}),onGuest:()=>{Ht(),ml()}}),Ss=Qt({authBtn:r,modal:n,onNewAccount:()=>{U=ve()?he():T(),mn(U,w)},onSignedIn:()=>{Ut(),U=T(),C(U),pn(U),$(),zc(),Sc(),xs?.hide(),Js().then(()=>{W===`profile`&&Xs(),W===`quests`&&nc(),W===`pvp`&&bs().then(e=>e?.render({resume:!0}))}),bs().then(e=>e?.render({resume:!0})),fl(),pl(),dl(),ul(),J||Z(W)},onSignedOut:()=>{Ut(),Ks(),Q=``,Gs(),vs?.dispose?.(),q=null,$n({clearCheckpoint:!0}),Yn(),U=he(),Ws(),$(),zc(),Sc(),xs?.show(),Z(`deck`)}}),nr(()=>q),C(U),ic(),Ws(),hl()}function sl(){if(!Ts||Ds!=null)return;let e=0,t=()=>{if(Ds=null,e+=1,Ts){if(Hn()){e<10&&(Ds=window.setTimeout(t,400));return}if(pn(U),dl()){Ts=!1;return}e<10&&(Ds=window.setTimeout(t,500))}};Ds=window.setTimeout(t,350)}function cl(){if(!Es||Os!=null)return;let e=0,t=()=>{if(Os=null,e+=1,Es){if(Hn()){e<10&&(Os=window.setTimeout(t,400));return}if(pn(U),ul()){Es=!1;return}e<10&&(Os=window.setTimeout(t,500))}};Os=window.setTimeout(t,350)}function ll(){return J||!$t()||!le(U)||!Sn(U)?!1:(J=!0,ns().then(({startPvpTutorial:e})=>{e({profile:U,saveProfile:w,onComplete:()=>{J=!1,U=T(),C(U),Ws(),Z(`play`),ul()}})}),!0)}function ul(){return J||!$t()||!h(U)||_n(U)||vn(U)||xn(U)||Sn(U)||!wn(U)?!1:(J=!0,Z(`play`),ns().then(({startCosmeticsTutorial:e})=>{e({profile:U,saveProfile:w,onComplete:()=>{J=!1,U=T(),C(U),Ws(),Z(`play`)}})}),!0)}function dl(){return J||!$t()||!le(U)?!1:(pn(U),xn(U)?(J=!0,Z(`play`),ns().then(({startQuestsTutorial:e})=>{e({profile:U,saveProfile:w,onComplete:()=>{J=!1,U=T(),C(U),Ws(),ll(),ul()}})}),!0):ll())}function fl(){return J||!$t()||!_n(U)?!1:(J=!0,is().then(({startInteractiveTutorial:e})=>{e({profile:U,saveProfile:w,onComplete:()=>{J=!1,U=T(),C(U),$(),zc(),Sc(),pl()||Z(`deck`),dl(),ul()}})}),!0)}function pl(){return J||!$t()||!vn(U)?!1:(J=!0,Z(`deck`),es().then(({startMetaTutorial:e})=>{e({profile:U,saveProfile:w,onComplete:()=>{J=!1,U=T(),C(U),$(),zc(),Sc(),Z(`deck`),dl(),ul()}})}),!0)}async function ml(){xs?.hide(),!fl()&&(pl()||dl()||ul()||J||(await el()||await Z(`deck`),Yn(),io(`hub`)))}async function hl(){try{if(await Ae()){try{let e=await Yt();e&&(U=e)}catch(e){console.warn(`Cloud sync on load failed`,e)}C(U),$(),zc(),Sc()}}catch(e){console.warn(`Auth init failed`,e)}if(pn(U),await Js(),vs&&vs.render(),Yn(),tn()){xs?.show();return}await ml()}ol(),E(async()=>{let{registerSW:e}=await import(`./virtual_pwa-register-CpSsV7JG.js`);return{registerSW:e}},[],import.meta.url).then(({registerSW:e})=>{e({immediate:!0})}),Xe(),et();export{Yn as A,Rt as B,Qn as C,Zn as D,Wn as E,gn as F,Ue as G,vt as H,bn as I,yn as L,Pn as M,Cn as N,$n as O,hn as P,Tn as R,ar as S,qn as T,dt as U,ft as V,Ye as W,Pa as _,Oo as a,Sa as b,Po as c,Ro as d,po as f,Wa as g,H as h,Mo as i,er as j,Hn as k,Ao as l,io as m,Vo as n,ko as o,ao as p,wo as r,No as s,Bo as t,Io as u,Aa as v,Gn as w,ur as x,Oa as y,Wt as z};