...
import{n as e,o as t,t as n}from"./cardCatalog-1bq4jvsX.js";import{d as r,i,r as a}from"./deckRules-ZM8f8fig.js";import{A as o,At as s,Ct as c,D as l,Dt as u,Et as d,G as f,H as p,Ot as m,P as h,St as g,Tt as _,_t as v,a as y,bt as ee,c as b,ct as x,d as S,dt as C,f as w,ft as te,g as ne,gt as re,ht as ie,i as ae,j as oe,kt as se,l as ce,lt as le,m as T,mt as ue,o as de,ot as fe,p as pe,pt as me,r as he,s as ge,st as _e,t as ve,u as E,ut as ye,vt as be,wt as xe,xt as Se,yt as Ce,z as we}from"./storage-ClGYzSuU.js";import{l as Te,p as Ee,r as De}from"./mageTitles-BPvsmJqw.js";import{t as D}from"./preload-helper-CV77j2BA.js";import{S as Oe,a as ke,c as Ae,d as je,g as Me,h as Ne,l as Pe,o as O,p as Fe,s as Ie,t as Le,v as Re,x as ze}from"./auth-BpO7FvsW.js";var Be=Object.defineProperty,Ve=(e,t)=>{let n={};for(var r in e)Be(n,r,{get:e[r],enumerable:!0});return t||Be(n,Symbol.toStringTag,{value:`Module`}),n};function He(){let e=window.visualViewport;return e?Math.max(0,Math.round(e.offsetTop)):0}function Ue(){let e=window.visualViewport;return e?Math.max(0,Math.round(window.innerHeight-e.offsetTop-e.height)):0}function We(){let e=document.documentElement,t=()=>{e.style.setProperty(`--viewport-inset-top`,`${He()}px`),e.style.setProperty(`--viewport-inset-bottom`,`${Ue()}px`)};t(),window.visualViewport?.addEventListener(`resize`,t),window.visualViewport?.addEventListener(`scroll`,t),window.addEventListener(`resize`,t),window.addEventListener(`orientationchange`,t)}We();var Ge=1100,Ke=120;function qe(){let e=document.getElementById(`app-splash`);if(!e||e.classList.contains(`app-splash--hide`))return;e.classList.add(`app-splash--hide`),document.body.classList.remove(`splash-active`);let t=()=>{e.remove()};e.addEventListener(`transitionend`,t,{once:!0}),window.setTimeout(t,600)}function Je(){qe()}function Ye(){let e=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches?Ke:Ge,t=performance.now(),n=()=>{let n=performance.now()-t,r=Math.max(0,e-n);window.setTimeout(qe,r)};document.readyState===`interactive`||document.readyState===`complete`?n():document.addEventListener(`DOMContentLoaded`,n,{once:!0})}document.body.classList.add(`splash-active`),Ye();var Xe=`(max-width: 768px)`,Ze=null;function Qe(){return document.getElementById(`mobile-confirm`)}function $e(e){let t=Qe();if(!t)return;t.classList.add(`hidden`),document.body.classList.remove(`mobile-confirm-open`);let n=Ze;Ze=null,n?.(e)}function et(e,t={}){if(!window.matchMedia(Xe).matches)return Promise.resolve(window.confirm(e));let n=Qe();if(!n)return Promise.resolve(window.confirm(e));let{title:r=`Confirm`,confirmLabel:i=`OK`,cancelLabel:a=`Cancel`,destructive:o=!1}=t;return new Promise(t=>{Ze&&$e(!1),Ze=t,n.querySelector(`#mobile-confirm-title`).textContent=r,n.querySelector(`#mobile-confirm-body`).textContent=e;let s=n.querySelector(`#mobile-confirm-ok`),c=n.querySelector(`#mobile-confirm-cancel`);s.textContent=i,c.textContent=a,s.classList.toggle(`btn-danger`,o),s.classList.toggle(`btn-primary`,!o),n.classList.remove(`hidden`),document.body.classList.add(`mobile-confirm-open`),c.focus()})}function tt(){let e=Qe();!e||e.dataset.bound||(e.dataset.bound=`1`,e.querySelector(`#mobile-confirm-ok`)?.addEventListener(`click`,()=>$e(!0)),e.querySelector(`#mobile-confirm-cancel`)?.addEventListener(`click`,()=>$e(!1)),e.querySelector(`[data-mobile-confirm-backdrop]`)?.addEventListener(`click`,()=>$e(!1)))}var nt=`cc_install_banner_dismissed`;function rt(){return window.matchMedia(`(display-mode: standalone)`).matches||window.navigator.standalone===!0}function it(){let e=window.navigator.userAgent;return/iphone|ipad|ipod/i.test(e)&&!/crios|fxios/i.test(e)}function at(){if(rt()||localStorage.getItem(nt)===`1`)return;let e=document.getElementById(`install-banner`);if(!e)return;let t=null,n=()=>{e.classList.remove(`hidden`),document.body.classList.add(`install-banner-visible`)},r=()=>{e.classList.add(`hidden`),document.body.classList.remove(`install-banner-visible`)};window.addEventListener(`beforeinstallprompt`,r=>{r.preventDefault(),t=r,e.querySelector(`#install-banner-ios-hint`)?.classList.add(`hidden`),e.querySelector(`.install-banner__hint--default`)?.classList.remove(`hidden`),e.querySelector(`#install-banner-btn`)?.classList.remove(`hidden`),n()}),it()&&(e.querySelector(`#install-banner-ios-hint`)?.classList.remove(`hidden`),e.querySelector(`.install-banner__hint--default`)?.classList.add(`hidden`),e.querySelector(`#install-banner-btn`)?.classList.add(`hidden`),window.setTimeout(n,2500)),e.querySelector(`#install-banner-btn`)?.addEventListener(`click`,async()=>{t&&(t.prompt(),await t.userChoice,t=null,r())}),e.querySelector(`#install-banner-dismiss`)?.addEventListener(`click`,()=>{localStorage.setItem(nt,`1`),r()})}var ot=[`attack`,`control`,`defense`,`movement`,`trap`,`special`],st={attack:`Attack`,control:`Control`,defense:`Defense`,movement:`Movement`,trap:`Trap`,special:`Special`},ct={aegis:`defense`,anchor:`defense`,backpedal:`control`,backstab:`attack`,backstep:`movement`,barrier:`defense`,bishops_mark:`movement`,blind:`control`,blizzard:`control`,snowball:`control`,berserk:`movement`,bomb:`attack`,shockwave:`control`,plague:`control`,bulwark:`defense`,create_foe:`special`,call_forward:`movement`,chain_lightning:`attack`,clone:`special`,coin_flip:`attack`,collapse:`special`,confusion:`control`,conjure:`special`,constitution:`defense`,counterspell:`trap`,crown:`special`,cryo_bolt:`attack`,cull:`attack`,darkness:`defense`,dash:`movement`,deep_freeze:`control`,deflect:`trap`,demote:`control`,deport:`movement`,displacement:`movement`,dominion:`special`,duel:`attack`,earthquake:`special`,execution:`attack`,extract:`control`,pyromancy:`attack`,fusion:`special`,hibernation:`special`,hostile_swap:`movement`,ignore:`special`,iron_will:`defense`,landmine:`trap`,last_king:`special`,bounty:`special`,link_fate:`special`,last_stand:`trap`,martyr:`trap`,leapfrog:`movement`,long_step:`movement`,magnet:`movement`,nudge:`movement`,offering:`special`,panic:`control`,poison:`attack`,mind_control:`special`,mulligan:`special`,zombify:`special`,press:`control`,purify:`special`,defuse:`special`,quick_march:`movement`,quicksand:`trap`,rally:`defense`,recall:`movement`,repel:`movement`,random_teleport:`movement`,retreat:`movement`,revive:`defense`,rooks_mark:`movement`,root:`control`,sacrifice:`attack`,sanctuary:`defense`,scatter:`movement`,shadow_swap:`movement`,sidestep:`movement`,shatter:`attack`,snipe:`attack`,snowball:`control`,stab:`attack`,stall:`defense`,tangle:`control`,teleport:`movement`,trickster:`special`,toll:`special`,vengeance:`trap`,ward:`defense`};function lt(e){let t=ct[e?.id];if(t)return t;let n=`${e?.id||``} ${e?.effect||``} ${e?.name||``} ${e?.desc||``}`.toLowerCase();return/trap|mine|quicksand|counterspell|vengeance|last.?stand|martyr/.test(n)?`trap`:/shield|ward|aegis|sanctuary|barrier|anchor|deflect|stall|iron_will|rally|darkness/.test(n)?`defense`:/move|nudge|teleport|recall|leap|step|displace|swap|scatter|retreat|bishop|rook|overrun|promote|pull|push|shift|earthquake|magnet|repel/.test(n)?`movement`:/freeze|blind|confusion|hex|root|panic|press|silence|paraly|control|cannot play|random|mark|poison|die in \d+ turn/.test(n)?`control`:/\bdestroy\b|\bkills?\b|fireball|bolt|stab|snipe|duel|sacrifice|execution|shatter|cull|lightning/.test(n)?`attack`:`special`}var ut=[{id:`bronze`,name:`Bronze Chest`,cost:25,cards:3,weights:{common:70,uncommon:25,rare:5,epic:0}},{id:`silver`,name:`Silver Chest`,cost:50,cards:5,weights:{common:50,uncommon:35,rare:12,epic:3}},{id:`gold`,name:`Gold Chest`,cost:100,cards:8,weights:{common:32,uncommon:38,rare:22,epic:6,legendary:2}}];function dt(e){let t=Math.random()*100,n=0;for(let r of[`common`,`uncommon`,`rare`,`epic`,`legendary`])if(n+=e[r]||0,t<=n)return r;return`common`}function ft(t){let n=e().filter(e=>e.rarity===t);return n.length?n[Math.floor(Math.random()*n.length)]:e()[0]}function pt(e,t){return ft(dt(t.weights))}function mt(e,n,r={}){let{starRefundChance:i=0}=r;if(ae(e,n.id)<t(n))return ve(e,n.id,1),{...n,duplicate:!1};let a=we[n.rarity]||10;if(i>0&&Math.random()<i){let e=Math.random()<.5?1:2;return{...n,duplicate:!0,starRefund:e}}return{...n,duplicate:!0,gemRefund:a}}function ht(e,t){let n=ut.find(e=>e.id===t);if(!n)return{success:!1,message:`Unknown chest.`};if(e.gems<n.cost)return{success:!1,message:`Not enough gems.`};e.gems-=n.cost;let r=[],i=0;for(let t=0;t<n.cards;t++){let t=mt(e,pt(e,n));r.push(t),t.gemRefund&&(i+=t.gemRefund)}return i&&(e.gems+=i),fe(e,`boxes_opened`,1),T(e),{success:!0,pulls:r,chest:n,bonusGems:i}}var gt=[`common`,`uncommon`,`rare`,`epic`,`legendary`];function _t(e,{minPct:t=1}={}){return gt.filter(n=>(e[n]??0)>=t).map(t=>`${e[t]}% ${t}`).join(` · `)}var vt={bronze:{label:`Bronze`,tagline:`Mostly common cards`,accent:`#cd7f32`,glow:`rgba(205, 127, 50, 0.45)`},silver:{label:`Silver`,tagline:`Balanced card mix`,accent:`#a8b8d8`,glow:`rgba(168, 184, 216, 0.5)`},gold:{label:`Gold`,tagline:`Higher rare & epic odds`,accent:`#e8c547`,glow:`rgba(232, 197, 71, 0.55)`}};function yt(e){let t=vt[e]||vt.bronze;return{t,lid:e===`gold`?`#f5e6a8`:e===`silver`?`#e8eef8`:`#d4954a`,body:e===`gold`?`#7a5c12`:e===`silver`?`#4a5568`:`#5c3a1e`,trim:e===`gold`?`#ffe566`:e===`silver`?`#c8d8f0`:t.accent}}function bt(e,t){let{lid:n,body:r,trim:i}=yt(e);return`
    <defs>
    ...
    <g${a}>
      ...
      ${s}
    </g>`}function wt(e){let{trim:t}=yt(e),n=`chestStage-${e}`;return`<svg class="chest-stage-svg" viewBox="0 0 120 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ${bt(e,n)}
    <ellipse class="chest-stage__shadow" cx="60" cy="90" rx="44" ry="9" fill="rgba(0,0,0,0.5)"/>
    ${Ct(n,t,e,!0)}
  </svg>`}function Tt(e){let{trim:t}=yt(e),n=`chestCard-${e}`;return`<svg class="chest-svg" viewBox="0 0 120 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ${bt(e,n)}
    <ellipse cx="60" cy="90" rx="44" ry="9" fill="rgba(0,0,0,0.5)"/>
    ${Ct(n,t,e,!1)}
  </svg>`}var Et={accent:`#c4b5fd`,glow:`rgba(167, 139, 250, 0.55)`,body:`#2a1848`,bodyHi:`#4c2d7a`,lid:`#6b46c1`,trim:`#e9d5ff`,gold:`#fbbf24`,gemSpell:`#7dd3fc`,gemCosmetic:`#f0abfc`},Dt={accent:`#fde68a`,glow:`rgba(251, 191, 36, 0.6)`,body:`#3d2810`,bodyHi:`#6b4420`,lid:`#b45309`,trim:`#fef3c7`,gold:`#fcd34d`,gemSpell:`#38bdf8`,gemCosmetic:`#e879f9`};function Ot(e,t){let{body:n,bodyHi:r,lid:i,trim:a,gold:o,gemSpell:s,gemCosmetic:c,glow:l}=e;return`
    <defs>
      <linearGradient id="${t}-body" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stop-color="${r}"/>
    ...
    </defs>`}function kt(e,t,n,r,i=1){return`
    ...
    </g>`}function k(e,t,n,r,i=.9){return`<path d="M${e} ${t-n} L${e+n*.28} ${t-n*.28} L${e+n} ${t} L${e+n*.28} ${t+n*.28} L${e} ${t+n} L${e-n*.28} ${t+n*.28} L${e-n} ${t} L${e-n*.28} ${t-n*.28} Z" fill="${r}" opacity="${i}"/>`}function At(e,t){let{trim:n,gold:r}=t;return`
    ...
    <g class="mystery-box-svg__float">
      ...
      ${k(86,32,3.5,n,.55)}
      ${k(60,18,3,r,.85)}
    </g>`}function jt(e,t){let{trim:n,gold:r}=t;return`
    ...
    <g class="mystery-box-svg__float">
      ...
      ${k(48,86,3.5,r,.8)}
      ${k(72,86,3.5,r,.8)}
    </g>`}function Mt(e){let t=e===`big`,n=t?Dt:Et,r=t?`mysteryBig`:`mysterySmall`,i=t?jt(r,n):At(r,n);return`<svg class="mystery-box-svg ${t?`mystery-box-svg--big`:`mystery-box-svg--small`}" viewBox="0 0 120 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ${Ot(n,r)}
    ${i}
  </svg>`}function Nt(){return Mt(`small`)}var Pt={accent:`#fde68a`,glow:`rgba(251, 191, 36, 0.55)`,body:`#2a1a10`,bodyHi:`#4a3020`,lid:`#92400e`,trim:`#fef3c7`,gold:`#fbbf24`,scroll:`#fff7ed`};function Ft(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function It(e){let t=e.length;return t>12?4.2:t>9?4.8:t>7?5.4:6.2}function Lt(e,t){if(!e)return`<path d="M44 32 H76 M44 36 H72 M44 40 H68" stroke="${t}" stroke-width="1.2" stroke-linecap="round" opacity="0.7"/>`;let n=Ft(e);return`<text x="60" y="41" text-anchor="middle" font-size="${It(e)}" font-weight="700" fill="${t}" font-family="serif">${n}</text>`}function Rt(e,t){let{body:n,bodyHi:r,lid:i,trim:a,gold:o,glow:s}=t;return`
    <defs>
    ...
    </defs>`}function zt(e,t,{forStage:n=!1,titleDisplay:r=``}={}){let{bodyHi:i,trim:a,gold:o,scroll:s}=t;return`
    ...
    <g${n?` class="chest-stage__lid"`:``}>
      ...
      ${k(86,32,3.5,a,.55)}
      ${k(60,14,3,o,.85)}
    </g>`}function Bt(e=``){let t=`titleBoxStage`,n=Pt;return`<svg class="chest-stage-svg mystery-box-svg mystery-box-svg--title" viewBox="0 0 120 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ${Rt(t,n)}
    ...
    ${zt(t,n,{forStage:!0,titleDisplay:e})}
  </svg>`}function Vt(){return Ht()}function Ht(){let e=`titleBox`,t=Pt;return`<svg class="mystery-box-svg mystery-box-svg--title" viewBox="0 0 120 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ${Rt(e,t)}
    <ellipse cx="60" cy="92" rx="40" ry="8" fill="rgba(0,0,0,0.45)"/>
    <circle cx="60" cy="52" r="46" fill="url(#${e}-aura)" opacity="0.55"/>
    <g class="mystery-box-svg__float">
  ...
  </svg>`}function Ut(){return Nt()}var Wt=.5,Gt=.1,Kt=[{id:`bronze`,name:`Bronze Chest`,cards:3,weights:{common:70,uncommon:25,rare:5,epic:0}},{id:`silver`,name:`Silver Chest`,cards:5,weights:{common:50,uncommon:35,rare:12,epic:3}},{id:`gold`,name:`Gold Chest`,cards:8,weights:{common:32,uncommon:38,rare:22,epic:6,legendary:2}}],qt=[{id:`bronze`,name:`Bronze Cosmetic Box`,pulls:3,weights:{common:70,uncommon:25,rare:5,epic:0}},{id:`silver`,name:`Silver Cosmetic Box`,pulls:5,weights:{common:50,uncommon:35,rare:12,epic:3}},{id:`gold`,name:`Gold Cosmetic Box`,pulls:8,weights:{common:32,uncommon:38,rare:22,epic:6,legendary:2}}];function Jt(e,{premium:t=!1}={}){let n=Math.random()*100;return t?n>50?e[2]:n>15?e[1]:e[0]:n>70?e[2]:n>35?e[1]:e[0]}function Yt(e){if((e.stars??0)<10)return{success:!1,message:`Not enough stars.`};e.stars=(e.stars??0)-10;let t=c(e),n=[],r=[],i=0,a=0;for(let o=0;o<6;o++)if(t&&Math.random()<.5){let t=p(e,Jt(qt).weights);t&&(r.push(t),t.duplicate&&(i+=t.gemRefund||10))}else{let t=mt(e,pt(e,Jt(Kt)),{starRefundChance:Gt});n.push(t),t.gemRefund&&(i+=t.gemRefund),t.starRefund&&(a+=t.starRefund)}return i&&(e.gems=(e.gems||0)+i),a&&(e.stars=(e.stars??0)+a),fe(e,`boxes_opened`,1),T(e),{success:!0,kind:n.length&&r.length?`mixed`:n.length?`card`:`cosmetic`,cardPulls:n,cosPulls:r,bonusGems:i,bonusStars:a,message:`Got ${n.length} spells and ${r.length} cosmetics`}}function Xt(e){if((e.stars??0)<10)return{success:!1,message:`Not enough stars.`};e.stars=(e.stars??0)-10;let t=De.filter(t=>!Te(e,t.id)),n,r=0;if(t.length){let r=t[Math.floor(Math.random()*t.length)];Ee(e,r.id),n={...r,duplicate:!1}}else{let t=De[Math.floor(Math.random()*De.length)];r=3,e.stars=(e.stars??0)+r,n={...t,duplicate:!0,starRefund:r}}return fe(e,`boxes_opened`,1),T(e),{success:!0,kind:`title`,pulls:[n],bonusStars:r,message:n.duplicate?`Duplicate ${n.name} — +${r} ★ refunded`:`Unlocked title: ${n.name}`}}var Zt=`arcane_checkers_guest_mode_v1`,Qt=`Sign in to save progress / play PvP`,$t=`Sign in to save progress`;function en(){return tn()&&!O()}function tn(){try{return localStorage.getItem(Zt)===`1`}catch{return!1}}function nn(){try{localStorage.setItem(Zt,`1`)}catch{}}function rn(){try{localStorage.removeItem(Zt)}catch{}}var an=Ve({pullCloudProfile:()=>un,scheduleCloudSave:()=>dn}),on=null;function sn(e){if(!e||typeof e!=`object`)return!0;let t=Object.keys(e);if(t.length===0||t.every(e=>e===`loginEmail`||e===`login_email`||e===`savedAt`))return!0;let n=e.collection&&Object.keys(e.collection).length>0,r=Array.isArray(e.decks)&&e.decks.length>0,i=e.adventure?.cleared,a=(Array.isArray(i)?i.length:Object.keys(i||{}).length)>0,o=typeof e.gems==`number`||typeof e.stars==`number`,s=typeof e.pvpWins==`number`&&e.pvpWins>0||typeof e.spellsPlayed==`number`&&e.spellsPlayed>0;return!(n||r||a||o||s)}function cn(e){return w(e),T(e,{bumpTimestamp:!1}),e}function ln(e,t){let n=ge();return!(n!==e&&n!==null||n===null&&tn()&&t&&!sn(t))}async function un(){let e=O();if(!e||!Ae())return null;let t=await ke(e.id),n=S(),r=t?.profile_json,i=ln(e.id,r);if(!r||typeof r!=`object`||sn(r)){if(!ce(n)&&i)cn(n);else if(!ce(n)&&!i)return cn(pe());return S()}if(ce(n)||!i){let e={...r};return i&&o(e,n),oe(e),cn(e)}return(r.savedAt||0)>=(n.savedAt||0)?cn(h(n,r)):(o(n,r),T(n),n)}function dn(e){let t=O();!t||!Ae()||(clearTimeout(on),on=setTimeout(async()=>{try{await Re(t.id,{profile_json:e,display_name:t.user_metadata?.display_name||t.email?.split(`@`)[0]})}catch(e){console.warn(`Cloud save failed`,e)}},800))}var fn=Le;function pn({authBtn:e,modal:t,onSignedIn:n,onSignedOut:r,onNewAccount:i}){if(!e||!t)return;let a=t.querySelector(`#auth-form`),o=t.querySelector(`#auth-modal-title`),s=t.querySelector(`#auth-toggle-mode`),c=t.querySelector(`#auth-error`),l=t.querySelector(`#auth-username-hint`),u=t.querySelector(`#auth-close`),d=t.querySelector(`.auth-modal-backdrop`),f=a?.querySelector(`button[type="submit"]`),p=`signin`,m=null,h=!1,g=!1;function _(){a?.querySelectorAll(`.auth-field-signup`).forEach(e=>{e.classList.toggle(`hidden`,p!==`signup`)});let e=a?.querySelector(`#auth-identifier`),t=a?.querySelector(`label[for="auth-identifier"]`);t&&(t.textContent=p===`signup`?`Email`:`Username or email`),e&&(e.placeholder=p===`signup`?`you@email.com`:`username or email`,e.type=p===`signup`?`email`:`text`,e.autocomplete=p===`signup`?`email`:`username`),f&&(f.textContent=p===`signup`?`Create account`:`Sign in`),l&&(l.textContent=``),l?.classList.remove(`auth-username-hint--ok`,`auth-username-hint--bad`)}function v(e){c&&(c.textContent=e||``)}function y(e,t=``){l&&(l.textContent=e||``,l.classList.remove(`auth-username-hint--ok`,`auth-username-hint--bad`),t===`ok`&&l.classList.add(`auth-username-hint--ok`),t===`bad`&&l.classList.add(`auth-username-hint--bad`))}async function ee(){if(p!==`signup`)return;let e=a?.querySelector(`#auth-username`)?.value?.trim();if(!e){y(``);return}if(!fn.test(e)){y(`3–24 letters, numbers, or underscore`,`bad`);return}if(y(`Checking…`),!await Pe(e)){let t=await Me(e);y(t?`Taken — try "${t}"`:`That username is taken`,`bad`),t&&l&&(l.dataset.suggestion=t);return}l&&delete l.dataset.suggestion,y(`Available`,`ok`)}function b(e,n={}){if(h=!!n.forced,!Ae()){v(`Add Supabase anon key in js/supabaseConfig.js`),t.classList.remove(`hidden`),u?.classList.toggle(`hidden`,h);return}p=e||p,o&&(o.textContent=p===`signup`?`Create account`:`Sign in`),s&&(s.textContent=p===`signup`?`Already have an account? Sign in`:`Need an account? Sign up`),v(``),_(),u?.classList.toggle(`hidden`,h),d?.classList.toggle(`auth-modal-backdrop--locked`,h),t.classList.remove(`hidden`)}function x(){h||(t.classList.add(`hidden`),v(``),y(``))}function S(t){if(e){if(!Ae()){e.textContent=`Setup cloud`,e.title=`Configure Supabase`,e.classList.remove(`hidden`),e.hidden=!1;return}t?(e.classList.add(`hidden`),e.hidden=!0):(e.textContent=`Sign in`,e.title=`Sign in or sign up`,e.classList.remove(`hidden`),e.hidden=!1)}}e.addEventListener(`click`,()=>{O()||b(`signin`)}),s?.addEventListener(`click`,e=>{e.preventDefault(),p=p===`signup`?`signin`:`signup`,b(p)}),u?.addEventListener(`click`,x),d?.addEventListener(`click`,()=>{h||x()});let C=a?.querySelector(`#auth-username`);C?.addEventListener(`input`,()=>{clearTimeout(m),m=setTimeout(()=>{ee().catch(()=>y(``))},350)}),l?.addEventListener(`click`,()=>{let e=l?.dataset?.suggestion;!e||!C||(C.value=e,delete l.dataset.suggestion,ee().catch(()=>{}))}),a?.addEventListener(`submit`,async e=>{e.preventDefault(),v(``);let t=a.querySelector(`#auth-identifier`)?.value?.trim(),r=a.querySelector(`#auth-username`)?.value?.trim(),o=a.querySelector(`#auth-password`)?.value;if(!t||!o){v(p===`signup`?`Email and password required.`:`Username or email and password required.`);return}f&&(f.disabled=!0),g=!0;try{if(p===`signup`){if(!t.includes(`@`)){v(`Use your email address to sign up.`);return}if(!r||!fn.test(r)){v(`Choose a username (3–24 letters, numbers, underscore).`);return}let e=r;if(!await Pe(e)){let t=await Me(e);if(t){v(`"${e}" is taken. Try "${t}" or tap the hint below.`),y(`Tap to use "${t}"`,`bad`),l&&(l.dataset.suggestion=t);return}v(`Username "${e}" is already taken. Pick another.`);return}i?.();let a=(await Ne(t,o,e,e)).session?.user??O();if(a){let r=await ke(a.id),i=r?.profile_json&&typeof r.profile_json==`object`?{...r.profile_json}:{};i.loginEmail=t.toLowerCase();try{await Re(a.id,{username:e,display_name:e,profile_json:i})}catch(t){if((t?.code||t?.details?.code)===`23505`){let t=await Me(e);v(t?`Account created but "${e}" was taken. Sign in and change your name to "${t}", or try sign up again with that username.`:`Account created but that username was just taken. Sign in with your email and pick another name in Profile.`),p=`signin`,b(`signin`);return}throw t}try{await un()}catch(e){console.warn(`Profile sync after signup failed`,e)}n?.(),h=!1,u?.classList.remove(`hidden`),d?.classList.remove(`auth-modal-backdrop--locked`),x();return}v(`Account created. Check your email to confirm, then sign in.`),p=`signin`,b(`signin`);return}await Fe(t,o);let e=O();if(!e){v(`Sign-in failed — no session returned. Try again or confirm your email.`);return}try{await un()}catch(e){console.warn(`Profile sync after sign-in failed`,e)}n?.(),h=!1,u?.classList.remove(`hidden`),d?.classList.remove(`auth-modal-backdrop--locked`),S(e),x()}catch(e){let t=e?.message||`Authentication failed`;if(t.includes(`Database error saving new user`)||t.includes(`username_taken`)||e?.code===`23505`){let e=r&&fn.test(r)?await Me(r):null;t=e?`Sign-up failed (username conflict). Try "${e}" instead.`:`Sign-up failed on the server. Try a different username, or sign in if you already have an account.`}else t.includes(`over_email_send_rate_limit`)||t.includes(`rate limit`)?t=`Too many sign-up attempts. Wait a few minutes or sign in with an existing account.`:t.includes(`User already registered`)&&(t=`That email is already registered. Try Sign in instead.`);t.includes(`Invalid login credentials`)?v(`Wrong email/username or password.`):t.includes(`Email not confirmed`)?v(`Confirm your email first (check inbox), or disable email confirmation in Supabase for testing.`):v(t)}finally{g=!1,f&&(f.disabled=!1)}});let w=!1;return je(async e=>{if(S(e),e){if(w=!0,g)return;try{await un()}catch(e){console.warn(`Profile sync failed`,e)}n?.(),h=!1,u?.classList.remove(`hidden`),d?.classList.remove(`auth-modal-backdrop--locked`),x()}else w&&(w=!1,r?.())}),Ie().then(S),{open:b,close:x}}function mn(){return!!O()||tn()}function hn({onSignIn:e,onSignUp:t,onGuest:n}){let r=document.getElementById(`auth-gate`);if(!r)return{show:()=>{},hide:()=>{},sync:()=>{}};let i=r.querySelector(`#auth-gate-signin`),a=r.querySelector(`#auth-gate-signup`),o=r.querySelector(`#auth-gate-guest`),s=r.querySelector(`#auth-gate-notice`);i?.addEventListener(`click`,()=>e?.()),a?.addEventListener(`click`,()=>t?.()),o?.addEventListener(`click`,()=>n?.());function c(){Ae()?s&&(s.textContent=`Create an account to sync decks, stars, and collection — or continue as guest to play Adventure on this device.`):s&&(s.textContent=`Cloud sign-in is not configured. Add your Supabase keys in js/supabaseConfig.js.`),r.classList.remove(`hidden`),document.body.classList.add(`auth-gate-active`)}function l(){r.classList.add(`hidden`),document.body.classList.remove(`auth-gate-active`)}function u(){mn()?l():c()}return{show:c,hide:l,sync:u}}function gn(){return Ae()&&!mn()}var _n=`arcane_checkers_tutorial_v1`,vn=`arcane_checkers_interactive_tutorial_v1`,yn=`arcane_checkers_meta_tutorial_v1`,bn=`arcane_checkers_quests_tutorial_v1`,xn=`arcane_checkers_pvp_tutorial_v1`,Sn=`arcane_checkers_cosmetics_tutorial_v1`,Cn=`arcane_checkers_pending_signup_tutorial_v1`;function wn(){try{sessionStorage.setItem(Cn,`1`)}catch{}}function Tn(){try{sessionStorage.removeItem(Cn)}catch{}}function En(){try{return sessionStorage.getItem(Cn)===`1`}catch{return!1}}function Dn(e){if(!e)return;let t=[[vn,e.interactiveTutorialDone||e.tutorialDone],[yn,e.metaTutorialDone||e.tutorialDone],[bn,e.questsTutorialDone],[xn,e.pvpTutorialDone],[Sn,e.cosmeticsTutorialDone]];try{for(let[e,n]of t)n?localStorage.setItem(e,`done`):localStorage.getItem(e)===`done`&&localStorage.removeItem(e)}catch{}}function On(e,t){wn();try{localStorage.removeItem(vn),localStorage.removeItem(yn),localStorage.removeItem(bn),localStorage.removeItem(xn),localStorage.removeItem(Sn),localStorage.removeItem(_n)}catch{}e&&(delete e.interactiveTutorialDone,delete e.metaTutorialDone,delete e.questsTutorialDone,delete e.pvpTutorialDone,delete e.cosmeticsTutorialDone,delete e.tutorialDone,t?.(e))}function kn(e={}){if(Tn(),e.persist){try{localStorage.setItem(vn,`done`)}catch{}e.profile&&(e.profile.interactiveTutorialDone=!0),e.saveProfile?.(e.profile)}}function An(e={}){if(e.persist){try{localStorage.setItem(yn,`done`),localStorage.setItem(_n,`done`)}catch{}e.profile&&(e.profile.metaTutorialDone=!0,e.profile.tutorialDone=!0),e.saveProfile?.(e.profile)}}function jn(e){if(En())return!0;if(e?.interactiveTutorialDone||e?.tutorialDone)return!1;try{return localStorage.getItem(vn)!==`done`}catch{return!0}}function Mn(e){if(e?.metaTutorialDone||e?.tutorialDone)return!1;if(!e?.interactiveTutorialDone)try{if(localStorage.getItem(vn)!==`done`)return!1}catch{return!1}try{return localStorage.getItem(yn)!==`done`}catch{return!0}}function Nn(e={}){if(e.persist){try{localStorage.setItem(bn,`done`)}catch{}e.profile&&(e.profile.questsTutorialDone=!0),e.saveProfile?.(e.profile)}}function Pn(e={}){if(e.persist){try{localStorage.setItem(xn,`done`)}catch{}e.profile&&(e.profile.pvpTutorialDone=!0),e.saveProfile?.(e.profile)}}function Fn(e){if(e?.questsTutorialDone)return!1;try{return localStorage.getItem(bn)!==`done`}catch{return!0}}function In(e){if(e?.pvpTutorialDone)return!1;if(!e?.questsTutorialDone)try{if(localStorage.getItem(bn)!==`done`)return!1}catch{return!1}try{return localStorage.getItem(xn)!==`done`}catch{return!0}}function Ln(e={}){if(e.persist){try{localStorage.setItem(Sn,`done`)}catch{}e.profile&&(e.profile.cosmeticsTutorialDone=!0),e.saveProfile?.(e.profile)}}function Rn(e){if(e?.cosmeticsTutorialDone)return!1;try{return localStorage.getItem(Sn)!==`done`}catch{return!0}}function zn(e){return e instanceof Element?!!e.closest(`#mobile-confirm, #tutorial-meta-overlay, #tutorial-match-overlay, .card-preview-modal`):!1}var Bn=new WeakSet,Vn=!1,Hn=null,Un=null;function Wn(){return document.getElementById(`panel-help-popup`)}function Gn(){let e=Wn();!e||e.classList.contains(`hidden`)||(e.classList.add(`hidden`),document.body.classList.remove(`panel-help-open`),Hn&&=(Hn.setAttribute(`aria-expanded`,`false`),Hn.classList.remove(`panel-help-btn--active`),null),Un&&=(clearTimeout(Un),null))}function Kn({title:e,bodyHtml:t,triggerBtn:n=null,autoCloseMs:r=0}){let i=Wn();if(!i)return;Gn();let a=i.querySelector(`#panel-help-popup-title`),o=i.querySelector(`#panel-help-popup-body`);a&&(a.textContent=e||`Help`),o&&(o.innerHTML=t||``),i.classList.remove(`hidden`),document.body.classList.add(`panel-help-open`),n&&(Hn=n,n.setAttribute(`aria-expanded`,`true`),n.classList.add(`panel-help-btn--active`)),r>0&&(Un=setTimeout(Gn,r)),i.querySelector(`.panel-help-popup__dismiss`)?.focus()}function qn(){if(Vn)return;Vn=!0;let e=Wn();e&&(e.querySelectorAll(`[data-panel-help-close]`).forEach(e=>{e.addEventListener(`click`,Gn)}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&Gn()}))}function Jn(e,t){let n=typeof e==`string`?document.getElementById(e):e,r=typeof t==`string`?document.getElementById(t):t;!n||!r||Bn.has(n)||(Bn.add(n),qn(),n.addEventListener(`click`,e=>{e.stopPropagation();let t=Wn();if(t&&!t.classList.contains(`hidden`)&&Hn===n){Gn();return}Kn({title:n.getAttribute(`aria-label`)||`Help`,bodyHtml:r.innerHTML,triggerBtn:n})}))}var Yn=`cc_match_checkpoint`,Xn=1440*60*1e3,Zn=null,Qn=!1,$n=null;function er(){return document.body.classList.contains(`match-active`)}function tr(e){if(!e||!(e instanceof Element)||e.closest(`.hidden`))return!1;let t=getComputedStyle(e);return!(t.display===`none`||t.visibility===`hidden`)}function nr(){let e=document.getElementById(`view-match`);if(e&&!e.classList.contains(`hidden`)&&e.querySelector(`.pvp-loading`))return!0;let t=document.querySelector(`#btn-leave-match`);if(!t)return!1;if(tr(t))return!0;if(!er())return!1;let n=document.getElementById(`play-arena-root`);return!!(e?.contains(t)||n?.contains(t))}function rr(e){Zn=e}function ir(){let e=Zn;return Zn=null,e}function ar(){Zn=null}function or(){Qn=!0}function sr(){let e=Qn;return Qn=!1,e}function cr(){let e=document.getElementById(`view-match`);if(e&&!e.classList.contains(`hidden`)&&e.innerHTML.trim()){if(e.querySelector(`.pvp-loading`))return;tr(e.querySelector(`#btn-leave-match`))||(e.innerHTML=``,e.classList.add(`hidden`))}else e?.classList.contains(`hidden`)&&e.innerHTML.trim()&&(e.innerHTML=``);let t=document.getElementById(`play-arena-root`);t&&t.querySelector(`#pvp-match-root`)?.remove()}function lr(){return!er()||nr()?!1:(cr(),pr({clearCheckpoint:!1}),window.dispatchEvent(new CustomEvent(`cc-match-shell-reconciled`)),!0)}function ur(e){document.querySelector(`.game-shell`)?.classList.toggle(`game-shell--in-match`,e)}function dr(e){$n=e,document.body.classList.add(`match-active`),ur(!0)}function fr(){try{sessionStorage.removeItem(Yn)}catch{}}function pr(e={}){$n=null,document.body.classList.remove(`match-active`),ur(!1),e.clearCheckpoint&&fr()}function mr(e){if(!(!$n||!e?.state||$n.kind!==`adventure`||e.state.gameOver))try{sessionStorage.setItem(Yn,JSON.stringify({...$n,state:e.state,winRewarded:!!e.winRewarded,savedAt:Date.now()}))}catch{}}function hr(){try{let e=sessionStorage.getItem(Yn);if(!e)return null;let t=JSON.parse(e);return!t?.state||t.state.gameOver||t.kind!==`adventure`||t.savedAt&&Date.now()-t.savedAt>Xn?(fr(),null):t}catch{return fr(),null}}function gr(e){if(window.__ccMatchVisibilityBound)return;window.__ccMatchVisibilityBound=!0;let t=()=>{let t=e();t&&mr(t)};document.addEventListener(`visibilitychange`,()=>{let n=e();document.hidden?(t(),n?.pauseForBackground?.()):n?.resumeFromBackground?.()}),window.addEventListener(`pagehide`,t)}var _r=new Set;function vr(e){for(let t of _r)t!==e&&t.close()}function yr(e){if(!e||e.dataset.customSelectEnhanced)return e?._customSelectApi??null;e.dataset.customSelectEnhanced=`1`;let t=document.createElement(`div`);t.className=`custom-select`;let n=document.createElement(`button`);n.type=`button`,n.className=`custom-select__trigger select-input`,n.setAttribute(`aria-haspopup`,`listbox`),n.setAttribute(`aria-expanded`,`false`);let r=document.createElement(`span`);r.className=`custom-select__chevron`,r.setAttribute(`aria-hidden`,`true`),r.textContent=`▾`;let i=document.createElement(`span`);i.className=`custom-select__label`;let a=document.createElement(`div`);a.className=`custom-select__list hidden`,a.setAttribute(`role`,`listbox`);let o=e.id;o&&(n.id=o,e.removeAttribute(`id`));let s=e.getAttribute(`aria-label`)?null:document.querySelector(`label[for="${o}"]`)?.id;s?n.setAttribute(`aria-labelledby`,s):e.getAttribute(`aria-label`)&&n.setAttribute(`aria-label`,e.getAttribute(`aria-label`)),e.classList.add(`custom-select__native`),e.tabIndex=-1,e.setAttribute(`aria-hidden`,`true`),e.parentNode.insertBefore(t,e),t.appendChild(e),t.appendChild(n),n.appendChild(i),n.appendChild(r),t.appendChild(a);let c=!1,l=-1;function u(){return[...e.options]}function d(){return e.options[e.selectedIndex]??null}function f(){let r=d();i.textContent=r?.textContent?.trim()||`Select…`,n.disabled=e.disabled,t.classList.toggle(`custom-select--disabled`,e.disabled),a.querySelectorAll(`.custom-select__option`).forEach(t=>{let n=t.dataset.value===e.value;t.classList.toggle(`custom-select__option--selected`,n),t.setAttribute(`aria-selected`,n?`true`:`false`)})}function p(t){let n=Object.getOwnPropertyDescriptor(HTMLSelectElement.prototype,t);!n?.set||!n?.get||Object.defineProperty(e,t,{configurable:!0,enumerable:n.enumerable,get(){return n.get.call(this)},set(e){n.set.call(this,e),f()}})}p(`value`),p(`selectedIndex`),p(`disabled`);function m(t){e.disabled||(e.value=t.value,e.dispatchEvent(new Event(`change`,{bubbles:!0})),f(),y())}function h(){a.innerHTML=``;for(let e of u()){let t=document.createElement(`button`);t.type=`button`,t.className=`custom-select__option`,t.setAttribute(`role`,`option`),t.dataset.value=e.value,t.textContent=e.textContent?.trim()||e.value,t.addEventListener(`click`,t=>{t.stopPropagation(),m(e)}),a.appendChild(t)}f()}function g(e){let t=[...a.querySelectorAll(`.custom-select__option`)];t.length&&(l=Math.max(0,Math.min(e,t.length-1)),t.forEach((e,t)=>{e.classList.toggle(`custom-select__option--active`,t===l)}),t[l]?.scrollIntoView({block:`nearest`}))}function _(){a.classList.remove(`custom-select__list--above`);let e=n.getBoundingClientRect(),t=Math.min(256,window.innerHeight*.5),r=window.innerHeight-e.bottom,i=e.top;r<t*.65&&i>r&&a.classList.add(`custom-select__list--above`)}function v(){c||e.disabled||(vr(b),c=!0,_r.add(b),a.classList.remove(`hidden`),t.classList.add(`custom-select--open`),n.setAttribute(`aria-expanded`,`true`),_(),g(Math.max(0,e.selectedIndex)),document.addEventListener(`click`,x),document.addEventListener(`keydown`,S))}function y(){c&&(c=!1,_r.delete(b),a.classList.add(`hidden`),t.classList.remove(`custom-select--open`),n.setAttribute(`aria-expanded`,`false`),l=-1,a.querySelectorAll(`.custom-select__option--active`).forEach(e=>{e.classList.remove(`custom-select__option--active`)}),document.removeEventListener(`click`,x),document.removeEventListener(`keydown`,S))}function ee(){return c}let b={close:y,rebuild:h,isOpen:ee};e._customSelectApi=b,n.addEventListener(`click`,t=>{t.stopPropagation(),!e.disabled&&(c?y():v())}),n.addEventListener(`keydown`,t=>{e.disabled||((t.key===`ArrowDown`||t.key===`ArrowUp`||t.key===`Enter`||t.key===` `)&&(t.preventDefault(),c||v(),t.key===`ArrowDown`&&g(l+1),t.key===`ArrowUp`&&g(l<=0?0:l-1),(t.key===`Enter`||t.key===` `)&&l>=0&&[...a.querySelectorAll(`.custom-select__option`)][l]?.click()),t.key===`Escape`&&y())});let x=e=>{if(!t.isConnected){y();return}t.contains(e.target)||y()},S=e=>{e.key===`Escape`&&y()},C=new MutationObserver(()=>{h()});C.observe(e,{childList:!0,subtree:!0,attributes:!0,attributeFilter:[`disabled`,`value`,`selected`]}),e.addEventListener(`change`,f);let w=e.remove.bind(e);return e.remove=function(){y(),C.disconnect(),w(),t.isConnected&&t.remove()},h(),b}function br(e){if(!e)return null;let t=typeof e==`string`?document.getElementById(e):e;return t?t.tagName===`SELECT`?t:t.closest(`.custom-select`)?.querySelector(`select.custom-select__native`)??null:null}function xr(e=document){e.querySelectorAll(`select.select-input:not([data-custom-select-enhanced]):not([data-no-custom-select])`).forEach(e=>{yr(e)})}var Sr=`online-players`,Cr=null,wr=new Set,Tr=new Set;function Er(){let e=new Set(wr);for(let t of Tr)t(e)}function Dr(e){let t=new Set;for(let n of Object.values(e||{}))for(let e of n){let n=e?.user_id;typeof n==`string`&&n.length>0&&t.add(n)}wr=t,Er()}function Or(e){return!!e&&wr.has(e)}function kr(e){return Tr.add(e),e(new Set(wr)),()=>Tr.delete(e)}function Ar(){jr();let e=O(),t=ze();if(!e||!t||!Oe())return;Cr=t.channel(Sr,{config:{presence:{key:e.id}}});let n=()=>Dr(Cr?.presenceState());Cr.on(`presence`,{event:`sync`},n).on(`presence`,{event:`join`},n).on(`presence`,{event:`leave`},n).subscribe(async t=>{if(t===`SUBSCRIBED`)try{await Cr.track({user_id:e.id})}catch(e){console.warn(`Friend presence track failed`,e)}})}function jr(){let e=ze();Cr&&=(e?.removeChannel(Cr),null),wr=new Set,Er()}var Mr={nudge:[`Move your piece 1 square forward-diagonally`],shield_1:[`Shield 1 turn — blocks one capture or spell hit`],shield_2:[`Shield 2 turns — cannot be captured`],forward_bolt:[`Destroy first enemy on forward diagonal (Stab)`],trickster:[`Swap up to 6 random pieces (not on back ranks)`],purify:[`Removes all debuffs from your pieces, including burn and freeze`],defuse:[`Can't be countered`,`Deactivates every trap on the board`,`Cast another spell this turn`],chain_lightning:[`Strike adjacent enemies only`,`Up to 2 kills if enemies touch each other`,`Your piece is paralyzed 2 turns`],pyromancy:[`Enemy piece + empty dark square — both burn 2 turns; fire tiles block enemies`,`You cannot cast spells on your next turn`],freeze_1:[`Enemy cannot move on their next turn`],snowball:[`Freeze an enemy piece — cannot move on its owner's next turn`],freeze_2:[`Enemy cannot move on their next turn`],deep_freeze:[`Freeze all enemies on one diagonal through your piece for 2 turns`],retreat_3:[`Backward movement for 3 turns`],bishop_2:[`Diagonal slide over empty dark squares for 2 turns`],rook_2:[`Rank/file slide over empty dark squares for 2 turns`],crown:[`Instantly crown a friendly piece`],swap_friendly:[`Swap two friendly pieces`],hostile_swap:[`Swap with an unshielded enemy within 3 squares (Chebyshev)`],quick_march:[`Same piece moves again; either step may capture`],offering:[`Sacrifice a friendly piece`,`Draw 2 cards`,`Cast another spell immediately`],mulligan:[`Shuffle your hand into your deck`,`Draw that many cards`,`Cast another spell this turn`],conjure:[`Draw 2 random cards not in your deck`,`Cards come from the global spell pool`],destroy_unshielded:[`Destroy any unshielded enemy`,`You cannot cast spells on your next turn`],revive:[`Requires a captured friendly piece`,`Place on any empty dark square on your side of the board`,`Returns a clean piece without zombie curse or Awoken Bear`,`Revived piece cannot capture this turn`],blink_2:[`Teleport within 2 squares`],random_teleport:[`Jump to a random empty dark square`,`Crowned if you land on the back rank`],long_step:[`Epic: leap 2 squares diagonally (no capture)`],dash:[`Move 1 square forward-diagonally`,`Destroy enemy on landing square`],sidestep:[`Skip 2 columns on the same row`],landmine:[`Hidden trap 2 turns — destroys enemy lander`],quicksand:[`Hidden trap — freezes the next piece to land there`],detonate:[`Destroy self + adjacent enemies`],venom:[`Poison — 2 ticks destroys target`],bomb:[`Arm friendly piece`,`On next move: explodes`,`Kills all adjacent pieces`],shockwave:[`Arm friendly piece`,`On next move: paralyzes all adjacent pieces`,`1 turn — does not kill`],plague:[`Infect your piece + adjacent pieces`,`Seed spreads plague on every move`,`All infected die in 2 owner turns`],press:[`Opponent must move again after their normal move on their next turn`,`Extra step cannot capture`],mind_control:[`Convert an enemy man to your color for 2 of your turns`,`Reverts to the enemy afterward`],zombify:[`Curse one of your men — sleeps in a gravestone for 1 turn`,`Rises as a zombie king that zombifies captures`,`Horde zombies persist even if the king falls`],barrier:[`Place on any dark square`,`Blocks enemies for 2 turn cycles`],vengeance:[`Hidden trap — destroys the next enemy who captures your piece`,`Expires after 2 of your turn cycles if unused`,`Your piece survives 2 turns (blood counters), then dies`],hibernation:[`Sleep 2 turns (immobile)`,`Wake with Awoken Bear mark`,`Extra move every turn after`],fusion:[`Merge two adjacent men into one`,`Gains Awoken Bear mark`,`Extra move every turn after`],root_2:[`Enemy cannot jump/capture next turn`],silence_3:[`Suppress special movement 3 turns`],poison_3:[`Enemy dies in 3 turns — 3-turn poison bar`],deflect_1:[`Hidden trap — spell hit within 2 turns kills closest enemy instead`],last_stand:[`Hidden trap — ultra shield on capture or destroy for 3 turns`,`Expires after 1 of your turn cycles if unused`],martyr:[`Hidden trap on a friendly piece`,`If an enemy captures or destroys it on their turn within 2 turns, draw 2 cards`,`Expires after 2 of your turn cycles if unused`],clone:[`Your man, then adjacent empty square — copy inherits Awoken Bear and zombie horde marks`,`Copy cannot capture or be taken this turn; dies to freeze/poison/burn/plague`],deport:[`Send an enemy back to its game-start square`,`Destroys any piece already on that square`],bounty:[`Mark an enemy piece`,`When you jump-capture it, draw 2 cards`,`Spell destroys do not count`],link_fate:[`Link two enemies — when one is destroyed, the other dies too`],extract:[`Opponent discards 1 random card from hand`],toll:[`For 2 turns, whenever an opponent casts a spell, draw 2 cards`,`Lasts 2 of your turn cycles`]},Nr={instant:[`Instant — no board target`],friendly:[`Target your piece`],enemy:[`Target enemy piece`],empty:[`Target empty dark square`],f_empty:[`Your piece, then destination`],f_f:[`Two friendly pieces`],f_e:[`Your piece, then enemy`],f_e_adj:[`Your piece, then adjacent enemy`],diagonal:[`Your piece, then diagonal strike`],discard_pick:[`Choose a card to discard`],e_e:[`Two enemy pieces`],column:[`Pick a board file (a–h)`]};function Pr(e){let t=[];return Mr[e.effect]?t.push(...Mr[e.effect]):e.desc&&t.push(e.desc),Nr[e.mode]&&t.push(...Nr[e.mode]),(e.rarity===`epic`||e.rarity===`legendary`)&&t.push(`${e.rarity.charAt(0).toUpperCase()+e.rarity.slice(1)} spell`),[...new Set(t)]}function Fr(e){return Pr(e).join(` · `)}var A=70,j=60,Ir=A/64,Lr=j/64;function Rr(e){return`<g transform="scale(${Ir}, ${Lr})">${e}</g>`}function zr(e){return`<g class="card-motif" opacity="0.98">${e}</g>`}function Br(e,t,n=5,r=.88){return`<circle cx="${e}" cy="${t}" r="${n}" fill="currentColor" opacity="${r}" stroke="#0f172a" stroke-width="0.8"/>`}function Vr(e,t,n=4){return`<circle cx="${e}" cy="${t}" r="${n}" fill="none" stroke="currentColor" stroke-width="1.6" stroke-dasharray="3 2" opacity="0.5"/>
    <ellipse cx="${e}" cy="${t+n*.5}" rx="${n*.8}" ry="${n*.3}" fill="currentColor" opacity="0.12"/>`}function Hr(e,t,n=6){return`<path d="M${e-n} ${t-n} L${e+n} ${t+n} M${e+n} ${t-n} L${e-n} ${t+n}" stroke="#0f172a" stroke-width="3.6" stroke-linecap="round" opacity="0.4"/>
    <path d="M${e-n} ${t-n} L${e+n} ${t+n} M${e+n} ${t-n} L${e-n} ${t+n}" stroke="currentColor" stroke-width="2.6" stroke-linecap="round"/>`}function Ur(e,t,n=5){return`<ellipse cx="${e}" cy="${t+n*.55}" rx="${n*1.1}" ry="${n*.35}" fill="#000" opacity="0.28"/>
  ...
  <ellipse cx="${e-n*.28}" cy="${t-n*.32}" rx="${n*.42}" ry="${n*.28}" fill="#fca5a5" opacity="0.55"/>
    ...
    <ellipse cx="${e}" cy="${t}" rx="${n}" ry="${r}" fill="#000" opacity="0.32"/>`}function P(e,t=`#e2e8f0`,n=.55){return e.map(([e,r,i=1])=>{let a=i*2.2;return`<path d="M${e} ${r-a} L${e+a*.3} ${r-a*.3} L${e+a} ${r} L${e+a*.3} ${r+a*.3} L${e} ${r+a} L${e-a*.3} ${r+a*.3} L${e-a} ${r} L${e-a*.3} ${r-a*.3} Z" fill="${t}" opacity="${n}"/>`}).join(``)}function F(e,t,n=5.5){return`${Yr(e,t,n)}
    ...
    <circle cx="${e}" cy="${t}" r="${n+4.5}" fill="none" stroke="#93c5fd" stroke-width="0.7" opacity="0.15"/>`}function I(e,t,n=5.5){return`${Ur(e,t,n)}
    ...
    <path d="M${n} ${r} L${n-l*7+d*4} ${r-u*7+f*4} M${n} ${r} L${n-l*7-d*4} ${r-u*7-f*4}" stroke="${i}" stroke-width="${a}" fill="none" stroke-linecap="round"/>`}function Wr(e,t,n,r,i=`#93c5fd`,a=2){let o=(e+n)/2,s=(t+r)/2-8;return`<path d="M${e} ${t} Q${o} ${s} ${n} ${r}" stroke="#0f172a" stroke-width="${a+2.4}" fill="none" opacity="0.22"/>
    <path d="M${e} ${t} Q${o} ${s} ${n} ${r}" stroke="${i}" stroke-width="${a+1}" fill="none" opacity="0.28"/>
    <path d="M${e} ${t} Q${o} ${s} ${n} ${r}" stroke="${i}" stroke-width="${a}" fill="none" stroke-linecap="round"/>`}function Gr(e,t,n=`#60a5fa`,r=`#93c5fd`,i=``){let a=i?` filter="url(#${i})"`:``;return`<path d="M${e} ${t-14} L${e+11} ${t-6} L${e+11} ${t+8} C${e+11} ${t+16} ${e} ${t+22} ${e} ${t+22} C${e} ${t+22} ${e-11} ${t+16} ${e-11} ${t+8} L${e-11} ${t-6} Z" fill="${n}" opacity="0.48" stroke="#0f172a" stroke-width="2.2"${a}/>
    ...
    <path d="M${e-2} ${t-8} L${e+3} ${t-3}" stroke="#fff" stroke-width="1.2" opacity="0.35" stroke-linecap="round"/>`}function Kr(e,t,n=28,r=!0){return`<rect x="${e-n/2}" y="${t-n/2}" width="${n}" height="${n}" rx="3" fill="#1c1917" opacity="0.65" stroke="#57534e" stroke-width="1.6"/>
    ...
    <rect x="${e-n/2+2}" y="${t-n/2+2}" width="${n-4}" height="${n-4}" rx="1" fill="none" stroke="#78716c" stroke-width="0.9" opacity="0.35"/>`}function qr(e,t,n=5,r=`#c4b5fd`){return`<circle cx="${e}" cy="${t}" r="${n+5}" fill="${r}" opacity="0.1"/>
    <circle cx="${e}" cy="${t}" r="${n+2}" fill="none" stroke="${r}" stroke-width="0.8" opacity="0.35"/>
    <path d="M${e} ${t-n} L${e+n*.6} ${t-n*.2} L${e+n} ${t+n*.4} L${e+n*.3} ${t+n} L${e-n*.3} ${t+n} L${e-n} ${t+n*.4} L${e-n*.6} ${t-n*.2} Z" fill="none" stroke="${r}" stroke-width="1.4" opacity="0.72"/>`}function Jr(e,t,n,r){let i=`lg-${e}`;return`<defs>
  ...
  ${Rr(r)}`}function z(e,t,n,r){let i=`cm-${e}`,a=`cm-vig-${e}`;return`<defs>
  ...
  <g filter="url(#${i}-glow)">${Rr(r)}</g>`}function B(e,t,n,r){let i=`uc-${e}`,a=`uc-vig-${e}`;return`<defs>
  ...
  <rect width="${A}" height="${j}" fill="url(#${a})"/>
  <g filter="url(#${i}-glow)">${Rr(r)}</g>`}function V(e,t,n,r){let i=`ra-${e}`,a=`ra-vig-${e}`;return`<defs>
  ...
  <rect width="${A}" height="${j}" fill="url(#${a})"/>
  <g filter="url(#${i}-glow)">${Rr(r)}</g>`}function H(e,t,n,r){let i=`ep-${e}`;return`<defs>
  ...
  <rect width="${A}" height="${j}" fill="url(#${i})"/>
  ${Rr(r)}`}function Yr(e,t,n=5){return`<ellipse cx="${e}" cy="${t+n*.55}" rx="${n*1.1}" ry="${n*.35}" fill="#000" opacity="0.28"/>
    ...
    <path d="M${e-n*.35} ${t+n*.15} Q${e} ${t+n*.45} ${e+n*.35} ${t+n*.15}" fill="none" stroke="#1e40af" stroke-width="1.2" opacity="0.45"/>`}var Xr=new Set(`nudge.backstep.retreat_3.anchor_2.recall.repel.leapfrog.random_teleport.rally.coin_flip.ignore.iron_will.demote.quicksand.create_foe.barrier.panic.swap_friendly.sidestep.press.shield_1.snowball.long_step.shield_2.poison_3.deflect_1.forward_bolt.crown.blink_2.landmine.reverse_only_2.root_2.sacrifice.scatter.mass_nudge.sanctuary_pulse.last_stand.martyr.cryo_bolt.collapse.last_king.snipe.dominion.toll.backstab.bomb.berserk.bounty.chain_lightning.clone.confusion.extract.constitution.counterspell.cull.deep_freeze.deport.destroy_unshielded.duel.earthquake.execution.hostile_swap.link_fate.magnet.mind_control.zombify.purify.defuse.pyromancy.quick_march.revive.shockwave.plague.bishop_2.rook_2.offering.mulligan.conjure.tangle.call_forward.dash.blizzard.bulwark.darkness.fortify.hibernation.vengeance.sanctuary.fusion.chameleon.blind.trickster.displacement`.split(`.`));function Zr(e){return Xr.has(e)}function Qr(){return`${N(32,54,20,4)}
    ...
    <path d="M14 20 L18 16 M50 18 L54 14" stroke="#fca5a5" stroke-width="1.4" stroke-linecap="round" opacity="0.55"/>`}function $r(){return`${N(32,56,20,4)}
    ...
    <circle cx="14" cy="14" r="2" fill="#fbbf24" opacity="0.6"/><circle cx="54" cy="16" r="1.5" fill="#fde68a" opacity="0.5"/>`}function ei(){return`${N(32,56,24,5)}
    ...
    ${P([[48,8,.8],[10,10,.7],[56,20,.9],[6,24,.6]],`#e0f2fe`,.7)}`}function ti(){return`${N(32,54,18,4)}
    ...
    <path d="M10 24 L14 28 L8 32 M54 26 L50 30 L56 34" stroke="#a5b4fc" stroke-width="1.4" fill="none" opacity="0.7"/>`}function ni(){return`${N(32,54,18,4)}
    ...
    ${P([[16,12,.7],[52,14,.8],[44,8,.6]],`#fde68a`,.65)}`}function ri(){return`${N(32,54,22,4)}
    ...
    ${P([[20,10,.9],[44,12,.8],[32,6,1.1],[14,24,.7],[50,22,.7]],`#bbf7d0`,.65)}`}function ii(){return`${N(32,56,24,5)}
  ...
  <path d="M14 54 L18 50 M50 54 L46 50 M54 14 L50 18 M10 14 L14 18" stroke="#d6d3d1" stroke-width="1.8" stroke-linecap="round" opacity="0.65"/>
    <path d="M8 32 L14 32 M50 32 L56 32 M32 8 L32 14 M32 50 L32 56" stroke="#a8a29e" stroke-width="1.4" stroke-linecap="round" opacity="0.4"/>`}function ai(){return`${N(32,54,22,4)}
    ${I(46,28,5.5)} ${Hr(46,28,6)}
    ${F(18,46,5.5)}
    ...
    ${P([[34,14,.9],[40,20,.7],[28,18,.8]],`#fca5a5`,.6)}`}function oi(){return`${N(32,56,16,4)}
    ${I(32,52,6)}
    ...
    ${qr(50,10,4,`#e9d5ff`)}
    ${P([[12,6,.8],[48,8,1],[22,4,.7],[36,44,.9]],`#e9d5ff`,.65)}`}function si(){let e=(e,t,n)=>`<g transform="translate(${e}, 40) scale(${t?-1:1}, 1)">
    ...
    ${P([[32,24,1],[26,20,.7],[38,20,.7]],`#fde68a`,.7)}`}function ci(){return`${N(36,56,18,4)}
    ${I(42,52,6)}
    ...
    ${P([[38,38,.7],[46,46,.6]],`#fca5a5`,.55)}`}function li(){return`${N(32,54,22,4)}
    ...
    ${P([[34,36,.7],[38,44,.6],[32,22,.8]],`#fde68a`,.6)}`}function ui(){return`${N(32,54,20,4)}
    ${F(32,42,6)}
    ...
    ${P([[32,8,.8],[20,32,.6],[44,32,.6]],`#bae6fd`,.55)}`}function di(){return`${N(32,54,22,4)}
    ${F(32,36,6)}
    ...
    ${P([[32,14,.9],[8,36,.7],[56,36,.7]],`#e9d5ff`,.6)}`}function fi(){return`${N(32,54,22,4)}
    ${F(32,36,6)}
    ...
    ${P([[32,22,.85],[10,24,.6],[54,24,.6]],`#86efac`,.55)}`}function pi(){return`${N(32,54,22,4)}
    ${I(48,32,6)}
    ...
    ${P([[22,20,.8],[36,28,.7],[36,36,.7]],`#e9d5ff`,.6)}`}function mi(){return`${N(32,54,22,4)}
    ${I(48,34,6)}
    ...
    ${P([[24,18,.75],[36,30,.65],[40,38,.55]],`#86efac`,.55)}`}function hi(){return`${N(32,54,18,4)}
    ${I(32,36,6)}
    ...
    ${P([[16,20,.8],[48,38,.7],[32,10,.9]],`#e9d5ff`,.6)}`}function gi(){return`${N(32,54,22,4)}
    ...
    ${P([[30,6,.9],[12,18,.6],[50,36,.5]],`#e9d5ff`,.55)}`}function _i(){return`${N(32,54,20,4)}
    ...
    ${P([[14,14,.8],[48,16,.7],[32,8,.9]],`#e9d5ff`,.6)}`}function vi(){return`${N(32,54,22,4)}
    ${F(32,50,5)}
    ...
    ${P([[50,10,1],[12,52,.8],[40,20,.7]],`#e0f2fe`,.7)}`}function yi(){return`${N(32,54,22,4)}
    ...
    ${P([[20,12,.9],[44,12,.8],[32,4,1],[14,28,.7],[50,28,.7]],`#fff`,.55)}`}function xi(){return`${N(32,54,22,4)}
    ...
    ${M(32,28,10,`#bae6fd`,`#0284c7`)}
    ${P([[10,12,.8],[54,12,.8],[10,50,.8],[54,50,.8],[32,6,1]],`#fff`,.6)}`}function Si(){return`${N(32,56,18,4)}
    ...
    ${qr(32,36,4,`#e9d5ff`)}
    ${P([[32,28,.8],[32,44,.7]],`#e9d5ff`,.6)}`}function wi(){return`${N(32,54,20,4)}
    ${F(22,38,5.5)}
    ...
    ${P([[36,32,.7],[48,34,.6],[42,28,.8]],`#e9d5ff`,.55)}`}function Ti(){return`${N(32,56,18,4)}
    ${F(32,42,6)}
  ...
  ${Rr(`<ellipse cx="32" cy="56" rx="20" ry="4" fill="#000" opacity="0.35"/>
  ...
  ${Ur(14,50,3.2)}${Yr(50,50,3.2)}`)}`}function Di(){return`${N(24,54,20,4)}
    ${I(48,20,5.5)}
    ...
    ${P([[18,32,.8],[28,28,.6]],`#e9d5ff`,.55)}`}function Oi(){return`${N(32,54,22,4)}
    ...
    ${P([[12,18,.8],[50,8,.75],[32,44,.6]],`#e9d5ff`,.6)}`}function ki(){return`${N(32,54,22,4)}
    ...
    ${P([[18,8,.8],[46,6,.75],[32,30,.65],[24,48,.55]],`#e9d5ff`,.6)}`}function Ai(){return`${N(28,54,18,4)}
    ${F(22,44,5.5)}
    ...
    ${P([[30,8,.8],[52,6,.7],[24,28,.6]],`#e9d5ff`,.6)}`}function ji(){return`${N(32,52,22,4)}
    ...
    ${P([[32,34,.9],[16,14,.7],[48,14,.7]],`#e0f2fe`,.6)}`}function Mi(){return`${N(32,54,18,4)}
    ${F(32,48,5.5)}
    ...
    ${P([[12,18,.7],[52,18,.7],[32,36,.6]],`#e9d5ff`,.55)}`}function Ni(){return`${N(32,54,18,4)}
    ${F(32,48,5.5)}
    ...
    ${P([[32,6,.7],[4,44,.6],[60,44,.6]],`#e9d5ff`,.55)}`}function Pi(){return`${N(30,52,20,4)}
    ${I(46,20,5.5)}
    ...
    ${P([[36,26,.7],[22,38,.6]],`#fca5a5`,.5)}`}function Fi(){return`${N(30,54,18,4)}
    ${F(18,50,5)}
    ${I(44,28,5)}
    ...
    ${P([[38,34,.7]],`#e9d5ff`,.5)}`}function Ii(){return`${N(32,54,26,4)}
    ...
    ${P([[8,10,.8],[56,12,.9],[32,18,.7]],`#e0f2fe`,.65)}`}function Li(){return`${N(32,54,22,4)}
    ...
    ${Gr(32,34,`#7c3aed`,`#e9d5ff`)}
    ${P([[20,40,.7],[44,24,.7],[32,28,.8]],`#e9d5ff`,.55)}`}function Ri(){return`${N(32,54,24,4)}
    ...
    ${P([[16,10,.7],[48,10,.7],[10,32,.6],[54,32,.6]],`#c4b5fd`,.45)}`}function zi(){return`${N(32,56,16,4)}
    ${F(32,34,6)}
    ...
    ${Gr(32,30,`#7c3aed`,`#e9d5ff`)}
    <text x="18" y="54" font-size="7" fill="#ddd6fe" opacity="0.8" font-weight="700">HOLD</text>
    ${P([[32,12,.8],[12,34,.6],[52,34,.6]],`#e9d5ff`,.5)}`}function Bi(){return`${N(32,56,16,4)}
    ${F(32,38,6)}
    ...
    ${P([[32,4,.8],[18,8,.6],[46,8,.6]],`#fde68a`,.55)}`}function Vi(){return`${N(30,54,18,4)}
    ${F(28,36,6)}
    ...
    ${P([[32,8,.8],[14,28,.6],[50,28,.6]],`#e9d5ff`,.5)}`}function Ui(){return`${N(32,54,20,4)}
    ...
    <path d="M24 50 C30 44 34 44 40 50" stroke="#fde68a" stroke-width="2" fill="none" opacity="0.7"/>
    ${M(32,14,5,`#fde68a`,`#b45309`)}
    ${P([[24,36,.7],[40,36,.7],[32,8,.9]],`#fde68a`,.6)}`}function Wi(){return`${N(32,54,18,4)}
    ${F(32,34,6)}
    ...
    ${P([[32,12,.8],[8,34,.6],[56,34,.6]],`#e9d5ff`,.55)}`}function Gi(){return`${N(32,54,20,4)}
    ...
    ${P([[8,8,.7],[56,8,.7],[8,56,.7],[56,56,.7]],`#fde68a`,.6)}`}function qi(){return`${N(28,54,18,4)}
    ${F(18,44,5.5)}
    ${L(42,24,6,`#cbd5e1`)}
    ...
    ${P([[32,22,.6]],`#93c5fd`,.4)}`}function Xi(){return`${N(32,54,20,4)}
    ...
    ${P([[32,6,.7]],`#cbd5e1`,.4)}`}function Zi(){return`${N(32,54,22,4)}
    ${F(32,24,5.5)}
    ...
    ${P([[20,40,.5],[44,40,.5]],`#93c5fd`,.4)}`}function Qi(){return`${N(30,54,20,4)}
    ${F(20,36,5)}${I(40,36,5)}
    ${L(54,36,5,`#fca5a5`)}
    ...
    ${P([[48,32,.6]],`#fde68a`,.45)}`}function $i(){return`${N(28,54,20,4)}
    ...
    ${P([[30,14,.8],[20,38,.5]],`#bae6fd`,.5)}`}function ea(){return`${N(32,54,18,4)}
    ${F(32,40,5.5)}
    ...
    ${P([[24,12,.8],[48,20,.7],[32,6,.9]],`#e9d5ff`,.55)}`}function ta(){return`${N(32,54,22,4)}
    ...
    ${P([[32,10,.8],[16,40,.5],[48,40,.5]],`#93c5fd`,.45)}`}function na(){return`${N(32,54,16,4)}
    ${F(32,36,6)}
    ...
    ${P([[16,12,.6]],`#fca5a5`,.4)}`}function ra(){return`${N(32,54,18,4)}
    ${F(32,34,6)}
    ...
    ${P([[32,20,.7]],`#e2e8f0`,.4)}`}function ia(){return`${N(32,54,16,4)}
    ${I(32,40,6)}
    ...
    ${P([[24,4,.6],[40,4,.6]],`#fde68a`,.45)}`}function aa(){return`${N(32,54,18,4)}
    ${Kr(32,36,32)}
    ...
    ${P([[30,36,.5]],`#d6d3d1`,.35)}`}function oa(){return`${N(32,54,16,4)}
    ...
    ${P([[46,10,.7]],`#fca5a5`,.5)}`}function sa(){return`${N(32,54,16,4)}
    ...
    ${P([[32,20,.5],[32,40,.5]],`#cbd5e1`,.35)}`}function ca(){return`${N(32,54,16,4)}
    ${I(32,22,6)}
    ...
    ${P([[28,16,.6],[36,16,.6]],`#fca5a5`,.45)}`}function la(){return`${N(32,54,20,4)}
    ...
    ${qr(32,34,4,`#c4b5fd`)}
    ${P([[32,30,.7]],`#e9d5ff`,.45)}`}function ua(){return`${N(28,54,18,4)}
    ${F(12,34,5.5)}
    ${L(50,34,6,`#cbd5e1`)}
    ...
    ${P([[46,30,.6]],`#e2e8f0`,.4)}`}function da(){return`${N(32,54,18,4)}
    ${I(32,28,6)}
    ...
    ${M(32,52,5,`#fca5a5`,`#dc2626`)}`}function fa(){return`${N(32,56,16,4)}
    ${F(32,38,6)}
    ${Gr(32,30,`#60a5fa`,`#93c5fd`)}
    ...
    ${P([[32,18,.7],[20,32,.5],[44,32,.5]],`#bae6fd`,.4)}`}function pa(){return`${N(32,54,18,4)}
    ${F(32,36,6)}
    ...
    ${P([[14,10,.7],[20,22,.5]],`#e0f2fe`,.5)}`}function ma(){return`${N(30,54,20,4)}
    ${F(14,50,5.5)}
    ${L(50,14,6,`#7dd3fc`)}
    ...
    ${P([[48,12,.7],[24,38,.5]],`#bae6fd`,.45)}`}function ha(){return`${N(32,56,16,4)}
    ${F(32,38,6)}
    ${Gr(32,28,`#38bdf8`,`#7dd3fc`)}
    ...
    ${P([[32,14,.8],[14,34,.5],[50,34,.5]],`#bae6fd`,.45)}`}function ga(){return`${N(32,54,16,4)}
    ${I(32,34,6)}
    ...
    ${P([[32,10,.7],[28,44,.5],[36,44,.5]],`#86efac`,.45)}`}function _a(){return`${N(26,54,16,4)}
    ${F(24,38,5.5)}
    ...
    ${P([[48,10,.6]],`#fde68a`,.45)}`}function va(){return`${N(30,54,18,4)}
    ...
    ${P([[42,20,.7]],`#fde68a`,.5)}`}function ya(){return`${N(32,56,16,4)}
    ${F(32,40,6)}
    ...
    ${P([[22,4,.7],[32,0,.8],[42,4,.7]],`#fde68a`,.6)}`}function ba(){return`${N(30,54,20,4)}
    ...
    ${P([[46,12,.8],[24,40,.5]],`#e0f2fe`,.5)}`}function xa(){return`${N(32,54,16,4)}
    ${Kr(32,36,32)}
    ...
    ${P([[32,24,.6]],`#fca5a5`,.4)}`}function Sa(){return`${N(32,54,18,4)}
    ${I(32,20,6)}
    ...
    ${P([[32,44,.5]],`#fca5a5`,.4)}`}function Ca(){return`${N(32,54,16,4)}
    ${I(32,24,6)}
  ...
  <path d="M28 48 L24 54 M36 48 L40 54" stroke="#86efac" stroke-width="1.4" stroke-linecap="round" opacity="0.35"/>
    ${P([[20,40,.5],[44,40,.5]],`#86efac`,.4)}`}function wa(){return`${N(30,54,20,4)}
    ...
    ${M(48,22,5,`#ef4444`,`#991b1b`)}`}function Ta(){return`${N(32,54,18,4)}
    ...
    ${P([[32,8,.6],[56,32,.6],[32,56,.6],[8,32,.6]],`#bae6fd`,.4)}`}function Ea(){return`${N(26,54,20,4)}
    ...
    ${P([[8,20,.6],[42,20,.6]],`#bae6fd`,.4)}`}function Da(){return`${N(32,54,22,4)}
    ...
    ${P([[44,10,.75],[30,28,.55],[20,46,.5]],`#e9d5ff`,.5)}`}function Oa(){return`${N(32,54,24,4)}
    ...
    ${P([[32,28,.7],[12,38,.5],[52,38,.5]],`#bae6fd`,.45)}`}function ka(){return`${N(32,56,14,3)}
    ${F(32,34,6)}
    ${Gr(32,28,`#38bdf8`,`#7dd3fc`)}
    ...
    <text x="10" y="18" font-size="6" fill="#e9d5ff" opacity="0.55">?</text>`}function Aa(){return`${N(30,56,16,3.5)}
    ${F(24,40,5.5)}
    ...
    ${P([[30,12,.7],[50,10,.6]],`#fecaca`,.55)}`}function ja(){return`${N(30,54,18,3.5)}
    ...
    ${Gr(32,34,`#38bdf8`,`#7dd3fc`)}
    <circle cx="32" cy="12" r="4" fill="#fde68a" opacity="0.3"/>`}function Pa(){return`${N(32,54,20,4)}
    ...
    <path d="M18 44 L22 40 M46 18 L50 14" stroke="#fbbf24" stroke-width="1.2" stroke-linecap="round" opacity="0.45"/>`}function Fa(){return`${N(32,54,18,3.5)}
    ...
    <circle cx="32" cy="40" r="14" fill="none" stroke="#60a5fa" stroke-width="0.8" opacity="0.2"/>`}function Ia(){return`${N(32,54,20,4)}
    ...
    ${P([[22,16,.75],[44,14,.7],[32,44,.55]],`#fde68a`,.55)}`}var La={nudge:()=>z(`nu`,`#94a3b8`,`#1e293b`,qi()),backstep:()=>z(`bs`,`#9ca3af`,`#1f2937`,Ji()),retreat_3:()=>z(`ret`,`#93c5fd`,`#1e3a5f`,Yi()),leapfrog:()=>z(`lf`,`#94a3b8`,`#1e293b`,$i()),long_step:()=>B(`ls`,`#7dd3fc`,`#1e3a5f`,ma()),sidestep:()=>z(`ss`,`#9ca3af`,`#1f2937`,ua()),blink_2:()=>B(`bl`,`#38bdf8`,`#0c4a6e`,ba()),random_teleport:()=>z(`rtp`,`#a78bfa`,`#312e81`,ea()),recall:()=>z(`rc`,`#93c5fd`,`#1e3a5f`,Zi()),repel:()=>z(`rp`,`#94a3b8`,`#1e293b`,Qi()),mass_nudge:()=>B(`mn`,`#7dd3fc`,`#1e3a5f`,Ea()),displacement:()=>V(`dp`,`#b794f4`,`#553c7a`,Da()),swap_friendly:()=>z(`sw`,`#a78bfa`,`#312e81`,la()),dominion:()=>B(`dm`,`#60a5fa`,`#1e3a5f`,Fa()),toll:()=>B(`tl`,`#fbbf24`,`#1e3a5f`,Ia()),shield_1:()=>z(`s1`,`#60a5fa`,`#1e3a5f`,fa()),shield_2:()=>B(`s2`,`#38bdf8`,`#0c4a6e`,ha()),bulwark:()=>V(`bw`,`#b794f4`,`#553c7a`,Li()),barrier:()=>z(`br`,`#94a3b8`,`#1f2937`,sa()),last_stand:()=>V(`ls`,`#38bdf8`,`#0c4a6e`,ka()),martyr:()=>H(`my`,`#fca5a5`,`#4c0519`,Aa()),fortify:()=>B(`fo`,`#a78bfa`,`#4c1d95`,zi()),sanctuary_pulse:()=>B(`sp`,`#7dd3fc`,`#1e3a5f`,Oa()),sanctuary:()=>V(`sa`,`#c4b5fd`,`#4c1d95`,Hi()),deflect_1:()=>B(`df`,`#38bdf8`,`#0c4a6e`,_a()),anchor_2:()=>z(`an`,`#94a3b8`,`#1f2937`,Xi()),iron_will:()=>z(`iw`,`#9ca3af`,`#1f2937`,ra()),vengeance:()=>V(`vg`,`#9f7aea`,`#3b0764`,Vi()),rally:()=>z(`rl`,`#60a5fa`,`#1e3a5f`,ta()),forward_bolt:()=>B(`fb`,`#fde68a`,`#1e3a5f`,va()),destroy_unshielded:()=>Jr(`sh`,`#4338ca`,`#1e1b4b`,ti()),pyromancy:()=>Jr(`py`,`#ea580c`,`#431407`,ni()),snipe:()=>B(`sn`,`#fde68a`,`#1e3a5f`,Pa()),duel:()=>z(`du`,`#d4b896`,`#3d2817`,si()),sacrifice:()=>B(`sc`,`#fca5a5`,`#1e3a5f`,wa()),cull:()=>H(`cu`,`#a78bfa`,`#2e1065`,oi()),execution:()=>V(`ex`,`#6ee7b7`,`#14532d`,ci()),chain_lightning:()=>Jr(`cl`,`#2563eb`,`#0c1929`,ei()),backstab:()=>B(`bk`,`#c4a574`,`#2d4a6e`,Qr()),cryo_bolt:()=>B(`cb`,`#7dd3fc`,`#0c4a6e`,ja()),bomb:()=>Jr(`bm`,`#f59e0b`,`#78350f`,$r()),shockwave:()=>H(`sw`,`#c4b5fd`,`#3b1f6e`,di()),plague:()=>H(`pg`,`#86efac`,`#14532d`,fi()),magnet:()=>V(`mg`,`#6ee7b7`,`#14532d`,li()),poison_3:()=>B(`po`,`#86efac`,`#14532d`,ga()),root_2:()=>B(`ro`,`#86efac`,`#14532d`,Ca()),panic:()=>z(`pn`,`#fca5a5`,`#1f2937`,ca()),blizzard:()=>V(`bz`,`#7dd3fc`,`#1e3a5f`,Ii()),snowball:()=>z(`sb`,`#bae6fd`,`#0c4a6e`,pa()),berserk:()=>Jr(`bk`,`#991b1b`,`#450a0a`,ai()),create_foe:()=>z(`cf`,`#78716c`,`#292524`,oa()),deep_freeze:()=>H(`df`,`#7dd3fc`,`#0c4a6e`,vi()),reverse_only_2:()=>B(`rv`,`#fca5a5`,`#1e3a5f`,Sa()),press:()=>z(`pr`,`#fca5a5`,`#1f2937`,da()),tangle:()=>V(`tg`,`#93c5fd`,`#312e81`,ji()),blind:()=>V(`bl`,`#a78bfa`,`#4c1d95`,Gi()),confusion:()=>H(`cf`,`#c4b5fd`,`#4c1d95`,hi()),extract:()=>V(`ex`,`#c4b5fd`,`#4c1d95`,gi()),fog_2:()=>zr(`${Br(32,34,6)}<ellipse cx="32" cy="24" rx="16" ry="8" fill="currentColor" opacity="0.22"/>`),crown:()=>B(`cr`,`#fbbf24`,`#451a03`,ya()),demote:()=>z(`dm`,`#fca5a5`,`#1f2937`,ia()),fusion:()=>V(`fu`,`#8b5cf6`,`#4c1d95`,Ui()),clone:()=>H(`cln`,`#93c5fd`,`#312e81`,wi()),chameleon:()=>V(`ch`,`#86efac`,`#312e81`,Wi()),hibernation:()=>H(`hi`,`#c4b5fd`,`#4c1d95`,Bi()),quicksand:()=>z(`qs`,`#a8a29e`,`#292524`,aa()),landmine:()=>B(`lm`,`#78716c`,`#292524`,xa()),collapse:()=>z(`co`,`#78716c`,`#292524`,Ma()),darkness:()=>V(`dk`,`#6d28d9`,`#1e1b4b`,Ri()),scatter:()=>B(`st`,`#7dd3fc`,`#1e3a5f`,Ta()),call_forward:()=>H(`cfw`,`#fca5a5`,`#4c1d95`,Pi()),dash:()=>V(`ds`,`#c4b5fd`,`#4c1d95`,Fi()),earthquake:()=>H(`eq`,`#78716c`,`#292524`,ii()),coin_flip:()=>Ei(),ignore:()=>z(`ig`,`#94a3b8`,`#1f2937`,na()),counterspell:()=>H(`cs`,`#a78bfa`,`#2e1065`,_i()),purify:()=>B(`pu`,`#6ee7b7`,`#14532d`,bi()),defuse:()=>B(`df`,`#7dd3fc`,`#0c4a6e`,xi()),trickster:()=>V(`tr`,`#c4b5fd`,`#553c7a`,Ki()),offering:()=>V(`of`,`#d8b4fe`,`#553c7a`,Ai()),mulligan:()=>V(`mu`,`#c4b5fd`,`#4c1d95`,Oi()),conjure:()=>H(`cj`,`#c4b5fd`,`#3b0764`,ki()),quick_march:()=>H(`qm`,`#60a5fa`,`#1e3a5f`,ui()),constitution:()=>H(`co`,`#4ade80`,`#14532d`,Ti()),last_king:()=>B(`lk`,`#fbbf24`,`#1e3a5f`,Na()),revive:()=>Jr(`rv`,`#15803d`,`#052e16`,ri()),mind_control:()=>H(`mc`,`#c4b5fd`,`#3b0764`,pi()),zombify:()=>Jr(`zb`,`#4ade80`,`#14532d`,mi()),bounty:()=>H(`bo`,`#4ade80`,`#14532d`,Si()),link_fate:()=>H(`lf`,`#a78bfa`,`#2e1065`,Ci()),bishop_2:()=>B(`bp`,`#b794f4`,`#4c1d95`,Mi()),rook_2:()=>B(`rk`,`#a78bfa`,`#4c1d95`,Ni()),hostile_swap:()=>H(`hs`,`#93c5fd`,`#312e81`,yi()),deport:()=>V(`dp`,`#c4b5fd`,`#1e1b4b`,Di())};function Ra(e,t=0){let n=La[e.effect];return n?n(t):null}var za={movement:{symbol:`↗`,label:`Motion`,anim:`movement`},combat:{symbol:`⚔`,label:`Strike`,anim:`combat`},defense:{symbol:`🛡`,label:`Ward`,anim:`defense`},debuff:{symbol:`❄`,label:`Curse`,anim:`debuff`},transform:{symbol:`✦`,label:`Morph`,anim:`transform`},board:{symbol:`◇`,label:`Terrain`,anim:`board`},crown:{symbol:`♔`,label:`Royal`,anim:`crown`},arcane:{symbol:`✧`,label:`Arcane`,anim:`arcane`}},Ba=[[`movement`,[`nudge`,`backstep`,`long_step`,`leapfrog`,`recall`,`teleport`,`random_teleport`,`displacement`,`berserk`,`dash`]],[`combat`,[`stab`,`shatter`,`destroy`,`snipe`,`duel`,`execution`,`cull`,`pyromancy`,`backstab`,`sacrifice`,`chain_lightning`,`cryo`,`bomb`,`magnet`]],[`special`,[`create_foe`,`clone`,`earthquake`]],[`defense`,[`shield`,`ward`,`aegis`,`bulwark`,`stall`,`sanctuary`,`barrier`,`anchor`,`iron_will`,`hibernation`,`constitution`]],[`debuff`,[`root`,`panic`,`backpedal`,`blizzard`,`deep_freeze`,`snowball`,`blind`,`confusion`,`extract`,`press`,`tangle`,`shockwave`]],[`board`,[`quicksand`,`landmine`,`collapse`,`darkness`,`earthquake`,`scatter`,`call_forward`]],[`meta`,[`counterspell`,`vengeance`,`last_stand`,`martyr`,`purify`,`defuse`,`trickster`,`ignore`,`offering`,`mulligan`,`conjure`,`quick_march`,`dominion`,`toll`,`last_king`,`revive`,`mind_control`,`zombify`]]];function Va(e){let t=0;for(let n=0;n<e.length;n++)t=(t+e.charCodeAt(n)*41)%360;return t}function Ha(e){let t=0;for(let n=0;n<e.length;n++)t=(t+e.charCodeAt(n)*13)%3;return t}function Ua(e){let t=`${e.id} ${e.effect} ${e.name}`.toLowerCase();for(let[e,n]of Ba)if(Array.isArray(n)&&n.some(e=>t.includes(e)))return e;return`arcane`}function Wa(e){return`ca${String(e).replace(/[^a-zA-Z0-9]/g,``)}`}function Ga(e,t,n){let r=[[12,18,.35],[48,12,.5],[52,44,.25],[18,50,.4],[38,28,.55]],i=n*4;return r.map(([e,n,r],a)=>`<circle cx="${(e+i+a*7)%56+4}" cy="${(n+i*2+a*5)%52+6}" r="1.2" fill="hsl(${t} 90% 85% / ${r})"/>`).join(``)}function Ka(e,t){let n=t,r={movement:`
      ...
      </g>`};return r[e]||r.arcane}function qa(e,t,n,r){return Ja(e,t,n,r)}function Ja(e,t,n,r){let i=Wa(n),a=(t+42)%360,o=Ha(n),s=r&&Ra(r,o)||Ka(e,o);return r?.effect&&Zr(r.effect)&&s?`<svg class="spell-card__svg spell-card__svg--full-bleed" viewBox="0 0 70 60" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid meet">${s}</svg>`:`<svg class="spell-card__svg" viewBox="0 0 70 60" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
  ...
  `,t.onClick&&l.addEventListener(`click`,n=>t.onClick(n,e)),Qa(l),l}function eo(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function to(e){return document.getElementById(e)}function no(){let e=to(`card-preview-modal`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function ro(e){document.body.classList.toggle(`card-preview-open`,e),window.dispatchEvent(new CustomEvent(`card-preview-change`,{detail:{open:e}}))}function io(){to(`card-preview-modal`)?.classList.add(`hidden`),to(`card-preview-mount`)?.classList.remove(`card-preview-mount--reveal-only`),ro(!1);let e=window.scrollY||document.documentElement.scrollTop||0;window.scrollTo(0,e),document.documentElement.scrollLeft=0,document.body.scrollLeft=0,document.querySelector(`.game-main`)?.scrollTo?.(0,document.querySelector(`.game-main`)?.scrollTop??0)}function ao(e,t={}){no();let n=to(`card-preview-modal`),r=to(`card-preview-mount`),i=to(`card-preview-actions`);if(!(!n||!r||!e)){if(r.innerHTML=``,r.classList.toggle(`card-preview-mount--reveal-only`,!!t.hideDesc),r.appendChild($a(e,{static:!0,hideDesc:t.hideDesc})),i){if(i.innerHTML=``,t.meta){let e=document.createElement(`p`);e.className=`card-preview-meta`,e.textContent=t.meta,i.appendChild(e)}let e=document.createElement(`div`);if(e.className=`card-preview-actions-row`,t.onPlay){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=`Cast spell`,n.addEventListener(`click`,()=>{io(),t.onPlay()}),e.appendChild(n)}if(t.onAdd){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=`Add to deck`,n.disabled=!!t.addDisabled,n.addEventListener(`click`,()=>{t.addDisabled||t.onAdd()}),e.appendChild(n)}if(t.onBuy){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=t.buyLabel||`Buy copy`,n.disabled=!!t.buyDisabled,n.addEventListener(`click`,()=>{t.buyDisabled||t.onBuy()}),e.appendChild(n)}if(t.onRemove){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-secondary`,n.textContent=`Remove all from deck`,n.addEventListener(`click`,()=>{t.onRemove(),io()}),e.appendChild(n)}e.children.length&&i.appendChild(e)}n.classList.remove(`hidden`),ro(!0)}}function oo(){to(`card-preview-close`)?.addEventListener(`click`,io),to(`card-preview-backdrop`)?.addEventListener(`click`,io),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&io()})}function so(e,t=`.spell-card`){e&&e.querySelectorAll(t).forEach((e,t)=>{e.classList.add(`spell-card--deal`),e.style.animationDelay=`${t*.1}s`})}function co(e){e&&(e.classList.add(`spell-card--rare-burst`),setTimeout(()=>e.classList.remove(`spell-card--rare-burst`),900))}function lo(e){e&&(e.classList.add(`spell-card--epic-burst`),setTimeout(()=>e.classList.remove(`spell-card--epic-burst`),1200))}function uo(e){e&&(e.classList.add(`spell-card--legendary-burst`),setTimeout(()=>e.classList.remove(`spell-card--legendary-burst`),1500))}function fo(e,t){t===`legendary`?uo(e):t===`epic`?lo(e):t===`rare`&&co(e)}var po={common:10,uncommon:20,rare:30,epic:40,legendary:50};function mo(e){return po[e]??30}function ho(e,r){let i=ae(e,r);if(i<1)return{success:!1,message:`Get this spell from a chest first.`};let a=n(r);if(!a)return{success:!1,message:`Unknown card.`};let o=t(r);if(i>=o)return{success:!1,message:`You already own the maximum (${o} copies).`};let s=mo(a.rarity);if(e.gems<s)return{success:!1,message:`Need ${s} gems (${e.gems} available).`};e.gems-=s;let c=ve(e,r,1);return c?{success:!0,cost:s,message:`+1 ${a.name} for ${s} gems (${i+c} owned).`}:(e.gems+=s,T(e),{success:!1,message:`You already own the maximum copies for this rarity.`})}var go={deck:`<svg class="nav-icon-svg" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    </div>`,t.style.animationDelay=`0s`,t}function gs(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function _s(e,t=``){let n=f(e),r=(t||`P`).charAt(0).toUpperCase(),i=ss(n.equipped.avatar)||`<span class="profile-avatar-fallback">${gs(r)}</span>`;return`<span class="profile-avatar-stack header-profile-btn__stack ${ds(n.equipped.frame)}"><span class="profile-avatar-inner header-profile-btn__inner">${i}</span></span>`}async function vs(e){if(!e)return``;try{return(await ke(e.id))?.username||e.user_metadata?.display_name||e.email?.split(`@`)[0]||``}catch{return e.user_metadata?.display_name||e.email?.split(`@`)[0]||``}}var ys=null;function bs(){return ys||=Promise.all([D(()=>import(`./match-C2574e0E.js`),[],import.meta.url),D(()=>import(`./matchView-XVqlgu7z.js`),[],import.meta.url),D(()=>Promise.resolve({}),__vite__mapDeps([0]),import.meta.url),D(()=>Promise.resolve({}),__vite__mapDeps([1]),import.meta.url)]).then(([e,t])=>({MatchSession:e.MatchSession,getMatchHtml:t.getMatchHtml})),ys}var xs=null;function Ss(){return xs||=Promise.all([D(()=>import(`./pvpUI-BSIxpu_n.js`),[],import.meta.url),D(()=>import(`./pvp-BDiYH8PZ.js`),[],import.meta.url)]).then(([e,t])=>({initPvpUI:e.initPvpUI,clearAllWaitingRoomsOnce:t.clearAllWaitingRoomsOnce})),xs}var Cs=null;function ws(){return Cs||=D(()=>import(`./profileUI-CwrZeIkE.js`),[],import.meta.url),Cs}function Ts(){Cs=null}var Es=null;function Ds(){return Es||=Promise.all([D(()=>import(`./settingsUI-CotGsDnu.js`),[],import.meta.url),D(()=>Promise.resolve({}),__vite__mapDeps([2]),import.meta.url)]).then(([e])=>e),Es}var Os=null;function ks(){return Os||=Promise.all([D(()=>import(`./chestOpenAnimation-C_fFUNci.js`),[],import.meta.url),D(()=>import(`./cosmeticOpenAnimation-49iuqLp5.js`),[],import.meta.url),D(()=>import(`./titleOpenAnimation-BIOc-J_u.js`),[],import.meta.url)]).then(([e,t,n])=>({playChestOpenAnimation:e.playChestOpenAnimation,playCosmeticOpenAnimation:t.playCosmeticOpenAnimation,playTitleOpenAnimation:n.playTitleOpenAnimation})),Os}var As=null;function js(){return As||=D(()=>import(`./socialUI-C18joqiE.js`),[],import.meta.url),As}var Ms=null;function Ns(){return Ms||=D(()=>import(`./tutorialMeta-CtrLMmsK.js`),[],import.meta.url),Ms}var Ps=null;function Fs(){return Ps||=D(()=>import(`./tutorialUnlocks-nP5-ARSg.js`),[],import.meta.url),Ps}var Is=null;function Ls(){return Is||=D(()=>import(`./tutorialMatch-CbS1WJFS.js`),[],import.meta.url),Is}function Rs(e,t){Ns().then(n=>n.notifyMetaTutorial(e,t)).catch(e=>console.warn(`[Tutorial] meta notify failed`,e))}function zs(e,t){Fs().then(n=>n.notifyUnlockTutorial(e,t))}var W;try{W=E()}catch(e){console.error(`Failed to load profile, resetting save:`,e),localStorage.removeItem(`cardCheckersProfile_v7`),localStorage.removeItem(`cardCheckersProfile_v5`),W=E()}var G=`deck`,Bs={deck:`Decks`,chests:`Shop`,play:`Play`,social:`Social`,quests:`Quests`,profile:`Profile`,settings:`Settings`},Vs=new Set(Object.keys(Bs)),Hs=null,Us=null,Ws=!1,Gs=`cards`,Ks=`list`,K=null,q=[],qs=null,Js=``,Ys=`all`,Xs=`all`,Zs=!0,Qs={legendary:5,epic:4,rare:3,uncommon:2,common:1};function $s(e){return[...e].sort((e,t)=>{let n=Qs[e.rarity]??0,r=Qs[t.rarity]??0;return n===r?e.name.localeCompare(t.name):r-n})}var J=null,ec=null,tc=null,nc=null,rc=null;function ic(){return ec?Promise.resolve(ec):(tc||=Ss().then(({initPvpUI:e,clearAllWaitingRoomsOnce:t})=>(t(),ec=e({arenaRoot:document.getElementById(`play-arena-root`),leaderboardRoot:document.getElementById(`play-leaderboard-root`),getProfile:()=>W,openAuthModal:()=>sc?.open(`signin`,{forced:!0}),onNavigateTab:Z,onNavigatePlayTab:jc,onNavigatePlayMenu:Ac,onOpenDeckEdit:jl}),ec)),tc)}function ac(){return nc?Promise.resolve(nc):(rc||=js().then(({initSocialUI:e})=>(nc=e({root:document.getElementById(`view-social`),getProfile:()=>W,saveProfile:T,openAuthModal:()=>sc?.open(`signin`,{forced:!0})}),nc)),rc)}var oc=null,sc=null,Y=!1,cc=!1,lc=!1,uc=!1,dc=!1,fc=null,pc=null,mc=null,hc=1,gc=null;function _c(e){return Qs[e?.rarity]??0}function vc(e){let t=i(e);return Object.entries(t).map(([e,t])=>({def:n(e),count:t})).filter(e=>e.def).sort((e,t)=>{let n=_c(t.def)-_c(e.def);return n===0?e.def.name.localeCompare(t.def.name):n})}function yc(e){let t=q.indexOf(e);t<0||(q.splice(t,1),Fl(),Rs(`card-removed-from-deck`,{cardId:e}))}function bc(e){let t=q.length;q=q.filter(t=>t!==e),q.length!==t&&(Fl(),Rs(`card-removed-from-deck`,{cardId:e}))}function xc(){let n=e().map(e=>({def:e,owned:ae(W,e.id)})).filter(e=>e.owned>0).sort((e,t)=>{let n=_c(t.def)-_c(e.def);return n===0?e.def.name.localeCompare(t.def.name):n});q=[];for(let{def:e,owned:r}of n){let n=Math.min(r,t(e));for(let t=0;t<n&&q.length<30;t++)q.push(e.id);if(q.length>=30)break}Fl()}var X=e=>document.getElementById(e);function Sc(){let e=document.getElementById(`adventure-prebattle`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function Cc(){let e=document.querySelector(`nav.game-nav.tabs`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function wc(){return window.matchMedia(`(min-width: 1000px) and (max-width: 1400px)`).matches?2.5:window.matchMedia(`(min-width: 600px) and (max-width: 999px)`).matches?1.85:1}function Tc(){Sc(),document.getElementById(`adventure-prebattle`)?.classList.remove(`hidden`),document.body.classList.add(`adventure-floor-open`)}function Ec(){document.getElementById(`adventure-prebattle`)?.classList.add(`hidden`),document.body.classList.remove(`adventure-floor-open`)}function Dc(e=le,t=`Locked`){Kn({title:t,bodyHtml:e,autoCloseMs:4500})}function Oc(){document.body.classList.toggle(`main-tab-active`,Vs.has(G)),document.body.classList.toggle(`play-sub-active`,G===`play`&&Hs!==null),document.body.classList.toggle(`adventure-active`,G===`play`&&Hs===`adventure`)}function kc(){let e=d(W);for(let t of[`arena`,`leaderboard`]){let n=document.querySelector(`.play-tab[data-play-tab="${t}"]`);n&&(n.classList.toggle(`play-tab--locked`,!e),n.setAttribute(`aria-disabled`,e?`false`:`true`),n.title=e?``:m(`PvP`))}}function Ac(){Hs=null,X(`play-menu`)?.classList.remove(`hidden`),document.querySelectorAll(`.play-tab-panel`).forEach(e=>{e.classList.add(`hidden`),e.hidden=!0}),Oc(),kc()}async function jc(e){if(!Ws&&(e===`arena`||e===`leaderboard`)&&!d(W)){let e=en(),t=Qt;await et(e?`${m(`PvP`)}\n\n${t}.`:m(`PvP`),{title:`PvP locked`,confirmLabel:`Go to Adventure`,cancelLabel:e?`Sign in`:`Not now`})?(Ws=!0,jc(`adventure`),Ws=!1):e&&sc?.open(`signin`,{forced:!0});return}Hs=e,X(`play-menu`)?.classList.add(`hidden`),document.querySelectorAll(`.play-tab`).forEach(t=>{let n=t.dataset.playTab===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,n?`true`:`false`)}),document.querySelectorAll(`.play-tab-panel`).forEach(t=>{let n=t.id===`play-tab-${e}`;t.classList.toggle(`hidden`,!n),t.hidden=!n}),Oc(),zs(`play-tab-changed`,{tab:e}),e===`adventure`?Bl():e===`arena`?ic().then(e=>{e?.setScreen?.(`arena`),e?.render({resume:!0})}):e===`leaderboard`&&ic().then(e=>{e?.setScreen?.(`leaderboard`),e?.render()})}function Mc(e,t,n){let r=e.querySelector(`.tab-btn__sign-in-badge`);t?(r||(r=document.createElement(`span`),r.className=`tab-btn__sign-in-badge`,r.setAttribute(`aria-hidden`,`true`),e.appendChild(r)),r.textContent=n,e.classList.add(`tab-btn--sign-in-nudge`)):(r?.remove(),e.classList.remove(`tab-btn--sign-in-nudge`))}function Nc(){let e=d(W),t=en();kc();let n=document.querySelector(`.tab-btn[data-tab="quests"]`);if(n){let r=!e,i=$t;n.classList.toggle(`tab-btn--locked`,r),n.setAttribute(`aria-disabled`,r?`true`:`false`),r?(n.title=t?`${m(`Quests`)} ${i}.`:m(`Quests`),Mc(n,t,`Sign in`)):t?(n.title=i,Mc(n,!1)):(n.title=``,Mc(n,!1))}let r=document.querySelector(`.tab-btn[data-tab="social"]`);r&&(t?(r.title=$t,Mc(r,!0,`Sign in`)):(r.title=``,Mc(r,!1)));let i=c(W),a=document.querySelector(`.vault-tab[data-vault-tab="cosmetics"]`);a&&(a.classList.toggle(`vault-tab--locked`,!i),a.title=i?``:_e,a.setAttribute(`aria-disabled`,i?`false`:`true`))}async function Z(e){let t=document.getElementById(`view-match`);if(!(Y&&t&&!t.classList.contains(`hidden`))&&!(t&&!t.classList.contains(`hidden`)&&t.querySelector(`.pvp-loading`)&&e!==G)){if(!cc&&e===`quests`&&!d(W)){let e=en(),t=$t;await et(e?`${m(`Quests`)}\n\n${t}.`:m(`Quests`),{title:`Quests locked`,confirmLabel:`Go to Adventure`,cancelLabel:e?`Sign in`:`Not now`})?(cc=!0,Z(`play`),cc=!1):e&&sc?.open(`signin`,{forced:!0});return}if(lr(),er()&&nr()){if(e===G||t?.querySelector(`.pvp-loading`)||!await et(`Leave your current match to open ${Bs[e]||e}?`,{title:`Leave match?`,confirmLabel:`Leave`,cancelLabel:`Stay`,destructive:!0}))return;rr(e),e===`play`&&(Us=`arena`),or(),document.querySelector(`#btn-leave-match`)?.click();return}if(Ks===`edit`&&(e!==`deck`||e===`deck`&&G===`deck`)){if(!await kl())return;Al()}if(e!==`deck`&&Ks===`edit`&&(cl(),document.body.classList.remove(`deck-editing`)),G=e,Oc(),Vs.has(e)&&ol(),document.querySelectorAll(`.tab-btn`).forEach(t=>{t.classList.toggle(`active`,t.dataset.tab===e)}),document.querySelectorAll(`.view`).forEach(t=>{t.classList.toggle(`hidden`,t.id!==`view-${e}`)}),e===`chests`&&(vl(Gs),bl()),e===`deck`&&(Ks=`list`,ul(`list`)),e===`profile`&&zc(),e===`settings`&&Bc(),e===`quests`&&(Gc(),Yc()),e===`play`){let e=Us??Hs;Us=null,e?jc(e):Ac()}e===`social`&&(nc?nc.refresh?.()??nc.render():(qc(),ac().then(e=>e?.render()).catch(e=>{console.error(`[Social] init failed`,e),Jc()}))),Rs(`tab-changed`,{tab:e}),zs(`tab-changed`,{tab:e}),er()||(Io(`hub`),await Wo())}}var Q=``;function Pc(e=Q){e&&(Q=e);let t=document.getElementById(`header-profile-menu`),n=document.getElementById(`header-profile-btn`),r=document.getElementById(`header-username`),i=document.getElementById(`auth-header-btn`),a=!!O();if(i&&(i.classList.toggle(`hidden`,a),i.hidden=a),t&&(t.classList.toggle(`hidden`,!a),t.hidden=!a),r){let e=a&&Q;r.textContent=e?Q:``,r.classList.toggle(`hidden`,!e),r.hidden=!e}n&&a&&(n.innerHTML=_s(W,Q),n.title=Q?`Account — ${Q}`:`Account menu`)}function Fc(){let e=document.getElementById(`header-profile-btn`),t=document.getElementById(`header-profile-dropdown`);!e||!t||(t.classList.add(`hidden`),t.hidden=!0,e.setAttribute(`aria-expanded`,`false`))}function Ic(){let e=document.getElementById(`header-profile-menu`),t=document.getElementById(`header-profile-btn`),n=document.getElementById(`header-profile-dropdown`);if(!e||!t||!n)return;let r=e=>{n.classList.toggle(`hidden`,!e),n.hidden=!e,t.setAttribute(`aria-expanded`,e?`true`:`false`)};t.addEventListener(`click`,e=>{e.stopPropagation();let t=!n.hidden;r(!t)}),n.querySelectorAll(`[data-profile-menu-action]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.profileMenuAction;Fc(),t===`settings`?Z(`settings`):Rc()})}),document.addEventListener(`click`,t=>{n.hidden||e.contains(t.target)||Fc()}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&!n.hidden&&Fc()})}async function Lc(){let e=O();if(!e){Q=``,Pc();return}Q=await vs(e),Pc()}function Rc(){Fc(),Z(`profile`),zs(`profile-opened`)}async function zc(){let{renderProfileTab:e}=await ws(),t=X(`view-profile`);e(W,t,{onGemsChange:Xc,onTitleChanged:()=>Pc()})}async function Bc(){let{renderSettingsTab:e}=await Ds();e(X(`view-settings`),{onUsernameChanged:e=>{Q=e,Pc(e)}})}var Vc=`
  ...
  <section class="panel game-panel social-panel social-panel--error">
  ...
  </section>`;function Gc(){let e=X(`view-quests`);e&&(e.innerHTML=Vc)}function Kc(e=X(`view-quests`)){e&&(e.innerHTML=Hc,e.querySelector(`.quests-retry-btn`)?.addEventListener(`click`,()=>{Ts(),Gc(),Yc()}))}function qc(){let e=X(`view-social`);e&&(e.innerHTML=Uc)}function Jc(e=X(`view-social`)){e&&(e.innerHTML=Wc,e.querySelector(`.social-retry-btn`)?.addEventListener(`click`,()=>{nc=null,rc=null,qc(),ac().then(e=>e?.render()).catch(t=>{console.error(`[Social] retry failed`,t),Jc(e)})}))}async function Yc(){let e=X(`view-quests`);if(e)try{let{renderQuestsTab:t}=await ws();t(W,e,{onTitleChanged:()=>Pc(),onCurrencyChange:()=>$()})}catch(t){console.error(`[Quests] render failed`,t),Kc(e)}}function $(){let e=X(`header-gems`);e&&(e.textContent=String(W.gems??0));let t=X(`header-stars`);t&&(t.textContent=String(W.stars??0)),document.querySelector(`.hud-gems`)?.classList.toggle(`hud-gems--low`,(W.gems??0)<50),document.querySelector(`.hud-stars`)?.classList.toggle(`hud-stars--low`,(W.stars??0)<10)}function Xc(){$()}function Zc(){document.querySelectorAll(`.collection-owned-only-toggle`).forEach(e=>{e.checked=Zs});for(let e of[`collection-search`]){let t=X(e);t&&(t.value=Js)}for(let e of[`collection-rarity`]){let t=br(e);t&&(t.value=Ys)}let e=br(`collection-category`);e&&(e.value=Xs)}var Qc=`(max-width: 899px)`,$c=`(max-width: 1280px)`,el=null;function tl(){return window.matchMedia(Qc).matches}function nl(){return document.body.classList.contains(`main-tab-active`)&&!document.body.classList.contains(`match-active`)&&!document.body.classList.contains(`deck-editing`)&&window.matchMedia($c).matches}function rl(){return document.querySelector(`.game-main`)}function il(){let e=rl();return nl()&&e?e.scrollTop:window.scrollY||document.documentElement.scrollTop||0}function al(e){let t=rl();if(nl()&&t){t.scrollTop=e;return}window.scrollTo(0,e)}function ol(){let e=rl();if(nl()&&e){e.scrollTop=0;return}window.scrollTo(0,0)}function sl(){tl()&&(el=il(),document.body.style.position=`fixed`,document.body.style.top=`0`,document.body.style.left=`0`,document.body.style.right=`0`,document.body.style.width=`100%`)}function cl(){if(el==null)return;let e=el;el=null,document.body.style.position=``,document.body.style.top=``,document.body.style.left=``,document.body.style.right=``,document.body.style.width=``,al(e)}function ll(){ol(),document.documentElement.scrollTop=0,document.body.scrollTop=0,document.querySelector(`.game-shell`)?.scrollTo?.(0,0),rl()?.scrollTo?.(0,0),document.querySelector(`#view-deck`)?.scrollTo?.(0,0),document.querySelectorAll(`#deck-subview-edit, #deck-subview-edit .deck-editor, #deck-subview-edit .deck-editor__body, #deck-subview-edit .deck-editor__grid, #deck-subview-edit .deck-editor__grid-cards`).forEach(e=>{e.scrollTop=0})}function ul(e){e!==`edit`&&cl(),Ks=e,document.body.classList.toggle(`deck-editing`,e===`edit`),X(`deck-subview-list`)?.classList.toggle(`hidden`,e!==`list`),X(`deck-subview-edit`)?.classList.toggle(`hidden`,e!==`edit`),e===`edit`&&(sl(),w(W),T(W),Ys=`all`,Js=``,Xs=`all`,Zs=!0,Zc(),Dl()),e===`list`&&Pl(),e===`edit`&&(Fl(),ll(),requestAnimationFrame(()=>{ll(),requestAnimationFrame(ll)}))}function dl({id:e,title:t,desc:n,cost:r,variant:i=`mystery`}){let a=(W.stars??0)>=r,o=i===`title`?Vt():Ut();return`
    ...
    </article>`}function fl(e,t){e.querySelector(`[data-mystery-open]`)?.addEventListener(`click`,e=>{e.stopPropagation(),t()}),e.addEventListener(`click`,t),e.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),t())})}function pl({bonusGems:e=0,bonusStars:t=0}={}){let n=[];return e&&n.push(`+${e} gem refund`),t&&n.push(`+${t} ★ from duplicates`),n.length?` (${n.join(`, `)})`:``}async function ml(e,t){let{playChestOpenAnimation:n,playCosmeticOpenAnimation:r,playTitleOpenAnimation:i}=await ks();e.kind===`card`?(await n({tier:`silver`,tierLabel:`Mystery Box`,pulls:e.cardPulls}),t&&(t.textContent=`Got ${e.cardPulls.length} spells.${pl(e)}`)):e.kind===`cosmetic`?(await r({boxId:`silver`,boxLabel:`Mystery Box`,pulls:e.cosPulls}),t&&(t.textContent=e.message+pl(e))):e.kind===`mixed`?(e.cardPulls.length&&await n({tier:`silver`,tierLabel:`Mystery Box — Spells`,pulls:e.cardPulls}),e.cosPulls.length&&await r({boxId:`silver`,boxLabel:`Mystery Box — Cosmetics`,pulls:e.cosPulls}),t&&(t.textContent=`${e.message}${pl(e)}`)):e.kind===`title`&&(await i({boxLabel:`Title Box`,pulls:e.pulls}),t&&(t.textContent=e.message))}async function hl(){let e=X(`mystery-box-log`);if(!((W.stars??0)>=10)){e&&(e.textContent=`Need 10 ★ stars. Clear Adventure floors to earn stars.`,e.classList.add(`chest-log--error`));return}let t=Yt(W);if(!t.success){e&&(e.textContent=t.message,e.classList.add(`chest-log--error`));return}T(W),$(),e&&e.classList.remove(`chest-log--error`),X(`mystery-box-list`)?.querySelectorAll(`.mystery-box__btn`).forEach(e=>{e.disabled=!0});try{await ml(t,e)}catch(n){console.error(`Mystery box animation failed:`,n),e&&(e.textContent=t.message)}bl({clearPulls:!1}),zc()}async function gl(){let e=X(`mystery-box-log`);if(!((W.stars??0)>=10)){e&&(e.textContent=`Need 10 ★ stars. Clear Adventure floors to earn stars.`,e.classList.add(`chest-log--error`));return}let t=Xt(W);if(!t.success){e&&(e.textContent=t.message,e.classList.add(`chest-log--error`));return}T(W),$(),e&&e.classList.remove(`chest-log--error`),X(`mystery-box-list`)?.querySelectorAll(`.mystery-box__btn`).forEach(e=>{e.disabled=!0});try{await ml(t,e)}catch(n){console.error(`Title box animation failed:`,n),e&&(e.textContent=t.message)}bl({clearPulls:!1}),zc()}function _l(){let e=X(`mystery-box-list`);if(!e)return;e.innerHTML=`
    ${dl({id:`mystery`,title:`Mystery Box`,desc:`6 random pulls — mix of spells and cosmetics (${Math.round(Wt*100)}% cosmetic per slot when unlocked).`,cost:10})}
    ${dl({id:`title`,title:`Title Box`,desc:`Box-exclusive mage titles only — The Brave, Ruthless, Omnipotent, and more.`,cost:10,variant:`title`})}
  `;let t=e.querySelectorAll(`.mystery-box`);fl(t[0],()=>hl()),fl(t[1],()=>gl())}function vl(e){if(!lc&&e===`cosmetics`&&!c(W)){Dc(_e,`Cosmetics locked`),lc=!0,vl(`cards`),lc=!1;return}Gs=e,document.querySelectorAll(`.vault-tab`).forEach(t=>{let n=t.dataset.vaultTab===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,n?`true`:`false`)}),document.querySelectorAll(`.vault-tab-panel`).forEach(t=>{let n=t.id===`vault-tab-${e}`;t.classList.toggle(`hidden`,!n),t.hidden=!n}),zs(`vault-tab-changed`,{tab:e})}function yl(){ws().then(({renderCosmeticBoxes:e})=>{e(W,X(`cosmetic-box-list`),{logEl:X(`cosmetic-box-log`),onGemsChange:Xc,cosmeticsUnlocked:c(W),onOpened:()=>{G===`profile`&&zc(),G===`quests`&&Yc()}})}).catch(e=>{console.error(`[Shop] cosmetics render failed`,e);let t=X(`cosmetic-box-log`);t&&(t.textContent=`Couldn't load cosmetic boxes — try again from the Shop tab.`,t.classList.add(`chest-log--error`))})}function bl(e={}){let{clearPulls:t=!0}=e;$(),yl(),_l();let n=X(`chest-list`),r=X(`chest-pulls`);if(r&&t&&(r.innerHTML=``,r.classList.add(`chest-pulls--hidden`),r.classList.remove(`chest-pulls--reveal`)),n){n.innerHTML=``;for(let e of ut){let t=vt[e.id]||vt.bronze,i=W.gems>=e.cost,a=document.createElement(`article`);a.className=`chest-card chest-card--${e.id}${i?``:` chest-card--locked`}`,a.innerHTML=`
      <div class="chest-card__aura" aria-hidden="true"></div>
      <div class="chest-card__visual">${Tt(e.id)}</div>
      <div class="chest-card__body">
        <h3 class="chest-card__name">${e.name}</h3>
        <p class="chest-card__tagline">${_t(e.weights)}</p>
    ...
    `;let o=a.querySelector(`.chest-open`);o.disabled=!i,o.addEventListener(`click`,async()=>{if(o.disabled)return;let n=ht(W,e.id),i=X(`chest-log`);if(!n.success){i&&(i.textContent=n.message,i.classList.add(`chest-log--error`));return}T(W),$(),o.disabled=!0;let{playChestOpenAnimation:a}=await ks();if(await a({tier:e.id,tierLabel:t.label,pulls:n.pulls}),Rs(`chest-opened`,{chestId:e.id}),i){let t=n.bonusGems?` (+${n.bonusGems} gems from duplicates)`:``;i.textContent=`Got ${n.pulls.length} spells from ${e.name}.${t}`,i.classList.remove(`chest-log--error`)}if(r){r.classList.remove(`chest-pulls--hidden`),r.classList.add(`chest-pulls--reveal`),r.innerHTML=`<p class="chest-pulls__label">Chest opened</p><div class="chest-pulls__grid"></div>`;let e=r.querySelector(`.chest-pulls__grid`);n.pulls.forEach((t,n)=>{let r=$a(t,{button:!0,deal:!0,gallery:!0,onClick:()=>ao(t)});if(r.style.animationDelay=`${n*.12}s`,t.duplicate){r.classList.add(`spell-card--duplicate-pull`);let e=document.createElement(`span`);e.className=`chest-pull-dup-badge`,e.textContent=t.starRefund?`Duplicate · +${t.starRefund} ★`:`Duplicate · +${t.gemRefund} ◆`,r.appendChild(e)}e.appendChild(r),fo(r,t.rarity)}),so(e),r.scrollIntoView({behavior:`smooth`,block:`nearest`})}bl()}),n.appendChild(a)}}}function xl(){return $s(e().filter(e=>{if(Xs!==`all`&&lt(e)!==Xs||Ys!==`all`&&e.rarity!==Ys)return!1;if(Js){let t=Js.toLowerCase();if(!e.name.toLowerCase().includes(t)&&!e.desc.toLowerCase().includes(t))return!1}return!(Zs&&ae(W,e.id)<=0)}))}function Sl(e,t){let n=ho(W,e);return t&&(t.textContent=n.message,t.className=n.success?`deck-status ok`:`deck-status warn`),n.success&&(T(W),$(),Ks===`list`&&Pl(),Ks===`edit`&&Fl()),n}function Cl(e,t){let n=ho(W,e);return n.success?(T(W),$(),q.push(e),he(W,e),T(W),Fl(),t&&(t.hidden=!1,t.textContent=`Bought and added to deck.`,t.className=`deck-editor__error deck-status ok`),!0):(t&&(t.hidden=!1,t.textContent=n.message,t.className=`deck-editor__error deck-status warn`),!1)}function wl(e){return a(q,e,W).ok?(q.push(e),he(W,e),T(W),Fl(),Rs(`card-added-to-deck`,{cardId:e}),!0):!1}function Tl(e,n,r={}){let{deckEdit:o=!1,statusEl:s=null}=r,c=ae(W,n.id),l=t(n),u=c>=l,d=mo(n.rarity),f=W.gems>=d&&!u,p=o?a(q,n.id,W):{ok:!1},m=o&&i(q)[n.id]||0,h=q.length<30,g=m<l,_=c>=1&&c<=m,v=c>=1&&!u,y=o&&!p.ok&&h&&g&&_&&v,ee=()=>Sl(n.id,s),x=()=>{let e=ae(W,n.id),t=o&&i(q)[n.id]||0,r=e>=l,s=W.gems>=d&&!r,c=o?a(q,n.id,W):{ok:!1};ao(n,{meta:o?`Owned ${e}/${l} · In deck ${t}/${l} · ${r?`max copies`:`${d} gems per copy`}`:`Owned ${e}/${l}${r?` · max copies`:` · ${d} gems per copy`}`,buyLabel:r?`Max copies owned`:`Buy copy (${d} gems)`,buyDisabled:!s||r||e<1,onBuy:()=>{ee(),io()},addDisabled:!c.ok,onAdd:o?()=>{wl(n.id)&&x()}:void 0})};if(o){let t=document.createElement(`div`);t.className=`deck-editor-tile`+(b(W,n.id)?` deck-editor-tile--new`:``);let r=$a(n,{button:!0,gallery:!0,onClick:()=>x()});r.classList.add(`deck-editor-tile__card`),r.title=`${n.name} — tap for full card`;let i=c>0?`Owned ${c}/${l}`:`Not in collection`,a=document.createElement(`div`);a.className=`deck-editor-tile__meta`,a.innerHTML=`${i} · In deck ${m}/${l}${b(W,n.id)?`<span class="deck-editor-tile__new">New</span>`:``}`,a.addEventListener(`click`,()=>x());let o=document.createElement(`button`);o.type=`button`,o.className=`deck-editor-tile__action`,p.ok?(o.classList.add(`deck-editor-tile__action--add`),o.textContent=`+ Add to deck`,o.addEventListener(`click`,e=>{e.stopPropagation(),wl(n.id)})):y?(o.classList.add(`deck-editor-tile__action--buy`),o.textContent=f?`Add for ${d} gems`:`Need ${d} gems`,o.disabled=!f,o.addEventListener(`click`,e=>{e.stopPropagation(),Cl(n.id,s)})):(o.classList.add(`deck-editor-tile__action--disabled`),o.disabled=!0,q.length>=30?o.textContent=`Deck full (30/30)`:m>=l?o.textContent=`Max copies in deck`:c<1?o.textContent=`Open Shop chests to unlock`:p.reason?o.textContent=p.reason:o.textContent=`Can't add`),t.append(r,a,o),e.appendChild(t);return}let S=document.createElement(`div`);S.className=`collection-card-wrap`+(c<1?` collection-card-wrap--unowned`:``);let C=$a(n,{button:!0,compact:!0,disabled:c<1||u,onClick:e=>{if(e.shiftKey||c<1||u){x();return}ee()}});C.title=u?`${n.name} — max ${l} copies owned. Tap to view full card.`:c<1?`${n.name} — not owned. Tap to view full card.`:`${n.name} — tap to buy (${d} gems). Shift+click to inspect.`,S.appendChild(C);let w=document.createElement(`span`);w.className=`collection-owned-count`,w.textContent=c>0?`×${c}`:`—`,S.appendChild(w);let te=document.createElement(`span`);te.className=`collection-buy-cost`,te.textContent=u?`MAX`:`${d} ◆`,(!f||u)&&te.classList.add(`collection-buy-cost--cant`),S.appendChild(te),e.appendChild(S)}function El(e,t={}){if(!e)return;let{deckEdit:n=!1,statusEl:r=null}=t;e.innerHTML=``;let i=xl();if(!i.length){e.className=`deck-editor__grid collection-grid`;let t=document.createElement(`p`);t.className=`collection-grid-empty muted`,t.textContent=n?`No spells match your filters. Try “All types”, clear search, or uncheck Owned only.`:`No cards match your filters. Open chests in the Shop to get more spells.`,e.appendChild(t);return}let a=0,o={deckEdit:n,statusEl:r};if(n||Xs!==`all`){e.className=`deck-editor__grid collection-grid`;for(let t of i)try{Tl(e,t,o),a+=1}catch(e){console.error(`Failed to render card:`,t?.id,e)}}else{e.className=`deck-editor__grid collection-categories`;let t=Object.fromEntries(ot.map(e=>[e,[]]));for(let e of i)t[lt(e)].push(e);for(let n of ot){let r=t[n];if(!r.length)continue;let i=document.createElement(`section`);i.className=`collection-category-section`,i.dataset.category=n;let s=document.createElement(`h3`);s.className=`collection-category-title`,s.textContent=st[n],i.appendChild(s);let c=document.createElement(`div`);c.className=`collection-grid deck-editor__grid-cards`;for(let e of r)try{Tl(c,e,o),a+=1}catch(t){console.error(`Failed to render card:`,e?.id,t)}i.appendChild(c),e.appendChild(i)}}if(i.length>0&&a===0){e.className=`deck-editor__grid collection-grid`;let t=document.createElement(`p`);t.className=`collection-grid-empty collection-grid-empty--error`,t.textContent=`Spells failed to display. Hard refresh the page (Ctrl+Shift+R).`,e.appendChild(t)}}function Dl(){qs={name:X(`deck-name-input`)?.value?.trim()??``,cardIds:[...q]}}function Ol(){return qs?(X(`deck-name-input`)?.value?.trim()??``)!==qs.name||q.length!==qs.cardIds.length?!0:q.some((e,t)=>e!==qs.cardIds[t]):!1}async function kl(){return Ol()?et(`Discard unsaved changes to this deck?`,{title:`Unsaved changes`,confirmLabel:`Discard`,cancelLabel:`Keep editing`,destructive:!0}):!0}function Al(){K=null,q=[],qs=null}function jl(e){let t=W.decks.find(t=>t.id===e);if(!t)return;K=t.id,q=[...t.cardIds];let n=X(`deck-name-input`);n&&(n.value=t.name),ul(`edit`),Rs(`deck-edit-opened`,{deckId:e})}function Ml(e){let t=Object.fromEntries(ot.map(e=>[e,0]));for(let r of e){let e=n(r);e&&(t[lt(e)]+=1)}return t}function Nl(e){let t=Ml(e),n=[];for(let e of ot){let r=t[e];if(r<=0)continue;let i=st[e];n.push(`<span class="deck-row__cat" title="${eo(i)}: ${r}"><span class="deck-row__cat-dot deck-row__cat-dot--${e}" aria-hidden="true"></span><span class="deck-row__cat-n">${r}</span></span>`)}return n.length?`<div class="deck-row__cats">${n.join(``)}</div>`:``}function Pl(){w(W)&&T(W),$();let e=X(`deck-list`);if(!e)return;e.innerHTML=``;let t=X(`deck-list-count`);if(t){let e=W.decks.length;t.textContent=e?`${e} deck${e===1?``:`s`}`:``}if(!W.decks.length){if(w(W)&&T(W),W.decks.length){Pl();return}e.innerHTML=`
    ...
    `,a.addEventListener(`click`,()=>jl(t.id)),e.appendChild(a)}}function Fl(){$();let e=X(`collection-grid`),t=X(`deck-slots`),n=X(`deck-status`),i=X(`edit-deck-heading`),a=X(`deck-count-badge`),o=X(`deck-progress-bar`);if(!e||!t)return;let s=X(`btn-delete-deck`);s&&(s.hidden=!(K&&K!==`new`&&K!==`deck-starter`)),i&&(i.textContent=K===`new`?`New deck`:`In your deck`);let c=r(q,W),l=`${q.length}/30`;a&&(a.textContent=l,a.classList.toggle(`deck-editor__count--ready`,c.valid));let u=X(`deck-progress-fill`),d=Math.min(100,q.length/30*100);u&&(u.style.width=`${d}%`),o&&(o.hidden=c.valid,c.valid||(o.setAttribute(`aria-valuenow`,String(q.length)),o.setAttribute(`aria-valuemax`,`30`))),n&&(c.valid?(n.textContent=``,n.hidden=!0,n.className=`deck-editor__error deck-status ok`):(n.hidden=!1,n.textContent=c.errors[0]||`${l} — keep adding spells`,n.className=`deck-editor__error deck-status warn`));let f=X(`deck-collection-hint`);f&&(f.hidden=!1,f.innerHTML=q.length>=30?`Deck is full. Remove a card from the strip above, or save when ready.`:`Tap <strong>+ Add to deck</strong> for copies you own. When all owned copies are in the deck, tap <strong>Add for X gems</strong> to buy another.`),El(e,{deckEdit:!0,statusEl:n}),t.innerHTML=``;let p=vc(q);if(!p.length){let e=document.createElement(`p`);e.className=`deck-editor__strip-empty`,e.textContent=`Empty deck — tap + Add to deck below`,t.appendChild(e)}for(let{def:e,count:n}of p){let r=document.createElement(`div`);r.className=`deck-slot-wrap deck-slot-wrap--strip`;let i=$a(e,{button:!0,tiny:!0,onClick:()=>{ao(e,{meta:n>1?`${n} copies in deck`:`In your deck`,onRemove:()=>bc(e.id)})}});if(r.appendChild(i),n>1){let e=document.createElement(`span`);e.className=`deck-stack-count`,e.textContent=`×${n}`,r.appendChild(e)}let a=document.createElement(`button`);a.type=`button`,a.className=`deck-slot-remove deck-slot-remove--visible`,a.setAttribute(`aria-label`,`Remove one ${e.name} from deck`),a.textContent=`−`,a.addEventListener(`click`,t=>{t.stopPropagation(),yc(e.id)}),r.appendChild(a),t.appendChild(r)}}function Il(){let e=X(`deck-name-input`)?.value?.trim()||`My Deck`,t=r(q,W);if(!t.valid){X(`deck-status`).textContent=t.errors.join(` `);return}let n;K&&K!==`new`?(n=W.decks.find(e=>e.id===K),n?(n.name=e,n.cardIds=[...q],n.updatedAt=Date.now()):n=y(e,q)):n=y(e,q),ne(W,n),W.selectedDeckId=n.id,T(W),Rs(`deck-saved`,{deckId:n.id}),Al(),ul(`list`)}function Ll(e=[]){let t=`New Deck`,n=new Set(e.map(e=>e.name?.trim()).filter(Boolean));if(!n.has(t))return t;let r=2;for(;n.has(`${t} ${r}`);)r++;return`${t} ${r}`}function Rl(){K=`new`,q=[];let e=X(`deck-name-input`);e&&(e.value=Ll(W.decks)),ul(`edit`)}function zl(){Ec(),mc=null}function Bl(){W.adventure=s(W.adventure),X(`adventure-map-view`)?.classList.remove(`hidden`),zl(),gc=null,Kl()}function Vl(e){let t=x[e]||x.verdant,n=`map-${e}`;return`<svg class="adventure-map-scenery-svg" viewBox="0 0 100 120" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
    <defs>
  ...
  </svg>`}function Hl(e=`#e8c547`){return`<svg class="adventure-map-tile__pawn-svg" viewBox="0 0 28 36" aria-hidden="true">
    <defs>
  ...
  </svg>`}function Ul(e){let t=x[e]||x.verdant;return`<svg class="adventure-map-tile__banner-svg" viewBox="0 0 24 20" aria-hidden="true">
    <defs>
    ...
    <div class="adventure-map-canvas__bg" aria-hidden="true">
      <div class="adventure-map-scenery adventure-map-scenery--${i}" aria-hidden="true">${Vl(i)}</div>
    ...
    <div class="adventure-map-tower">
      ...
      <span class="adventure-map-tile__stone" aria-hidden="true">
        ...
        ${a>0?`<span class="adventure-floor-row__stars">${C(a)}</span>`:``}`,o.addEventListener(`click`,()=>eu(t.id)),y.appendChild(o)}}let b=r.querySelector(`.adventure-map-tile--next`);Wl(r),b&&requestAnimationFrame(()=>{requestAnimationFrame(()=>b.scrollIntoView({behavior:`smooth`,block:`nearest`}))});let S=y?.querySelector(`.adventure-floor-row--next`);S&&requestAnimationFrame(()=>S.scrollIntoView({behavior:`smooth`,block:`end`})),r.querySelector(`.adventure-challenge-toggle`)?.addEventListener(`click`,t=>{t.preventDefault(),t.stopPropagation(),e.challengeMode=!e.challengeMode,W.adventure=e,T(W),es(),Bo.tap(),Kl()})}function ql(e){let t=ue(e);if(!t||!_(W.adventure,e))return;mc=e,Tc();let n=X(`prebattle-title`),i=X(`prebattle-flavor`),a=X(`prebattle-opponent`);n&&(n.textContent=`Tower ${t.worldId} · Floor ${t.floorInWorld}`),i&&(i.textContent=t.flavor||``),a&&(a.textContent=`Loading…`);try{gc=be(W,e),T(W)}catch(e){console.error(`Enemy deck failed`,e),a&&(a.textContent=`Could not build enemy deck. Try again.`);return}a&&(a.textContent=`Review the enemy spell deck, then choose your grimoire below.`);let o=X(`prebattle-gem-hint`);if(o){let n=te(W.adventure,e);o.textContent=(xe(W.adventure,e)?`Repeat clear: +${n} gems`:`First clear: +${n} gems`)+(t.worldId===5&&Se(W.adventure)?` · Challenge mode: enemy has an extra rank of pieces`:``)}let s=X(`enemy-deck-preview`);if(s){s.innerHTML=``;try{for(let{def:e,count:t}of me(gc)){if(!e)continue;let n=document.createElement(`button`);n.type=`button`,n.className=`enemy-deck-spell-btn`,n.title=`View ${e.name}`;let r=document.createElement(`span`);if(r.className=`enemy-deck-spell-btn__name`,r.textContent=e.name,n.appendChild(r),t>1){let e=document.createElement(`span`);e.className=`enemy-deck-spell-btn__count`,e.textContent=`×${t}`,n.appendChild(e)}n.addEventListener(`click`,()=>ao(e,{meta:t>1?`${t} copies in enemy deck`:`Enemy deck`})),s.appendChild(n)}}catch(e){console.error(`Enemy preview failed`,e),s.innerHTML=`<p class="empty-msg">Enemy deck preview unavailable.</p>`}}w(W)&&T(W);let c=br(`adventure-deck-select`);if(!c){a&&(a.textContent=`Deck selector missing — hard refresh the page.`);return}c.innerHTML=``;let l=W.decks.filter(e=>r(e.cardIds,W).valid);if(!l.length){let e=document.createElement(`option`);e.value=``,e.textContent=`No complete decks — build one in Decks`,c.appendChild(e),c.disabled=!0,X(`btn-start-adventure`).disabled=!0;return}c.disabled=!1;let u=W.selectedDeckId&&l.some(e=>e.id===W.selectedDeckId)?W.selectedDeckId:l[0].id;for(let e of l){let t=document.createElement(`option`);t.value=e.id,t.textContent=e.name,e.id===u&&(t.selected=!0),c.appendChild(t)}W.selectedDeckId=u,X(`btn-start-adventure`).disabled=!1}async function Jl(e,t,n,r,i=null,a=!1,o=void 0){let s=t.opponent;zl(),gc=null,document.querySelectorAll(`.view`).forEach(e=>e.classList.add(`hidden`)),X(`view-match`)?.classList.remove(`hidden`);let c=X(`view-match`);if(!c)return;let{MatchSession:u,getMatchHtml:d}=await bs();c.innerHTML=d(s);let p=o??(Ce(r).id===5&&Se(W.adventure)),m={levelId:r,deckId:e.id,challengeMode:p},h={aiDeckIds:n,opponentName:s,cosmetics:f(W),profile:W,challengeMode:p,buildGameOverActions:({won:e,isTie:t})=>Xl(m,{won:e,isTie:t}),onGameOverAction:e=>{Zl(e,m,c)}};i&&(h.initialState=i);try{J=new u(e.cardIds,c,()=>{J=null,pr(),Wo(),Io(`hub`),c.innerHTML=``,X(`view-match`)?.classList.add(`hidden`);let e=ir();e?Z(e):(Us=`adventure`,Z(`play`)),uc&&nu(),dc&&ru()},e=>{let t=se(W,r,e),{gems:n,stars:i,starsGained:a}=t;return W.gems+=n,fe(W,`adventure_floors`,1),l(W),T(W),$(),Nc(),r===1&&t.firstTime&&(uc=!0,nu()),r===5&&t.firstTime&&(dc=!0),{message:`+${n} gems! · Best: ${C(i)}`,starsGained:a}},h)}catch(e){throw J=null,c.innerHTML=``,X(`view-match`)?.classList.add(`hidden`),Z(`play`),e}dr({kind:`adventure`,deckId:e.id,deckCardIds:e.cardIds,aiDeckIds:n,opponentName:s,levelId:r,challengeMode:p}),await Wo(),Io(`match`),a&&(J.winRewarded=!0),mr(J),J.setMessage(``),J.render()}async function Yl(){let e=hr();if(!e)return!1;let t=W.decks.find(t=>t.id===e.deckId)||W.decks.find(e=>e.cardIds?.length===30),n=e.levelId?ue(e.levelId):null;return!t||t.cardIds.length!==30||!n||!e.aiDeckIds?.length||!await et(`Resume your adventure match where you left off?`,{title:`Resume match?`,confirmLabel:`Resume`,cancelLabel:`Discard`})?(fr(),!1):(mc=e.levelId,await Jl(t,n,e.aiDeckIds,e.levelId,e.state,e.winRewarded,e.challengeMode),J?.setMessage(`Match resumed — pick up where you left off.`),!0)}function Xl({levelId:e},{won:t,isTie:n}){let r=e+1,i=t&&r<=50&&_(W.adventure,r);if(n)return[{id:`backToAdventure`,label:`Back to Adventure`,primary:!0}];if(t){let e=[];return i?(e.push({id:`nextFloor`,label:`Next floor`,primary:!0}),e.push({id:`retry`,label:`Retry floor`}),e.push({id:`backToAdventure`,label:`Back to Adventure`})):(e.push({id:`backToAdventure`,label:`Back to Adventure`,primary:!0}),e.push({id:`retry`,label:`Retry floor`})),e}return[{id:`retry`,label:`Retry floor`,primary:!0},{id:`backToAdventure`,label:`Back to Adventure`}]}async function Zl(e,{levelId:t,deckId:n,challengeMode:r},i){let a=W.decks.find(e=>e.id===n);if(e===`backToAdventure`){J?.onExit?.();return}if(e===`nextFloor`){let e=t+1;if(!ue(e)||!_(W.adventure,e)){J?.onExit?.();return}J?.dispose(),J=null,pr({clearCheckpoint:!0}),Wo(),Io(`hub`),i&&(i.innerHTML=``),X(`view-match`)?.classList.add(`hidden`),await Z(`play`),ql(e);return}if(e===`retry`){let e=t,n=ue(e);if(!a||a.cardIds.length!==30||!n){J?.onExit?.();return}J?.dispose(),J=null,pr(),await Jl(a,n,be(W,e),e,null,!1,r)}}function Ql(){let e=br(`adventure-deck-select`)?.value,t=W.decks.find(t=>t.id===e),n=mc,r=n?ue(n):null,i=gc?[...gc]:null;if(!t||t.cardIds.length!==30||!r||!i?.length){let e=X(`prebattle-opponent`);e&&(!t||t.cardIds.length!==30?e.textContent=`Build a complete 30-card deck in the Decks tab, then try again.`:e.textContent=`Could not start battle — close and pick the floor again.`);return}Jl(t,r,i,n)}function $l(){if(window.__adventureMapCaptureBound)return;window.__adventureMapCaptureBound=!0;let e=null,t=!1,n=0,r=e=>e.closest?.(`#adventure-map .adventure-map-tile, #adventure-map .adventure-map-pin`),i=e=>e?.closest?.(`.adventure-map-scene`),a=()=>{t=!0,clearTimeout(n),n=setTimeout(()=>{t=!1},280)},o=(e,t)=>{if(!e||e.disabled)return;let n=Number(e.dataset.level);!Number.isFinite(n)||n<1||(t.preventDefault(),t.stopPropagation(),eu(n))};document.addEventListener(`pointerdown`,t=>{if(t.button!==0)return;let n=r(t.target);if(!n||n.disabled)return;let a=i(n);e={pin:n,pointerId:t.pointerId,startX:t.clientX,startY:t.clientY,scrollTop:a?.scrollTop??0,scrollLeft:a?.scrollLeft??0,cancelled:!1}},!0),document.addEventListener(`pointermove`,t=>{if(!e||t.pointerId!==e.pointerId||e.cancelled)return;let n=t.clientX-e.startX,r=t.clientY-e.startY;Math.hypot(n,r)>12&&(e.cancelled=!0);let a=i(e.pin);a&&(Math.abs(a.scrollTop-e.scrollTop)>3&&(e.cancelled=!0),Math.abs(a.scrollLeft-e.scrollLeft)>3&&(e.cancelled=!0))},!0),document.addEventListener(`pointerup`,t=>{if(!e||t.pointerId!==e.pointerId)return;let{pin:n,cancelled:r}=e;if(e=null,r){a();return}o(n,t),a()},!0),document.addEventListener(`pointercancel`,t=>{!e||t.pointerId!==e.pointerId||(e=null,a())},!0),document.addEventListener(`click`,e=>{if(t){e.preventDefault(),e.stopPropagation();return}let n=r(e.target);!n||n.disabled||o(n,e)},!0)}function eu(e){let t=s(W.adventure);if(W.adventure=t,!_(t,e)){Dc(`Locked — beat global floor ${e-1} first, then return here.`,`Floor locked`);return}T(W),ql(e)}function tu(){Cc(),window.addEventListener(`orientationchange`,Cc),window.addEventListener(`resize`,Cc),Oc(),Co(),_o(),Yo(),Ro(),Go(),Xo(),oo(),$l(),Sc(),document.querySelector(`.adventure-map-scene`)?.addEventListener(`scroll`,Gl,{passive:!0});let e;window.addEventListener(`resize`,()=>{clearTimeout(e),e=setTimeout(()=>{if(!document.body.classList.contains(`adventure-active`))return;let e=X(`adventure-map`);e&&Wl(e)},120)}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&zl()}),document.querySelectorAll(`.tab-btn`).forEach(e=>{e.addEventListener(`click`,()=>{es(),Bo.tap(),Z(e.dataset.tab)})}),document.querySelectorAll(`.play-tab`).forEach(e=>{e.addEventListener(`click`,()=>{if(lr(),G!==`play`){Us=e.dataset.playTab,Z(`play`);return}jc(e.dataset.playTab)})}),document.querySelectorAll(`.play-sub-back`).forEach(e=>{e.addEventListener(`click`,()=>{es(),Bo.tap(),Ac()})}),document.querySelectorAll(`.vault-tab`).forEach(e=>{e.addEventListener(`click`,()=>{lr(),vl(e.dataset.vaultTab)})}),X(`btn-new-deck`)?.addEventListener(`click`,Rl),X(`btn-back-from-edit`)?.addEventListener(`click`,async()=>{await kl()&&(Al(),ul(`list`))}),X(`btn-delete-deck`)?.addEventListener(`click`,async()=>{if(!K||K===`new`)return;let e=W.decks.find(e=>e.id===K);e&&await et(`Delete "${e.name}"? This cannot be undone.`,{title:`Delete deck?`,confirmLabel:`Delete`,cancelLabel:`Keep`,destructive:!0})&&(de(W,e.id),Al(),ul(`list`))});let t=()=>{Ks===`edit`&&Fl(),Ks===`list`&&Pl()};document.querySelectorAll(`.collection-owned-only-toggle`).forEach(e=>{e.addEventListener(`change`,e=>{Zs=e.target.checked,Zc(),t()})}),document.querySelectorAll(`.btn-reset-collection-filters`).forEach(e=>{e.addEventListener(`click`,()=>{Ys=`all`,Js=``,Xs=`all`,Zs=!0,Zc(),t()})}),Zc(),xr(),X(`collection-search`)?.addEventListener(`input`,e=>{Js=e.target.value,t()}),br(`collection-category`)?.addEventListener(`change`,e=>{Xs=e.target.value,t()}),br(`collection-rarity`)?.addEventListener(`change`,e=>{Ys=e.target.value,t()}),X(`btn-clear-deck`)?.addEventListener(`click`,()=>{q=[],Fl()}),X(`btn-auto-finish-deck`)?.addEventListener(`click`,xc),X(`btn-save-deck`)?.addEventListener(`click`,Il),X(`btn-back-adventure`)?.addEventListener(`click`,zl),X(`adventure-floor-backdrop`)?.addEventListener(`click`,zl),X(`btn-start-adventure`)?.addEventListener(`click`,Ql),br(`adventure-deck-select`)?.addEventListener(`change`,e=>{W.selectedDeckId=e.target.value,T(W)});let n=document.getElementById(`auth-modal`),r=document.getElementById(`auth-header-btn`);Ic(),Jn(`play-help-btn`,`play-help-desc`),Jn(`adventure-help-btn`,`adventure-help-desc`),Jn(`shop-help-btn`,`shop-help-desc`),Jn(`deck-help-btn`,`deck-help-desc`),oc=hn({onSignIn:()=>sc?.open(`signin`,{forced:!0}),onSignUp:()=>sc?.open(`signup`,{forced:!0}),onGuest:()=>{nn(),lu()}}),sc=pn({authBtn:r,modal:n,onNewAccount:()=>{W=ge()?pe():E(),On(W,T)},onSignedIn:()=>{rn(),Ar(),W=E(),w(W),Dn(W),$(),Pl(),_l(),oc?.hide(),Lc().then(()=>{G===`profile`&&zc(),G===`quests`&&Yc(),G===`play`&&ic().then(e=>e?.render({resume:!0})),G===`social`&&ac().then(e=>e?.refresh?.()??e?.render())}),ic().then(e=>e?.render({resume:!0})),su(),cu(),ou(),au(),Y||Z(G)},onSignedOut:()=>{rn(),jr(),Fc(),Q=``,Pc(),ec?.dispose?.(),J=null,pr({clearCheckpoint:!0}),lr(),W=pe(),Nc(),$(),Pl(),_l(),oc?.show(),Z(`deck`)}}),gr(()=>J),w(W),Zc(),Nc(),uu()}function nu(){if(!uc||fc!=null)return;let e=0,t=()=>{if(fc=null,e+=1,uc){if(nr()){e<10&&(fc=window.setTimeout(t,400));return}if(Dn(W),ou()){uc=!1;return}e<10&&(fc=window.setTimeout(t,500))}};fc=window.setTimeout(t,350)}function ru(){if(!dc||pc!=null)return;let e=0,t=()=>{if(pc=null,e+=1,dc){if(nr()){e<10&&(pc=window.setTimeout(t,400));return}if(Dn(W),au()){dc=!1;return}e<10&&(pc=window.setTimeout(t,500))}};pc=window.setTimeout(t,350)}function iu(){return Y||!mn()||!d(W)||!In(W)?!1:(Y=!0,Z(`play`),Fs().then(({startPvpTutorial:e})=>{e({profile:W,saveProfile:T,onComplete:()=>{Y=!1,W=E(),w(W),Nc(),Z(`play`),au()}})}),!0)}function au(){return Y||!mn()||!c(W)||jn(W)||Mn(W)||Fn(W)||In(W)||!Rn(W)?!1:(Y=!0,Z(`play`),Fs().then(({startCosmeticsTutorial:e})=>{e({profile:W,saveProfile:T,onComplete:()=>{Y=!1,W=E(),w(W),Nc(),Z(`play`)}})}),!0)}function ou(){return Y||!mn()||!d(W)?!1:(Dn(W),Fn(W)?(Y=!0,Z(`play`),Fs().then(({startQuestsTutorial:e})=>{e({profile:W,saveProfile:T,onComplete:()=>{Y=!1,W=E(),w(W),Nc(),iu(),au()}})}),!0):iu())}function su(){return Y||!mn()||!jn(W)?!1:(Y=!0,Ls().then(({startInteractiveTutorial:e})=>{e({profile:W,saveProfile:T,onComplete:()=>{Y=!1,W=E(),w(W),$(),Pl(),_l(),cu()||Z(`deck`),ou(),au()}})}),!0)}function cu(){return Y||!mn()||!Mn(W)?!1:(Y=!0,Z(`deck`),Ns().then(({startMetaTutorial:e})=>{e({profile:W,saveProfile:T,onComplete:()=>{Y=!1,W=E(),w(W),$(),Pl(),_l(),Z(`deck`),ou(),au()}})}),!0)}async function lu(){oc?.hide(),!su()&&(cu()||ou()||au()||Y||(await Yl()||await Z(`deck`),lr(),Io(`hub`)))}async function uu(){try{if(await Ie()){Ar();try{let e=await un();e&&(W=e)}catch(e){console.warn(`Cloud sync on load failed`,e)}w(W),$(),Pl(),_l()}}catch(e){console.warn(`Auth init failed`,e)}if(Dn(W),await Lc(),ec&&G===`play`&&(Hs===`arena`||Hs===`leaderboard`)&&ec.render(),lr(),gn()){oc?.show();return}await lu()}tu(),D(async()=>{let{registerSW:e}=await import(`./virtual_pwa-register-CpSsV7JG.js`);return{registerSW:e}},[],import.meta.url).then(({registerSW:e})=>{e({immediate:!0})}),tt(),at();export{ir as A,Pn as B,Or as C,fr as D,br as E,mr as F,$t as G,zn as H,Jn as I,wt as J,Bt as K,Ln as L,pr as M,nr as N,ar as O,lr as P,kn as R,Pr as S,yr as T,an as U,Nn as V,Qt as W,et as X,_t as Y,Je as Z,So as _,ls as a,ao as b,us as c,ps as d,hs as f,U as g,Io as h,ts as i,dr as j,sr as k,ds as l,Lo as m,_s as n,as as o,Wo as p,vt as q,vs as r,os as s,bs as t,ss as u,fo as v,kr as w,$a as x,so as y,An as z};