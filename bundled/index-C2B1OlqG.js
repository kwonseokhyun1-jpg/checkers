...
import{n as e,o as t,t as n}from"./cardCatalog-dJdvie_N.js";import{c as r,i,r as a}from"./deckRules-DZQUcLp7.js";import{At as o,Ct as s,Dt as c,Et as l,Ft as u,H as d,I as f,It as p,Lt as m,Mt as h,Nt as g,Ot as ee,Pt as _,R as v,Rt as y,St as b,T as x,Tt as S,_t as C,a as w,bt as te,c as ne,d as re,f as T,g as ie,gt as ae,i as oe,jt as se,kt as ce,l as le,lt as ue,m as E,nt as de,o as fe,ot as pe,p as me,r as he,s as ge,t as _e,u as ve,vt as ye,wt as be,xt as xe,yt as Se,z as Ce,zt as we}from"./storage-B1-xSlsj.js";import{t as D}from"./preload-helper-CV77j2BA.js";import{_ as Te,a as Ee,c as De,d as Oe,f as ke,h as Ae,l as je,m as Me,o as O,s as Ne,t as Pe}from"./auth-CAClyXnN.js";var Fe=Object.defineProperty,Ie=(e,t)=>{let n={};for(var r in e)Fe(n,r,{get:e[r],enumerable:!0});return t||Fe(n,Symbol.toStringTag,{value:`Module`}),n};function Le(){let e=window.visualViewport;return e?Math.max(0,Math.round(e.offsetTop)):0}function Re(){let e=window.visualViewport;return e?Math.max(0,Math.round(window.innerHeight-e.offsetTop-e.height)):0}function ze(){let e=document.documentElement,t=()=>{e.style.setProperty(`--viewport-inset-top`,`${Le()}px`),e.style.setProperty(`--viewport-inset-bottom`,`${Re()}px`)};t(),window.visualViewport?.addEventListener(`resize`,t),window.visualViewport?.addEventListener(`scroll`,t),window.addEventListener(`resize`,t),window.addEventListener(`orientationchange`,t)}ze();var Be=1100,Ve=120;function He(){let e=document.getElementById(`app-splash`);if(!e||e.classList.contains(`app-splash--hide`))return;e.classList.add(`app-splash--hide`),document.body.classList.remove(`splash-active`);let t=()=>{e.remove()};e.addEventListener(`transitionend`,t,{once:!0}),window.setTimeout(t,600)}function Ue(){He()}function We(){let e=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches?Ve:Be,t=performance.now(),n=()=>{let n=performance.now()-t,r=Math.max(0,e-n);window.setTimeout(He,r)};document.readyState===`interactive`||document.readyState===`complete`?n():document.addEventListener(`DOMContentLoaded`,n,{once:!0})}document.body.classList.add(`splash-active`),We();var Ge=`(max-width: 768px)`,Ke=null;function qe(){return document.getElementById(`mobile-confirm`)}function Je(e){let t=qe();if(!t)return;t.classList.add(`hidden`),document.body.classList.remove(`mobile-confirm-open`);let n=Ke;Ke=null,n?.(e)}function Ye(e,t={}){if(!window.matchMedia(Ge).matches)return Promise.resolve(window.confirm(e));let n=qe();if(!n)return Promise.resolve(window.confirm(e));let{title:r=`Confirm`,confirmLabel:i=`OK`,cancelLabel:a=`Cancel`,destructive:o=!1}=t;return new Promise(t=>{Ke&&Je(!1),Ke=t,n.querySelector(`#mobile-confirm-title`).textContent=r,n.querySelector(`#mobile-confirm-body`).textContent=e;let s=n.querySelector(`#mobile-confirm-ok`),c=n.querySelector(`#mobile-confirm-cancel`);s.textContent=i,c.textContent=a,s.classList.toggle(`btn-danger`,o),s.classList.toggle(`btn-primary`,!o),n.classList.remove(`hidden`),document.body.classList.add(`mobile-confirm-open`),c.focus()})}function Xe(){let e=qe();!e||e.dataset.bound||(e.dataset.bound=`1`,e.querySelector(`#mobile-confirm-ok`)?.addEventListener(`click`,()=>Je(!0)),e.querySelector(`#mobile-confirm-cancel`)?.addEventListener(`click`,()=>Je(!1)),e.querySelector(`[data-mobile-confirm-backdrop]`)?.addEventListener(`click`,()=>Je(!1)))}var Ze=`cc_install_banner_dismissed`;function Qe(){return window.matchMedia(`(display-mode: standalone)`).matches||window.navigator.standalone===!0}function $e(){let e=window.navigator.userAgent;return/iphone|ipad|ipod/i.test(e)&&!/crios|fxios/i.test(e)}function et(){if(Qe()||localStorage.getItem(Ze)===`1`)return;let e=document.getElementById(`install-banner`);if(!e)return;let t=null,n=()=>{e.classList.remove(`hidden`),document.body.classList.add(`install-banner-visible`)},r=()=>{e.classList.add(`hidden`),document.body.classList.remove(`install-banner-visible`)};window.addEventListener(`beforeinstallprompt`,r=>{r.preventDefault(),t=r,e.querySelector(`#install-banner-ios-hint`)?.classList.add(`hidden`),e.querySelector(`.install-banner__hint--default`)?.classList.remove(`hidden`),e.querySelector(`#install-banner-btn`)?.classList.remove(`hidden`),n()}),$e()&&(e.querySelector(`#install-banner-ios-hint`)?.classList.remove(`hidden`),e.querySelector(`.install-banner__hint--default`)?.classList.add(`hidden`),e.querySelector(`#install-banner-btn`)?.classList.add(`hidden`),window.setTimeout(n,2500)),e.querySelector(`#install-banner-btn`)?.addEventListener(`click`,async()=>{t&&(t.prompt(),await t.userChoice,t=null,r())}),e.querySelector(`#install-banner-dismiss`)?.addEventListener(`click`,()=>{localStorage.setItem(Ze,`1`),r()})}var tt=[`attack`,`control`,`defense`,`movement`,`trap`,`special`],nt={attack:`Attack`,control:`Control`,defense:`Defense`,movement:`Movement`,trap:`Trap`,special:`Special`},rt={aegis:`defense`,anchor:`defense`,backpedal:`control`,backstab:`attack`,backstep:`movement`,barrier:`defense`,bishops_mark:`movement`,blind:`control`,blizzard:`control`,snowball:`control`,berserk:`movement`,bomb:`attack`,shockwave:`control`,plague:`control`,bulwark:`defense`,create_foe:`special`,call_forward:`movement`,chain_lightning:`attack`,clone:`special`,coin_flip:`attack`,collapse:`special`,confusion:`control`,constitution:`defense`,counterspell:`trap`,crown:`special`,cryo_bolt:`attack`,cull:`attack`,darkness:`defense`,dash:`movement`,deep_freeze:`control`,deflect:`trap`,demote:`control`,deport:`movement`,displacement:`movement`,dominion:`special`,duel:`attack`,earthquake:`special`,execution:`attack`,pyromancy:`attack`,fusion:`special`,hibernation:`special`,hostile_swap:`movement`,ignore:`special`,iron_will:`defense`,landmine:`trap`,last_king:`special`,bounty:`special`,link_fate:`special`,last_stand:`trap`,leapfrog:`movement`,long_step:`movement`,magnet:`movement`,nudge:`movement`,offering:`special`,panic:`control`,poison:`attack`,mind_control:`special`,press:`control`,purify:`special`,quick_march:`movement`,quicksand:`trap`,rally:`defense`,recall:`movement`,repel:`movement`,random_teleport:`movement`,retreat:`movement`,revive:`defense`,rooks_mark:`movement`,root:`control`,sacrifice:`attack`,sanctuary:`defense`,scatter:`movement`,shadow_swap:`movement`,sidestep:`movement`,shatter:`attack`,snipe:`attack`,snowball:`control`,stab:`attack`,stall:`defense`,tangle:`control`,teleport:`movement`,trickster:`special`,vengeance:`trap`,ward:`defense`};function it(e){let t=rt[e?.id];if(t)return t;let n=`${e?.id||``} ${e?.effect||``} ${e?.name||``} ${e?.desc||``}`.toLowerCase();return/trap|mine|quicksand|counterspell|vengeance|last.?stand/.test(n)?`trap`:/shield|ward|aegis|sanctuary|barrier|anchor|deflect|stall|iron_will|rally|darkness/.test(n)?`defense`:/move|nudge|teleport|recall|leap|step|displace|swap|scatter|retreat|bishop|rook|overrun|promote|pull|push|shift|earthquake|magnet|repel/.test(n)?`movement`:/freeze|blind|confusion|hex|root|panic|press|silence|paraly|control|cannot play|random|mark|poison|die in \d+ turn/.test(n)?`control`:/\bdestroy\b|\bkills?\b|fireball|bolt|stab|snipe|duel|sacrifice|execution|shatter|cull|lightning/.test(n)?`attack`:`special`}var at=[{id:`bronze`,name:`Bronze Chest`,cost:25,cards:3,weights:{common:70,uncommon:25,rare:5,epic:0}},{id:`silver`,name:`Silver Chest`,cost:50,cards:5,weights:{common:50,uncommon:35,rare:12,epic:3}},{id:`gold`,name:`Gold Chest`,cost:100,cards:8,weights:{common:32,uncommon:38,rare:22,epic:6,legendary:2}}];function ot(e){let t=Math.random()*100,n=0;for(let r of[`common`,`uncommon`,`rare`,`epic`,`legendary`])if(n+=e[r]||0,t<=n)return r;return`common`}function st(t){let n=e().filter(e=>e.rarity===t);return n.length?n[Math.floor(Math.random()*n.length)]:e()[0]}function ct(e,t){return st(ot(t.weights))}function lt(e,n,r={}){let{starRefundChance:i=0}=r;if(oe(e,n.id)<t(n))return _e(e,n.id,1),{...n,duplicate:!1};let a=de[n.rarity]||5;if(i>0&&Math.random()<i){let e=Math.random()<.5?1:2;return{...n,duplicate:!0,starRefund:e}}return{...n,duplicate:!0,gemRefund:a}}function ut(e,t){let n=at.find(e=>e.id===t);if(!n)return{success:!1,message:`Unknown chest.`};if(e.gems<n.cost)return{success:!1,message:`Not enough gems.`};e.gems-=n.cost;let r=[],i=0;for(let t=0;t<n.cards;t++){let t=lt(e,ct(e,n));r.push(t),t.gemRefund&&(i+=t.gemRefund)}return i&&(e.gems+=i),E(e),{success:!0,pulls:r,chest:n,bonusGems:i}}var dt=[`common`,`uncommon`,`rare`,`epic`,`legendary`];function ft(e,{minPct:t=1}={}){return dt.filter(n=>(e[n]??0)>=t).map(t=>`${e[t]}% ${t}`).join(` · `)}var pt={bronze:{label:`Bronze`,tagline:`Mostly common cards`,accent:`#cd7f32`,glow:`rgba(205, 127, 50, 0.45)`},silver:{label:`Silver`,tagline:`Balanced card mix`,accent:`#a8b8d8`,glow:`rgba(168, 184, 216, 0.5)`},gold:{label:`Gold`,tagline:`Higher rare & epic odds`,accent:`#e8c547`,glow:`rgba(232, 197, 71, 0.55)`}};function mt(e){let t=pt[e]||pt.bronze;return{t,lid:e===`gold`?`#f5e6a8`:e===`silver`?`#e8eef8`:`#d4954a`,body:e===`gold`?`#7a5c12`:e===`silver`?`#4a5568`:`#5c3a1e`,trim:e===`gold`?`#ffe566`:e===`silver`?`#c8d8f0`:t.accent}}function ht(e,t){let{lid:n,body:r,trim:i}=mt(e);return`
    <defs>
    ...
    </g>`}function k(e,t,n,r,i=.9){return`<path d="M${e} ${t-n} L${e+n*.28} ${t-n*.28} L${e+n} ${t} L${e+n*.28} ${t+n*.28} L${e} ${t+n} L${e-n*.28} ${t+n*.28} L${e-n} ${t} L${e-n*.28} ${t-n*.28} Z" fill="${r}" opacity="${i}"/>`}function Tt(e,t){let{trim:n,gold:r}=t;return`
    ...
    ${Ct(n,r)}
    ${i}
  </svg>`}function Ot(){return Dt(`small`)}function kt(){return Dt(`big`)}var At=.5,jt=.1,Mt=[{id:`bronze`,name:`Bronze Chest`,cards:3,weights:{common:70,uncommon:25,rare:5,epic:0}},{id:`silver`,name:`Silver Chest`,cards:5,weights:{common:50,uncommon:35,rare:12,epic:3}},{id:`gold`,name:`Gold Chest`,cards:8,weights:{common:32,uncommon:38,rare:22,epic:6,legendary:2}}],Nt=[{id:`bronze`,name:`Bronze Cosmetic Box`,pulls:3,weights:{common:70,uncommon:25,rare:5,epic:0}},{id:`silver`,name:`Silver Cosmetic Box`,pulls:5,weights:{common:50,uncommon:35,rare:12,epic:3}},{id:`gold`,name:`Gold Cosmetic Box`,pulls:8,weights:{common:32,uncommon:38,rare:22,epic:6,legendary:2}}];function Pt(e,{premium:t=!1}={}){let n=Math.random()*100;return t?n>50?e[2]:n>15?e[1]:e[0]:n>70?e[2]:n>35?e[1]:e[0]}function Ft(e,t,{starRefundChance:n=0}={}){let r=[],i=0,a=0;for(let o=0;o<t.cards;o++){let o=lt(e,ct(e,t),{starRefundChance:n});r.push(o),o.gemRefund&&(i+=o.gemRefund),o.starRefund&&(a+=o.starRefund)}return i&&(e.gems=(e.gems||0)+i),a&&(e.stars=(e.stars??0)+a),{pulls:r,bonusGems:i,bonusStars:a}}function It(e,t){e.cosmetics=e.cosmetics||{};let n=[],r=0;for(let i=0;i<t.pulls;i++){let i=pe(e,t.weights);i&&(n.push(i),i.duplicate&&(r+=i.gemRefund||5))}return r&&(e.gems=(e.gems||0)+r),{pulls:n,bonusGems:r}}function Lt(e){if((e.stars??0)<10)return{success:!1,message:`Not enough stars.`};if(e.stars=(e.stars??0)-10,!(h(e)&&Math.random()<.5)){let t=Pt(Mt),{pulls:n,bonusGems:r,bonusStars:i}=Ft(e,t,{starRefundChance:jt});return E(e),{success:!0,kind:`card`,tier:t,pulls:n,bonusGems:r,bonusStars:i,message:`Cards from ${t.name}`}}let t=Pt(Nt),{pulls:n,bonusGems:r}=It(e,t);return E(e),{success:!0,kind:`cosmetic`,tier:t,pulls:n,bonusGems:r,message:`Cosmetics from ${t.name}`}}function Rt(e){if((e.stars??0)<20)return{success:!1,message:`Not enough stars.`};e.stars=(e.stars??0)-20;let t=Pt(Mt,{premium:!0}),{pulls:n,bonusGems:r,bonusStars:i}=Ft(e,t,{starRefundChance:jt}),a=[],o=r,s=null;if(h(e)){s=Pt(Nt,{premium:!0});let t=It(e,s);a=t.pulls,o+=t.bonusGems}return E(e),{success:!0,kind:a.length?`both`:`card`,cardTier:t,cardPulls:n,cosTier:s,cosPulls:a,bonusGems:o,bonusStars:i,message:a.length?`Big haul: ${n.length} spells + ${a.length} cosmetics`:`Cards from ${t.name}`}}var zt=`arcane_checkers_guest_mode_v1`,Bt=`Sign in to save progress / play PvP`,Vt=`Sign in to save progress`;function Ht(){return Ut()&&!O()}function Ut(){try{return localStorage.getItem(zt)===`1`}catch{return!1}}function Wt(){try{localStorage.setItem(zt,`1`)}catch{}}function Gt(){try{localStorage.removeItem(zt)}catch{}}var Kt=Ie({pullCloudProfile:()=>Zt,scheduleCloudSave:()=>Qt}),qt=null;function Jt(e){if(!e||typeof e!=`object`)return!0;let t=Object.keys(e);if(t.length===0||t.every(e=>e===`loginEmail`||e===`login_email`||e===`savedAt`))return!0;let n=e.collection&&Object.keys(e.collection).length>0,r=Array.isArray(e.decks)&&e.decks.length>0,i=e.adventure?.cleared,a=(Array.isArray(i)?i.length:Object.keys(i||{}).length)>0,o=typeof e.gems==`number`||typeof e.stars==`number`,s=typeof e.pvpWins==`number`&&e.pvpWins>0||typeof e.spellsPlayed==`number`&&e.spellsPlayed>0;return!(n||r||a||o||s)}function Yt(e){return T(e),E(e,{bumpTimestamp:!1}),e}function Xt(e,t){let n=ge();return!(n!==e&&n!==null||n===null&&Ut()&&t&&!Jt(t))}async function Zt(){let e=O();if(!e||!De())return null;let t=await Ee(e.id),n=re(),r=t?.profile_json,i=Xt(e.id,r);if(!r||typeof r!=`object`||Jt(r)){if(!le(n)&&i)Yt(n);else if(!le(n)&&!i)return Yt(me());return re()}if(le(n)||!i){let e={...r};return i&&v(e,n),Ce(e),Yt(e)}return(r.savedAt||0)>=(n.savedAt||0)?Yt(d(n,r)):(v(n,r),E(n),n)}function Qt(e){let t=O();!t||!De()||(clearTimeout(qt),qt=setTimeout(async()=>{try{await Te(t.id,{profile_json:e,display_name:t.user_metadata?.display_name||t.email?.split(`@`)[0]})}catch(e){console.warn(`Cloud save failed`,e)}},800))}var $t=Pe;function en({authBtn:e,modal:t,onSignedIn:n,onSignedOut:r,onNewAccount:i}){if(!e||!t)return;let a=t.querySelector(`#auth-form`),o=t.querySelector(`#auth-modal-title`),s=t.querySelector(`#auth-toggle-mode`),c=t.querySelector(`#auth-error`),l=t.querySelector(`#auth-username-hint`),u=t.querySelector(`#auth-close`),d=t.querySelector(`.auth-modal-backdrop`),f=a?.querySelector(`button[type="submit"]`),p=`signin`,m=null,h=!1,g=!1;function ee(){a?.querySelectorAll(`.auth-field-signup`).forEach(e=>{e.classList.toggle(`hidden`,p!==`signup`)});let e=a?.querySelector(`#auth-identifier`),t=a?.querySelector(`label[for="auth-identifier"]`);t&&(t.textContent=p===`signup`?`Email`:`Username or email`),e&&(e.placeholder=p===`signup`?`you@email.com`:`username or email`,e.type=p===`signup`?`email`:`text`,e.autocomplete=p===`signup`?`email`:`username`),f&&(f.textContent=p===`signup`?`Create account`:`Sign in`),l&&(l.textContent=``),l?.classList.remove(`auth-username-hint--ok`,`auth-username-hint--bad`)}function _(e){c&&(c.textContent=e||``)}function v(e,t=``){l&&(l.textContent=e||``,l.classList.remove(`auth-username-hint--ok`,`auth-username-hint--bad`),t===`ok`&&l.classList.add(`auth-username-hint--ok`),t===`bad`&&l.classList.add(`auth-username-hint--bad`))}async function y(){if(p!==`signup`)return;let e=a?.querySelector(`#auth-username`)?.value?.trim();if(!e){v(``);return}if(!$t.test(e)){v(`3–24 letters, numbers, or underscore`,`bad`);return}if(v(`Checking…`),!await je(e)){let t=await Ae(e);v(t?`Taken — try "${t}"`:`That username is taken`,`bad`),t&&l&&(l.dataset.suggestion=t);return}l&&delete l.dataset.suggestion,v(`Available`,`ok`)}function b(e,n={}){if(h=!!n.forced,!De()){_(`Add Supabase anon key in js/supabaseConfig.js`),t.classList.remove(`hidden`),u?.classList.toggle(`hidden`,h);return}p=e||p,o&&(o.textContent=p===`signup`?`Create account`:`Sign in`),s&&(s.textContent=p===`signup`?`Already have an account? Sign in`:`Need an account? Sign up`),_(``),ee(),u?.classList.toggle(`hidden`,h),d?.classList.toggle(`auth-modal-backdrop--locked`,h),t.classList.remove(`hidden`)}function x(){h||(t.classList.add(`hidden`),_(``),v(``))}function S(t){if(e){if(!De()){e.textContent=`Setup cloud`,e.title=`Configure Supabase`,e.classList.remove(`hidden`),e.hidden=!1;return}t?(e.classList.add(`hidden`),e.hidden=!0):(e.textContent=`Sign in`,e.title=`Sign in or sign up`,e.classList.remove(`hidden`),e.hidden=!1)}}e.addEventListener(`click`,()=>{O()||b(`signin`)}),s?.addEventListener(`click`,e=>{e.preventDefault(),p=p===`signup`?`signin`:`signup`,b(p)}),u?.addEventListener(`click`,x),d?.addEventListener(`click`,()=>{h||x()});let C=a?.querySelector(`#auth-username`);C?.addEventListener(`input`,()=>{clearTimeout(m),m=setTimeout(()=>{y().catch(()=>v(``))},350)}),l?.addEventListener(`click`,()=>{let e=l?.dataset?.suggestion;!e||!C||(C.value=e,delete l.dataset.suggestion,y().catch(()=>{}))}),a?.addEventListener(`submit`,async e=>{e.preventDefault(),_(``);let t=a.querySelector(`#auth-identifier`)?.value?.trim(),r=a.querySelector(`#auth-username`)?.value?.trim(),o=a.querySelector(`#auth-password`)?.value;if(!t||!o){_(p===`signup`?`Email and password required.`:`Username or email and password required.`);return}f&&(f.disabled=!0),g=!0;try{if(p===`signup`){if(!t.includes(`@`)){_(`Use your email address to sign up.`);return}if(!r||!$t.test(r)){_(`Choose a username (3–24 letters, numbers, underscore).`);return}let e=r;if(!await je(e)){let t=await Ae(e);if(t){_(`"${e}" is taken. Try "${t}" or tap the hint below.`),v(`Tap to use "${t}"`,`bad`),l&&(l.dataset.suggestion=t);return}_(`Username "${e}" is already taken. Pick another.`);return}i?.();let a=(await Me(t,o,e,e)).session?.user??O();if(a){let r=await Ee(a.id),i=r?.profile_json&&typeof r.profile_json==`object`?{...r.profile_json}:{};i.loginEmail=t.toLowerCase();try{await Te(a.id,{username:e,display_name:e,profile_json:i})}catch(t){if((t?.code||t?.details?.code)===`23505`){let t=await Ae(e);_(t?`Account created but "${e}" was taken. Sign in and change your name to "${t}", or try sign up again with that username.`:`Account created but that username was just taken. Sign in with your email and pick another name in Profile.`),p=`signin`,b(`signin`);return}throw t}try{await Zt()}catch(e){console.warn(`Profile sync after signup failed`,e)}n?.(),h=!1,u?.classList.remove(`hidden`),d?.classList.remove(`auth-modal-backdrop--locked`),x();return}_(`Account created. Check your email to confirm, then sign in.`),p=`signin`,b(`signin`);return}await ke(t,o);let e=O();if(!e){_(`Sign-in failed — no session returned. Try again or confirm your email.`);return}try{await Zt()}catch(e){console.warn(`Profile sync after sign-in failed`,e)}n?.(),h=!1,u?.classList.remove(`hidden`),d?.classList.remove(`auth-modal-backdrop--locked`),S(e),x()}catch(e){let t=e?.message||`Authentication failed`;if(t.includes(`Database error saving new user`)||t.includes(`username_taken`)||e?.code===`23505`){let e=r&&$t.test(r)?await Ae(r):null;t=e?`Sign-up failed (username conflict). Try "${e}" instead.`:`Sign-up failed on the server. Try a different username, or sign in if you already have an account.`}else t.includes(`over_email_send_rate_limit`)||t.includes(`rate limit`)?t=`Too many sign-up attempts. Wait a few minutes or sign in with an existing account.`:t.includes(`User already registered`)&&(t=`That email is already registered. Try Sign in instead.`);t.includes(`Invalid login credentials`)?_(`Wrong email/username or password.`):t.includes(`Email not confirmed`)?_(`Confirm your email first (check inbox), or disable email confirmation in Supabase for testing.`):_(t)}finally{g=!1,f&&(f.disabled=!1)}});let w=!1;return Oe(async e=>{if(S(e),e){if(w=!0,g)return;try{await Zt()}catch(e){console.warn(`Profile sync failed`,e)}n?.(),h=!1,u?.classList.remove(`hidden`),d?.classList.remove(`auth-modal-backdrop--locked`),x()}else w&&(w=!1,r?.())}),Ne().then(S),{open:b,close:x}}function tn(){return!!O()||Ut()}function nn({onSignIn:e,onSignUp:t,onGuest:n}){let r=document.getElementById(`auth-gate`);if(!r)return{show:()=>{},hide:()=>{},sync:()=>{}};let i=r.querySelector(`#auth-gate-signin`),a=r.querySelector(`#auth-gate-signup`),o=r.querySelector(`#auth-gate-guest`),s=r.querySelector(`#auth-gate-notice`);i?.addEventListener(`click`,()=>e?.()),a?.addEventListener(`click`,()=>t?.()),o?.addEventListener(`click`,()=>n?.());function c(){De()?s&&(s.textContent=`Create an account to sync decks, stars, and collection — or continue as guest to play Adventure on this device.`):s&&(s.textContent=`Cloud sign-in is not configured. Add your Supabase keys in js/supabaseConfig.js.`),r.classList.remove(`hidden`),document.body.classList.add(`auth-gate-active`)}function l(){r.classList.add(`hidden`),document.body.classList.remove(`auth-gate-active`)}function u(){tn()?l():c()}return{show:c,hide:l,sync:u}}function rn(){return De()&&!tn()}var an=`arcane_checkers_tutorial_v1`,on=`arcane_checkers_interactive_tutorial_v1`,sn=`arcane_checkers_meta_tutorial_v1`,cn=`arcane_checkers_quests_tutorial_v1`,ln=`arcane_checkers_pvp_tutorial_v1`,un=`arcane_checkers_cosmetics_tutorial_v1`,dn=`arcane_checkers_pending_signup_tutorial_v1`;function fn(){try{sessionStorage.setItem(dn,`1`)}catch{}}function pn(){try{sessionStorage.removeItem(dn)}catch{}}function mn(){try{return sessionStorage.getItem(dn)===`1`}catch{return!1}}function hn(e){if(!e)return;let t=[[on,e.interactiveTutorialDone||e.tutorialDone],[sn,e.metaTutorialDone||e.tutorialDone],[cn,e.questsTutorialDone],[ln,e.pvpTutorialDone],[un,e.cosmeticsTutorialDone]];try{for(let[e,n]of t)n?localStorage.setItem(e,`done`):localStorage.getItem(e)===`done`&&localStorage.removeItem(e)}catch{}}function gn(e,t){fn();try{localStorage.removeItem(on),localStorage.removeItem(sn),localStorage.removeItem(cn),localStorage.removeItem(ln),localStorage.removeItem(un),localStorage.removeItem(an)}catch{}e&&(delete e.interactiveTutorialDone,delete e.metaTutorialDone,delete e.questsTutorialDone,delete e.pvpTutorialDone,delete e.cosmeticsTutorialDone,delete e.tutorialDone,t?.(e))}function _n(e={}){if(pn(),e.persist){try{localStorage.setItem(on,`done`)}catch{}e.profile&&(e.profile.interactiveTutorialDone=!0),e.saveProfile?.(e.profile)}}function vn(e={}){if(e.persist){try{localStorage.setItem(sn,`done`),localStorage.setItem(an,`done`)}catch{}e.profile&&(e.profile.metaTutorialDone=!0,e.profile.tutorialDone=!0),e.saveProfile?.(e.profile)}}function yn(e){if(mn())return!0;if(e?.interactiveTutorialDone||e?.tutorialDone)return!1;try{return localStorage.getItem(on)!==`done`}catch{return!0}}function bn(e){if(e?.metaTutorialDone||e?.tutorialDone)return!1;if(!e?.interactiveTutorialDone)try{if(localStorage.getItem(on)!==`done`)return!1}catch{return!1}try{return localStorage.getItem(sn)!==`done`}catch{return!0}}function xn(e={}){if(e.persist){try{localStorage.setItem(cn,`done`)}catch{}e.profile&&(e.profile.questsTutorialDone=!0),e.saveProfile?.(e.profile)}}function Sn(e={}){if(e.persist){try{localStorage.setItem(ln,`done`)}catch{}e.profile&&(e.profile.pvpTutorialDone=!0),e.saveProfile?.(e.profile)}}function Cn(e){if(e?.questsTutorialDone)return!1;try{return localStorage.getItem(cn)!==`done`}catch{return!0}}function wn(e){if(e?.pvpTutorialDone)return!1;if(!e?.questsTutorialDone)try{if(localStorage.getItem(cn)!==`done`)return!1}catch{return!1}try{return localStorage.getItem(ln)!==`done`}catch{return!0}}function Tn(e={}){if(e.persist){try{localStorage.setItem(un,`done`)}catch{}e.profile&&(e.profile.cosmeticsTutorialDone=!0),e.saveProfile?.(e.profile)}}function En(e){if(e?.cosmeticsTutorialDone)return!1;try{return localStorage.getItem(un)!==`done`}catch{return!0}}function Dn(e){return e instanceof Element?!!e.closest(`#mobile-confirm, #tutorial-meta-overlay, #tutorial-match-overlay, .card-preview-modal`):!1}var On=new WeakSet,kn=!1,An=null,jn=null;function Mn(){return document.getElementById(`panel-help-popup`)}function Nn(){let e=Mn();!e||e.classList.contains(`hidden`)||(e.classList.add(`hidden`),document.body.classList.remove(`panel-help-open`),An&&=(An.setAttribute(`aria-expanded`,`false`),An.classList.remove(`panel-help-btn--active`),null),jn&&=(clearTimeout(jn),null))}function Pn({title:e,bodyHtml:t,triggerBtn:n=null,autoCloseMs:r=0}){let i=Mn();if(!i)return;Nn();let a=i.querySelector(`#panel-help-popup-title`),o=i.querySelector(`#panel-help-popup-body`);a&&(a.textContent=e||`Help`),o&&(o.innerHTML=t||``),i.classList.remove(`hidden`),document.body.classList.add(`panel-help-open`),n&&(An=n,n.setAttribute(`aria-expanded`,`true`),n.classList.add(`panel-help-btn--active`)),r>0&&(jn=setTimeout(Nn,r)),i.querySelector(`.panel-help-popup__dismiss`)?.focus()}function Fn(){if(kn)return;kn=!0;let e=Mn();e&&(e.querySelectorAll(`[data-panel-help-close]`).forEach(e=>{e.addEventListener(`click`,Nn)}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&Nn()}))}function In(e,t){let n=typeof e==`string`?document.getElementById(e):e,r=typeof t==`string`?document.getElementById(t):t;!n||!r||On.has(n)||(On.add(n),Fn(),n.addEventListener(`click`,e=>{e.stopPropagation();let t=Mn();if(t&&!t.classList.contains(`hidden`)&&An===n){Nn();return}Pn({title:n.getAttribute(`aria-label`)||`Help`,bodyHtml:r.innerHTML,triggerBtn:n})}))}var Ln=`cc_match_checkpoint`,Rn=1440*60*1e3,zn=null,Bn=!1,Vn=null;function Hn(){return document.body.classList.contains(`match-active`)}function Un(e){if(!e||!(e instanceof Element)||e.closest(`.hidden`))return!1;let t=getComputedStyle(e);return!(t.display===`none`||t.visibility===`hidden`)}function Wn(){let e=document.querySelector(`#btn-leave-match`);if(!e)return!1;if(Un(e))return!0;if(!Hn())return!1;let t=document.getElementById(`view-match`),n=document.getElementById(`view-pvp`);return!!(t?.contains(e)||n?.contains(e))}function Gn(e){zn=e}function Kn(){let e=zn;return zn=null,e}function qn(){zn=null}function Jn(){Bn=!0}function Yn(){let e=Bn;return Bn=!1,e}function Xn(){let e=document.getElementById(`view-match`);e?.classList.contains(`hidden`)&&e.innerHTML.trim()&&(e.innerHTML=``);let t=document.getElementById(`pvp-match-root`);t&&(Un(t.querySelector(`#btn-leave-match`))||t.remove())}function Zn(){return!Hn()||Wn()?!1:(Xn(),tr({clearCheckpoint:!1}),window.dispatchEvent(new CustomEvent(`cc-match-shell-reconciled`)),!0)}function Qn(e){document.querySelector(`.game-shell`)?.classList.toggle(`game-shell--in-match`,e)}function $n(e){Vn=e,document.body.classList.add(`match-active`),Qn(!0)}function er(){try{sessionStorage.removeItem(Ln)}catch{}}function tr(e={}){Vn=null,document.body.classList.remove(`match-active`),Qn(!1),e.clearCheckpoint&&er()}function nr(e){if(!(!Vn||!e?.state||Vn.kind!==`adventure`||e.state.gameOver))try{sessionStorage.setItem(Ln,JSON.stringify({...Vn,state:e.state,winRewarded:!!e.winRewarded,savedAt:Date.now()}))}catch{}}function rr(){try{let e=sessionStorage.getItem(Ln);if(!e)return null;let t=JSON.parse(e);return!t?.state||t.state.gameOver||t.kind!==`adventure`||t.savedAt&&Date.now()-t.savedAt>Rn?(er(),null):t}catch{return er(),null}}function ir(e){if(window.__ccMatchVisibilityBound)return;window.__ccMatchVisibilityBound=!0;let t=()=>{let t=e();t&&nr(t)};document.addEventListener(`visibilitychange`,()=>{let n=e();document.hidden?(t(),n?.pauseForBackground?.()):n?.resumeFromBackground?.()}),window.addEventListener(`pagehide`,t)}var ar=new Set;function or(e){for(let t of ar)t!==e&&t.close()}function sr(e){if(!e||e.dataset.customSelectEnhanced)return e?._customSelectApi??null;e.dataset.customSelectEnhanced=`1`;let t=document.createElement(`div`);t.className=`custom-select`;let n=document.createElement(`button`);n.type=`button`,n.className=`custom-select__trigger select-input`,n.setAttribute(`aria-haspopup`,`listbox`),n.setAttribute(`aria-expanded`,`false`);let r=document.createElement(`span`);r.className=`custom-select__chevron`,r.setAttribute(`aria-hidden`,`true`),r.textContent=`▾`;let i=document.createElement(`span`);i.className=`custom-select__label`;let a=document.createElement(`div`);a.className=`custom-select__list hidden`,a.setAttribute(`role`,`listbox`);let o=e.id;o&&(n.id=o,e.removeAttribute(`id`));let s=e.getAttribute(`aria-label`)?null:document.querySelector(`label[for="${o}"]`)?.id;s?n.setAttribute(`aria-labelledby`,s):e.getAttribute(`aria-label`)&&n.setAttribute(`aria-label`,e.getAttribute(`aria-label`)),e.classList.add(`custom-select__native`),e.tabIndex=-1,e.setAttribute(`aria-hidden`,`true`),e.parentNode.insertBefore(t,e),t.appendChild(e),t.appendChild(n),n.appendChild(i),n.appendChild(r),t.appendChild(a);let c=!1,l=-1;function u(){return[...e.options]}function d(){return e.options[e.selectedIndex]??null}function f(){let r=d();i.textContent=r?.textContent?.trim()||`Select…`,n.disabled=e.disabled,t.classList.toggle(`custom-select--disabled`,e.disabled),a.querySelectorAll(`.custom-select__option`).forEach(t=>{let n=t.dataset.value===e.value;t.classList.toggle(`custom-select__option--selected`,n),t.setAttribute(`aria-selected`,n?`true`:`false`)})}function p(t){let n=Object.getOwnPropertyDescriptor(HTMLSelectElement.prototype,t);!n?.set||!n?.get||Object.defineProperty(e,t,{configurable:!0,enumerable:n.enumerable,get(){return n.get.call(this)},set(e){n.set.call(this,e),f()}})}p(`value`),p(`selectedIndex`),p(`disabled`);function m(t){e.disabled||(e.value=t.value,e.dispatchEvent(new Event(`change`,{bubbles:!0})),f(),v())}function h(){a.innerHTML=``;for(let e of u()){let t=document.createElement(`button`);t.type=`button`,t.className=`custom-select__option`,t.setAttribute(`role`,`option`),t.dataset.value=e.value,t.textContent=e.textContent?.trim()||e.value,t.addEventListener(`click`,t=>{t.stopPropagation(),m(e)}),a.appendChild(t)}f()}function g(e){let t=[...a.querySelectorAll(`.custom-select__option`)];t.length&&(l=Math.max(0,Math.min(e,t.length-1)),t.forEach((e,t)=>{e.classList.toggle(`custom-select__option--active`,t===l)}),t[l]?.scrollIntoView({block:`nearest`}))}function ee(){a.classList.remove(`custom-select__list--above`);let e=n.getBoundingClientRect(),t=Math.min(256,window.innerHeight*.5),r=window.innerHeight-e.bottom,i=e.top;r<t*.65&&i>r&&a.classList.add(`custom-select__list--above`)}function _(){c||e.disabled||(or(b),c=!0,ar.add(b),a.classList.remove(`hidden`),t.classList.add(`custom-select--open`),n.setAttribute(`aria-expanded`,`true`),ee(),g(Math.max(0,e.selectedIndex)),document.addEventListener(`click`,x),document.addEventListener(`keydown`,S))}function v(){c&&(c=!1,ar.delete(b),a.classList.add(`hidden`),t.classList.remove(`custom-select--open`),n.setAttribute(`aria-expanded`,`false`),l=-1,a.querySelectorAll(`.custom-select__option--active`).forEach(e=>{e.classList.remove(`custom-select__option--active`)}),document.removeEventListener(`click`,x),document.removeEventListener(`keydown`,S))}function y(){return c}let b={close:v,rebuild:h,isOpen:y};e._customSelectApi=b,n.addEventListener(`click`,t=>{t.stopPropagation(),!e.disabled&&(c?v():_())}),n.addEventListener(`keydown`,t=>{e.disabled||((t.key===`ArrowDown`||t.key===`ArrowUp`||t.key===`Enter`||t.key===` `)&&(t.preventDefault(),c||_(),t.key===`ArrowDown`&&g(l+1),t.key===`ArrowUp`&&g(l<=0?0:l-1),(t.key===`Enter`||t.key===` `)&&l>=0&&[...a.querySelectorAll(`.custom-select__option`)][l]?.click()),t.key===`Escape`&&v())});let x=e=>{if(!t.isConnected){v();return}t.contains(e.target)||v()},S=e=>{e.key===`Escape`&&v()},C=new MutationObserver(()=>{h()});C.observe(e,{childList:!0,subtree:!0,attributes:!0,attributeFilter:[`disabled`,`value`,`selected`]}),e.addEventListener(`change`,f);let w=e.remove.bind(e);return e.remove=function(){v(),C.disconnect(),w(),t.isConnected&&t.remove()},h(),b}function cr(e){if(!e)return null;let t=typeof e==`string`?document.getElementById(e):e;return t?t.tagName===`SELECT`?t:t.closest(`.custom-select`)?.querySelector(`select.custom-select__native`)??null:null}function lr(e=document){e.querySelectorAll(`select.select-input:not([data-custom-select-enhanced]):not([data-no-custom-select])`).forEach(e=>{sr(e)})}var ur={nudge:[`Move your piece 1 square forward-diagonally`],shield_1:[`Shield 1 turn — blocks one capture or spell hit`],shield_2:[`Shield 2 turns — cannot be captured`],forward_bolt:[`Destroy first enemy on forward diagonal (Stab)`],trickster:[`Swap up to 6 random pieces (not on back ranks)`],purify:[`Removes all debuffs from your pieces, including burn and freeze`],chain_lightning:[`Strike adjacent enemies only`,`Up to 2 kills if enemies touch each other`,`Your piece is paralyzed 2 turns`],pyromancy:[`Enemy piece + empty dark square — both burn 2 turns; fire tiles block enemies`,`You cannot cast spells on your next turn`],freeze_1:[`Enemy cannot move on their next turn`],snowball:[`Freeze an enemy piece — cannot move on its owner's next turn`],freeze_2:[`Enemy cannot move on their next turn`],deep_freeze:[`Freeze all enemies on one diagonal through your piece for 2 turns`],retreat_3:[`Backward movement for 3 turns`],bishop_2:[`Diagonal slide over empty dark squares for 2 turns`],rook_2:[`Rank/file slide over empty dark squares for 2 turns`],crown:[`Instantly crown a friendly piece`],swap_friendly:[`Swap two friendly pieces`],quick_march:[`Same piece moves again; either step may capture`],offering:[`Sacrifice a friendly piece`,`Draw 2 cards`,`Cast another spell immediately`],destroy_unshielded:[`Destroy any unshielded enemy`,`You cannot cast spells on your next turn`],revive:[`Requires a captured friendly piece`,`Place on any empty dark square on your side of the board`,`Revived piece cannot capture this turn`],blink_2:[`Teleport within 2 squares`],random_teleport:[`Jump to a random empty dark square`,`Crowned if you land on the back rank`],long_step:[`Epic: leap 2 squares diagonally (no capture)`],dash:[`Move 1 square forward-diagonally`,`Destroy enemy on landing square`],sidestep:[`Skip 2 columns on the same row`],landmine:[`Hidden trap 2 turns — destroys enemy lander`],quicksand:[`Hidden trap — freezes the next piece to land there`],detonate:[`Destroy self + adjacent enemies`],venom:[`Poison — 2 ticks destroys target`],bomb:[`Arm friendly piece`,`On next move: explodes`,`Kills all adjacent pieces`],shockwave:[`Arm friendly piece`,`On next move: paralyzes all adjacent pieces`,`1 turn — does not kill`],plague:[`Infect your piece + adjacent pieces`,`Seed spreads plague on every move`,`All infected die in 2 owner turns`],press:[`Opponent must move again after their normal move on their next turn`],mind_control:[`Convert an enemy man to your color for 2 of your turns`,`Reverts to the enemy afterward`],barrier:[`Place on any dark square`,`Blocks enemies for 2 turn cycles`],vengeance:[`Hidden trap — destroys the next enemy who captures your piece`,`Expires after 2 of your turn cycles if unused`,`Your piece survives 2 turns (blood counters), then dies`],hibernation:[`Sleep 2 turns (immobile)`,`Wake with Awoken Bear mark`,`Extra move every turn after`],fusion:[`Merge two adjacent men into one`,`Gains Awoken Bear mark`,`Extra move every turn after`],root_2:[`Enemy cannot jump/capture next turn`],silence_3:[`Suppress special movement 3 turns`],poison_3:[`Enemy dies in 3 turns — 3-turn poison bar`],deflect_1:[`Hidden trap — spell hit within 2 turns kills closest enemy instead`],last_stand:[`Hidden trap — ultra shield on capture or destroy for 3 turns`,`Expires after 1 of your turn cycles if unused`],clone:[`Your man, then adjacent empty square — copy cannot capture or be taken this turn; dies to freeze/poison/burn/plague`],deport:[`Send an enemy back to its game-start square`,`Destroys any piece already on that square`],bounty:[`Mark an enemy piece`,`When you jump-capture it, draw 2 cards`,`Spell destroys do not count`],link_fate:[`Link two enemies — when one is destroyed, the other dies too`]},dr={instant:[`Instant — no board target`],friendly:[`Target your piece`],enemy:[`Target enemy piece`],empty:[`Target empty dark square`],f_empty:[`Your piece, then destination`],f_f:[`Two friendly pieces`],f_e:[`Your piece, then enemy`],f_e_adj:[`Your piece, then adjacent enemy`],diagonal:[`Your piece, then diagonal strike`],discard_pick:[`Choose a card to discard`],e_e:[`Two enemy pieces`],column:[`Pick a board file (a–h)`]};function fr(e){let t=[];return ur[e.effect]?t.push(...ur[e.effect]):e.desc&&t.push(e.desc),dr[e.mode]&&t.push(...dr[e.mode]),(e.rarity===`epic`||e.rarity===`legendary`)&&t.push(`${e.rarity.charAt(0).toUpperCase()+e.rarity.slice(1)} spell`),[...new Set(t)]}function pr(e){return fr(e).join(` · `)}var A=70,j=60,mr=A/64,hr=j/64;function gr(e){return`<g transform="scale(${mr}, ${hr})">${e}</g>`}function _r(e){return`<g class="card-motif" opacity="0.98">${e}</g>`}function vr(e,t,n=5,r=.88){return`<circle cx="${e}" cy="${t}" r="${n}" fill="currentColor" opacity="${r}" stroke="#0f172a" stroke-width="0.8"/>`}function yr(e,t,n=4){return`<circle cx="${e}" cy="${t}" r="${n}" fill="none" stroke="currentColor" stroke-width="1.6" stroke-dasharray="3 2" opacity="0.5"/>
    <ellipse cx="${e}" cy="${t+n*.5}" rx="${n*.8}" ry="${n*.3}" fill="currentColor" opacity="0.12"/>`}function br(e,t,n=6){return`<path d="M${e-n} ${t-n} L${e+n} ${t+n} M${e+n} ${t-n} L${e-n} ${t+n}" stroke="#0f172a" stroke-width="3.6" stroke-linecap="round" opacity="0.4"/>
    <path d="M${e-n} ${t-n} L${e+n} ${t+n} M${e+n} ${t-n} L${e-n} ${t+n}" stroke="currentColor" stroke-width="2.6" stroke-linecap="round"/>`}function xr(e,t,n=5){return`<ellipse cx="${e}" cy="${t+n*.55}" rx="${n*1.1}" ry="${n*.35}" fill="#000" opacity="0.28"/>
  ...
  <ellipse cx="${e-n*.28}" cy="${t-n*.32}" rx="${n*.42}" ry="${n*.28}" fill="#fca5a5" opacity="0.55"/>
    ...
    <ellipse cx="${e}" cy="${t}" rx="${n}" ry="${r}" fill="#000" opacity="0.32"/>`}function P(e,t=`#e2e8f0`,n=.55){return e.map(([e,r,i=1])=>{let a=i*2.2;return`<path d="M${e} ${r-a} L${e+a*.3} ${r-a*.3} L${e+a} ${r} L${e+a*.3} ${r+a*.3} L${e} ${r+a} L${e-a*.3} ${r+a*.3} L${e-a} ${r} L${e-a*.3} ${r-a*.3} Z" fill="${t}" opacity="${n}"/>`}).join(``)}function F(e,t,n=5.5){return`${Dr(e,t,n)}
    ...
    <circle cx="${e}" cy="${t}" r="${n+4.5}" fill="none" stroke="#93c5fd" stroke-width="0.7" opacity="0.15"/>`}function I(e,t,n=5.5){return`${xr(e,t,n)}
    ...
    <path d="M${n} ${r} L${n-l*7+d*4} ${r-u*7+f*4} M${n} ${r} L${n-l*7-d*4} ${r-u*7-f*4}" stroke="${i}" stroke-width="${a}" fill="none" stroke-linecap="round"/>`}function Sr(e,t,n,r,i=`#93c5fd`,a=2){let o=(e+n)/2,s=(t+r)/2-8;return`<path d="M${e} ${t} Q${o} ${s} ${n} ${r}" stroke="#0f172a" stroke-width="${a+2.4}" fill="none" opacity="0.22"/>
    <path d="M${e} ${t} Q${o} ${s} ${n} ${r}" stroke="${i}" stroke-width="${a+1}" fill="none" opacity="0.28"/>
    <path d="M${e} ${t} Q${o} ${s} ${n} ${r}" stroke="${i}" stroke-width="${a}" fill="none" stroke-linecap="round"/>`}function Cr(e,t,n=`#60a5fa`,r=`#93c5fd`,i=``){let a=i?` filter="url(#${i})"`:``;return`<path d="M${e} ${t-14} L${e+11} ${t-6} L${e+11} ${t+8} C${e+11} ${t+16} ${e} ${t+22} ${e} ${t+22} C${e} ${t+22} ${e-11} ${t+16} ${e-11} ${t+8} L${e-11} ${t-6} Z" fill="${n}" opacity="0.48" stroke="#0f172a" stroke-width="2.2"${a}/>
    ...
    <path d="M${e-2} ${t-8} L${e+3} ${t-3}" stroke="#fff" stroke-width="1.2" opacity="0.35" stroke-linecap="round"/>`}function wr(e,t,n=28,r=!0){return`<rect x="${e-n/2}" y="${t-n/2}" width="${n}" height="${n}" rx="3" fill="#1c1917" opacity="0.65" stroke="#57534e" stroke-width="1.6"/>
    ...
    <rect x="${e-n/2+2}" y="${t-n/2+2}" width="${n-4}" height="${n-4}" rx="1" fill="none" stroke="#78716c" stroke-width="0.9" opacity="0.35"/>`}function Tr(e,t,n=5,r=`#c4b5fd`){return`<circle cx="${e}" cy="${t}" r="${n+5}" fill="${r}" opacity="0.1"/>
    <circle cx="${e}" cy="${t}" r="${n+2}" fill="none" stroke="${r}" stroke-width="0.8" opacity="0.35"/>
    <path d="M${e} ${t-n} L${e+n*.6} ${t-n*.2} L${e+n} ${t+n*.4} L${e+n*.3} ${t+n} L${e-n*.3} ${t+n} L${e-n} ${t+n*.4} L${e-n*.6} ${t-n*.2} Z" fill="none" stroke="${r}" stroke-width="1.4" opacity="0.72"/>`}function Er(e,t,n,r){let i=`lg-${e}`;return`<defs>
  ...
  ${gr(r)}`}function z(e,t,n,r){let i=`cm-${e}`,a=`cm-vig-${e}`;return`<defs>
  ...
  <g filter="url(#${i}-glow)">${gr(r)}</g>`}function B(e,t,n,r){let i=`uc-${e}`,a=`uc-vig-${e}`;return`<defs>
  ...
  <rect width="${A}" height="${j}" fill="url(#${a})"/>
  <g filter="url(#${i}-glow)">${gr(r)}</g>`}function V(e,t,n,r){let i=`ra-${e}`,a=`ra-vig-${e}`;return`<defs>
  ...
  <rect width="${A}" height="${j}" fill="url(#${a})"/>
  <g filter="url(#${i}-glow)">${gr(r)}</g>`}function H(e,t,n,r){let i=`ep-${e}`;return`<defs>
  ...
  <rect width="${A}" height="${j}" fill="url(#${i})"/>
  ${gr(r)}`}function Dr(e,t,n=5){return`<ellipse cx="${e}" cy="${t+n*.55}" rx="${n*1.1}" ry="${n*.35}" fill="#000" opacity="0.28"/>
    ...
    <path d="M${e-n*.35} ${t+n*.15} Q${e} ${t+n*.45} ${e+n*.35} ${t+n*.15}" fill="none" stroke="#1e40af" stroke-width="1.2" opacity="0.45"/>`}var Or=new Set(`nudge.backstep.retreat_3.anchor_2.recall.repel.leapfrog.random_teleport.rally.coin_flip.ignore.iron_will.demote.quicksand.create_foe.barrier.panic.swap_friendly.sidestep.press.shield_1.snowball.long_step.shield_2.poison_3.deflect_1.forward_bolt.crown.blink_2.landmine.reverse_only_2.root_2.sacrifice.scatter.mass_nudge.sanctuary_pulse.last_stand.cryo_bolt.collapse.last_king.snipe.dominion.backstab.bomb.berserk.bounty.chain_lightning.clone.confusion.constitution.counterspell.cull.deep_freeze.deport.destroy_unshielded.duel.earthquake.execution.hostile_swap.link_fate.magnet.mind_control.purify.pyromancy.quick_march.revive.shockwave.plague.bishop_2.rook_2.offering.tangle.call_forward.dash.blizzard.bulwark.darkness.fortify.hibernation.vengeance.sanctuary.fusion.chameleon.blind.trickster.displacement`.split(`.`));function kr(e){return Or.has(e)}function Ar(){return`${N(32,54,20,4)}
    ...
    <path d="M14 20 L18 16 M50 18 L54 14" stroke="#fca5a5" stroke-width="1.4" stroke-linecap="round" opacity="0.55"/>`}function jr(){return`${N(32,56,20,4)}
    ...
    <circle cx="14" cy="14" r="2" fill="#fbbf24" opacity="0.6"/><circle cx="54" cy="16" r="1.5" fill="#fde68a" opacity="0.5"/>`}function Mr(){return`${N(32,56,24,5)}
    ...
    ${P([[48,8,.8],[10,10,.7],[56,20,.9],[6,24,.6]],`#e0f2fe`,.7)}`}function Nr(){return`${N(32,54,18,4)}
    ...
    <path d="M10 24 L14 28 L8 32 M54 26 L50 30 L56 34" stroke="#a5b4fc" stroke-width="1.4" fill="none" opacity="0.7"/>`}function Pr(){return`${N(32,54,18,4)}
    ...
    ${P([[16,12,.7],[52,14,.8],[44,8,.6]],`#fde68a`,.65)}`}function Fr(){return`${N(32,54,22,4)}
    ...
    ${P([[20,10,.9],[44,12,.8],[32,6,1.1],[14,24,.7],[50,22,.7]],`#bbf7d0`,.65)}`}function Ir(){return`${N(32,56,24,5)}
  ...
  <path d="M14 54 L18 50 M50 54 L46 50 M54 14 L50 18 M10 14 L14 18" stroke="#d6d3d1" stroke-width="1.8" stroke-linecap="round" opacity="0.65"/>
    <path d="M8 32 L14 32 M50 32 L56 32 M32 8 L32 14 M32 50 L32 56" stroke="#a8a29e" stroke-width="1.4" stroke-linecap="round" opacity="0.4"/>`}function Lr(){return`${N(32,54,22,4)}
    ${I(46,28,5.5)} ${br(46,28,6)}
    ${F(18,46,5.5)}
    ...
    ${P([[34,14,.9],[40,20,.7],[28,18,.8]],`#fca5a5`,.6)}`}function Rr(){return`${N(32,56,16,4)}
    ${I(32,52,6)}
    ...
    ${Tr(50,10,4,`#e9d5ff`)}
    ${P([[12,6,.8],[48,8,1],[22,4,.7],[36,44,.9]],`#e9d5ff`,.65)}`}function zr(){let e=(e,t,n)=>`<g transform="translate(${e}, 40) scale(${t?-1:1}, 1)">
    ...
    ${P([[32,24,1],[26,20,.7],[38,20,.7]],`#fde68a`,.7)}`}function Br(){return`${N(36,56,18,4)}
    ${I(42,52,6)}
    ...
    ${P([[38,38,.7],[46,46,.6]],`#fca5a5`,.55)}`}function Vr(){return`${N(32,54,22,4)}
    ...
    ${P([[34,36,.7],[38,44,.6],[32,22,.8]],`#fde68a`,.6)}`}function Hr(){return`${N(32,54,20,4)}
    ${F(32,42,6)}
    ...
    ${P([[32,8,.8],[20,32,.6],[44,32,.6]],`#bae6fd`,.55)}`}function Ur(){return`${N(32,54,22,4)}
    ${F(32,36,6)}
    ...
    ${P([[32,14,.9],[8,36,.7],[56,36,.7]],`#e9d5ff`,.6)}`}function Wr(){return`${N(32,54,22,4)}
    ${F(32,36,6)}
    ...
    ${P([[32,22,.85],[10,24,.6],[54,24,.6]],`#86efac`,.55)}`}function Gr(){return`${N(32,54,22,4)}
    ${I(48,32,6)}
    ...
    ${P([[22,20,.8],[36,28,.7],[36,36,.7]],`#e9d5ff`,.6)}`}function Kr(){return`${N(32,54,18,4)}
    ${I(32,36,6)}
    ...
    ${P([[16,20,.8],[48,38,.7],[32,10,.9]],`#e9d5ff`,.6)}`}function qr(){return`${N(32,54,20,4)}
    ...
    ${P([[14,14,.8],[48,16,.7],[32,8,.9]],`#e9d5ff`,.6)}`}function Jr(){return`${N(32,54,22,4)}
    ${F(32,50,5)}
    ...
    ${P([[50,10,1],[12,52,.8],[40,20,.7]],`#e0f2fe`,.7)}`}function Yr(){return`${N(32,54,22,4)}
    ...
    ${P([[20,12,.9],[44,12,.8],[32,4,1],[14,28,.7],[50,28,.7]],`#fff`,.55)}`}function Zr(){return`${N(32,56,18,4)}
    ...
    ${P([[14,10,.7],[50,10,.7],[32,28,.8]],`#fde68a`,.6)}`}function Qr(){return`${N(32,54,22,4)}
    ...
    ${Tr(32,36,4,`#e9d5ff`)}
    ${P([[32,28,.8],[32,44,.7]],`#e9d5ff`,.6)}`}function $r(){return`${N(32,54,20,4)}
    ${F(22,38,5.5)}
    ...
    ${P([[36,32,.7],[48,34,.6],[42,28,.8]],`#e9d5ff`,.55)}`}function ei(){return`${N(32,56,18,4)}
    ${F(32,42,6)}
  ...
  ${gr(`<ellipse cx="32" cy="56" rx="20" ry="4" fill="#000" opacity="0.35"/>
  ...
  ${xr(14,50,3.2)}${Dr(50,50,3.2)}`)}`}function ni(){return`${N(24,54,20,4)}
    ${I(48,20,5.5)}
    ...
    ${P([[18,32,.8],[28,28,.6]],`#e9d5ff`,.55)}`}function ri(){return`${N(28,54,18,4)}
    ${F(22,44,5.5)}
    ...
    ${P([[30,8,.8],[52,6,.7],[24,28,.6]],`#e9d5ff`,.6)}`}function ii(){return`${N(32,52,22,4)}
    ...
    ${P([[32,34,.9],[16,14,.7],[48,14,.7]],`#e0f2fe`,.6)}`}function ai(){return`${N(32,54,18,4)}
    ${F(32,48,5.5)}
    ...
    ${P([[12,18,.7],[52,18,.7],[32,36,.6]],`#e9d5ff`,.55)}`}function oi(){return`${N(32,54,18,4)}
    ${F(32,48,5.5)}
    ...
    ${P([[32,6,.7],[4,44,.6],[60,44,.6]],`#e9d5ff`,.55)}`}function si(){return`${N(30,52,20,4)}
    ${I(46,20,5.5)}
    ...
    ${P([[36,26,.7],[22,38,.6]],`#fca5a5`,.5)}`}function ci(){return`${N(30,54,18,4)}
    ${F(18,50,5)}
    ${I(44,28,5)}
    ...
    ${P([[38,34,.7]],`#e9d5ff`,.5)}`}function li(){return`${N(32,54,26,4)}
    ...
    ${P([[8,10,.8],[56,12,.9],[32,18,.7]],`#e0f2fe`,.65)}`}function ui(){return`${N(32,54,22,4)}
    ...
    ${Cr(32,34,`#7c3aed`,`#e9d5ff`)}
    ${P([[20,40,.7],[44,24,.7],[32,28,.8]],`#e9d5ff`,.55)}`}function di(){return`${N(32,54,24,4)}
    ...
    ${P([[16,10,.7],[48,10,.7],[10,32,.6],[54,32,.6]],`#c4b5fd`,.45)}`}function fi(){return`${N(32,56,16,4)}
    ${F(32,34,6)}
    ...
    ${Cr(32,30,`#7c3aed`,`#e9d5ff`)}
    <text x="18" y="54" font-size="7" fill="#ddd6fe" opacity="0.8" font-weight="700">HOLD</text>
    ${P([[32,12,.8],[12,34,.6],[52,34,.6]],`#e9d5ff`,.5)}`}function pi(){return`${N(32,56,16,4)}
    ${F(32,38,6)}
    ...
    ${P([[32,4,.8],[18,8,.6],[46,8,.6]],`#fde68a`,.55)}`}function mi(){return`${N(30,54,18,4)}
    ${F(28,36,6)}
    ...
    ${P([[12,12,.7],[46,18,.6]],`#fca5a5`,.5)}`}function hi(){return`${N(32,54,20,4)}
    ...
    ${P([[32,8,.8],[14,28,.6],[50,28,.6]],`#e9d5ff`,.5)}`}function gi(){return`${N(32,54,20,4)}
    ...
    <path d="M24 50 C30 44 34 44 40 50" stroke="#fde68a" stroke-width="2" fill="none" opacity="0.7"/>
    ${M(32,14,5,`#fde68a`,`#b45309`)}
    ${P([[24,36,.7],[40,36,.7],[32,8,.9]],`#fde68a`,.6)}`}function _i(){return`${N(32,54,18,4)}
    ${F(32,34,6)}
    ...
    ${P([[32,12,.8],[8,34,.6],[56,34,.6]],`#e9d5ff`,.55)}`}function vi(){return`${N(32,54,20,4)}
    ...
    ${P([[46,16,.7],[24,20,.5]],`#c4b5fd`,.45)}`}function yi(){return`${N(32,54,24,4)}
    ...
    ${P([[8,8,.7],[56,8,.7],[8,56,.7],[56,56,.7]],`#fde68a`,.6)}`}function bi(){return`${N(28,54,18,4)}
    ${F(18,44,5.5)}
    ${L(42,24,6,`#cbd5e1`)}
    ...
    ${P([[40,20,.7],[22,36,.5]],`#e2e8f0`,.45)}`}function xi(){return`${N(32,54,16,4)}
    ${F(32,20,5.5)}
    ${L(32,48,6,`#cbd5e1`)}
    ...
    ${P([[32,16,.6],[32,44,.5]],`#cbd5e1`,.4)}`}function Si(){return`${N(32,54,16,4)}
    ${F(32,26,5.5)}
    ...
    ${P([[32,22,.6]],`#93c5fd`,.4)}`}function Ci(){return`${N(32,54,20,4)}
    ...
    ${P([[32,6,.7]],`#cbd5e1`,.4)}`}function wi(){return`${N(32,54,22,4)}
    ${F(32,24,5.5)}
    ...
    ${P([[20,40,.5],[44,40,.5]],`#93c5fd`,.4)}`}function Ti(){return`${N(30,54,20,4)}
    ${F(20,36,5)}${I(40,36,5)}
    ${L(54,36,5,`#fca5a5`)}
    ...
    ${P([[48,32,.6]],`#fde68a`,.45)}`}function Ei(){return`${N(28,54,20,4)}
    ...
    ${P([[30,14,.8],[20,38,.5]],`#bae6fd`,.5)}`}function Di(){return`${N(32,54,18,4)}
    ${F(32,40,5.5)}
    ...
    ${P([[24,12,.8],[48,20,.7],[32,6,.9]],`#e9d5ff`,.55)}`}function Oi(){return`${N(32,54,22,4)}
    ...
    ${P([[32,10,.8],[16,40,.5],[48,40,.5]],`#93c5fd`,.45)}`}function ki(){return`${N(32,54,16,4)}
    ${F(32,36,6)}
    ...
    ${P([[16,12,.6]],`#fca5a5`,.4)}`}function Ai(){return`${N(32,54,18,4)}
    ${F(32,34,6)}
    ...
    ${P([[32,20,.7]],`#e2e8f0`,.4)}`}function ji(){return`${N(32,54,16,4)}
    ${I(32,40,6)}
    ...
    ${P([[24,4,.6],[40,4,.6]],`#fde68a`,.45)}`}function Mi(){return`${N(32,54,18,4)}
    ${wr(32,36,32)}
    ...
    ${P([[30,36,.5]],`#d6d3d1`,.35)}`}function Ni(){return`${N(32,54,16,4)}
    ...
    ${P([[46,10,.7]],`#fca5a5`,.5)}`}function Pi(){return`${N(32,54,16,4)}
    ...
    ${P([[32,20,.5],[32,40,.5]],`#cbd5e1`,.35)}`}function Fi(){return`${N(32,54,16,4)}
    ${I(32,22,6)}
    ...
    ${P([[28,16,.6],[36,16,.6]],`#fca5a5`,.45)}`}function Ii(){return`${N(32,54,20,4)}
    ...
    ${Tr(32,34,4,`#c4b5fd`)}
    ${P([[32,30,.7]],`#e9d5ff`,.45)}`}function Li(){return`${N(28,54,18,4)}
    ${F(12,34,5.5)}
    ${L(50,34,6,`#cbd5e1`)}
    ...
    ${P([[46,30,.6]],`#e2e8f0`,.4)}`}function Ri(){return`${N(32,54,18,4)}
    ${I(32,28,6)}
    ...
    ${M(32,52,5,`#fca5a5`,`#dc2626`)}`}function zi(){return`${N(32,56,16,4)}
    ${F(32,38,6)}
    ${Cr(32,30,`#60a5fa`,`#93c5fd`)}
    ...
    ${P([[32,18,.7],[20,32,.5],[44,32,.5]],`#bae6fd`,.4)}`}function Bi(){return`${N(32,54,18,4)}
    ${F(32,36,6)}
    ...
    ${P([[14,10,.7],[20,22,.5]],`#e0f2fe`,.5)}`}function Vi(){return`${N(30,54,20,4)}
    ${F(14,50,5.5)}
    ${L(50,14,6,`#7dd3fc`)}
    ...
    ${P([[48,12,.7],[24,38,.5]],`#bae6fd`,.45)}`}function Hi(){return`${N(32,56,16,4)}
    ${F(32,38,6)}
    ${Cr(32,28,`#38bdf8`,`#7dd3fc`)}
    ...
    ${P([[32,14,.8],[14,34,.5],[50,34,.5]],`#bae6fd`,.45)}`}function Ui(){return`${N(32,54,16,4)}
    ${I(32,34,6)}
    ...
    ${P([[32,10,.7],[28,44,.5],[36,44,.5]],`#86efac`,.45)}`}function Wi(){return`${N(26,54,16,4)}
    ${F(24,38,5.5)}
    ...
    ${P([[48,10,.6]],`#fde68a`,.45)}`}function Gi(){return`${N(30,54,18,4)}
    ...
    ${P([[42,20,.7]],`#fde68a`,.5)}`}function Ki(){return`${N(32,56,16,4)}
    ${F(32,40,6)}
    ...
    ${P([[22,4,.7],[32,0,.8],[42,4,.7]],`#fde68a`,.6)}`}function qi(){return`${N(30,54,20,4)}
    ...
    ${P([[46,12,.8],[24,40,.5]],`#e0f2fe`,.5)}`}function Ji(){return`${N(32,54,16,4)}
    ${wr(32,36,32)}
    ...
    ${P([[32,24,.6]],`#fca5a5`,.4)}`}function Yi(){return`${N(32,54,18,4)}
    ${I(32,20,6)}
    ...
    ${P([[32,44,.5]],`#fca5a5`,.4)}`}function Xi(){return`${N(32,54,16,4)}
    ${I(32,24,6)}
  ...
  <path d="M28 48 L24 54 M36 48 L40 54" stroke="#86efac" stroke-width="1.4" stroke-linecap="round" opacity="0.35"/>
    ${P([[20,40,.5],[44,40,.5]],`#86efac`,.4)}`}function Zi(){return`${N(30,54,20,4)}
    ...
    ${M(48,22,5,`#ef4444`,`#991b1b`)}`}function Qi(){return`${N(32,54,18,4)}
    ...
    ${P([[32,8,.6],[56,32,.6],[32,56,.6],[8,32,.6]],`#bae6fd`,.4)}`}function $i(){return`${N(26,54,20,4)}
    ...
    ${P([[8,20,.6],[42,20,.6]],`#bae6fd`,.4)}`}function ea(){return`${N(32,54,22,4)}
    ...
    ${P([[44,10,.75],[30,28,.55],[20,46,.5]],`#e9d5ff`,.5)}`}function ta(){return`${N(32,54,24,4)}
    ...
    ${P([[32,28,.7],[12,38,.5],[52,38,.5]],`#bae6fd`,.45)}`}function na(){return`${N(32,56,14,3)}
    ${F(32,34,6)}
    ${Cr(32,28,`#38bdf8`,`#7dd3fc`)}
    ...
    <text x="10" y="18" font-size="6" fill="#e9d5ff" opacity="0.55">?</text>`}function ra(){return`${N(30,54,18,3.5)}
    ...
    <circle cx="42" cy="22" r="8" fill="#7dd3fc" opacity="0.12"/>`}function ia(){return`${N(32,54,14,3.5)}
    ${wr(32,36,30,!1)}
    ${Dr(32,34,4)}
    ...
    <path d="M24 38 L28 42 M36 38 L40 42" stroke="#d6d3d1" stroke-width="1.2" stroke-linecap="round" opacity="0.4"/>`}function aa(){return`${N(32,56,14,3)}
    ${F(32,38,7)}
    ...
    ${Cr(32,34,`#38bdf8`,`#7dd3fc`)}
    <circle cx="32" cy="12" r="4" fill="#fde68a" opacity="0.3"/>`}function oa(){return`${N(32,54,20,4)}
    ...
    <path d="M18 44 L22 40 M46 18 L50 14" stroke="#fbbf24" stroke-width="1.2" stroke-linecap="round" opacity="0.45"/>`}function sa(){return`${N(32,54,18,3.5)}
    ...
    <circle cx="32" cy="40" r="14" fill="none" stroke="#60a5fa" stroke-width="0.8" opacity="0.2"/>`}var ca={nudge:()=>z(`nu`,`#94a3b8`,`#1e293b`,bi()),backstep:()=>z(`bs`,`#9ca3af`,`#1f2937`,xi()),retreat_3:()=>z(`ret`,`#93c5fd`,`#1e3a5f`,Si()),leapfrog:()=>z(`lf`,`#94a3b8`,`#1e293b`,Ei()),long_step:()=>B(`ls`,`#7dd3fc`,`#1e3a5f`,Vi()),sidestep:()=>z(`ss`,`#9ca3af`,`#1f2937`,Li()),blink_2:()=>B(`bl`,`#38bdf8`,`#0c4a6e`,qi()),random_teleport:()=>z(`rtp`,`#a78bfa`,`#312e81`,Di()),recall:()=>z(`rc`,`#93c5fd`,`#1e3a5f`,wi()),repel:()=>z(`rp`,`#94a3b8`,`#1e293b`,Ti()),mass_nudge:()=>B(`mn`,`#7dd3fc`,`#1e3a5f`,$i()),displacement:()=>V(`dp`,`#b794f4`,`#553c7a`,ea()),swap_friendly:()=>z(`sw`,`#a78bfa`,`#312e81`,Ii()),dominion:()=>B(`dm`,`#60a5fa`,`#1e3a5f`,sa()),shield_1:()=>z(`s1`,`#60a5fa`,`#1e3a5f`,zi()),shield_2:()=>B(`s2`,`#38bdf8`,`#0c4a6e`,Hi()),bulwark:()=>V(`bw`,`#b794f4`,`#553c7a`,ui()),barrier:()=>z(`br`,`#94a3b8`,`#1f2937`,Pi()),last_stand:()=>B(`ls`,`#38bdf8`,`#0c4a6e`,na()),fortify:()=>V(`fo`,`#a78bfa`,`#4c1d95`,fi()),sanctuary_pulse:()=>B(`sp`,`#7dd3fc`,`#1e3a5f`,ta()),sanctuary:()=>V(`sa`,`#c4b5fd`,`#4c1d95`,hi()),deflect_1:()=>B(`df`,`#38bdf8`,`#0c4a6e`,Wi()),anchor_2:()=>z(`an`,`#94a3b8`,`#1f2937`,Ci()),iron_will:()=>z(`iw`,`#9ca3af`,`#1f2937`,Ai()),vengeance:()=>V(`vg`,`#9f7aea`,`#3b0764`,mi()),rally:()=>z(`rl`,`#60a5fa`,`#1e3a5f`,Oi()),forward_bolt:()=>B(`fb`,`#fde68a`,`#1e3a5f`,Gi()),destroy_unshielded:()=>Er(`sh`,`#4338ca`,`#1e1b4b`,Nr()),pyromancy:()=>Er(`py`,`#ea580c`,`#431407`,Pr()),snipe:()=>B(`sn`,`#fde68a`,`#1e3a5f`,oa()),duel:()=>z(`du`,`#d4b896`,`#3d2817`,zr()),sacrifice:()=>B(`sc`,`#fca5a5`,`#1e3a5f`,Zi()),cull:()=>H(`cu`,`#a78bfa`,`#2e1065`,Rr()),execution:()=>H(`ex`,`#6ee7b7`,`#14532d`,Br()),chain_lightning:()=>Er(`cl`,`#2563eb`,`#0c1929`,Mr()),backstab:()=>B(`bk`,`#c4a574`,`#2d4a6e`,Ar()),cryo_bolt:()=>B(`cb`,`#7dd3fc`,`#0c4a6e`,ra()),bomb:()=>Er(`bm`,`#f59e0b`,`#78350f`,jr()),shockwave:()=>H(`sw`,`#c4b5fd`,`#3b1f6e`,Ur()),plague:()=>H(`pg`,`#86efac`,`#14532d`,Wr()),magnet:()=>H(`mg`,`#6ee7b7`,`#14532d`,Vr()),poison_3:()=>B(`po`,`#86efac`,`#14532d`,Ui()),root_2:()=>B(`ro`,`#86efac`,`#14532d`,Xi()),panic:()=>z(`pn`,`#fca5a5`,`#1f2937`,Fi()),blizzard:()=>V(`bz`,`#7dd3fc`,`#1e3a5f`,li()),snowball:()=>z(`sb`,`#bae6fd`,`#0c4a6e`,Bi()),berserk:()=>Er(`bk`,`#991b1b`,`#450a0a`,Lr()),create_foe:()=>z(`cf`,`#78716c`,`#292524`,Ni()),deep_freeze:()=>H(`df`,`#7dd3fc`,`#0c4a6e`,Jr()),reverse_only_2:()=>B(`rv`,`#fca5a5`,`#1e3a5f`,Yi()),press:()=>z(`pr`,`#fca5a5`,`#1f2937`,Ri()),tangle:()=>V(`tg`,`#93c5fd`,`#312e81`,ii()),blind:()=>V(`bl`,`#a78bfa`,`#4c1d95`,vi()),confusion:()=>H(`cf`,`#c4b5fd`,`#4c1d95`,Kr()),fog_2:()=>_r(`${vr(32,34,6)}<ellipse cx="32" cy="24" rx="16" ry="8" fill="currentColor" opacity="0.22"/>`),crown:()=>B(`cr`,`#fbbf24`,`#451a03`,Ki()),demote:()=>z(`dm`,`#fca5a5`,`#1f2937`,ji()),fusion:()=>V(`fu`,`#8b5cf6`,`#4c1d95`,gi()),clone:()=>H(`cln`,`#93c5fd`,`#312e81`,$r()),chameleon:()=>V(`ch`,`#86efac`,`#312e81`,_i()),hibernation:()=>V(`hi`,`#c4b5fd`,`#4c1d95`,pi()),quicksand:()=>z(`qs`,`#a8a29e`,`#292524`,Mi()),landmine:()=>B(`lm`,`#78716c`,`#292524`,Ji()),collapse:()=>z(`co`,`#78716c`,`#292524`,ia()),darkness:()=>V(`dk`,`#6d28d9`,`#1e1b4b`,di()),scatter:()=>B(`st`,`#7dd3fc`,`#1e3a5f`,Qi()),call_forward:()=>V(`cfw`,`#fca5a5`,`#4c1d95`,si()),dash:()=>V(`ds`,`#c4b5fd`,`#4c1d95`,ci()),earthquake:()=>Er(`eq`,`#78716c`,`#292524`,Ir()),coin_flip:()=>ti(),ignore:()=>z(`ig`,`#94a3b8`,`#1f2937`,ki()),counterspell:()=>H(`cs`,`#a78bfa`,`#2e1065`,qr()),purify:()=>H(`pu`,`#6ee7b7`,`#14532d`,Xr()),trickster:()=>V(`tr`,`#c4b5fd`,`#553c7a`,yi()),offering:()=>V(`of`,`#d8b4fe`,`#553c7a`,ri()),quick_march:()=>H(`qm`,`#60a5fa`,`#1e3a5f`,Hr()),constitution:()=>H(`co`,`#4ade80`,`#14532d`,ei()),last_king:()=>B(`lk`,`#fbbf24`,`#1e3a5f`,aa()),revive:()=>Er(`rv`,`#15803d`,`#052e16`,Fr()),mind_control:()=>H(`mc`,`#c4b5fd`,`#3b0764`,Gr()),bounty:()=>H(`bo`,`#4ade80`,`#14532d`,Zr()),link_fate:()=>H(`lf`,`#a78bfa`,`#2e1065`,Qr()),bishop_2:()=>V(`bp`,`#b794f4`,`#4c1d95`,ai()),rook_2:()=>V(`rk`,`#a78bfa`,`#4c1d95`,oi()),hostile_swap:()=>H(`hs`,`#93c5fd`,`#312e81`,Yr()),deport:()=>H(`dp`,`#c4b5fd`,`#1e1b4b`,ni())};function la(e,t=0){let n=ca[e.effect];return n?n(t):null}var ua={movement:{symbol:`↗`,label:`Motion`,anim:`movement`},combat:{symbol:`⚔`,label:`Strike`,anim:`combat`},defense:{symbol:`🛡`,label:`Ward`,anim:`defense`},debuff:{symbol:`❄`,label:`Curse`,anim:`debuff`},transform:{symbol:`✦`,label:`Morph`,anim:`transform`},board:{symbol:`◇`,label:`Terrain`,anim:`board`},crown:{symbol:`♔`,label:`Royal`,anim:`crown`},arcane:{symbol:`✧`,label:`Arcane`,anim:`arcane`}},da=[[`movement`,[`nudge`,`backstep`,`long_step`,`leapfrog`,`recall`,`teleport`,`random_teleport`,`displacement`,`berserk`,`dash`]],[`combat`,[`stab`,`shatter`,`destroy`,`snipe`,`duel`,`execution`,`cull`,`pyromancy`,`backstab`,`sacrifice`,`chain_lightning`,`cryo`,`bomb`,`magnet`]],[`special`,[`create_foe`,`clone`,`earthquake`]],[`defense`,[`shield`,`ward`,`aegis`,`bulwark`,`stall`,`sanctuary`,`barrier`,`anchor`,`iron_will`,`hibernation`,`constitution`]],[`debuff`,[`root`,`panic`,`backpedal`,`blizzard`,`deep_freeze`,`snowball`,`blind`,`confusion`,`press`,`tangle`,`shockwave`]],[`board`,[`quicksand`,`landmine`,`collapse`,`darkness`,`earthquake`,`scatter`,`call_forward`]],[`meta`,[`counterspell`,`vengeance`,`last_stand`,`purify`,`trickster`,`ignore`,`offering`,`quick_march`,`dominion`,`last_king`,`revive`,`mind_control`]]];function fa(e){let t=0;for(let n=0;n<e.length;n++)t=(t+e.charCodeAt(n)*41)%360;return t}function pa(e){let t=0;for(let n=0;n<e.length;n++)t=(t+e.charCodeAt(n)*13)%3;return t}function ma(e){let t=`${e.id} ${e.effect} ${e.name}`.toLowerCase();for(let[e,n]of da)if(Array.isArray(n)&&n.some(e=>t.includes(e)))return e;return`arcane`}function ha(e){return`ca${String(e).replace(/[^a-zA-Z0-9]/g,``)}`}function ga(e,t,n){let r=[[12,18,.35],[48,12,.5],[52,44,.25],[18,50,.4],[38,28,.55]],i=n*4;return r.map(([e,n,r],a)=>`<circle cx="${(e+i+a*7)%56+4}" cy="${(n+i*2+a*5)%52+6}" r="1.2" fill="hsl(${t} 90% 85% / ${r})"/>`).join(``)}function _a(e,t){let n=t,r={movement:`
      ...
      </g>`};return r[e]||r.arcane}function va(e,t,n,r){return ya(e,t,n,r)}function ya(e,t,n,r){let i=ha(n),a=(t+42)%360,o=pa(n),s=r&&la(r,o)||_a(e,o);return r?.effect&&kr(r.effect)&&s?`<svg class="spell-card__svg spell-card__svg--full-bleed" viewBox="0 0 70 60" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid meet">${s}</svg>`:`<svg class="spell-card__svg" viewBox="0 0 70 60" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
  ...
  </svg>`}function ba(e){return e.tiny?`tiny`:e.small?`small`:e.compact?`compact`:`full`}function xa(e){let t=fr(e);return t.length?`<ul class="spell-card__effects">${t.map(e=>`<li>${Ta(e)}</li>`).join(``)}</ul>`:``}var Sa=new WeakMap;function Ca(e){let t=e?.querySelector?.(`.spell-card__name`),n=e?.querySelector?.(`.spell-card__title-frame`);if(!t||!n)return;let r=()=>{t.classList.add(`spell-card__name--fit`),t.style.fontSize=``,t.style.textOverflow=``,t.style.overflow=``;let e=n.clientWidth;if(e<=0)return;let r=parseFloat(getComputedStyle(t).fontSize);if(!r)return;let i=r*.55;for(;t.scrollWidth>e&&r>i;)r-=.5,t.style.fontSize=`${r}px`;t.scrollWidth>e&&(t.style.overflow=`hidden`,t.style.textOverflow=`ellipsis`)};if(r(),requestAnimationFrame(r),!Sa.has(e)&&typeof ResizeObserver<`u`){let t=new ResizeObserver(()=>r());t.observe(n),Sa.set(e,t)}}function wa(e,t={}){let n=ma(e),r=fa(e.id),i=ua[n]||ua.arcane,a=ba(t),o=!(t.hideDesc||t.gallery)&&a!==`tiny`,s=t.showViewFullHint||t.gallery,c=t.button?`button`:`div`,l=document.createElement(c);t.button&&(l.type=`button`);let u=e.rarity===`legendary`?`legendary`:e.rarity;l.className=[`spell-card`,`spell-card--${a}`,`spell-card--anim-${i.anim}`,u,e.rarity===`rare`?`spell-card--rare-fx`:``,e.rarity===`epic`?`spell-card--epic-fx`:``,e.rarity===`legendary`?`spell-card--legendary-fx`:``,e.rarity===`uncommon`?`spell-card--uncommon-fx`:``,e.rarity===`common`?`spell-card--common-fx`:``,`theme-${n}`,t.disabled?`disabled`:``,t.selected?`selected`:``,t.static?`static`:``,t.deal?`spell-card--deal`:``,t.fullDesc?`spell-card--full-desc`:``,t.gallery?`spell-card--gallery`:``].filter(Boolean).join(` `),l.style.setProperty(`--card-hue`,String(r)),l.dataset.cardId=e.id,l.title=pr(e);let d=e.rarity===`legendary`?`<div class="spell-card__fx spell-card__fx--legendary" aria-hidden="true"></div>`:e.rarity===`epic`?`<div class="spell-card__fx spell-card__fx--epic" aria-hidden="true"></div>`:e.rarity===`rare`?`<div class="spell-card__fx spell-card__fx--rare" aria-hidden="true"></div>`:e.rarity===`uncommon`?`<div class="spell-card__fx spell-card__fx--uncommon" aria-hidden="true"></div>`:e.rarity===`common`?`<div class="spell-card__fx spell-card__fx--common" aria-hidden="true"></div>`:``,f=e?.effect&&kr(e.effect);return l.innerHTML=`
    ${d}
    <div class="spell-card__frame">
      <div class="spell-card__title-frame">
        <h3 class="spell-card__name">${Ta(e.name)}</h3>
      </div>
      ...
      <div class="spell-card__type-frame${s?` spell-card__type-frame--with-hint`:``}">
        ...
        ${t.meta?`<span class="spell-card__meta">${Ta(t.meta)}</span>`:``}
      </div>
      ${o?`<div class="spell-card__text-frame"><p class="spell-card__desc">${Ta(e.desc)}</p></div>`:``}
    </div>
    <div class="spell-card__tooltip" role="tooltip">
      <strong>${Ta(e.name)}</strong>
      ${xa(e)}
    </div>
  `,t.onClick&&l.addEventListener(`click`,n=>t.onClick(n,e)),Ca(l),l}function Ta(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function Ea(e){return document.getElementById(e)}function Da(){let e=Ea(`card-preview-modal`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function Oa(e){document.body.classList.toggle(`card-preview-open`,e),window.dispatchEvent(new CustomEvent(`card-preview-change`,{detail:{open:e}}))}function ka(){Ea(`card-preview-modal`)?.classList.add(`hidden`),Ea(`card-preview-mount`)?.classList.remove(`card-preview-mount--reveal-only`),Oa(!1)}function Aa(e,t={}){Da();let n=Ea(`card-preview-modal`),r=Ea(`card-preview-mount`),i=Ea(`card-preview-actions`);if(!(!n||!r||!e)){if(r.innerHTML=``,r.classList.toggle(`card-preview-mount--reveal-only`,!!t.hideDesc),r.appendChild(wa(e,{static:!0,hideDesc:t.hideDesc})),i){if(i.innerHTML=``,t.meta){let e=document.createElement(`p`);e.className=`card-preview-meta`,e.textContent=t.meta,i.appendChild(e)}let e=document.createElement(`div`);if(e.className=`card-preview-actions-row`,t.onPlay){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=`Cast spell`,n.addEventListener(`click`,()=>{ka(),t.onPlay()}),e.appendChild(n)}if(t.onAdd){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=`Add to deck`,n.disabled=!!t.addDisabled,n.addEventListener(`click`,()=>{t.addDisabled||t.onAdd()}),e.appendChild(n)}if(t.onBuy){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=t.buyLabel||`Buy copy`,n.disabled=!!t.buyDisabled,n.addEventListener(`click`,()=>{t.buyDisabled||t.onBuy()}),e.appendChild(n)}if(t.onRemove){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-secondary`,n.textContent=`Remove all from deck`,n.addEventListener(`click`,()=>{t.onRemove(),ka()}),e.appendChild(n)}e.children.length&&i.appendChild(e)}n.classList.remove(`hidden`),Oa(!0)}}function ja(){Ea(`card-preview-close`)?.addEventListener(`click`,ka),Ea(`card-preview-backdrop`)?.addEventListener(`click`,ka),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&ka()})}function Ma(e,t=`.spell-card`){e&&e.querySelectorAll(t).forEach((e,t)=>{e.classList.add(`spell-card--deal`),e.style.animationDelay=`${t*.1}s`})}function Na(e){e&&(e.classList.add(`spell-card--rare-burst`),setTimeout(()=>e.classList.remove(`spell-card--rare-burst`),900))}function Pa(e){e&&(e.classList.add(`spell-card--epic-burst`),setTimeout(()=>e.classList.remove(`spell-card--epic-burst`),1200))}function Fa(e){e&&(e.classList.add(`spell-card--legendary-burst`),setTimeout(()=>e.classList.remove(`spell-card--legendary-burst`),1500))}function Ia(e,t){t===`legendary`?Fa(e):t===`epic`?Pa(e):t===`rare`&&Na(e)}var La={common:10,uncommon:20,rare:30,epic:40,legendary:50};function Ra(e){return La[e]??30}function za(e,r){let i=oe(e,r);if(i<1)return{success:!1,message:`Get this spell from a chest first.`};let a=n(r);if(!a)return{success:!1,message:`Unknown card.`};let o=t(r);if(i>=o)return{success:!1,message:`You already own the maximum (${o} copies).`};let s=Ra(a.rarity);if(e.gems<s)return{success:!1,message:`Need ${s} gems (${e.gems} available).`};e.gems-=s;let c=_e(e,r,1);return c?{success:!0,cost:s,message:`+1 ${a.name} for ${s} gems (${i+c} owned).`}:(e.gems+=s,E(e),{success:!1,message:`You already own the maximum copies for this rarity.`})}var Ba={deck:`<svg class="nav-icon-svg" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  </svg>`};function Va(){let e={deck:Ba.deck,chests:Ba.chests,play:Ba.play,pvp:Ba.pvp,quests:Ba.quests};for(let t of document.querySelectorAll(`.game-nav .tab-btn[data-tab]`)){let n=t.querySelector(`.tab-btn__icon`),r=t.dataset.tab;n&&e[r]&&(n.innerHTML=e[r])}}var Ha=`arcaneCheckersSettings_v1`,Ua={musicEnabled:!0,musicVolume:.45,sfxEnabled:!0,sfxVolume:.7,hapticsEnabled:!0},Wa={...Ua};function Ga(){try{let e=localStorage.getItem(Ha);return e?{...Ua,...JSON.parse(e)}:{...Ua}}catch{return{...Ua}}}function U(){return{...Wa}}function Ka(e){Wa={...Wa,...e};try{localStorage.setItem(Ha,JSON.stringify(Wa))}catch{}return window.dispatchEvent(new CustomEvent(`arcane-settings-changed`,{detail:U()})),U()}function qa(){return Wa=Ga(),U()}var Ja={hub:`assets/audio/background.m4a`,match:`assets/audio/background.m4a`},Ya={tap:`assets/audio/sfx/tap.mp3`,spell:`assets/audio/sfx/spell.mp3`,capture:`assets/audio/sfx/capture.mp3`,win:`assets/audio/sfx/win.mp3`,chest:`assets/audio/sfx/chest.mp3`},Xa=null,Za=null,Qa=`hub`,$a=!1;function eo(){return typeof Audio<`u`}function to(e,t){if(!(!eo()||!U().sfxEnabled))try{let n=new Audio(e);n.volume=Math.max(0,Math.min(1,t*U().sfxVolume)),n.play().catch(()=>{})}catch{}}function no(e){let t=Ja[e];if(!t||!eo())return null;let n=e===`hub`?Xa:Za;return n||(n=new Audio(t),n.loop=!0,n.preload=`auto`,e===`hub`?Xa=n:Za=n),n}function ro(e){e&&(e.volume=Math.max(0,Math.min(1,U().musicVolume)))}function io(){Xa?.pause(),Za?.pause()}function ao(){$a||!eo()||($a=!0,[Xa,Za].forEach(e=>{e&&e.play().then(()=>e.pause()).catch(()=>{})}))}function oo(e){if(Qa=e,!U().musicEnabled){io();return}let t=no(`hub`),n=no(`match`);e===`match`?(t?.pause(),n&&(ro(n),n.play().catch(()=>{}))):(n?.pause(),t&&(ro(t),t.play().catch(()=>{})))}function so(){if(!U().musicEnabled){io();return}ro(Xa),ro(Za),oo(Qa)}function co(){if(!eo())return;window.addEventListener(`arcane-settings-changed`,()=>so());let e=()=>{ao(),U().musicEnabled&&oo(Qa),window.removeEventListener(`pointerdown`,e),window.removeEventListener(`keydown`,e)};window.addEventListener(`pointerdown`,e,{once:!0}),window.addEventListener(`keydown`,e,{once:!0})}function lo(e){let t=Ya[e];t&&to(t,1)}var uo={tap:()=>lo(`tap`),spell:()=>lo(`spell`),capture:()=>lo(`capture`),win:()=>lo(`win`),chest:()=>lo(`chest`)},fo=null,po=!1;async function mo(){if(po)return fo;po=!0;try{let{Capacitor:e}=await D(async()=>{let{Capacitor:e}=await import(`./dist-DM6qMOWp.js`);return{Capacitor:e}},[],import.meta.url);if(!e.isNativePlatform())return null;fo=(await D(()=>import(`./esm-TGGH6JYM.js`),[],import.meta.url)).ScreenOrientation}catch{fo=null}return fo}async function ho(){document.body.classList.remove(`orientation-match`),document.body.classList.add(`orientation-portrait`);let e=await mo();if(e)try{await e.lock({orientation:`portrait`})}catch{}}async function go(){await ho()}var _o=null;function vo(){return _o||(_o=document.createElement(`div`),_o.id=`network-banner`,_o.className=`network-banner hidden`,_o.setAttribute(`role`,`status`),_o.setAttribute(`aria-live`,`polite`),document.body.appendChild(_o),_o)}function yo(){let e=vo(),t=!navigator.onLine;e.textContent=t?`No connection — some features need internet`:``,e.classList.toggle(`hidden`,!t)}function bo(){yo(),window.addEventListener(`online`,yo),window.addEventListener(`offline`,yo)}async function xo(){try{let{Capacitor:e}=await D(async()=>{let{Capacitor:e}=await import(`./dist-DM6qMOWp.js`);return{Capacitor:e}},[],import.meta.url);if(!e.isNativePlatform())return;let{StatusBar:t,Style:n}=await D(async()=>{let{StatusBar:e,Style:t}=await import(`./esm-C-SIlwqj.js`);return{StatusBar:e,Style:t}},[],import.meta.url);await t.setOverlaysWebView({overlay:!0}),await t.setStyle({style:n.Dark}),await t.setBackgroundColor({color:`#080a12`});let{SplashScreen:r}=await D(async()=>{let{SplashScreen:e}=await import(`./esm-Ck_AT-RK.js`);return{SplashScreen:e}},[],import.meta.url);await r.hide()}catch(e){console.warn(`Capacitor init skipped`,e)}}var So=null,Co=!1;async function wo(){if(Co)return So;Co=!0;try{let{Capacitor:e}=await D(async()=>{let{Capacitor:e}=await import(`./dist-DM6qMOWp.js`);return{Capacitor:e}},[],import.meta.url);if(!e.isNativePlatform())return null;let{Haptics:t,ImpactStyle:n}=await D(async()=>{let{Haptics:e,ImpactStyle:t}=await import(`./esm-D_it6P9V.js`);return{Haptics:e,ImpactStyle:t}},[],import.meta.url);So={Haptics:t,ImpactStyle:n}}catch{So=null}return So}async function To(){if(!U().hapticsEnabled)return;let e=await wo();if(e)try{await e.Haptics.impact({style:e.ImpactStyle.Light})}catch{}}var Eo={bronze:{label:`Bronze`,tagline:`Same odds as Bronze Chest`,visual:`bronze`,accent:`#c77dff`,glow:`rgba(199, 125, 255, 0.45)`},silver:{label:`Silver`,tagline:`Same odds as Silver Chest`,visual:`silver`,accent:`#7dd3fc`,glow:`rgba(125, 211, 252, 0.5)`},gold:{label:`Gold`,tagline:`Same odds as Gold Chest`,visual:`gold`,accent:`#ffd87a`,glow:`rgba(255, 216, 122, 0.55)`}};function Do(e){let t=Eo[e]||Eo.style_crate,n=t.visual;return{tier:t,lid:n===`gold`?`#f0e6c8`:n===`silver`?`#e4ecf8`:`#e8c4f8`,body:n===`gold`?`#5a4518`:n===`silver`?`#3d4a62`:`#4a2860`,trim:t.accent,ribbon:n===`gold`?`#ff9de2`:n===`silver`?`#a5f3fc`:`#d8b4fe`}}function Oo(e,t){let{lid:n,body:r,trim:i,ribbon:a}=Do(e);return`
    <defs>
      <linearGradient id="${t}-body" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stop-color="${r}"/>
    ...
    </defs>`}function ko(e,t,n){let{trim:r,ribbon:i,tier:a}=Do(e);return`
    ...
    </g>`}function Ao(e){let t=`vanityStage-${e}`;return`<svg class="chest-stage-svg vanity-box-svg" viewBox="0 0 120 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ${Oo(e,t)}
    <ellipse class="chest-stage__shadow" cx="60" cy="90" rx="42" ry="8" fill="rgba(0,0,0,0.5)"/>
    ${ko(e,t,!0)}
  </svg>`}function jo(e){let t=`vanityCard-${e}`;return`<svg class="chest-svg vanity-box-svg" viewBox="0 0 120 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ${Oo(e,t)}
    <ellipse cx="60" cy="90" rx="42" ry="8" fill="rgba(0,0,0,0.5)"/>
    ${ko(e,t,!1)}
  </svg>`}function Mo(e){let t=No[e]||No.avatar_default,n=`av-${e.replace(/[^a-z0-9]/gi,``)}`;return`<svg viewBox="0 0 64 64" class="cosmetic-avatar-svg cosmetic-avatar-svg--${e.replace(`avatar_`,``)}" aria-hidden="true">
    <defs>
    ...
    ${t.svg}
  </svg>`}var No={avatar_default:{bg:[`#4a5f7a`,`#1e2a3a`],glow:`#8fa4c4`,svg:`<ellipse cx="32" cy="38" rx="14" ry="16" fill="#2a3548"/>
      ...
      <circle cx="36" cy="26" r="2" fill="#0a1628"/>`}};function Po(e){let t={banner_default:`linear-gradient(135deg,#1e2a44,#2d4a6e)`,banner_nebula:`linear-gradient(135deg,#2a1f4e,#6b4fd4 55%,#1a1030)`,banner_crimson:`linear-gradient(135deg,#3a1018,#8b2030 50%,#1a0a10)`,banner_storm:`linear-gradient(135deg,#1a2840,#3d7ab8 45%,#9ad4ff)`,banner_aurora:`linear-gradient(135deg,#0f3d3a,#5ce1e6 40%,#9f7aea 80%,#1a0a20)`,banner_forest:`linear-gradient(135deg,#1a2e0e,#2d5016 50%,#0f1a08)`,banner_sunset:`linear-gradient(135deg,#431407,#c2410c 45%,#fdba74 75%,#1a0a04)`,banner_midnight:`linear-gradient(135deg,#0f172a,#1e3a5f 50%,#020617)`,banner_ocean:`linear-gradient(135deg,#042f2e,#0e7490 45%,#164e63 80%,#020617)`,banner_eclipse:`linear-gradient(135deg,#0a0a0a,#1a1a2e 35%,#fbbf24 50%,#0a0a0a 65%,#312e81)`,banner_sand:`linear-gradient(135deg,#78350f,#d97706 45%,#fcd34d 75%,#451a03)`,banner_mist:`linear-gradient(135deg,#374151,#6b7280 50%,#9ca3af 80%,#1f2937)`,banner_dawn:`linear-gradient(135deg,#4a1942,#ec4899 40%,#fbbf24 70%,#1a0a20)`};return t[e]||t.banner_default}function Fo(e){return e===`pieceSkin`?`Piece skin`:e===`frame`?`Frame`:e===`avatar`?`Avatar`:e===`banner`?`Banner`:e}function Io(e){return`profile-frame profile-frame--${(e||`frame_default`).replace(/^frame_/,``)}`}function Lo(e){return(e||`frame_default`).replace(/^frame_/,``),`<div class="cosmetic-frame-preview ${Io(e)}">
    <div class="cosmetic-frame-preview__inner">${Mo(`avatar_default`)}</div>
  </div>`}function Ro(e,t){return t===`avatar`?Mo(e):t===`frame`?Lo(e):t===`banner`?`<div class="cosmetic-preview-banner" style="background:${Po(e)}"></div>`:t===`pieceSkin`?zo(e):``}function zo(e){let t=e.replace(`skin_`,``);return`<div class="cosmetic-skin-preview">
    <span class="piece red piece-skin-${t} king"></span>
    <span class="piece black piece-skin-${t}"></span>
  </div>`}function Bo(e){let t=document.createElement(`article`);t.className=`cosmetic-reveal-card rarity-${e.rarity} cosmetic-reveal-card--${e.type}`,e.duplicate&&t.classList.add(`cosmetic-reveal-card--duplicate`);let n=Ro(e.id,e.type),r=Fo(e.type);return t.innerHTML=`
    ...
    </div>`,t.style.animationDelay=`0s`,t}function Vo(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function Ho(e,t=``){let n=ue(e),r=(t||`P`).charAt(0).toUpperCase(),i=Mo(n.equipped.avatar)||`<span class="profile-avatar-fallback">${Vo(r)}</span>`;return`<span class="profile-avatar-stack header-profile-btn__stack ${Io(n.equipped.frame)}"><span class="profile-avatar-inner header-profile-btn__inner">${i}</span></span>`}async function Uo(e){if(!e)return``;try{return(await Ee(e.id))?.username||e.user_metadata?.display_name||e.email?.split(`@`)[0]||``}catch{return e.user_metadata?.display_name||e.email?.split(`@`)[0]||``}}var Wo=null;function Go(){return Wo||=Promise.all([D(()=>import(`./match-ChKgfPtl.js`),[],import.meta.url),D(()=>import(`./matchView-CvZpZCck.js`),[],import.meta.url),D(()=>Promise.resolve({}),__vite__mapDeps([0]),import.meta.url),D(()=>Promise.resolve({}),__vite__mapDeps([1]),import.meta.url)]).then(([e,t])=>({MatchSession:e.MatchSession,getMatchHtml:t.getMatchHtml})),Wo}var Ko=null;function qo(){return Ko||=Promise.all([D(()=>import(`./pvpUI-BuAexcUv.js`),[],import.meta.url),D(()=>import(`./pvp-Bg7bC-D1.js`),[],import.meta.url)]).then(([e,t])=>({initPvpUI:e.initPvpUI,clearAllWaitingRoomsOnce:t.clearAllWaitingRoomsOnce})),Ko}var Jo=null;function Yo(){return Jo||=D(()=>import(`./profileUI-B01uRiOs.js`),[],import.meta.url),Jo}function Xo(){Jo=null}var Zo=null;function Qo(){return Zo||=Promise.all([D(()=>import(`./settingsUI-CPo4jgDD.js`),[],import.meta.url),D(()=>Promise.resolve({}),__vite__mapDeps([2]),import.meta.url)]).then(([e])=>e),Zo}var $o=null;function es(){return $o||=Promise.all([D(()=>import(`./chestOpenAnimation-CAYJ2iXn.js`),[],import.meta.url),D(()=>import(`./cosmeticOpenAnimation-D6fU8mjZ.js`),[],import.meta.url)]).then(([e,t])=>({playChestOpenAnimation:e.playChestOpenAnimation,playCosmeticOpenAnimation:t.playCosmeticOpenAnimation})),$o}var ts=null;function ns(){return ts||=D(()=>import(`./tutorialMeta-DJ3I6raL.js`),[],import.meta.url),ts}var rs=null;function is(){return rs||=D(()=>import(`./tutorialUnlocks-_6Mshh6V.js`),[],import.meta.url),rs}var as=null;function os(){return as||=D(()=>import(`./tutorialMatch-Jp2_1SlE.js`),[],import.meta.url),as}function ss(e,t){ns().then(n=>n.notifyMetaTutorial(e,t))}function cs(e,t){is().then(n=>n.notifyUnlockTutorial(e,t))}var W;try{W=ve()}catch(e){console.error(`Failed to load profile, resetting save:`,e),localStorage.removeItem(`cardCheckersProfile_v7`),localStorage.removeItem(`cardCheckersProfile_v5`),W=ve()}var G=`deck`,ls={deck:`Decks`,chests:`Shop`,play:`Play`,pvp:`PvP`,quests:`Quests`,profile:`Profile`,settings:`Settings`},us=new Set(Object.keys(ls)),ds=`cards`,fs=`list`,K=null,q=[],ps=null,ms=``,hs=`all`,gs=`all`,_s=!0,vs={legendary:5,epic:4,rare:3,uncommon:2,common:1};function ys(e){return[...e].sort((e,t)=>{let n=vs[e.rarity]??0,r=vs[t.rarity]??0;return n===r?e.name.localeCompare(t.name):r-n})}var J=null,bs=null,xs=null;function Ss(){return bs?Promise.resolve(bs):(xs||=qo().then(({initPvpUI:e,clearAllWaitingRoomsOnce:t})=>(t(),bs=e({root:document.getElementById(`view-pvp`),getProfile:()=>W,openAuthModal:()=>ws?.open(`signin`,{forced:!0}),onNavigateTab:Z,onOpenDeckEdit:Bc,onPvpViewShown:()=>{G=`pvp`,Gs()}}),bs)),xs)}var Cs=null,ws=null,Y=!1,Ts=!1,Es=!1,Ds=!1,Os=!1,ks=null,As=null,js=null,Ms=1,Ns=null;function Ps(e){return vs[e?.rarity]??0}function Fs(e){let t=i(e);return Object.entries(t).map(([e,t])=>({def:n(e),count:t})).filter(e=>e.def).sort((e,t)=>{let n=Ps(t.def)-Ps(e.def);return n===0?e.def.name.localeCompare(t.def.name):n})}function Is(e){let t=q.indexOf(e);t<0||(q.splice(t,1),Wc(),ss(`card-removed-from-deck`,{cardId:e}))}function Ls(e){let t=q.length;q=q.filter(t=>t!==e),q.length!==t&&(Wc(),ss(`card-removed-from-deck`,{cardId:e}))}function Rs(){let n=e().map(e=>({def:e,owned:oe(W,e.id)})).filter(e=>e.owned>0).sort((e,t)=>{let n=Ps(t.def)-Ps(e.def);return n===0?e.def.name.localeCompare(t.def.name):n});q=[];for(let{def:e,owned:r}of n){let n=Math.min(r,t(e));for(let t=0;t<n&&q.length<30;t++)q.push(e.id);if(q.length>=30)break}Wc()}var X=e=>document.getElementById(e);function zs(){let e=document.getElementById(`adventure-prebattle`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function Bs(){let e=document.querySelector(`nav.game-nav.tabs`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function Vs(){return window.matchMedia(`(min-width: 1000px) and (max-width: 1400px)`).matches?2.5:window.matchMedia(`(min-width: 600px) and (max-width: 999px)`).matches?1.85:1}function Hs(){zs(),document.getElementById(`adventure-prebattle`)?.classList.remove(`hidden`),document.body.classList.add(`adventure-floor-open`)}function Us(){document.getElementById(`adventure-prebattle`)?.classList.add(`hidden`),document.body.classList.remove(`adventure-floor-open`)}function Ws(e=ye,t=`Locked`){Pn({title:t,bodyHtml:e,autoCloseMs:4500})}function Gs(){document.body.classList.toggle(`main-tab-active`,us.has(G)),document.body.classList.toggle(`adventure-active`,G===`play`)}function Ks(e,t,n){let r=e.querySelector(`.tab-btn__sign-in-badge`);t?(r||(r=document.createElement(`span`),r.className=`tab-btn__sign-in-badge`,r.setAttribute(`aria-hidden`,`true`),e.appendChild(r)),r.textContent=n,e.classList.add(`tab-btn--sign-in-nudge`)):(r?.remove(),e.classList.remove(`tab-btn--sign-in-nudge`))}function qs(){let e=u(W),t=Ht();for(let n of[`quests`,`pvp`]){let r=document.querySelector(`.tab-btn[data-tab="${n}"]`);if(!r)continue;let i=n===`pvp`?`PvP`:`Quests`,a=!e,o=n===`pvp`?Bt:Vt;r.classList.toggle(`tab-btn--locked`,a),r.setAttribute(`aria-disabled`,a?`true`:`false`),a?(r.title=t?`${m(i)} ${o}.`:m(i),Ks(r,t,`Sign in`)):t?(r.title=o,Ks(r,n===`pvp`,`Sign in`)):(r.title=``,Ks(r,!1))}let n=h(W),r=document.querySelector(`.vault-tab[data-vault-tab="cosmetics"]`);r&&(r.classList.toggle(`vault-tab--locked`,!n),r.title=n?``:ae,r.setAttribute(`aria-disabled`,n?`false`:`true`))}async function Z(e){let t=document.getElementById(`view-match`);if(!(Y&&t&&!t.classList.contains(`hidden`))){if(!Ts&&(e===`quests`||e===`pvp`)&&!u(W)){let t=e===`pvp`?`PvP`:`Quests`,n=Ht(),r=e===`pvp`?Bt:Vt;await Ye(n?`${m(t)}\n\n${r}.`:m(t),{title:`${t} locked`,confirmLabel:`Go to Adventure`,cancelLabel:n?`Sign in`:`Not now`})?(Ts=!0,Z(`play`),Ts=!1):n&&ws?.open(`signin`,{forced:!0});return}if(Zn(),Hn()&&Wn()){if(e===G)return;if(!(e===`pvp`&&document.getElementById(`pvp-match-root`))){if(!await Ye(`Leave your current match to open ${ls[e]||e}?`,{title:`Leave match?`,confirmLabel:`Leave`,cancelLabel:`Stay`,destructive:!0}))return;Gn(e),Jn(),document.querySelector(`#btn-leave-match`)?.click();return}}if(fs===`edit`&&(e!==`deck`||e===`deck`&&G===`deck`)){if(!await Rc())return;zc()}e!==`deck`&&fs===`edit`&&(vc(),document.body.classList.remove(`deck-editing`)),G=e,Gs(),us.has(e)&&gc(),document.querySelectorAll(`.tab-btn`).forEach(t=>{t.classList.toggle(`active`,t.dataset.tab===e)}),document.querySelectorAll(`.view`).forEach(t=>{t.classList.toggle(`hidden`,t.id!==`view-${e}`)}),ss(`tab-changed`,{tab:e}),cs(`tab-changed`,{tab:e}),e===`chests`&&(Dc(ds),kc()),e===`deck`&&(fs=`list`,bc(`list`)),e===`profile`&&$s(),e===`settings`&&ec(),e===`quests`&&(rc(),ac()),e===`play`&&Yc(),e===`pvp`&&Ss().then(e=>e?.render({resume:!0})).catch(e=>{console.error(`[PvP] init failed`,e);let t=document.getElementById(`view-pvp`);t&&!t.innerHTML.trim()&&(t.innerHTML=`<section class="panel game-panel pvp-panel"><p class="pvp-status pvp-status--error">Couldn't load PvP — please reload the page.</p></section>`)}),Hn()||(oo(`hub`),await ho())}}var Q=``;function Js(e=Q){e&&(Q=e);let t=document.getElementById(`header-profile-menu`),n=document.getElementById(`header-profile-btn`),r=document.getElementById(`header-username`),i=document.getElementById(`auth-header-btn`),a=!!O();if(i&&(i.classList.toggle(`hidden`,a),i.hidden=a),t&&(t.classList.toggle(`hidden`,!a),t.hidden=!a),r){let e=a&&Q;r.textContent=e?Q:``,r.classList.toggle(`hidden`,!e),r.hidden=!e}n&&a&&(n.innerHTML=Ho(W,Q),n.title=Q?`Account — ${Q}`:`Account menu`)}function Ys(){let e=document.getElementById(`header-profile-btn`),t=document.getElementById(`header-profile-dropdown`);!e||!t||(t.classList.add(`hidden`),t.hidden=!0,e.setAttribute(`aria-expanded`,`false`))}function Xs(){let e=document.getElementById(`header-profile-menu`),t=document.getElementById(`header-profile-btn`),n=document.getElementById(`header-profile-dropdown`);if(!e||!t||!n)return;let r=e=>{n.classList.toggle(`hidden`,!e),n.hidden=!e,t.setAttribute(`aria-expanded`,e?`true`:`false`)};t.addEventListener(`click`,e=>{e.stopPropagation();let t=!n.hidden;r(!t)}),n.querySelectorAll(`[data-profile-menu-action]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.profileMenuAction;Ys(),t===`settings`?Z(`settings`):Qs()})}),document.addEventListener(`click`,t=>{n.hidden||e.contains(t.target)||Ys()}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&!n.hidden&&Ys()})}async function Zs(){let e=O();if(!e){Q=``,Js();return}Q=await Uo(e),Js()}function Qs(){Ys(),Z(`profile`),cs(`profile-opened`)}async function $s(){let{renderProfileTab:e}=await Yo(),t=X(`view-profile`);e(W,t,{onGemsChange:oc,onTitleChanged:()=>Js()})}async function ec(){let{renderSettingsTab:e}=await Qo();e(X(`view-settings`),{onUsernameChanged:e=>{Q=e,Js(e)}})}var tc=`
  ...
  <section class="panel game-panel quests-panel quests-panel--error">
  ...
  </section>`;function rc(){let e=X(`view-quests`);e&&(e.innerHTML=tc)}function ic(e=X(`view-quests`)){e&&(e.innerHTML=nc,e.querySelector(`.quests-retry-btn`)?.addEventListener(`click`,()=>{Xo(),rc(),ac()}))}async function ac(){let e=X(`view-quests`);if(e)try{let{renderQuestsTab:t}=await Yo();t(W,e,{onTitleChanged:()=>Js(),onCurrencyChange:()=>$()})}catch(t){console.error(`[Quests] render failed`,t),ic(e)}}function $(){let e=X(`header-gems`);e&&(e.textContent=String(W.gems??0));let t=X(`header-stars`);t&&(t.textContent=String(W.stars??0)),document.querySelector(`.hud-gems`)?.classList.toggle(`hud-gems--low`,(W.gems??0)<50),document.querySelector(`.hud-stars`)?.classList.toggle(`hud-stars--low`,(W.stars??0)<10)}function oc(){$()}function sc(){document.querySelectorAll(`.collection-owned-only-toggle`).forEach(e=>{e.checked=_s});for(let e of[`collection-search`]){let t=X(e);t&&(t.value=ms)}for(let e of[`collection-rarity`]){let t=cr(e);t&&(t.value=hs)}let e=cr(`collection-category`);e&&(e.value=gs)}var cc=`(max-width: 899px)`,lc=`(max-width: 1280px)`,uc=null;function dc(){return window.matchMedia(cc).matches}function fc(){return document.body.classList.contains(`main-tab-active`)&&!document.body.classList.contains(`match-active`)&&!document.body.classList.contains(`deck-editing`)&&window.matchMedia(lc).matches}function pc(){return document.querySelector(`.game-main`)}function mc(){let e=pc();return fc()&&e?e.scrollTop:window.scrollY||document.documentElement.scrollTop||0}function hc(e){let t=pc();if(fc()&&t){t.scrollTop=e;return}window.scrollTo(0,e)}function gc(){let e=pc();if(fc()&&e){e.scrollTop=0;return}window.scrollTo(0,0)}function _c(){dc()&&(uc=mc(),document.body.style.position=`fixed`,document.body.style.top=`0`,document.body.style.left=`0`,document.body.style.right=`0`,document.body.style.width=`100%`)}function vc(){if(uc==null)return;let e=uc;uc=null,document.body.style.position=``,document.body.style.top=``,document.body.style.left=``,document.body.style.right=``,document.body.style.width=``,hc(e)}function yc(){gc(),document.documentElement.scrollTop=0,document.body.scrollTop=0,document.querySelector(`.game-shell`)?.scrollTo?.(0,0),pc()?.scrollTo?.(0,0),document.querySelector(`#view-deck`)?.scrollTo?.(0,0),document.querySelectorAll(`#deck-subview-edit, #deck-subview-edit .deck-editor, #deck-subview-edit .deck-editor__body, #deck-subview-edit .deck-editor__grid, #deck-subview-edit .deck-editor__grid-cards`).forEach(e=>{e.scrollTop=0})}function bc(e){e!==`edit`&&vc(),fs=e,document.body.classList.toggle(`deck-editing`,e===`edit`),X(`deck-subview-list`)?.classList.toggle(`hidden`,e!==`list`),X(`deck-subview-edit`)?.classList.toggle(`hidden`,e!==`edit`),e===`edit`&&(_c(),T(W),E(W),hs=`all`,ms=``,gs=`all`,_s=!0,sc(),Ic()),e===`list`&&Uc(),e===`edit`&&(Wc(),yc(),requestAnimationFrame(()=>{yc(),requestAnimationFrame(yc)}))}function xc({id:e,title:t,desc:n,cost:r,big:i=!1}){let a=(W.stars??0)>=r,o=i?kt():Ot();return`
    ...
    </article>`}function Sc(e,t){e.querySelector(`[data-mystery-open]`)?.addEventListener(`click`,e=>{e.stopPropagation(),t()}),e.addEventListener(`click`,t),e.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),t())})}function Cc({bonusGems:e=0,bonusStars:t=0}={}){let n=[];return e&&n.push(`+${e} gem refund`),t&&n.push(`+${t} ★ from duplicates`),n.length?` (${n.join(`, `)})`:``}async function wc(e,t){let{playChestOpenAnimation:n,playCosmeticOpenAnimation:r}=await es();e.kind===`card`?(await n({tier:e.tier.id,tierLabel:`Small Mystery Box — ${e.tier.name}`,pulls:e.pulls}),t&&(t.textContent=`Got ${e.pulls.length} spells from ${e.tier.name}.${Cc(e)}`)):e.kind===`cosmetic`?(await r({boxId:e.tier?.id||`bronze`,boxLabel:`Small Mystery Box`,pulls:e.pulls}),t&&(t.textContent=e.message+Cc(e))):e.kind===`both`&&(await n({tier:e.cardTier.id,tierLabel:`Big Mystery — ${e.cardTier.name}`,pulls:e.cardPulls}),await r({boxId:e.cosTier?.id||`gold`,boxLabel:`Big Mystery Box`,pulls:e.cosPulls}),t&&(t.textContent=`${e.message}${Cc(e)}`))}async function Tc({big:e=!1}={}){let t=X(`mystery-box-log`),n=e?20:10;if(!((W.stars??0)>=n)){t&&(t.textContent=`Need ${n} ★ stars. Clear Adventure floors to earn stars.`,t.classList.add(`chest-log--error`));return}let r=e?Rt(W):Lt(W);if(!r.success){t&&(t.textContent=r.message,t.classList.add(`chest-log--error`));return}E(W),$(),t&&t.classList.remove(`chest-log--error`),X(`mystery-box-list`)?.querySelectorAll(`.mystery-box__btn`).forEach(e=>{e.disabled=!0});try{await wc(r,t)}catch(e){console.error(`Mystery box animation failed:`,e),t&&(t.textContent=r.message)}kc({clearPulls:!1}),$s()}function Ec(){let e=X(`mystery-box-list`);if(!e)return;e.innerHTML=`
    ${xc({id:`standard`,title:`Small Mystery Box`,desc:`${Math.round(At*100)}% cosmetics · ${Math.round((1-At)*100)}% spells — same tier odds as Shop chests.`,cost:10})}
    ${xc({id:`big`,title:`Big Mystery Box`,desc:`Spells and cosmetics in one open — better tier odds (50% gold).`,cost:20,big:!0})}
  `;let t=e.querySelectorAll(`.mystery-box`);Sc(t[0],()=>Tc({big:!1})),Sc(t[1],()=>Tc({big:!0}))}function Dc(e){if(!Es&&e===`cosmetics`&&!h(W)){Ws(ae,`Cosmetics locked`),Es=!0,Dc(`cards`),Es=!1;return}ds=e,document.querySelectorAll(`.vault-tab`).forEach(t=>{let n=t.dataset.vaultTab===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,n?`true`:`false`)}),document.querySelectorAll(`.vault-tab-panel`).forEach(t=>{let n=t.id===`vault-tab-${e}`;t.classList.toggle(`hidden`,!n),t.hidden=!n}),cs(`vault-tab-changed`,{tab:e})}function Oc(){Yo().then(({renderCosmeticBoxes:e})=>{e(W,X(`cosmetic-box-list`),{logEl:X(`cosmetic-box-log`),onGemsChange:oc,cosmeticsUnlocked:h(W),onOpened:()=>{G===`profile`&&$s(),G===`quests`&&ac()}})})}function kc(e={}){let{clearPulls:t=!0}=e;$(),Oc(),Ec();let n=X(`chest-list`),r=X(`chest-pulls`);if(r&&t&&(r.innerHTML=``,r.classList.add(`chest-pulls--hidden`),r.classList.remove(`chest-pulls--reveal`)),n){n.innerHTML=``;for(let e of at){let t=pt[e.id]||pt.bronze,i=W.gems>=e.cost,a=document.createElement(`article`);a.className=`chest-card chest-card--${e.id}${i?``:` chest-card--locked`}`,a.innerHTML=`
    ...
    `;let o=a.querySelector(`.chest-open`);o.disabled=!i,o.addEventListener(`click`,async()=>{if(o.disabled)return;let n=ut(W,e.id),i=X(`chest-log`);if(!n.success){i&&(i.textContent=n.message,i.classList.add(`chest-log--error`));return}E(W),$(),o.disabled=!0;let{playChestOpenAnimation:a}=await es();if(await a({tier:e.id,tierLabel:t.label,pulls:n.pulls}),ss(`chest-opened`,{chestId:e.id}),i){let t=n.bonusGems?` (+${n.bonusGems} gems from duplicates)`:``;i.textContent=`Got ${n.pulls.length} spells from ${e.name}.${t}`,i.classList.remove(`chest-log--error`)}if(r){r.classList.remove(`chest-pulls--hidden`),r.classList.add(`chest-pulls--reveal`),r.innerHTML=`<p class="chest-pulls__label">Chest opened</p><div class="chest-pulls__grid"></div>`;let e=r.querySelector(`.chest-pulls__grid`);n.pulls.forEach((t,n)=>{let r=wa(t,{button:!0,deal:!0,gallery:!0,onClick:()=>Aa(t)});if(r.style.animationDelay=`${n*.12}s`,t.duplicate){r.classList.add(`spell-card--duplicate-pull`);let e=document.createElement(`span`);e.className=`chest-pull-dup-badge`,e.textContent=t.starRefund?`Duplicate · +${t.starRefund} ★`:`Duplicate · +${t.gemRefund} ◆`,r.appendChild(e)}e.appendChild(r),Ia(r,t.rarity)}),Ma(e),r.scrollIntoView({behavior:`smooth`,block:`nearest`})}kc()}),n.appendChild(a)}}}function Ac(){return ys(e().filter(e=>{if(gs!==`all`&&it(e)!==gs||hs!==`all`&&e.rarity!==hs)return!1;if(ms){let t=ms.toLowerCase();if(!e.name.toLowerCase().includes(t)&&!e.desc.toLowerCase().includes(t))return!1}return!(_s&&oe(W,e.id)<=0)}))}function jc(e,t){let n=za(W,e);return t&&(t.textContent=n.message,t.className=n.success?`deck-status ok`:`deck-status warn`),n.success&&(E(W),$(),fs===`list`&&Uc(),fs===`edit`&&Wc()),n}function Mc(e,t){let n=za(W,e);return n.success?(E(W),$(),q.push(e),he(W,e),E(W),Wc(),t&&(t.hidden=!1,t.textContent=`Bought and added to deck.`,t.className=`deck-editor__error deck-status ok`),!0):(t&&(t.hidden=!1,t.textContent=n.message,t.className=`deck-editor__error deck-status warn`),!1)}function Nc(e){return a(q,e,W).ok?(q.push(e),he(W,e),E(W),Wc(),ss(`card-added-to-deck`,{cardId:e}),!0):!1}function Pc(e,n,r={}){let{deckEdit:o=!1,statusEl:s=null}=r,c=oe(W,n.id),l=t(n),u=c>=l,d=Ra(n.rarity),f=W.gems>=d&&!u,p=o?a(q,n.id,W):{ok:!1},m=o&&i(q)[n.id]||0,h=q.length<30,g=m<l,ee=c>=1&&c<=m,_=c>=1&&!u,v=o&&!p.ok&&h&&g&&ee&&_,y=()=>jc(n.id,s),b=()=>{let e=oe(W,n.id),t=o&&i(q)[n.id]||0,r=e>=l,s=W.gems>=d&&!r,c=o?a(q,n.id,W):{ok:!1};Aa(n,{meta:o?`Owned ${e}/${l} · In deck ${t}/${l} · ${r?`max copies`:`${d} gems per copy`}`:`Owned ${e}/${l}${r?` · max copies`:` · ${d} gems per copy`}`,buyLabel:r?`Max copies owned`:`Buy copy (${d} gems)`,buyDisabled:!s||r||e<1,onBuy:()=>{y(),ka()},addDisabled:!c.ok,onAdd:o?()=>{Nc(n.id)&&b()}:void 0})};if(o){let t=document.createElement(`div`);t.className=`deck-editor-tile`+(ne(W,n.id)?` deck-editor-tile--new`:``);let r=wa(n,{button:!0,gallery:!0,onClick:()=>b()});r.classList.add(`deck-editor-tile__card`),r.title=`${n.name} — tap for full card`;let i=c>0?`Owned ${c}/${l}`:`Not in collection`,a=document.createElement(`div`);a.className=`deck-editor-tile__meta`,a.innerHTML=`${i} · In deck ${m}/${l}${ne(W,n.id)?`<span class="deck-editor-tile__new">New</span>`:``}`,a.addEventListener(`click`,()=>b());let o=document.createElement(`button`);o.type=`button`,o.className=`deck-editor-tile__action`,p.ok?(o.classList.add(`deck-editor-tile__action--add`),o.textContent=`+ Add to deck`,o.addEventListener(`click`,e=>{e.stopPropagation(),Nc(n.id)})):v?(o.classList.add(`deck-editor-tile__action--buy`),o.textContent=f?`Add for ${d} gems`:`Need ${d} gems`,o.disabled=!f,o.addEventListener(`click`,e=>{e.stopPropagation(),Mc(n.id,s)})):(o.classList.add(`deck-editor-tile__action--disabled`),o.disabled=!0,q.length>=30?o.textContent=`Deck full (30/30)`:m>=l?o.textContent=`Max copies in deck`:c<1?o.textContent=`Open Shop chests to unlock`:p.reason?o.textContent=p.reason:o.textContent=`Can't add`),t.append(r,a,o),e.appendChild(t);return}let x=document.createElement(`div`);x.className=`collection-card-wrap`+(c<1?` collection-card-wrap--unowned`:``);let S=wa(n,{button:!0,compact:!0,disabled:c<1||u,onClick:e=>{if(e.shiftKey||c<1||u){b();return}y()}});S.title=u?`${n.name} — max ${l} copies owned. Tap to view full card.`:c<1?`${n.name} — not owned. Tap to view full card.`:`${n.name} — tap to buy (${d} gems). Shift+click to inspect.`,x.appendChild(S);let C=document.createElement(`span`);C.className=`collection-owned-count`,C.textContent=c>0?`×${c}`:`—`,x.appendChild(C);let w=document.createElement(`span`);w.className=`collection-buy-cost`,w.textContent=u?`MAX`:`${d} ◆`,(!f||u)&&w.classList.add(`collection-buy-cost--cant`),x.appendChild(w),e.appendChild(x)}function Fc(e,t={}){if(!e)return;let{deckEdit:n=!1,statusEl:r=null}=t;e.innerHTML=``;let i=Ac();if(!i.length){e.className=`deck-editor__grid collection-grid`;let t=document.createElement(`p`);t.className=`collection-grid-empty muted`,t.textContent=n?`No spells match your filters. Try “All types”, clear search, or uncheck Owned only.`:`No cards match your filters. Open chests in the Shop to get more spells.`,e.appendChild(t);return}let a=0,o={deckEdit:n,statusEl:r};if(n||gs!==`all`){e.className=`deck-editor__grid collection-grid`;for(let t of i)try{Pc(e,t,o),a+=1}catch(e){console.error(`Failed to render card:`,t?.id,e)}}else{e.className=`deck-editor__grid collection-categories`;let t=Object.fromEntries(tt.map(e=>[e,[]]));for(let e of i)t[it(e)].push(e);for(let n of tt){let r=t[n];if(!r.length)continue;let i=document.createElement(`section`);i.className=`collection-category-section`,i.dataset.category=n;let s=document.createElement(`h3`);s.className=`collection-category-title`,s.textContent=nt[n],i.appendChild(s);let c=document.createElement(`div`);c.className=`collection-grid deck-editor__grid-cards`;for(let e of r)try{Pc(c,e,o),a+=1}catch(t){console.error(`Failed to render card:`,e?.id,t)}i.appendChild(c),e.appendChild(i)}}if(i.length>0&&a===0){e.className=`deck-editor__grid collection-grid`;let t=document.createElement(`p`);t.className=`collection-grid-empty collection-grid-empty--error`,t.textContent=`Spells failed to display. Hard refresh the page (Ctrl+Shift+R).`,e.appendChild(t)}}function Ic(){ps={name:X(`deck-name-input`)?.value?.trim()??``,cardIds:[...q]}}function Lc(){return ps?(X(`deck-name-input`)?.value?.trim()??``)!==ps.name||q.length!==ps.cardIds.length?!0:q.some((e,t)=>e!==ps.cardIds[t]):!1}async function Rc(){return Lc()?Ye(`Discard unsaved changes to this deck?`,{title:`Unsaved changes`,confirmLabel:`Discard`,cancelLabel:`Keep editing`,destructive:!0}):!0}function zc(){K=null,q=[],ps=null}function Bc(e){let t=W.decks.find(t=>t.id===e);if(!t)return;K=t.id,q=[...t.cardIds];let n=X(`deck-name-input`);n&&(n.value=t.name),bc(`edit`),ss(`deck-edit-opened`,{deckId:e})}function Vc(e){let t=Object.fromEntries(tt.map(e=>[e,0]));for(let r of e){let e=n(r);e&&(t[it(e)]+=1)}return t}function Hc(e){let t=Vc(e),n=[];for(let e of tt){let r=t[e];if(r<=0)continue;let i=nt[e];n.push(`<span class="deck-row__cat" title="${Ta(i)}: ${r}"><span class="deck-row__cat-dot deck-row__cat-dot--${e}" aria-hidden="true"></span><span class="deck-row__cat-n">${r}</span></span>`)}return n.length?`<div class="deck-row__cats">${n.join(``)}</div>`:``}function Uc(){T(W)&&E(W),$();let e=X(`deck-list`);if(!e)return;e.innerHTML=``;let t=X(`deck-list-count`);if(t){let e=W.decks.length;t.textContent=e?`${e} deck${e===1?``:`s`}`:``}if(!W.decks.length){if(T(W)&&E(W),W.decks.length){Uc();return}e.innerHTML=`
      ...
      <h3 class="deck-row-name">${Ta(t.name)}</h3>
      <div class="deck-row__progress">
        <div class="deck-progress-bar deck-row__progress-bar" role="progressbar" aria-valuemin="0" aria-valuemax="30" aria-valuenow="${t.cardIds.length}" aria-label="${Ta(t.name)} progress">
    ...
    `,a.addEventListener(`click`,()=>Bc(t.id)),e.appendChild(a)}}function Wc(){$();let e=X(`collection-grid`),t=X(`deck-slots`),n=X(`deck-status`),i=X(`edit-deck-heading`),a=X(`deck-count-badge`),o=X(`deck-progress-bar`);if(!e||!t)return;let s=X(`btn-delete-deck`);s&&(s.hidden=!(K&&K!==`new`&&K!==`deck-starter`)),i&&(i.textContent=K===`new`?`New deck`:`In your deck`);let c=r(q,W),l=`${q.length}/30`;a&&(a.textContent=l,a.classList.toggle(`deck-editor__count--ready`,c.valid));let u=X(`deck-progress-fill`),d=Math.min(100,q.length/30*100);u&&(u.style.width=`${d}%`),o&&(o.hidden=c.valid,c.valid||(o.setAttribute(`aria-valuenow`,String(q.length)),o.setAttribute(`aria-valuemax`,`30`))),n&&(c.valid?(n.textContent=``,n.hidden=!0,n.className=`deck-editor__error deck-status ok`):(n.hidden=!1,n.textContent=c.errors[0]||`${l} — keep adding spells`,n.className=`deck-editor__error deck-status warn`));let f=X(`deck-collection-hint`);f&&(f.hidden=!1,f.innerHTML=q.length>=30?`Deck is full. Remove a card from the strip above, or save when ready.`:`Tap <strong>+ Add to deck</strong> for copies you own. When all owned copies are in the deck, tap <strong>Add for X gems</strong> to buy another.`),Fc(e,{deckEdit:!0,statusEl:n}),t.innerHTML=``;let p=Fs(q);if(!p.length){let e=document.createElement(`p`);e.className=`deck-editor__strip-empty`,e.textContent=`Empty deck — tap + Add to deck below`,t.appendChild(e)}for(let{def:e,count:n}of p){let r=document.createElement(`div`);r.className=`deck-slot-wrap deck-slot-wrap--strip`;let i=wa(e,{button:!0,tiny:!0,onClick:()=>{Aa(e,{meta:n>1?`${n} copies in deck`:`In your deck`,onRemove:()=>Ls(e.id)})}});if(r.appendChild(i),n>1){let e=document.createElement(`span`);e.className=`deck-stack-count`,e.textContent=`×${n}`,r.appendChild(e)}let a=document.createElement(`button`);a.type=`button`,a.className=`deck-slot-remove deck-slot-remove--visible`,a.setAttribute(`aria-label`,`Remove one ${e.name} from deck`),a.textContent=`−`,a.addEventListener(`click`,t=>{t.stopPropagation(),Is(e.id)}),r.appendChild(a),t.appendChild(r)}}function Gc(){let e=X(`deck-name-input`)?.value?.trim()||`My Deck`,t=r(q,W);if(!t.valid){X(`deck-status`).textContent=t.errors.join(` `);return}let n;K&&K!==`new`?(n=W.decks.find(e=>e.id===K),n?(n.name=e,n.cardIds=[...q],n.updatedAt=Date.now()):n=w(e,q)):n=w(e,q),ie(W,n),W.selectedDeckId=n.id,E(W),ss(`deck-saved`,{deckId:n.id}),zc(),bc(`list`)}function Kc(e=[]){let t=`New Deck`,n=new Set(e.map(e=>e.name?.trim()).filter(Boolean));if(!n.has(t))return t;let r=2;for(;n.has(`${t} ${r}`);)r++;return`${t} ${r}`}function qc(){K=`new`,q=[];let e=X(`deck-name-input`);e&&(e.value=Kc(W.decks)),bc(`edit`)}function Jc(){Us(),js=null}function Yc(){W.adventure=we(W.adventure),X(`adventure-map-view`)?.classList.remove(`hidden`),Jc(),Ns=null,tl()}function Xc(e){let t=C[e]||C.verdant,n=`map-${e}`;return`<svg class="adventure-map-scenery-svg" viewBox="0 0 100 120" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
    <defs>
  ...
  </svg>`}function Zc(e=`#e8c547`){return`<svg class="adventure-map-tile__pawn-svg" viewBox="0 0 28 36" aria-hidden="true">
    <defs>
  ...
  </svg>`}function Qc(e){let t=C[e]||C.verdant;return`<svg class="adventure-map-tile__banner-svg" viewBox="0 0 24 20" aria-hidden="true">
    <defs>
    ...
    <div class="adventure-map-canvas__bg" aria-hidden="true">
      <div class="adventure-map-scenery adventure-map-scenery--${i}" aria-hidden="true">${Xc(i)}</div>
    ...
    <div class="adventure-map-tower">
    ...
    </div>`;let d=r.querySelector(`.adventure-map-tiles`),f=r.querySelector(`.adventure-map-tower`),m=S(Ms),h=l(e),ee=Vs();f?.style.setProperty(`--tower-top-ratio`,`0.72`),f?.style.setProperty(`--adventure-map-scale`,String(ee)),m.forEach((t,n)=>{let r=_(e,t.id),o=g(e,t.id),s=t.id===h&&r,c=be(e,t.id),l=(t.floorInWorld-1)/9,u=1-l*.26,f=u*ee,p=(1-l*.1)*ee,m=Math.sin((t.floorInWorld-1)*.62)*.32*u*ee,v=document.createElement(`button`);v.type=`button`,v.className=`adventure-map-tile`,v.classList.add(`adventure-map-tile--floor-${t.floorInWorld}`),v.style.zIndex=String(n+10),v.style.setProperty(`--floor-scale`,f.toFixed(4)),v.style.setProperty(`--floor-height-scale`,p.toFixed(4)),v.style.setProperty(`--floor-offset-x`,`${m.toFixed(3)}rem`),v.dataset.level=String(t.id),r||v.classList.add(`adventure-map-tile--locked`),o&&v.classList.add(`adventure-map-tile--cleared`),s&&v.classList.add(`adventure-map-tile--next`),t.floorInWorld>=7&&t.floorInWorld<10&&v.classList.add(`adventure-map-tile--rampart`),t.floorInWorld===10&&v.classList.add(`adventure-map-tile--summit`),v.setAttribute(`aria-disabled`,r?`false`:`true`),r||(v.title=`Clear global floor ${t.id-1} to unlock`),v.setAttribute(`aria-label`,`Floor ${t.floorInWorld}: ${t.opponent}, ${t.flavor}`);let y=o?`<span class="adventure-map-tile__stars">${te(c)}</span>`:``,b=s?`<span class="adventure-map-tile__pawn">${Zc(a.accent)}</span>`:``,x=t.floorInWorld===10?`<span class="adventure-map-tile__banner">${Qc(i)}</span>`:``,S=t.floorInWorld>1&&t.floorInWorld<10?`<span class="adventure-map-tile__windows" aria-hidden="true"></span>`:``,C=o?`<span class="adventure-map-tile__torch" aria-hidden="true"></span>`:``;v.innerHTML=`
      ${b}
      ${x}
      <span class="adventure-map-tile__stone" aria-hidden="true">
      ...
      </span>`,r||(v.disabled=!0),v.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),ll(t.id))}),d?.appendChild(v)});let v=X(`adventure-floor-list`);if(v){v.classList.add(`adventure-floor-list--sr`),v.innerHTML=``;for(let t of m){let n=_(e,t.id),r=g(e,t.id),i=t.id===h&&n,a=be(e,t.id),o=document.createElement(`button`);o.type=`button`,o.className=`adventure-floor-row`,n||(o.disabled=!0),r&&o.classList.add(`adventure-floor-row--cleared`),i&&o.classList.add(`adventure-floor-row--next`),o.innerHTML=`
        ...
        ${a>0?`<span class="adventure-floor-row__stars">${te(a)}</span>`:``}`,o.addEventListener(`click`,()=>ll(t.id)),v.appendChild(o)}}let y=r.querySelector(`.adventure-map-tile--next`);$c(r),y&&requestAnimationFrame(()=>{requestAnimationFrame(()=>y.scrollIntoView({behavior:`smooth`,block:`nearest`}))});let b=v?.querySelector(`.adventure-floor-row--next`);b&&requestAnimationFrame(()=>b.scrollIntoView({behavior:`smooth`,block:`end`})),r.querySelector(`.adventure-challenge-toggle`)?.addEventListener(`click`,t=>{t.preventDefault(),t.stopPropagation(),e.challengeMode=!e.challengeMode,W.adventure=e,E(W),To(),uo.tap(),tl()})}function nl(e){let t=s(e);if(!t||!_(W.adventure,e))return;js=e,Hs();let n=X(`prebattle-title`),i=X(`prebattle-flavor`),a=X(`prebattle-opponent`);n&&(n.textContent=`Tower ${t.worldId} · Floor ${t.floorInWorld}`),i&&(i.textContent=t.flavor||``),a&&(a.textContent=`Loading…`);try{Ns=c(W,e),E(W)}catch(e){console.error(`Enemy deck failed`,e),a&&(a.textContent=`Could not build enemy deck. Try again.`);return}a&&(a.textContent=`Review the enemy spell deck, then choose your grimoire below.`);let l=X(`prebattle-gem-hint`);if(l){let n=xe(W.adventure,e);l.textContent=(g(W.adventure,e)?`Repeat clear: +${n} gems`:`First clear: +${n} gems`)+(t.worldId===5&&o(W.adventure)?` · Challenge mode: enemy has an extra rank of pieces`:``)}let u=X(`enemy-deck-preview`);if(u){u.innerHTML=``;try{for(let{def:e,count:t}of b(Ns)){if(!e)continue;let n=document.createElement(`button`);n.type=`button`,n.className=`enemy-deck-spell-btn`,n.title=`View ${e.name}`;let r=document.createElement(`span`);if(r.className=`enemy-deck-spell-btn__name`,r.textContent=e.name,n.appendChild(r),t>1){let e=document.createElement(`span`);e.className=`enemy-deck-spell-btn__count`,e.textContent=`×${t}`,n.appendChild(e)}n.addEventListener(`click`,()=>Aa(e,{meta:t>1?`${t} copies in enemy deck`:`Enemy deck`})),u.appendChild(n)}}catch(e){console.error(`Enemy preview failed`,e),u.innerHTML=`<p class="empty-msg">Enemy deck preview unavailable.</p>`}}T(W)&&E(W);let d=cr(`adventure-deck-select`);if(!d){a&&(a.textContent=`Deck selector missing — hard refresh the page.`);return}d.innerHTML=``;let f=W.decks.filter(e=>r(e.cardIds,W).valid);if(!f.length){let e=document.createElement(`option`);e.value=``,e.textContent=`No complete decks — build one in Decks`,d.appendChild(e),d.disabled=!0,X(`btn-start-adventure`).disabled=!0;return}d.disabled=!1;let p=W.selectedDeckId&&f.some(e=>e.id===W.selectedDeckId)?W.selectedDeckId:f[0].id;for(let e of f){let t=document.createElement(`option`);t.value=e.id,t.textContent=e.name,e.id===p&&(t.selected=!0),d.appendChild(t)}W.selectedDeckId=p,X(`btn-start-adventure`).disabled=!1}async function rl(e,t,n,r,i=null,a=!1,s=void 0){let c=t.opponent;Jc(),Ns=null,document.querySelectorAll(`.view`).forEach(e=>e.classList.add(`hidden`)),X(`view-match`)?.classList.remove(`hidden`);let l=X(`view-match`);if(!l)return;let{MatchSession:u,getMatchHtml:d}=await Go();l.innerHTML=d(c);let p=s??(ee(r).id===5&&o(W.adventure)),m={levelId:r,deckId:e.id,challengeMode:p},h={aiDeckIds:n,opponentName:c,cosmetics:ue(W),profile:W,challengeMode:p,buildGameOverActions:({won:e,isTie:t})=>al(m,{won:e,isTie:t}),onGameOverAction:e=>{ol(e,m,l)}};i&&(h.initialState=i);try{J=new u(e.cardIds,l,()=>{J=null,tr(),ho(),oo(`hub`),l.innerHTML=``,X(`view-match`)?.classList.add(`hidden`),Z(Kn()||`play`),Ds&&dl(),Os&&fl()},e=>{let t=y(W,r,e),{gems:n,stars:i,starsGained:a}=t;return W.gems+=n,x(W,`adventure_floors`,1),f(W),E(W),$(),qs(),r===1&&t.firstTime&&(Ds=!0,dl()),r===5&&t.firstTime&&(Os=!0),{message:`+${n} gems! · Best: ${te(i)}`,starsGained:a}},h)}catch(e){throw J=null,l.innerHTML=``,X(`view-match`)?.classList.add(`hidden`),Z(`play`),e}$n({kind:`adventure`,deckId:e.id,deckCardIds:e.cardIds,aiDeckIds:n,opponentName:c,levelId:r,challengeMode:p}),await ho(),oo(`match`),a&&(J.winRewarded=!0),nr(J),J.setMessage(``),J.render()}async function il(){let e=rr();if(!e)return!1;let t=W.decks.find(t=>t.id===e.deckId)||W.decks.find(e=>e.cardIds?.length===30),n=e.levelId?s(e.levelId):null;return!t||t.cardIds.length!==30||!n||!e.aiDeckIds?.length||!await Ye(`Resume your adventure match where you left off?`,{title:`Resume match?`,confirmLabel:`Resume`,cancelLabel:`Discard`})?(er(),!1):(js=e.levelId,await rl(t,n,e.aiDeckIds,e.levelId,e.state,e.winRewarded,e.challengeMode),J?.setMessage(`Match resumed — pick up where you left off.`),!0)}function al({levelId:e},{won:t,isTie:n}){let r=e+1,i=t&&r<=50&&_(W.adventure,r);if(n)return[{id:`backToAdventure`,label:`Back to Adventure`,primary:!0}];if(t){let e=[];return i?(e.push({id:`nextFloor`,label:`Next floor`,primary:!0}),e.push({id:`retry`,label:`Retry floor`}),e.push({id:`backToAdventure`,label:`Back to Adventure`})):(e.push({id:`backToAdventure`,label:`Back to Adventure`,primary:!0}),e.push({id:`retry`,label:`Retry floor`})),e}return[{id:`retry`,label:`Retry floor`,primary:!0},{id:`backToAdventure`,label:`Back to Adventure`}]}async function ol(e,{levelId:t,deckId:n,challengeMode:r},i){let a=W.decks.find(e=>e.id===n);if(e===`backToAdventure`){J?.onExit?.();return}if(e===`retry`||e===`nextFloor`){let n=e===`nextFloor`?t+1:t,i=s(n);if(!a||a.cardIds.length!==30||!i){J?.onExit?.();return}J?.dispose(),J=null,tr(),await rl(a,i,c(W,n),n,null,!1,e===`retry`?r:void 0)}}function sl(){let e=cr(`adventure-deck-select`)?.value,t=W.decks.find(t=>t.id===e),n=js,r=n?s(n):null,i=Ns?[...Ns]:null;if(!t||t.cardIds.length!==30||!r||!i?.length){let e=X(`prebattle-opponent`);e&&(!t||t.cardIds.length!==30?e.textContent=`Build a complete 30-card deck in the Decks tab, then try again.`:e.textContent=`Could not start battle — close and pick the floor again.`);return}rl(t,r,i,n)}function cl(){if(window.__adventureMapCaptureBound)return;window.__adventureMapCaptureBound=!0;let e=null,t=!1,n=0,r=e=>e.closest?.(`#adventure-map .adventure-map-tile, #adventure-map .adventure-map-pin`),i=e=>e?.closest?.(`.adventure-map-scene`),a=()=>{t=!0,clearTimeout(n),n=setTimeout(()=>{t=!1},280)},o=(e,t)=>{if(!e||e.disabled)return;let n=Number(e.dataset.level);!Number.isFinite(n)||n<1||(t.preventDefault(),t.stopPropagation(),ll(n))};document.addEventListener(`pointerdown`,t=>{if(t.button!==0)return;let n=r(t.target);if(!n||n.disabled)return;let a=i(n);e={pin:n,pointerId:t.pointerId,startX:t.clientX,startY:t.clientY,scrollTop:a?.scrollTop??0,scrollLeft:a?.scrollLeft??0,cancelled:!1}},!0),document.addEventListener(`pointermove`,t=>{if(!e||t.pointerId!==e.pointerId||e.cancelled)return;let n=t.clientX-e.startX,r=t.clientY-e.startY;Math.hypot(n,r)>12&&(e.cancelled=!0);let a=i(e.pin);a&&(Math.abs(a.scrollTop-e.scrollTop)>3&&(e.cancelled=!0),Math.abs(a.scrollLeft-e.scrollLeft)>3&&(e.cancelled=!0))},!0),document.addEventListener(`pointerup`,t=>{if(!e||t.pointerId!==e.pointerId)return;let{pin:n,cancelled:r}=e;if(e=null,r){a();return}o(n,t),a()},!0),document.addEventListener(`pointercancel`,t=>{!e||t.pointerId!==e.pointerId||(e=null,a())},!0),document.addEventListener(`click`,e=>{if(t){e.preventDefault(),e.stopPropagation();return}let n=r(e.target);!n||n.disabled||o(n,e)},!0)}function ll(e){let t=we(W.adventure);if(W.adventure=t,!_(t,e)){Ws(`Locked — beat global floor ${e-1} first, then return here.`,`Floor locked`);return}E(W),nl(e)}function ul(){Bs(),window.addEventListener(`orientationchange`,Bs),window.addEventListener(`resize`,Bs),Gs(),qa(),Va(),bo(),co(),go(),xo(),ja(),cl(),zs(),document.querySelector(`.adventure-map-scene`)?.addEventListener(`scroll`,el,{passive:!0});let e;window.addEventListener(`resize`,()=>{clearTimeout(e),e=setTimeout(()=>{if(!document.body.classList.contains(`adventure-active`))return;let e=X(`adventure-map`);e&&$c(e)},120)}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&Jc()}),document.querySelectorAll(`.tab-btn`).forEach(e=>{e.addEventListener(`click`,()=>{To(),uo.tap(),Z(e.dataset.tab)})}),document.querySelectorAll(`.vault-tab`).forEach(e=>{e.addEventListener(`click`,()=>{Zn(),Dc(e.dataset.vaultTab)})}),X(`btn-new-deck`)?.addEventListener(`click`,qc),X(`btn-back-from-edit`)?.addEventListener(`click`,async()=>{await Rc()&&(zc(),bc(`list`))}),X(`btn-delete-deck`)?.addEventListener(`click`,async()=>{if(!K||K===`new`)return;let e=W.decks.find(e=>e.id===K);e&&await Ye(`Delete "${e.name}"? This cannot be undone.`,{title:`Delete deck?`,confirmLabel:`Delete`,cancelLabel:`Keep`,destructive:!0})&&(fe(W,e.id),zc(),bc(`list`))});let t=()=>{fs===`edit`&&Wc(),fs===`list`&&Uc()};document.querySelectorAll(`.collection-owned-only-toggle`).forEach(e=>{e.addEventListener(`change`,e=>{_s=e.target.checked,sc(),t()})}),document.querySelectorAll(`.btn-reset-collection-filters`).forEach(e=>{e.addEventListener(`click`,()=>{hs=`all`,ms=``,gs=`all`,_s=!0,sc(),t()})}),sc(),lr(),X(`collection-search`)?.addEventListener(`input`,e=>{ms=e.target.value,t()}),cr(`collection-category`)?.addEventListener(`change`,e=>{gs=e.target.value,t()}),cr(`collection-rarity`)?.addEventListener(`change`,e=>{hs=e.target.value,t()}),X(`btn-clear-deck`)?.addEventListener(`click`,()=>{q=[],Wc()}),X(`btn-auto-finish-deck`)?.addEventListener(`click`,Rs),X(`btn-save-deck`)?.addEventListener(`click`,Gc),X(`btn-back-adventure`)?.addEventListener(`click`,Jc),X(`adventure-floor-backdrop`)?.addEventListener(`click`,Jc),X(`btn-start-adventure`)?.addEventListener(`click`,sl),cr(`adventure-deck-select`)?.addEventListener(`change`,e=>{W.selectedDeckId=e.target.value,E(W)});let n=document.getElementById(`auth-modal`),r=document.getElementById(`auth-header-btn`);Xs(),In(`adventure-help-btn`,`adventure-help-desc`),In(`shop-help-btn`,`shop-help-desc`),In(`deck-help-btn`,`deck-help-desc`),Cs=nn({onSignIn:()=>ws?.open(`signin`,{forced:!0}),onSignUp:()=>ws?.open(`signup`,{forced:!0}),onGuest:()=>{Wt(),vl()}}),ws=en({authBtn:r,modal:n,onNewAccount:()=>{W=ge()?me():ve(),gn(W,E)},onSignedIn:()=>{Gt(),W=ve(),T(W),hn(W),$(),Uc(),Ec(),Cs?.hide(),Zs().then(()=>{G===`profile`&&$s(),G===`quests`&&ac(),G===`pvp`&&Ss().then(e=>e?.render({resume:!0}))}),Ss().then(e=>e?.render({resume:!0})),gl(),_l(),hl(),ml(),Y||Z(G)},onSignedOut:()=>{Gt(),Ys(),Q=``,Js(),bs?.dispose?.(),J=null,tr({clearCheckpoint:!0}),Zn(),W=me(),qs(),$(),Uc(),Ec(),Cs?.show(),Z(`deck`)}}),ir(()=>J),T(W),sc(),qs(),yl()}function dl(){if(!Ds||ks!=null)return;let e=0,t=()=>{if(ks=null,e+=1,Ds){if(Wn()){e<10&&(ks=window.setTimeout(t,400));return}if(hn(W),hl()){Ds=!1;return}e<10&&(ks=window.setTimeout(t,500))}};ks=window.setTimeout(t,350)}function fl(){if(!Os||As!=null)return;let e=0,t=()=>{if(As=null,e+=1,Os){if(Wn()){e<10&&(As=window.setTimeout(t,400));return}if(hn(W),ml()){Os=!1;return}e<10&&(As=window.setTimeout(t,500))}};As=window.setTimeout(t,350)}function pl(){return Y||!tn()||!u(W)||!wn(W)?!1:(Y=!0,is().then(({startPvpTutorial:e})=>{e({profile:W,saveProfile:E,onComplete:()=>{Y=!1,W=ve(),T(W),qs(),Z(`play`),ml()}})}),!0)}function ml(){return Y||!tn()||!h(W)||yn(W)||bn(W)||Cn(W)||wn(W)||!En(W)?!1:(Y=!0,Z(`play`),is().then(({startCosmeticsTutorial:e})=>{e({profile:W,saveProfile:E,onComplete:()=>{Y=!1,W=ve(),T(W),qs(),Z(`play`)}})}),!0)}function hl(){return Y||!tn()||!u(W)?!1:(hn(W),Cn(W)?(Y=!0,Z(`play`),is().then(({startQuestsTutorial:e})=>{e({profile:W,saveProfile:E,onComplete:()=>{Y=!1,W=ve(),T(W),qs(),pl(),ml()}})}),!0):pl())}function gl(){return Y||!tn()||!yn(W)?!1:(Y=!0,os().then(({startInteractiveTutorial:e})=>{e({profile:W,saveProfile:E,onComplete:()=>{Y=!1,W=ve(),T(W),$(),Uc(),Ec(),_l()||Z(`deck`),hl(),ml()}})}),!0)}function _l(){return Y||!tn()||!bn(W)?!1:(Y=!0,Z(`deck`),ns().then(({startMetaTutorial:e})=>{e({profile:W,saveProfile:E,onComplete:()=>{Y=!1,W=ve(),T(W),$(),Uc(),Ec(),Z(`deck`),hl(),ml()}})}),!0)}async function vl(){Cs?.hide(),!gl()&&(_l()||hl()||ml()||Y||(await il()||await Z(`deck`),Zn(),oo(`hub`)))}async function yl(){try{if(await Ne()){try{let e=await Zt();e&&(W=e)}catch(e){console.warn(`Cloud sync on load failed`,e)}T(W),$(),Uc(),Ec()}}catch(e){console.warn(`Auth init failed`,e)}if(hn(W),await Zs(),bs&&bs.render(),Zn(),rn()){Cs?.show();return}await vl()}ul(),D(async()=>{let{registerSW:e}=await import(`./virtual_pwa-register-CpSsV7JG.js`);return{registerSW:e}},[],import.meta.url).then(({registerSW:e})=>{e({immediate:!0})}),Xe(),et();export{Zn as A,Bt as B,er as C,$n as D,Kn as E,vn as F,Ue as G,yt as H,Sn as I,xn as L,In as M,Tn as N,tr as O,_n as P,Dn as R,sr as S,Yn as T,ft as U,pt as V,Ye as W,Ia as _,Ao as a,wa as b,Io as c,Bo as d,ho as f,Ka as g,U as h,Po as i,nr as j,Wn as k,Mo as l,oo as m,Uo as n,jo as o,so as p,Eo as r,Fo as s,Ho as t,Ro as u,Ma as v,qn as w,fr as x,Aa as y,Kt as z};