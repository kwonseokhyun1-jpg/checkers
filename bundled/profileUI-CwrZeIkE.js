import{$ as e,C as t,F as n,G as r,I as i,J as a,L as o,O as s,Q as c,T as l,W as u,_ as d,at as f,b as p,et as m,it as h,m as g,nt as _,rt as v,st as y,tt as b,v as x,w as S,x as C,y as ee}from"./storage-ClGYzSuU.js";import{a as w,c as T,d as E,l as D,o as O,t as k,u as A}from"./mageTitles-BPvsmJqw.js";import{a as te,c as ne,o as re}from"./auth-BpO7FvsW.js";import{Y as ie,a as j,c as M,d as N,i as P,l as F,n as I,r as L,s as R,u as z}from"./index-DXIHMLPG.js";import{playCosmeticOpenAnimation as B}from"./cosmeticOpenAnimation-49iuqLp5.js";import{notifyUnlockTutorial as V}from"./tutorialUnlocks-nP5-ARSg.js";import{t as H}from"./profileStatCards-DHpHe70G.js";var U=null;function W(){U!=null&&(clearInterval(U),U=null)}function G(e){if(!e)return;W();let t=()=>{e.textContent=`Resets in: ${_(f())}`};t(),U=setInterval(t,1e3)}function K(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}var q={common:`rarity-common`,uncommon:`rarity-uncommon`,rare:`rarity-rare`,epic:`rarity-epic`,legendary:`rarity-legendary`};function J(e){if(e===`pieceSkin`)return`Piece skins`;if(e===`frame`)return`Frames`;let t=M(e);return t.endsWith(`s`)?t:`${t}s`}function Y(e){let t=T(e);return t?E(t):``}function ae(e){return H(s(e))}function oe(e,t,{username:n}){let r=Y(t),i=n||`Player`,a=i.charAt(0).toUpperCase()||`?`;return`
