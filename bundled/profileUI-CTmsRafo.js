import{A as e,C as t,D as n,E as r,G as i,J as a,L as o,M as s,N as c,O as l,P as u,Q as d,S as f,U as p,W as m,X as h,Y as g,Z as _,_ as v,at as y,b,ct as x,ft as S,it as C,k as w,m as T,q as E,v as ee,w as te,x as ne,y as D}from"./storage-6NjshSp-.js";import{a as O,c as k,o as A}from"./auth-7c7ssOss.js";import{U as j,c as M,i as N,l as P,n as re,o as F,r as I,s as L,t as R,u as z}from"./index-Bjc1WWa7.js";import{playCosmeticOpenAnimation as B}from"./cosmeticOpenAnimation-BbuDMP5d.js";import{notifyUnlockTutorial as V}from"./tutorialUnlocks-B_qQ80Dh.js";var H=null;function U(){H!=null&&(clearInterval(H),H=null)}function W(e){if(!e)return;U();let t=()=>{e.textContent=`Resets in: ${ne(te())}`};t(),H=setInterval(t,1e3)}function G(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}var K={common:`rarity-common`,uncommon:`rarity-uncommon`,rare:`rarity-rare`,epic:`rarity-epic`,legendary:`rarity-legendary`};function q(e){if(e===`pieceSkin`)return`Piece skins`;if(e===`frame`)return`Frames`;let t=L(e);return t.endsWith(`s`)?t:`${t}s`}function J(e){let t=E(e);return t?g(t):``}var Y={pvp:`<svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
