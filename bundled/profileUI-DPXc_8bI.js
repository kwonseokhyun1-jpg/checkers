import{$ as e,C as t,F as n,G as r,I as i,J as a,L as o,O as s,Q as c,T as l,W as u,_ as d,at as f,b as p,et as m,it as h,m as g,nt as _,rt as v,st as y,tt as b,v as x,w as ee,x as S,y as C}from"./storage-DCDtoONJ.js";import{a as w,c as T,d as E,l as D,o as O,t as k,u as A}from"./mageTitles-BPvsmJqw.js";import{a as te,c as ne,o as re}from"./auth-bvzcHbgO.js";import{a as j,c as M,d as N,i as P,l as F,n as I,q as L,r as R,s as z,u as B}from"./index-DTxZ_IKn.js";import{playCosmeticOpenAnimation as V}from"./cosmeticOpenAnimation-DX7ntqVl.js";import{notifyUnlockTutorial as H}from"./tutorialUnlocks-U14Xf9Fr.js";var U=null;function W(){U!=null&&(clearInterval(U),U=null)}function G(e){if(!e)return;W();let t=()=>{e.textContent=`Resets in: ${_(f())}`};t(),U=setInterval(t,1e3)}function K(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}var q={common:`rarity-common`,uncommon:`rarity-uncommon`,rare:`rarity-rare`,epic:`rarity-epic`,legendary:`rarity-legendary`};function J(e){if(e===`pieceSkin`)return`Piece skins`;if(e===`frame`)return`Frames`;let t=M(e);return t.endsWith(`s`)?t:`${t}s`}function Y(e){let t=T(e);return t?E(t):``}var ie={pvp:`<svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <div class="profile-showcase profile-hero-card__showcase">
        ...
        <div class="profile-showcase__hero profile-hero-card__hero">
          <div class="profile-avatar-stack ${F(e.equipped.frame)}" id="profile-avatar-stack">
            <div class="profile-avatar-inner" id="profile-avatar-preview" aria-hidden="true">${B(e.equipped.avatar)||`<span class="profile-avatar-fallback">${K(a)}</span>`}</div>
          </div>
  ...
  `;let d=t.querySelector(`#profile-cosmetic-grid`),f=`avatar`,p=``,m=()=>{let n=r(e);t.querySelector(`#profile-banner-preview`).style.background=j(n.equipped.banner);let i=t.querySelector(`#profile-avatar-preview`),o=(p||`P`).charAt(0).toUpperCase();i&&(i.innerHTML=B(n.equipped.avatar)||`<span class="profile-avatar-fallback">${K(o)}</span>`);let s=t.querySelector(`#profile-avatar-stack`);s&&(s.className=`profile-avatar-stack ${F(n.equipped.frame)}`);let c=t.querySelector(`#profile-hero-username`);c&&(c.textContent=p||`Player`);let l=t.querySelector(`.profile-hero-card__title-badge`),u=Y(e);if(u)if(l)l.innerHTML=u;else{let e=t.querySelector(`.profile-hero-card__name-row`);if(e){let t=document.createElement(`span`);t.className=`profile-hero-card__title-badge`,t.innerHTML=u,e.appendChild(t)}}else l&&l.remove();a?.()},h=()=>{let t=e.cosmetics?.owned?.[f]||[];d.innerHTML=``;for(let n of t){let t=i[n];if(!t)continue;let r=e.cosmetics.equipped[f]===n,a=document.createElement(`button`);a.type=`button`,a.className=`profile-cosmetic-card ${q[t.rarity]||``} ${r?`profile-cosmetic-card--equipped`:``}`;let o=N(n,t.type);a.innerHTML=`
