import{$ as e,A as t,C as n,D as r,E as i,G as a,L as o,M as s,N as c,O as l,P as u,Q as d,S as f,U as p,W as m,_ as h,b as g,k as _,m as v,nt as y,ot as b,v as x,w as S,x as ee,y as C}from"./storage-DWQ_vGAQ.js";import{a as w,c as T,d as E,l as D,o as O,t as k,u as A}from"./mageTitles-BPvsmJqw.js";import{a as j,c as te,o as ne}from"./auth-sCrcMfYD.js";import{W as re,c as M,i as N,l as P,n as F,o as I,r as L,s as R,t as z,u as B}from"./index-CUvSgvOw.js";import{playCosmeticOpenAnimation as V}from"./cosmeticOpenAnimation-DgD-wFzo.js";import{notifyUnlockTutorial as H}from"./tutorialUnlocks-BmtsIyvl.js";var U=null;function W(){U!=null&&(clearInterval(U),U=null)}function G(e){if(!e)return;W();let t=()=>{e.textContent=`Resets in: ${ee(S())}`};t(),U=setInterval(t,1e3)}function K(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}var q={common:`rarity-common`,uncommon:`rarity-uncommon`,rare:`rarity-rare`,epic:`rarity-epic`,legendary:`rarity-legendary`};function J(e){if(e===`pieceSkin`)return`Piece skins`;if(e===`frame`)return`Frames`;let t=R(e);return t.endsWith(`s`)?t:`${t}s`}function Y(e){let t=T(e);return t?E(t):``}var ie={pvp:`<svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
