...
import{n as e,o as t,t as n}from"./cardCatalog-CmmoeQUE.js";import{c as r,i,r as a}from"./deckRules-CeTI-85o.js";import{A as o,Ct as s,D as c,Dt as l,Et as u,N as d,Ot as f,R as p,St as m,Tt as h,V as g,W as ee,_t as _,a as v,at as y,bt as b,c as x,ct as S,d as C,dt as te,f as w,ft as ne,g as re,gt as ie,ht as ae,i as oe,k as se,kt as ce,l as le,lt as ue,m as T,mt as de,o as fe,ot as pe,p as me,pt as he,r as ge,s as _e,st as ve,t as ye,u as be,ut as xe,vt as Se,wt as Ce,xt as we,yt as Te}from"./storage-DHowQvPT.js";import{l as Ee,p as De,r as Oe}from"./mageTitles-BPvsmJqw.js";import{t as E}from"./preload-helper-CV77j2BA.js";import{_ as ke,a as Ae,c as je,d as Me,f as Ne,h as Pe,l as Fe,m as Ie,o as D,s as Le,t as Re}from"./auth-BJAF1pnW.js";var ze=Object.defineProperty,Be=(e,t)=>{let n={};for(var r in e)ze(n,r,{get:e[r],enumerable:!0});return t||ze(n,Symbol.toStringTag,{value:`Module`}),n};function Ve(){let e=window.visualViewport;return e?Math.max(0,Math.round(e.offsetTop)):0}function He(){let e=window.visualViewport;return e?Math.max(0,Math.round(window.innerHeight-e.offsetTop-e.height)):0}function Ue(){let e=document.documentElement,t=()=>{e.style.setProperty(`--viewport-inset-top`,`${Ve()}px`),e.style.setProperty(`--viewport-inset-bottom`,`${He()}px`)};t(),window.visualViewport?.addEventListener(`resize`,t),window.visualViewport?.addEventListener(`scroll`,t),window.addEventListener(`resize`,t),window.addEventListener(`orientationchange`,t)}Ue();var We=1100,Ge=120;function Ke(){let e=document.getElementById(`app-splash`);if(!e||e.classList.contains(`app-splash--hide`))return;e.classList.add(`app-splash--hide`),document.body.classList.remove(`splash-active`);let t=()=>{e.remove()};e.addEventListener(`transitionend`,t,{once:!0}),window.setTimeout(t,600)}function qe(){Ke()}function Je(){let e=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches?Ge:We,t=performance.now(),n=()=>{let n=performance.now()-t,r=Math.max(0,e-n);window.setTimeout(Ke,r)};document.readyState===`interactive`||document.readyState===`complete`?n():document.addEventListener(`DOMContentLoaded`,n,{once:!0})}document.body.classList.add(`splash-active`),Je();var Ye=`(max-width: 768px)`,Xe=null;function Ze(){return document.getElementById(`mobile-confirm`)}function Qe(e){let t=Ze();if(!t)return;t.classList.add(`hidden`),document.body.classList.remove(`mobile-confirm-open`);let n=Xe;Xe=null,n?.(e)}function $e(e,t={}){if(!window.matchMedia(Ye).matches)return Promise.resolve(window.confirm(e));let n=Ze();if(!n)return Promise.resolve(window.confirm(e));let{title:r=`Confirm`,confirmLabel:i=`OK`,cancelLabel:a=`Cancel`,destructive:o=!1}=t;return new Promise(t=>{Xe&&Qe(!1),Xe=t,n.querySelector(`#mobile-confirm-title`).textContent=r,n.querySelector(`#mobile-confirm-body`).textContent=e;let s=n.querySelector(`#mobile-confirm-ok`),c=n.querySelector(`#mobile-confirm-cancel`);s.textContent=i,c.textContent=a,s.classList.toggle(`btn-danger`,o),s.classList.toggle(`btn-primary`,!o),n.classList.remove(`hidden`),document.body.classList.add(`mobile-confirm-open`),c.focus()})}function et(){let e=Ze();!e||e.dataset.bound||(e.dataset.bound=`1`,e.querySelector(`#mobile-confirm-ok`)?.addEventListener(`click`,()=>Qe(!0)),e.querySelector(`#mobile-confirm-cancel`)?.addEventListener(`click`,()=>Qe(!1)),e.querySelector(`[data-mobile-confirm-backdrop]`)?.addEventListener(`click`,()=>Qe(!1)))}var tt=`cc_install_banner_dismissed`;function nt(){return window.matchMedia(`(display-mode: standalone)`).matches||window.navigator.standalone===!0}function rt(){let e=window.navigator.userAgent;return/iphone|ipad|ipod/i.test(e)&&!/crios|fxios/i.test(e)}function it(){if(nt()||localStorage.getItem(tt)===`1`)return;let e=document.getElementById(`install-banner`);if(!e)return;let t=null,n=()=>{e.classList.remove(`hidden`),document.body.classList.add(`install-banner-visible`)},r=()=>{e.classList.add(`hidden`),document.body.classList.remove(`install-banner-visible`)};window.addEventListener(`beforeinstallprompt`,r=>{r.preventDefault(),t=r,e.querySelector(`#install-banner-ios-hint`)?.classList.add(`hidden`),e.querySelector(`.install-banner__hint--default`)?.classList.remove(`hidden`),e.querySelector(`#install-banner-btn`)?.classList.remove(`hidden`),n()}),rt()&&(e.querySelector(`#install-banner-ios-hint`)?.classList.remove(`hidden`),e.querySelector(`.install-banner__hint--default`)?.classList.add(`hidden`),e.querySelector(`#install-banner-btn`)?.classList.add(`hidden`),window.setTimeout(n,2500)),e.querySelector(`#install-banner-btn`)?.addEventListener(`click`,async()=>{t&&(t.prompt(),await t.userChoice,t=null,r())}),e.querySelector(`#install-banner-dismiss`)?.addEventListener(`click`,()=>{localStorage.setItem(tt,`1`),r()})}var at=[`attack`,`control`,`defense`,`movement`,`trap`,`special`],ot={attack:`Attack`,control:`Control`,defense:`Defense`,movement:`Movement`,trap:`Trap`,special:`Special`},st={aegis:`defense`,anchor:`defense`,backpedal:`control`,backstab:`attack`,backstep:`movement`,barrier:`defense`,bishops_mark:`movement`,blind:`control`,blizzard:`control`,snowball:`control`,berserk:`movement`,bomb:`attack`,shockwave:`control`,plague:`control`,bulwark:`defense`,create_foe:`special`,call_forward:`movement`,chain_lightning:`attack`,clone:`special`,coin_flip:`attack`,collapse:`special`,confusion:`control`,constitution:`defense`,counterspell:`trap`,crown:`special`,cryo_bolt:`attack`,cull:`attack`,darkness:`defense`,dash:`movement`,deep_freeze:`control`,deflect:`trap`,demote:`control`,deport:`movement`,displacement:`movement`,dominion:`special`,duel:`attack`,earthquake:`special`,execution:`attack`,extract:`control`,pyromancy:`attack`,fusion:`special`,hibernation:`special`,hostile_swap:`movement`,ignore:`special`,iron_will:`defense`,landmine:`trap`,last_king:`special`,bounty:`special`,link_fate:`special`,last_stand:`trap`,leapfrog:`movement`,long_step:`movement`,magnet:`movement`,nudge:`movement`,offering:`special`,panic:`control`,poison:`attack`,mind_control:`special`,zombify:`special`,press:`control`,purify:`special`,quick_march:`movement`,quicksand:`trap`,rally:`defense`,recall:`movement`,repel:`movement`,random_teleport:`movement`,retreat:`movement`,revive:`defense`,rooks_mark:`movement`,root:`control`,sacrifice:`attack`,sanctuary:`defense`,scatter:`movement`,shadow_swap:`movement`,sidestep:`movement`,shatter:`attack`,snipe:`attack`,snowball:`control`,stab:`attack`,stall:`defense`,tangle:`control`,teleport:`movement`,trickster:`special`,vengeance:`trap`,ward:`defense`};function ct(e){let t=st[e?.id];if(t)return t;let n=`${e?.id||``} ${e?.effect||``} ${e?.name||``} ${e?.desc||``}`.toLowerCase();return/trap|mine|quicksand|counterspell|vengeance|last.?stand/.test(n)?`trap`:/shield|ward|aegis|sanctuary|barrier|anchor|deflect|stall|iron_will|rally|darkness/.test(n)?`defense`:/move|nudge|teleport|recall|leap|step|displace|swap|scatter|retreat|bishop|rook|overrun|promote|pull|push|shift|earthquake|magnet|repel/.test(n)?`movement`:/freeze|blind|confusion|hex|root|panic|press|silence|paraly|control|cannot play|random|mark|poison|die in \d+ turn/.test(n)?`control`:/\bdestroy\b|\bkills?\b|fireball|bolt|stab|snipe|duel|sacrifice|execution|shatter|cull|lightning/.test(n)?`attack`:`special`}var lt=[{id:`bronze`,name:`Bronze Chest`,cost:25,cards:3,weights:{common:70,uncommon:25,rare:5,epic:0}},{id:`silver`,name:`Silver Chest`,cost:50,cards:5,weights:{common:50,uncommon:35,rare:12,epic:3}},{id:`gold`,name:`Gold Chest`,cost:100,cards:8,weights:{common:32,uncommon:38,rare:22,epic:6,legendary:2}}];function ut(e){let t=Math.random()*100,n=0;for(let r of[`common`,`uncommon`,`rare`,`epic`,`legendary`])if(n+=e[r]||0,t<=n)return r;return`common`}function dt(t){let n=e().filter(e=>e.rarity===t);return n.length?n[Math.floor(Math.random()*n.length)]:e()[0]}function ft(e,t){return dt(ut(t.weights))}function pt(e,n,r={}){let{starRefundChance:i=0}=r;if(oe(e,n.id)<t(n))return ye(e,n.id,1),{...n,duplicate:!1};let a=p[n.rarity]||5;if(i>0&&Math.random()<i){let e=Math.random()<.5?1:2;return{...n,duplicate:!0,starRefund:e}}return{...n,duplicate:!0,gemRefund:a}}function mt(e,t){let n=lt.find(e=>e.id===t);if(!n)return{success:!1,message:`Unknown chest.`};if(e.gems<n.cost)return{success:!1,message:`Not enough gems.`};e.gems-=n.cost;let r=[],i=0;for(let t=0;t<n.cards;t++){let t=pt(e,ft(e,n));r.push(t),t.gemRefund&&(i+=t.gemRefund)}return i&&(e.gems+=i),y(e,`boxes_opened`,1),T(e),{success:!0,pulls:r,chest:n,bonusGems:i}}var ht=[`common`,`uncommon`,`rare`,`epic`,`legendary`];function gt(e,{minPct:t=1}={}){return ht.filter(n=>(e[n]??0)>=t).map(t=>`${e[t]}% ${t}`).join(` · `)}var _t={bronze:{label:`Bronze`,tagline:`Mostly common cards`,accent:`#cd7f32`,glow:`rgba(205, 127, 50, 0.45)`},silver:{label:`Silver`,tagline:`Balanced card mix`,accent:`#a8b8d8`,glow:`rgba(168, 184, 216, 0.5)`},gold:{label:`Gold`,tagline:`Higher rare & epic odds`,accent:`#e8c547`,glow:`rgba(232, 197, 71, 0.55)`}};function vt(e){let t=_t[e]||_t.bronze;return{t,lid:e===`gold`?`#f5e6a8`:e===`silver`?`#e8eef8`:`#d4954a`,body:e===`gold`?`#7a5c12`:e===`silver`?`#4a5568`:`#5c3a1e`,trim:e===`gold`?`#ffe566`:e===`silver`?`#c8d8f0`:t.accent}}function yt(e,t){let{lid:n,body:r,trim:i}=vt(e);return`
  ...
  <path d="M28 48 L24 54 M36 48 L40 54" stroke="#86efac" stroke-width="1.4" stroke-linecap="round" opacity="0.35"/>
    ...
    <text x="10" y="18" font-size="6" fill="#e9d5ff" opacity="0.55">?</text>`}function ga(){return`${M(30,54,18,3.5)}
    ...
    <circle cx="42" cy="22" r="8" fill="#7dd3fc" opacity="0.12"/>`}function _a(){return`${M(32,54,14,3.5)}
    ${Fr(32,36,30,!1)}
    ${Rr(32,34,4)}
    ...
    <path d="M24 38 L28 42 M36 38 L40 42" stroke="#d6d3d1" stroke-width="1.2" stroke-linecap="round" opacity="0.4"/>`}function va(){return`${M(32,56,14,3)}
    ${P(32,38,7)}
    ...
    <circle cx="32" cy="12" r="4" fill="#fde68a" opacity="0.3"/>`}function ya(){return`${M(32,54,20,4)}
    ...
    <path d="M18 44 L22 40 M46 18 L50 14" stroke="#fbbf24" stroke-width="1.2" stroke-linecap="round" opacity="0.45"/>`}function ba(){return`${M(32,54,18,3.5)}
    ...
    <circle cx="32" cy="40" r="14" fill="none" stroke="#60a5fa" stroke-width="0.8" opacity="0.2"/>`}var xa={nudge:()=>R(`nu`,`#94a3b8`,`#1e293b`,Ni()),backstep:()=>R(`bs`,`#9ca3af`,`#1f2937`,Pi()),retreat_3:()=>R(`ret`,`#93c5fd`,`#1e3a5f`,Fi()),leapfrog:()=>R(`lf`,`#94a3b8`,`#1e293b`,zi()),long_step:()=>z(`ls`,`#7dd3fc`,`#1e3a5f`,ea()),sidestep:()=>R(`ss`,`#9ca3af`,`#1f2937`,Xi()),blink_2:()=>z(`bl`,`#38bdf8`,`#0c4a6e`,oa()),random_teleport:()=>R(`rtp`,`#a78bfa`,`#312e81`,Bi()),recall:()=>R(`rc`,`#93c5fd`,`#1e3a5f`,Li()),repel:()=>R(`rp`,`#94a3b8`,`#1e293b`,Ri()),mass_nudge:()=>z(`mn`,`#7dd3fc`,`#1e3a5f`,fa()),displacement:()=>B(`dp`,`#b794f4`,`#553c7a`,pa()),swap_friendly:()=>R(`sw`,`#a78bfa`,`#312e81`,Yi()),dominion:()=>z(`dm`,`#60a5fa`,`#1e3a5f`,ba()),shield_1:()=>R(`s1`,`#60a5fa`,`#1e3a5f`,Qi()),shield_2:()=>z(`s2`,`#38bdf8`,`#0c4a6e`,ta()),bulwark:()=>B(`bw`,`#b794f4`,`#553c7a`,Ci()),barrier:()=>R(`br`,`#94a3b8`,`#1f2937`,qi()),last_stand:()=>B(`ls`,`#38bdf8`,`#0c4a6e`,ha()),fortify:()=>z(`fo`,`#a78bfa`,`#4c1d95`,Ti()),sanctuary_pulse:()=>z(`sp`,`#7dd3fc`,`#1e3a5f`,ma()),sanctuary:()=>B(`sa`,`#c4b5fd`,`#4c1d95`,Oi()),deflect_1:()=>z(`df`,`#38bdf8`,`#0c4a6e`,ra()),anchor_2:()=>R(`an`,`#94a3b8`,`#1f2937`,Ii()),iron_will:()=>R(`iw`,`#9ca3af`,`#1f2937`,Ui()),vengeance:()=>B(`vg`,`#9f7aea`,`#3b0764`,Di()),rally:()=>R(`rl`,`#60a5fa`,`#1e3a5f`,Vi()),forward_bolt:()=>z(`fb`,`#fde68a`,`#1e3a5f`,ia()),destroy_unshielded:()=>Lr(`sh`,`#4338ca`,`#1e1b4b`,Wr()),pyromancy:()=>Lr(`py`,`#ea580c`,`#431407`,Gr()),snipe:()=>z(`sn`,`#fde68a`,`#1e3a5f`,ya()),duel:()=>R(`du`,`#d4b896`,`#3d2817`,Xr()),sacrifice:()=>z(`sc`,`#fca5a5`,`#1e3a5f`,ua()),cull:()=>V(`cu`,`#a78bfa`,`#2e1065`,Yr()),execution:()=>B(`ex`,`#6ee7b7`,`#14532d`,Zr()),chain_lightning:()=>Lr(`cl`,`#2563eb`,`#0c1929`,Ur()),backstab:()=>z(`bk`,`#c4a574`,`#2d4a6e`,Vr()),cryo_bolt:()=>z(`cb`,`#7dd3fc`,`#0c4a6e`,ga()),bomb:()=>Lr(`bm`,`#f59e0b`,`#78350f`,Hr()),shockwave:()=>V(`sw`,`#c4b5fd`,`#3b1f6e`,ei()),plague:()=>V(`pg`,`#86efac`,`#14532d`,ti()),magnet:()=>V(`mg`,`#6ee7b7`,`#14532d`,Qr()),poison_3:()=>z(`po`,`#86efac`,`#14532d`,na()),root_2:()=>z(`ro`,`#86efac`,`#14532d`,la()),panic:()=>R(`pn`,`#fca5a5`,`#1f2937`,Ji()),blizzard:()=>B(`bz`,`#7dd3fc`,`#1e3a5f`,Si()),snowball:()=>R(`sb`,`#bae6fd`,`#0c4a6e`,$i()),berserk:()=>Lr(`bk`,`#991b1b`,`#450a0a`,Jr()),create_foe:()=>R(`cf`,`#78716c`,`#292524`,Ki()),deep_freeze:()=>V(`df`,`#7dd3fc`,`#0c4a6e`,si()),reverse_only_2:()=>z(`rv`,`#fca5a5`,`#1e3a5f`,ca()),press:()=>R(`pr`,`#fca5a5`,`#1f2937`,Zi()),tangle:()=>B(`tg`,`#93c5fd`,`#312e81`,_i()),blind:()=>B(`bl`,`#a78bfa`,`#4c1d95`,ji()),confusion:()=>V(`cf`,`#c4b5fd`,`#4c1d95`,ii()),extract:()=>B(`ex`,`#c4b5fd`,`#4c1d95`,ai()),fog_2:()=>Or(`${kr(32,34,6)}<ellipse cx="32" cy="24" rx="16" ry="8" fill="currentColor" opacity="0.22"/>`),crown:()=>z(`cr`,`#fbbf24`,`#451a03`,aa()),demote:()=>R(`dm`,`#fca5a5`,`#1f2937`,Wi()),fusion:()=>B(`fu`,`#8b5cf6`,`#4c1d95`,ki()),clone:()=>V(`cln`,`#93c5fd`,`#312e81`,fi()),chameleon:()=>B(`ch`,`#86efac`,`#312e81`,Ai()),hibernation:()=>V(`hi`,`#c4b5fd`,`#4c1d95`,Ei()),quicksand:()=>R(`qs`,`#a8a29e`,`#292524`,Gi()),landmine:()=>z(`lm`,`#78716c`,`#292524`,sa()),collapse:()=>R(`co`,`#78716c`,`#292524`,_a()),darkness:()=>B(`dk`,`#6d28d9`,`#1e1b4b`,wi()),scatter:()=>z(`st`,`#7dd3fc`,`#1e3a5f`,da()),call_forward:()=>B(`cfw`,`#fca5a5`,`#4c1d95`,bi()),dash:()=>B(`ds`,`#c4b5fd`,`#4c1d95`,xi()),earthquake:()=>V(`eq`,`#78716c`,`#292524`,qr()),coin_flip:()=>mi(),ignore:()=>R(`ig`,`#94a3b8`,`#1f2937`,Hi()),counterspell:()=>V(`cs`,`#a78bfa`,`#2e1065`,oi()),purify:()=>V(`pu`,`#6ee7b7`,`#14532d`,li()),trickster:()=>B(`tr`,`#c4b5fd`,`#553c7a`,Mi()),offering:()=>B(`of`,`#d8b4fe`,`#553c7a`,gi()),quick_march:()=>V(`qm`,`#60a5fa`,`#1e3a5f`,$r()),constitution:()=>V(`co`,`#4ade80`,`#14532d`,pi()),last_king:()=>z(`lk`,`#fbbf24`,`#1e3a5f`,va()),revive:()=>Lr(`rv`,`#15803d`,`#052e16`,Kr()),mind_control:()=>V(`mc`,`#c4b5fd`,`#3b0764`,ni()),zombify:()=>Lr(`zb`,`#4ade80`,`#14532d`,ri()),bounty:()=>V(`bo`,`#4ade80`,`#14532d`,ui()),link_fate:()=>V(`lf`,`#a78bfa`,`#2e1065`,di()),bishop_2:()=>z(`bp`,`#b794f4`,`#4c1d95`,vi()),rook_2:()=>z(`rk`,`#a78bfa`,`#4c1d95`,yi()),hostile_swap:()=>V(`hs`,`#93c5fd`,`#312e81`,ci()),deport:()=>B(`dp`,`#c4b5fd`,`#1e1b4b`,hi())};function Sa(e,t=0){let n=xa[e.effect];return n?n(t):null}var Ca={movement:{symbol:`↗`,label:`Motion`,anim:`movement`},combat:{symbol:`⚔`,label:`Strike`,anim:`combat`},defense:{symbol:`🛡`,label:`Ward`,anim:`defense`},debuff:{symbol:`❄`,label:`Curse`,anim:`debuff`},transform:{symbol:`✦`,label:`Morph`,anim:`transform`},board:{symbol:`◇`,label:`Terrain`,anim:`board`},crown:{symbol:`♔`,label:`Royal`,anim:`crown`},arcane:{symbol:`✧`,label:`Arcane`,anim:`arcane`}},wa=[[`movement`,[`nudge`,`backstep`,`long_step`,`leapfrog`,`recall`,`teleport`,`random_teleport`,`displacement`,`berserk`,`dash`]],[`combat`,[`stab`,`shatter`,`destroy`,`snipe`,`duel`,`execution`,`cull`,`pyromancy`,`backstab`,`sacrifice`,`chain_lightning`,`cryo`,`bomb`,`magnet`]],[`special`,[`create_foe`,`clone`,`earthquake`]],[`defense`,[`shield`,`ward`,`aegis`,`bulwark`,`stall`,`sanctuary`,`barrier`,`anchor`,`iron_will`,`hibernation`,`constitution`]],[`debuff`,[`root`,`panic`,`backpedal`,`blizzard`,`deep_freeze`,`snowball`,`blind`,`confusion`,`extract`,`press`,`tangle`,`shockwave`]],[`board`,[`quicksand`,`landmine`,`collapse`,`darkness`,`earthquake`,`scatter`,`call_forward`]],[`meta`,[`counterspell`,`vengeance`,`last_stand`,`purify`,`trickster`,`ignore`,`offering`,`quick_march`,`dominion`,`last_king`,`revive`,`mind_control`,`zombify`]]];function Ta(e){let t=0;for(let n=0;n<e.length;n++)t=(t+e.charCodeAt(n)*41)%360;return t}function Ea(e){let t=0;for(let n=0;n<e.length;n++)t=(t+e.charCodeAt(n)*13)%3;return t}function Da(e){let t=`${e.id} ${e.effect} ${e.name}`.toLowerCase();for(let[e,n]of wa)if(Array.isArray(n)&&n.some(e=>t.includes(e)))return e;return`arcane`}function Oa(e){return`ca${String(e).replace(/[^a-zA-Z0-9]/g,``)}`}function ka(e,t,n){let r=[[12,18,.35],[48,12,.5],[52,44,.25],[18,50,.4],[38,28,.55]],i=n*4;return r.map(([e,n,r],a)=>`<circle cx="${(e+i+a*7)%56+4}" cy="${(n+i*2+a*5)%52+6}" r="1.2" fill="hsl(${t} 90% 85% / ${r})"/>`).join(``)}function Aa(e,t){let n=t,r={movement:`
      ...
      </g>`};return r[e]||r.arcane}function ja(e,t,n,r){return Ma(e,t,n,r)}function Ma(e,t,n,r){let i=Oa(n),a=(t+42)%360,o=Ea(n),s=r&&Sa(r,o)||Aa(e,o);return r?.effect&&Br(r.effect)&&s?`<svg class="spell-card__svg spell-card__svg--full-bleed" viewBox="0 0 70 60" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid meet">${s}</svg>`:`<svg class="spell-card__svg" viewBox="0 0 70 60" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
    ...
    <div class="spell-card__frame">
      ...
      <div class="spell-card__type-frame${s?` spell-card__type-frame--with-hint`:``}">
        ...
        ${t.meta?`<span class="spell-card__meta">${Ra(t.meta)}</span>`:``}
      </div>
      ${o?`<div class="spell-card__text-frame"><p class="spell-card__desc">${Ra(e.desc)}</p></div>`:``}
    </div>
    <div class="spell-card__tooltip" role="tooltip">
      <strong>${Ra(e.name)}</strong>
      ${Pa(e)}
    </div>
  `,t.onClick&&l.addEventListener(`click`,n=>t.onClick(n,e)),Ia(l),l}function Ra(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function za(e){return document.getElementById(e)}function Ba(){let e=za(`card-preview-modal`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function Va(e){document.body.classList.toggle(`card-preview-open`,e),window.dispatchEvent(new CustomEvent(`card-preview-change`,{detail:{open:e}}))}function Ha(){za(`card-preview-modal`)?.classList.add(`hidden`),za(`card-preview-mount`)?.classList.remove(`card-preview-mount--reveal-only`),Va(!1)}function Ua(e,t={}){Ba();let n=za(`card-preview-modal`),r=za(`card-preview-mount`),i=za(`card-preview-actions`);if(!(!n||!r||!e)){if(r.innerHTML=``,r.classList.toggle(`card-preview-mount--reveal-only`,!!t.hideDesc),r.appendChild(La(e,{static:!0,hideDesc:t.hideDesc})),i){if(i.innerHTML=``,t.meta){let e=document.createElement(`p`);e.className=`card-preview-meta`,e.textContent=t.meta,i.appendChild(e)}let e=document.createElement(`div`);if(e.className=`card-preview-actions-row`,t.onPlay){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=`Cast spell`,n.addEventListener(`click`,()=>{Ha(),t.onPlay()}),e.appendChild(n)}if(t.onAdd){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=`Add to deck`,n.disabled=!!t.addDisabled,n.addEventListener(`click`,()=>{t.addDisabled||t.onAdd()}),e.appendChild(n)}if(t.onBuy){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=t.buyLabel||`Buy copy`,n.disabled=!!t.buyDisabled,n.addEventListener(`click`,()=>{t.buyDisabled||t.onBuy()}),e.appendChild(n)}if(t.onRemove){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-secondary`,n.textContent=`Remove all from deck`,n.addEventListener(`click`,()=>{t.onRemove(),Ha()}),e.appendChild(n)}e.children.length&&i.appendChild(e)}n.classList.remove(`hidden`),Va(!0)}}function Wa(){za(`card-preview-close`)?.addEventListener(`click`,Ha),za(`card-preview-backdrop`)?.addEventListener(`click`,Ha),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&Ha()})}function Ga(e,t=`.spell-card`){e&&e.querySelectorAll(t).forEach((e,t)=>{e.classList.add(`spell-card--deal`),e.style.animationDelay=`${t*.1}s`})}function Ka(e){e&&(e.classList.add(`spell-card--rare-burst`),setTimeout(()=>e.classList.remove(`spell-card--rare-burst`),900))}function qa(e){e&&(e.classList.add(`spell-card--epic-burst`),setTimeout(()=>e.classList.remove(`spell-card--epic-burst`),1200))}function Ja(e){e&&(e.classList.add(`spell-card--legendary-burst`),setTimeout(()=>e.classList.remove(`spell-card--legendary-burst`),1500))}function Ya(e,t){t===`legendary`?Ja(e):t===`epic`?qa(e):t===`rare`&&Ka(e)}var Xa={common:10,uncommon:20,rare:30,epic:40,legendary:50};function Za(e){return Xa[e]??30}function Qa(e,r){let i=oe(e,r);if(i<1)return{success:!1,message:`Get this spell from a chest first.`};let a=n(r);if(!a)return{success:!1,message:`Unknown card.`};let o=t(r);if(i>=o)return{success:!1,message:`You already own the maximum (${o} copies).`};let s=Za(a.rarity);if(e.gems<s)return{success:!1,message:`Need ${s} gems (${e.gems} available).`};e.gems-=s;let c=ye(e,r,1);return c?{success:!0,cost:s,message:`+1 ${a.name} for ${s} gems (${i+c} owned).`}:(e.gems+=s,T(e),{success:!1,message:`You already own the maximum copies for this rarity.`})}var $a={deck:`<svg class="nav-icon-svg" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  </svg>`};function eo(){let e={deck:$a.deck,chests:$a.chests,play:$a.play,pvp:$a.pvp,quests:$a.quests};for(let t of document.querySelectorAll(`.game-nav .tab-btn[data-tab]`)){let n=t.querySelector(`.tab-btn__icon`),r=t.dataset.tab;n&&e[r]&&(n.innerHTML=e[r])}}var to=`arcaneCheckersSettings_v1`,no={musicEnabled:!0,musicVolume:.45,sfxEnabled:!0,sfxVolume:.7,hapticsEnabled:!0},ro={...no};function io(){try{let e=localStorage.getItem(to);return e?{...no,...JSON.parse(e)}:{...no}}catch{return{...no}}}function H(){return{...ro}}function ao(e){ro={...ro,...e};try{localStorage.setItem(to,JSON.stringify(ro))}catch{}return window.dispatchEvent(new CustomEvent(`arcane-settings-changed`,{detail:H()})),H()}function oo(){return ro=io(),H()}var so={hub:`assets/audio/background.m4a`,match:`assets/audio/background.m4a`},co={tap:`assets/audio/sfx/tap.mp3`,spell:`assets/audio/sfx/spell.mp3`,capture:`assets/audio/sfx/capture.mp3`,win:`assets/audio/sfx/win.mp3`,chest:`assets/audio/sfx/chest.mp3`},lo=null,uo=null,fo=`hub`,po=!1;function mo(){return typeof Audio<`u`}function ho(e,t){if(!(!mo()||!H().sfxEnabled))try{let n=new Audio(e);n.volume=Math.max(0,Math.min(1,t*H().sfxVolume)),n.play().catch(()=>{})}catch{}}function go(e){let t=so[e];if(!t||!mo())return null;let n=e===`hub`?lo:uo;return n||(n=new Audio(t),n.loop=!0,n.preload=`auto`,e===`hub`?lo=n:uo=n),n}function _o(e){e&&(e.volume=Math.max(0,Math.min(1,H().musicVolume)))}function vo(){lo?.pause(),uo?.pause()}function yo(){po||!mo()||(po=!0,[lo,uo].forEach(e=>{e&&e.play().then(()=>e.pause()).catch(()=>{})}))}function bo(e){if(fo=e,!H().musicEnabled){vo();return}let t=go(`hub`),n=go(`match`);e===`match`?(t?.pause(),n&&(_o(n),n.play().catch(()=>{}))):(n?.pause(),t&&(_o(t),t.play().catch(()=>{})))}function xo(){if(!H().musicEnabled){vo();return}_o(lo),_o(uo),bo(fo)}function So(){if(!mo())return;window.addEventListener(`arcane-settings-changed`,()=>xo());let e=()=>{yo(),H().musicEnabled&&bo(fo),window.removeEventListener(`pointerdown`,e),window.removeEventListener(`keydown`,e)};window.addEventListener(`pointerdown`,e,{once:!0}),window.addEventListener(`keydown`,e,{once:!0})}function Co(e){let t=co[e];t&&ho(t,1)}var wo={tap:()=>Co(`tap`),spell:()=>Co(`spell`),capture:()=>Co(`capture`),win:()=>Co(`win`),chest:()=>Co(`chest`)},To=null,Eo=!1;async function Do(){if(Eo)return To;Eo=!0;try{let{Capacitor:e}=await E(async()=>{let{Capacitor:e}=await import(`./dist-DM6qMOWp.js`);return{Capacitor:e}},[],import.meta.url);if(!e.isNativePlatform())return null;To=(await E(()=>import(`./esm-TGGH6JYM.js`),[],import.meta.url)).ScreenOrientation}catch{To=null}return To}async function Oo(){document.body.classList.remove(`orientation-match`),document.body.classList.add(`orientation-portrait`);let e=await Do();if(e)try{await e.lock({orientation:`portrait`})}catch{}}async function ko(){await Oo()}var Ao=null;function jo(){return Ao||(Ao=document.createElement(`div`),Ao.id=`network-banner`,Ao.className=`network-banner hidden`,Ao.setAttribute(`role`,`status`),Ao.setAttribute(`aria-live`,`polite`),document.body.appendChild(Ao),Ao)}function Mo(){let e=jo(),t=!navigator.onLine;e.textContent=t?`No connection — some features need internet`:``,e.classList.toggle(`hidden`,!t)}function No(){Mo(),window.addEventListener(`online`,Mo),window.addEventListener(`offline`,Mo)}async function Po(){try{let{Capacitor:e}=await E(async()=>{let{Capacitor:e}=await import(`./dist-DM6qMOWp.js`);return{Capacitor:e}},[],import.meta.url);if(!e.isNativePlatform())return;let{StatusBar:t,Style:n}=await E(async()=>{let{StatusBar:e,Style:t}=await import(`./esm-C-SIlwqj.js`);return{StatusBar:e,Style:t}},[],import.meta.url);await t.setOverlaysWebView({overlay:!0}),await t.setStyle({style:n.Dark}),await t.setBackgroundColor({color:`#080a12`});let{SplashScreen:r}=await E(async()=>{let{SplashScreen:e}=await import(`./esm-Ck_AT-RK.js`);return{SplashScreen:e}},[],import.meta.url);await r.hide()}catch(e){console.warn(`Capacitor init skipped`,e)}}var Fo=null,Io=!1;async function Lo(){if(Io)return Fo;Io=!0;try{let{Capacitor:e}=await E(async()=>{let{Capacitor:e}=await import(`./dist-DM6qMOWp.js`);return{Capacitor:e}},[],import.meta.url);if(!e.isNativePlatform())return null;let{Haptics:t,ImpactStyle:n}=await E(async()=>{let{Haptics:e,ImpactStyle:t}=await import(`./esm-D_it6P9V.js`);return{Haptics:e,ImpactStyle:t}},[],import.meta.url);Fo={Haptics:t,ImpactStyle:n}}catch{Fo=null}return Fo}async function Ro(){if(!H().hapticsEnabled)return;let e=await Lo();if(e)try{await e.Haptics.impact({style:e.ImpactStyle.Light})}catch{}}var zo={bronze:{label:`Bronze`,tagline:`Same odds as Bronze Chest`,visual:`bronze`,accent:`#c77dff`,glow:`rgba(199, 125, 255, 0.45)`},silver:{label:`Silver`,tagline:`Same odds as Silver Chest`,visual:`silver`,accent:`#7dd3fc`,glow:`rgba(125, 211, 252, 0.5)`},gold:{label:`Gold`,tagline:`Same odds as Gold Chest`,visual:`gold`,accent:`#ffd87a`,glow:`rgba(255, 216, 122, 0.55)`}};function Bo(e){let t=zo[e]||zo.style_crate,n=t.visual;return{tier:t,lid:n===`gold`?`#f0e6c8`:n===`silver`?`#e4ecf8`:`#e8c4f8`,body:n===`gold`?`#5a4518`:n===`silver`?`#3d4a62`:`#4a2860`,trim:t.accent,ribbon:n===`gold`?`#ff9de2`:n===`silver`?`#a5f3fc`:`#d8b4fe`}}function Vo(e,t){let{lid:n,body:r,trim:i,ribbon:a}=Bo(e);return`
    <defs>
      <linearGradient id="${t}-body" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stop-color="${r}"/>
    ...
    </defs>`}function Ho(e,t,n){let{trim:r,ribbon:i,tier:a}=Bo(e);return`
    ${n?`<g class="chest-stage__interior">
    ...
    </g>`}function Uo(e){let t=`vanityStage-${e}`;return`<svg class="chest-stage-svg vanity-box-svg" viewBox="0 0 120 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ${Vo(e,t)}
    <ellipse class="chest-stage__shadow" cx="60" cy="90" rx="42" ry="8" fill="rgba(0,0,0,0.5)"/>
    ${Ho(e,t,!0)}
  </svg>`}function Wo(e){let t=`vanityCard-${e}`;return`<svg class="chest-svg vanity-box-svg" viewBox="0 0 120 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ${Vo(e,t)}
    <ellipse cx="60" cy="90" rx="42" ry="8" fill="rgba(0,0,0,0.5)"/>
    ${Ho(e,t,!1)}
  </svg>`}function Go(e){let t=Ko[e]||Ko.avatar_default,n=`av-${e.replace(/[^a-z0-9]/gi,``)}`;return`<svg viewBox="0 0 64 64" class="cosmetic-avatar-svg cosmetic-avatar-svg--${e.replace(`avatar_`,``)}" aria-hidden="true">
    <defs>
    ...
    ${t.svg}
  </svg>`}var Ko={avatar_default:{bg:[`#4a5f7a`,`#1e2a3a`],glow:`#8fa4c4`,svg:`<ellipse cx="32" cy="38" rx="14" ry="16" fill="#2a3548"/>
      ...
      <circle cx="36" cy="26" r="2" fill="#0a1628"/>`}};function qo(e){let t={banner_default:`linear-gradient(135deg,#1e2a44,#2d4a6e)`,banner_nebula:`linear-gradient(135deg,#2a1f4e,#6b4fd4 55%,#1a1030)`,banner_crimson:`linear-gradient(135deg,#3a1018,#8b2030 50%,#1a0a10)`,banner_storm:`linear-gradient(135deg,#1a2840,#3d7ab8 45%,#9ad4ff)`,banner_aurora:`linear-gradient(135deg,#0f3d3a,#5ce1e6 40%,#9f7aea 80%,#1a0a20)`,banner_forest:`linear-gradient(135deg,#1a2e0e,#2d5016 50%,#0f1a08)`,banner_sunset:`linear-gradient(135deg,#431407,#c2410c 45%,#fdba74 75%,#1a0a04)`,banner_midnight:`linear-gradient(135deg,#0f172a,#1e3a5f 50%,#020617)`,banner_ocean:`linear-gradient(135deg,#042f2e,#0e7490 45%,#164e63 80%,#020617)`,banner_eclipse:`linear-gradient(135deg,#0a0a0a,#1a1a2e 35%,#fbbf24 50%,#0a0a0a 65%,#312e81)`,banner_sand:`linear-gradient(135deg,#78350f,#d97706 45%,#fcd34d 75%,#451a03)`,banner_mist:`linear-gradient(135deg,#374151,#6b7280 50%,#9ca3af 80%,#1f2937)`,banner_dawn:`linear-gradient(135deg,#4a1942,#ec4899 40%,#fbbf24 70%,#1a0a20)`};return t[e]||t.banner_default}function Jo(e){return e===`pieceSkin`?`Piece skin`:e===`frame`?`Frame`:e===`avatar`?`Avatar`:e===`banner`?`Banner`:e}function Yo(e){return`profile-frame profile-frame--${(e||`frame_default`).replace(/^frame_/,``)}`}function Xo(e){return(e||`frame_default`).replace(/^frame_/,``),`<div class="cosmetic-frame-preview ${Yo(e)}">
    <div class="cosmetic-frame-preview__inner">${Go(`avatar_default`)}</div>
  </div>`}function Zo(e,t){return t===`avatar`?Go(e):t===`frame`?Xo(e):t===`banner`?`<div class="cosmetic-preview-banner" style="background:${qo(e)}"></div>`:t===`pieceSkin`?Qo(e):``}function Qo(e){let t=e.replace(`skin_`,``);return`<div class="cosmetic-skin-preview">
    <span class="piece red piece-skin-${t} king"></span>
    <span class="piece black piece-skin-${t}"></span>
  </div>`}function $o(e){let t=document.createElement(`article`);t.className=`cosmetic-reveal-card rarity-${e.rarity} cosmetic-reveal-card--${e.type}`,e.duplicate&&t.classList.add(`cosmetic-reveal-card--duplicate`);let n=Zo(e.id,e.type),r=Jo(e.type);return t.innerHTML=`
    ...
    </div>`,t.style.animationDelay=`0s`,t}function es(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function ts(e,t=``){let n=ee(e),r=(t||`P`).charAt(0).toUpperCase(),i=Go(n.equipped.avatar)||`<span class="profile-avatar-fallback">${es(r)}</span>`;return`<span class="profile-avatar-stack header-profile-btn__stack ${Yo(n.equipped.frame)}"><span class="profile-avatar-inner header-profile-btn__inner">${i}</span></span>`}async function ns(e){if(!e)return``;try{return(await Ae(e.id))?.username||e.user_metadata?.display_name||e.email?.split(`@`)[0]||``}catch{return e.user_metadata?.display_name||e.email?.split(`@`)[0]||``}}var rs=null;function is(){return rs||=Promise.all([E(()=>import(`./match-BtLnNN3g.js`),[],import.meta.url),E(()=>import(`./matchView-BSbaCRTd.js`),[],import.meta.url),E(()=>Promise.resolve({}),__vite__mapDeps([0]),import.meta.url),E(()=>Promise.resolve({}),__vite__mapDeps([1]),import.meta.url)]).then(([e,t])=>({MatchSession:e.MatchSession,getMatchHtml:t.getMatchHtml})),rs}var as=null;function os(){return as||=Promise.all([E(()=>import(`./pvpUI-Bi1pJRZP.js`),[],import.meta.url),E(()=>import(`./pvp-B7RinJq9.js`),[],import.meta.url)]).then(([e,t])=>({initPvpUI:e.initPvpUI,clearAllWaitingRoomsOnce:t.clearAllWaitingRoomsOnce})),as}var ss=null;function cs(){return ss||=E(()=>import(`./profileUI-OjTpY0tT.js`),[],import.meta.url),ss}function ls(){ss=null}var us=null;function ds(){return us||=Promise.all([E(()=>import(`./settingsUI-dsrLCWFf.js`),[],import.meta.url),E(()=>Promise.resolve({}),__vite__mapDeps([2]),import.meta.url)]).then(([e])=>e),us}var fs=null;function ps(){return fs||=Promise.all([E(()=>import(`./chestOpenAnimation-C3DpyDef.js`),[],import.meta.url),E(()=>import(`./cosmeticOpenAnimation-C4OCMc_p.js`),[],import.meta.url),E(()=>import(`./titleOpenAnimation-CQ7uzgsr.js`),[],import.meta.url)]).then(([e,t,n])=>({playChestOpenAnimation:e.playChestOpenAnimation,playCosmeticOpenAnimation:t.playCosmeticOpenAnimation,playTitleOpenAnimation:n.playTitleOpenAnimation})),fs}var ms=null;function hs(){return ms||=E(()=>import(`./tutorialMeta-CpdPiuR3.js`),[],import.meta.url),ms}var gs=null;function _s(){return gs||=E(()=>import(`./tutorialUnlocks-CWiWHZGg.js`),[],import.meta.url),gs}var vs=null;function ys(){return vs||=E(()=>import(`./tutorialMatch-CSrSohKE.js`),[],import.meta.url),vs}function bs(e,t){hs().then(n=>n.notifyMetaTutorial(e,t))}function xs(e,t){_s().then(n=>n.notifyUnlockTutorial(e,t))}var U;try{U=be()}catch(e){console.error(`Failed to load profile, resetting save:`,e),localStorage.removeItem(`cardCheckersProfile_v7`),localStorage.removeItem(`cardCheckersProfile_v5`),U=be()}var W=`deck`,Ss={deck:`Decks`,chests:`Shop`,play:`Play`,pvp:`PvP`,quests:`Quests`,profile:`Profile`,settings:`Settings`},Cs=new Set(Object.keys(Ss)),ws=`cards`,Ts=`list`,G=null,K=[],Es=null,Ds=``,Os=`all`,ks=`all`,As=!0,js={legendary:5,epic:4,rare:3,uncommon:2,common:1};function Ms(e){return[...e].sort((e,t)=>{let n=js[e.rarity]??0,r=js[t.rarity]??0;return n===r?e.name.localeCompare(t.name):r-n})}var q=null,Ns=null,Ps=null;function Fs(){return Ns?Promise.resolve(Ns):(Ps||=os().then(({initPvpUI:e,clearAllWaitingRoomsOnce:t})=>(t(),Ns=e({root:document.getElementById(`view-pvp`),getProfile:()=>U,openAuthModal:()=>Ls?.open(`signin`,{forced:!0}),onNavigateTab:Z,onOpenDeckEdit:$c,onPvpViewShown:()=>{W=`pvp`,rc()}}),Ns)),Ps)}var Is=null,Ls=null,J=!1,Rs=!1,zs=!1,Bs=!1,Vs=!1,Hs=null,Us=null,Ws=null,Y=1,Gs=null;function Ks(e){return js[e?.rarity]??0}function qs(e){let t=i(e);return Object.entries(t).map(([e,t])=>({def:n(e),count:t})).filter(e=>e.def).sort((e,t)=>{let n=Ks(t.def)-Ks(e.def);return n===0?e.def.name.localeCompare(t.def.name):n})}function Js(e){let t=K.indexOf(e);t<0||(K.splice(t,1),rl(),bs(`card-removed-from-deck`,{cardId:e}))}function Ys(e){let t=K.length;K=K.filter(t=>t!==e),K.length!==t&&(rl(),bs(`card-removed-from-deck`,{cardId:e}))}function Xs(){let n=e().map(e=>({def:e,owned:oe(U,e.id)})).filter(e=>e.owned>0).sort((e,t)=>{let n=Ks(t.def)-Ks(e.def);return n===0?e.def.name.localeCompare(t.def.name):n});K=[];for(let{def:e,owned:r}of n){let n=Math.min(r,t(e));for(let t=0;t<n&&K.length<30;t++)K.push(e.id);if(K.length>=30)break}rl()}var X=e=>document.getElementById(e);function Zs(){let e=document.getElementById(`adventure-prebattle`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function Qs(){let e=document.querySelector(`nav.game-nav.tabs`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function $s(){return window.matchMedia(`(min-width: 1000px) and (max-width: 1400px)`).matches?2.5:window.matchMedia(`(min-width: 600px) and (max-width: 999px)`).matches?1.85:1}function ec(){Zs(),document.getElementById(`adventure-prebattle`)?.classList.remove(`hidden`),document.body.classList.add(`adventure-floor-open`)}function tc(){document.getElementById(`adventure-prebattle`)?.classList.add(`hidden`),document.body.classList.remove(`adventure-floor-open`)}function nc(e=S,t=`Locked`){Gn({title:t,bodyHtml:e,autoCloseMs:4500})}function rc(){document.body.classList.toggle(`main-tab-active`,Cs.has(W)),document.body.classList.toggle(`adventure-active`,W===`play`)}function ic(e,t,n){let r=e.querySelector(`.tab-btn__sign-in-badge`);t?(r||(r=document.createElement(`span`),r.className=`tab-btn__sign-in-badge`,r.setAttribute(`aria-hidden`,`true`),e.appendChild(r)),r.textContent=n,e.classList.add(`tab-btn--sign-in-nudge`)):(r?.remove(),e.classList.remove(`tab-btn--sign-in-nudge`))}function ac(){let e=h(U),t=$t();for(let n of[`quests`,`pvp`]){let r=document.querySelector(`.tab-btn[data-tab="${n}"]`);if(!r)continue;let i=n===`pvp`?`PvP`:`Quests`,a=!e,o=n===`pvp`?Zt:Qt;r.classList.toggle(`tab-btn--locked`,a),r.setAttribute(`aria-disabled`,a?`true`:`false`),a?(r.title=t?`${l(i)} ${o}.`:l(i),ic(r,t,`Sign in`)):t?(r.title=o,ic(r,n===`pvp`,`Sign in`)):(r.title=``,ic(r,!1))}let n=m(U),r=document.querySelector(`.vault-tab[data-vault-tab="cosmetics"]`);r&&(r.classList.toggle(`vault-tab--locked`,!n),r.title=n?``:pe,r.setAttribute(`aria-disabled`,n?`false`:`true`))}async function Z(e){let t=document.getElementById(`view-match`);if(!(J&&t&&!t.classList.contains(`hidden`))){if(!Rs&&(e===`quests`||e===`pvp`)&&!h(U)){let t=e===`pvp`?`PvP`:`Quests`,n=$t(),r=e===`pvp`?Zt:Qt;await $e(n?`${l(t)}\n\n${r}.`:l(t),{title:`${t} locked`,confirmLabel:`Go to Adventure`,cancelLabel:n?`Sign in`:`Not now`})?(Rs=!0,Z(`play`),Rs=!1):n&&Ls?.open(`signin`,{forced:!0});return}if(cr(),$n()&&tr()){if(e===W)return;if(!(e===`pvp`&&document.getElementById(`pvp-match-root`))){if(!await $e(`Leave your current match to open ${Ss[e]||e}?`,{title:`Leave match?`,confirmLabel:`Leave`,cancelLabel:`Stay`,destructive:!0}))return;nr(e),ar(),document.querySelector(`#btn-leave-match`)?.click();return}}if(Ts===`edit`&&(e!==`deck`||e===`deck`&&W===`deck`)){if(!await Zc())return;Qc()}e!==`deck`&&Ts===`edit`&&(Ac(),document.body.classList.remove(`deck-editing`)),W=e,rc(),Cs.has(e)&&Oc(),document.querySelectorAll(`.tab-btn`).forEach(t=>{t.classList.toggle(`active`,t.dataset.tab===e)}),document.querySelectorAll(`.view`).forEach(t=>{t.classList.toggle(`hidden`,t.id!==`view-${e}`)}),bs(`tab-changed`,{tab:e}),xs(`tab-changed`,{tab:e}),e===`chests`&&(Bc(ws),Hc()),e===`deck`&&(Ts=`list`,Mc(`list`)),e===`profile`&&dc(),e===`settings`&&fc(),e===`quests`&&(hc(),_c()),e===`play`&&cl(),e===`pvp`&&Fs().then(e=>e?.render({resume:!0})).catch(e=>{console.error(`[PvP] init failed`,e);let t=document.getElementById(`view-pvp`);t&&!t.innerHTML.trim()&&(t.innerHTML=`<section class="panel game-panel pvp-panel"><p class="pvp-status pvp-status--error">Couldn't load PvP — please reload the page.</p></section>`)}),$n()||(bo(`hub`),await Oo())}}var Q=``;function oc(e=Q){e&&(Q=e);let t=document.getElementById(`header-profile-menu`),n=document.getElementById(`header-profile-btn`),r=document.getElementById(`header-username`),i=document.getElementById(`auth-header-btn`),a=!!D();if(i&&(i.classList.toggle(`hidden`,a),i.hidden=a),t&&(t.classList.toggle(`hidden`,!a),t.hidden=!a),r){let e=a&&Q;r.textContent=e?Q:``,r.classList.toggle(`hidden`,!e),r.hidden=!e}n&&a&&(n.innerHTML=ts(U,Q),n.title=Q?`Account — ${Q}`:`Account menu`)}function sc(){let e=document.getElementById(`header-profile-btn`),t=document.getElementById(`header-profile-dropdown`);!e||!t||(t.classList.add(`hidden`),t.hidden=!0,e.setAttribute(`aria-expanded`,`false`))}function cc(){let e=document.getElementById(`header-profile-menu`),t=document.getElementById(`header-profile-btn`),n=document.getElementById(`header-profile-dropdown`);if(!e||!t||!n)return;let r=e=>{n.classList.toggle(`hidden`,!e),n.hidden=!e,t.setAttribute(`aria-expanded`,e?`true`:`false`)};t.addEventListener(`click`,e=>{e.stopPropagation();let t=!n.hidden;r(!t)}),n.querySelectorAll(`[data-profile-menu-action]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.profileMenuAction;sc(),t===`settings`?Z(`settings`):uc()})}),document.addEventListener(`click`,t=>{n.hidden||e.contains(t.target)||sc()}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&!n.hidden&&sc()})}async function lc(){let e=D();if(!e){Q=``,oc();return}Q=await ns(e),oc()}function uc(){sc(),Z(`profile`),xs(`profile-opened`)}async function dc(){let{renderProfileTab:e}=await cs(),t=X(`view-profile`);e(U,t,{onGemsChange:vc,onTitleChanged:()=>oc()})}async function fc(){let{renderSettingsTab:e}=await ds();e(X(`view-settings`),{onUsernameChanged:e=>{Q=e,oc(e)}})}var pc=`
  ...
  <section class="panel game-panel quests-panel quests-panel--error">
  ...
  </section>`;function hc(){let e=X(`view-quests`);e&&(e.innerHTML=pc)}function gc(e=X(`view-quests`)){e&&(e.innerHTML=mc,e.querySelector(`.quests-retry-btn`)?.addEventListener(`click`,()=>{ls(),hc(),_c()}))}async function _c(){let e=X(`view-quests`);if(e)try{let{renderQuestsTab:t}=await cs();t(U,e,{onTitleChanged:()=>oc(),onCurrencyChange:()=>$()})}catch(t){console.error(`[Quests] render failed`,t),gc(e)}}function $(){let e=X(`header-gems`);e&&(e.textContent=String(U.gems??0));let t=X(`header-stars`);t&&(t.textContent=String(U.stars??0)),document.querySelector(`.hud-gems`)?.classList.toggle(`hud-gems--low`,(U.gems??0)<50),document.querySelector(`.hud-stars`)?.classList.toggle(`hud-stars--low`,(U.stars??0)<10)}function vc(){$()}function yc(){document.querySelectorAll(`.collection-owned-only-toggle`).forEach(e=>{e.checked=As});for(let e of[`collection-search`]){let t=X(e);t&&(t.value=Ds)}for(let e of[`collection-rarity`]){let t=yr(e);t&&(t.value=Os)}let e=yr(`collection-category`);e&&(e.value=ks)}var bc=`(max-width: 899px)`,xc=`(max-width: 1280px)`,Sc=null;function Cc(){return window.matchMedia(bc).matches}function wc(){return document.body.classList.contains(`main-tab-active`)&&!document.body.classList.contains(`match-active`)&&!document.body.classList.contains(`deck-editing`)&&window.matchMedia(xc).matches}function Tc(){return document.querySelector(`.game-main`)}function Ec(){let e=Tc();return wc()&&e?e.scrollTop:window.scrollY||document.documentElement.scrollTop||0}function Dc(e){let t=Tc();if(wc()&&t){t.scrollTop=e;return}window.scrollTo(0,e)}function Oc(){let e=Tc();if(wc()&&e){e.scrollTop=0;return}window.scrollTo(0,0)}function kc(){Cc()&&(Sc=Ec(),document.body.style.position=`fixed`,document.body.style.top=`0`,document.body.style.left=`0`,document.body.style.right=`0`,document.body.style.width=`100%`)}function Ac(){if(Sc==null)return;let e=Sc;Sc=null,document.body.style.position=``,document.body.style.top=``,document.body.style.left=``,document.body.style.right=``,document.body.style.width=``,Dc(e)}function jc(){Oc(),document.documentElement.scrollTop=0,document.body.scrollTop=0,document.querySelector(`.game-shell`)?.scrollTo?.(0,0),Tc()?.scrollTo?.(0,0),document.querySelector(`#view-deck`)?.scrollTo?.(0,0),document.querySelectorAll(`#deck-subview-edit, #deck-subview-edit .deck-editor, #deck-subview-edit .deck-editor__body, #deck-subview-edit .deck-editor__grid, #deck-subview-edit .deck-editor__grid-cards`).forEach(e=>{e.scrollTop=0})}function Mc(e){e!==`edit`&&Ac(),Ts=e,document.body.classList.toggle(`deck-editing`,e===`edit`),X(`deck-subview-list`)?.classList.toggle(`hidden`,e!==`list`),X(`deck-subview-edit`)?.classList.toggle(`hidden`,e!==`edit`),e===`edit`&&(kc(),w(U),T(U),Os=`all`,Ds=``,ks=`all`,As=!0,yc(),Yc()),e===`list`&&nl(),e===`edit`&&(rl(),jc(),requestAnimationFrame(()=>{jc(),requestAnimationFrame(jc)}))}function Nc({id:e,title:t,desc:n,cost:r,variant:i=`mystery`}){let a=(U.stars??0)>=r,o=i===`title`?Bt():Ht();return`
    ...
    </article>`}function Pc(e,t){e.querySelector(`[data-mystery-open]`)?.addEventListener(`click`,e=>{e.stopPropagation(),t()}),e.addEventListener(`click`,t),e.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),t())})}function Fc({bonusGems:e=0,bonusStars:t=0}={}){let n=[];return e&&n.push(`+${e} gem refund`),t&&n.push(`+${t} ★ from duplicates`),n.length?` (${n.join(`, `)})`:``}async function Ic(e,t){let{playChestOpenAnimation:n,playCosmeticOpenAnimation:r,playTitleOpenAnimation:i}=await ps();e.kind===`card`?(await n({tier:`silver`,tierLabel:`Mystery Box`,pulls:e.cardPulls}),t&&(t.textContent=`Got ${e.cardPulls.length} spells.${Fc(e)}`)):e.kind===`cosmetic`?(await r({boxId:`silver`,boxLabel:`Mystery Box`,pulls:e.cosPulls}),t&&(t.textContent=e.message+Fc(e))):e.kind===`mixed`?(e.cardPulls.length&&await n({tier:`silver`,tierLabel:`Mystery Box — Spells`,pulls:e.cardPulls}),e.cosPulls.length&&await r({boxId:`silver`,boxLabel:`Mystery Box — Cosmetics`,pulls:e.cosPulls}),t&&(t.textContent=`${e.message}${Fc(e)}`)):e.kind===`title`&&(await i({boxLabel:`Title Box`,pulls:e.pulls}),t&&(t.textContent=e.message))}async function Lc(){let e=X(`mystery-box-log`);if(!((U.stars??0)>=10)){e&&(e.textContent=`Need 10 ★ stars. Clear Adventure floors to earn stars.`,e.classList.add(`chest-log--error`));return}let t=Jt(U);if(!t.success){e&&(e.textContent=t.message,e.classList.add(`chest-log--error`));return}T(U),$(),e&&e.classList.remove(`chest-log--error`),X(`mystery-box-list`)?.querySelectorAll(`.mystery-box__btn`).forEach(e=>{e.disabled=!0});try{await Ic(t,e)}catch(n){console.error(`Mystery box animation failed:`,n),e&&(e.textContent=t.message)}Hc({clearPulls:!1}),dc()}async function Rc(){let e=X(`mystery-box-log`);if(!((U.stars??0)>=10)){e&&(e.textContent=`Need 10 ★ stars. Clear Adventure floors to earn stars.`,e.classList.add(`chest-log--error`));return}let t=Yt(U);if(!t.success){e&&(e.textContent=t.message,e.classList.add(`chest-log--error`));return}T(U),$(),e&&e.classList.remove(`chest-log--error`),X(`mystery-box-list`)?.querySelectorAll(`.mystery-box__btn`).forEach(e=>{e.disabled=!0});try{await Ic(t,e)}catch(n){console.error(`Title box animation failed:`,n),e&&(e.textContent=t.message)}Hc({clearPulls:!1}),dc()}function zc(){let e=X(`mystery-box-list`);if(!e)return;e.innerHTML=`
    ${Nc({id:`mystery`,title:`Mystery Box`,desc:`6 random pulls — mix of spells and cosmetics (${Math.round(Ut*100)}% cosmetic per slot when unlocked).`,cost:10})}
    ${Nc({id:`title`,title:`Title Box`,desc:`Box-exclusive mage titles only — The Brave, Ruthless, Omnipotent, and more.`,cost:10,variant:`title`})}
  `;let t=e.querySelectorAll(`.mystery-box`);Pc(t[0],()=>Lc()),Pc(t[1],()=>Rc())}function Bc(e){if(!zs&&e===`cosmetics`&&!m(U)){nc(pe,`Cosmetics locked`),zs=!0,Bc(`cards`),zs=!1;return}ws=e,document.querySelectorAll(`.vault-tab`).forEach(t=>{let n=t.dataset.vaultTab===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,n?`true`:`false`)}),document.querySelectorAll(`.vault-tab-panel`).forEach(t=>{let n=t.id===`vault-tab-${e}`;t.classList.toggle(`hidden`,!n),t.hidden=!n}),xs(`vault-tab-changed`,{tab:e})}function Vc(){cs().then(({renderCosmeticBoxes:e})=>{e(U,X(`cosmetic-box-list`),{logEl:X(`cosmetic-box-log`),onGemsChange:vc,cosmeticsUnlocked:m(U),onOpened:()=>{W===`profile`&&dc(),W===`quests`&&_c()}})})}function Hc(e={}){let{clearPulls:t=!0}=e;$(),Vc(),zc();let n=X(`chest-list`),r=X(`chest-pulls`);if(r&&t&&(r.innerHTML=``,r.classList.add(`chest-pulls--hidden`),r.classList.remove(`chest-pulls--reveal`)),n){n.innerHTML=``;for(let e of lt){let t=_t[e.id]||_t.bronze,i=U.gems>=e.cost,a=document.createElement(`article`);a.className=`chest-card chest-card--${e.id}${i?``:` chest-card--locked`}`,a.innerHTML=`
    ...
    `;let o=a.querySelector(`.chest-open`);o.disabled=!i,o.addEventListener(`click`,async()=>{if(o.disabled)return;let n=mt(U,e.id),i=X(`chest-log`);if(!n.success){i&&(i.textContent=n.message,i.classList.add(`chest-log--error`));return}T(U),$(),o.disabled=!0;let{playChestOpenAnimation:a}=await ps();if(await a({tier:e.id,tierLabel:t.label,pulls:n.pulls}),bs(`chest-opened`,{chestId:e.id}),i){let t=n.bonusGems?` (+${n.bonusGems} gems from duplicates)`:``;i.textContent=`Got ${n.pulls.length} spells from ${e.name}.${t}`,i.classList.remove(`chest-log--error`)}if(r){r.classList.remove(`chest-pulls--hidden`),r.classList.add(`chest-pulls--reveal`),r.innerHTML=`<p class="chest-pulls__label">Chest opened</p><div class="chest-pulls__grid"></div>`;let e=r.querySelector(`.chest-pulls__grid`);n.pulls.forEach((t,n)=>{let r=La(t,{button:!0,deal:!0,gallery:!0,onClick:()=>Ua(t)});if(r.style.animationDelay=`${n*.12}s`,t.duplicate){r.classList.add(`spell-card--duplicate-pull`);let e=document.createElement(`span`);e.className=`chest-pull-dup-badge`,e.textContent=t.starRefund?`Duplicate · +${t.starRefund} ★`:`Duplicate · +${t.gemRefund} ◆`,r.appendChild(e)}e.appendChild(r),Ya(r,t.rarity)}),Ga(e),r.scrollIntoView({behavior:`smooth`,block:`nearest`})}Hc()}),n.appendChild(a)}}}function Uc(){return Ms(e().filter(e=>{if(ks!==`all`&&ct(e)!==ks||Os!==`all`&&e.rarity!==Os)return!1;if(Ds){let t=Ds.toLowerCase();if(!e.name.toLowerCase().includes(t)&&!e.desc.toLowerCase().includes(t))return!1}return!(As&&oe(U,e.id)<=0)}))}function Wc(e,t){let n=Qa(U,e);return t&&(t.textContent=n.message,t.className=n.success?`deck-status ok`:`deck-status warn`),n.success&&(T(U),$(),Ts===`list`&&nl(),Ts===`edit`&&rl()),n}function Gc(e,t){let n=Qa(U,e);return n.success?(T(U),$(),K.push(e),ge(U,e),T(U),rl(),t&&(t.hidden=!1,t.textContent=`Bought and added to deck.`,t.className=`deck-editor__error deck-status ok`),!0):(t&&(t.hidden=!1,t.textContent=n.message,t.className=`deck-editor__error deck-status warn`),!1)}function Kc(e){return a(K,e,U).ok?(K.push(e),ge(U,e),T(U),rl(),bs(`card-added-to-deck`,{cardId:e}),!0):!1}function qc(e,n,r={}){let{deckEdit:o=!1,statusEl:s=null}=r,c=oe(U,n.id),l=t(n),u=c>=l,d=Za(n.rarity),f=U.gems>=d&&!u,p=o?a(K,n.id,U):{ok:!1},m=o&&i(K)[n.id]||0,h=K.length<30,g=m<l,ee=c>=1&&c<=m,_=c>=1&&!u,v=o&&!p.ok&&h&&g&&ee&&_,y=()=>Wc(n.id,s),b=()=>{let e=oe(U,n.id),t=o&&i(K)[n.id]||0,r=e>=l,s=U.gems>=d&&!r,c=o?a(K,n.id,U):{ok:!1};Ua(n,{meta:o?`Owned ${e}/${l} · In deck ${t}/${l} · ${r?`max copies`:`${d} gems per copy`}`:`Owned ${e}/${l}${r?` · max copies`:` · ${d} gems per copy`}`,buyLabel:r?`Max copies owned`:`Buy copy (${d} gems)`,buyDisabled:!s||r||e<1,onBuy:()=>{y(),Ha()},addDisabled:!c.ok,onAdd:o?()=>{Kc(n.id)&&b()}:void 0})};if(o){let t=document.createElement(`div`);t.className=`deck-editor-tile`+(x(U,n.id)?` deck-editor-tile--new`:``);let r=La(n,{button:!0,gallery:!0,onClick:()=>b()});r.classList.add(`deck-editor-tile__card`),r.title=`${n.name} — tap for full card`;let i=c>0?`Owned ${c}/${l}`:`Not in collection`,a=document.createElement(`div`);a.className=`deck-editor-tile__meta`,a.innerHTML=`${i} · In deck ${m}/${l}${x(U,n.id)?`<span class="deck-editor-tile__new">New</span>`:``}`,a.addEventListener(`click`,()=>b());let o=document.createElement(`button`);o.type=`button`,o.className=`deck-editor-tile__action`,p.ok?(o.classList.add(`deck-editor-tile__action--add`),o.textContent=`+ Add to deck`,o.addEventListener(`click`,e=>{e.stopPropagation(),Kc(n.id)})):v?(o.classList.add(`deck-editor-tile__action--buy`),o.textContent=f?`Add for ${d} gems`:`Need ${d} gems`,o.disabled=!f,o.addEventListener(`click`,e=>{e.stopPropagation(),Gc(n.id,s)})):(o.classList.add(`deck-editor-tile__action--disabled`),o.disabled=!0,K.length>=30?o.textContent=`Deck full (30/30)`:m>=l?o.textContent=`Max copies in deck`:c<1?o.textContent=`Open Shop chests to unlock`:p.reason?o.textContent=p.reason:o.textContent=`Can't add`),t.append(r,a,o),e.appendChild(t);return}let S=document.createElement(`div`);S.className=`collection-card-wrap`+(c<1?` collection-card-wrap--unowned`:``);let C=La(n,{button:!0,compact:!0,disabled:c<1||u,onClick:e=>{if(e.shiftKey||c<1||u){b();return}y()}});C.title=u?`${n.name} — max ${l} copies owned. Tap to view full card.`:c<1?`${n.name} — not owned. Tap to view full card.`:`${n.name} — tap to buy (${d} gems). Shift+click to inspect.`,S.appendChild(C);let te=document.createElement(`span`);te.className=`collection-owned-count`,te.textContent=c>0?`×${c}`:`—`,S.appendChild(te);let w=document.createElement(`span`);w.className=`collection-buy-cost`,w.textContent=u?`MAX`:`${d} ◆`,(!f||u)&&w.classList.add(`collection-buy-cost--cant`),S.appendChild(w),e.appendChild(S)}function Jc(e,t={}){if(!e)return;let{deckEdit:n=!1,statusEl:r=null}=t;e.innerHTML=``;let i=Uc();if(!i.length){e.className=`deck-editor__grid collection-grid`;let t=document.createElement(`p`);t.className=`collection-grid-empty muted`,t.textContent=n?`No spells match your filters. Try “All types”, clear search, or uncheck Owned only.`:`No cards match your filters. Open chests in the Shop to get more spells.`,e.appendChild(t);return}let a=0,o={deckEdit:n,statusEl:r};if(n||ks!==`all`){e.className=`deck-editor__grid collection-grid`;for(let t of i)try{qc(e,t,o),a+=1}catch(e){console.error(`Failed to render card:`,t?.id,e)}}else{e.className=`deck-editor__grid collection-categories`;let t=Object.fromEntries(at.map(e=>[e,[]]));for(let e of i)t[ct(e)].push(e);for(let n of at){let r=t[n];if(!r.length)continue;let i=document.createElement(`section`);i.className=`collection-category-section`,i.dataset.category=n;let s=document.createElement(`h3`);s.className=`collection-category-title`,s.textContent=ot[n],i.appendChild(s);let c=document.createElement(`div`);c.className=`collection-grid deck-editor__grid-cards`;for(let e of r)try{qc(c,e,o),a+=1}catch(t){console.error(`Failed to render card:`,e?.id,t)}i.appendChild(c),e.appendChild(i)}}if(i.length>0&&a===0){e.className=`deck-editor__grid collection-grid`;let t=document.createElement(`p`);t.className=`collection-grid-empty collection-grid-empty--error`,t.textContent=`Spells failed to display. Hard refresh the page (Ctrl+Shift+R).`,e.appendChild(t)}}function Yc(){Es={name:X(`deck-name-input`)?.value?.trim()??``,cardIds:[...K]}}function Xc(){return Es?(X(`deck-name-input`)?.value?.trim()??``)!==Es.name||K.length!==Es.cardIds.length?!0:K.some((e,t)=>e!==Es.cardIds[t]):!1}async function Zc(){return Xc()?$e(`Discard unsaved changes to this deck?`,{title:`Unsaved changes`,confirmLabel:`Discard`,cancelLabel:`Keep editing`,destructive:!0}):!0}function Qc(){G=null,K=[],Es=null}function $c(e){let t=U.decks.find(t=>t.id===e);if(!t)return;G=t.id,K=[...t.cardIds];let n=X(`deck-name-input`);n&&(n.value=t.name),Mc(`edit`),bs(`deck-edit-opened`,{deckId:e})}function el(e){let t=Object.fromEntries(at.map(e=>[e,0]));for(let r of e){let e=n(r);e&&(t[ct(e)]+=1)}return t}function tl(e){let t=el(e),n=[];for(let e of at){let r=t[e];if(r<=0)continue;let i=ot[e];n.push(`<span class="deck-row__cat" title="${Ra(i)}: ${r}"><span class="deck-row__cat-dot deck-row__cat-dot--${e}" aria-hidden="true"></span><span class="deck-row__cat-n">${r}</span></span>`)}return n.length?`<div class="deck-row__cats">${n.join(``)}</div>`:``}function nl(){w(U)&&T(U),$();let e=X(`deck-list`);if(!e)return;e.innerHTML=``;let t=X(`deck-list-count`);if(t){let e=U.decks.length;t.textContent=e?`${e} deck${e===1?``:`s`}`:``}if(!U.decks.length){if(w(U)&&T(U),U.decks.length){nl();return}e.innerHTML=`
      ...
      <h3 class="deck-row-name">${Ra(t.name)}</h3>
      <div class="deck-row__progress">
        <div class="deck-progress-bar deck-row__progress-bar" role="progressbar" aria-valuemin="0" aria-valuemax="30" aria-valuenow="${t.cardIds.length}" aria-label="${Ra(t.name)} progress">
    ...
    `,a.addEventListener(`click`,()=>$c(t.id)),e.appendChild(a)}}function rl(){$();let e=X(`collection-grid`),t=X(`deck-slots`),n=X(`deck-status`),i=X(`edit-deck-heading`),a=X(`deck-count-badge`),o=X(`deck-progress-bar`);if(!e||!t)return;let s=X(`btn-delete-deck`);s&&(s.hidden=!(G&&G!==`new`&&G!==`deck-starter`)),i&&(i.textContent=G===`new`?`New deck`:`In your deck`);let c=r(K,U),l=`${K.length}/30`;a&&(a.textContent=l,a.classList.toggle(`deck-editor__count--ready`,c.valid));let u=X(`deck-progress-fill`),d=Math.min(100,K.length/30*100);u&&(u.style.width=`${d}%`),o&&(o.hidden=c.valid,c.valid||(o.setAttribute(`aria-valuenow`,String(K.length)),o.setAttribute(`aria-valuemax`,`30`))),n&&(c.valid?(n.textContent=``,n.hidden=!0,n.className=`deck-editor__error deck-status ok`):(n.hidden=!1,n.textContent=c.errors[0]||`${l} — keep adding spells`,n.className=`deck-editor__error deck-status warn`));let f=X(`deck-collection-hint`);f&&(f.hidden=!1,f.innerHTML=K.length>=30?`Deck is full. Remove a card from the strip above, or save when ready.`:`Tap <strong>+ Add to deck</strong> for copies you own. When all owned copies are in the deck, tap <strong>Add for X gems</strong> to buy another.`),Jc(e,{deckEdit:!0,statusEl:n}),t.innerHTML=``;let p=qs(K);if(!p.length){let e=document.createElement(`p`);e.className=`deck-editor__strip-empty`,e.textContent=`Empty deck — tap + Add to deck below`,t.appendChild(e)}for(let{def:e,count:n}of p){let r=document.createElement(`div`);r.className=`deck-slot-wrap deck-slot-wrap--strip`;let i=La(e,{button:!0,tiny:!0,onClick:()=>{Ua(e,{meta:n>1?`${n} copies in deck`:`In your deck`,onRemove:()=>Ys(e.id)})}});if(r.appendChild(i),n>1){let e=document.createElement(`span`);e.className=`deck-stack-count`,e.textContent=`×${n}`,r.appendChild(e)}let a=document.createElement(`button`);a.type=`button`,a.className=`deck-slot-remove deck-slot-remove--visible`,a.setAttribute(`aria-label`,`Remove one ${e.name} from deck`),a.textContent=`−`,a.addEventListener(`click`,t=>{t.stopPropagation(),Js(e.id)}),r.appendChild(a),t.appendChild(r)}}function il(){let e=X(`deck-name-input`)?.value?.trim()||`My Deck`,t=r(K,U);if(!t.valid){X(`deck-status`).textContent=t.errors.join(` `);return}let n;G&&G!==`new`?(n=U.decks.find(e=>e.id===G),n?(n.name=e,n.cardIds=[...K],n.updatedAt=Date.now()):n=v(e,K)):n=v(e,K),re(U,n),U.selectedDeckId=n.id,T(U),bs(`deck-saved`,{deckId:n.id}),Qc(),Mc(`list`)}function al(e=[]){let t=`New Deck`,n=new Set(e.map(e=>e.name?.trim()).filter(Boolean));if(!n.has(t))return t;let r=2;for(;n.has(`${t} ${r}`);)r++;return`${t} ${r}`}function ol(){G=`new`,K=[];let e=X(`deck-name-input`);e&&(e.value=al(U.decks)),Mc(`edit`)}function sl(){tc(),Ws=null}function cl(){U.adventure=ce(U.adventure),X(`adventure-map-view`)?.classList.remove(`hidden`),sl(),Gs=null,ml()}function ll(e){let t=ve[e]||ve.verdant,n=`map-${e}`;return`<svg class="adventure-map-scenery-svg" viewBox="0 0 100 120" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
    <defs>
  ...
  </svg>`}function ul(e=`#e8c547`){return`<svg class="adventure-map-tile__pawn-svg" viewBox="0 0 28 36" aria-hidden="true">
    <defs>
  ...
  </svg>`}function dl(e){let t=ve[e]||ve.verdant;return`<svg class="adventure-map-tile__banner-svg" viewBox="0 0 24 20" aria-hidden="true">
    <defs>
    ...
    <div class="adventure-map-canvas__bg" aria-hidden="true">
      <div class="adventure-map-scenery adventure-map-scenery--${i}" aria-hidden="true">${ll(i)}</div>
    ...
    <div class="adventure-map-tower">
      ...
      <span class="adventure-map-tile__stone" aria-hidden="true">
        ...
        ${a>0?`<span class="adventure-floor-row__stars">${xe(a)}</span>`:``}`,o.addEventListener(`click`,()=>Sl(t.id)),g.appendChild(o)}}let ee=r.querySelector(`.adventure-map-tile--next`);fl(r),ee&&requestAnimationFrame(()=>{requestAnimationFrame(()=>ee.scrollIntoView({behavior:`smooth`,block:`nearest`}))});let _=g?.querySelector(`.adventure-floor-row--next`);_&&requestAnimationFrame(()=>_.scrollIntoView({behavior:`smooth`,block:`end`})),r.querySelector(`.adventure-challenge-toggle`)?.addEventListener(`click`,t=>{t.preventDefault(),t.stopPropagation(),e.challengeMode=!e.challengeMode,U.adventure=e,T(U),Ro(),wo.tap(),ml()})}function hl(e){let t=he(e);if(!t||!Ce(U.adventure,e))return;Ws=e,ec();let n=X(`prebattle-title`),i=X(`prebattle-flavor`),a=X(`prebattle-opponent`);n&&(n.textContent=`Tower ${t.worldId} · Floor ${t.floorInWorld}`),i&&(i.textContent=t.flavor||``),a&&(a.textContent=`Loading…`);try{Gs=_(U,e),T(U)}catch(e){console.error(`Enemy deck failed`,e),a&&(a.textContent=`Could not build enemy deck. Try again.`);return}a&&(a.textContent=`Review the enemy spell deck, then choose your grimoire below.`);let o=X(`prebattle-gem-hint`);if(o){let n=te(U.adventure,e);o.textContent=(s(U.adventure,e)?`Repeat clear: +${n} gems`:`First clear: +${n} gems`)+(t.worldId===5&&b(U.adventure)?` · Challenge mode: enemy has an extra rank of pieces`:``)}let c=X(`enemy-deck-preview`);if(c){c.innerHTML=``;try{for(let{def:e,count:t}of ne(Gs)){if(!e)continue;let n=document.createElement(`button`);n.type=`button`,n.className=`enemy-deck-spell-btn`,n.title=`View ${e.name}`;let r=document.createElement(`span`);if(r.className=`enemy-deck-spell-btn__name`,r.textContent=e.name,n.appendChild(r),t>1){let e=document.createElement(`span`);e.className=`enemy-deck-spell-btn__count`,e.textContent=`×${t}`,n.appendChild(e)}n.addEventListener(`click`,()=>Ua(e,{meta:t>1?`${t} copies in enemy deck`:`Enemy deck`})),c.appendChild(n)}}catch(e){console.error(`Enemy preview failed`,e),c.innerHTML=`<p class="empty-msg">Enemy deck preview unavailable.</p>`}}w(U)&&T(U);let l=yr(`adventure-deck-select`);if(!l){a&&(a.textContent=`Deck selector missing — hard refresh the page.`);return}l.innerHTML=``;let u=U.decks.filter(e=>r(e.cardIds,U).valid);if(!u.length){let e=document.createElement(`option`);e.value=``,e.textContent=`No complete decks — build one in Decks`,l.appendChild(e),l.disabled=!0,X(`btn-start-adventure`).disabled=!0;return}l.disabled=!1;let d=U.selectedDeckId&&u.some(e=>e.id===U.selectedDeckId)?U.selectedDeckId:u[0].id;for(let e of u){let t=document.createElement(`option`);t.value=e.id,t.textContent=e.name,e.id===d&&(t.selected=!0),l.appendChild(t)}U.selectedDeckId=d,X(`btn-start-adventure`).disabled=!1}async function gl(e,t,n,r,i=null,a=!1,o=void 0){let s=t.opponent;sl(),Gs=null,document.querySelectorAll(`.view`).forEach(e=>e.classList.add(`hidden`)),X(`view-match`)?.classList.remove(`hidden`);let l=X(`view-match`);if(!l)return;let{MatchSession:u,getMatchHtml:d}=await is();l.innerHTML=d(s);let p=o??(Se(r).id===5&&b(U.adventure)),m={levelId:r,deckId:e.id,challengeMode:p},h={aiDeckIds:n,opponentName:s,cosmetics:ee(U),profile:U,challengeMode:p,buildGameOverActions:({won:e,isTie:t})=>vl(m,{won:e,isTie:t}),onGameOverAction:e=>{yl(e,m,l)}};i&&(h.initialState=i);try{q=new u(e.cardIds,l,()=>{q=null,fr(),Oo(),bo(`hub`),l.innerHTML=``,X(`view-match`)?.classList.add(`hidden`),Z(rr()||`play`),Bs&&wl(),Vs&&Tl()},e=>{let t=f(U,r,e),{gems:n,stars:i,starsGained:a}=t;return U.gems+=n,y(U,`adventure_floors`,1),c(U),T(U),$(),ac(),r===1&&t.firstTime&&(Bs=!0,wl()),r===5&&t.firstTime&&(Vs=!0),{message:`+${n} gems! · Best: ${xe(i)}`,starsGained:a}},h)}catch(e){throw q=null,l.innerHTML=``,X(`view-match`)?.classList.add(`hidden`),Z(`play`),e}ur({kind:`adventure`,deckId:e.id,deckCardIds:e.cardIds,aiDeckIds:n,opponentName:s,levelId:r,challengeMode:p}),await Oo(),bo(`match`),a&&(q.winRewarded=!0),pr(q),q.setMessage(``),q.render()}async function _l(){let e=mr();if(!e)return!1;let t=U.decks.find(t=>t.id===e.deckId)||U.decks.find(e=>e.cardIds?.length===30),n=e.levelId?he(e.levelId):null;return!t||t.cardIds.length!==30||!n||!e.aiDeckIds?.length||!await $e(`Resume your adventure match where you left off?`,{title:`Resume match?`,confirmLabel:`Resume`,cancelLabel:`Discard`})?(dr(),!1):(Ws=e.levelId,await gl(t,n,e.aiDeckIds,e.levelId,e.state,e.winRewarded,e.challengeMode),q?.setMessage(`Match resumed — pick up where you left off.`),!0)}function vl({levelId:e},{won:t,isTie:n}){let r=e+1,i=t&&r<=50&&Ce(U.adventure,r);if(n)return[{id:`backToAdventure`,label:`Back to Adventure`,primary:!0}];if(t){let e=[];return i?(e.push({id:`nextFloor`,label:`Next floor`,primary:!0}),e.push({id:`retry`,label:`Retry floor`}),e.push({id:`backToAdventure`,label:`Back to Adventure`})):(e.push({id:`backToAdventure`,label:`Back to Adventure`,primary:!0}),e.push({id:`retry`,label:`Retry floor`})),e}return[{id:`retry`,label:`Retry floor`,primary:!0},{id:`backToAdventure`,label:`Back to Adventure`}]}async function yl(e,{levelId:t,deckId:n,challengeMode:r},i){let a=U.decks.find(e=>e.id===n);if(e===`backToAdventure`){q?.onExit?.();return}if(e===`nextFloor`){let e=t+1;if(!he(e)||!Ce(U.adventure,e)){q?.onExit?.();return}q?.dispose(),q=null,fr({clearCheckpoint:!0}),Oo(),bo(`hub`),i&&(i.innerHTML=``),X(`view-match`)?.classList.add(`hidden`),await Z(`play`),hl(e);return}if(e===`retry`){let e=t,n=he(e);if(!a||a.cardIds.length!==30||!n){q?.onExit?.();return}q?.dispose(),q=null,fr(),await gl(a,n,_(U,e),e,null,!1,r)}}function bl(){let e=yr(`adventure-deck-select`)?.value,t=U.decks.find(t=>t.id===e),n=Ws,r=n?he(n):null,i=Gs?[...Gs]:null;if(!t||t.cardIds.length!==30||!r||!i?.length){let e=X(`prebattle-opponent`);e&&(!t||t.cardIds.length!==30?e.textContent=`Build a complete 30-card deck in the Decks tab, then try again.`:e.textContent=`Could not start battle — close and pick the floor again.`);return}gl(t,r,i,n)}function xl(){if(window.__adventureMapCaptureBound)return;window.__adventureMapCaptureBound=!0;let e=null,t=!1,n=0,r=e=>e.closest?.(`#adventure-map .adventure-map-tile, #adventure-map .adventure-map-pin`),i=e=>e?.closest?.(`.adventure-map-scene`),a=()=>{t=!0,clearTimeout(n),n=setTimeout(()=>{t=!1},280)},o=(e,t)=>{if(!e||e.disabled)return;let n=Number(e.dataset.level);!Number.isFinite(n)||n<1||(t.preventDefault(),t.stopPropagation(),Sl(n))};document.addEventListener(`pointerdown`,t=>{if(t.button!==0)return;let n=r(t.target);if(!n||n.disabled)return;let a=i(n);e={pin:n,pointerId:t.pointerId,startX:t.clientX,startY:t.clientY,scrollTop:a?.scrollTop??0,scrollLeft:a?.scrollLeft??0,cancelled:!1}},!0),document.addEventListener(`pointermove`,t=>{if(!e||t.pointerId!==e.pointerId||e.cancelled)return;let n=t.clientX-e.startX,r=t.clientY-e.startY;Math.hypot(n,r)>12&&(e.cancelled=!0);let a=i(e.pin);a&&(Math.abs(a.scrollTop-e.scrollTop)>3&&(e.cancelled=!0),Math.abs(a.scrollLeft-e.scrollLeft)>3&&(e.cancelled=!0))},!0),document.addEventListener(`pointerup`,t=>{if(!e||t.pointerId!==e.pointerId)return;let{pin:n,cancelled:r}=e;if(e=null,r){a();return}o(n,t),a()},!0),document.addEventListener(`pointercancel`,t=>{!e||t.pointerId!==e.pointerId||(e=null,a())},!0),document.addEventListener(`click`,e=>{if(t){e.preventDefault(),e.stopPropagation();return}let n=r(e.target);!n||n.disabled||o(n,e)},!0)}function Sl(e){let t=ce(U.adventure);if(U.adventure=t,!Ce(t,e)){nc(`Locked — beat global floor ${e-1} first, then return here.`,`Floor locked`);return}T(U),hl(e)}function Cl(){Qs(),window.addEventListener(`orientationchange`,Qs),window.addEventListener(`resize`,Qs),rc(),oo(),eo(),No(),So(),ko(),Po(),Wa(),xl(),Zs(),document.querySelector(`.adventure-map-scene`)?.addEventListener(`scroll`,pl,{passive:!0});let e;window.addEventListener(`resize`,()=>{clearTimeout(e),e=setTimeout(()=>{if(!document.body.classList.contains(`adventure-active`))return;let e=X(`adventure-map`);e&&fl(e)},120)}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&sl()}),document.querySelectorAll(`.tab-btn`).forEach(e=>{e.addEventListener(`click`,()=>{Ro(),wo.tap(),Z(e.dataset.tab)})}),document.querySelectorAll(`.vault-tab`).forEach(e=>{e.addEventListener(`click`,()=>{cr(),Bc(e.dataset.vaultTab)})}),X(`btn-new-deck`)?.addEventListener(`click`,ol),X(`btn-back-from-edit`)?.addEventListener(`click`,async()=>{await Zc()&&(Qc(),Mc(`list`))}),X(`btn-delete-deck`)?.addEventListener(`click`,async()=>{if(!G||G===`new`)return;let e=U.decks.find(e=>e.id===G);e&&await $e(`Delete "${e.name}"? This cannot be undone.`,{title:`Delete deck?`,confirmLabel:`Delete`,cancelLabel:`Keep`,destructive:!0})&&(fe(U,e.id),Qc(),Mc(`list`))});let t=()=>{Ts===`edit`&&rl(),Ts===`list`&&nl()};document.querySelectorAll(`.collection-owned-only-toggle`).forEach(e=>{e.addEventListener(`change`,e=>{As=e.target.checked,yc(),t()})}),document.querySelectorAll(`.btn-reset-collection-filters`).forEach(e=>{e.addEventListener(`click`,()=>{Os=`all`,Ds=``,ks=`all`,As=!0,yc(),t()})}),yc(),br(),X(`collection-search`)?.addEventListener(`input`,e=>{Ds=e.target.value,t()}),yr(`collection-category`)?.addEventListener(`change`,e=>{ks=e.target.value,t()}),yr(`collection-rarity`)?.addEventListener(`change`,e=>{Os=e.target.value,t()}),X(`btn-clear-deck`)?.addEventListener(`click`,()=>{K=[],rl()}),X(`btn-auto-finish-deck`)?.addEventListener(`click`,Xs),X(`btn-save-deck`)?.addEventListener(`click`,il),X(`btn-back-adventure`)?.addEventListener(`click`,sl),X(`adventure-floor-backdrop`)?.addEventListener(`click`,sl),X(`btn-start-adventure`)?.addEventListener(`click`,bl),yr(`adventure-deck-select`)?.addEventListener(`change`,e=>{U.selectedDeckId=e.target.value,T(U)});let n=document.getElementById(`auth-modal`),r=document.getElementById(`auth-header-btn`);cc(),qn(`adventure-help-btn`,`adventure-help-desc`),qn(`shop-help-btn`,`shop-help-desc`),qn(`deck-help-btn`,`deck-help-desc`),Is=mn({onSignIn:()=>Ls?.open(`signin`,{forced:!0}),onSignUp:()=>Ls?.open(`signup`,{forced:!0}),onGuest:()=>{tn(),jl()}}),Ls=fn({authBtn:r,modal:n,onNewAccount:()=>{U=_e()?me():be(),Dn(U,T)},onSignedIn:()=>{nn(),U=be(),w(U),En(U),$(),nl(),zc(),Is?.hide(),lc().then(()=>{W===`profile`&&dc(),W===`quests`&&_c(),W===`pvp`&&Fs().then(e=>e?.render({resume:!0}))}),Fs().then(e=>e?.render({resume:!0})),kl(),Al(),Ol(),Dl(),J||Z(W)},onSignedOut:()=>{nn(),sc(),Q=``,oc(),Ns?.dispose?.(),q=null,fr({clearCheckpoint:!0}),cr(),U=me(),ac(),$(),nl(),zc(),Is?.show(),Z(`deck`)}}),hr(()=>q),w(U),yc(),ac(),Ml()}function wl(){if(!Bs||Hs!=null)return;let e=0,t=()=>{if(Hs=null,e+=1,Bs){if(tr()){e<10&&(Hs=window.setTimeout(t,400));return}if(En(U),Ol()){Bs=!1;return}e<10&&(Hs=window.setTimeout(t,500))}};Hs=window.setTimeout(t,350)}function Tl(){if(!Vs||Us!=null)return;let e=0,t=()=>{if(Us=null,e+=1,Vs){if(tr()){e<10&&(Us=window.setTimeout(t,400));return}if(En(U),Dl()){Vs=!1;return}e<10&&(Us=window.setTimeout(t,500))}};Us=window.setTimeout(t,350)}function El(){return J||!pn()||!h(U)||!Fn(U)?!1:(J=!0,_s().then(({startPvpTutorial:e})=>{e({profile:U,saveProfile:T,onComplete:()=>{J=!1,U=be(),w(U),ac(),Z(`play`),Dl()}})}),!0)}function Dl(){return J||!pn()||!m(U)||An(U)||jn(U)||Pn(U)||Fn(U)||!Ln(U)?!1:(J=!0,Z(`play`),_s().then(({startCosmeticsTutorial:e})=>{e({profile:U,saveProfile:T,onComplete:()=>{J=!1,U=be(),w(U),ac(),Z(`play`)}})}),!0)}function Ol(){return J||!pn()||!h(U)?!1:(En(U),Pn(U)?(J=!0,Z(`play`),_s().then(({startQuestsTutorial:e})=>{e({profile:U,saveProfile:T,onComplete:()=>{J=!1,U=be(),w(U),ac(),El(),Dl()}})}),!0):El())}function kl(){return J||!pn()||!An(U)?!1:(J=!0,ys().then(({startInteractiveTutorial:e})=>{e({profile:U,saveProfile:T,onComplete:()=>{J=!1,U=be(),w(U),$(),nl(),zc(),Al()||Z(`deck`),Ol(),Dl()}})}),!0)}function Al(){return J||!pn()||!jn(U)?!1:(J=!0,Z(`deck`),hs().then(({startMetaTutorial:e})=>{e({profile:U,saveProfile:T,onComplete:()=>{J=!1,U=be(),w(U),$(),nl(),zc(),Z(`deck`),Ol(),Dl()}})}),!0)}async function jl(){Is?.hide(),!kl()&&(Al()||Ol()||Dl()||J||(await _l()||await Z(`deck`),cr(),bo(`hub`)))}async function Ml(){try{if(await Le()){try{let e=await ln();e&&(U=e)}catch(e){console.warn(`Cloud sync on load failed`,e)}w(U),$(),nl(),zc()}}catch(e){console.warn(`Auth init failed`,e)}if(En(U),await lc(),Ns&&Ns.render(),cr(),hn()){Is?.show();return}await jl()}Cl(),E(async()=>{let{registerSW:e}=await import(`./virtual_pwa-register-CpSsV7JG.js`);return{registerSW:e}},[],import.meta.url).then(({registerSW:e})=>{e({immediate:!0})}),et(),it();export{cr as A,Zt as B,dr as C,ur as D,rr as E,kn as F,$e as G,_t as H,Nn as I,qe as K,Mn as L,qn as M,In as N,fr as O,On as P,Rn as R,vr as S,or as T,Ct as U,zt as V,gt as W,Ya as _,Uo as a,La as b,Yo as c,$o as d,Oo as f,ao as g,H as h,qo as i,pr as j,tr as k,Go as l,bo as m,ns as n,Wo as o,xo as p,zo as r,Jo as s,ts as t,Zo as u,Ga as v,ir as w,Cr as x,Ua as y,rn as z};