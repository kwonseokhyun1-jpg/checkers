import{a as e,c as t,g as n,h as r,i,n as a,o,p as s,r as c,u as l,v as u,y as d}from"./auth-DFecQAOy.js";import{B as f,W as p,g as m,h,p as g}from"./index-CV2-qlXG.js";var _=`https://sites.google.com/view/arcane-checkers/home`;function v(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function y(){let e=h();return`
