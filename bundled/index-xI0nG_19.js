...
import{n as e,o as t,t as n}from"./cardCatalog-AYo7Vx9E.js";import{d as r,i,r as a}from"./deckRules-t-dVXs5T.js";import{A as o,At as s,Ct as c,D as l,Dt as u,Et as d,G as f,H as p,Ot as m,P as h,St as g,Tt as _,_t as v,a as y,bt as ee,c as b,ct as x,d as S,dt as C,f as w,ft as te,g as ne,gt as re,ht as ie,i as ae,j as oe,kt as se,l as ce,lt as le,m as T,mt as ue,o as de,ot as fe,p as pe,pt as me,r as he,s as ge,st as _e,t as ve,u as E,ut as ye,vt as be,wt as xe,xt as Se,yt as Ce,z as we}from"./storage-BIj5ZND2.js";import{l as Te,p as Ee,r as De}from"./mageTitles-BPvsmJqw.js";import{t as D}from"./preload-helper-CV77j2BA.js";import{a as Oe,c as ke,d as Ae,g as je,h as Me,l as Ne,o as O,p as Pe,s as Fe,t as Ie,v as Le}from"./auth-CgMhKfsK.js";var Re=Object.defineProperty,ze=(e,t)=>{let n={};for(var r in e)Re(n,r,{get:e[r],enumerable:!0});return t||Re(n,Symbol.toStringTag,{value:`Module`}),n};function Be(){let e=window.visualViewport;return e?Math.max(0,Math.round(e.offsetTop)):0}function Ve(){let e=window.visualViewport;return e?Math.max(0,Math.round(window.innerHeight-e.offsetTop-e.height)):0}function He(){let e=document.documentElement,t=()=>{e.style.setProperty(`--viewport-inset-top`,`${Be()}px`),e.style.setProperty(`--viewport-inset-bottom`,`${Ve()}px`)};t(),window.visualViewport?.addEventListener(`resize`,t),window.visualViewport?.addEventListener(`scroll`,t),window.addEventListener(`resize`,t),window.addEventListener(`orientationchange`,t)}He();var Ue=1100,We=120;function Ge(){let e=document.getElementById(`app-splash`);if(!e||e.classList.contains(`app-splash--hide`))return;e.classList.add(`app-splash--hide`),document.body.classList.remove(`splash-active`);let t=()=>{e.remove()};e.addEventListener(`transitionend`,t,{once:!0}),window.setTimeout(t,600)}function Ke(){Ge()}function qe(){let e=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches?We:Ue,t=performance.now(),n=()=>{let n=performance.now()-t,r=Math.max(0,e-n);window.setTimeout(Ge,r)};document.readyState===`interactive`||document.readyState===`complete`?n():document.addEventListener(`DOMContentLoaded`,n,{once:!0})}document.body.classList.add(`splash-active`),qe();var Je=`(max-width: 768px)`,Ye=null;function Xe(){return document.getElementById(`mobile-confirm`)}function Ze(e){let t=Xe();if(!t)return;t.classList.add(`hidden`),document.body.classList.remove(`mobile-confirm-open`);let n=Ye;Ye=null,n?.(e)}function Qe(e,t={}){if(!window.matchMedia(Je).matches)return Promise.resolve(window.confirm(e));let n=Xe();if(!n)return Promise.resolve(window.confirm(e));let{title:r=`Confirm`,confirmLabel:i=`OK`,cancelLabel:a=`Cancel`,destructive:o=!1}=t;return new Promise(t=>{Ye&&Ze(!1),Ye=t,n.querySelector(`#mobile-confirm-title`).textContent=r,n.querySelector(`#mobile-confirm-body`).textContent=e;let s=n.querySelector(`#mobile-confirm-ok`),c=n.querySelector(`#mobile-confirm-cancel`);s.textContent=i,c.textContent=a,s.classList.toggle(`btn-danger`,o),s.classList.toggle(`btn-primary`,!o),n.classList.remove(`hidden`),document.body.classList.add(`mobile-confirm-open`),c.focus()})}function $e(){let e=Xe();!e||e.dataset.bound||(e.dataset.bound=`1`,e.querySelector(`#mobile-confirm-ok`)?.addEventListener(`click`,()=>Ze(!0)),e.querySelector(`#mobile-confirm-cancel`)?.addEventListener(`click`,()=>Ze(!1)),e.querySelector(`[data-mobile-confirm-backdrop]`)?.addEventListener(`click`,()=>Ze(!1)))}var et=`cc_install_banner_dismissed`;function tt(){return window.matchMedia(`(display-mode: standalone)`).matches||window.navigator.standalone===!0}function nt(){let e=window.navigator.userAgent;return/iphone|ipad|ipod/i.test(e)&&!/crios|fxios/i.test(e)}function rt(){if(tt()||localStorage.getItem(et)===`1`)return;let e=document.getElementById(`install-banner`);if(!e)return;let t=null,n=()=>{e.classList.remove(`hidden`),document.body.classList.add(`install-banner-visible`)},r=()=>{e.classList.add(`hidden`),document.body.classList.remove(`install-banner-visible`)};window.addEventListener(`beforeinstallprompt`,r=>{r.preventDefault(),t=r,e.querySelector(`#install-banner-ios-hint`)?.classList.add(`hidden`),e.querySelector(`.install-banner__hint--default`)?.classList.remove(`hidden`),e.querySelector(`#install-banner-btn`)?.classList.remove(`hidden`),n()}),nt()&&(e.querySelector(`#install-banner-ios-hint`)?.classList.remove(`hidden`),e.querySelector(`.install-banner__hint--default`)?.classList.add(`hidden`),e.querySelector(`#install-banner-btn`)?.classList.add(`hidden`),window.setTimeout(n,2500)),e.querySelector(`#install-banner-btn`)?.addEventListener(`click`,async()=>{t&&(t.prompt(),await t.userChoice,t=null,r())}),e.querySelector(`#install-banner-dismiss`)?.addEventListener(`click`,()=>{localStorage.setItem(et,`1`),r()})}var it=[`attack`,`control`,`defense`,`movement`,`trap`,`special`],at={attack:`Attack`,control:`Control`,defense:`Defense`,movement:`Movement`,trap:`Trap`,special:`Special`},ot={aegis:`defense`,anchor:`defense`,backpedal:`control`,backstab:`attack`,backstep:`movement`,barrier:`defense`,bishops_mark:`movement`,blind:`control`,blizzard:`control`,snowball:`control`,berserk:`movement`,bomb:`attack`,shockwave:`control`,plague:`control`,bulwark:`defense`,create_foe:`special`,call_forward:`movement`,chain_lightning:`attack`,clone:`special`,coin_flip:`attack`,collapse:`special`,confusion:`control`,constitution:`defense`,counterspell:`trap`,crown:`special`,cryo_bolt:`attack`,cull:`attack`,darkness:`defense`,dash:`movement`,deep_freeze:`control`,deflect:`trap`,demote:`control`,deport:`movement`,displacement:`movement`,dominion:`special`,duel:`attack`,earthquake:`special`,execution:`attack`,extract:`control`,pyromancy:`attack`,fusion:`special`,hibernation:`special`,hostile_swap:`movement`,ignore:`special`,iron_will:`defense`,landmine:`trap`,last_king:`special`,bounty:`special`,link_fate:`special`,last_stand:`trap`,martyr:`trap`,leapfrog:`movement`,long_step:`movement`,magnet:`movement`,nudge:`movement`,offering:`special`,panic:`control`,poison:`attack`,mind_control:`special`,mulligan:`special`,zombify:`special`,press:`control`,purify:`special`,quick_march:`movement`,quicksand:`trap`,rally:`defense`,recall:`movement`,repel:`movement`,random_teleport:`movement`,retreat:`movement`,revive:`defense`,rooks_mark:`movement`,root:`control`,sacrifice:`attack`,sanctuary:`defense`,scatter:`movement`,shadow_swap:`movement`,sidestep:`movement`,shatter:`attack`,snipe:`attack`,snowball:`control`,stab:`attack`,stall:`defense`,tangle:`control`,teleport:`movement`,trickster:`special`,toll:`special`,vengeance:`trap`,ward:`defense`};function st(e){let t=ot[e?.id];if(t)return t;let n=`${e?.id||``} ${e?.effect||``} ${e?.name||``} ${e?.desc||``}`.toLowerCase();return/trap|mine|quicksand|counterspell|vengeance|last.?stand|martyr/.test(n)?`trap`:/shield|ward|aegis|sanctuary|barrier|anchor|deflect|stall|iron_will|rally|darkness/.test(n)?`defense`:/move|nudge|teleport|recall|leap|step|displace|swap|scatter|retreat|bishop|rook|overrun|promote|pull|push|shift|earthquake|magnet|repel/.test(n)?`movement`:/freeze|blind|confusion|hex|root|panic|press|silence|paraly|control|cannot play|random|mark|poison|die in \d+ turn/.test(n)?`control`:/\bdestroy\b|\bkills?\b|fireball|bolt|stab|snipe|duel|sacrifice|execution|shatter|cull|lightning/.test(n)?`attack`:`special`}var ct=[{id:`bronze`,name:`Bronze Chest`,cost:25,cards:3,weights:{common:70,uncommon:25,rare:5,epic:0}},{id:`silver`,name:`Silver Chest`,cost:50,cards:5,weights:{common:50,uncommon:35,rare:12,epic:3}},{id:`gold`,name:`Gold Chest`,cost:100,cards:8,weights:{common:32,uncommon:38,rare:22,epic:6,legendary:2}}];function lt(e){let t=Math.random()*100,n=0;for(let r of[`common`,`uncommon`,`rare`,`epic`,`legendary`])if(n+=e[r]||0,t<=n)return r;return`common`}function ut(t){let n=e().filter(e=>e.rarity===t);return n.length?n[Math.floor(Math.random()*n.length)]:e()[0]}function dt(e,t){return ut(lt(t.weights))}function ft(e,n,r={}){let{starRefundChance:i=0}=r;if(ae(e,n.id)<t(n))return ve(e,n.id,1),{...n,duplicate:!1};let a=we[n.rarity]||10;if(i>0&&Math.random()<i){let e=Math.random()<.5?1:2;return{...n,duplicate:!0,starRefund:e}}return{...n,duplicate:!0,gemRefund:a}}function pt(e,t){let n=ct.find(e=>e.id===t);if(!n)return{success:!1,message:`Unknown chest.`};if(e.gems<n.cost)return{success:!1,message:`Not enough gems.`};e.gems-=n.cost;let r=[],i=0;for(let t=0;t<n.cards;t++){let t=ft(e,dt(e,n));r.push(t),t.gemRefund&&(i+=t.gemRefund)}return i&&(e.gems+=i),fe(e,`boxes_opened`,1),T(e),{success:!0,pulls:r,chest:n,bonusGems:i}}var mt=[`common`,`uncommon`,`rare`,`epic`,`legendary`];function ht(e,{minPct:t=1}={}){return mt.filter(n=>(e[n]??0)>=t).map(t=>`${e[t]}% ${t}`).join(` · `)}var gt={bronze:{label:`Bronze`,tagline:`Mostly common cards`,accent:`#cd7f32`,glow:`rgba(205, 127, 50, 0.45)`},silver:{label:`Silver`,tagline:`Balanced card mix`,accent:`#a8b8d8`,glow:`rgba(168, 184, 216, 0.5)`},gold:{label:`Gold`,tagline:`Higher rare & epic odds`,accent:`#e8c547`,glow:`rgba(232, 197, 71, 0.55)`}};function _t(e){let t=gt[e]||gt.bronze;return{t,lid:e===`gold`?`#f5e6a8`:e===`silver`?`#e8eef8`:`#d4954a`,body:e===`gold`?`#7a5c12`:e===`silver`?`#4a5568`:`#5c3a1e`,trim:e===`gold`?`#ffe566`:e===`silver`?`#c8d8f0`:t.accent}}function vt(e,t){let{lid:n,body:r,trim:i}=_t(e);return`
  ...
  <path d="M28 48 L24 54 M36 48 L40 54" stroke="#86efac" stroke-width="1.4" stroke-linecap="round" opacity="0.35"/>
    ...
    <circle cx="32" cy="40" r="14" fill="none" stroke="#60a5fa" stroke-width="0.8" opacity="0.2"/>`}function Sa(){return`${N(32,54,20,4)}
  ...
  `,t.onClick&&l.addEventListener(`click`,n=>t.onClick(n,e)),Ra(l),l}function Ba(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function Va(e){return document.getElementById(e)}function Ha(){let e=Va(`card-preview-modal`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function Ua(e){document.body.classList.toggle(`card-preview-open`,e),window.dispatchEvent(new CustomEvent(`card-preview-change`,{detail:{open:e}}))}function Wa(){Va(`card-preview-modal`)?.classList.add(`hidden`),Va(`card-preview-mount`)?.classList.remove(`card-preview-mount--reveal-only`),Ua(!1)}function Ga(e,t={}){Ha();let n=Va(`card-preview-modal`),r=Va(`card-preview-mount`),i=Va(`card-preview-actions`);if(!(!n||!r||!e)){if(r.innerHTML=``,r.classList.toggle(`card-preview-mount--reveal-only`,!!t.hideDesc),r.appendChild(za(e,{static:!0,hideDesc:t.hideDesc})),i){if(i.innerHTML=``,t.meta){let e=document.createElement(`p`);e.className=`card-preview-meta`,e.textContent=t.meta,i.appendChild(e)}let e=document.createElement(`div`);if(e.className=`card-preview-actions-row`,t.onPlay){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=`Cast spell`,n.addEventListener(`click`,()=>{Wa(),t.onPlay()}),e.appendChild(n)}if(t.onAdd){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=`Add to deck`,n.disabled=!!t.addDisabled,n.addEventListener(`click`,()=>{t.addDisabled||t.onAdd()}),e.appendChild(n)}if(t.onBuy){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=t.buyLabel||`Buy copy`,n.disabled=!!t.buyDisabled,n.addEventListener(`click`,()=>{t.buyDisabled||t.onBuy()}),e.appendChild(n)}if(t.onRemove){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-secondary`,n.textContent=`Remove all from deck`,n.addEventListener(`click`,()=>{t.onRemove(),Wa()}),e.appendChild(n)}e.children.length&&i.appendChild(e)}n.classList.remove(`hidden`),Ua(!0)}}function Ka(){Va(`card-preview-close`)?.addEventListener(`click`,Wa),Va(`card-preview-backdrop`)?.addEventListener(`click`,Wa),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&Wa()})}function qa(e,t=`.spell-card`){e&&e.querySelectorAll(t).forEach((e,t)=>{e.classList.add(`spell-card--deal`),e.style.animationDelay=`${t*.1}s`})}function Ja(e){e&&(e.classList.add(`spell-card--rare-burst`),setTimeout(()=>e.classList.remove(`spell-card--rare-burst`),900))}function Ya(e){e&&(e.classList.add(`spell-card--epic-burst`),setTimeout(()=>e.classList.remove(`spell-card--epic-burst`),1200))}function Xa(e){e&&(e.classList.add(`spell-card--legendary-burst`),setTimeout(()=>e.classList.remove(`spell-card--legendary-burst`),1500))}function Za(e,t){t===`legendary`?Xa(e):t===`epic`?Ya(e):t===`rare`&&Ja(e)}var Qa={common:10,uncommon:20,rare:30,epic:40,legendary:50};function $a(e){return Qa[e]??30}function eo(e,r){let i=ae(e,r);if(i<1)return{success:!1,message:`Get this spell from a chest first.`};let a=n(r);if(!a)return{success:!1,message:`Unknown card.`};let o=t(r);if(i>=o)return{success:!1,message:`You already own the maximum (${o} copies).`};let s=$a(a.rarity);if(e.gems<s)return{success:!1,message:`Need ${s} gems (${e.gems} available).`};e.gems-=s;let c=ve(e,r,1);return c?{success:!0,cost:s,message:`+1 ${a.name} for ${s} gems (${i+c} owned).`}:(e.gems+=s,T(e),{success:!1,message:`You already own the maximum copies for this rarity.`})}var to={deck:`<svg class="nav-icon-svg" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    </div>`,t.style.animationDelay=`0s`,t}function ns(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function rs(e,t=``){let n=f(e),r=(t||`P`).charAt(0).toUpperCase(),i=qo(n.equipped.avatar)||`<span class="profile-avatar-fallback">${ns(r)}</span>`;return`<span class="profile-avatar-stack header-profile-btn__stack ${Zo(n.equipped.frame)}"><span class="profile-avatar-inner header-profile-btn__inner">${i}</span></span>`}async function is(e){if(!e)return``;try{return(await Oe(e.id))?.username||e.user_metadata?.display_name||e.email?.split(`@`)[0]||``}catch{return e.user_metadata?.display_name||e.email?.split(`@`)[0]||``}}var as=null;function os(){return as||=Promise.all([D(()=>import(`./match-DBPmkxg2.js`),[],import.meta.url),D(()=>import(`./matchView-X_5jfI9g.js`),[],import.meta.url),D(()=>Promise.resolve({}),__vite__mapDeps([0]),import.meta.url),D(()=>Promise.resolve({}),__vite__mapDeps([1]),import.meta.url)]).then(([e,t])=>({MatchSession:e.MatchSession,getMatchHtml:t.getMatchHtml})),as}var ss=null;function cs(){return ss||=Promise.all([D(()=>import(`./pvpUI-B_aV3jFM.js`),[],import.meta.url),D(()=>import(`./pvp-BBEiOBzO.js`),[],import.meta.url)]).then(([e,t])=>({initPvpUI:e.initPvpUI,clearAllWaitingRoomsOnce:t.clearAllWaitingRoomsOnce})),ss}var ls=null;function us(){return ls||=D(()=>import(`./profileUI-C2V-nwcp.js`),[],import.meta.url),ls}function ds(){ls=null}var fs=null;function ps(){return fs||=Promise.all([D(()=>import(`./settingsUI-DQBAJZZp.js`),[],import.meta.url),D(()=>Promise.resolve({}),__vite__mapDeps([2]),import.meta.url)]).then(([e])=>e),fs}var ms=null;function hs(){return ms||=Promise.all([D(()=>import(`./chestOpenAnimation-CCdCbdRN.js`),[],import.meta.url),D(()=>import(`./cosmeticOpenAnimation-C-m7uNgv.js`),[],import.meta.url),D(()=>import(`./titleOpenAnimation-D1qdVzki.js`),[],import.meta.url)]).then(([e,t,n])=>({playChestOpenAnimation:e.playChestOpenAnimation,playCosmeticOpenAnimation:t.playCosmeticOpenAnimation,playTitleOpenAnimation:n.playTitleOpenAnimation})),ms}var gs=null;function _s(){return gs||=D(()=>import(`./socialUI-DtzKBl0x.js`),[],import.meta.url),gs}var vs=null;function ys(){return vs||=D(()=>import(`./tutorialMeta-DakKFg7c.js`),[],import.meta.url),vs}var bs=null;function xs(){return bs||=D(()=>import(`./tutorialUnlocks-BVo28qSB.js`),[],import.meta.url),bs}var Ss=null;function Cs(){return Ss||=D(()=>import(`./tutorialMatch-B5ZwX4vP.js`),[],import.meta.url),Ss}function ws(e,t){ys().then(n=>n.notifyMetaTutorial(e,t)).catch(e=>console.warn(`[Tutorial] meta notify failed`,e))}function Ts(e,t){xs().then(n=>n.notifyUnlockTutorial(e,t))}var W;try{W=E()}catch(e){console.error(`Failed to load profile, resetting save:`,e),localStorage.removeItem(`cardCheckersProfile_v7`),localStorage.removeItem(`cardCheckersProfile_v5`),W=E()}var G=`deck`,Es={deck:`Decks`,chests:`Shop`,play:`Play`,social:`Social`,quests:`Quests`,profile:`Profile`,settings:`Settings`},Ds=new Set(Object.keys(Es)),Os=null,ks=null,As=!1,js=`cards`,Ms=`list`,K=null,q=[],Ns=null,Ps=``,Fs=`all`,Is=`all`,Ls=!0,Rs={legendary:5,epic:4,rare:3,uncommon:2,common:1};function zs(e){return[...e].sort((e,t)=>{let n=Rs[e.rarity]??0,r=Rs[t.rarity]??0;return n===r?e.name.localeCompare(t.name):r-n})}var J=null,Bs=null,Vs=null,Hs=null,Us=null;function Ws(){return Bs?Promise.resolve(Bs):(Vs||=cs().then(({initPvpUI:e,clearAllWaitingRoomsOnce:t})=>(t(),Bs=e({arenaRoot:document.getElementById(`play-arena-root`),leaderboardRoot:document.getElementById(`play-leaderboard-root`),getProfile:()=>W,openAuthModal:()=>qs?.open(`signin`,{forced:!0}),onNavigateTab:Z,onNavigatePlayTab:_c,onNavigatePlayMenu:gc,onOpenDeckEdit:_l}),Bs)),Vs)}function Gs(){return Hs?Promise.resolve(Hs):(Us||=_s().then(({initSocialUI:e})=>(Hs=e({root:document.getElementById(`view-social`),getProfile:()=>W,saveProfile:T,openAuthModal:()=>qs?.open(`signin`,{forced:!0})}),Hs)),Us)}var Ks=null,qs=null,Y=!1,Js=!1,Ys=!1,Xs=!1,Zs=!1,Qs=null,$s=null,ec=null,tc=1,nc=null;function rc(e){return Rs[e?.rarity]??0}function ic(e){let t=i(e);return Object.entries(t).map(([e,t])=>({def:n(e),count:t})).filter(e=>e.def).sort((e,t)=>{let n=rc(t.def)-rc(e.def);return n===0?e.def.name.localeCompare(t.def.name):n})}function ac(e){let t=q.indexOf(e);t<0||(q.splice(t,1),xl(),ws(`card-removed-from-deck`,{cardId:e}))}function oc(e){let t=q.length;q=q.filter(t=>t!==e),q.length!==t&&(xl(),ws(`card-removed-from-deck`,{cardId:e}))}function sc(){let n=e().map(e=>({def:e,owned:ae(W,e.id)})).filter(e=>e.owned>0).sort((e,t)=>{let n=rc(t.def)-rc(e.def);return n===0?e.def.name.localeCompare(t.def.name):n});q=[];for(let{def:e,owned:r}of n){let n=Math.min(r,t(e));for(let t=0;t<n&&q.length<30;t++)q.push(e.id);if(q.length>=30)break}xl()}var X=e=>document.getElementById(e);function cc(){let e=document.getElementById(`adventure-prebattle`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function lc(){let e=document.querySelector(`nav.game-nav.tabs`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function uc(){return window.matchMedia(`(min-width: 1000px) and (max-width: 1400px)`).matches?2.5:window.matchMedia(`(min-width: 600px) and (max-width: 999px)`).matches?1.85:1}function dc(){cc(),document.getElementById(`adventure-prebattle`)?.classList.remove(`hidden`),document.body.classList.add(`adventure-floor-open`)}function fc(){document.getElementById(`adventure-prebattle`)?.classList.add(`hidden`),document.body.classList.remove(`adventure-floor-open`)}function pc(e=le,t=`Locked`){Wn({title:t,bodyHtml:e,autoCloseMs:4500})}function mc(){document.body.classList.toggle(`main-tab-active`,Ds.has(G)),document.body.classList.toggle(`play-sub-active`,G===`play`&&Os!==null),document.body.classList.toggle(`adventure-active`,G===`play`&&Os===`adventure`)}function hc(){let e=d(W);for(let t of[`arena`,`leaderboard`]){let n=document.querySelector(`.play-tab[data-play-tab="${t}"]`);n&&(n.classList.toggle(`play-tab--locked`,!e),n.setAttribute(`aria-disabled`,e?`false`:`true`),n.title=e?``:m(`PvP`))}}function gc(){Os=null,X(`play-menu`)?.classList.remove(`hidden`),document.querySelectorAll(`.play-tab-panel`).forEach(e=>{e.classList.add(`hidden`),e.hidden=!0}),mc(),hc()}async function _c(e){if(!As&&(e===`arena`||e===`leaderboard`)&&!d(W)){let e=Qt(),t=Xt;await Qe(e?`${m(`PvP`)}\n\n${t}.`:m(`PvP`),{title:`PvP locked`,confirmLabel:`Go to Adventure`,cancelLabel:e?`Sign in`:`Not now`})?(As=!0,_c(`adventure`),As=!1):e&&qs?.open(`signin`,{forced:!0});return}Os=e,X(`play-menu`)?.classList.add(`hidden`),document.querySelectorAll(`.play-tab`).forEach(t=>{let n=t.dataset.playTab===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,n?`true`:`false`)}),document.querySelectorAll(`.play-tab-panel`).forEach(t=>{let n=t.id===`play-tab-${e}`;t.classList.toggle(`hidden`,!n),t.hidden=!n}),mc(),Ts(`play-tab-changed`,{tab:e}),e===`adventure`?El():e===`arena`?Ws().then(e=>{e?.setScreen?.(`arena`),e?.render({resume:!0})}):e===`leaderboard`&&Ws().then(e=>{e?.setScreen?.(`leaderboard`),e?.render()})}function vc(e,t,n){let r=e.querySelector(`.tab-btn__sign-in-badge`);t?(r||(r=document.createElement(`span`),r.className=`tab-btn__sign-in-badge`,r.setAttribute(`aria-hidden`,`true`),e.appendChild(r)),r.textContent=n,e.classList.add(`tab-btn--sign-in-nudge`)):(r?.remove(),e.classList.remove(`tab-btn--sign-in-nudge`))}function yc(){let e=d(W),t=Qt();hc();let n=document.querySelector(`.tab-btn[data-tab="quests"]`);if(n){let r=!e,i=Zt;n.classList.toggle(`tab-btn--locked`,r),n.setAttribute(`aria-disabled`,r?`true`:`false`),r?(n.title=t?`${m(`Quests`)} ${i}.`:m(`Quests`),vc(n,t,`Sign in`)):t?(n.title=i,vc(n,!1)):(n.title=``,vc(n,!1))}let r=document.querySelector(`.tab-btn[data-tab="social"]`);r&&(t?(r.title=Zt,vc(r,!0,`Sign in`)):(r.title=``,vc(r,!1)));let i=c(W),a=document.querySelector(`.vault-tab[data-vault-tab="cosmetics"]`);a&&(a.classList.toggle(`vault-tab--locked`,!i),a.title=i?``:_e,a.setAttribute(`aria-disabled`,i?`false`:`true`))}async function Z(e){let t=document.getElementById(`view-match`);if(!(Y&&t&&!t.classList.contains(`hidden`))&&!(t&&!t.classList.contains(`hidden`)&&t.querySelector(`.pvp-loading`)&&e!==G)){if(!Js&&e===`quests`&&!d(W)){let e=Qt(),t=Zt;await Qe(e?`${m(`Quests`)}\n\n${t}.`:m(`Quests`),{title:`Quests locked`,confirmLabel:`Go to Adventure`,cancelLabel:e?`Sign in`:`Not now`})?(Js=!0,Z(`play`),Js=!1):e&&qs?.open(`signin`,{forced:!0});return}if(sr(),Qn()&&er()){if(e===G||t?.querySelector(`.pvp-loading`)||!await Qe(`Leave your current match to open ${Es[e]||e}?`,{title:`Leave match?`,confirmLabel:`Leave`,cancelLabel:`Stay`,destructive:!0}))return;tr(e),e===`play`&&(ks=`arena`),ir(),document.querySelector(`#btn-leave-match`)?.click();return}if(Ms===`edit`&&(e!==`deck`||e===`deck`&&G===`deck`)){if(!await hl())return;gl()}if(e!==`deck`&&Ms===`edit`&&(Jc(),document.body.classList.remove(`deck-editing`)),G=e,mc(),Ds.has(e)&&Kc(),document.querySelectorAll(`.tab-btn`).forEach(t=>{t.classList.toggle(`active`,t.dataset.tab===e)}),document.querySelectorAll(`.view`).forEach(t=>{t.classList.toggle(`hidden`,t.id!==`view-${e}`)}),e===`chests`&&(il(js),ol()),e===`deck`&&(Ms=`list`,Xc(`list`)),e===`profile`&&Tc(),e===`settings`&&Ec(),e===`quests`&&(jc(),Fc()),e===`play`){let e=ks??Os;ks=null,e?_c(e):gc()}e===`social`&&(Hs?Hs.refresh?.()??Hs.render():(Nc(),Gs().then(e=>e?.render()).catch(e=>{console.error(`[Social] init failed`,e),Pc()}))),ws(`tab-changed`,{tab:e}),Ts(`tab-changed`,{tab:e}),Qn()||(So(`hub`),await Ao())}}var Q=``;function bc(e=Q){e&&(Q=e);let t=document.getElementById(`header-profile-menu`),n=document.getElementById(`header-profile-btn`),r=document.getElementById(`header-username`),i=document.getElementById(`auth-header-btn`),a=!!O();if(i&&(i.classList.toggle(`hidden`,a),i.hidden=a),t&&(t.classList.toggle(`hidden`,!a),t.hidden=!a),r){let e=a&&Q;r.textContent=e?Q:``,r.classList.toggle(`hidden`,!e),r.hidden=!e}n&&a&&(n.innerHTML=rs(W,Q),n.title=Q?`Account — ${Q}`:`Account menu`)}function xc(){let e=document.getElementById(`header-profile-btn`),t=document.getElementById(`header-profile-dropdown`);!e||!t||(t.classList.add(`hidden`),t.hidden=!0,e.setAttribute(`aria-expanded`,`false`))}function Sc(){let e=document.getElementById(`header-profile-menu`),t=document.getElementById(`header-profile-btn`),n=document.getElementById(`header-profile-dropdown`);if(!e||!t||!n)return;let r=e=>{n.classList.toggle(`hidden`,!e),n.hidden=!e,t.setAttribute(`aria-expanded`,e?`true`:`false`)};t.addEventListener(`click`,e=>{e.stopPropagation();let t=!n.hidden;r(!t)}),n.querySelectorAll(`[data-profile-menu-action]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.profileMenuAction;xc(),t===`settings`?Z(`settings`):wc()})}),document.addEventListener(`click`,t=>{n.hidden||e.contains(t.target)||xc()}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&!n.hidden&&xc()})}async function Cc(){let e=O();if(!e){Q=``,bc();return}Q=await is(e),bc()}function wc(){xc(),Z(`profile`),Ts(`profile-opened`)}async function Tc(){let{renderProfileTab:e}=await us(),t=X(`view-profile`);e(W,t,{onGemsChange:Ic,onTitleChanged:()=>bc()})}async function Ec(){let{renderSettingsTab:e}=await ps();e(X(`view-settings`),{onUsernameChanged:e=>{Q=e,bc(e)}})}var Dc=`
  ...
  <section class="panel game-panel social-panel social-panel--error">
  ...
  </section>`;function jc(){let e=X(`view-quests`);e&&(e.innerHTML=Dc)}function Mc(e=X(`view-quests`)){e&&(e.innerHTML=Oc,e.querySelector(`.quests-retry-btn`)?.addEventListener(`click`,()=>{ds(),jc(),Fc()}))}function Nc(){let e=X(`view-social`);e&&(e.innerHTML=kc)}function Pc(e=X(`view-social`)){e&&(e.innerHTML=Ac,e.querySelector(`.social-retry-btn`)?.addEventListener(`click`,()=>{Hs=null,Us=null,Nc(),Gs().then(e=>e?.render()).catch(t=>{console.error(`[Social] retry failed`,t),Pc(e)})}))}async function Fc(){let e=X(`view-quests`);if(e)try{let{renderQuestsTab:t}=await us();t(W,e,{onTitleChanged:()=>bc(),onCurrencyChange:()=>$()})}catch(t){console.error(`[Quests] render failed`,t),Mc(e)}}function $(){let e=X(`header-gems`);e&&(e.textContent=String(W.gems??0));let t=X(`header-stars`);t&&(t.textContent=String(W.stars??0)),document.querySelector(`.hud-gems`)?.classList.toggle(`hud-gems--low`,(W.gems??0)<50),document.querySelector(`.hud-stars`)?.classList.toggle(`hud-stars--low`,(W.stars??0)<10)}function Ic(){$()}function Lc(){document.querySelectorAll(`.collection-owned-only-toggle`).forEach(e=>{e.checked=Ls});for(let e of[`collection-search`]){let t=X(e);t&&(t.value=Ps)}for(let e of[`collection-rarity`]){let t=vr(e);t&&(t.value=Fs)}let e=vr(`collection-category`);e&&(e.value=Is)}var Rc=`(max-width: 899px)`,zc=`(max-width: 1280px)`,Bc=null;function Vc(){return window.matchMedia(Rc).matches}function Hc(){return document.body.classList.contains(`main-tab-active`)&&!document.body.classList.contains(`match-active`)&&!document.body.classList.contains(`deck-editing`)&&window.matchMedia(zc).matches}function Uc(){return document.querySelector(`.game-main`)}function Wc(){let e=Uc();return Hc()&&e?e.scrollTop:window.scrollY||document.documentElement.scrollTop||0}function Gc(e){let t=Uc();if(Hc()&&t){t.scrollTop=e;return}window.scrollTo(0,e)}function Kc(){let e=Uc();if(Hc()&&e){e.scrollTop=0;return}window.scrollTo(0,0)}function qc(){Vc()&&(Bc=Wc(),document.body.style.position=`fixed`,document.body.style.top=`0`,document.body.style.left=`0`,document.body.style.right=`0`,document.body.style.width=`100%`)}function Jc(){if(Bc==null)return;let e=Bc;Bc=null,document.body.style.position=``,document.body.style.top=``,document.body.style.left=``,document.body.style.right=``,document.body.style.width=``,Gc(e)}function Yc(){Kc(),document.documentElement.scrollTop=0,document.body.scrollTop=0,document.querySelector(`.game-shell`)?.scrollTo?.(0,0),Uc()?.scrollTo?.(0,0),document.querySelector(`#view-deck`)?.scrollTo?.(0,0),document.querySelectorAll(`#deck-subview-edit, #deck-subview-edit .deck-editor, #deck-subview-edit .deck-editor__body, #deck-subview-edit .deck-editor__grid, #deck-subview-edit .deck-editor__grid-cards`).forEach(e=>{e.scrollTop=0})}function Xc(e){e!==`edit`&&Jc(),Ms=e,document.body.classList.toggle(`deck-editing`,e===`edit`),X(`deck-subview-list`)?.classList.toggle(`hidden`,e!==`list`),X(`deck-subview-edit`)?.classList.toggle(`hidden`,e!==`edit`),e===`edit`&&(qc(),w(W),T(W),Fs=`all`,Ps=``,Is=`all`,Ls=!0,Lc(),pl()),e===`list`&&bl(),e===`edit`&&(xl(),Yc(),requestAnimationFrame(()=>{Yc(),requestAnimationFrame(Yc)}))}function Zc({id:e,title:t,desc:n,cost:r,variant:i=`mystery`}){let a=(W.stars??0)>=r,o=i===`title`?zt():Vt();return`
    ...
    </article>`}function Qc(e,t){e.querySelector(`[data-mystery-open]`)?.addEventListener(`click`,e=>{e.stopPropagation(),t()}),e.addEventListener(`click`,t),e.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),t())})}function $c({bonusGems:e=0,bonusStars:t=0}={}){let n=[];return e&&n.push(`+${e} gem refund`),t&&n.push(`+${t} ★ from duplicates`),n.length?` (${n.join(`, `)})`:``}async function el(e,t){let{playChestOpenAnimation:n,playCosmeticOpenAnimation:r,playTitleOpenAnimation:i}=await hs();e.kind===`card`?(await n({tier:`silver`,tierLabel:`Mystery Box`,pulls:e.cardPulls}),t&&(t.textContent=`Got ${e.cardPulls.length} spells.${$c(e)}`)):e.kind===`cosmetic`?(await r({boxId:`silver`,boxLabel:`Mystery Box`,pulls:e.cosPulls}),t&&(t.textContent=e.message+$c(e))):e.kind===`mixed`?(e.cardPulls.length&&await n({tier:`silver`,tierLabel:`Mystery Box — Spells`,pulls:e.cardPulls}),e.cosPulls.length&&await r({boxId:`silver`,boxLabel:`Mystery Box — Cosmetics`,pulls:e.cosPulls}),t&&(t.textContent=`${e.message}${$c(e)}`)):e.kind===`title`&&(await i({boxLabel:`Title Box`,pulls:e.pulls}),t&&(t.textContent=e.message))}async function tl(){let e=X(`mystery-box-log`);if(!((W.stars??0)>=10)){e&&(e.textContent=`Need 10 ★ stars. Clear Adventure floors to earn stars.`,e.classList.add(`chest-log--error`));return}let t=qt(W);if(!t.success){e&&(e.textContent=t.message,e.classList.add(`chest-log--error`));return}T(W),$(),e&&e.classList.remove(`chest-log--error`),X(`mystery-box-list`)?.querySelectorAll(`.mystery-box__btn`).forEach(e=>{e.disabled=!0});try{await el(t,e)}catch(n){console.error(`Mystery box animation failed:`,n),e&&(e.textContent=t.message)}ol({clearPulls:!1}),Tc()}async function nl(){let e=X(`mystery-box-log`);if(!((W.stars??0)>=10)){e&&(e.textContent=`Need 10 ★ stars. Clear Adventure floors to earn stars.`,e.classList.add(`chest-log--error`));return}let t=Jt(W);if(!t.success){e&&(e.textContent=t.message,e.classList.add(`chest-log--error`));return}T(W),$(),e&&e.classList.remove(`chest-log--error`),X(`mystery-box-list`)?.querySelectorAll(`.mystery-box__btn`).forEach(e=>{e.disabled=!0});try{await el(t,e)}catch(n){console.error(`Title box animation failed:`,n),e&&(e.textContent=t.message)}ol({clearPulls:!1}),Tc()}function rl(){let e=X(`mystery-box-list`);if(!e)return;e.innerHTML=`
    ${Zc({id:`mystery`,title:`Mystery Box`,desc:`6 random pulls — mix of spells and cosmetics (${Math.round(Ht*100)}% cosmetic per slot when unlocked).`,cost:10})}
    ${Zc({id:`title`,title:`Title Box`,desc:`Box-exclusive mage titles only — The Brave, Ruthless, Omnipotent, and more.`,cost:10,variant:`title`})}
  `;let t=e.querySelectorAll(`.mystery-box`);Qc(t[0],()=>tl()),Qc(t[1],()=>nl())}function il(e){if(!Ys&&e===`cosmetics`&&!c(W)){pc(_e,`Cosmetics locked`),Ys=!0,il(`cards`),Ys=!1;return}js=e,document.querySelectorAll(`.vault-tab`).forEach(t=>{let n=t.dataset.vaultTab===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,n?`true`:`false`)}),document.querySelectorAll(`.vault-tab-panel`).forEach(t=>{let n=t.id===`vault-tab-${e}`;t.classList.toggle(`hidden`,!n),t.hidden=!n}),Ts(`vault-tab-changed`,{tab:e})}function al(){us().then(({renderCosmeticBoxes:e})=>{e(W,X(`cosmetic-box-list`),{logEl:X(`cosmetic-box-log`),onGemsChange:Ic,cosmeticsUnlocked:c(W),onOpened:()=>{G===`profile`&&Tc(),G===`quests`&&Fc()}})}).catch(e=>{console.error(`[Shop] cosmetics render failed`,e);let t=X(`cosmetic-box-log`);t&&(t.textContent=`Couldn't load cosmetic boxes — try again from the Shop tab.`,t.classList.add(`chest-log--error`))})}function ol(e={}){let{clearPulls:t=!0}=e;$(),al(),rl();let n=X(`chest-list`),r=X(`chest-pulls`);if(r&&t&&(r.innerHTML=``,r.classList.add(`chest-pulls--hidden`),r.classList.remove(`chest-pulls--reveal`)),n){n.innerHTML=``;for(let e of ct){let t=gt[e.id]||gt.bronze,i=W.gems>=e.cost,a=document.createElement(`article`);a.className=`chest-card chest-card--${e.id}${i?``:` chest-card--locked`}`,a.innerHTML=`
    ...
    `;let o=a.querySelector(`.chest-open`);o.disabled=!i,o.addEventListener(`click`,async()=>{if(o.disabled)return;let n=pt(W,e.id),i=X(`chest-log`);if(!n.success){i&&(i.textContent=n.message,i.classList.add(`chest-log--error`));return}T(W),$(),o.disabled=!0;let{playChestOpenAnimation:a}=await hs();if(await a({tier:e.id,tierLabel:t.label,pulls:n.pulls}),ws(`chest-opened`,{chestId:e.id}),i){let t=n.bonusGems?` (+${n.bonusGems} gems from duplicates)`:``;i.textContent=`Got ${n.pulls.length} spells from ${e.name}.${t}`,i.classList.remove(`chest-log--error`)}if(r){r.classList.remove(`chest-pulls--hidden`),r.classList.add(`chest-pulls--reveal`),r.innerHTML=`<p class="chest-pulls__label">Chest opened</p><div class="chest-pulls__grid"></div>`;let e=r.querySelector(`.chest-pulls__grid`);n.pulls.forEach((t,n)=>{let r=za(t,{button:!0,deal:!0,gallery:!0,onClick:()=>Ga(t)});if(r.style.animationDelay=`${n*.12}s`,t.duplicate){r.classList.add(`spell-card--duplicate-pull`);let e=document.createElement(`span`);e.className=`chest-pull-dup-badge`,e.textContent=t.starRefund?`Duplicate · +${t.starRefund} ★`:`Duplicate · +${t.gemRefund} ◆`,r.appendChild(e)}e.appendChild(r),Za(r,t.rarity)}),qa(e),r.scrollIntoView({behavior:`smooth`,block:`nearest`})}ol()}),n.appendChild(a)}}}function sl(){return zs(e().filter(e=>{if(Is!==`all`&&st(e)!==Is||Fs!==`all`&&e.rarity!==Fs)return!1;if(Ps){let t=Ps.toLowerCase();if(!e.name.toLowerCase().includes(t)&&!e.desc.toLowerCase().includes(t))return!1}return!(Ls&&ae(W,e.id)<=0)}))}function cl(e,t){let n=eo(W,e);return t&&(t.textContent=n.message,t.className=n.success?`deck-status ok`:`deck-status warn`),n.success&&(T(W),$(),Ms===`list`&&bl(),Ms===`edit`&&xl()),n}function ll(e,t){let n=eo(W,e);return n.success?(T(W),$(),q.push(e),he(W,e),T(W),xl(),t&&(t.hidden=!1,t.textContent=`Bought and added to deck.`,t.className=`deck-editor__error deck-status ok`),!0):(t&&(t.hidden=!1,t.textContent=n.message,t.className=`deck-editor__error deck-status warn`),!1)}function ul(e){return a(q,e,W).ok?(q.push(e),he(W,e),T(W),xl(),ws(`card-added-to-deck`,{cardId:e}),!0):!1}function dl(e,n,r={}){let{deckEdit:o=!1,statusEl:s=null}=r,c=ae(W,n.id),l=t(n),u=c>=l,d=$a(n.rarity),f=W.gems>=d&&!u,p=o?a(q,n.id,W):{ok:!1},m=o&&i(q)[n.id]||0,h=q.length<30,g=m<l,_=c>=1&&c<=m,v=c>=1&&!u,y=o&&!p.ok&&h&&g&&_&&v,ee=()=>cl(n.id,s),x=()=>{let e=ae(W,n.id),t=o&&i(q)[n.id]||0,r=e>=l,s=W.gems>=d&&!r,c=o?a(q,n.id,W):{ok:!1};Ga(n,{meta:o?`Owned ${e}/${l} · In deck ${t}/${l} · ${r?`max copies`:`${d} gems per copy`}`:`Owned ${e}/${l}${r?` · max copies`:` · ${d} gems per copy`}`,buyLabel:r?`Max copies owned`:`Buy copy (${d} gems)`,buyDisabled:!s||r||e<1,onBuy:()=>{ee(),Wa()},addDisabled:!c.ok,onAdd:o?()=>{ul(n.id)&&x()}:void 0})};if(o){let t=document.createElement(`div`);t.className=`deck-editor-tile`+(b(W,n.id)?` deck-editor-tile--new`:``);let r=za(n,{button:!0,gallery:!0,onClick:()=>x()});r.classList.add(`deck-editor-tile__card`),r.title=`${n.name} — tap for full card`;let i=c>0?`Owned ${c}/${l}`:`Not in collection`,a=document.createElement(`div`);a.className=`deck-editor-tile__meta`,a.innerHTML=`${i} · In deck ${m}/${l}${b(W,n.id)?`<span class="deck-editor-tile__new">New</span>`:``}`,a.addEventListener(`click`,()=>x());let o=document.createElement(`button`);o.type=`button`,o.className=`deck-editor-tile__action`,p.ok?(o.classList.add(`deck-editor-tile__action--add`),o.textContent=`+ Add to deck`,o.addEventListener(`click`,e=>{e.stopPropagation(),ul(n.id)})):y?(o.classList.add(`deck-editor-tile__action--buy`),o.textContent=f?`Add for ${d} gems`:`Need ${d} gems`,o.disabled=!f,o.addEventListener(`click`,e=>{e.stopPropagation(),ll(n.id,s)})):(o.classList.add(`deck-editor-tile__action--disabled`),o.disabled=!0,q.length>=30?o.textContent=`Deck full (30/30)`:m>=l?o.textContent=`Max copies in deck`:c<1?o.textContent=`Open Shop chests to unlock`:p.reason?o.textContent=p.reason:o.textContent=`Can't add`),t.append(r,a,o),e.appendChild(t);return}let S=document.createElement(`div`);S.className=`collection-card-wrap`+(c<1?` collection-card-wrap--unowned`:``);let C=za(n,{button:!0,compact:!0,disabled:c<1||u,onClick:e=>{if(e.shiftKey||c<1||u){x();return}ee()}});C.title=u?`${n.name} — max ${l} copies owned. Tap to view full card.`:c<1?`${n.name} — not owned. Tap to view full card.`:`${n.name} — tap to buy (${d} gems). Shift+click to inspect.`,S.appendChild(C);let w=document.createElement(`span`);w.className=`collection-owned-count`,w.textContent=c>0?`×${c}`:`—`,S.appendChild(w);let te=document.createElement(`span`);te.className=`collection-buy-cost`,te.textContent=u?`MAX`:`${d} ◆`,(!f||u)&&te.classList.add(`collection-buy-cost--cant`),S.appendChild(te),e.appendChild(S)}function fl(e,t={}){if(!e)return;let{deckEdit:n=!1,statusEl:r=null}=t;e.innerHTML=``;let i=sl();if(!i.length){e.className=`deck-editor__grid collection-grid`;let t=document.createElement(`p`);t.className=`collection-grid-empty muted`,t.textContent=n?`No spells match your filters. Try “All types”, clear search, or uncheck Owned only.`:`No cards match your filters. Open chests in the Shop to get more spells.`,e.appendChild(t);return}let a=0,o={deckEdit:n,statusEl:r};if(n||Is!==`all`){e.className=`deck-editor__grid collection-grid`;for(let t of i)try{dl(e,t,o),a+=1}catch(e){console.error(`Failed to render card:`,t?.id,e)}}else{e.className=`deck-editor__grid collection-categories`;let t=Object.fromEntries(it.map(e=>[e,[]]));for(let e of i)t[st(e)].push(e);for(let n of it){let r=t[n];if(!r.length)continue;let i=document.createElement(`section`);i.className=`collection-category-section`,i.dataset.category=n;let s=document.createElement(`h3`);s.className=`collection-category-title`,s.textContent=at[n],i.appendChild(s);let c=document.createElement(`div`);c.className=`collection-grid deck-editor__grid-cards`;for(let e of r)try{dl(c,e,o),a+=1}catch(t){console.error(`Failed to render card:`,e?.id,t)}i.appendChild(c),e.appendChild(i)}}if(i.length>0&&a===0){e.className=`deck-editor__grid collection-grid`;let t=document.createElement(`p`);t.className=`collection-grid-empty collection-grid-empty--error`,t.textContent=`Spells failed to display. Hard refresh the page (Ctrl+Shift+R).`,e.appendChild(t)}}function pl(){Ns={name:X(`deck-name-input`)?.value?.trim()??``,cardIds:[...q]}}function ml(){return Ns?(X(`deck-name-input`)?.value?.trim()??``)!==Ns.name||q.length!==Ns.cardIds.length?!0:q.some((e,t)=>e!==Ns.cardIds[t]):!1}async function hl(){return ml()?Qe(`Discard unsaved changes to this deck?`,{title:`Unsaved changes`,confirmLabel:`Discard`,cancelLabel:`Keep editing`,destructive:!0}):!0}function gl(){K=null,q=[],Ns=null}function _l(e){let t=W.decks.find(t=>t.id===e);if(!t)return;K=t.id,q=[...t.cardIds];let n=X(`deck-name-input`);n&&(n.value=t.name),Xc(`edit`),ws(`deck-edit-opened`,{deckId:e})}function vl(e){let t=Object.fromEntries(it.map(e=>[e,0]));for(let r of e){let e=n(r);e&&(t[st(e)]+=1)}return t}function yl(e){let t=vl(e),n=[];for(let e of it){let r=t[e];if(r<=0)continue;let i=at[e];n.push(`<span class="deck-row__cat" title="${Ba(i)}: ${r}"><span class="deck-row__cat-dot deck-row__cat-dot--${e}" aria-hidden="true"></span><span class="deck-row__cat-n">${r}</span></span>`)}return n.length?`<div class="deck-row__cats">${n.join(``)}</div>`:``}function bl(){w(W)&&T(W),$();let e=X(`deck-list`);if(!e)return;e.innerHTML=``;let t=X(`deck-list-count`);if(t){let e=W.decks.length;t.textContent=e?`${e} deck${e===1?``:`s`}`:``}if(!W.decks.length){if(w(W)&&T(W),W.decks.length){bl();return}e.innerHTML=`
  ...
  </svg>`}function Ol(e=`#e8c547`){return`<svg class="adventure-map-tile__pawn-svg" viewBox="0 0 28 36" aria-hidden="true">
    <defs>
  ...
  </svg>`}function kl(e){let t=x[e]||x.verdant;return`<svg class="adventure-map-tile__banner-svg" viewBox="0 0 24 20" aria-hidden="true">
    <defs>
    ...
    <div class="adventure-map-tower">
      ...
      <span class="adventure-map-tile__stone" aria-hidden="true">
        ...
        ${a>0?`<span class="adventure-floor-row__stars">${C(a)}</span>`:``}`,o.addEventListener(`click`,()=>Bl(t.id)),y.appendChild(o)}}let b=r.querySelector(`.adventure-map-tile--next`);Al(r),b&&requestAnimationFrame(()=>{requestAnimationFrame(()=>b.scrollIntoView({behavior:`smooth`,block:`nearest`}))});let S=y?.querySelector(`.adventure-floor-row--next`);S&&requestAnimationFrame(()=>S.scrollIntoView({behavior:`smooth`,block:`end`})),r.querySelector(`.adventure-challenge-toggle`)?.addEventListener(`click`,t=>{t.preventDefault(),t.stopPropagation(),e.challengeMode=!e.challengeMode,W.adventure=e,T(W),Bo(),Eo.tap(),Ml()})}function Nl(e){let t=ue(e);if(!t||!_(W.adventure,e))return;ec=e,dc();let n=X(`prebattle-title`),i=X(`prebattle-flavor`),a=X(`prebattle-opponent`);n&&(n.textContent=`Tower ${t.worldId} · Floor ${t.floorInWorld}`),i&&(i.textContent=t.flavor||``),a&&(a.textContent=`Loading…`);try{nc=be(W,e),T(W)}catch(e){console.error(`Enemy deck failed`,e),a&&(a.textContent=`Could not build enemy deck. Try again.`);return}a&&(a.textContent=`Review the enemy spell deck, then choose your grimoire below.`);let o=X(`prebattle-gem-hint`);if(o){let n=te(W.adventure,e);o.textContent=(xe(W.adventure,e)?`Repeat clear: +${n} gems`:`First clear: +${n} gems`)+(t.worldId===5&&Se(W.adventure)?` · Challenge mode: enemy has an extra rank of pieces`:``)}let s=X(`enemy-deck-preview`);if(s){s.innerHTML=``;try{for(let{def:e,count:t}of me(nc)){if(!e)continue;let n=document.createElement(`button`);n.type=`button`,n.className=`enemy-deck-spell-btn`,n.title=`View ${e.name}`;let r=document.createElement(`span`);if(r.className=`enemy-deck-spell-btn__name`,r.textContent=e.name,n.appendChild(r),t>1){let e=document.createElement(`span`);e.className=`enemy-deck-spell-btn__count`,e.textContent=`×${t}`,n.appendChild(e)}n.addEventListener(`click`,()=>Ga(e,{meta:t>1?`${t} copies in enemy deck`:`Enemy deck`})),s.appendChild(n)}}catch(e){console.error(`Enemy preview failed`,e),s.innerHTML=`<p class="empty-msg">Enemy deck preview unavailable.</p>`}}w(W)&&T(W);let c=vr(`adventure-deck-select`);if(!c){a&&(a.textContent=`Deck selector missing — hard refresh the page.`);return}c.innerHTML=``;let l=W.decks.filter(e=>r(e.cardIds,W).valid);if(!l.length){let e=document.createElement(`option`);e.value=``,e.textContent=`No complete decks — build one in Decks`,c.appendChild(e),c.disabled=!0,X(`btn-start-adventure`).disabled=!0;return}c.disabled=!1;let u=W.selectedDeckId&&l.some(e=>e.id===W.selectedDeckId)?W.selectedDeckId:l[0].id;for(let e of l){let t=document.createElement(`option`);t.value=e.id,t.textContent=e.name,e.id===u&&(t.selected=!0),c.appendChild(t)}W.selectedDeckId=u,X(`btn-start-adventure`).disabled=!1}async function Pl(e,t,n,r,i=null,a=!1,o=void 0){let s=t.opponent;Tl(),nc=null,document.querySelectorAll(`.view`).forEach(e=>e.classList.add(`hidden`)),X(`view-match`)?.classList.remove(`hidden`);let c=X(`view-match`);if(!c)return;let{MatchSession:u,getMatchHtml:d}=await os();c.innerHTML=d(s);let p=o??(Ce(r).id===5&&Se(W.adventure)),m={levelId:r,deckId:e.id,challengeMode:p},h={aiDeckIds:n,opponentName:s,cosmetics:f(W),profile:W,challengeMode:p,buildGameOverActions:({won:e,isTie:t})=>Il(m,{won:e,isTie:t}),onGameOverAction:e=>{Ll(e,m,c)}};i&&(h.initialState=i);try{J=new u(e.cardIds,c,()=>{J=null,dr(),Ao(),So(`hub`),c.innerHTML=``,X(`view-match`)?.classList.add(`hidden`);let e=nr();e?Z(e):(ks=`adventure`,Z(`play`)),Xs&&Hl(),Zs&&Ul()},e=>{let t=se(W,r,e),{gems:n,stars:i,starsGained:a}=t;return W.gems+=n,fe(W,`adventure_floors`,1),l(W),T(W),$(),yc(),r===1&&t.firstTime&&(Xs=!0,Hl()),r===5&&t.firstTime&&(Zs=!0),{message:`+${n} gems! · Best: ${C(i)}`,starsGained:a}},h)}catch(e){throw J=null,c.innerHTML=``,X(`view-match`)?.classList.add(`hidden`),Z(`play`),e}lr({kind:`adventure`,deckId:e.id,deckCardIds:e.cardIds,aiDeckIds:n,opponentName:s,levelId:r,challengeMode:p}),await Ao(),So(`match`),a&&(J.winRewarded=!0),fr(J),J.setMessage(``),J.render()}async function Fl(){let e=pr();if(!e)return!1;let t=W.decks.find(t=>t.id===e.deckId)||W.decks.find(e=>e.cardIds?.length===30),n=e.levelId?ue(e.levelId):null;return!t||t.cardIds.length!==30||!n||!e.aiDeckIds?.length||!await Qe(`Resume your adventure match where you left off?`,{title:`Resume match?`,confirmLabel:`Resume`,cancelLabel:`Discard`})?(ur(),!1):(ec=e.levelId,await Pl(t,n,e.aiDeckIds,e.levelId,e.state,e.winRewarded,e.challengeMode),J?.setMessage(`Match resumed — pick up where you left off.`),!0)}function Il({levelId:e},{won:t,isTie:n}){let r=e+1,i=t&&r<=50&&_(W.adventure,r);if(n)return[{id:`backToAdventure`,label:`Back to Adventure`,primary:!0}];if(t){let e=[];return i?(e.push({id:`nextFloor`,label:`Next floor`,primary:!0}),e.push({id:`retry`,label:`Retry floor`}),e.push({id:`backToAdventure`,label:`Back to Adventure`})):(e.push({id:`backToAdventure`,label:`Back to Adventure`,primary:!0}),e.push({id:`retry`,label:`Retry floor`})),e}return[{id:`retry`,label:`Retry floor`,primary:!0},{id:`backToAdventure`,label:`Back to Adventure`}]}async function Ll(e,{levelId:t,deckId:n,challengeMode:r},i){let a=W.decks.find(e=>e.id===n);if(e===`backToAdventure`){J?.onExit?.();return}if(e===`nextFloor`){let e=t+1;if(!ue(e)||!_(W.adventure,e)){J?.onExit?.();return}J?.dispose(),J=null,dr({clearCheckpoint:!0}),Ao(),So(`hub`),i&&(i.innerHTML=``),X(`view-match`)?.classList.add(`hidden`),await Z(`play`),Nl(e);return}if(e===`retry`){let e=t,n=ue(e);if(!a||a.cardIds.length!==30||!n){J?.onExit?.();return}J?.dispose(),J=null,dr(),await Pl(a,n,be(W,e),e,null,!1,r)}}function Rl(){let e=vr(`adventure-deck-select`)?.value,t=W.decks.find(t=>t.id===e),n=ec,r=n?ue(n):null,i=nc?[...nc]:null;if(!t||t.cardIds.length!==30||!r||!i?.length){let e=X(`prebattle-opponent`);e&&(!t||t.cardIds.length!==30?e.textContent=`Build a complete 30-card deck in the Decks tab, then try again.`:e.textContent=`Could not start battle — close and pick the floor again.`);return}Pl(t,r,i,n)}function zl(){if(window.__adventureMapCaptureBound)return;window.__adventureMapCaptureBound=!0;let e=null,t=!1,n=0,r=e=>e.closest?.(`#adventure-map .adventure-map-tile, #adventure-map .adventure-map-pin`),i=e=>e?.closest?.(`.adventure-map-scene`),a=()=>{t=!0,clearTimeout(n),n=setTimeout(()=>{t=!1},280)},o=(e,t)=>{if(!e||e.disabled)return;let n=Number(e.dataset.level);!Number.isFinite(n)||n<1||(t.preventDefault(),t.stopPropagation(),Bl(n))};document.addEventListener(`pointerdown`,t=>{if(t.button!==0)return;let n=r(t.target);if(!n||n.disabled)return;let a=i(n);e={pin:n,pointerId:t.pointerId,startX:t.clientX,startY:t.clientY,scrollTop:a?.scrollTop??0,scrollLeft:a?.scrollLeft??0,cancelled:!1}},!0),document.addEventListener(`pointermove`,t=>{if(!e||t.pointerId!==e.pointerId||e.cancelled)return;let n=t.clientX-e.startX,r=t.clientY-e.startY;Math.hypot(n,r)>12&&(e.cancelled=!0);let a=i(e.pin);a&&(Math.abs(a.scrollTop-e.scrollTop)>3&&(e.cancelled=!0),Math.abs(a.scrollLeft-e.scrollLeft)>3&&(e.cancelled=!0))},!0),document.addEventListener(`pointerup`,t=>{if(!e||t.pointerId!==e.pointerId)return;let{pin:n,cancelled:r}=e;if(e=null,r){a();return}o(n,t),a()},!0),document.addEventListener(`pointercancel`,t=>{!e||t.pointerId!==e.pointerId||(e=null,a())},!0),document.addEventListener(`click`,e=>{if(t){e.preventDefault(),e.stopPropagation();return}let n=r(e.target);!n||n.disabled||o(n,e)},!0)}function Bl(e){let t=s(W.adventure);if(W.adventure=t,!_(t,e)){pc(`Locked — beat global floor ${e-1} first, then return here.`,`Floor locked`);return}T(W),Nl(e)}function Vl(){lc(),window.addEventListener(`orientationchange`,lc),window.addEventListener(`resize`,lc),mc(),co(),no(),Fo(),wo(),jo(),Io(),Ka(),zl(),cc(),document.querySelector(`.adventure-map-scene`)?.addEventListener(`scroll`,jl,{passive:!0});let e;window.addEventListener(`resize`,()=>{clearTimeout(e),e=setTimeout(()=>{if(!document.body.classList.contains(`adventure-active`))return;let e=X(`adventure-map`);e&&Al(e)},120)}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&Tl()}),document.querySelectorAll(`.tab-btn`).forEach(e=>{e.addEventListener(`click`,()=>{Bo(),Eo.tap(),Z(e.dataset.tab)})}),document.querySelectorAll(`.play-tab`).forEach(e=>{e.addEventListener(`click`,()=>{if(sr(),G!==`play`){ks=e.dataset.playTab,Z(`play`);return}_c(e.dataset.playTab)})}),document.querySelectorAll(`.play-sub-back`).forEach(e=>{e.addEventListener(`click`,()=>{Bo(),Eo.tap(),gc()})}),document.querySelectorAll(`.vault-tab`).forEach(e=>{e.addEventListener(`click`,()=>{sr(),il(e.dataset.vaultTab)})}),X(`btn-new-deck`)?.addEventListener(`click`,wl),X(`btn-back-from-edit`)?.addEventListener(`click`,async()=>{await hl()&&(gl(),Xc(`list`))}),X(`btn-delete-deck`)?.addEventListener(`click`,async()=>{if(!K||K===`new`)return;let e=W.decks.find(e=>e.id===K);e&&await Qe(`Delete "${e.name}"? This cannot be undone.`,{title:`Delete deck?`,confirmLabel:`Delete`,cancelLabel:`Keep`,destructive:!0})&&(de(W,e.id),gl(),Xc(`list`))});let t=()=>{Ms===`edit`&&xl(),Ms===`list`&&bl()};document.querySelectorAll(`.collection-owned-only-toggle`).forEach(e=>{e.addEventListener(`change`,e=>{Ls=e.target.checked,Lc(),t()})}),document.querySelectorAll(`.btn-reset-collection-filters`).forEach(e=>{e.addEventListener(`click`,()=>{Fs=`all`,Ps=``,Is=`all`,Ls=!0,Lc(),t()})}),Lc(),yr(),X(`collection-search`)?.addEventListener(`input`,e=>{Ps=e.target.value,t()}),vr(`collection-category`)?.addEventListener(`change`,e=>{Is=e.target.value,t()}),vr(`collection-rarity`)?.addEventListener(`change`,e=>{Fs=e.target.value,t()}),X(`btn-clear-deck`)?.addEventListener(`click`,()=>{q=[],xl()}),X(`btn-auto-finish-deck`)?.addEventListener(`click`,sc),X(`btn-save-deck`)?.addEventListener(`click`,Sl),X(`btn-back-adventure`)?.addEventListener(`click`,Tl),X(`adventure-floor-backdrop`)?.addEventListener(`click`,Tl),X(`btn-start-adventure`)?.addEventListener(`click`,Rl),vr(`adventure-deck-select`)?.addEventListener(`change`,e=>{W.selectedDeckId=e.target.value,T(W)});let n=document.getElementById(`auth-modal`),r=document.getElementById(`auth-header-btn`);Sc(),Kn(`play-help-btn`,`play-help-desc`),Kn(`adventure-help-btn`,`adventure-help-desc`),Kn(`shop-help-btn`,`shop-help-desc`),Kn(`deck-help-btn`,`deck-help-desc`),Ks=pn({onSignIn:()=>qs?.open(`signin`,{forced:!0}),onSignUp:()=>qs?.open(`signup`,{forced:!0}),onGuest:()=>{en(),Yl()}}),qs=dn({authBtn:r,modal:n,onNewAccount:()=>{W=ge()?pe():E(),En(W,T)},onSignedIn:()=>{tn(),W=E(),w(W),Tn(W),$(),bl(),rl(),Ks?.hide(),Cc().then(()=>{G===`profile`&&Tc(),G===`quests`&&Fc(),G===`play`&&Ws().then(e=>e?.render({resume:!0})),G===`social`&&Gs().then(e=>e?.refresh?.()??e?.render())}),Ws().then(e=>e?.render({resume:!0})),ql(),Jl(),Kl(),Gl(),Y||Z(G)},onSignedOut:()=>{tn(),xc(),Q=``,bc(),Bs?.dispose?.(),J=null,dr({clearCheckpoint:!0}),sr(),W=pe(),yc(),$(),bl(),rl(),Ks?.show(),Z(`deck`)}}),mr(()=>J),w(W),Lc(),yc(),Xl()}function Hl(){if(!Xs||Qs!=null)return;let e=0,t=()=>{if(Qs=null,e+=1,Xs){if(er()){e<10&&(Qs=window.setTimeout(t,400));return}if(Tn(W),Kl()){Xs=!1;return}e<10&&(Qs=window.setTimeout(t,500))}};Qs=window.setTimeout(t,350)}function Ul(){if(!Zs||$s!=null)return;let e=0,t=()=>{if($s=null,e+=1,Zs){if(er()){e<10&&($s=window.setTimeout(t,400));return}if(Tn(W),Gl()){Zs=!1;return}e<10&&($s=window.setTimeout(t,500))}};$s=window.setTimeout(t,350)}function Wl(){return Y||!fn()||!d(W)||!Pn(W)?!1:(Y=!0,Z(`play`),xs().then(({startPvpTutorial:e})=>{e({profile:W,saveProfile:T,onComplete:()=>{Y=!1,W=E(),w(W),yc(),Z(`play`),Gl()}})}),!0)}function Gl(){return Y||!fn()||!c(W)||kn(W)||An(W)||Nn(W)||Pn(W)||!In(W)?!1:(Y=!0,Z(`play`),xs().then(({startCosmeticsTutorial:e})=>{e({profile:W,saveProfile:T,onComplete:()=>{Y=!1,W=E(),w(W),yc(),Z(`play`)}})}),!0)}function Kl(){return Y||!fn()||!d(W)?!1:(Tn(W),Nn(W)?(Y=!0,Z(`play`),xs().then(({startQuestsTutorial:e})=>{e({profile:W,saveProfile:T,onComplete:()=>{Y=!1,W=E(),w(W),yc(),Wl(),Gl()}})}),!0):Wl())}function ql(){return Y||!fn()||!kn(W)?!1:(Y=!0,Cs().then(({startInteractiveTutorial:e})=>{e({profile:W,saveProfile:T,onComplete:()=>{Y=!1,W=E(),w(W),$(),bl(),rl(),Jl()||Z(`deck`),Kl(),Gl()}})}),!0)}function Jl(){return Y||!fn()||!An(W)?!1:(Y=!0,Z(`deck`),ys().then(({startMetaTutorial:e})=>{e({profile:W,saveProfile:T,onComplete:()=>{Y=!1,W=E(),w(W),$(),bl(),rl(),Z(`deck`),Kl(),Gl()}})}),!0)}async function Yl(){Ks?.hide(),!ql()&&(Jl()||Kl()||Gl()||Y||(await Fl()||await Z(`deck`),sr(),So(`hub`)))}async function Xl(){try{if(await Fe()){try{let e=await cn();e&&(W=e)}catch(e){console.warn(`Cloud sync on load failed`,e)}w(W),$(),bl(),rl()}}catch(e){console.warn(`Auth init failed`,e)}if(Tn(W),await Cc(),Bs&&G===`play`&&(Os===`arena`||Os===`leaderboard`)&&Bs.render(),sr(),mn()){Ks?.show();return}await Yl()}Vl(),D(async()=>{let{registerSW:e}=await import(`./virtual_pwa-register-CpSsV7JG.js`);return{registerSW:e}},[],import.meta.url).then(({registerSW:e})=>{e({immediate:!0})}),$e(),rt();export{dr as A,Ln as B,_r as C,ar as D,rr as E,Fn as F,gt as G,Xt as H,Dn as I,Qe as J,St as K,On as L,sr as M,fr as N,nr as O,Kn as P,Mn as R,Sr as S,ur as T,Zt as U,nn as V,Rt as W,Ke as Y,so as _,Yo as a,Ga as b,Xo as c,$o as d,ts as f,U as g,So as h,Vo as i,er as j,lr as k,Zo as l,Co as m,rs as n,Go as o,Ao as p,ht as q,is as r,Ko as s,os as t,qo as u,Za as v,vr as w,za as x,qa as y,jn as z};