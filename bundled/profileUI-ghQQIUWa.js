import{$ as e,C as t,F as n,G as r,I as i,J as a,L as o,O as s,Q as c,T as l,W as u,_ as d,at as f,b as p,et as m,it as h,m as g,nt as _,rt as v,st as y,tt as b,v as x,w as S,x as C,y as w}from"./storage-D9Rz-LDI.js";import{a as T,c as E,d as D,l as O,o as k,t as A,u as j}from"./mageTitles-BPvsmJqw.js";import{a as ee,c as te,o as ne}from"./auth-DHasSuFN.js";import{K as re,a as M,c as N,d as P,i as F,l as I,n as L,r as R,s as z,u as B}from"./index-BX4eR634.js";import{playCosmeticOpenAnimation as V}from"./cosmeticOpenAnimation-BSAcRCdP.js";import{notifyUnlockTutorial as H}from"./tutorialUnlocks-CAOqeLhj.js";var U=null;function W(){U!=null&&(clearInterval(U),U=null)}function G(e){if(!e)return;W();let t=()=>{e.textContent=`Resets in: ${_(f())}`};t(),U=setInterval(t,1e3)}function K(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}var q={common:`rarity-common`,uncommon:`rarity-uncommon`,rare:`rarity-rare`,epic:`rarity-epic`,legendary:`rarity-legendary`};function J(e){if(e===`pieceSkin`)return`Piece skins`;if(e===`frame`)return`Frames`;let t=N(e);return t.endsWith(`s`)?t:`${t}s`}function Y(e){let t=E(e);return t?D(t):``}var ie={pvp:`<svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <div class="profile-hero-card">
      <div class="profile-showcase profile-hero-card__showcase">
        ...
        <div class="profile-showcase__hero profile-hero-card__hero">
          <div class="profile-avatar-stack ${I(e.equipped.frame)}" id="profile-avatar-stack">
      ...
      ${ae(t)}
    </div>`}function X(e,t,{logEl:r,onGemsChange:i,onOpened:o,cosmeticsUnlocked:s=!0}={}){if(t){if(t.innerHTML=``,!s){t.innerHTML=`<p class="vault-locked-msg muted">${y}</p>`;return}for(let c of n){let n=F[c.id]||F.style_crate,l=e.gems>=c.cost,u=document.createElement(`article`);u.className=`chest-card chest-card--${n.visual} cosmetic-box-card cosmetic-box-card--${c.id}${l?``:` chest-card--locked`}`,u.innerHTML=`
  ...
  `;let d=t.querySelector(`#profile-cosmetic-grid`),f=`avatar`,p=``,m=()=>{let n=r(e);t.querySelector(`#profile-banner-preview`).style.background=M(n.equipped.banner);let i=t.querySelector(`#profile-avatar-preview`),o=(p||`P`).charAt(0).toUpperCase();i&&(i.innerHTML=B(n.equipped.avatar)||`<span class="profile-avatar-fallback">${K(o)}</span>`);let s=t.querySelector(`#profile-avatar-stack`);s&&(s.className=`profile-avatar-stack ${I(n.equipped.frame)}`);let c=t.querySelector(`#profile-hero-username`);c&&(c.textContent=p||`Player`);let l=t.querySelector(`.profile-hero-card__title-badge`),u=Y(e);if(u)if(l)l.innerHTML=u;else{let e=t.querySelector(`.profile-hero-card__name-row`);if(e){let t=document.createElement(`span`);t.className=`profile-hero-card__title-badge`,t.innerHTML=u,e.appendChild(t)}}else l&&l.remove();a?.()},h=()=>{let t=e.cosmetics?.owned?.[f]||[];d.innerHTML=``;for(let n of t){let t=i[n];if(!t)continue;let r=e.cosmetics.equipped[f]===n,a=document.createElement(`button`);a.type=`button`,a.className=`profile-cosmetic-card ${q[t.rarity]||``} ${r?`profile-cosmetic-card--equipped`:``}`;let o=P(n,t.type);a.innerHTML=`
