...
import{n as e,o as t,t as n}from"./cardCatalog-UntPSDsZ.js";import{c as r,i,r as a}from"./deckRules-Co0LaCgH.js";import{A as o,Ct as s,D as c,Dt as l,Et as u,N as d,Ot as f,R as p,St as m,Tt as h,V as g,W as ee,_t as _,a as v,at as y,bt as b,c as x,ct as S,d as C,dt as te,f as w,ft as ne,g as re,gt as ie,ht as ae,i as oe,k as se,kt as ce,l as le,lt as ue,m as T,mt as de,o as fe,ot as pe,p as me,pt as he,r as ge,s as _e,st as ve,t as ye,u as E,ut as be,vt as xe,wt as Se,xt as Ce,yt as we}from"./storage-Cg_enSNM.js";import{l as Te,p as Ee,r as De}from"./mageTitles-BPvsmJqw.js";import{t as D}from"./preload-helper-CV77j2BA.js";import{_ as Oe,a as ke,c as Ae,d as je,f as Me,h as Ne,l as Pe,m as Fe,o as O,s as Ie,t as Le}from"./auth-C4G8ORWQ.js";var Re=Object.defineProperty,ze=(e,t)=>{let n={};for(var r in e)Re(n,r,{get:e[r],enumerable:!0});return t||Re(n,Symbol.toStringTag,{value:`Module`}),n};function Be(){let e=window.visualViewport;return e?Math.max(0,Math.round(e.offsetTop)):0}function Ve(){let e=window.visualViewport;return e?Math.max(0,Math.round(window.innerHeight-e.offsetTop-e.height)):0}function He(){let e=document.documentElement,t=()=>{e.style.setProperty(`--viewport-inset-top`,`${Be()}px`),e.style.setProperty(`--viewport-inset-bottom`,`${Ve()}px`)};t(),window.visualViewport?.addEventListener(`resize`,t),window.visualViewport?.addEventListener(`scroll`,t),window.addEventListener(`resize`,t),window.addEventListener(`orientationchange`,t)}He();var Ue=1100,We=120;function Ge(){let e=document.getElementById(`app-splash`);if(!e||e.classList.contains(`app-splash--hide`))return;e.classList.add(`app-splash--hide`),document.body.classList.remove(`splash-active`);let t=()=>{e.remove()};e.addEventListener(`transitionend`,t,{once:!0}),window.setTimeout(t,600)}function Ke(){Ge()}function qe(){let e=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches?We:Ue,t=performance.now(),n=()=>{let n=performance.now()-t,r=Math.max(0,e-n);window.setTimeout(Ge,r)};document.readyState===`interactive`||document.readyState===`complete`?n():document.addEventListener(`DOMContentLoaded`,n,{once:!0})}document.body.classList.add(`splash-active`),qe();var Je=`(max-width: 768px)`,Ye=null;function Xe(){return document.getElementById(`mobile-confirm`)}function Ze(e){let t=Xe();if(!t)return;t.classList.add(`hidden`),document.body.classList.remove(`mobile-confirm-open`);let n=Ye;Ye=null,n?.(e)}function Qe(e,t={}){if(!window.matchMedia(Je).matches)return Promise.resolve(window.confirm(e));let n=Xe();if(!n)return Promise.resolve(window.confirm(e));let{title:r=`Confirm`,confirmLabel:i=`OK`,cancelLabel:a=`Cancel`,destructive:o=!1}=t;return new Promise(t=>{Ye&&Ze(!1),Ye=t,n.querySelector(`#mobile-confirm-title`).textContent=r,n.querySelector(`#mobile-confirm-body`).textContent=e;let s=n.querySelector(`#mobile-confirm-ok`),c=n.querySelector(`#mobile-confirm-cancel`);s.textContent=i,c.textContent=a,s.classList.toggle(`btn-danger`,o),s.classList.toggle(`btn-primary`,!o),n.classList.remove(`hidden`),document.body.classList.add(`mobile-confirm-open`),c.focus()})}function $e(){let e=Xe();!e||e.dataset.bound||(e.dataset.bound=`1`,e.querySelector(`#mobile-confirm-ok`)?.addEventListener(`click`,()=>Ze(!0)),e.querySelector(`#mobile-confirm-cancel`)?.addEventListener(`click`,()=>Ze(!1)),e.querySelector(`[data-mobile-confirm-backdrop]`)?.addEventListener(`click`,()=>Ze(!1)))}var et=`cc_install_banner_dismissed`;function tt(){return window.matchMedia(`(display-mode: standalone)`).matches||window.navigator.standalone===!0}function nt(){let e=window.navigator.userAgent;return/iphone|ipad|ipod/i.test(e)&&!/crios|fxios/i.test(e)}function rt(){if(tt()||localStorage.getItem(et)===`1`)return;let e=document.getElementById(`install-banner`);if(!e)return;let t=null,n=()=>{e.classList.remove(`hidden`),document.body.classList.add(`install-banner-visible`)},r=()=>{e.classList.add(`hidden`),document.body.classList.remove(`install-banner-visible`)};window.addEventListener(`beforeinstallprompt`,r=>{r.preventDefault(),t=r,e.querySelector(`#install-banner-ios-hint`)?.classList.add(`hidden`),e.querySelector(`.install-banner__hint--default`)?.classList.remove(`hidden`),e.querySelector(`#install-banner-btn`)?.classList.remove(`hidden`),n()}),nt()&&(e.querySelector(`#install-banner-ios-hint`)?.classList.remove(`hidden`),e.querySelector(`.install-banner__hint--default`)?.classList.add(`hidden`),e.querySelector(`#install-banner-btn`)?.classList.add(`hidden`),window.setTimeout(n,2500)),e.querySelector(`#install-banner-btn`)?.addEventListener(`click`,async()=>{t&&(t.prompt(),await t.userChoice,t=null,r())}),e.querySelector(`#install-banner-dismiss`)?.addEventListener(`click`,()=>{localStorage.setItem(et,`1`),r()})}var it=[`attack`,`control`,`defense`,`movement`,`trap`,`special`],at={attack:`Attack`,control:`Control`,defense:`Defense`,movement:`Movement`,trap:`Trap`,special:`Special`},ot={aegis:`defense`,anchor:`defense`,backpedal:`control`,backstab:`attack`,backstep:`movement`,barrier:`defense`,bishops_mark:`movement`,blind:`control`,blizzard:`control`,snowball:`control`,berserk:`movement`,bomb:`attack`,shockwave:`control`,plague:`control`,bulwark:`defense`,create_foe:`special`,call_forward:`movement`,chain_lightning:`attack`,clone:`special`,coin_flip:`attack`,collapse:`special`,confusion:`control`,constitution:`defense`,counterspell:`trap`,crown:`special`,cryo_bolt:`attack`,cull:`attack`,darkness:`defense`,dash:`movement`,deep_freeze:`control`,deflect:`trap`,demote:`control`,deport:`movement`,displacement:`movement`,dominion:`special`,duel:`attack`,earthquake:`special`,execution:`attack`,extract:`control`,pyromancy:`attack`,fusion:`special`,hibernation:`special`,hostile_swap:`movement`,ignore:`special`,iron_will:`defense`,landmine:`trap`,last_king:`special`,bounty:`special`,link_fate:`special`,last_stand:`trap`,leapfrog:`movement`,long_step:`movement`,magnet:`movement`,nudge:`movement`,offering:`special`,panic:`control`,poison:`attack`,mind_control:`special`,press:`control`,purify:`special`,quick_march:`movement`,quicksand:`trap`,rally:`defense`,recall:`movement`,repel:`movement`,random_teleport:`movement`,retreat:`movement`,revive:`defense`,rooks_mark:`movement`,root:`control`,sacrifice:`attack`,sanctuary:`defense`,scatter:`movement`,shadow_swap:`movement`,sidestep:`movement`,shatter:`attack`,snipe:`attack`,snowball:`control`,stab:`attack`,stall:`defense`,tangle:`control`,teleport:`movement`,trickster:`special`,vengeance:`trap`,ward:`defense`};function st(e){let t=ot[e?.id];if(t)return t;let n=`${e?.id||``} ${e?.effect||``} ${e?.name||``} ${e?.desc||``}`.toLowerCase();return/trap|mine|quicksand|counterspell|vengeance|last.?stand/.test(n)?`trap`:/shield|ward|aegis|sanctuary|barrier|anchor|deflect|stall|iron_will|rally|darkness/.test(n)?`defense`:/move|nudge|teleport|recall|leap|step|displace|swap|scatter|retreat|bishop|rook|overrun|promote|pull|push|shift|earthquake|magnet|repel/.test(n)?`movement`:/freeze|blind|confusion|hex|root|panic|press|silence|paraly|control|cannot play|random|mark|poison|die in \d+ turn/.test(n)?`control`:/\bdestroy\b|\bkills?\b|fireball|bolt|stab|snipe|duel|sacrifice|execution|shatter|cull|lightning/.test(n)?`attack`:`special`}var ct=[{id:`bronze`,name:`Bronze Chest`,cost:25,cards:3,weights:{common:70,uncommon:25,rare:5,epic:0}},{id:`silver`,name:`Silver Chest`,cost:50,cards:5,weights:{common:50,uncommon:35,rare:12,epic:3}},{id:`gold`,name:`Gold Chest`,cost:100,cards:8,weights:{common:32,uncommon:38,rare:22,epic:6,legendary:2}}];function lt(e){let t=Math.random()*100,n=0;for(let r of[`common`,`uncommon`,`rare`,`epic`,`legendary`])if(n+=e[r]||0,t<=n)return r;return`common`}function ut(t){let n=e().filter(e=>e.rarity===t);return n.length?n[Math.floor(Math.random()*n.length)]:e()[0]}function dt(e,t){return ut(lt(t.weights))}function ft(e,n,r={}){let{starRefundChance:i=0}=r;if(oe(e,n.id)<t(n))return ye(e,n.id,1),{...n,duplicate:!1};let a=p[n.rarity]||5;if(i>0&&Math.random()<i){let e=Math.random()<.5?1:2;return{...n,duplicate:!0,starRefund:e}}return{...n,duplicate:!0,gemRefund:a}}function pt(e,t){let n=ct.find(e=>e.id===t);if(!n)return{success:!1,message:`Unknown chest.`};if(e.gems<n.cost)return{success:!1,message:`Not enough gems.`};e.gems-=n.cost;let r=[],i=0;for(let t=0;t<n.cards;t++){let t=ft(e,dt(e,n));r.push(t),t.gemRefund&&(i+=t.gemRefund)}return i&&(e.gems+=i),y(e,`boxes_opened`,1),T(e),{success:!0,pulls:r,chest:n,bonusGems:i}}var mt=[`common`,`uncommon`,`rare`,`epic`,`legendary`];function ht(e,{minPct:t=1}={}){return mt.filter(n=>(e[n]??0)>=t).map(t=>`${e[t]}% ${t}`).join(` · `)}var gt={bronze:{label:`Bronze`,tagline:`Mostly common cards`,accent:`#cd7f32`,glow:`rgba(205, 127, 50, 0.45)`},silver:{label:`Silver`,tagline:`Balanced card mix`,accent:`#a8b8d8`,glow:`rgba(168, 184, 216, 0.5)`},gold:{label:`Gold`,tagline:`Higher rare & epic odds`,accent:`#e8c547`,glow:`rgba(232, 197, 71, 0.55)`}};function _t(e){let t=gt[e]||gt.bronze;return{t,lid:e===`gold`?`#f5e6a8`:e===`silver`?`#e8eef8`:`#d4954a`,body:e===`gold`?`#7a5c12`:e===`silver`?`#4a5568`:`#5c3a1e`,trim:e===`gold`?`#ffe566`:e===`silver`?`#c8d8f0`:t.accent}}function vt(e,t){let{lid:n,body:r,trim:i}=_t(e);return`
  ...
  <path d="M14 54 L18 50 M50 54 L46 50 M54 14 L50 18 M10 14 L14 18" stroke="#d6d3d1" stroke-width="1.8" stroke-linecap="round" opacity="0.65"/>
    ...
    ${P([[16,20,.8],[48,38,.7],[32,10,.9]],`#e9d5ff`,.6)}`}function ri(){return`${N(32,54,22,4)}
    ...
    ${P([[30,6,.9],[12,18,.6],[50,36,.5]],`#e9d5ff`,.55)}`}function ii(){return`${N(32,54,20,4)}
    ...
    ${P([[14,14,.8],[48,16,.7],[32,8,.9]],`#e9d5ff`,.6)}`}function ai(){return`${N(32,54,22,4)}
    ${F(32,50,5)}
    ...
    ${P([[50,10,1],[12,52,.8],[40,20,.7]],`#e0f2fe`,.7)}`}function oi(){return`${N(32,54,22,4)}
    ...
    ${P([[32,32,.8],[28,28,.6],[36,36,.6]],`#fde68a`,.55)}`}function si(){return`${N(32,54,22,4)}
    ...
    ${P([[20,12,.9],[44,12,.8],[32,4,1],[14,28,.7],[50,28,.7]],`#fff`,.55)}`}function ci(){return`${N(32,56,18,4)}
    ...
    ${P([[14,10,.7],[50,10,.7],[32,28,.8]],`#fde68a`,.6)}`}function li(){return`${N(32,54,22,4)}
    ...
    ${Fr(32,36,4,`#e9d5ff`)}
    ${P([[32,28,.8],[32,44,.7]],`#e9d5ff`,.6)}`}function ui(){return`${N(32,54,20,4)}
    ${F(22,38,5.5)}
    ...
    ${P([[36,32,.7],[48,34,.6],[42,28,.8]],`#e9d5ff`,.55)}`}function di(){return`${N(32,56,18,4)}
    ${F(32,42,6)}
  ...
  ${jr(14,50,3.2)}${Lr(50,50,3.2)}`)}`}function pi(){return`${N(24,54,20,4)}
    ${I(48,20,5.5)}
    ...
    ${P([[18,32,.8],[28,28,.6]],`#e9d5ff`,.55)}`}function mi(){return`${N(28,54,18,4)}
    ${F(22,44,5.5)}
    ...
    ${P([[30,8,.8],[52,6,.7],[24,28,.6]],`#e9d5ff`,.6)}`}function hi(){return`${N(32,52,22,4)}
    ...
    ${P([[32,34,.9],[16,14,.7],[48,14,.7]],`#e0f2fe`,.6)}`}function gi(){return`${N(32,54,18,4)}
    ${F(32,48,5.5)}
    ...
    ${P([[12,18,.7],[52,18,.7],[32,36,.6]],`#e9d5ff`,.55)}`}function _i(){return`${N(32,54,18,4)}
    ${F(32,48,5.5)}
    ...
    ${P([[32,6,.7],[4,44,.6],[60,44,.6]],`#e9d5ff`,.55)}`}function vi(){return`${N(30,52,20,4)}
    ${I(46,20,5.5)}
    ...
    ${P([[36,26,.7],[22,38,.6]],`#fca5a5`,.5)}`}function yi(){return`${N(30,54,18,4)}
    ${F(18,50,5)}
    ${I(44,28,5)}
    ...
    ${P([[38,34,.7]],`#e9d5ff`,.5)}`}function bi(){return`${N(32,54,26,4)}
    ...
    ${P([[8,10,.8],[56,12,.9],[32,18,.7]],`#e0f2fe`,.65)}`}function xi(){return`${N(32,54,22,4)}
    ...
    ${P([[20,40,.7],[44,24,.7],[32,28,.8]],`#e9d5ff`,.55)}`}function Si(){return`${N(32,54,24,4)}
    ...
    ${P([[16,10,.7],[48,10,.7],[10,32,.6],[54,32,.6]],`#c4b5fd`,.45)}`}function Ci(){return`${N(32,56,16,4)}
    ${F(32,34,6)}
    ...
    ${P([[32,12,.8],[12,34,.6],[52,34,.6]],`#e9d5ff`,.5)}`}function wi(){return`${N(32,56,16,4)}
    ${F(32,38,6)}
    ...
    ${P([[32,4,.8],[18,8,.6],[46,8,.6]],`#fde68a`,.55)}`}function Ti(){return`${N(30,54,18,4)}
    ${F(28,36,6)}
    ...
    ${P([[12,12,.7],[46,18,.6]],`#fca5a5`,.5)}`}function Ei(){return`${N(32,54,20,4)}
    ...
    ${P([[32,8,.8],[14,28,.6],[50,28,.6]],`#e9d5ff`,.5)}`}function Di(){return`${N(32,54,20,4)}
    ...
    <path d="M24 50 C30 44 34 44 40 50" stroke="#fde68a" stroke-width="2" fill="none" opacity="0.7"/>
    ${M(32,14,5,`#fde68a`,`#b45309`)}
    ${P([[24,36,.7],[40,36,.7],[32,8,.9]],`#fde68a`,.6)}`}function Oi(){return`${N(32,54,18,4)}
    ${F(32,34,6)}
    ...
    ${P([[32,12,.8],[8,34,.6],[56,34,.6]],`#e9d5ff`,.55)}`}function ki(){return`${N(32,54,20,4)}
    ...
    ${P([[46,16,.7],[24,20,.5]],`#c4b5fd`,.45)}`}function Ai(){return`${N(32,54,24,4)}
    ...
    ${P([[8,8,.7],[56,8,.7],[8,56,.7],[56,56,.7]],`#fde68a`,.6)}`}function ji(){return`${N(28,54,18,4)}
    ${F(18,44,5.5)}
    ${L(42,24,6,`#cbd5e1`)}
    ...
    ${P([[40,20,.7],[22,36,.5]],`#e2e8f0`,.45)}`}function Mi(){return`${N(32,54,16,4)}
    ${F(32,20,5.5)}
    ${L(32,48,6,`#cbd5e1`)}
    ...
    ${P([[32,16,.6],[32,44,.5]],`#cbd5e1`,.4)}`}function Ni(){return`${N(32,54,16,4)}
    ${F(32,26,5.5)}
    ...
    ${P([[32,22,.6]],`#93c5fd`,.4)}`}function Pi(){return`${N(32,54,20,4)}
    ...
    ${P([[32,6,.7]],`#cbd5e1`,.4)}`}function Fi(){return`${N(32,54,22,4)}
    ${F(32,24,5.5)}
    ...
    ${P([[20,40,.5],[44,40,.5]],`#93c5fd`,.4)}`}function Ii(){return`${N(30,54,20,4)}
    ${F(20,36,5)}${I(40,36,5)}
    ${L(54,36,5,`#fca5a5`)}
    ...
    ${P([[48,32,.6]],`#fde68a`,.45)}`}function Li(){return`${N(28,54,20,4)}
    ...
    ${P([[30,14,.8],[20,38,.5]],`#bae6fd`,.5)}`}function Ri(){return`${N(32,54,18,4)}
    ${F(32,40,5.5)}
    ...
    ${P([[24,12,.8],[48,20,.7],[32,6,.9]],`#e9d5ff`,.55)}`}function zi(){return`${N(32,54,22,4)}
    ...
    ${P([[32,10,.8],[16,40,.5],[48,40,.5]],`#93c5fd`,.45)}`}function Bi(){return`${N(32,54,16,4)}
    ${F(32,36,6)}
    ...
    ${P([[16,12,.6]],`#fca5a5`,.4)}`}function Vi(){return`${N(32,54,18,4)}
    ${F(32,34,6)}
    ...
    ${P([[32,20,.7]],`#e2e8f0`,.4)}`}function Hi(){return`${N(32,54,16,4)}
    ${I(32,40,6)}
    ...
    ${P([[24,4,.6],[40,4,.6]],`#fde68a`,.45)}`}function Ui(){return`${N(32,54,18,4)}
    ${Pr(32,36,32)}
    ...
    ${P([[30,36,.5]],`#d6d3d1`,.35)}`}function Wi(){return`${N(32,54,16,4)}
    ...
    ${P([[46,10,.7]],`#fca5a5`,.5)}`}function Gi(){return`${N(32,54,16,4)}
    ...
    ${P([[32,20,.5],[32,40,.5]],`#cbd5e1`,.35)}`}function Ki(){return`${N(32,54,16,4)}
    ${I(32,22,6)}
    ...
    ${P([[28,16,.6],[36,16,.6]],`#fca5a5`,.45)}`}function qi(){return`${N(32,54,20,4)}
    ...
    ${Fr(32,34,4,`#c4b5fd`)}
    ${P([[32,30,.7]],`#e9d5ff`,.45)}`}function Ji(){return`${N(28,54,18,4)}
    ${F(12,34,5.5)}
    ${L(50,34,6,`#cbd5e1`)}
    ...
    ${P([[46,30,.6]],`#e2e8f0`,.4)}`}function Yi(){return`${N(32,54,18,4)}
    ${I(32,28,6)}
    ...
    ${M(32,52,5,`#fca5a5`,`#dc2626`)}`}function Xi(){return`${N(32,56,16,4)}
    ${F(32,38,6)}
    ...
    ${P([[32,18,.7],[20,32,.5],[44,32,.5]],`#bae6fd`,.4)}`}function Zi(){return`${N(32,54,18,4)}
    ${F(32,36,6)}
    ...
    ${P([[14,10,.7],[20,22,.5]],`#e0f2fe`,.5)}`}function Qi(){return`${N(30,54,20,4)}
    ${F(14,50,5.5)}
    ${L(50,14,6,`#7dd3fc`)}
    ...
    ${P([[48,12,.7],[24,38,.5]],`#bae6fd`,.45)}`}function $i(){return`${N(32,56,16,4)}
    ${F(32,38,6)}
    ...
    ${P([[32,14,.8],[14,34,.5],[50,34,.5]],`#bae6fd`,.45)}`}function ea(){return`${N(32,54,16,4)}
    ${I(32,34,6)}
    ...
    ${P([[32,10,.7],[28,44,.5],[36,44,.5]],`#86efac`,.45)}`}function ta(){return`${N(26,54,16,4)}
    ${F(24,38,5.5)}
    ...
    ${P([[48,10,.6]],`#fde68a`,.45)}`}function na(){return`${N(30,54,18,4)}
    ...
    ${P([[42,20,.7]],`#fde68a`,.5)}`}function ra(){return`${N(32,56,16,4)}
    ${F(32,40,6)}
    ...
    ${P([[22,4,.7],[32,0,.8],[42,4,.7]],`#fde68a`,.6)}`}function ia(){return`${N(30,54,20,4)}
    ...
    ${P([[46,12,.8],[24,40,.5]],`#e0f2fe`,.5)}`}function aa(){return`${N(32,54,16,4)}
    ${Pr(32,36,32)}
    ...
    ${P([[32,24,.6]],`#fca5a5`,.4)}`}function oa(){return`${N(32,54,18,4)}
    ${I(32,20,6)}
    ...
    ${P([[32,44,.5]],`#fca5a5`,.4)}`}function sa(){return`${N(32,54,16,4)}
    ${I(32,24,6)}
  ...
  <path d="M28 48 L24 54 M36 48 L40 54" stroke="#86efac" stroke-width="1.4" stroke-linecap="round" opacity="0.35"/>
    ${P([[20,40,.5],[44,40,.5]],`#86efac`,.4)}`}function ca(){return`${N(30,54,20,4)}
    ...
    ${M(48,22,5,`#ef4444`,`#991b1b`)}`}function la(){return`${N(32,54,18,4)}
    ...
    ${P([[32,8,.6],[56,32,.6],[32,56,.6],[8,32,.6]],`#bae6fd`,.4)}`}function ua(){return`${N(26,54,20,4)}
    ...
    ${P([[44,10,.75],[30,28,.55],[20,46,.5]],`#e9d5ff`,.5)}`}function fa(){return`${N(32,54,24,4)}
    ...
    ${P([[32,28,.7],[12,38,.5],[52,38,.5]],`#bae6fd`,.45)}`}function pa(){return`${N(32,56,14,3)}
    ${F(32,34,6)}
    ${Nr(32,28,`#38bdf8`,`#7dd3fc`)}
    ...
    <text x="10" y="18" font-size="6" fill="#e9d5ff" opacity="0.55">?</text>`}function ma(){return`${N(30,54,18,3.5)}
    ...
    <circle cx="42" cy="22" r="8" fill="#7dd3fc" opacity="0.12"/>`}function ha(){return`${N(32,54,14,3.5)}
    ${Pr(32,36,30,!1)}
    ${Lr(32,34,4)}
    ...
    <path d="M24 38 L28 42 M36 38 L40 42" stroke="#d6d3d1" stroke-width="1.2" stroke-linecap="round" opacity="0.4"/>`}function ga(){return`${N(32,56,14,3)}
    ${F(32,38,7)}
    ...
    <circle cx="32" cy="12" r="4" fill="#fde68a" opacity="0.3"/>`}function _a(){return`${N(32,54,20,4)}
    ...
    <path d="M18 44 L22 40 M46 18 L50 14" stroke="#fbbf24" stroke-width="1.2" stroke-linecap="round" opacity="0.45"/>`}function va(){return`${N(32,54,18,3.5)}
    ...
    <circle cx="32" cy="40" r="14" fill="none" stroke="#60a5fa" stroke-width="0.8" opacity="0.2"/>`}var ya={nudge:()=>z(`nu`,`#94a3b8`,`#1e293b`,ji()),backstep:()=>z(`bs`,`#9ca3af`,`#1f2937`,Mi()),retreat_3:()=>z(`ret`,`#93c5fd`,`#1e3a5f`,Ni()),leapfrog:()=>z(`lf`,`#94a3b8`,`#1e293b`,Li()),long_step:()=>B(`ls`,`#7dd3fc`,`#1e3a5f`,Qi()),sidestep:()=>z(`ss`,`#9ca3af`,`#1f2937`,Ji()),blink_2:()=>B(`bl`,`#38bdf8`,`#0c4a6e`,ia()),random_teleport:()=>z(`rtp`,`#a78bfa`,`#312e81`,Ri()),recall:()=>z(`rc`,`#93c5fd`,`#1e3a5f`,Fi()),repel:()=>z(`rp`,`#94a3b8`,`#1e293b`,Ii()),mass_nudge:()=>B(`mn`,`#7dd3fc`,`#1e3a5f`,ua()),displacement:()=>V(`dp`,`#b794f4`,`#553c7a`,da()),swap_friendly:()=>z(`sw`,`#a78bfa`,`#312e81`,qi()),dominion:()=>B(`dm`,`#60a5fa`,`#1e3a5f`,va()),shield_1:()=>z(`s1`,`#60a5fa`,`#1e3a5f`,Xi()),shield_2:()=>B(`s2`,`#38bdf8`,`#0c4a6e`,$i()),bulwark:()=>V(`bw`,`#b794f4`,`#553c7a`,xi()),barrier:()=>z(`br`,`#94a3b8`,`#1f2937`,Gi()),last_stand:()=>B(`ls`,`#38bdf8`,`#0c4a6e`,pa()),fortify:()=>V(`fo`,`#a78bfa`,`#4c1d95`,Ci()),sanctuary_pulse:()=>B(`sp`,`#7dd3fc`,`#1e3a5f`,fa()),sanctuary:()=>V(`sa`,`#c4b5fd`,`#4c1d95`,Ei()),deflect_1:()=>B(`df`,`#38bdf8`,`#0c4a6e`,ta()),anchor_2:()=>z(`an`,`#94a3b8`,`#1f2937`,Pi()),iron_will:()=>z(`iw`,`#9ca3af`,`#1f2937`,Vi()),vengeance:()=>V(`vg`,`#9f7aea`,`#3b0764`,Ti()),rally:()=>z(`rl`,`#60a5fa`,`#1e3a5f`,zi()),forward_bolt:()=>B(`fb`,`#fde68a`,`#1e3a5f`,na()),destroy_unshielded:()=>Ir(`sh`,`#4338ca`,`#1e1b4b`,Ur()),pyromancy:()=>Ir(`py`,`#ea580c`,`#431407`,Wr()),snipe:()=>B(`sn`,`#fde68a`,`#1e3a5f`,_a()),duel:()=>z(`du`,`#d4b896`,`#3d2817`,Yr()),sacrifice:()=>B(`sc`,`#fca5a5`,`#1e3a5f`,ca()),cull:()=>H(`cu`,`#a78bfa`,`#2e1065`,Jr()),execution:()=>H(`ex`,`#6ee7b7`,`#14532d`,Xr()),chain_lightning:()=>Ir(`cl`,`#2563eb`,`#0c1929`,Hr()),backstab:()=>B(`bk`,`#c4a574`,`#2d4a6e`,Br()),cryo_bolt:()=>B(`cb`,`#7dd3fc`,`#0c4a6e`,ma()),bomb:()=>Ir(`bm`,`#f59e0b`,`#78350f`,Vr()),shockwave:()=>H(`sw`,`#c4b5fd`,`#3b1f6e`,$r()),plague:()=>H(`pg`,`#86efac`,`#14532d`,ei()),magnet:()=>H(`mg`,`#6ee7b7`,`#14532d`,Zr()),poison_3:()=>B(`po`,`#86efac`,`#14532d`,ea()),root_2:()=>B(`ro`,`#86efac`,`#14532d`,sa()),panic:()=>z(`pn`,`#fca5a5`,`#1f2937`,Ki()),blizzard:()=>V(`bz`,`#7dd3fc`,`#1e3a5f`,bi()),snowball:()=>z(`sb`,`#bae6fd`,`#0c4a6e`,Zi()),berserk:()=>Ir(`bk`,`#991b1b`,`#450a0a`,qr()),create_foe:()=>z(`cf`,`#78716c`,`#292524`,Wi()),deep_freeze:()=>H(`df`,`#7dd3fc`,`#0c4a6e`,ai()),reverse_only_2:()=>B(`rv`,`#fca5a5`,`#1e3a5f`,oa()),press:()=>z(`pr`,`#fca5a5`,`#1f2937`,Yi()),tangle:()=>V(`tg`,`#93c5fd`,`#312e81`,hi()),blind:()=>V(`bl`,`#a78bfa`,`#4c1d95`,ki()),confusion:()=>H(`cf`,`#c4b5fd`,`#4c1d95`,ni()),extract:()=>H(`ex`,`#c4b5fd`,`#4c1d95`,ri()),fog_2:()=>Dr(`${Or(32,34,6)}<ellipse cx="32" cy="24" rx="16" ry="8" fill="currentColor" opacity="0.22"/>`),crown:()=>B(`cr`,`#fbbf24`,`#451a03`,ra()),demote:()=>z(`dm`,`#fca5a5`,`#1f2937`,Hi()),fusion:()=>V(`fu`,`#8b5cf6`,`#4c1d95`,Di()),clone:()=>H(`cln`,`#93c5fd`,`#312e81`,ui()),chameleon:()=>V(`ch`,`#86efac`,`#312e81`,Oi()),hibernation:()=>V(`hi`,`#c4b5fd`,`#4c1d95`,wi()),quicksand:()=>z(`qs`,`#a8a29e`,`#292524`,Ui()),landmine:()=>B(`lm`,`#78716c`,`#292524`,aa()),collapse:()=>z(`co`,`#78716c`,`#292524`,ha()),darkness:()=>V(`dk`,`#6d28d9`,`#1e1b4b`,Si()),scatter:()=>B(`st`,`#7dd3fc`,`#1e3a5f`,la()),call_forward:()=>V(`cfw`,`#fca5a5`,`#4c1d95`,vi()),dash:()=>V(`ds`,`#c4b5fd`,`#4c1d95`,yi()),earthquake:()=>Ir(`eq`,`#78716c`,`#292524`,Kr()),coin_flip:()=>fi(),ignore:()=>z(`ig`,`#94a3b8`,`#1f2937`,Bi()),counterspell:()=>H(`cs`,`#a78bfa`,`#2e1065`,ii()),purify:()=>H(`pu`,`#6ee7b7`,`#14532d`,si()),trickster:()=>V(`tr`,`#c4b5fd`,`#553c7a`,Ai()),offering:()=>V(`of`,`#d8b4fe`,`#553c7a`,mi()),quick_march:()=>H(`qm`,`#60a5fa`,`#1e3a5f`,Qr()),constitution:()=>H(`co`,`#4ade80`,`#14532d`,di()),last_king:()=>B(`lk`,`#fbbf24`,`#1e3a5f`,ga()),revive:()=>Ir(`rv`,`#15803d`,`#052e16`,Gr()),mind_control:()=>H(`mc`,`#c4b5fd`,`#3b0764`,ti()),bounty:()=>H(`bo`,`#4ade80`,`#14532d`,ci()),link_fate:()=>H(`lf`,`#a78bfa`,`#2e1065`,li()),bishop_2:()=>V(`bp`,`#b794f4`,`#4c1d95`,gi()),rook_2:()=>V(`rk`,`#a78bfa`,`#4c1d95`,_i()),hostile_swap:()=>H(`hs`,`#93c5fd`,`#312e81`,oi()),deport:()=>H(`dp`,`#c4b5fd`,`#1e1b4b`,pi())};function ba(e,t=0){let n=ya[e.effect];return n?n(t):null}var xa={movement:{symbol:`↗`,label:`Motion`,anim:`movement`},combat:{symbol:`⚔`,label:`Strike`,anim:`combat`},defense:{symbol:`🛡`,label:`Ward`,anim:`defense`},debuff:{symbol:`❄`,label:`Curse`,anim:`debuff`},transform:{symbol:`✦`,label:`Morph`,anim:`transform`},board:{symbol:`◇`,label:`Terrain`,anim:`board`},crown:{symbol:`♔`,label:`Royal`,anim:`crown`},arcane:{symbol:`✧`,label:`Arcane`,anim:`arcane`}},Sa=[[`movement`,[`nudge`,`backstep`,`long_step`,`leapfrog`,`recall`,`teleport`,`random_teleport`,`displacement`,`berserk`,`dash`]],[`combat`,[`stab`,`shatter`,`destroy`,`snipe`,`duel`,`execution`,`cull`,`pyromancy`,`backstab`,`sacrifice`,`chain_lightning`,`cryo`,`bomb`,`magnet`]],[`special`,[`create_foe`,`clone`,`earthquake`]],[`defense`,[`shield`,`ward`,`aegis`,`bulwark`,`stall`,`sanctuary`,`barrier`,`anchor`,`iron_will`,`hibernation`,`constitution`]],[`debuff`,[`root`,`panic`,`backpedal`,`blizzard`,`deep_freeze`,`snowball`,`blind`,`confusion`,`extract`,`press`,`tangle`,`shockwave`]],[`board`,[`quicksand`,`landmine`,`collapse`,`darkness`,`earthquake`,`scatter`,`call_forward`]],[`meta`,[`counterspell`,`vengeance`,`last_stand`,`purify`,`trickster`,`ignore`,`offering`,`quick_march`,`dominion`,`last_king`,`revive`,`mind_control`]]];function Ca(e){let t=0;for(let n=0;n<e.length;n++)t=(t+e.charCodeAt(n)*41)%360;return t}function wa(e){let t=0;for(let n=0;n<e.length;n++)t=(t+e.charCodeAt(n)*13)%3;return t}function Ta(e){let t=`${e.id} ${e.effect} ${e.name}`.toLowerCase();for(let[e,n]of Sa)if(Array.isArray(n)&&n.some(e=>t.includes(e)))return e;return`arcane`}function Ea(e){return`ca${String(e).replace(/[^a-zA-Z0-9]/g,``)}`}function Da(e,t,n){let r=[[12,18,.35],[48,12,.5],[52,44,.25],[18,50,.4],[38,28,.55]],i=n*4;return r.map(([e,n,r],a)=>`<circle cx="${(e+i+a*7)%56+4}" cy="${(n+i*2+a*5)%52+6}" r="1.2" fill="hsl(${t} 90% 85% / ${r})"/>`).join(``)}function Oa(e,t){let n=t,r={movement:`
      ...
      </g>`};return r[e]||r.arcane}function ka(e,t,n,r){return Aa(e,t,n,r)}function Aa(e,t,n,r){let i=Ea(n),a=(t+42)%360,o=wa(n),s=r&&ba(r,o)||Oa(e,o);return r?.effect&&zr(r.effect)&&s?`<svg class="spell-card__svg spell-card__svg--full-bleed" viewBox="0 0 70 60" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid meet">${s}</svg>`:`<svg class="spell-card__svg" viewBox="0 0 70 60" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
  ...
  `,t.onClick&&l.addEventListener(`click`,n=>t.onClick(n,e)),Pa(l),l}function Ia(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function La(e){return document.getElementById(e)}function Ra(){let e=La(`card-preview-modal`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function za(e){document.body.classList.toggle(`card-preview-open`,e),window.dispatchEvent(new CustomEvent(`card-preview-change`,{detail:{open:e}}))}function Ba(){La(`card-preview-modal`)?.classList.add(`hidden`),La(`card-preview-mount`)?.classList.remove(`card-preview-mount--reveal-only`),za(!1)}function Va(e,t={}){Ra();let n=La(`card-preview-modal`),r=La(`card-preview-mount`),i=La(`card-preview-actions`);if(!(!n||!r||!e)){if(r.innerHTML=``,r.classList.toggle(`card-preview-mount--reveal-only`,!!t.hideDesc),r.appendChild(Fa(e,{static:!0,hideDesc:t.hideDesc})),i){if(i.innerHTML=``,t.meta){let e=document.createElement(`p`);e.className=`card-preview-meta`,e.textContent=t.meta,i.appendChild(e)}let e=document.createElement(`div`);if(e.className=`card-preview-actions-row`,t.onPlay){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=`Cast spell`,n.addEventListener(`click`,()=>{Ba(),t.onPlay()}),e.appendChild(n)}if(t.onAdd){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=`Add to deck`,n.disabled=!!t.addDisabled,n.addEventListener(`click`,()=>{t.addDisabled||t.onAdd()}),e.appendChild(n)}if(t.onBuy){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=t.buyLabel||`Buy copy`,n.disabled=!!t.buyDisabled,n.addEventListener(`click`,()=>{t.buyDisabled||t.onBuy()}),e.appendChild(n)}if(t.onRemove){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-secondary`,n.textContent=`Remove all from deck`,n.addEventListener(`click`,()=>{t.onRemove(),Ba()}),e.appendChild(n)}e.children.length&&i.appendChild(e)}n.classList.remove(`hidden`),za(!0)}}function Ha(){La(`card-preview-close`)?.addEventListener(`click`,Ba),La(`card-preview-backdrop`)?.addEventListener(`click`,Ba),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&Ba()})}function Ua(e,t=`.spell-card`){e&&e.querySelectorAll(t).forEach((e,t)=>{e.classList.add(`spell-card--deal`),e.style.animationDelay=`${t*.1}s`})}function Wa(e){e&&(e.classList.add(`spell-card--rare-burst`),setTimeout(()=>e.classList.remove(`spell-card--rare-burst`),900))}function Ga(e){e&&(e.classList.add(`spell-card--epic-burst`),setTimeout(()=>e.classList.remove(`spell-card--epic-burst`),1200))}function Ka(e){e&&(e.classList.add(`spell-card--legendary-burst`),setTimeout(()=>e.classList.remove(`spell-card--legendary-burst`),1500))}function qa(e,t){t===`legendary`?Ka(e):t===`epic`?Ga(e):t===`rare`&&Wa(e)}var Ja={common:10,uncommon:20,rare:30,epic:40,legendary:50};function Ya(e){return Ja[e]??30}function Xa(e,r){let i=oe(e,r);if(i<1)return{success:!1,message:`Get this spell from a chest first.`};let a=n(r);if(!a)return{success:!1,message:`Unknown card.`};let o=t(r);if(i>=o)return{success:!1,message:`You already own the maximum (${o} copies).`};let s=Ya(a.rarity);if(e.gems<s)return{success:!1,message:`Need ${s} gems (${e.gems} available).`};e.gems-=s;let c=ye(e,r,1);return c?{success:!0,cost:s,message:`+1 ${a.name} for ${s} gems (${i+c} owned).`}:(e.gems+=s,T(e),{success:!1,message:`You already own the maximum copies for this rarity.`})}var Za={deck:`<svg class="nav-icon-svg" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    </div>`,t.style.animationDelay=`0s`,t}function Qo(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function $o(e,t=``){let n=ee(e),r=(t||`P`).charAt(0).toUpperCase(),i=Uo(n.equipped.avatar)||`<span class="profile-avatar-fallback">${Qo(r)}</span>`;return`<span class="profile-avatar-stack header-profile-btn__stack ${qo(n.equipped.frame)}"><span class="profile-avatar-inner header-profile-btn__inner">${i}</span></span>`}async function es(e){if(!e)return``;try{return(await ke(e.id))?.username||e.user_metadata?.display_name||e.email?.split(`@`)[0]||``}catch{return e.user_metadata?.display_name||e.email?.split(`@`)[0]||``}}var ts=null;function ns(){return ts||=Promise.all([D(()=>import(`./match-Byj-IiOQ.js`),[],import.meta.url),D(()=>import(`./matchView-CnDpj-jX.js`),[],import.meta.url),D(()=>Promise.resolve({}),__vite__mapDeps([0]),import.meta.url),D(()=>Promise.resolve({}),__vite__mapDeps([1]),import.meta.url)]).then(([e,t])=>({MatchSession:e.MatchSession,getMatchHtml:t.getMatchHtml})),ts}var rs=null;function is(){return rs||=Promise.all([D(()=>import(`./pvpUI-DsAKNf3M.js`),[],import.meta.url),D(()=>import(`./pvp-CiHXJ9nc.js`),[],import.meta.url)]).then(([e,t])=>({initPvpUI:e.initPvpUI,clearAllWaitingRoomsOnce:t.clearAllWaitingRoomsOnce})),rs}var as=null;function os(){return as||=D(()=>import(`./profileUI-0bzDDdf2.js`),[],import.meta.url),as}function ss(){as=null}var cs=null;function ls(){return cs||=Promise.all([D(()=>import(`./settingsUI-CLGDpQsL.js`),[],import.meta.url),D(()=>Promise.resolve({}),__vite__mapDeps([2]),import.meta.url)]).then(([e])=>e),cs}var us=null;function ds(){return us||=Promise.all([D(()=>import(`./chestOpenAnimation-DRwrI8pJ.js`),[],import.meta.url),D(()=>import(`./cosmeticOpenAnimation-CV5nOgg1.js`),[],import.meta.url),D(()=>import(`./titleOpenAnimation-BJbfaiJp.js`),[],import.meta.url)]).then(([e,t,n])=>({playChestOpenAnimation:e.playChestOpenAnimation,playCosmeticOpenAnimation:t.playCosmeticOpenAnimation,playTitleOpenAnimation:n.playTitleOpenAnimation})),us}var fs=null;function ps(){return fs||=D(()=>import(`./tutorialMeta-BIHY4UrI.js`),[],import.meta.url),fs}var ms=null;function hs(){return ms||=D(()=>import(`./tutorialUnlocks-B9ug6qz5.js`),[],import.meta.url),ms}var gs=null;function _s(){return gs||=D(()=>import(`./tutorialMatch-D-QTTxOI.js`),[],import.meta.url),gs}function vs(e,t){ps().then(n=>n.notifyMetaTutorial(e,t))}function ys(e,t){hs().then(n=>n.notifyUnlockTutorial(e,t))}var W;try{W=E()}catch(e){console.error(`Failed to load profile, resetting save:`,e),localStorage.removeItem(`cardCheckersProfile_v7`),localStorage.removeItem(`cardCheckersProfile_v5`),W=E()}var G=`deck`,bs={deck:`Decks`,chests:`Shop`,play:`Play`,pvp:`PvP`,quests:`Quests`,profile:`Profile`,settings:`Settings`},xs=new Set(Object.keys(bs)),Ss=`cards`,Cs=`list`,K=null,q=[],ws=null,Ts=``,Es=`all`,Ds=`all`,Os=!0,ks={legendary:5,epic:4,rare:3,uncommon:2,common:1};function As(e){return[...e].sort((e,t)=>{let n=ks[e.rarity]??0,r=ks[t.rarity]??0;return n===r?e.name.localeCompare(t.name):r-n})}var J=null,js=null,Ms=null;function Ns(){return js?Promise.resolve(js):(Ms||=is().then(({initPvpUI:e,clearAllWaitingRoomsOnce:t})=>(t(),js=e({root:document.getElementById(`view-pvp`),getProfile:()=>W,openAuthModal:()=>Fs?.open(`signin`,{forced:!0}),onNavigateTab:Z,onOpenDeckEdit:Qc,onPvpViewShown:()=>{G=`pvp`,nc()}}),js)),Ms)}var Ps=null,Fs=null,Y=!1,Is=!1,Ls=!1,Rs=!1,zs=!1,Bs=null,Vs=null,Hs=null,Us=1,Ws=null;function Gs(e){return ks[e?.rarity]??0}function Ks(e){let t=i(e);return Object.entries(t).map(([e,t])=>({def:n(e),count:t})).filter(e=>e.def).sort((e,t)=>{let n=Gs(t.def)-Gs(e.def);return n===0?e.def.name.localeCompare(t.def.name):n})}function qs(e){let t=q.indexOf(e);t<0||(q.splice(t,1),nl(),vs(`card-removed-from-deck`,{cardId:e}))}function Js(e){let t=q.length;q=q.filter(t=>t!==e),q.length!==t&&(nl(),vs(`card-removed-from-deck`,{cardId:e}))}function Ys(){let n=e().map(e=>({def:e,owned:oe(W,e.id)})).filter(e=>e.owned>0).sort((e,t)=>{let n=Gs(t.def)-Gs(e.def);return n===0?e.def.name.localeCompare(t.def.name):n});q=[];for(let{def:e,owned:r}of n){let n=Math.min(r,t(e));for(let t=0;t<n&&q.length<30;t++)q.push(e.id);if(q.length>=30)break}nl()}var X=e=>document.getElementById(e);function Xs(){let e=document.getElementById(`adventure-prebattle`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function Zs(){let e=document.querySelector(`nav.game-nav.tabs`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function Qs(){return window.matchMedia(`(min-width: 1000px) and (max-width: 1400px)`).matches?2.5:window.matchMedia(`(min-width: 600px) and (max-width: 999px)`).matches?1.85:1}function $s(){Xs(),document.getElementById(`adventure-prebattle`)?.classList.remove(`hidden`),document.body.classList.add(`adventure-floor-open`)}function ec(){document.getElementById(`adventure-prebattle`)?.classList.add(`hidden`),document.body.classList.remove(`adventure-floor-open`)}function tc(e=S,t=`Locked`){Wn({title:t,bodyHtml:e,autoCloseMs:4500})}function nc(){document.body.classList.toggle(`main-tab-active`,xs.has(G)),document.body.classList.toggle(`adventure-active`,G===`play`)}function rc(e,t,n){let r=e.querySelector(`.tab-btn__sign-in-badge`);t?(r||(r=document.createElement(`span`),r.className=`tab-btn__sign-in-badge`,r.setAttribute(`aria-hidden`,`true`),e.appendChild(r)),r.textContent=n,e.classList.add(`tab-btn--sign-in-nudge`)):(r?.remove(),e.classList.remove(`tab-btn--sign-in-nudge`))}function ic(){let e=h(W),t=Qt();for(let n of[`quests`,`pvp`]){let r=document.querySelector(`.tab-btn[data-tab="${n}"]`);if(!r)continue;let i=n===`pvp`?`PvP`:`Quests`,a=!e,o=n===`pvp`?Xt:Zt;r.classList.toggle(`tab-btn--locked`,a),r.setAttribute(`aria-disabled`,a?`true`:`false`),a?(r.title=t?`${l(i)} ${o}.`:l(i),rc(r,t,`Sign in`)):t?(r.title=o,rc(r,n===`pvp`,`Sign in`)):(r.title=``,rc(r,!1))}let n=m(W),r=document.querySelector(`.vault-tab[data-vault-tab="cosmetics"]`);r&&(r.classList.toggle(`vault-tab--locked`,!n),r.title=n?``:pe,r.setAttribute(`aria-disabled`,n?`false`:`true`))}async function Z(e){let t=document.getElementById(`view-match`);if(!(Y&&t&&!t.classList.contains(`hidden`))){if(!Is&&(e===`quests`||e===`pvp`)&&!h(W)){let t=e===`pvp`?`PvP`:`Quests`,n=Qt(),r=e===`pvp`?Xt:Zt;await Qe(n?`${l(t)}\n\n${r}.`:l(t),{title:`${t} locked`,confirmLabel:`Go to Adventure`,cancelLabel:n?`Sign in`:`Not now`})?(Is=!0,Z(`play`),Is=!1):n&&Fs?.open(`signin`,{forced:!0});return}if(sr(),Qn()&&er()){if(e===G)return;if(!(e===`pvp`&&document.getElementById(`pvp-match-root`))){if(!await Qe(`Leave your current match to open ${bs[e]||e}?`,{title:`Leave match?`,confirmLabel:`Leave`,cancelLabel:`Stay`,destructive:!0}))return;tr(e),ir(),document.querySelector(`#btn-leave-match`)?.click();return}}if(Cs===`edit`&&(e!==`deck`||e===`deck`&&G===`deck`)){if(!await Xc())return;Zc()}e!==`deck`&&Cs===`edit`&&(kc(),document.body.classList.remove(`deck-editing`)),G=e,nc(),xs.has(e)&&Dc(),document.querySelectorAll(`.tab-btn`).forEach(t=>{t.classList.toggle(`active`,t.dataset.tab===e)}),document.querySelectorAll(`.view`).forEach(t=>{t.classList.toggle(`hidden`,t.id!==`view-${e}`)}),vs(`tab-changed`,{tab:e}),ys(`tab-changed`,{tab:e}),e===`chests`&&(zc(Ss),Vc()),e===`deck`&&(Cs=`list`,jc(`list`)),e===`profile`&&uc(),e===`settings`&&dc(),e===`quests`&&(mc(),gc()),e===`play`&&sl(),e===`pvp`&&Ns().then(e=>e?.render({resume:!0})).catch(e=>{console.error(`[PvP] init failed`,e);let t=document.getElementById(`view-pvp`);t&&!t.innerHTML.trim()&&(t.innerHTML=`<section class="panel game-panel pvp-panel"><p class="pvp-status pvp-status--error">Couldn't load PvP — please reload the page.</p></section>`)}),Qn()||(vo(`hub`),await Eo())}}var Q=``;function ac(e=Q){e&&(Q=e);let t=document.getElementById(`header-profile-menu`),n=document.getElementById(`header-profile-btn`),r=document.getElementById(`header-username`),i=document.getElementById(`auth-header-btn`),a=!!O();if(i&&(i.classList.toggle(`hidden`,a),i.hidden=a),t&&(t.classList.toggle(`hidden`,!a),t.hidden=!a),r){let e=a&&Q;r.textContent=e?Q:``,r.classList.toggle(`hidden`,!e),r.hidden=!e}n&&a&&(n.innerHTML=$o(W,Q),n.title=Q?`Account — ${Q}`:`Account menu`)}function oc(){let e=document.getElementById(`header-profile-btn`),t=document.getElementById(`header-profile-dropdown`);!e||!t||(t.classList.add(`hidden`),t.hidden=!0,e.setAttribute(`aria-expanded`,`false`))}function sc(){let e=document.getElementById(`header-profile-menu`),t=document.getElementById(`header-profile-btn`),n=document.getElementById(`header-profile-dropdown`);if(!e||!t||!n)return;let r=e=>{n.classList.toggle(`hidden`,!e),n.hidden=!e,t.setAttribute(`aria-expanded`,e?`true`:`false`)};t.addEventListener(`click`,e=>{e.stopPropagation();let t=!n.hidden;r(!t)}),n.querySelectorAll(`[data-profile-menu-action]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.profileMenuAction;oc(),t===`settings`?Z(`settings`):lc()})}),document.addEventListener(`click`,t=>{n.hidden||e.contains(t.target)||oc()}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&!n.hidden&&oc()})}async function cc(){let e=O();if(!e){Q=``,ac();return}Q=await es(e),ac()}function lc(){oc(),Z(`profile`),ys(`profile-opened`)}async function uc(){let{renderProfileTab:e}=await os(),t=X(`view-profile`);e(W,t,{onGemsChange:_c,onTitleChanged:()=>ac()})}async function dc(){let{renderSettingsTab:e}=await ls();e(X(`view-settings`),{onUsernameChanged:e=>{Q=e,ac(e)}})}var fc=`
  ...
  <section class="panel game-panel quests-panel quests-panel--error">
  ...
  </section>`;function mc(){let e=X(`view-quests`);e&&(e.innerHTML=fc)}function hc(e=X(`view-quests`)){e&&(e.innerHTML=pc,e.querySelector(`.quests-retry-btn`)?.addEventListener(`click`,()=>{ss(),mc(),gc()}))}async function gc(){let e=X(`view-quests`);if(e)try{let{renderQuestsTab:t}=await os();t(W,e,{onTitleChanged:()=>ac(),onCurrencyChange:()=>$()})}catch(t){console.error(`[Quests] render failed`,t),hc(e)}}function $(){let e=X(`header-gems`);e&&(e.textContent=String(W.gems??0));let t=X(`header-stars`);t&&(t.textContent=String(W.stars??0)),document.querySelector(`.hud-gems`)?.classList.toggle(`hud-gems--low`,(W.gems??0)<50),document.querySelector(`.hud-stars`)?.classList.toggle(`hud-stars--low`,(W.stars??0)<10)}function _c(){$()}function vc(){document.querySelectorAll(`.collection-owned-only-toggle`).forEach(e=>{e.checked=Os});for(let e of[`collection-search`]){let t=X(e);t&&(t.value=Ts)}for(let e of[`collection-rarity`]){let t=vr(e);t&&(t.value=Es)}let e=vr(`collection-category`);e&&(e.value=Ds)}var yc=`(max-width: 899px)`,bc=`(max-width: 1280px)`,xc=null;function Sc(){return window.matchMedia(yc).matches}function Cc(){return document.body.classList.contains(`main-tab-active`)&&!document.body.classList.contains(`match-active`)&&!document.body.classList.contains(`deck-editing`)&&window.matchMedia(bc).matches}function wc(){return document.querySelector(`.game-main`)}function Tc(){let e=wc();return Cc()&&e?e.scrollTop:window.scrollY||document.documentElement.scrollTop||0}function Ec(e){let t=wc();if(Cc()&&t){t.scrollTop=e;return}window.scrollTo(0,e)}function Dc(){let e=wc();if(Cc()&&e){e.scrollTop=0;return}window.scrollTo(0,0)}function Oc(){Sc()&&(xc=Tc(),document.body.style.position=`fixed`,document.body.style.top=`0`,document.body.style.left=`0`,document.body.style.right=`0`,document.body.style.width=`100%`)}function kc(){if(xc==null)return;let e=xc;xc=null,document.body.style.position=``,document.body.style.top=``,document.body.style.left=``,document.body.style.right=``,document.body.style.width=``,Ec(e)}function Ac(){Dc(),document.documentElement.scrollTop=0,document.body.scrollTop=0,document.querySelector(`.game-shell`)?.scrollTo?.(0,0),wc()?.scrollTo?.(0,0),document.querySelector(`#view-deck`)?.scrollTo?.(0,0),document.querySelectorAll(`#deck-subview-edit, #deck-subview-edit .deck-editor, #deck-subview-edit .deck-editor__body, #deck-subview-edit .deck-editor__grid, #deck-subview-edit .deck-editor__grid-cards`).forEach(e=>{e.scrollTop=0})}function jc(e){e!==`edit`&&kc(),Cs=e,document.body.classList.toggle(`deck-editing`,e===`edit`),X(`deck-subview-list`)?.classList.toggle(`hidden`,e!==`list`),X(`deck-subview-edit`)?.classList.toggle(`hidden`,e!==`edit`),e===`edit`&&(Oc(),w(W),T(W),Es=`all`,Ts=``,Ds=`all`,Os=!0,vc(),Jc()),e===`list`&&tl(),e===`edit`&&(nl(),Ac(),requestAnimationFrame(()=>{Ac(),requestAnimationFrame(Ac)}))}function Mc({id:e,title:t,desc:n,cost:r,variant:i=`mystery`}){let a=(W.stars??0)>=r,o=i===`title`?zt():Vt();return`
    ...
    </article>`}function Nc(e,t){e.querySelector(`[data-mystery-open]`)?.addEventListener(`click`,e=>{e.stopPropagation(),t()}),e.addEventListener(`click`,t),e.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),t())})}function Pc({bonusGems:e=0,bonusStars:t=0}={}){let n=[];return e&&n.push(`+${e} gem refund`),t&&n.push(`+${t} ★ from duplicates`),n.length?` (${n.join(`, `)})`:``}async function Fc(e,t){let{playChestOpenAnimation:n,playCosmeticOpenAnimation:r,playTitleOpenAnimation:i}=await ds();e.kind===`card`?(await n({tier:`silver`,tierLabel:`Mystery Box`,pulls:e.cardPulls}),t&&(t.textContent=`Got ${e.cardPulls.length} spells.${Pc(e)}`)):e.kind===`cosmetic`?(await r({boxId:`silver`,boxLabel:`Mystery Box`,pulls:e.cosPulls}),t&&(t.textContent=e.message+Pc(e))):e.kind===`mixed`?(e.cardPulls.length&&await n({tier:`silver`,tierLabel:`Mystery Box — Spells`,pulls:e.cardPulls}),e.cosPulls.length&&await r({boxId:`silver`,boxLabel:`Mystery Box — Cosmetics`,pulls:e.cosPulls}),t&&(t.textContent=`${e.message}${Pc(e)}`)):e.kind===`title`&&(await i({boxLabel:`Title Box`,pulls:e.pulls}),t&&(t.textContent=e.message))}async function Ic(){let e=X(`mystery-box-log`);if(!((W.stars??0)>=10)){e&&(e.textContent=`Need 10 ★ stars. Clear Adventure floors to earn stars.`,e.classList.add(`chest-log--error`));return}let t=qt(W);if(!t.success){e&&(e.textContent=t.message,e.classList.add(`chest-log--error`));return}T(W),$(),e&&e.classList.remove(`chest-log--error`),X(`mystery-box-list`)?.querySelectorAll(`.mystery-box__btn`).forEach(e=>{e.disabled=!0});try{await Fc(t,e)}catch(n){console.error(`Mystery box animation failed:`,n),e&&(e.textContent=t.message)}Vc({clearPulls:!1}),uc()}async function Lc(){let e=X(`mystery-box-log`);if(!((W.stars??0)>=10)){e&&(e.textContent=`Need 10 ★ stars. Clear Adventure floors to earn stars.`,e.classList.add(`chest-log--error`));return}let t=Jt(W);if(!t.success){e&&(e.textContent=t.message,e.classList.add(`chest-log--error`));return}T(W),$(),e&&e.classList.remove(`chest-log--error`),X(`mystery-box-list`)?.querySelectorAll(`.mystery-box__btn`).forEach(e=>{e.disabled=!0});try{await Fc(t,e)}catch(n){console.error(`Title box animation failed:`,n),e&&(e.textContent=t.message)}Vc({clearPulls:!1}),uc()}function Rc(){let e=X(`mystery-box-list`);if(!e)return;e.innerHTML=`
    ${Mc({id:`mystery`,title:`Mystery Box`,desc:`6 random pulls — mix of spells and cosmetics (${Math.round(Ht*100)}% cosmetic per slot when unlocked).`,cost:10})}
    ${Mc({id:`title`,title:`Title Box`,desc:`Box-exclusive mage titles only — The Brave, Ruthless, Omnipotent, and more.`,cost:10,variant:`title`})}
  `;let t=e.querySelectorAll(`.mystery-box`);Nc(t[0],()=>Ic()),Nc(t[1],()=>Lc())}function zc(e){if(!Ls&&e===`cosmetics`&&!m(W)){tc(pe,`Cosmetics locked`),Ls=!0,zc(`cards`),Ls=!1;return}Ss=e,document.querySelectorAll(`.vault-tab`).forEach(t=>{let n=t.dataset.vaultTab===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,n?`true`:`false`)}),document.querySelectorAll(`.vault-tab-panel`).forEach(t=>{let n=t.id===`vault-tab-${e}`;t.classList.toggle(`hidden`,!n),t.hidden=!n}),ys(`vault-tab-changed`,{tab:e})}function Bc(){os().then(({renderCosmeticBoxes:e})=>{e(W,X(`cosmetic-box-list`),{logEl:X(`cosmetic-box-log`),onGemsChange:_c,cosmeticsUnlocked:m(W),onOpened:()=>{G===`profile`&&uc(),G===`quests`&&gc()}})})}function Vc(e={}){let{clearPulls:t=!0}=e;$(),Bc(),Rc();let n=X(`chest-list`),r=X(`chest-pulls`);if(r&&t&&(r.innerHTML=``,r.classList.add(`chest-pulls--hidden`),r.classList.remove(`chest-pulls--reveal`)),n){n.innerHTML=``;for(let e of ct){let t=gt[e.id]||gt.bronze,i=W.gems>=e.cost,a=document.createElement(`article`);a.className=`chest-card chest-card--${e.id}${i?``:` chest-card--locked`}`,a.innerHTML=`
    ...
    `;let o=a.querySelector(`.chest-open`);o.disabled=!i,o.addEventListener(`click`,async()=>{if(o.disabled)return;let n=pt(W,e.id),i=X(`chest-log`);if(!n.success){i&&(i.textContent=n.message,i.classList.add(`chest-log--error`));return}T(W),$(),o.disabled=!0;let{playChestOpenAnimation:a}=await ds();if(await a({tier:e.id,tierLabel:t.label,pulls:n.pulls}),vs(`chest-opened`,{chestId:e.id}),i){let t=n.bonusGems?` (+${n.bonusGems} gems from duplicates)`:``;i.textContent=`Got ${n.pulls.length} spells from ${e.name}.${t}`,i.classList.remove(`chest-log--error`)}if(r){r.classList.remove(`chest-pulls--hidden`),r.classList.add(`chest-pulls--reveal`),r.innerHTML=`<p class="chest-pulls__label">Chest opened</p><div class="chest-pulls__grid"></div>`;let e=r.querySelector(`.chest-pulls__grid`);n.pulls.forEach((t,n)=>{let r=Fa(t,{button:!0,deal:!0,gallery:!0,onClick:()=>Va(t)});if(r.style.animationDelay=`${n*.12}s`,t.duplicate){r.classList.add(`spell-card--duplicate-pull`);let e=document.createElement(`span`);e.className=`chest-pull-dup-badge`,e.textContent=t.starRefund?`Duplicate · +${t.starRefund} ★`:`Duplicate · +${t.gemRefund} ◆`,r.appendChild(e)}e.appendChild(r),qa(r,t.rarity)}),Ua(e),r.scrollIntoView({behavior:`smooth`,block:`nearest`})}Vc()}),n.appendChild(a)}}}function Hc(){return As(e().filter(e=>{if(Ds!==`all`&&st(e)!==Ds||Es!==`all`&&e.rarity!==Es)return!1;if(Ts){let t=Ts.toLowerCase();if(!e.name.toLowerCase().includes(t)&&!e.desc.toLowerCase().includes(t))return!1}return!(Os&&oe(W,e.id)<=0)}))}function Uc(e,t){let n=Xa(W,e);return t&&(t.textContent=n.message,t.className=n.success?`deck-status ok`:`deck-status warn`),n.success&&(T(W),$(),Cs===`list`&&tl(),Cs===`edit`&&nl()),n}function Wc(e,t){let n=Xa(W,e);return n.success?(T(W),$(),q.push(e),ge(W,e),T(W),nl(),t&&(t.hidden=!1,t.textContent=`Bought and added to deck.`,t.className=`deck-editor__error deck-status ok`),!0):(t&&(t.hidden=!1,t.textContent=n.message,t.className=`deck-editor__error deck-status warn`),!1)}function Gc(e){return a(q,e,W).ok?(q.push(e),ge(W,e),T(W),nl(),vs(`card-added-to-deck`,{cardId:e}),!0):!1}function Kc(e,n,r={}){let{deckEdit:o=!1,statusEl:s=null}=r,c=oe(W,n.id),l=t(n),u=c>=l,d=Ya(n.rarity),f=W.gems>=d&&!u,p=o?a(q,n.id,W):{ok:!1},m=o&&i(q)[n.id]||0,h=q.length<30,g=m<l,ee=c>=1&&c<=m,_=c>=1&&!u,v=o&&!p.ok&&h&&g&&ee&&_,y=()=>Uc(n.id,s),b=()=>{let e=oe(W,n.id),t=o&&i(q)[n.id]||0,r=e>=l,s=W.gems>=d&&!r,c=o?a(q,n.id,W):{ok:!1};Va(n,{meta:o?`Owned ${e}/${l} · In deck ${t}/${l} · ${r?`max copies`:`${d} gems per copy`}`:`Owned ${e}/${l}${r?` · max copies`:` · ${d} gems per copy`}`,buyLabel:r?`Max copies owned`:`Buy copy (${d} gems)`,buyDisabled:!s||r||e<1,onBuy:()=>{y(),Ba()},addDisabled:!c.ok,onAdd:o?()=>{Gc(n.id)&&b()}:void 0})};if(o){let t=document.createElement(`div`);t.className=`deck-editor-tile`+(x(W,n.id)?` deck-editor-tile--new`:``);let r=Fa(n,{button:!0,gallery:!0,onClick:()=>b()});r.classList.add(`deck-editor-tile__card`),r.title=`${n.name} — tap for full card`;let i=c>0?`Owned ${c}/${l}`:`Not in collection`,a=document.createElement(`div`);a.className=`deck-editor-tile__meta`,a.innerHTML=`${i} · In deck ${m}/${l}${x(W,n.id)?`<span class="deck-editor-tile__new">New</span>`:``}`,a.addEventListener(`click`,()=>b());let o=document.createElement(`button`);o.type=`button`,o.className=`deck-editor-tile__action`,p.ok?(o.classList.add(`deck-editor-tile__action--add`),o.textContent=`+ Add to deck`,o.addEventListener(`click`,e=>{e.stopPropagation(),Gc(n.id)})):v?(o.classList.add(`deck-editor-tile__action--buy`),o.textContent=f?`Add for ${d} gems`:`Need ${d} gems`,o.disabled=!f,o.addEventListener(`click`,e=>{e.stopPropagation(),Wc(n.id,s)})):(o.classList.add(`deck-editor-tile__action--disabled`),o.disabled=!0,q.length>=30?o.textContent=`Deck full (30/30)`:m>=l?o.textContent=`Max copies in deck`:c<1?o.textContent=`Open Shop chests to unlock`:p.reason?o.textContent=p.reason:o.textContent=`Can't add`),t.append(r,a,o),e.appendChild(t);return}let S=document.createElement(`div`);S.className=`collection-card-wrap`+(c<1?` collection-card-wrap--unowned`:``);let C=Fa(n,{button:!0,compact:!0,disabled:c<1||u,onClick:e=>{if(e.shiftKey||c<1||u){b();return}y()}});C.title=u?`${n.name} — max ${l} copies owned. Tap to view full card.`:c<1?`${n.name} — not owned. Tap to view full card.`:`${n.name} — tap to buy (${d} gems). Shift+click to inspect.`,S.appendChild(C);let te=document.createElement(`span`);te.className=`collection-owned-count`,te.textContent=c>0?`×${c}`:`—`,S.appendChild(te);let w=document.createElement(`span`);w.className=`collection-buy-cost`,w.textContent=u?`MAX`:`${d} ◆`,(!f||u)&&w.classList.add(`collection-buy-cost--cant`),S.appendChild(w),e.appendChild(S)}function qc(e,t={}){if(!e)return;let{deckEdit:n=!1,statusEl:r=null}=t;e.innerHTML=``;let i=Hc();if(!i.length){e.className=`deck-editor__grid collection-grid`;let t=document.createElement(`p`);t.className=`collection-grid-empty muted`,t.textContent=n?`No spells match your filters. Try “All types”, clear search, or uncheck Owned only.`:`No cards match your filters. Open chests in the Shop to get more spells.`,e.appendChild(t);return}let a=0,o={deckEdit:n,statusEl:r};if(n||Ds!==`all`){e.className=`deck-editor__grid collection-grid`;for(let t of i)try{Kc(e,t,o),a+=1}catch(e){console.error(`Failed to render card:`,t?.id,e)}}else{e.className=`deck-editor__grid collection-categories`;let t=Object.fromEntries(it.map(e=>[e,[]]));for(let e of i)t[st(e)].push(e);for(let n of it){let r=t[n];if(!r.length)continue;let i=document.createElement(`section`);i.className=`collection-category-section`,i.dataset.category=n;let s=document.createElement(`h3`);s.className=`collection-category-title`,s.textContent=at[n],i.appendChild(s);let c=document.createElement(`div`);c.className=`collection-grid deck-editor__grid-cards`;for(let e of r)try{Kc(c,e,o),a+=1}catch(t){console.error(`Failed to render card:`,e?.id,t)}i.appendChild(c),e.appendChild(i)}}if(i.length>0&&a===0){e.className=`deck-editor__grid collection-grid`;let t=document.createElement(`p`);t.className=`collection-grid-empty collection-grid-empty--error`,t.textContent=`Spells failed to display. Hard refresh the page (Ctrl+Shift+R).`,e.appendChild(t)}}function Jc(){ws={name:X(`deck-name-input`)?.value?.trim()??``,cardIds:[...q]}}function Yc(){return ws?(X(`deck-name-input`)?.value?.trim()??``)!==ws.name||q.length!==ws.cardIds.length?!0:q.some((e,t)=>e!==ws.cardIds[t]):!1}async function Xc(){return Yc()?Qe(`Discard unsaved changes to this deck?`,{title:`Unsaved changes`,confirmLabel:`Discard`,cancelLabel:`Keep editing`,destructive:!0}):!0}function Zc(){K=null,q=[],ws=null}function Qc(e){let t=W.decks.find(t=>t.id===e);if(!t)return;K=t.id,q=[...t.cardIds];let n=X(`deck-name-input`);n&&(n.value=t.name),jc(`edit`),vs(`deck-edit-opened`,{deckId:e})}function $c(e){let t=Object.fromEntries(it.map(e=>[e,0]));for(let r of e){let e=n(r);e&&(t[st(e)]+=1)}return t}function el(e){let t=$c(e),n=[];for(let e of it){let r=t[e];if(r<=0)continue;let i=at[e];n.push(`<span class="deck-row__cat" title="${Ia(i)}: ${r}"><span class="deck-row__cat-dot deck-row__cat-dot--${e}" aria-hidden="true"></span><span class="deck-row__cat-n">${r}</span></span>`)}return n.length?`<div class="deck-row__cats">${n.join(``)}</div>`:``}function tl(){w(W)&&T(W),$();let e=X(`deck-list`);if(!e)return;e.innerHTML=``;let t=X(`deck-list-count`);if(t){let e=W.decks.length;t.textContent=e?`${e} deck${e===1?``:`s`}`:``}if(!W.decks.length){if(w(W)&&T(W),W.decks.length){tl();return}e.innerHTML=`
  ...
  </svg>`}function ll(e=`#e8c547`){return`<svg class="adventure-map-tile__pawn-svg" viewBox="0 0 28 36" aria-hidden="true">
    <defs>
  ...
  </svg>`}function ul(e){let t=ve[e]||ve.verdant;return`<svg class="adventure-map-tile__banner-svg" viewBox="0 0 24 20" aria-hidden="true">
    <defs>
    ...
    <div class="adventure-map-canvas__bg" aria-hidden="true">
      <div class="adventure-map-scenery adventure-map-scenery--${i}" aria-hidden="true">${cl(i)}</div>
    ...
    <div class="adventure-map-tower">
      ...
      <span class="adventure-map-tile__stone" aria-hidden="true">
        ...
        ${a>0?`<span class="adventure-floor-row__stars">${be(a)}</span>`:``}`,o.addEventListener(`click`,()=>xl(t.id)),g.appendChild(o)}}let ee=r.querySelector(`.adventure-map-tile--next`);dl(r),ee&&requestAnimationFrame(()=>{requestAnimationFrame(()=>ee.scrollIntoView({behavior:`smooth`,block:`nearest`}))});let _=g?.querySelector(`.adventure-floor-row--next`);_&&requestAnimationFrame(()=>_.scrollIntoView({behavior:`smooth`,block:`end`})),r.querySelector(`.adventure-challenge-toggle`)?.addEventListener(`click`,t=>{t.preventDefault(),t.stopPropagation(),e.challengeMode=!e.challengeMode,W.adventure=e,T(W),Io(),So.tap(),pl()})}function ml(e){let t=he(e);if(!t||!Se(W.adventure,e))return;Hs=e,$s();let n=X(`prebattle-title`),i=X(`prebattle-flavor`),a=X(`prebattle-opponent`);n&&(n.textContent=`Tower ${t.worldId} · Floor ${t.floorInWorld}`),i&&(i.textContent=t.flavor||``),a&&(a.textContent=`Loading…`);try{Ws=_(W,e),T(W)}catch(e){console.error(`Enemy deck failed`,e),a&&(a.textContent=`Could not build enemy deck. Try again.`);return}a&&(a.textContent=`Review the enemy spell deck, then choose your grimoire below.`);let o=X(`prebattle-gem-hint`);if(o){let n=te(W.adventure,e);o.textContent=(s(W.adventure,e)?`Repeat clear: +${n} gems`:`First clear: +${n} gems`)+(t.worldId===5&&b(W.adventure)?` · Challenge mode: enemy has an extra rank of pieces`:``)}let c=X(`enemy-deck-preview`);if(c){c.innerHTML=``;try{for(let{def:e,count:t}of ne(Ws)){if(!e)continue;let n=document.createElement(`button`);n.type=`button`,n.className=`enemy-deck-spell-btn`,n.title=`View ${e.name}`;let r=document.createElement(`span`);if(r.className=`enemy-deck-spell-btn__name`,r.textContent=e.name,n.appendChild(r),t>1){let e=document.createElement(`span`);e.className=`enemy-deck-spell-btn__count`,e.textContent=`×${t}`,n.appendChild(e)}n.addEventListener(`click`,()=>Va(e,{meta:t>1?`${t} copies in enemy deck`:`Enemy deck`})),c.appendChild(n)}}catch(e){console.error(`Enemy preview failed`,e),c.innerHTML=`<p class="empty-msg">Enemy deck preview unavailable.</p>`}}w(W)&&T(W);let l=vr(`adventure-deck-select`);if(!l){a&&(a.textContent=`Deck selector missing — hard refresh the page.`);return}l.innerHTML=``;let u=W.decks.filter(e=>r(e.cardIds,W).valid);if(!u.length){let e=document.createElement(`option`);e.value=``,e.textContent=`No complete decks — build one in Decks`,l.appendChild(e),l.disabled=!0,X(`btn-start-adventure`).disabled=!0;return}l.disabled=!1;let d=W.selectedDeckId&&u.some(e=>e.id===W.selectedDeckId)?W.selectedDeckId:u[0].id;for(let e of u){let t=document.createElement(`option`);t.value=e.id,t.textContent=e.name,e.id===d&&(t.selected=!0),l.appendChild(t)}W.selectedDeckId=d,X(`btn-start-adventure`).disabled=!1}async function hl(e,t,n,r,i=null,a=!1,o=void 0){let s=t.opponent;ol(),Ws=null,document.querySelectorAll(`.view`).forEach(e=>e.classList.add(`hidden`)),X(`view-match`)?.classList.remove(`hidden`);let l=X(`view-match`);if(!l)return;let{MatchSession:u,getMatchHtml:d}=await ns();l.innerHTML=d(s);let p=o??(xe(r).id===5&&b(W.adventure)),m={levelId:r,deckId:e.id,challengeMode:p},h={aiDeckIds:n,opponentName:s,cosmetics:ee(W),profile:W,challengeMode:p,buildGameOverActions:({won:e,isTie:t})=>_l(m,{won:e,isTie:t}),onGameOverAction:e=>{vl(e,m,l)}};i&&(h.initialState=i);try{J=new u(e.cardIds,l,()=>{J=null,dr(),Eo(),vo(`hub`),l.innerHTML=``,X(`view-match`)?.classList.add(`hidden`),Z(nr()||`play`),Rs&&Cl(),zs&&wl()},e=>{let t=f(W,r,e),{gems:n,stars:i,starsGained:a}=t;return W.gems+=n,y(W,`adventure_floors`,1),c(W),T(W),$(),ic(),r===1&&t.firstTime&&(Rs=!0,Cl()),r===5&&t.firstTime&&(zs=!0),{message:`+${n} gems! · Best: ${be(i)}`,starsGained:a}},h)}catch(e){throw J=null,l.innerHTML=``,X(`view-match`)?.classList.add(`hidden`),Z(`play`),e}lr({kind:`adventure`,deckId:e.id,deckCardIds:e.cardIds,aiDeckIds:n,opponentName:s,levelId:r,challengeMode:p}),await Eo(),vo(`match`),a&&(J.winRewarded=!0),fr(J),J.setMessage(``),J.render()}async function gl(){let e=pr();if(!e)return!1;let t=W.decks.find(t=>t.id===e.deckId)||W.decks.find(e=>e.cardIds?.length===30),n=e.levelId?he(e.levelId):null;return!t||t.cardIds.length!==30||!n||!e.aiDeckIds?.length||!await Qe(`Resume your adventure match where you left off?`,{title:`Resume match?`,confirmLabel:`Resume`,cancelLabel:`Discard`})?(ur(),!1):(Hs=e.levelId,await hl(t,n,e.aiDeckIds,e.levelId,e.state,e.winRewarded,e.challengeMode),J?.setMessage(`Match resumed — pick up where you left off.`),!0)}function _l({levelId:e},{won:t,isTie:n}){let r=e+1,i=t&&r<=50&&Se(W.adventure,r);if(n)return[{id:`backToAdventure`,label:`Back to Adventure`,primary:!0}];if(t){let e=[];return i?(e.push({id:`nextFloor`,label:`Next floor`,primary:!0}),e.push({id:`retry`,label:`Retry floor`}),e.push({id:`backToAdventure`,label:`Back to Adventure`})):(e.push({id:`backToAdventure`,label:`Back to Adventure`,primary:!0}),e.push({id:`retry`,label:`Retry floor`})),e}return[{id:`retry`,label:`Retry floor`,primary:!0},{id:`backToAdventure`,label:`Back to Adventure`}]}async function vl(e,{levelId:t,deckId:n,challengeMode:r},i){let a=W.decks.find(e=>e.id===n);if(e===`backToAdventure`){J?.onExit?.();return}if(e===`nextFloor`){let e=t+1;if(!he(e)||!Se(W.adventure,e)){J?.onExit?.();return}J?.dispose(),J=null,dr({clearCheckpoint:!0}),Eo(),vo(`hub`),i&&(i.innerHTML=``),X(`view-match`)?.classList.add(`hidden`),await Z(`play`),ml(e);return}if(e===`retry`){let e=t,n=he(e);if(!a||a.cardIds.length!==30||!n){J?.onExit?.();return}J?.dispose(),J=null,dr(),await hl(a,n,_(W,e),e,null,!1,r)}}function yl(){let e=vr(`adventure-deck-select`)?.value,t=W.decks.find(t=>t.id===e),n=Hs,r=n?he(n):null,i=Ws?[...Ws]:null;if(!t||t.cardIds.length!==30||!r||!i?.length){let e=X(`prebattle-opponent`);e&&(!t||t.cardIds.length!==30?e.textContent=`Build a complete 30-card deck in the Decks tab, then try again.`:e.textContent=`Could not start battle — close and pick the floor again.`);return}hl(t,r,i,n)}function bl(){if(window.__adventureMapCaptureBound)return;window.__adventureMapCaptureBound=!0;let e=null,t=!1,n=0,r=e=>e.closest?.(`#adventure-map .adventure-map-tile, #adventure-map .adventure-map-pin`),i=e=>e?.closest?.(`.adventure-map-scene`),a=()=>{t=!0,clearTimeout(n),n=setTimeout(()=>{t=!1},280)},o=(e,t)=>{if(!e||e.disabled)return;let n=Number(e.dataset.level);!Number.isFinite(n)||n<1||(t.preventDefault(),t.stopPropagation(),xl(n))};document.addEventListener(`pointerdown`,t=>{if(t.button!==0)return;let n=r(t.target);if(!n||n.disabled)return;let a=i(n);e={pin:n,pointerId:t.pointerId,startX:t.clientX,startY:t.clientY,scrollTop:a?.scrollTop??0,scrollLeft:a?.scrollLeft??0,cancelled:!1}},!0),document.addEventListener(`pointermove`,t=>{if(!e||t.pointerId!==e.pointerId||e.cancelled)return;let n=t.clientX-e.startX,r=t.clientY-e.startY;Math.hypot(n,r)>12&&(e.cancelled=!0);let a=i(e.pin);a&&(Math.abs(a.scrollTop-e.scrollTop)>3&&(e.cancelled=!0),Math.abs(a.scrollLeft-e.scrollLeft)>3&&(e.cancelled=!0))},!0),document.addEventListener(`pointerup`,t=>{if(!e||t.pointerId!==e.pointerId)return;let{pin:n,cancelled:r}=e;if(e=null,r){a();return}o(n,t),a()},!0),document.addEventListener(`pointercancel`,t=>{!e||t.pointerId!==e.pointerId||(e=null,a())},!0),document.addEventListener(`click`,e=>{if(t){e.preventDefault(),e.stopPropagation();return}let n=r(e.target);!n||n.disabled||o(n,e)},!0)}function xl(e){let t=ce(W.adventure);if(W.adventure=t,!Se(t,e)){tc(`Locked — beat global floor ${e-1} first, then return here.`,`Floor locked`);return}T(W),ml(e)}function Sl(){Zs(),window.addEventListener(`orientationchange`,Zs),window.addEventListener(`resize`,Zs),nc(),io(),Qa(),jo(),bo(),Do(),Mo(),Ha(),bl(),Xs(),document.querySelector(`.adventure-map-scene`)?.addEventListener(`scroll`,fl,{passive:!0});let e;window.addEventListener(`resize`,()=>{clearTimeout(e),e=setTimeout(()=>{if(!document.body.classList.contains(`adventure-active`))return;let e=X(`adventure-map`);e&&dl(e)},120)}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&ol()}),document.querySelectorAll(`.tab-btn`).forEach(e=>{e.addEventListener(`click`,()=>{Io(),So.tap(),Z(e.dataset.tab)})}),document.querySelectorAll(`.vault-tab`).forEach(e=>{e.addEventListener(`click`,()=>{sr(),zc(e.dataset.vaultTab)})}),X(`btn-new-deck`)?.addEventListener(`click`,al),X(`btn-back-from-edit`)?.addEventListener(`click`,async()=>{await Xc()&&(Zc(),jc(`list`))}),X(`btn-delete-deck`)?.addEventListener(`click`,async()=>{if(!K||K===`new`)return;let e=W.decks.find(e=>e.id===K);e&&await Qe(`Delete "${e.name}"? This cannot be undone.`,{title:`Delete deck?`,confirmLabel:`Delete`,cancelLabel:`Keep`,destructive:!0})&&(fe(W,e.id),Zc(),jc(`list`))});let t=()=>{Cs===`edit`&&nl(),Cs===`list`&&tl()};document.querySelectorAll(`.collection-owned-only-toggle`).forEach(e=>{e.addEventListener(`change`,e=>{Os=e.target.checked,vc(),t()})}),document.querySelectorAll(`.btn-reset-collection-filters`).forEach(e=>{e.addEventListener(`click`,()=>{Es=`all`,Ts=``,Ds=`all`,Os=!0,vc(),t()})}),vc(),yr(),X(`collection-search`)?.addEventListener(`input`,e=>{Ts=e.target.value,t()}),vr(`collection-category`)?.addEventListener(`change`,e=>{Ds=e.target.value,t()}),vr(`collection-rarity`)?.addEventListener(`change`,e=>{Es=e.target.value,t()}),X(`btn-clear-deck`)?.addEventListener(`click`,()=>{q=[],nl()}),X(`btn-auto-finish-deck`)?.addEventListener(`click`,Ys),X(`btn-save-deck`)?.addEventListener(`click`,rl),X(`btn-back-adventure`)?.addEventListener(`click`,ol),X(`adventure-floor-backdrop`)?.addEventListener(`click`,ol),X(`btn-start-adventure`)?.addEventListener(`click`,yl),vr(`adventure-deck-select`)?.addEventListener(`change`,e=>{W.selectedDeckId=e.target.value,T(W)});let n=document.getElementById(`auth-modal`),r=document.getElementById(`auth-header-btn`);sc(),Kn(`adventure-help-btn`,`adventure-help-desc`),Kn(`shop-help-btn`,`shop-help-desc`),Kn(`deck-help-btn`,`deck-help-desc`),Ps=pn({onSignIn:()=>Fs?.open(`signin`,{forced:!0}),onSignUp:()=>Fs?.open(`signup`,{forced:!0}),onGuest:()=>{en(),Al()}}),Fs=dn({authBtn:r,modal:n,onNewAccount:()=>{W=_e()?me():E(),En(W,T)},onSignedIn:()=>{tn(),W=E(),w(W),Tn(W),$(),tl(),Rc(),Ps?.hide(),cc().then(()=>{G===`profile`&&uc(),G===`quests`&&gc(),G===`pvp`&&Ns().then(e=>e?.render({resume:!0}))}),Ns().then(e=>e?.render({resume:!0})),Ol(),kl(),Dl(),El(),Y||Z(G)},onSignedOut:()=>{tn(),oc(),Q=``,ac(),js?.dispose?.(),J=null,dr({clearCheckpoint:!0}),sr(),W=me(),ic(),$(),tl(),Rc(),Ps?.show(),Z(`deck`)}}),mr(()=>J),w(W),vc(),ic(),jl()}function Cl(){if(!Rs||Bs!=null)return;let e=0,t=()=>{if(Bs=null,e+=1,Rs){if(er()){e<10&&(Bs=window.setTimeout(t,400));return}if(Tn(W),Dl()){Rs=!1;return}e<10&&(Bs=window.setTimeout(t,500))}};Bs=window.setTimeout(t,350)}function wl(){if(!zs||Vs!=null)return;let e=0,t=()=>{if(Vs=null,e+=1,zs){if(er()){e<10&&(Vs=window.setTimeout(t,400));return}if(Tn(W),El()){zs=!1;return}e<10&&(Vs=window.setTimeout(t,500))}};Vs=window.setTimeout(t,350)}function Tl(){return Y||!fn()||!h(W)||!Pn(W)?!1:(Y=!0,hs().then(({startPvpTutorial:e})=>{e({profile:W,saveProfile:T,onComplete:()=>{Y=!1,W=E(),w(W),ic(),Z(`play`),El()}})}),!0)}function El(){return Y||!fn()||!m(W)||kn(W)||An(W)||Nn(W)||Pn(W)||!In(W)?!1:(Y=!0,Z(`play`),hs().then(({startCosmeticsTutorial:e})=>{e({profile:W,saveProfile:T,onComplete:()=>{Y=!1,W=E(),w(W),ic(),Z(`play`)}})}),!0)}function Dl(){return Y||!fn()||!h(W)?!1:(Tn(W),Nn(W)?(Y=!0,Z(`play`),hs().then(({startQuestsTutorial:e})=>{e({profile:W,saveProfile:T,onComplete:()=>{Y=!1,W=E(),w(W),ic(),Tl(),El()}})}),!0):Tl())}function Ol(){return Y||!fn()||!kn(W)?!1:(Y=!0,_s().then(({startInteractiveTutorial:e})=>{e({profile:W,saveProfile:T,onComplete:()=>{Y=!1,W=E(),w(W),$(),tl(),Rc(),kl()||Z(`deck`),Dl(),El()}})}),!0)}function kl(){return Y||!fn()||!An(W)?!1:(Y=!0,Z(`deck`),ps().then(({startMetaTutorial:e})=>{e({profile:W,saveProfile:T,onComplete:()=>{Y=!1,W=E(),w(W),$(),tl(),Rc(),Z(`deck`),Dl(),El()}})}),!0)}async function Al(){Ps?.hide(),!Ol()&&(kl()||Dl()||El()||Y||(await gl()||await Z(`deck`),sr(),vo(`hub`)))}async function jl(){try{if(await Ie()){try{let e=await cn();e&&(W=e)}catch(e){console.warn(`Cloud sync on load failed`,e)}w(W),$(),tl(),Rc()}}catch(e){console.warn(`Auth init failed`,e)}if(Tn(W),await cc(),js&&js.render(),sr(),mn()){Ps?.show();return}await Al()}Sl(),D(async()=>{let{registerSW:e}=await import(`./virtual_pwa-register-CpSsV7JG.js`);return{registerSW:e}},[],import.meta.url).then(({registerSW:e})=>{e({immediate:!0})}),$e(),rt();export{sr as A,Xt as B,ur as C,lr as D,nr as E,On as F,Qe as G,gt as H,Mn as I,Ke as K,jn as L,Kn as M,Fn as N,dr as O,Dn as P,Ln as R,_r as S,ar as T,St as U,Rt as V,ht as W,qa as _,Vo as a,Fa as b,qo as c,Zo as d,Eo as f,ro as g,U as h,Go as i,fr as j,er as k,Uo as l,vo as m,es as n,Ho as o,yo as p,Lo as r,Ko as s,$o as t,Yo as u,Ua as v,rr as w,Sr as x,Va as y,nn as z};