...
import{n as e,o as t,t as n}from"./cardCatalog-1bq4jvsX.js";import{d as r,i,r as a}from"./deckRules-ZM8f8fig.js";import{A as o,At as s,Ct as c,D as l,Dt as u,Et as d,G as f,H as p,Ot as m,P as h,St as g,Tt as _,_t as v,a as y,bt as ee,c as b,ct as x,d as S,dt as C,f as w,ft as te,g as ne,gt as re,ht as ie,i as ae,j as oe,kt as se,l as ce,lt as le,m as T,mt as ue,o as de,ot as fe,p as pe,pt as me,r as he,s as ge,st as _e,t as ve,u as ye,ut as be,vt as xe,wt as Se,xt as Ce,yt as we,z as Te}from"./storage-0_6T3ywz.js";import{l as Ee,p as De,r as Oe}from"./mageTitles-BPvsmJqw.js";import{t as E}from"./preload-helper-CV77j2BA.js";import{S as ke,a as Ae,c as je,d as Me,g as Ne,h as Pe,l as Fe,o as D,p as Ie,s as Le,t as Re,v as ze,x as Be}from"./auth-BCcJRer8.js";var Ve=Object.defineProperty,He=(e,t)=>{let n={};for(var r in e)Ve(n,r,{get:e[r],enumerable:!0});return t||Ve(n,Symbol.toStringTag,{value:`Module`}),n};function Ue(){let e=window.visualViewport;return e?Math.max(0,Math.round(e.offsetTop)):0}function We(){let e=window.visualViewport;return e?Math.max(0,Math.round(window.innerHeight-e.offsetTop-e.height)):0}function Ge(){let e=document.documentElement,t=()=>{e.style.setProperty(`--viewport-inset-top`,`${Ue()}px`),e.style.setProperty(`--viewport-inset-bottom`,`${We()}px`)};t(),window.visualViewport?.addEventListener(`resize`,t),window.visualViewport?.addEventListener(`scroll`,t),window.addEventListener(`resize`,t),window.addEventListener(`orientationchange`,t)}Ge();var Ke=1100,qe=120;function Je(){let e=document.getElementById(`app-splash`);if(!e||e.classList.contains(`app-splash--hide`))return;e.classList.add(`app-splash--hide`),document.body.classList.remove(`splash-active`);let t=()=>{e.remove()};e.addEventListener(`transitionend`,t,{once:!0}),window.setTimeout(t,600)}function Ye(){Je()}function Xe(){let e=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches?qe:Ke,t=performance.now(),n=()=>{let n=performance.now()-t,r=Math.max(0,e-n);window.setTimeout(Je,r)};document.readyState===`interactive`||document.readyState===`complete`?n():document.addEventListener(`DOMContentLoaded`,n,{once:!0})}document.body.classList.add(`splash-active`),Xe();var Ze=`(max-width: 768px)`,Qe=null;function $e(){return document.getElementById(`mobile-confirm`)}function et(e){let t=$e();if(!t)return;t.classList.add(`hidden`),document.body.classList.remove(`mobile-confirm-open`);let n=Qe;Qe=null,n?.(e)}function tt(e,t={}){if(!window.matchMedia(Ze).matches)return Promise.resolve(window.confirm(e));let n=$e();if(!n)return Promise.resolve(window.confirm(e));let{title:r=`Confirm`,confirmLabel:i=`OK`,cancelLabel:a=`Cancel`,destructive:o=!1}=t;return new Promise(t=>{Qe&&et(!1),Qe=t,n.querySelector(`#mobile-confirm-title`).textContent=r,n.querySelector(`#mobile-confirm-body`).textContent=e;let s=n.querySelector(`#mobile-confirm-ok`),c=n.querySelector(`#mobile-confirm-cancel`);s.textContent=i,c.textContent=a,s.classList.toggle(`btn-danger`,o),s.classList.toggle(`btn-primary`,!o),n.classList.remove(`hidden`),document.body.classList.add(`mobile-confirm-open`),c.focus()})}function nt(){let e=$e();!e||e.dataset.bound||(e.dataset.bound=`1`,e.querySelector(`#mobile-confirm-ok`)?.addEventListener(`click`,()=>et(!0)),e.querySelector(`#mobile-confirm-cancel`)?.addEventListener(`click`,()=>et(!1)),e.querySelector(`[data-mobile-confirm-backdrop]`)?.addEventListener(`click`,()=>et(!1)))}var rt=`cc_install_banner_dismissed`;function it(){return window.matchMedia(`(display-mode: standalone)`).matches||window.navigator.standalone===!0}function at(){let e=window.navigator.userAgent;return/iphone|ipad|ipod/i.test(e)&&!/crios|fxios/i.test(e)}function ot(){if(it()||localStorage.getItem(rt)===`1`)return;let e=document.getElementById(`install-banner`);if(!e)return;let t=null,n=()=>{e.classList.remove(`hidden`),document.body.classList.add(`install-banner-visible`)},r=()=>{e.classList.add(`hidden`),document.body.classList.remove(`install-banner-visible`)};window.addEventListener(`beforeinstallprompt`,r=>{r.preventDefault(),t=r,e.querySelector(`#install-banner-ios-hint`)?.classList.add(`hidden`),e.querySelector(`.install-banner__hint--default`)?.classList.remove(`hidden`),e.querySelector(`#install-banner-btn`)?.classList.remove(`hidden`),n()}),at()&&(e.querySelector(`#install-banner-ios-hint`)?.classList.remove(`hidden`),e.querySelector(`.install-banner__hint--default`)?.classList.add(`hidden`),e.querySelector(`#install-banner-btn`)?.classList.add(`hidden`),window.setTimeout(n,2500)),e.querySelector(`#install-banner-btn`)?.addEventListener(`click`,async()=>{t&&(t.prompt(),await t.userChoice,t=null,r())}),e.querySelector(`#install-banner-dismiss`)?.addEventListener(`click`,()=>{localStorage.setItem(rt,`1`),r()})}var st=[`attack`,`control`,`defense`,`movement`,`trap`,`special`],ct={attack:`Attack`,control:`Control`,defense:`Defense`,movement:`Movement`,trap:`Trap`,special:`Special`},lt={aegis:`defense`,anchor:`defense`,backpedal:`control`,backstab:`attack`,backstep:`movement`,barrier:`defense`,bishops_mark:`movement`,blind:`control`,blizzard:`control`,snowball:`control`,berserk:`movement`,bomb:`attack`,shockwave:`control`,plague:`control`,bulwark:`defense`,create_foe:`special`,call_forward:`movement`,chain_lightning:`attack`,clone:`special`,coin_flip:`attack`,collapse:`special`,confusion:`control`,conjure:`special`,constitution:`defense`,counterspell:`trap`,crown:`special`,cryo_bolt:`attack`,cull:`attack`,darkness:`defense`,dash:`movement`,deep_freeze:`control`,deflect:`trap`,demote:`control`,deport:`movement`,displacement:`movement`,dominion:`special`,duel:`attack`,earthquake:`special`,execution:`attack`,extract:`control`,pyromancy:`attack`,fusion:`special`,hibernation:`special`,hostile_swap:`movement`,ignore:`special`,iron_will:`defense`,landmine:`trap`,last_king:`special`,bounty:`special`,link_fate:`special`,last_stand:`trap`,martyr:`trap`,leapfrog:`movement`,long_step:`movement`,magnet:`movement`,nudge:`movement`,offering:`special`,panic:`control`,poison:`attack`,mind_control:`special`,mulligan:`special`,zombify:`special`,press:`control`,purify:`special`,defuse:`special`,quick_march:`movement`,quicksand:`trap`,rally:`defense`,recall:`movement`,repel:`movement`,random_teleport:`movement`,retreat:`movement`,revive:`defense`,rooks_mark:`movement`,root:`control`,sacrifice:`attack`,sanctuary:`defense`,scatter:`movement`,shadow_swap:`movement`,sidestep:`movement`,shatter:`attack`,snipe:`attack`,snowball:`control`,stab:`attack`,stall:`defense`,tangle:`control`,teleport:`movement`,trickster:`special`,toll:`special`,vengeance:`trap`,ward:`defense`};function ut(e){let t=lt[e?.id];if(t)return t;let n=`${e?.id||``} ${e?.effect||``} ${e?.name||``} ${e?.desc||``}`.toLowerCase();return/trap|mine|quicksand|counterspell|vengeance|last.?stand|martyr/.test(n)?`trap`:/shield|ward|aegis|sanctuary|barrier|anchor|deflect|stall|iron_will|rally|darkness/.test(n)?`defense`:/move|nudge|teleport|recall|leap|step|displace|swap|scatter|retreat|bishop|rook|overrun|promote|pull|push|shift|earthquake|magnet|repel/.test(n)?`movement`:/freeze|blind|confusion|hex|root|panic|press|silence|paraly|control|cannot play|random|mark|poison|die in \d+ turn/.test(n)?`control`:/\bdestroy\b|\bkills?\b|fireball|bolt|stab|snipe|duel|sacrifice|execution|shatter|cull|lightning/.test(n)?`attack`:`special`}var dt=[{id:`bronze`,name:`Bronze Chest`,cost:25,cards:3,weights:{common:70,uncommon:25,rare:5,epic:0}},{id:`silver`,name:`Silver Chest`,cost:50,cards:5,weights:{common:50,uncommon:35,rare:12,epic:3}},{id:`gold`,name:`Gold Chest`,cost:100,cards:8,weights:{common:32,uncommon:38,rare:22,epic:6,legendary:2}}];function ft(e){let t=Math.random()*100,n=0;for(let r of[`common`,`uncommon`,`rare`,`epic`,`legendary`])if(n+=e[r]||0,t<=n)return r;return`common`}function pt(t){let n=e().filter(e=>e.rarity===t);return n.length?n[Math.floor(Math.random()*n.length)]:e()[0]}function mt(e,t){return pt(ft(t.weights))}function ht(e,n,r={}){let{starRefundChance:i=0}=r;if(ae(e,n.id)<t(n))return ve(e,n.id,1),{...n,duplicate:!1};let a=Te[n.rarity]||10;if(i>0&&Math.random()<i){let e=Math.random()<.5?1:2;return{...n,duplicate:!0,starRefund:e}}return{...n,duplicate:!0,gemRefund:a}}function gt(e,t){let n=dt.find(e=>e.id===t);if(!n)return{success:!1,message:`Unknown chest.`};if(e.gems<n.cost)return{success:!1,message:`Not enough gems.`};e.gems-=n.cost;let r=[],i=0;for(let t=0;t<n.cards;t++){let t=ht(e,mt(e,n));r.push(t),t.gemRefund&&(i+=t.gemRefund)}return i&&(e.gems+=i),fe(e,`boxes_opened`,1),T(e),{success:!0,pulls:r,chest:n,bonusGems:i}}var _t=[`common`,`uncommon`,`rare`,`epic`,`legendary`];function vt(e,{minPct:t=1}={}){return _t.filter(n=>(e[n]??0)>=t).map(t=>`${e[t]}% ${t}`).join(` · `)}var yt={bronze:{label:`Bronze`,tagline:`Mostly common cards`,accent:`#cd7f32`,glow:`rgba(205, 127, 50, 0.45)`},silver:{label:`Silver`,tagline:`Balanced card mix`,accent:`#a8b8d8`,glow:`rgba(168, 184, 216, 0.5)`},gold:{label:`Gold`,tagline:`Higher rare & epic odds`,accent:`#e8c547`,glow:`rgba(232, 197, 71, 0.55)`}};function bt(e){let t=yt[e]||yt.bronze;return{t,lid:e===`gold`?`#f5e6a8`:e===`silver`?`#e8eef8`:`#d4954a`,body:e===`gold`?`#7a5c12`:e===`silver`?`#4a5568`:`#5c3a1e`,trim:e===`gold`?`#ffe566`:e===`silver`?`#c8d8f0`:t.accent}}function xt(e,t){let{lid:n,body:r,trim:i}=bt(e);return`
  ...
  </svg>`}function Wt(){return Pt()}var Gt=.5,Kt=.1,qt=[{id:`bronze`,name:`Bronze Chest`,cards:3,weights:{common:70,uncommon:25,rare:5,epic:0}},{id:`silver`,name:`Silver Chest`,cards:5,weights:{common:50,uncommon:35,rare:12,epic:3}},{id:`gold`,name:`Gold Chest`,cards:8,weights:{common:32,uncommon:38,rare:22,epic:6,legendary:2}}],Jt=[{id:`bronze`,name:`Bronze Cosmetic Box`,pulls:3,weights:{common:70,uncommon:25,rare:5,epic:0}},{id:`silver`,name:`Silver Cosmetic Box`,pulls:5,weights:{common:50,uncommon:35,rare:12,epic:3}},{id:`gold`,name:`Gold Cosmetic Box`,pulls:8,weights:{common:32,uncommon:38,rare:22,epic:6,legendary:2}}];function Yt(e,{premium:t=!1}={}){let n=Math.random()*100;return t?n>50?e[2]:n>15?e[1]:e[0]:n>70?e[2]:n>35?e[1]:e[0]}function Xt(e){if((e.stars??0)<10)return{success:!1,message:`Not enough stars.`};e.stars=(e.stars??0)-10;let t=c(e),n=[],r=[],i=0,a=0;for(let o=0;o<6;o++)if(t&&Math.random()<.5){let t=p(e,Yt(Jt).weights);t&&(r.push(t),t.duplicate&&(i+=t.gemRefund||10))}else{let t=ht(e,mt(e,Yt(qt)),{starRefundChance:Kt});n.push(t),t.gemRefund&&(i+=t.gemRefund),t.starRefund&&(a+=t.starRefund)}return i&&(e.gems=(e.gems||0)+i),a&&(e.stars=(e.stars??0)+a),fe(e,`boxes_opened`,1),T(e),{success:!0,kind:n.length&&r.length?`mixed`:n.length?`card`:`cosmetic`,cardPulls:n,cosPulls:r,bonusGems:i,bonusStars:a,message:`Got ${n.length} spells and ${r.length} cosmetics`}}function Zt(e){if((e.stars??0)<10)return{success:!1,message:`Not enough stars.`};e.stars=(e.stars??0)-10;let t=Oe.filter(t=>!Ee(e,t.id)),n,r=0;if(t.length){let r=t[Math.floor(Math.random()*t.length)];De(e,r.id),n={...r,duplicate:!1}}else{let t=Oe[Math.floor(Math.random()*Oe.length)];r=3,e.stars=(e.stars??0)+r,n={...t,duplicate:!0,starRefund:r}}return fe(e,`boxes_opened`,1),T(e),{success:!0,kind:`title`,pulls:[n],bonusStars:r,message:n.duplicate?`Duplicate ${n.name} — +${r} ★ refunded`:`Unlocked title: ${n.name}`}}var Qt=`arcane_checkers_guest_mode_v1`,$t=`Sign in to save progress / play PvP`,en=`Sign in to save progress`;function tn(){return nn()&&!D()}function nn(){try{return localStorage.getItem(Qt)===`1`}catch{return!1}}function rn(){try{localStorage.setItem(Qt,`1`)}catch{}}function an(){try{localStorage.removeItem(Qt)}catch{}}var on=He({flushCloudSave:()=>mn,isEmptyRemoteProfile:()=>cn,profileJsonForSignupUpsert:()=>dn,pullCloudProfile:()=>fn,scheduleCloudSave:()=>pn}),sn=null;function cn(e){if(!e||typeof e!=`object`)return!0;let t=Object.keys(e);if(t.length===0||t.every(e=>e===`loginEmail`||e===`login_email`||e===`savedAt`))return!0;let n=e.collection&&Object.keys(e.collection).length>0,r=Array.isArray(e.decks)&&e.decks.length>0,i=e.adventure?.cleared,a=(Array.isArray(i)?i.length:Object.keys(i||{}).length)>0,o=typeof e.gems==`number`||typeof e.stars==`number`,s=typeof e.pvpWins==`number`&&e.pvpWins>0||typeof e.spellsPlayed==`number`&&e.spellsPlayed>0;return!(n||r||a||o||s)}function ln(e){return w(e),T(e,{bumpTimestamp:!1}),e}function un(e,t){let n=ge();return!(n!==e&&n!==null||nn()&&t&&!cn(t))}function dn(e,t,{wasGuest:n=!1}={}){let r=String(t||``).trim().toLowerCase(),i=e&&typeof e==`object`?{...e}:{};if(n){let e=S();if(!ce(e)&&cn(i)){let t={...e,loginEmail:r};return w(t),typeof t.savedAt!=`number`&&(t.savedAt=Date.now()),t}}return i.loginEmail=r,i}async function fn(){let e=D();if(!e||!je())return null;let t=await Ae(e.id),n=S(),r=t?.profile_json,i=un(e.id,r);if(!r||typeof r!=`object`||cn(r)){if(!ce(n)&&i){if(ln(n),nn())try{await mn(S())}catch(e){console.warn(`Guest progress cloud claim failed`,e)}}else if(!ce(n)&&!i)return ln(pe());return S()}if(ce(n)||!i){let e={...r};return i&&o(e,n),oe(e),ln(e)}return(r.savedAt||0)>=(n.savedAt||0)?ln(h(n,r)):(o(n,r),T(n),n)}function pn(e){!D()||!je()||(clearTimeout(sn),sn=setTimeout(async()=>{try{await mn(e)}catch(e){console.warn(`Cloud save failed`,e)}},800))}async function mn(e){let t=D();return!t||!je()||!e?null:(clearTimeout(sn),sn=null,ze(t.id,{profile_json:e,display_name:t.user_metadata?.display_name||t.email?.split(`@`)[0]}))}var hn=Re;function gn({authBtn:e,modal:t,onSignedIn:n,onSignedOut:r,onNewAccount:i}){if(!e||!t)return;let a=t.querySelector(`#auth-form`),o=t.querySelector(`#auth-modal-title`),s=t.querySelector(`#auth-toggle-mode`),c=t.querySelector(`#auth-error`),l=t.querySelector(`#auth-username-hint`),u=t.querySelector(`#auth-close`),d=t.querySelector(`.auth-modal-backdrop`),f=a?.querySelector(`button[type="submit"]`),p=`signin`,m=null,h=!1,g=!1;function _(){a?.querySelectorAll(`.auth-field-signup`).forEach(e=>{e.classList.toggle(`hidden`,p!==`signup`)});let e=a?.querySelector(`#auth-identifier`),t=a?.querySelector(`label[for="auth-identifier"]`);t&&(t.textContent=p===`signup`?`Email`:`Username or email`),e&&(e.placeholder=p===`signup`?`you@email.com`:`username or email`,e.type=p===`signup`?`email`:`text`,e.autocomplete=p===`signup`?`email`:`username`),f&&(f.textContent=p===`signup`?`Create account`:`Sign in`),l&&(l.textContent=``),l?.classList.remove(`auth-username-hint--ok`,`auth-username-hint--bad`)}function v(e){c&&(c.textContent=e||``)}function y(e,t=``){l&&(l.textContent=e||``,l.classList.remove(`auth-username-hint--ok`,`auth-username-hint--bad`),t===`ok`&&l.classList.add(`auth-username-hint--ok`),t===`bad`&&l.classList.add(`auth-username-hint--bad`))}async function ee(){if(p!==`signup`)return;let e=a?.querySelector(`#auth-username`)?.value?.trim();if(!e){y(``);return}if(!hn.test(e)){y(`3–24 letters, numbers, or underscore`,`bad`);return}if(y(`Checking…`),!await Fe(e)){let t=await Ne(e);y(t?`Taken — try "${t}"`:`That username is taken`,`bad`),t&&l&&(l.dataset.suggestion=t);return}l&&delete l.dataset.suggestion,y(`Available`,`ok`)}function b(e,n={}){if(h=!!n.forced,!je()){v(`Add Supabase anon key in js/supabaseConfig.js`),t.classList.remove(`hidden`),u?.classList.toggle(`hidden`,h);return}p=e||p,o&&(o.textContent=p===`signup`?`Create account`:`Sign in`),s&&(s.textContent=p===`signup`?`Already have an account? Sign in`:`Need an account? Sign up`),v(``),_(),u?.classList.toggle(`hidden`,h),d?.classList.toggle(`auth-modal-backdrop--locked`,h),t.classList.remove(`hidden`)}function x(){h||(t.classList.add(`hidden`),v(``),y(``))}function S(t){if(e){if(!je()){e.textContent=`Setup cloud`,e.title=`Configure Supabase`,e.classList.remove(`hidden`),e.hidden=!1;return}t?(e.classList.add(`hidden`),e.hidden=!0):(e.textContent=`Sign in`,e.title=`Sign in or sign up`,e.classList.remove(`hidden`),e.hidden=!1)}}e.addEventListener(`click`,()=>{D()||b(`signin`)}),s?.addEventListener(`click`,e=>{e.preventDefault(),p=p===`signup`?`signin`:`signup`,b(p)}),u?.addEventListener(`click`,x),d?.addEventListener(`click`,()=>{h||x()});let C=a?.querySelector(`#auth-username`);C?.addEventListener(`input`,()=>{clearTimeout(m),m=setTimeout(()=>{ee().catch(()=>y(``))},350)}),l?.addEventListener(`click`,()=>{let e=l?.dataset?.suggestion;!e||!C||(C.value=e,delete l.dataset.suggestion,ee().catch(()=>{}))}),a?.addEventListener(`submit`,async e=>{e.preventDefault(),v(``);let t=a.querySelector(`#auth-identifier`)?.value?.trim(),r=a.querySelector(`#auth-username`)?.value?.trim(),o=a.querySelector(`#auth-password`)?.value;if(!t||!o){v(p===`signup`?`Email and password required.`:`Username or email and password required.`);return}f&&(f.disabled=!0),g=!0;try{if(p===`signup`){if(!t.includes(`@`)){v(`Use your email address to sign up.`);return}if(!r||!hn.test(r)){v(`Choose a username (3–24 letters, numbers, underscore).`);return}let e=r;if(!await Fe(e)){let t=await Ne(e);if(t){v(`"${e}" is taken. Try "${t}" or tap the hint below.`),y(`Tap to use "${t}"`,`bad`),l&&(l.dataset.suggestion=t);return}v(`Username "${e}" is already taken. Pick another.`);return}let a=nn();i?.();let s=(await Pe(t,o,e,e)).session?.user??D();if(s){let r=dn((await Ae(s.id))?.profile_json,t,{wasGuest:a});try{await ze(s.id,{username:e,display_name:e,profile_json:r})}catch(t){if((t?.code||t?.details?.code)===`23505`){let t=await Ne(e);v(t?`Account created but "${e}" was taken. Sign in and change your name to "${t}", or try sign up again with that username.`:`Account created but that username was just taken. Sign in with your email and pick another name in Profile.`),p=`signin`,b(`signin`);return}throw t}try{await fn()}catch(e){console.warn(`Profile sync after signup failed`,e)}n?.(),h=!1,u?.classList.remove(`hidden`),d?.classList.remove(`auth-modal-backdrop--locked`),x();return}v(`Account created. Check your email to confirm, then sign in.`),p=`signin`,b(`signin`);return}await Ie(t,o);let e=D();if(!e){v(`Sign-in failed — no session returned. Try again or confirm your email.`);return}try{await fn()}catch(e){console.warn(`Profile sync after sign-in failed`,e)}n?.(),h=!1,u?.classList.remove(`hidden`),d?.classList.remove(`auth-modal-backdrop--locked`),S(e),x()}catch(e){let t=e?.message||`Authentication failed`;if(t.includes(`Database error saving new user`)||t.includes(`username_taken`)||e?.code===`23505`){let e=r&&hn.test(r)?await Ne(r):null;t=e?`Sign-up failed (username conflict). Try "${e}" instead.`:`Sign-up failed on the server. Try a different username, or sign in if you already have an account.`}else t.includes(`over_email_send_rate_limit`)||t.includes(`rate limit`)?t=`Too many sign-up attempts. Wait a few minutes or sign in with an existing account.`:t.includes(`User already registered`)&&(t=`That email is already registered. Try Sign in instead.`);t.includes(`Invalid login credentials`)?v(`Wrong email/username or password.`):t.includes(`Email not confirmed`)?v(`Confirm your email first (check inbox), or disable email confirmation in Supabase for testing.`):v(t)}finally{g=!1,f&&(f.disabled=!1)}});let w=!1;return Me(async e=>{if(S(e),e){if(w=!0,g)return;try{await fn()}catch(e){console.warn(`Profile sync failed`,e)}n?.(),h=!1,u?.classList.remove(`hidden`),d?.classList.remove(`auth-modal-backdrop--locked`),x()}else w&&(w=!1,r?.())}),Le().then(S),{open:b,close:x}}function _n(){return!!D()||nn()}function vn({onSignIn:e,onSignUp:t,onGuest:n}){let r=document.getElementById(`auth-gate`);if(!r)return{show:()=>{},hide:()=>{},sync:()=>{}};let i=r.querySelector(`#auth-gate-signin`),a=r.querySelector(`#auth-gate-signup`),o=r.querySelector(`#auth-gate-guest`),s=r.querySelector(`#auth-gate-notice`);i?.addEventListener(`click`,()=>e?.()),a?.addEventListener(`click`,()=>t?.()),o?.addEventListener(`click`,()=>n?.());function c(){je()?s&&(s.textContent=`Create an account to sync decks, stars, and collection — or continue as guest to play Adventure on this device.`):s&&(s.textContent=`Cloud sign-in is not configured. Add your Supabase keys in js/supabaseConfig.js.`),r.classList.remove(`hidden`),document.body.classList.add(`auth-gate-active`)}function l(){r.classList.add(`hidden`),document.body.classList.remove(`auth-gate-active`)}function u(){_n()?l():c()}return{show:c,hide:l,sync:u}}function yn(){return je()&&!_n()}var bn=`arcane_checkers_tutorial_v1`,xn=`arcane_checkers_interactive_tutorial_v1`,Sn=`arcane_checkers_meta_tutorial_v1`,Cn=`arcane_checkers_quests_tutorial_v1`,wn=`arcane_checkers_pvp_tutorial_v1`,Tn=`arcane_checkers_cosmetics_tutorial_v1`,En=`arcane_checkers_pending_signup_tutorial_v1`;function Dn(){try{sessionStorage.setItem(En,`1`)}catch{}}function On(){try{sessionStorage.removeItem(En)}catch{}}function kn(){try{return sessionStorage.getItem(En)===`1`}catch{return!1}}function An(e){if(!e)return;let t=[[xn,e.interactiveTutorialDone||e.tutorialDone],[Sn,e.metaTutorialDone||e.tutorialDone],[Cn,e.questsTutorialDone],[wn,e.pvpTutorialDone],[Tn,e.cosmeticsTutorialDone]];try{for(let[e,n]of t)n?localStorage.setItem(e,`done`):localStorage.getItem(e)===`done`&&localStorage.removeItem(e)}catch{}}function jn(e,t){Dn();try{localStorage.removeItem(xn),localStorage.removeItem(Sn),localStorage.removeItem(Cn),localStorage.removeItem(wn),localStorage.removeItem(Tn),localStorage.removeItem(bn)}catch{}e&&(delete e.interactiveTutorialDone,delete e.metaTutorialDone,delete e.questsTutorialDone,delete e.pvpTutorialDone,delete e.cosmeticsTutorialDone,delete e.tutorialDone,t?.(e))}function Mn(e={}){if(On(),e.persist){try{localStorage.setItem(xn,`done`)}catch{}e.profile&&(e.profile.interactiveTutorialDone=!0),e.saveProfile?.(e.profile)}}function Nn(e={}){if(e.persist){try{localStorage.setItem(Sn,`done`),localStorage.setItem(bn,`done`)}catch{}e.profile&&(e.profile.metaTutorialDone=!0,e.profile.tutorialDone=!0),e.saveProfile?.(e.profile)}}function Pn(e){if(kn())return!0;if(e?.interactiveTutorialDone||e?.tutorialDone)return!1;try{return localStorage.getItem(xn)!==`done`}catch{return!0}}function Fn(e){if(e?.metaTutorialDone||e?.tutorialDone)return!1;if(!e?.interactiveTutorialDone)try{if(localStorage.getItem(xn)!==`done`)return!1}catch{return!1}try{return localStorage.getItem(Sn)!==`done`}catch{return!0}}function In(e={}){if(e.persist){try{localStorage.setItem(Cn,`done`)}catch{}e.profile&&(e.profile.questsTutorialDone=!0),e.saveProfile?.(e.profile)}}function Ln(e={}){if(e.persist){try{localStorage.setItem(wn,`done`)}catch{}e.profile&&(e.profile.pvpTutorialDone=!0),e.saveProfile?.(e.profile)}}function Rn(e){if(e?.questsTutorialDone)return!1;try{return localStorage.getItem(Cn)!==`done`}catch{return!0}}function zn(e){if(e?.pvpTutorialDone)return!1;if(!e?.questsTutorialDone)try{if(localStorage.getItem(Cn)!==`done`)return!1}catch{return!1}try{return localStorage.getItem(wn)!==`done`}catch{return!0}}function Bn(e={}){if(e.persist){try{localStorage.setItem(Tn,`done`)}catch{}e.profile&&(e.profile.cosmeticsTutorialDone=!0),e.saveProfile?.(e.profile)}}function Vn(e){if(e?.cosmeticsTutorialDone)return!1;try{return localStorage.getItem(Tn)!==`done`}catch{return!0}}function Hn(e){return e instanceof Element?!!e.closest(`#mobile-confirm, #tutorial-meta-overlay, #tutorial-match-overlay, .card-preview-modal`):!1}var Un=new WeakSet,Wn=!1,Gn=null,Kn=null;function qn(){return document.getElementById(`panel-help-popup`)}function Jn(){let e=qn();!e||e.classList.contains(`hidden`)||(e.classList.add(`hidden`),document.body.classList.remove(`panel-help-open`),Gn&&=(Gn.setAttribute(`aria-expanded`,`false`),Gn.classList.remove(`panel-help-btn--active`),null),Kn&&=(clearTimeout(Kn),null))}function Yn({title:e,bodyHtml:t,triggerBtn:n=null,autoCloseMs:r=0}){let i=qn();if(!i)return;Jn();let a=i.querySelector(`#panel-help-popup-title`),o=i.querySelector(`#panel-help-popup-body`);a&&(a.textContent=e||`Help`),o&&(o.innerHTML=t||``),i.classList.remove(`hidden`),document.body.classList.add(`panel-help-open`),n&&(Gn=n,n.setAttribute(`aria-expanded`,`true`),n.classList.add(`panel-help-btn--active`)),r>0&&(Kn=setTimeout(Jn,r)),i.querySelector(`.panel-help-popup__dismiss`)?.focus()}function Xn(){if(Wn)return;Wn=!0;let e=qn();e&&(e.querySelectorAll(`[data-panel-help-close]`).forEach(e=>{e.addEventListener(`click`,Jn)}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&Jn()}))}function Zn(e,t){let n=typeof e==`string`?document.getElementById(e):e,r=typeof t==`string`?document.getElementById(t):t;!n||!r||Un.has(n)||(Un.add(n),Xn(),n.addEventListener(`click`,e=>{e.stopPropagation();let t=qn();if(t&&!t.classList.contains(`hidden`)&&Gn===n){Jn();return}Yn({title:n.getAttribute(`aria-label`)||`Help`,bodyHtml:r.innerHTML,triggerBtn:n})}))}var Qn=`cc_match_checkpoint`,$n=1440*60*1e3,er=null,tr=!1,nr=null;function rr(){return document.body.classList.contains(`match-active`)}function ir(e){if(!e||!(e instanceof Element)||e.closest(`.hidden`))return!1;let t=getComputedStyle(e);return!(t.display===`none`||t.visibility===`hidden`)}function ar(){let e=document.getElementById(`view-match`);if(e&&!e.classList.contains(`hidden`)&&e.querySelector(`.pvp-loading`))return!0;let t=document.querySelector(`#btn-leave-match`);if(!t)return!1;if(ir(t))return!0;if(!rr())return!1;let n=document.getElementById(`play-arena-root`);return!!(e?.contains(t)||n?.contains(t))}function or(e){er=e}function sr(){let e=er;return er=null,e}function cr(){er=null}function lr(){tr=!0}function ur(){let e=tr;return tr=!1,e}function dr(){let e=document.getElementById(`view-match`);if(e&&!e.classList.contains(`hidden`)&&e.innerHTML.trim()){if(e.querySelector(`.pvp-loading`))return;ir(e.querySelector(`#btn-leave-match`))||(e.innerHTML=``,e.classList.add(`hidden`))}else e?.classList.contains(`hidden`)&&e.innerHTML.trim()&&(e.innerHTML=``);let t=document.getElementById(`play-arena-root`);t&&t.querySelector(`#pvp-match-root`)?.remove()}function fr(){return!rr()||ar()?!1:(dr(),gr({clearCheckpoint:!1}),window.dispatchEvent(new CustomEvent(`cc-match-shell-reconciled`)),!0)}function pr(e){document.querySelector(`.game-shell`)?.classList.toggle(`game-shell--in-match`,e)}function mr(e){nr=e,document.body.classList.add(`match-active`),pr(!0)}function hr(){try{sessionStorage.removeItem(Qn)}catch{}}function gr(e={}){nr=null,document.body.classList.remove(`match-active`),pr(!1),e.clearCheckpoint&&hr()}function _r(e){if(!(!nr||!e?.state||nr.kind!==`adventure`||e.state.gameOver))try{sessionStorage.setItem(Qn,JSON.stringify({...nr,state:e.state,winRewarded:!!e.winRewarded,savedAt:Date.now()}))}catch{}}function vr(){try{let e=sessionStorage.getItem(Qn);if(!e)return null;let t=JSON.parse(e);return!t?.state||t.state.gameOver||t.kind!==`adventure`||t.savedAt&&Date.now()-t.savedAt>$n?(hr(),null):t}catch{return hr(),null}}function yr(e){if(window.__ccMatchVisibilityBound)return;window.__ccMatchVisibilityBound=!0;let t=()=>{let t=e();t&&_r(t)};document.addEventListener(`visibilitychange`,()=>{let n=e();document.hidden?(t(),n?.pauseForBackground?.()):n?.resumeFromBackground?.()}),window.addEventListener(`pagehide`,t)}var br=new Set;function xr(e){for(let t of br)t!==e&&t.close()}function Sr(e){if(!e||e.dataset.customSelectEnhanced)return e?._customSelectApi??null;e.dataset.customSelectEnhanced=`1`;let t=document.createElement(`div`);t.className=`custom-select`;let n=document.createElement(`button`);n.type=`button`,n.className=`custom-select__trigger select-input`,n.setAttribute(`aria-haspopup`,`listbox`),n.setAttribute(`aria-expanded`,`false`);let r=document.createElement(`span`);r.className=`custom-select__chevron`,r.setAttribute(`aria-hidden`,`true`),r.textContent=`▾`;let i=document.createElement(`span`);i.className=`custom-select__label`;let a=document.createElement(`div`);a.className=`custom-select__list hidden`,a.setAttribute(`role`,`listbox`);let o=e.id;o&&(n.id=o,e.removeAttribute(`id`));let s=e.getAttribute(`aria-label`)?null:document.querySelector(`label[for="${o}"]`)?.id;s?n.setAttribute(`aria-labelledby`,s):e.getAttribute(`aria-label`)&&n.setAttribute(`aria-label`,e.getAttribute(`aria-label`)),e.classList.add(`custom-select__native`),e.tabIndex=-1,e.setAttribute(`aria-hidden`,`true`),e.parentNode.insertBefore(t,e),t.appendChild(e),t.appendChild(n),n.appendChild(i),n.appendChild(r),t.appendChild(a);let c=!1,l=-1;function u(){return[...e.options]}function d(){return e.options[e.selectedIndex]??null}function f(){let r=d();i.textContent=r?.textContent?.trim()||`Select…`,n.disabled=e.disabled,t.classList.toggle(`custom-select--disabled`,e.disabled),a.querySelectorAll(`.custom-select__option`).forEach(t=>{let n=t.dataset.value===e.value;t.classList.toggle(`custom-select__option--selected`,n),t.setAttribute(`aria-selected`,n?`true`:`false`)})}function p(t){let n=Object.getOwnPropertyDescriptor(HTMLSelectElement.prototype,t);!n?.set||!n?.get||Object.defineProperty(e,t,{configurable:!0,enumerable:n.enumerable,get(){return n.get.call(this)},set(e){n.set.call(this,e),f()}})}p(`value`),p(`selectedIndex`),p(`disabled`);function m(t){e.disabled||(e.value=t.value,e.dispatchEvent(new Event(`change`,{bubbles:!0})),f(),y())}function h(){a.innerHTML=``;for(let e of u()){let t=document.createElement(`button`);t.type=`button`,t.className=`custom-select__option`,t.setAttribute(`role`,`option`),t.dataset.value=e.value,t.textContent=e.textContent?.trim()||e.value,t.addEventListener(`click`,t=>{t.stopPropagation(),m(e)}),a.appendChild(t)}f()}function g(e){let t=[...a.querySelectorAll(`.custom-select__option`)];t.length&&(l=Math.max(0,Math.min(e,t.length-1)),t.forEach((e,t)=>{e.classList.toggle(`custom-select__option--active`,t===l)}),t[l]?.scrollIntoView({block:`nearest`}))}function _(){a.classList.remove(`custom-select__list--above`);let e=n.getBoundingClientRect(),t=Math.min(256,window.innerHeight*.5),r=window.innerHeight-e.bottom,i=e.top;r<t*.65&&i>r&&a.classList.add(`custom-select__list--above`)}function v(){c||e.disabled||(xr(b),c=!0,br.add(b),a.classList.remove(`hidden`),t.classList.add(`custom-select--open`),n.setAttribute(`aria-expanded`,`true`),_(),g(Math.max(0,e.selectedIndex)),document.addEventListener(`click`,x),document.addEventListener(`keydown`,S))}function y(){c&&(c=!1,br.delete(b),a.classList.add(`hidden`),t.classList.remove(`custom-select--open`),n.setAttribute(`aria-expanded`,`false`),l=-1,a.querySelectorAll(`.custom-select__option--active`).forEach(e=>{e.classList.remove(`custom-select__option--active`)}),document.removeEventListener(`click`,x),document.removeEventListener(`keydown`,S))}function ee(){return c}let b={close:y,rebuild:h,isOpen:ee};e._customSelectApi=b,n.addEventListener(`click`,t=>{t.stopPropagation(),!e.disabled&&(c?y():v())}),n.addEventListener(`keydown`,t=>{e.disabled||((t.key===`ArrowDown`||t.key===`ArrowUp`||t.key===`Enter`||t.key===` `)&&(t.preventDefault(),c||v(),t.key===`ArrowDown`&&g(l+1),t.key===`ArrowUp`&&g(l<=0?0:l-1),(t.key===`Enter`||t.key===` `)&&l>=0&&[...a.querySelectorAll(`.custom-select__option`)][l]?.click()),t.key===`Escape`&&y())});let x=e=>{if(!t.isConnected){y();return}t.contains(e.target)||y()},S=e=>{e.key===`Escape`&&y()},C=new MutationObserver(()=>{h()});C.observe(e,{childList:!0,subtree:!0,attributes:!0,attributeFilter:[`disabled`,`value`,`selected`]}),e.addEventListener(`change`,f);let w=e.remove.bind(e);return e.remove=function(){y(),C.disconnect(),w(),t.isConnected&&t.remove()},h(),b}function Cr(e){if(!e)return null;let t=typeof e==`string`?document.getElementById(e):e;return t?t.tagName===`SELECT`?t:t.closest(`.custom-select`)?.querySelector(`select.custom-select__native`)??null:null}function wr(e=document){e.querySelectorAll(`select.select-input:not([data-custom-select-enhanced]):not([data-no-custom-select])`).forEach(e=>{Sr(e)})}var Tr=`online-players`,Er=null,Dr=new Set,Or=new Set;function kr(){let e=new Set(Dr);for(let t of Or)t(e)}function Ar(e){let t=new Set;for(let n of Object.values(e||{}))for(let e of n){let n=e?.user_id;typeof n==`string`&&n.length>0&&t.add(n)}Dr=t,kr()}function jr(e){return!!e&&Dr.has(e)}function Mr(e){return Or.add(e),e(new Set(Dr)),()=>Or.delete(e)}function Nr(){Pr();let e=D(),t=Be();if(!e||!t||!ke())return;Er=t.channel(Tr,{config:{presence:{key:e.id}}});let n=()=>Ar(Er?.presenceState());Er.on(`presence`,{event:`sync`},n).on(`presence`,{event:`join`},n).on(`presence`,{event:`leave`},n).subscribe(async t=>{if(t===`SUBSCRIBED`)try{await Er.track({user_id:e.id})}catch(e){console.warn(`Friend presence track failed`,e)}})}function Pr(){let e=Be();Er&&=(e?.removeChannel(Er),null),Dr=new Set,kr()}var Fr={nudge:[`Move your piece 1 square forward-diagonally`],shield_1:[`Shield 1 turn — blocks one capture or spell hit`],shield_2:[`Shield 2 turns — cannot be captured`],forward_bolt:[`Destroy first enemy on forward diagonal (Stab)`],trickster:[`Swap up to 6 random pieces (not on back ranks)`],purify:[`Removes all debuffs from your pieces, including burn and freeze`],defuse:[`Can't be countered`,`Deactivates every trap on the board`,`Cast another spell this turn`],chain_lightning:[`Strike adjacent enemies only`,`Up to 2 kills if enemies touch each other`,`Your piece is paralyzed 2 turns`],pyromancy:[`Enemy piece + empty dark square — both burn 2 turns; fire tiles block enemies`,`You cannot cast spells on your next turn`],freeze_1:[`Enemy cannot move on their next turn`],snowball:[`Freeze an enemy piece — cannot move on its owner's next turn`],freeze_2:[`Enemy cannot move on their next turn`],deep_freeze:[`Freeze all enemies on one diagonal through your piece for 2 turns`],retreat_3:[`Backward movement for 3 turns`],bishop_2:[`Diagonal slide over empty dark squares for 2 turns`],rook_2:[`Rank/file slide over empty dark squares for 2 turns`],crown:[`Instantly crown a friendly piece`],swap_friendly:[`Swap two friendly pieces`],hostile_swap:[`Swap with an unshielded enemy within 3 squares (Chebyshev)`],quick_march:[`Same piece moves again; either step may capture`],offering:[`Sacrifice a friendly piece`,`Draw 2 cards`,`Cast another spell immediately`],mulligan:[`Shuffle your hand into your deck`,`Draw that many cards`,`Cast another spell this turn`],conjure:[`Draw 2 random cards not in your deck`,`Cards come from the global spell pool`],destroy_unshielded:[`Destroy any unshielded enemy`,`You cannot cast spells on your next turn`],revive:[`Requires a captured friendly piece`,`Place on any empty dark square on your side of the board`,`Returns a clean piece without zombie curse or Awoken Bear`,`Revived piece cannot capture this turn`],blink_2:[`Teleport within 2 squares`],random_teleport:[`Jump to a random empty dark square`,`Crowned if you land on the back rank`],long_step:[`Epic: leap 2 squares diagonally (no capture)`],dash:[`Move 1 square forward-diagonally`,`Destroy enemy on landing square`],sidestep:[`Skip 2 columns on the same row`],landmine:[`Hidden trap 2 turns — destroys enemy lander`],quicksand:[`Hidden trap — freezes the next piece to land there`],detonate:[`Destroy self + adjacent enemies`],venom:[`Poison — 2 ticks destroys target`],bomb:[`Arm friendly piece`,`On next move: explodes`,`Kills all adjacent pieces`],shockwave:[`Arm friendly piece`,`On next move: paralyzes all adjacent pieces`,`1 turn — does not kill`],plague:[`Infect your piece + adjacent pieces`,`Seed spreads plague on every move`,`All infected die in 2 owner turns`],press:[`Opponent must move again after their normal move on their next turn`,`Extra step cannot capture`],mind_control:[`Convert an enemy man to your color for 2 of your turns`,`Reverts to the enemy afterward`],zombify:[`Curse one of your men — sleeps in a gravestone for 1 turn`,`Rises as a zombie king that zombifies captures`,`Horde zombies persist even if the king falls`],barrier:[`Place on any dark square`,`Blocks enemies for 2 turn cycles`],vengeance:[`Hidden trap — destroys the next enemy who captures your piece`,`Expires after 2 of your turn cycles if unused`,`Your piece survives 2 turns (blood counters), then dies`],hibernation:[`Sleep 2 turns (immobile)`,`Wake with Awoken Bear mark`,`Extra move every turn after`],fusion:[`Merge two adjacent men into one`,`Gains Awoken Bear mark`,`Extra move every turn after`],root_2:[`Enemy cannot jump/capture next turn`],silence_3:[`Suppress special movement 3 turns`],poison_3:[`Enemy dies in 3 turns — 3-turn poison bar`],deflect_1:[`Hidden trap — spell hit within 2 turns kills closest enemy instead`],last_stand:[`Hidden trap — ultra shield on capture or destroy for 3 turns`,`Expires after 1 of your turn cycles if unused`],martyr:[`Hidden trap on a friendly piece`,`If an enemy captures or destroys it on their turn within 2 turns, draw 2 cards`,`Expires after 2 of your turn cycles if unused`],clone:[`Your man, then adjacent empty square — copy inherits Awoken Bear and zombie horde marks`,`Copy cannot capture or be taken this turn; dies to freeze/poison/burn/plague`],deport:[`Send an enemy back to its game-start square`,`Destroys any piece already on that square`],bounty:[`Mark an enemy piece`,`When you jump-capture it, draw 2 cards`,`Spell destroys do not count`],link_fate:[`Link two enemies — when one is destroyed, the other dies too`],extract:[`Opponent discards 1 random card from hand`],toll:[`For 2 turns, whenever an opponent casts a spell, draw 2 cards`,`Lasts 2 of your turn cycles`]},Ir={instant:[`Instant — no board target`],friendly:[`Target your piece`],enemy:[`Target enemy piece`],empty:[`Target empty dark square`],f_empty:[`Your piece, then destination`],f_f:[`Two friendly pieces`],f_e:[`Your piece, then enemy`],f_e_adj:[`Your piece, then adjacent enemy`],diagonal:[`Your piece, then diagonal strike`],discard_pick:[`Choose a card to discard`],e_e:[`Two enemy pieces`],column:[`Pick a board file (a–h)`]};function Lr(e){let t=[];return Fr[e.effect]?t.push(...Fr[e.effect]):e.desc&&t.push(e.desc),Ir[e.mode]&&t.push(...Ir[e.mode]),(e.rarity===`epic`||e.rarity===`legendary`)&&t.push(`${e.rarity.charAt(0).toUpperCase()+e.rarity.slice(1)} spell`),[...new Set(t)]}function Rr(e){return Lr(e).join(` · `)}var k=70,A=60,zr=k/64,Br=A/64;function Vr(e){return`<g transform="scale(${zr}, ${Br})">${e}</g>`}function Hr(e){return`<g class="card-motif" opacity="0.98">${e}</g>`}function Ur(e,t,n=5,r=.88){return`<circle cx="${e}" cy="${t}" r="${n}" fill="currentColor" opacity="${r}" stroke="#0f172a" stroke-width="0.8"/>`}function Wr(e,t,n=4){return`<circle cx="${e}" cy="${t}" r="${n}" fill="none" stroke="currentColor" stroke-width="1.6" stroke-dasharray="3 2" opacity="0.5"/>
    <ellipse cx="${e}" cy="${t+n*.5}" rx="${n*.8}" ry="${n*.3}" fill="currentColor" opacity="0.12"/>`}function Gr(e,t,n=6){return`<path d="M${e-n} ${t-n} L${e+n} ${t+n} M${e+n} ${t-n} L${e-n} ${t+n}" stroke="#0f172a" stroke-width="3.6" stroke-linecap="round" opacity="0.4"/>
    <path d="M${e-n} ${t-n} L${e+n} ${t+n} M${e+n} ${t-n} L${e-n} ${t+n}" stroke="currentColor" stroke-width="2.6" stroke-linecap="round"/>`}function Kr(e,t,n=5){return`<ellipse cx="${e}" cy="${t+n*.55}" rx="${n*1.1}" ry="${n*.35}" fill="#000" opacity="0.28"/>
  ...
  <ellipse cx="${e-n*.28}" cy="${t-n*.32}" rx="${n*.42}" ry="${n*.28}" fill="#fca5a5" opacity="0.55"/>
    ...
    <ellipse cx="${e}" cy="${t}" rx="${n}" ry="${r}" fill="#000" opacity="0.32"/>`}function N(e,t=`#e2e8f0`,n=.55){return e.map(([e,r,i=1])=>{let a=i*2.2;return`<path d="M${e} ${r-a} L${e+a*.3} ${r-a*.3} L${e+a} ${r} L${e+a*.3} ${r+a*.3} L${e} ${r+a} L${e-a*.3} ${r+a*.3} L${e-a} ${r} L${e-a*.3} ${r-a*.3} Z" fill="${t}" opacity="${n}"/>`}).join(``)}function P(e,t,n=5.5){return`${Qr(e,t,n)}
    ...
    <circle cx="${e}" cy="${t}" r="${n+4.5}" fill="none" stroke="#93c5fd" stroke-width="0.7" opacity="0.15"/>`}function F(e,t,n=5.5){return`${Kr(e,t,n)}
    ...
    <path d="M${n} ${r} L${n-l*7+d*4} ${r-u*7+f*4} M${n} ${r} L${n-l*7-d*4} ${r-u*7-f*4}" stroke="${i}" stroke-width="${a}" fill="none" stroke-linecap="round"/>`}function qr(e,t,n,r,i=`#93c5fd`,a=2){let o=(e+n)/2,s=(t+r)/2-8;return`<path d="M${e} ${t} Q${o} ${s} ${n} ${r}" stroke="#0f172a" stroke-width="${a+2.4}" fill="none" opacity="0.22"/>
    <path d="M${e} ${t} Q${o} ${s} ${n} ${r}" stroke="${i}" stroke-width="${a+1}" fill="none" opacity="0.28"/>
    <path d="M${e} ${t} Q${o} ${s} ${n} ${r}" stroke="${i}" stroke-width="${a}" fill="none" stroke-linecap="round"/>`}function Jr(e,t,n=`#60a5fa`,r=`#93c5fd`,i=``){let a=i?` filter="url(#${i})"`:``;return`<path d="M${e} ${t-14} L${e+11} ${t-6} L${e+11} ${t+8} C${e+11} ${t+16} ${e} ${t+22} ${e} ${t+22} C${e} ${t+22} ${e-11} ${t+16} ${e-11} ${t+8} L${e-11} ${t-6} Z" fill="${n}" opacity="0.48" stroke="#0f172a" stroke-width="2.2"${a}/>
    ...
    <path d="M${e-2} ${t-8} L${e+3} ${t-3}" stroke="#fff" stroke-width="1.2" opacity="0.35" stroke-linecap="round"/>`}function Yr(e,t,n=28,r=!0){return`<rect x="${e-n/2}" y="${t-n/2}" width="${n}" height="${n}" rx="3" fill="#1c1917" opacity="0.65" stroke="#57534e" stroke-width="1.6"/>
    ...
    <rect x="${e-n/2+2}" y="${t-n/2+2}" width="${n-4}" height="${n-4}" rx="1" fill="none" stroke="#78716c" stroke-width="0.9" opacity="0.35"/>`}function Xr(e,t,n=5,r=`#c4b5fd`){return`<circle cx="${e}" cy="${t}" r="${n+5}" fill="${r}" opacity="0.1"/>
    <circle cx="${e}" cy="${t}" r="${n+2}" fill="none" stroke="${r}" stroke-width="0.8" opacity="0.35"/>
    <path d="M${e} ${t-n} L${e+n*.6} ${t-n*.2} L${e+n} ${t+n*.4} L${e+n*.3} ${t+n} L${e-n*.3} ${t+n} L${e-n} ${t+n*.4} L${e-n*.6} ${t-n*.2} Z" fill="none" stroke="${r}" stroke-width="1.4" opacity="0.72"/>`}function Zr(e,t,n,r){let i=`lg-${e}`;return`<defs>
  ...
  ${Vr(r)}`}function R(e,t,n,r){let i=`cm-${e}`,a=`cm-vig-${e}`;return`<defs>
  ...
  <g filter="url(#${i}-glow)">${Vr(r)}</g>`}function z(e,t,n,r){let i=`uc-${e}`,a=`uc-vig-${e}`;return`<defs>
  ...
  <rect width="${k}" height="${A}" fill="url(#${a})"/>
  <g filter="url(#${i}-glow)">${Vr(r)}</g>`}function B(e,t,n,r){let i=`ra-${e}`,a=`ra-vig-${e}`;return`<defs>
  ...
  <rect width="${k}" height="${A}" fill="url(#${a})"/>
  <g filter="url(#${i}-glow)">${Vr(r)}</g>`}function V(e,t,n,r){let i=`ep-${e}`;return`<defs>
  ...
  <rect width="${k}" height="${A}" fill="url(#${i})"/>
  ${Vr(r)}`}function Qr(e,t,n=5){return`<ellipse cx="${e}" cy="${t+n*.55}" rx="${n*1.1}" ry="${n*.35}" fill="#000" opacity="0.28"/>
    ...
    <path d="M${e-n*.35} ${t+n*.15} Q${e} ${t+n*.45} ${e+n*.35} ${t+n*.15}" fill="none" stroke="#1e40af" stroke-width="1.2" opacity="0.45"/>`}var $r=new Set(`nudge.backstep.retreat_3.anchor_2.recall.repel.leapfrog.random_teleport.rally.coin_flip.ignore.iron_will.demote.quicksand.create_foe.barrier.panic.swap_friendly.sidestep.press.shield_1.snowball.long_step.shield_2.poison_3.deflect_1.forward_bolt.crown.blink_2.landmine.reverse_only_2.root_2.sacrifice.scatter.mass_nudge.sanctuary_pulse.last_stand.martyr.cryo_bolt.collapse.last_king.snipe.dominion.toll.backstab.bomb.berserk.bounty.chain_lightning.clone.confusion.extract.constitution.counterspell.cull.deep_freeze.deport.destroy_unshielded.duel.earthquake.execution.hostile_swap.link_fate.magnet.mind_control.zombify.purify.defuse.pyromancy.quick_march.revive.shockwave.plague.bishop_2.rook_2.offering.mulligan.conjure.tangle.call_forward.dash.blizzard.bulwark.darkness.fortify.hibernation.vengeance.sanctuary.fusion.chameleon.blind.trickster.displacement`.split(`.`));function ei(e){return $r.has(e)}function ti(){return`${M(32,54,20,4)}
    ...
    <path d="M14 20 L18 16 M50 18 L54 14" stroke="#fca5a5" stroke-width="1.4" stroke-linecap="round" opacity="0.55"/>`}function ni(){return`${M(32,56,20,4)}
    ...
    <circle cx="14" cy="14" r="2" fill="#fbbf24" opacity="0.6"/><circle cx="54" cy="16" r="1.5" fill="#fde68a" opacity="0.5"/>`}function ri(){return`${M(32,56,24,5)}
    ...
    ${N([[48,8,.8],[10,10,.7],[56,20,.9],[6,24,.6]],`#e0f2fe`,.7)}`}function ii(){return`${M(32,54,18,4)}
    ...
    <path d="M10 24 L14 28 L8 32 M54 26 L50 30 L56 34" stroke="#a5b4fc" stroke-width="1.4" fill="none" opacity="0.7"/>`}function ai(){return`${M(32,54,18,4)}
    ...
    ${N([[16,12,.7],[52,14,.8],[44,8,.6]],`#fde68a`,.65)}`}function oi(){return`${M(32,54,22,4)}
    ...
    ${N([[20,10,.9],[44,12,.8],[32,6,1.1],[14,24,.7],[50,22,.7]],`#bbf7d0`,.65)}`}function si(){return`${M(32,56,24,5)}
  ...
  <path d="M14 54 L18 50 M50 54 L46 50 M54 14 L50 18 M10 14 L14 18" stroke="#d6d3d1" stroke-width="1.8" stroke-linecap="round" opacity="0.65"/>
    <path d="M8 32 L14 32 M50 32 L56 32 M32 8 L32 14 M32 50 L32 56" stroke="#a8a29e" stroke-width="1.4" stroke-linecap="round" opacity="0.4"/>`}function ci(){return`${M(32,54,22,4)}
    ${F(46,28,5.5)} ${Gr(46,28,6)}
    ${P(18,46,5.5)}
    ...
    ${N([[34,14,.9],[40,20,.7],[28,18,.8]],`#fca5a5`,.6)}`}function li(){return`${M(32,56,16,4)}
    ${F(32,52,6)}
    ...
    ${Xr(50,10,4,`#e9d5ff`)}
    ${N([[12,6,.8],[48,8,1],[22,4,.7],[36,44,.9]],`#e9d5ff`,.65)}`}function ui(){let e=(e,t,n)=>`<g transform="translate(${e}, 40) scale(${t?-1:1}, 1)">
    ...
    ${N([[32,24,1],[26,20,.7],[38,20,.7]],`#fde68a`,.7)}`}function di(){return`${M(36,56,18,4)}
    ${F(42,52,6)}
    ...
    ${N([[38,38,.7],[46,46,.6]],`#fca5a5`,.55)}`}function fi(){return`${M(32,54,22,4)}
    ...
    ${N([[34,36,.7],[38,44,.6],[32,22,.8]],`#fde68a`,.6)}`}function pi(){return`${M(32,54,20,4)}
    ${P(32,42,6)}
    ...
    ${N([[32,8,.8],[20,32,.6],[44,32,.6]],`#bae6fd`,.55)}`}function mi(){return`${M(32,54,22,4)}
    ${P(32,36,6)}
    ...
    ${N([[32,14,.9],[8,36,.7],[56,36,.7]],`#e9d5ff`,.6)}`}function hi(){return`${M(32,54,22,4)}
    ${P(32,36,6)}
    ...
    ${N([[32,22,.85],[10,24,.6],[54,24,.6]],`#86efac`,.55)}`}function gi(){return`${M(32,54,22,4)}
    ${F(48,32,6)}
    ...
    ${N([[22,20,.8],[36,28,.7],[36,36,.7]],`#e9d5ff`,.6)}`}function _i(){return`${M(32,54,22,4)}
    ${F(48,34,6)}
    ...
    ${N([[24,18,.75],[36,30,.65],[40,38,.55]],`#86efac`,.55)}`}function vi(){return`${M(32,54,18,4)}
    ${F(32,36,6)}
    ...
    ${N([[16,20,.8],[48,38,.7],[32,10,.9]],`#e9d5ff`,.6)}`}function yi(){return`${M(32,54,22,4)}
    ...
    ${N([[30,6,.9],[12,18,.6],[50,36,.5]],`#e9d5ff`,.55)}`}function bi(){return`${M(32,54,20,4)}
    ...
    ${N([[14,14,.8],[48,16,.7],[32,8,.9]],`#e9d5ff`,.6)}`}function xi(){return`${M(32,54,22,4)}
    ${P(32,50,5)}
    ...
    ${N([[50,10,1],[12,52,.8],[40,20,.7]],`#e0f2fe`,.7)}`}function Si(){return`${M(32,54,22,4)}
    ...
    ${N([[20,12,.9],[44,12,.8],[32,4,1],[14,28,.7],[50,28,.7]],`#fff`,.55)}`}function wi(){return`${M(32,54,22,4)}
    ...
    ${N([[10,12,.8],[54,12,.8],[10,50,.8],[54,50,.8],[32,6,1]],`#fff`,.6)}`}function Ti(){return`${M(32,56,18,4)}
    ...
    ${N([[14,10,.7],[50,10,.7],[32,28,.8]],`#fde68a`,.6)}`}function Ei(){return`${M(32,54,22,4)}
    ...
    ${Xr(32,36,4,`#e9d5ff`)}
    ${N([[32,28,.8],[32,44,.7]],`#e9d5ff`,.6)}`}function Di(){return`${M(32,54,20,4)}
    ${P(22,38,5.5)}
    ...
    ${N([[36,32,.7],[48,34,.6],[42,28,.8]],`#e9d5ff`,.55)}`}function Oi(){return`${M(32,56,18,4)}
    ${P(32,42,6)}
  ...
  ${Vr(`<ellipse cx="32" cy="56" rx="20" ry="4" fill="#000" opacity="0.35"/>
  ...
  ${Kr(14,50,3.2)}${Qr(50,50,3.2)}`)}`}function Ai(){return`${M(24,54,20,4)}
    ${F(48,20,5.5)}
    ...
    ${N([[18,32,.8],[28,28,.6]],`#e9d5ff`,.55)}`}function ji(){return`${M(32,54,22,4)}
    ...
    ${N([[12,18,.8],[50,8,.75],[32,44,.6]],`#e9d5ff`,.6)}`}function Mi(){return`${M(32,54,22,4)}
    ...
    ${N([[18,8,.8],[46,6,.75],[32,30,.65],[24,48,.55]],`#e9d5ff`,.6)}`}function Ni(){return`${M(28,54,18,4)}
    ${P(22,44,5.5)}
    ...
    ${N([[30,8,.8],[52,6,.7],[24,28,.6]],`#e9d5ff`,.6)}`}function Pi(){return`${M(32,52,22,4)}
    ...
    ${N([[32,34,.9],[16,14,.7],[48,14,.7]],`#e0f2fe`,.6)}`}function Fi(){return`${M(32,54,18,4)}
    ${P(32,48,5.5)}
    ...
    ${N([[12,18,.7],[52,18,.7],[32,36,.6]],`#e9d5ff`,.55)}`}function Ii(){return`${M(32,54,18,4)}
    ${P(32,48,5.5)}
    ...
    ${N([[32,6,.7],[4,44,.6],[60,44,.6]],`#e9d5ff`,.55)}`}function Li(){return`${M(30,52,20,4)}
    ${F(46,20,5.5)}
    ...
    ${N([[36,26,.7],[22,38,.6]],`#fca5a5`,.5)}`}function Ri(){return`${M(30,54,18,4)}
    ${P(18,50,5)}
    ${F(44,28,5)}
    ...
    ${N([[38,34,.7]],`#e9d5ff`,.5)}`}function zi(){return`${M(32,54,26,4)}
    ...
    ${N([[8,10,.8],[56,12,.9],[32,18,.7]],`#e0f2fe`,.65)}`}function Bi(){return`${M(32,54,22,4)}
    ...
    ${Jr(32,34,`#7c3aed`,`#e9d5ff`)}
    ${N([[20,40,.7],[44,24,.7],[32,28,.8]],`#e9d5ff`,.55)}`}function Vi(){return`${M(32,54,24,4)}
    ...
    ${N([[16,10,.7],[48,10,.7],[10,32,.6],[54,32,.6]],`#c4b5fd`,.45)}`}function Hi(){return`${M(32,56,16,4)}
    ${P(32,34,6)}
    ...
    ${Jr(32,30,`#7c3aed`,`#e9d5ff`)}
    <text x="18" y="54" font-size="7" fill="#ddd6fe" opacity="0.8" font-weight="700">HOLD</text>
    ${N([[32,12,.8],[12,34,.6],[52,34,.6]],`#e9d5ff`,.5)}`}function Ui(){return`${M(32,56,16,4)}
    ${P(32,38,6)}
    ...
    ${N([[32,4,.8],[18,8,.6],[46,8,.6]],`#fde68a`,.55)}`}function Wi(){return`${M(30,54,18,4)}
    ${P(28,36,6)}
    ...
    ${N([[12,12,.7],[46,18,.6]],`#fca5a5`,.5)}`}function Gi(){return`${M(32,54,20,4)}
    ...
    ${N([[32,8,.8],[14,28,.6],[50,28,.6]],`#e9d5ff`,.5)}`}function Ki(){return`${M(32,54,20,4)}
    ...
    <path d="M24 50 C30 44 34 44 40 50" stroke="#fde68a" stroke-width="2" fill="none" opacity="0.7"/>
    ${j(32,14,5,`#fde68a`,`#b45309`)}
    ${N([[24,36,.7],[40,36,.7],[32,8,.9]],`#fde68a`,.6)}`}function qi(){return`${M(32,54,18,4)}
    ${P(32,34,6)}
    ...
    ${N([[32,12,.8],[8,34,.6],[56,34,.6]],`#e9d5ff`,.55)}`}function Ji(){return`${M(32,54,20,4)}
    ...
    ${N([[46,16,.7],[24,20,.5]],`#c4b5fd`,.45)}`}function Yi(){return`${M(32,54,24,4)}
    ...
    ${N([[8,8,.7],[56,8,.7],[8,56,.7],[56,56,.7]],`#fde68a`,.6)}`}function Xi(){return`${M(28,54,18,4)}
    ${P(18,44,5.5)}
    ${I(42,24,6,`#cbd5e1`)}
    ...
    ${N([[40,20,.7],[22,36,.5]],`#e2e8f0`,.45)}`}function Zi(){return`${M(32,54,16,4)}
    ${P(32,20,5.5)}
    ${I(32,48,6,`#cbd5e1`)}
    ...
    ${N([[32,16,.6],[32,44,.5]],`#cbd5e1`,.4)}`}function Qi(){return`${M(32,54,16,4)}
    ${P(32,26,5.5)}
    ...
    ${N([[32,22,.6]],`#93c5fd`,.4)}`}function $i(){return`${M(32,54,20,4)}
    ...
    ${N([[32,6,.7]],`#cbd5e1`,.4)}`}function ea(){return`${M(32,54,22,4)}
    ${P(32,24,5.5)}
    ...
    ${N([[20,40,.5],[44,40,.5]],`#93c5fd`,.4)}`}function ta(){return`${M(30,54,20,4)}
    ${P(20,36,5)}${F(40,36,5)}
    ${I(54,36,5,`#fca5a5`)}
    ...
    ${N([[48,32,.6]],`#fde68a`,.45)}`}function na(){return`${M(28,54,20,4)}
    ...
    ${N([[30,14,.8],[20,38,.5]],`#bae6fd`,.5)}`}function ra(){return`${M(32,54,18,4)}
    ${P(32,40,5.5)}
    ...
    ${N([[24,12,.8],[48,20,.7],[32,6,.9]],`#e9d5ff`,.55)}`}function ia(){return`${M(32,54,22,4)}
    ...
    ${N([[32,10,.8],[16,40,.5],[48,40,.5]],`#93c5fd`,.45)}`}function aa(){return`${M(32,54,16,4)}
    ${P(32,36,6)}
    ...
    ${N([[16,12,.6]],`#fca5a5`,.4)}`}function oa(){return`${M(32,54,18,4)}
    ${P(32,34,6)}
    ...
    ${N([[32,20,.7]],`#e2e8f0`,.4)}`}function sa(){return`${M(32,54,16,4)}
    ${F(32,40,6)}
    ...
    ${N([[24,4,.6],[40,4,.6]],`#fde68a`,.45)}`}function ca(){return`${M(32,54,18,4)}
    ${Yr(32,36,32)}
    ...
    ${N([[30,36,.5]],`#d6d3d1`,.35)}`}function la(){return`${M(32,54,16,4)}
    ...
    ${N([[46,10,.7]],`#fca5a5`,.5)}`}function ua(){return`${M(32,54,16,4)}
    ...
    ${N([[32,20,.5],[32,40,.5]],`#cbd5e1`,.35)}`}function da(){return`${M(32,54,16,4)}
    ${F(32,22,6)}
    ...
    ${N([[28,16,.6],[36,16,.6]],`#fca5a5`,.45)}`}function fa(){return`${M(32,54,20,4)}
    ...
    ${Xr(32,34,4,`#c4b5fd`)}
    ${N([[32,30,.7]],`#e9d5ff`,.45)}`}function pa(){return`${M(28,54,18,4)}
    ${P(12,34,5.5)}
    ${I(50,34,6,`#cbd5e1`)}
    ...
    ${N([[46,30,.6]],`#e2e8f0`,.4)}`}function ma(){return`${M(32,54,18,4)}
    ${F(32,28,6)}
    ...
    ${j(32,52,5,`#fca5a5`,`#dc2626`)}`}function ha(){return`${M(32,56,16,4)}
    ${P(32,38,6)}
    ${Jr(32,30,`#60a5fa`,`#93c5fd`)}
    ...
    ${N([[32,18,.7],[20,32,.5],[44,32,.5]],`#bae6fd`,.4)}`}function ga(){return`${M(32,54,18,4)}
    ${P(32,36,6)}
    ...
    ${N([[14,10,.7],[20,22,.5]],`#e0f2fe`,.5)}`}function _a(){return`${M(30,54,20,4)}
    ${P(14,50,5.5)}
    ${I(50,14,6,`#7dd3fc`)}
    ...
    ${N([[48,12,.7],[24,38,.5]],`#bae6fd`,.45)}`}function va(){return`${M(32,56,16,4)}
    ${P(32,38,6)}
    ${Jr(32,28,`#38bdf8`,`#7dd3fc`)}
    ...
    ${N([[32,14,.8],[14,34,.5],[50,34,.5]],`#bae6fd`,.45)}`}function ya(){return`${M(32,54,16,4)}
    ${F(32,34,6)}
    ...
    ${N([[32,10,.7],[28,44,.5],[36,44,.5]],`#86efac`,.45)}`}function ba(){return`${M(26,54,16,4)}
    ${P(24,38,5.5)}
    ...
    ${N([[48,10,.6]],`#fde68a`,.45)}`}function xa(){return`${M(30,54,18,4)}
    ...
    ${N([[42,20,.7]],`#fde68a`,.5)}`}function Sa(){return`${M(32,56,16,4)}
    ${P(32,40,6)}
    ...
    ${N([[22,4,.7],[32,0,.8],[42,4,.7]],`#fde68a`,.6)}`}function Ca(){return`${M(30,54,20,4)}
    ...
    ${N([[46,12,.8],[24,40,.5]],`#e0f2fe`,.5)}`}function wa(){return`${M(32,54,16,4)}
    ${Yr(32,36,32)}
    ...
    ${N([[32,24,.6]],`#fca5a5`,.4)}`}function Ta(){return`${M(32,54,18,4)}
    ${F(32,20,6)}
  ...
  <path d="M28 48 L24 54 M36 48 L40 54" stroke="#86efac" stroke-width="1.4" stroke-linecap="round" opacity="0.35"/>
    ${N([[20,40,.5],[44,40,.5]],`#86efac`,.4)}`}function Da(){return`${M(30,54,20,4)}
    ...
    ${j(48,22,5,`#ef4444`,`#991b1b`)}`}function Oa(){return`${M(32,54,18,4)}
    ...
    ${N([[32,8,.6],[56,32,.6],[32,56,.6],[8,32,.6]],`#bae6fd`,.4)}`}function ka(){return`${M(26,54,20,4)}
    ...
    ${N([[8,20,.6],[42,20,.6]],`#bae6fd`,.4)}`}function Aa(){return`${M(32,54,22,4)}
    ...
    ${N([[44,10,.75],[30,28,.55],[20,46,.5]],`#e9d5ff`,.5)}`}function ja(){return`${M(32,54,24,4)}
    ...
    ${N([[32,28,.7],[12,38,.5],[52,38,.5]],`#bae6fd`,.45)}`}function Ma(){return`${M(32,56,14,3)}
    ${P(32,34,6)}
    ${Jr(32,28,`#38bdf8`,`#7dd3fc`)}
    ...
    <text x="10" y="18" font-size="6" fill="#e9d5ff" opacity="0.55">?</text>`}function Na(){return`${M(30,56,16,3.5)}
    ${P(24,40,5.5)}
    ...
    ${N([[30,12,.7],[50,10,.6]],`#fecaca`,.55)}`}function Pa(){return`${M(30,54,18,3.5)}
    ...
    <circle cx="42" cy="22" r="8" fill="#7dd3fc" opacity="0.12"/>`}function Fa(){return`${M(32,54,14,3.5)}
    ${Yr(32,36,30,!1)}
    ${Qr(32,34,4)}
    ...
    <path d="M24 38 L28 42 M36 38 L40 42" stroke="#d6d3d1" stroke-width="1.2" stroke-linecap="round" opacity="0.4"/>`}function Ia(){return`${M(32,56,14,3)}
    ${P(32,38,7)}
    ...
    ${Jr(32,34,`#38bdf8`,`#7dd3fc`)}
    <circle cx="32" cy="12" r="4" fill="#fde68a" opacity="0.3"/>`}function La(){return`${M(32,54,20,4)}
    ...
    <path d="M18 44 L22 40 M46 18 L50 14" stroke="#fbbf24" stroke-width="1.2" stroke-linecap="round" opacity="0.45"/>`}function Ra(){return`${M(32,54,18,3.5)}
    ...
    <circle cx="32" cy="40" r="14" fill="none" stroke="#60a5fa" stroke-width="0.8" opacity="0.2"/>`}function za(){return`${M(32,54,20,4)}
    ...
    ${N([[22,16,.75],[44,14,.7],[32,44,.55]],`#fde68a`,.55)}`}var Ba={nudge:()=>R(`nu`,`#94a3b8`,`#1e293b`,Xi()),backstep:()=>R(`bs`,`#9ca3af`,`#1f2937`,Zi()),retreat_3:()=>R(`ret`,`#93c5fd`,`#1e3a5f`,Qi()),leapfrog:()=>R(`lf`,`#94a3b8`,`#1e293b`,na()),long_step:()=>z(`ls`,`#7dd3fc`,`#1e3a5f`,_a()),sidestep:()=>R(`ss`,`#9ca3af`,`#1f2937`,pa()),blink_2:()=>z(`bl`,`#38bdf8`,`#0c4a6e`,Ca()),random_teleport:()=>R(`rtp`,`#a78bfa`,`#312e81`,ra()),recall:()=>R(`rc`,`#93c5fd`,`#1e3a5f`,ea()),repel:()=>R(`rp`,`#94a3b8`,`#1e293b`,ta()),mass_nudge:()=>z(`mn`,`#7dd3fc`,`#1e3a5f`,ka()),displacement:()=>B(`dp`,`#b794f4`,`#553c7a`,Aa()),swap_friendly:()=>R(`sw`,`#a78bfa`,`#312e81`,fa()),dominion:()=>z(`dm`,`#60a5fa`,`#1e3a5f`,Ra()),toll:()=>z(`tl`,`#fbbf24`,`#1e3a5f`,za()),shield_1:()=>R(`s1`,`#60a5fa`,`#1e3a5f`,ha()),shield_2:()=>z(`s2`,`#38bdf8`,`#0c4a6e`,va()),bulwark:()=>B(`bw`,`#b794f4`,`#553c7a`,Bi()),barrier:()=>R(`br`,`#94a3b8`,`#1f2937`,ua()),last_stand:()=>B(`ls`,`#38bdf8`,`#0c4a6e`,Ma()),martyr:()=>V(`my`,`#fca5a5`,`#4c0519`,Na()),fortify:()=>z(`fo`,`#a78bfa`,`#4c1d95`,Hi()),sanctuary_pulse:()=>z(`sp`,`#7dd3fc`,`#1e3a5f`,ja()),sanctuary:()=>B(`sa`,`#c4b5fd`,`#4c1d95`,Gi()),deflect_1:()=>z(`df`,`#38bdf8`,`#0c4a6e`,ba()),anchor_2:()=>R(`an`,`#94a3b8`,`#1f2937`,$i()),iron_will:()=>R(`iw`,`#9ca3af`,`#1f2937`,oa()),vengeance:()=>B(`vg`,`#9f7aea`,`#3b0764`,Wi()),rally:()=>R(`rl`,`#60a5fa`,`#1e3a5f`,ia()),forward_bolt:()=>z(`fb`,`#fde68a`,`#1e3a5f`,xa()),destroy_unshielded:()=>Zr(`sh`,`#4338ca`,`#1e1b4b`,ii()),pyromancy:()=>Zr(`py`,`#ea580c`,`#431407`,ai()),snipe:()=>z(`sn`,`#fde68a`,`#1e3a5f`,La()),duel:()=>R(`du`,`#d4b896`,`#3d2817`,ui()),sacrifice:()=>z(`sc`,`#fca5a5`,`#1e3a5f`,Da()),cull:()=>V(`cu`,`#a78bfa`,`#2e1065`,li()),execution:()=>B(`ex`,`#6ee7b7`,`#14532d`,di()),chain_lightning:()=>Zr(`cl`,`#2563eb`,`#0c1929`,ri()),backstab:()=>z(`bk`,`#c4a574`,`#2d4a6e`,ti()),cryo_bolt:()=>z(`cb`,`#7dd3fc`,`#0c4a6e`,Pa()),bomb:()=>Zr(`bm`,`#f59e0b`,`#78350f`,ni()),shockwave:()=>V(`sw`,`#c4b5fd`,`#3b1f6e`,mi()),plague:()=>V(`pg`,`#86efac`,`#14532d`,hi()),magnet:()=>B(`mg`,`#6ee7b7`,`#14532d`,fi()),poison_3:()=>z(`po`,`#86efac`,`#14532d`,ya()),root_2:()=>z(`ro`,`#86efac`,`#14532d`,Ea()),panic:()=>R(`pn`,`#fca5a5`,`#1f2937`,da()),blizzard:()=>B(`bz`,`#7dd3fc`,`#1e3a5f`,zi()),snowball:()=>R(`sb`,`#bae6fd`,`#0c4a6e`,ga()),berserk:()=>Zr(`bk`,`#991b1b`,`#450a0a`,ci()),create_foe:()=>R(`cf`,`#78716c`,`#292524`,la()),deep_freeze:()=>V(`df`,`#7dd3fc`,`#0c4a6e`,xi()),reverse_only_2:()=>z(`rv`,`#fca5a5`,`#1e3a5f`,Ta()),press:()=>R(`pr`,`#fca5a5`,`#1f2937`,ma()),tangle:()=>B(`tg`,`#93c5fd`,`#312e81`,Pi()),blind:()=>B(`bl`,`#a78bfa`,`#4c1d95`,Ji()),confusion:()=>V(`cf`,`#c4b5fd`,`#4c1d95`,vi()),extract:()=>B(`ex`,`#c4b5fd`,`#4c1d95`,yi()),fog_2:()=>Hr(`${Ur(32,34,6)}<ellipse cx="32" cy="24" rx="16" ry="8" fill="currentColor" opacity="0.22"/>`),crown:()=>z(`cr`,`#fbbf24`,`#451a03`,Sa()),demote:()=>R(`dm`,`#fca5a5`,`#1f2937`,sa()),fusion:()=>B(`fu`,`#8b5cf6`,`#4c1d95`,Ki()),clone:()=>V(`cln`,`#93c5fd`,`#312e81`,Di()),chameleon:()=>B(`ch`,`#86efac`,`#312e81`,qi()),hibernation:()=>V(`hi`,`#c4b5fd`,`#4c1d95`,Ui()),quicksand:()=>R(`qs`,`#a8a29e`,`#292524`,ca()),landmine:()=>z(`lm`,`#78716c`,`#292524`,wa()),collapse:()=>R(`co`,`#78716c`,`#292524`,Fa()),darkness:()=>B(`dk`,`#6d28d9`,`#1e1b4b`,Vi()),scatter:()=>z(`st`,`#7dd3fc`,`#1e3a5f`,Oa()),call_forward:()=>V(`cfw`,`#fca5a5`,`#4c1d95`,Li()),dash:()=>B(`ds`,`#c4b5fd`,`#4c1d95`,Ri()),earthquake:()=>V(`eq`,`#78716c`,`#292524`,si()),coin_flip:()=>ki(),ignore:()=>R(`ig`,`#94a3b8`,`#1f2937`,aa()),counterspell:()=>V(`cs`,`#a78bfa`,`#2e1065`,bi()),purify:()=>z(`pu`,`#6ee7b7`,`#14532d`,Ci()),defuse:()=>z(`df`,`#7dd3fc`,`#0c4a6e`,wi()),trickster:()=>B(`tr`,`#c4b5fd`,`#553c7a`,Yi()),offering:()=>B(`of`,`#d8b4fe`,`#553c7a`,Ni()),mulligan:()=>B(`mu`,`#c4b5fd`,`#4c1d95`,ji()),conjure:()=>V(`cj`,`#c4b5fd`,`#3b0764`,Mi()),quick_march:()=>V(`qm`,`#60a5fa`,`#1e3a5f`,pi()),constitution:()=>V(`co`,`#4ade80`,`#14532d`,Oi()),last_king:()=>z(`lk`,`#fbbf24`,`#1e3a5f`,Ia()),revive:()=>Zr(`rv`,`#15803d`,`#052e16`,oi()),mind_control:()=>V(`mc`,`#c4b5fd`,`#3b0764`,gi()),zombify:()=>Zr(`zb`,`#4ade80`,`#14532d`,_i()),bounty:()=>V(`bo`,`#4ade80`,`#14532d`,Ti()),link_fate:()=>V(`lf`,`#a78bfa`,`#2e1065`,Ei()),bishop_2:()=>z(`bp`,`#b794f4`,`#4c1d95`,Fi()),rook_2:()=>z(`rk`,`#a78bfa`,`#4c1d95`,Ii()),hostile_swap:()=>V(`hs`,`#93c5fd`,`#312e81`,Si()),deport:()=>B(`dp`,`#c4b5fd`,`#1e1b4b`,Ai())};function Va(e,t=0){let n=Ba[e.effect];return n?n(t):null}var Ha={movement:{symbol:`↗`,label:`Motion`,anim:`movement`},combat:{symbol:`⚔`,label:`Strike`,anim:`combat`},defense:{symbol:`🛡`,label:`Ward`,anim:`defense`},debuff:{symbol:`❄`,label:`Curse`,anim:`debuff`},transform:{symbol:`✦`,label:`Morph`,anim:`transform`},board:{symbol:`◇`,label:`Terrain`,anim:`board`},crown:{symbol:`♔`,label:`Royal`,anim:`crown`},arcane:{symbol:`✧`,label:`Arcane`,anim:`arcane`}},Ua=[[`movement`,[`nudge`,`backstep`,`long_step`,`leapfrog`,`recall`,`teleport`,`random_teleport`,`displacement`,`berserk`,`dash`]],[`combat`,[`stab`,`shatter`,`destroy`,`snipe`,`duel`,`execution`,`cull`,`pyromancy`,`backstab`,`sacrifice`,`chain_lightning`,`cryo`,`bomb`,`magnet`]],[`special`,[`create_foe`,`clone`,`earthquake`]],[`defense`,[`shield`,`ward`,`aegis`,`bulwark`,`stall`,`sanctuary`,`barrier`,`anchor`,`iron_will`,`hibernation`,`constitution`]],[`debuff`,[`root`,`panic`,`backpedal`,`blizzard`,`deep_freeze`,`snowball`,`blind`,`confusion`,`extract`,`press`,`tangle`,`shockwave`]],[`board`,[`quicksand`,`landmine`,`collapse`,`darkness`,`earthquake`,`scatter`,`call_forward`]],[`meta`,[`counterspell`,`vengeance`,`last_stand`,`martyr`,`purify`,`defuse`,`trickster`,`ignore`,`offering`,`mulligan`,`conjure`,`quick_march`,`dominion`,`toll`,`last_king`,`revive`,`mind_control`,`zombify`]]];function Wa(e){let t=0;for(let n=0;n<e.length;n++)t=(t+e.charCodeAt(n)*41)%360;return t}function Ga(e){let t=0;for(let n=0;n<e.length;n++)t=(t+e.charCodeAt(n)*13)%3;return t}function Ka(e){let t=`${e.id} ${e.effect} ${e.name}`.toLowerCase();for(let[e,n]of Ua)if(Array.isArray(n)&&n.some(e=>t.includes(e)))return e;return`arcane`}function qa(e){return`ca${String(e).replace(/[^a-zA-Z0-9]/g,``)}`}function Ja(e,t,n){let r=[[12,18,.35],[48,12,.5],[52,44,.25],[18,50,.4],[38,28,.55]],i=n*4;return r.map(([e,n,r],a)=>`<circle cx="${(e+i+a*7)%56+4}" cy="${(n+i*2+a*5)%52+6}" r="1.2" fill="hsl(${t} 90% 85% / ${r})"/>`).join(``)}function Ya(e,t){let n=t,r={movement:`
      ...
      </g>`};return r[e]||r.arcane}function Xa(e,t,n,r){return Za(e,t,n,r)}function Za(e,t,n,r){let i=qa(n),a=(t+42)%360,o=Ga(n),s=r&&Va(r,o)||Ya(e,o);return r?.effect&&ei(r.effect)&&s?`<svg class="spell-card__svg spell-card__svg--full-bleed" viewBox="0 0 70 60" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid meet">${s}</svg>`:`<svg class="spell-card__svg" viewBox="0 0 70 60" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
  ...
  </svg>`}function Qa(e){return e.tiny?`tiny`:e.small?`small`:e.compact?`compact`:`full`}function $a(e){let t=Lr(e);return t.length?`<ul class="spell-card__effects">${t.map(e=>`<li>${ro(e)}</li>`).join(``)}</ul>`:``}var eo=new WeakMap;function to(e){let t=e?.querySelector?.(`.spell-card__name`),n=e?.querySelector?.(`.spell-card__title-frame`);if(!t||!n)return;let r=()=>{t.classList.add(`spell-card__name--fit`),t.style.fontSize=``,t.style.textOverflow=``,t.style.overflow=``;let e=n.clientWidth;if(e<=0)return;let r=parseFloat(getComputedStyle(t).fontSize);if(!r)return;let i=r*.55;for(;t.scrollWidth>e&&r>i;)r-=.5,t.style.fontSize=`${r}px`;t.scrollWidth>e&&(t.style.overflow=`hidden`,t.style.textOverflow=`ellipsis`)};if(r(),requestAnimationFrame(r),!eo.has(e)&&typeof ResizeObserver<`u`){let t=new ResizeObserver(()=>r());t.observe(n),eo.set(e,t)}}function no(e,t={}){let n=Ka(e),r=Wa(e.id),i=Ha[n]||Ha.arcane,a=Qa(t),o=!(t.hideDesc||t.gallery)&&a!==`tiny`,s=t.showViewFullHint||t.gallery,c=t.button?`button`:`div`,l=document.createElement(c);t.button&&(l.type=`button`);let u=e.rarity===`legendary`?`legendary`:e.rarity;l.className=[`spell-card`,`spell-card--${a}`,`spell-card--anim-${i.anim}`,u,e.rarity===`rare`?`spell-card--rare-fx`:``,e.rarity===`epic`?`spell-card--epic-fx`:``,e.rarity===`legendary`?`spell-card--legendary-fx`:``,e.rarity===`uncommon`?`spell-card--uncommon-fx`:``,e.rarity===`common`?`spell-card--common-fx`:``,`theme-${n}`,t.disabled?`disabled`:``,t.selected?`selected`:``,t.static?`static`:``,t.deal?`spell-card--deal`:``,t.fullDesc?`spell-card--full-desc`:``,t.gallery?`spell-card--gallery`:``].filter(Boolean).join(` `),l.style.setProperty(`--card-hue`,String(r)),l.dataset.cardId=e.id,l.title=Rr(e);let d=e.rarity===`legendary`?`<div class="spell-card__fx spell-card__fx--legendary" aria-hidden="true"></div>`:e.rarity===`epic`?`<div class="spell-card__fx spell-card__fx--epic" aria-hidden="true"></div>`:e.rarity===`rare`?`<div class="spell-card__fx spell-card__fx--rare" aria-hidden="true"></div>`:e.rarity===`uncommon`?`<div class="spell-card__fx spell-card__fx--uncommon" aria-hidden="true"></div>`:e.rarity===`common`?`<div class="spell-card__fx spell-card__fx--common" aria-hidden="true"></div>`:``,f=e?.effect&&ei(e.effect);return l.innerHTML=`
    ${d}
    <div class="spell-card__frame">
      <div class="spell-card__title-frame">
        <h3 class="spell-card__name">${ro(e.name)}</h3>
      </div>
      ...
      <div class="spell-card__type-frame${s?` spell-card__type-frame--with-hint`:``}">
        ...
        ${t.meta?`<span class="spell-card__meta">${ro(t.meta)}</span>`:``}
      </div>
      ${o?`<div class="spell-card__text-frame"><p class="spell-card__desc">${ro(e.desc)}</p></div>`:``}
    </div>
    <div class="spell-card__tooltip" role="tooltip">
      <strong>${ro(e.name)}</strong>
      ${$a(e)}
    </div>
  `,t.onClick&&l.addEventListener(`click`,n=>t.onClick(n,e)),to(l),l}function ro(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function io(e){return document.getElementById(e)}function ao(){let e=io(`card-preview-modal`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function oo(e){document.body.classList.toggle(`card-preview-open`,e),window.dispatchEvent(new CustomEvent(`card-preview-change`,{detail:{open:e}}))}function so(){io(`card-preview-modal`)?.classList.add(`hidden`),io(`card-preview-mount`)?.classList.remove(`card-preview-mount--reveal-only`),oo(!1);let e=window.scrollY||document.documentElement.scrollTop||0;window.scrollTo(0,e),document.documentElement.scrollLeft=0,document.body.scrollLeft=0,document.querySelector(`.game-main`)?.scrollTo?.(0,document.querySelector(`.game-main`)?.scrollTop??0)}function co(e,t={}){ao();let n=io(`card-preview-modal`),r=io(`card-preview-mount`),i=io(`card-preview-actions`);if(!(!n||!r||!e)){if(r.innerHTML=``,r.classList.toggle(`card-preview-mount--reveal-only`,!!t.hideDesc),r.appendChild(no(e,{static:!0,hideDesc:t.hideDesc})),i){if(i.innerHTML=``,t.meta){let e=document.createElement(`p`);e.className=`card-preview-meta`,e.textContent=t.meta,i.appendChild(e)}let e=document.createElement(`div`);if(e.className=`card-preview-actions-row`,t.onPlay){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=`Cast spell`,n.addEventListener(`click`,()=>{so(),t.onPlay()}),e.appendChild(n)}if(t.onAdd){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=`Add to deck`,n.disabled=!!t.addDisabled,n.addEventListener(`click`,()=>{t.addDisabled||t.onAdd()}),e.appendChild(n)}if(t.onBuy){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=t.buyLabel||`Buy copy`,n.disabled=!!t.buyDisabled,n.addEventListener(`click`,()=>{t.buyDisabled||t.onBuy()}),e.appendChild(n)}if(t.onRemove){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-secondary`,n.textContent=`Remove all from deck`,n.addEventListener(`click`,()=>{t.onRemove(),so()}),e.appendChild(n)}e.children.length&&i.appendChild(e)}n.classList.remove(`hidden`),oo(!0)}}function lo(){io(`card-preview-close`)?.addEventListener(`click`,so),io(`card-preview-backdrop`)?.addEventListener(`click`,so),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&so()})}function uo(e,t=`.spell-card`){e&&e.querySelectorAll(t).forEach((e,t)=>{e.classList.add(`spell-card--deal`),e.style.animationDelay=`${t*.1}s`})}function fo(e){e&&(e.classList.add(`spell-card--rare-burst`),setTimeout(()=>e.classList.remove(`spell-card--rare-burst`),900))}function po(e){e&&(e.classList.add(`spell-card--epic-burst`),setTimeout(()=>e.classList.remove(`spell-card--epic-burst`),1200))}function mo(e){e&&(e.classList.add(`spell-card--legendary-burst`),setTimeout(()=>e.classList.remove(`spell-card--legendary-burst`),1500))}function ho(e,t){t===`legendary`?mo(e):t===`epic`?po(e):t===`rare`&&fo(e)}var go={common:10,uncommon:20,rare:30,epic:40,legendary:50};function _o(e){return go[e]??30}function vo(e,r){let i=ae(e,r);if(i<1)return{success:!1,message:`Get this spell from a chest first.`};let a=n(r);if(!a)return{success:!1,message:`Unknown card.`};let o=t(r);if(i>=o)return{success:!1,message:`You already own the maximum (${o} copies).`};let s=_o(a.rarity);if(e.gems<s)return{success:!1,message:`Need ${s} gems (${e.gems} available).`};e.gems-=s;let c=ve(e,r,1);return c?{success:!0,cost:s,message:`+1 ${a.name} for ${s} gems (${i+c} owned).`}:(e.gems+=s,T(e),{success:!1,message:`You already own the maximum copies for this rarity.`})}var yo={deck:`<svg class="nav-icon-svg" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  </svg>`};function bo(){let e={deck:yo.deck,chests:yo.chests,play:yo.play,social:yo.social,quests:yo.quests};for(let t of document.querySelectorAll(`.game-nav .tab-btn[data-tab]`)){let n=t.querySelector(`.tab-btn__icon`),r=t.dataset.tab;n&&e[r]&&(n.innerHTML=e[r])}}var xo=`arcaneCheckersSettings_v1`,So={musicEnabled:!0,musicVolume:.45,sfxEnabled:!0,sfxVolume:.7,hapticsEnabled:!0},Co={...So};function wo(){try{let e=localStorage.getItem(xo);return e?{...So,...JSON.parse(e)}:{...So}}catch{return{...So}}}function H(){return{...Co}}function To(e){Co={...Co,...e};try{localStorage.setItem(xo,JSON.stringify(Co))}catch{}return window.dispatchEvent(new CustomEvent(`arcane-settings-changed`,{detail:H()})),H()}function Eo(){return Co=wo(),H()}var Do={hub:`assets/audio/background.m4a`,match:`assets/audio/background.m4a`},Oo={tap:`assets/audio/sfx/tap.mp3`,spell:`assets/audio/sfx/spell.mp3`,capture:`assets/audio/sfx/capture.mp3`,win:`assets/audio/sfx/win.mp3`,chest:`assets/audio/sfx/chest.mp3`},ko=null,Ao=null,jo=`hub`,Mo=!1;function No(){return typeof Audio<`u`}function Po(e,t){if(!(!No()||!H().sfxEnabled))try{let n=new Audio(e);n.volume=Math.max(0,Math.min(1,t*H().sfxVolume)),n.play().catch(()=>{})}catch{}}function Fo(e){let t=Do[e];if(!t||!No())return null;let n=e===`hub`?ko:Ao;return n||(n=new Audio(t),n.loop=!0,n.preload=`auto`,e===`hub`?ko=n:Ao=n),n}function Io(e){e&&(e.volume=Math.max(0,Math.min(1,H().musicVolume)))}function Lo(){ko?.pause(),Ao?.pause()}function Ro(){Mo||!No()||(Mo=!0,[ko,Ao].forEach(e=>{e&&e.play().then(()=>e.pause()).catch(()=>{})}))}function zo(e){if(jo=e,!H().musicEnabled){Lo();return}let t=Fo(`hub`),n=Fo(`match`);e===`match`?(t?.pause(),n&&(Io(n),n.play().catch(()=>{}))):(n?.pause(),t&&(Io(t),t.play().catch(()=>{})))}function Bo(){if(!H().musicEnabled){Lo();return}Io(ko),Io(Ao),zo(jo)}function Vo(){if(!No())return;window.addEventListener(`arcane-settings-changed`,()=>Bo());let e=()=>{Ro(),H().musicEnabled&&zo(jo),window.removeEventListener(`pointerdown`,e),window.removeEventListener(`keydown`,e)};window.addEventListener(`pointerdown`,e,{once:!0}),window.addEventListener(`keydown`,e,{once:!0})}function Ho(e){let t=Oo[e];t&&Po(t,1)}var Uo={tap:()=>Ho(`tap`),spell:()=>Ho(`spell`),capture:()=>Ho(`capture`),win:()=>Ho(`win`),chest:()=>Ho(`chest`)},Wo=null,Go=!1;async function Ko(){if(Go)return Wo;Go=!0;try{let{Capacitor:e}=await E(async()=>{let{Capacitor:e}=await import(`./dist-DM6qMOWp.js`);return{Capacitor:e}},[],import.meta.url);if(!e.isNativePlatform())return null;Wo=(await E(()=>import(`./esm-TGGH6JYM.js`),[],import.meta.url)).ScreenOrientation}catch{Wo=null}return Wo}async function qo(){document.body.classList.remove(`orientation-match`),document.body.classList.add(`orientation-portrait`);let e=await Ko();if(e)try{await e.lock({orientation:`portrait`})}catch{}}async function Jo(){await qo()}var Yo=null;function Xo(){return Yo||(Yo=document.createElement(`div`),Yo.id=`network-banner`,Yo.className=`network-banner hidden`,Yo.setAttribute(`role`,`status`),Yo.setAttribute(`aria-live`,`polite`),document.body.appendChild(Yo),Yo)}function Zo(){let e=Xo(),t=!navigator.onLine;e.textContent=t?`No connection — some features need internet`:``,e.classList.toggle(`hidden`,!t)}function Qo(){Zo(),window.addEventListener(`online`,Zo),window.addEventListener(`offline`,Zo)}async function $o(){try{let{Capacitor:e}=await E(async()=>{let{Capacitor:e}=await import(`./dist-DM6qMOWp.js`);return{Capacitor:e}},[],import.meta.url);if(!e.isNativePlatform())return;let{StatusBar:t,Style:n}=await E(async()=>{let{StatusBar:e,Style:t}=await import(`./esm-C-SIlwqj.js`);return{StatusBar:e,Style:t}},[],import.meta.url);await t.setOverlaysWebView({overlay:!0}),await t.setStyle({style:n.Dark}),await t.setBackgroundColor({color:`#080a12`});let{SplashScreen:r}=await E(async()=>{let{SplashScreen:e}=await import(`./esm-Ck_AT-RK.js`);return{SplashScreen:e}},[],import.meta.url);await r.hide()}catch(e){console.warn(`Capacitor init skipped`,e)}}var es=null,ts=!1;async function ns(){if(ts)return es;ts=!0;try{let{Capacitor:e}=await E(async()=>{let{Capacitor:e}=await import(`./dist-DM6qMOWp.js`);return{Capacitor:e}},[],import.meta.url);if(!e.isNativePlatform())return null;let{Haptics:t,ImpactStyle:n}=await E(async()=>{let{Haptics:e,ImpactStyle:t}=await import(`./esm-D_it6P9V.js`);return{Haptics:e,ImpactStyle:t}},[],import.meta.url);es={Haptics:t,ImpactStyle:n}}catch{es=null}return es}async function rs(){if(!H().hapticsEnabled)return;let e=await ns();if(e)try{await e.Haptics.impact({style:e.ImpactStyle.Light})}catch{}}var is={bronze:{label:`Bronze`,tagline:`Same odds as Bronze Chest`,visual:`bronze`,accent:`#c77dff`,glow:`rgba(199, 125, 255, 0.45)`},silver:{label:`Silver`,tagline:`Same odds as Silver Chest`,visual:`silver`,accent:`#7dd3fc`,glow:`rgba(125, 211, 252, 0.5)`},gold:{label:`Gold`,tagline:`Same odds as Gold Chest`,visual:`gold`,accent:`#ffd87a`,glow:`rgba(255, 216, 122, 0.55)`}};function as(e){let t=is[e]||is.style_crate,n=t.visual;return{tier:t,lid:n===`gold`?`#f0e6c8`:n===`silver`?`#e4ecf8`:`#e8c4f8`,body:n===`gold`?`#5a4518`:n===`silver`?`#3d4a62`:`#4a2860`,trim:t.accent,ribbon:n===`gold`?`#ff9de2`:n===`silver`?`#a5f3fc`:`#d8b4fe`}}function os(e,t){let{lid:n,body:r,trim:i,ribbon:a}=as(e);return`
    <defs>
      <linearGradient id="${t}-body" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stop-color="${r}"/>
    ...
    </defs>`}function ss(e,t,n){let{trim:r,ribbon:i,tier:a}=as(e);return`
    ${n?`<g class="chest-stage__interior">
    ...
    </g>`}function cs(e){let t=`vanityStage-${e}`;return`<svg class="chest-stage-svg vanity-box-svg" viewBox="0 0 120 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ${os(e,t)}
    <ellipse class="chest-stage__shadow" cx="60" cy="90" rx="42" ry="8" fill="rgba(0,0,0,0.5)"/>
    ${ss(e,t,!0)}
  </svg>`}function ls(e){let t=`vanityCard-${e}`;return`<svg class="chest-svg vanity-box-svg" viewBox="0 0 120 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ${os(e,t)}
    <ellipse cx="60" cy="90" rx="42" ry="8" fill="rgba(0,0,0,0.5)"/>
    ${ss(e,t,!1)}
  </svg>`}function us(e){let t=ds[e]||ds.avatar_default,n=`av-${e.replace(/[^a-z0-9]/gi,``)}`;return`<svg viewBox="0 0 64 64" class="cosmetic-avatar-svg cosmetic-avatar-svg--${e.replace(`avatar_`,``)}" aria-hidden="true">
    <defs>
    ...
    ${t.svg}
  </svg>`}var ds={avatar_default:{bg:[`#4a5f7a`,`#1e2a3a`],glow:`#8fa4c4`,svg:`<ellipse cx="32" cy="38" rx="14" ry="16" fill="#2a3548"/>
      ...
      <circle cx="36" cy="26" r="2" fill="#0a1628"/>`}};function fs(e){let t={banner_default:`linear-gradient(135deg,#1e2a44,#2d4a6e)`,banner_nebula:`linear-gradient(135deg,#2a1f4e,#6b4fd4 55%,#1a1030)`,banner_crimson:`linear-gradient(135deg,#3a1018,#8b2030 50%,#1a0a10)`,banner_storm:`linear-gradient(135deg,#1a2840,#3d7ab8 45%,#9ad4ff)`,banner_aurora:`linear-gradient(135deg,#0f3d3a,#5ce1e6 40%,#9f7aea 80%,#1a0a20)`,banner_forest:`linear-gradient(135deg,#1a2e0e,#2d5016 50%,#0f1a08)`,banner_sunset:`linear-gradient(135deg,#431407,#c2410c 45%,#fdba74 75%,#1a0a04)`,banner_midnight:`linear-gradient(135deg,#0f172a,#1e3a5f 50%,#020617)`,banner_ocean:`linear-gradient(135deg,#042f2e,#0e7490 45%,#164e63 80%,#020617)`,banner_eclipse:`linear-gradient(135deg,#0a0a0a,#1a1a2e 35%,#fbbf24 50%,#0a0a0a 65%,#312e81)`,banner_sand:`linear-gradient(135deg,#78350f,#d97706 45%,#fcd34d 75%,#451a03)`,banner_mist:`linear-gradient(135deg,#374151,#6b7280 50%,#9ca3af 80%,#1f2937)`,banner_dawn:`linear-gradient(135deg,#4a1942,#ec4899 40%,#fbbf24 70%,#1a0a20)`};return t[e]||t.banner_default}function ps(e){return e===`pieceSkin`?`Piece skin`:e===`frame`?`Frame`:e===`avatar`?`Avatar`:e===`banner`?`Banner`:e}function ms(e){return`profile-frame profile-frame--${(e||`frame_default`).replace(/^frame_/,``)}`}function hs(e){return(e||`frame_default`).replace(/^frame_/,``),`<div class="cosmetic-frame-preview ${ms(e)}">
    <div class="cosmetic-frame-preview__inner">${us(`avatar_default`)}</div>
  </div>`}function gs(e,t){return t===`avatar`?us(e):t===`frame`?hs(e):t===`banner`?`<div class="cosmetic-preview-banner" style="background:${fs(e)}"></div>`:t===`pieceSkin`?_s(e):``}function _s(e){let t=e.replace(`skin_`,``);return`<div class="cosmetic-skin-preview">
    <span class="piece red piece-skin-${t} king"></span>
    <span class="piece black piece-skin-${t}"></span>
  </div>`}function vs(e){let t=document.createElement(`article`);t.className=`cosmetic-reveal-card rarity-${e.rarity} cosmetic-reveal-card--${e.type}`,e.duplicate&&t.classList.add(`cosmetic-reveal-card--duplicate`);let n=gs(e.id,e.type),r=ps(e.type);return t.innerHTML=`
    ...
    </div>`,t.style.animationDelay=`0s`,t}function ys(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function bs(e,t=``){let n=f(e),r=(t||`P`).charAt(0).toUpperCase(),i=us(n.equipped.avatar)||`<span class="profile-avatar-fallback">${ys(r)}</span>`;return`<span class="profile-avatar-stack header-profile-btn__stack ${ms(n.equipped.frame)}"><span class="profile-avatar-inner header-profile-btn__inner">${i}</span></span>`}async function xs(e){if(!e)return``;try{return(await Ae(e.id))?.username||e.user_metadata?.display_name||e.email?.split(`@`)[0]||``}catch{return e.user_metadata?.display_name||e.email?.split(`@`)[0]||``}}var Ss=null;function Cs(){return Ss||=Promise.all([E(()=>import(`./match-PLy7Ns52.js`),[],import.meta.url),E(()=>import(`./matchView-XVqlgu7z.js`),[],import.meta.url),E(()=>Promise.resolve({}),__vite__mapDeps([0]),import.meta.url),E(()=>Promise.resolve({}),__vite__mapDeps([1]),import.meta.url)]).then(([e,t])=>({MatchSession:e.MatchSession,getMatchHtml:t.getMatchHtml})),Ss}var ws=null;function Ts(){return ws||=Promise.all([E(()=>import(`./pvpUI-EBWuu2c9.js`),[],import.meta.url),E(()=>import(`./pvp-4YNULCmk.js`),[],import.meta.url)]).then(([e,t])=>({initPvpUI:e.initPvpUI,clearAllWaitingRoomsOnce:t.clearAllWaitingRoomsOnce})),ws}var Es=null;function Ds(){return Es||=E(()=>import(`./profileUI-D9D6o4Kf.js`),[],import.meta.url),Es}function Os(){Es=null}var ks=null;function As(){return ks||=Promise.all([E(()=>import(`./settingsUI-5RwnOLey.js`),[],import.meta.url),E(()=>Promise.resolve({}),__vite__mapDeps([2]),import.meta.url)]).then(([e])=>e),ks}var js=null;function Ms(){return js||=Promise.all([E(()=>import(`./chestOpenAnimation-xrkYdMXx.js`),[],import.meta.url),E(()=>import(`./cosmeticOpenAnimation-CP7Y_gkh.js`),[],import.meta.url),E(()=>import(`./titleOpenAnimation-BzSk_fvG.js`),[],import.meta.url)]).then(([e,t,n])=>({playChestOpenAnimation:e.playChestOpenAnimation,playCosmeticOpenAnimation:t.playCosmeticOpenAnimation,playTitleOpenAnimation:n.playTitleOpenAnimation})),js}var Ns=null;function Ps(){return Ns||=E(()=>import(`./socialUI-DLeCxhSy.js`),[],import.meta.url),Ns}var Fs=null;function Is(){return Fs||=E(()=>import(`./tutorialMeta-Bj6flnb3.js`),[],import.meta.url),Fs}var Ls=null;function Rs(){return Ls||=E(()=>import(`./tutorialUnlocks-CFXWnO9E.js`),[],import.meta.url),Ls}var zs=null;function Bs(){return zs||=E(()=>import(`./tutorialMatch-BgB7ASfi.js`),[],import.meta.url),zs}function Vs(e,t){Is().then(n=>n.notifyMetaTutorial(e,t)).catch(e=>console.warn(`[Tutorial] meta notify failed`,e))}function Hs(e,t){Rs().then(n=>n.notifyUnlockTutorial(e,t))}var U;try{U=ye()}catch(e){console.error(`Failed to load profile, resetting save:`,e),localStorage.removeItem(`cardCheckersProfile_v7`),localStorage.removeItem(`cardCheckersProfile_v5`),U=ye()}var W=`deck`,Us={deck:`Decks`,chests:`Shop`,play:`Play`,social:`Social`,quests:`Quests`,profile:`Profile`,settings:`Settings`},Ws=new Set(Object.keys(Us)),Gs=null,Ks=null,qs=!1,Js=`cards`,Ys=`list`,G=null,K=[],Xs=null,Zs=``,Qs=`all`,$s=`all`,ec=!0,tc={legendary:5,epic:4,rare:3,uncommon:2,common:1};function nc(e){return[...e].sort((e,t)=>{let n=tc[e.rarity]??0,r=tc[t.rarity]??0;return n===r?e.name.localeCompare(t.name):r-n})}var q=null,rc=null,ic=null,ac=null,oc=null;function sc(){return rc?Promise.resolve(rc):(ic||=Ts().then(({initPvpUI:e,clearAllWaitingRoomsOnce:t})=>(t(),rc=e({arenaRoot:document.getElementById(`play-arena-root`),leaderboardRoot:document.getElementById(`play-leaderboard-root`),getProfile:()=>U,openAuthModal:()=>uc?.open(`signin`,{forced:!0}),onNavigateTab:Z,onNavigatePlayTab:Nc,onNavigatePlayMenu:Mc,onOpenDeckEdit:Nl}),rc)),ic)}function cc(){return ac?Promise.resolve(ac):(oc||=Ps().then(({initSocialUI:e})=>(ac=e({root:document.getElementById(`view-social`),getProfile:()=>U,saveProfile:T,openAuthModal:()=>uc?.open(`signin`,{forced:!0})}),ac)),oc)}var lc=null,uc=null,J=!1,dc=!1,fc=!1,pc=!1,mc=!1,hc=null,gc=null,_c=null,Y=1,vc=null;function yc(e){return tc[e?.rarity]??0}function bc(e){let t=i(e);return Object.entries(t).map(([e,t])=>({def:n(e),count:t})).filter(e=>e.def).sort((e,t)=>{let n=yc(t.def)-yc(e.def);return n===0?e.def.name.localeCompare(t.def.name):n})}function xc(e){let t=K.indexOf(e);t<0||(K.splice(t,1),Ll(),Vs(`card-removed-from-deck`,{cardId:e}))}function Sc(e){let t=K.length;K=K.filter(t=>t!==e),K.length!==t&&(Ll(),Vs(`card-removed-from-deck`,{cardId:e}))}function Cc(){let n=e().map(e=>({def:e,owned:ae(U,e.id)})).filter(e=>e.owned>0).sort((e,t)=>{let n=yc(t.def)-yc(e.def);return n===0?e.def.name.localeCompare(t.def.name):n});K=[];for(let{def:e,owned:r}of n){let n=Math.min(r,t(e));for(let t=0;t<n&&K.length<30;t++)K.push(e.id);if(K.length>=30)break}Ll()}var X=e=>document.getElementById(e);function wc(){let e=document.getElementById(`adventure-prebattle`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function Tc(){let e=document.querySelector(`nav.game-nav.tabs`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function Ec(){return window.matchMedia(`(min-width: 1000px) and (max-width: 1400px)`).matches?2.5:window.matchMedia(`(min-width: 600px) and (max-width: 999px)`).matches?1.85:1}function Dc(){wc(),document.getElementById(`adventure-prebattle`)?.classList.remove(`hidden`),document.body.classList.add(`adventure-floor-open`)}function Oc(){document.getElementById(`adventure-prebattle`)?.classList.add(`hidden`),document.body.classList.remove(`adventure-floor-open`)}function kc(e=le,t=`Locked`){Yn({title:t,bodyHtml:e,autoCloseMs:4500})}function Ac(){document.body.classList.toggle(`main-tab-active`,Ws.has(W)),document.body.classList.toggle(`play-sub-active`,W===`play`&&Gs!==null),document.body.classList.toggle(`adventure-active`,W===`play`&&Gs===`adventure`)}function jc(){let e=d(U);for(let t of[`arena`,`leaderboard`]){let n=document.querySelector(`.play-tab[data-play-tab="${t}"]`);n&&(n.classList.toggle(`play-tab--locked`,!e),n.setAttribute(`aria-disabled`,e?`false`:`true`),n.title=e?``:m(`PvP`))}}function Mc(){Gs=null,X(`play-menu`)?.classList.remove(`hidden`),document.querySelectorAll(`.play-tab-panel`).forEach(e=>{e.classList.add(`hidden`),e.hidden=!0}),Ac(),jc()}async function Nc(e){if(!qs&&(e===`arena`||e===`leaderboard`)&&!d(U)){let e=tn(),t=$t;await tt(e?`${m(`PvP`)}\n\n${t}.`:m(`PvP`),{title:`PvP locked`,confirmLabel:`Go to Adventure`,cancelLabel:e?`Sign in`:`Not now`})?(qs=!0,Nc(`adventure`),qs=!1):e&&uc?.open(`signin`,{forced:!0});return}Gs=e,X(`play-menu`)?.classList.add(`hidden`),document.querySelectorAll(`.play-tab`).forEach(t=>{let n=t.dataset.playTab===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,n?`true`:`false`)}),document.querySelectorAll(`.play-tab-panel`).forEach(t=>{let n=t.id===`play-tab-${e}`;t.classList.toggle(`hidden`,!n),t.hidden=!n}),Ac(),Hs(`play-tab-changed`,{tab:e}),e===`adventure`?Hl():e===`arena`?sc().then(e=>{e?.setScreen?.(`arena`),e?.render({resume:!0})}):e===`leaderboard`&&sc().then(e=>{e?.setScreen?.(`leaderboard`),e?.render()})}function Pc(e,t,n){let r=e.querySelector(`.tab-btn__sign-in-badge`);t?(r||(r=document.createElement(`span`),r.className=`tab-btn__sign-in-badge`,r.setAttribute(`aria-hidden`,`true`),e.appendChild(r)),r.textContent=n,e.classList.add(`tab-btn--sign-in-nudge`)):(r?.remove(),e.classList.remove(`tab-btn--sign-in-nudge`))}function Fc(){let e=d(U),t=tn();jc();let n=document.querySelector(`.tab-btn[data-tab="quests"]`);if(n){let r=!e,i=en;n.classList.toggle(`tab-btn--locked`,r),n.setAttribute(`aria-disabled`,r?`true`:`false`),r?(n.title=t?`${m(`Quests`)} ${i}.`:m(`Quests`),Pc(n,t,`Sign in`)):t?(n.title=i,Pc(n,!1)):(n.title=``,Pc(n,!1))}let r=document.querySelector(`.tab-btn[data-tab="social"]`);r&&(t?(r.title=en,Pc(r,!0,`Sign in`)):(r.title=``,Pc(r,!1)));let i=c(U),a=document.querySelector(`.vault-tab[data-vault-tab="cosmetics"]`);a&&(a.classList.toggle(`vault-tab--locked`,!i),a.title=i?``:_e,a.setAttribute(`aria-disabled`,i?`false`:`true`))}async function Z(e){let t=document.getElementById(`view-match`);if(!(J&&t&&!t.classList.contains(`hidden`))&&!(t&&!t.classList.contains(`hidden`)&&t.querySelector(`.pvp-loading`)&&e!==W)){if(!dc&&e===`quests`&&!d(U)){let e=tn(),t=en;await tt(e?`${m(`Quests`)}\n\n${t}.`:m(`Quests`),{title:`Quests locked`,confirmLabel:`Go to Adventure`,cancelLabel:e?`Sign in`:`Not now`})?(dc=!0,Z(`play`),dc=!1):e&&uc?.open(`signin`,{forced:!0});return}if(fr(),rr()&&ar()){if(e===W||t?.querySelector(`.pvp-loading`)||!await tt(`Leave your current match to open ${Us[e]||e}?`,{title:`Leave match?`,confirmLabel:`Leave`,cancelLabel:`Stay`,destructive:!0}))return;or(e),e===`play`&&(Ks=`arena`),lr(),document.querySelector(`#btn-leave-match`)?.click();return}if(Ys===`edit`&&(e!==`deck`||e===`deck`&&W===`deck`)){if(!await jl())return;Ml()}if(e!==`deck`&&Ys===`edit`&&(ul(),document.body.classList.remove(`deck-editing`)),W=e,Ac(),Ws.has(e)&&cl(),document.querySelectorAll(`.tab-btn`).forEach(t=>{t.classList.toggle(`active`,t.dataset.tab===e)}),document.querySelectorAll(`.view`).forEach(t=>{t.classList.toggle(`hidden`,t.id!==`view-${e}`)}),e===`chests`&&(bl(Js),Sl()),e===`deck`&&(Ys=`list`,fl(`list`)),e===`profile`&&Vc(),e===`settings`&&Hc(),e===`quests`&&(qc(),Zc()),e===`play`){let e=Ks??Gs;Ks=null,e?Nc(e):Mc()}e===`social`&&(ac?ac.refresh?.()??ac.render():(Yc(),cc().then(e=>e?.render()).catch(e=>{console.error(`[Social] init failed`,e),Xc()}))),Vs(`tab-changed`,{tab:e}),Hs(`tab-changed`,{tab:e}),rr()||(zo(`hub`),await qo())}}var Q=``;function Ic(e=Q){e&&(Q=e);let t=document.getElementById(`header-profile-menu`),n=document.getElementById(`header-profile-btn`),r=document.getElementById(`header-username`),i=document.getElementById(`auth-header-btn`),a=!!D();if(i&&(i.classList.toggle(`hidden`,a),i.hidden=a),t&&(t.classList.toggle(`hidden`,!a),t.hidden=!a),r){let e=a&&Q;r.textContent=e?Q:``,r.classList.toggle(`hidden`,!e),r.hidden=!e}n&&a&&(n.innerHTML=bs(U,Q),n.title=Q?`Account — ${Q}`:`Account menu`)}function Lc(){let e=document.getElementById(`header-profile-btn`),t=document.getElementById(`header-profile-dropdown`);!e||!t||(t.classList.add(`hidden`),t.hidden=!0,e.setAttribute(`aria-expanded`,`false`))}function Rc(){let e=document.getElementById(`header-profile-menu`),t=document.getElementById(`header-profile-btn`),n=document.getElementById(`header-profile-dropdown`);if(!e||!t||!n)return;let r=e=>{n.classList.toggle(`hidden`,!e),n.hidden=!e,t.setAttribute(`aria-expanded`,e?`true`:`false`)};t.addEventListener(`click`,e=>{e.stopPropagation();let t=!n.hidden;r(!t)}),n.querySelectorAll(`[data-profile-menu-action]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.profileMenuAction;Lc(),t===`settings`?Z(`settings`):Bc()})}),document.addEventListener(`click`,t=>{n.hidden||e.contains(t.target)||Lc()}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&!n.hidden&&Lc()})}async function zc(){let e=D();if(!e){Q=``,Ic();return}Q=await xs(e),Ic()}function Bc(){Lc(),Z(`profile`),Hs(`profile-opened`)}async function Vc(){let{renderProfileTab:e}=await Ds(),t=X(`view-profile`);e(U,t,{onGemsChange:Qc,onTitleChanged:()=>Ic()})}async function Hc(){let{renderSettingsTab:e}=await As();e(X(`view-settings`),{onUsernameChanged:e=>{Q=e,Ic(e)}})}var Uc=`
  ...
  <section class="panel game-panel social-panel social-panel--error">
  ...
  </section>`;function qc(){let e=X(`view-quests`);e&&(e.innerHTML=Uc)}function Jc(e=X(`view-quests`)){e&&(e.innerHTML=Wc,e.querySelector(`.quests-retry-btn`)?.addEventListener(`click`,()=>{Os(),qc(),Zc()}))}function Yc(){let e=X(`view-social`);e&&(e.innerHTML=Gc)}function Xc(e=X(`view-social`)){e&&(e.innerHTML=Kc,e.querySelector(`.social-retry-btn`)?.addEventListener(`click`,()=>{ac=null,oc=null,Yc(),cc().then(e=>e?.render()).catch(t=>{console.error(`[Social] retry failed`,t),Xc(e)})}))}async function Zc(){let e=X(`view-quests`);if(e)try{let{renderQuestsTab:t}=await Ds();t(U,e,{onTitleChanged:()=>Ic(),onCurrencyChange:()=>$()})}catch(t){console.error(`[Quests] render failed`,t),Jc(e)}}function $(){let e=X(`header-gems`);e&&(e.textContent=String(U.gems??0));let t=X(`header-stars`);t&&(t.textContent=String(U.stars??0)),document.querySelector(`.hud-gems`)?.classList.toggle(`hud-gems--low`,(U.gems??0)<50),document.querySelector(`.hud-stars`)?.classList.toggle(`hud-stars--low`,(U.stars??0)<10)}function Qc(){$()}function $c(){document.querySelectorAll(`.collection-owned-only-toggle`).forEach(e=>{e.checked=ec});for(let e of[`collection-search`]){let t=X(e);t&&(t.value=Zs)}for(let e of[`collection-rarity`]){let t=Cr(e);t&&(t.value=Qs)}let e=Cr(`collection-category`);e&&(e.value=$s)}var el=`(max-width: 899px)`,tl=`(max-width: 1280px)`,nl=null;function rl(){return window.matchMedia(el).matches}function il(){return document.body.classList.contains(`main-tab-active`)&&!document.body.classList.contains(`match-active`)&&!document.body.classList.contains(`deck-editing`)&&window.matchMedia(tl).matches}function al(){return document.querySelector(`.game-main`)}function ol(){let e=al();return il()&&e?e.scrollTop:window.scrollY||document.documentElement.scrollTop||0}function sl(e){let t=al();if(il()&&t){t.scrollTop=e;return}window.scrollTo(0,e)}function cl(){let e=al();if(il()&&e){e.scrollTop=0;return}window.scrollTo(0,0)}function ll(){rl()&&(nl=ol(),document.body.style.position=`fixed`,document.body.style.top=`0`,document.body.style.left=`0`,document.body.style.right=`0`,document.body.style.width=`100%`)}function ul(){if(nl==null)return;let e=nl;nl=null,document.body.style.position=``,document.body.style.top=``,document.body.style.left=``,document.body.style.right=``,document.body.style.width=``,sl(e)}function dl(){cl(),document.documentElement.scrollTop=0,document.body.scrollTop=0,document.querySelector(`.game-shell`)?.scrollTo?.(0,0),al()?.scrollTo?.(0,0),document.querySelector(`#view-deck`)?.scrollTo?.(0,0),document.querySelectorAll(`#deck-subview-edit, #deck-subview-edit .deck-editor, #deck-subview-edit .deck-editor__body, #deck-subview-edit .deck-editor__grid, #deck-subview-edit .deck-editor__grid-cards`).forEach(e=>{e.scrollTop=0})}function fl(e){e!==`edit`&&ul(),Ys=e,document.body.classList.toggle(`deck-editing`,e===`edit`),X(`deck-subview-list`)?.classList.toggle(`hidden`,e!==`list`),X(`deck-subview-edit`)?.classList.toggle(`hidden`,e!==`edit`),e===`edit`&&(ll(),w(U),T(U),Qs=`all`,Zs=``,$s=`all`,ec=!0,$c(),kl()),e===`list`&&Il(),e===`edit`&&(Ll(),dl(),requestAnimationFrame(()=>{dl(),requestAnimationFrame(dl)}))}function pl({id:e,title:t,desc:n,cost:r,variant:i=`mystery`}){let a=(U.stars??0)>=r,o=i===`title`?Ht():Wt();return`
    ...
    </article>`}function ml(e,t){e.querySelector(`[data-mystery-open]`)?.addEventListener(`click`,e=>{e.stopPropagation(),t()}),e.addEventListener(`click`,t),e.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),t())})}function hl({bonusGems:e=0,bonusStars:t=0}={}){let n=[];return e&&n.push(`+${e} gem refund`),t&&n.push(`+${t} ★ from duplicates`),n.length?` (${n.join(`, `)})`:``}async function gl(e,t){let{playChestOpenAnimation:n,playCosmeticOpenAnimation:r,playTitleOpenAnimation:i}=await Ms();e.kind===`card`?(await n({tier:`silver`,tierLabel:`Mystery Box`,pulls:e.cardPulls}),t&&(t.textContent=`Got ${e.cardPulls.length} spells.${hl(e)}`)):e.kind===`cosmetic`?(await r({boxId:`silver`,boxLabel:`Mystery Box`,pulls:e.cosPulls}),t&&(t.textContent=e.message+hl(e))):e.kind===`mixed`?(e.cardPulls.length&&await n({tier:`silver`,tierLabel:`Mystery Box — Spells`,pulls:e.cardPulls}),e.cosPulls.length&&await r({boxId:`silver`,boxLabel:`Mystery Box — Cosmetics`,pulls:e.cosPulls}),t&&(t.textContent=`${e.message}${hl(e)}`)):e.kind===`title`&&(await i({boxLabel:`Title Box`,pulls:e.pulls}),t&&(t.textContent=e.message))}async function _l(){let e=X(`mystery-box-log`);if(!((U.stars??0)>=10)){e&&(e.textContent=`Need 10 ★ stars. Clear Adventure floors to earn stars.`,e.classList.add(`chest-log--error`));return}let t=Xt(U);if(!t.success){e&&(e.textContent=t.message,e.classList.add(`chest-log--error`));return}T(U),$(),e&&e.classList.remove(`chest-log--error`),X(`mystery-box-list`)?.querySelectorAll(`.mystery-box__btn`).forEach(e=>{e.disabled=!0});try{await gl(t,e)}catch(n){console.error(`Mystery box animation failed:`,n),e&&(e.textContent=t.message)}Sl({clearPulls:!1}),Vc()}async function vl(){let e=X(`mystery-box-log`);if(!((U.stars??0)>=10)){e&&(e.textContent=`Need 10 ★ stars. Clear Adventure floors to earn stars.`,e.classList.add(`chest-log--error`));return}let t=Zt(U);if(!t.success){e&&(e.textContent=t.message,e.classList.add(`chest-log--error`));return}T(U),$(),e&&e.classList.remove(`chest-log--error`),X(`mystery-box-list`)?.querySelectorAll(`.mystery-box__btn`).forEach(e=>{e.disabled=!0});try{await gl(t,e)}catch(n){console.error(`Title box animation failed:`,n),e&&(e.textContent=t.message)}Sl({clearPulls:!1}),Vc()}function yl(){let e=X(`mystery-box-list`);if(!e)return;e.innerHTML=`
    ${pl({id:`mystery`,title:`Mystery Box`,desc:`6 random pulls — mix of spells and cosmetics (${Math.round(Gt*100)}% cosmetic per slot when unlocked).`,cost:10})}
    ${pl({id:`title`,title:`Title Box`,desc:`Box-exclusive mage titles only — The Brave, Ruthless, Omnipotent, and more.`,cost:10,variant:`title`})}
  `;let t=e.querySelectorAll(`.mystery-box`);ml(t[0],()=>_l()),ml(t[1],()=>vl())}function bl(e){if(!fc&&e===`cosmetics`&&!c(U)){kc(_e,`Cosmetics locked`),fc=!0,bl(`cards`),fc=!1;return}Js=e,document.querySelectorAll(`.vault-tab`).forEach(t=>{let n=t.dataset.vaultTab===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,n?`true`:`false`)}),document.querySelectorAll(`.vault-tab-panel`).forEach(t=>{let n=t.id===`vault-tab-${e}`;t.classList.toggle(`hidden`,!n),t.hidden=!n}),Hs(`vault-tab-changed`,{tab:e})}function xl(){Ds().then(({renderCosmeticBoxes:e})=>{e(U,X(`cosmetic-box-list`),{logEl:X(`cosmetic-box-log`),onGemsChange:Qc,cosmeticsUnlocked:c(U),onOpened:()=>{W===`profile`&&Vc(),W===`quests`&&Zc()}})}).catch(e=>{console.error(`[Shop] cosmetics render failed`,e);let t=X(`cosmetic-box-log`);t&&(t.textContent=`Couldn't load cosmetic boxes — try again from the Shop tab.`,t.classList.add(`chest-log--error`))})}function Sl(e={}){let{clearPulls:t=!0}=e;$(),xl(),yl();let n=X(`chest-list`),r=X(`chest-pulls`);if(r&&t&&(r.innerHTML=``,r.classList.add(`chest-pulls--hidden`),r.classList.remove(`chest-pulls--reveal`)),n){n.innerHTML=``;for(let e of dt){let t=yt[e.id]||yt.bronze,i=U.gems>=e.cost,a=document.createElement(`article`);a.className=`chest-card chest-card--${e.id}${i?``:` chest-card--locked`}`,a.innerHTML=`
    ...
    `;let o=a.querySelector(`.chest-open`);o.disabled=!i,o.addEventListener(`click`,async()=>{if(o.disabled)return;let n=gt(U,e.id),i=X(`chest-log`);if(!n.success){i&&(i.textContent=n.message,i.classList.add(`chest-log--error`));return}T(U),$(),o.disabled=!0;let{playChestOpenAnimation:a}=await Ms();if(await a({tier:e.id,tierLabel:t.label,pulls:n.pulls}),Vs(`chest-opened`,{chestId:e.id}),i){let t=n.bonusGems?` (+${n.bonusGems} gems from duplicates)`:``;i.textContent=`Got ${n.pulls.length} spells from ${e.name}.${t}`,i.classList.remove(`chest-log--error`)}if(r){r.classList.remove(`chest-pulls--hidden`),r.classList.add(`chest-pulls--reveal`),r.innerHTML=`<p class="chest-pulls__label">Chest opened</p><div class="chest-pulls__grid"></div>`;let e=r.querySelector(`.chest-pulls__grid`);n.pulls.forEach((t,n)=>{let r=no(t,{button:!0,deal:!0,gallery:!0,onClick:()=>co(t)});if(r.style.animationDelay=`${n*.12}s`,t.duplicate){r.classList.add(`spell-card--duplicate-pull`);let e=document.createElement(`span`);e.className=`chest-pull-dup-badge`,e.textContent=t.starRefund?`Duplicate · +${t.starRefund} ★`:`Duplicate · +${t.gemRefund} ◆`,r.appendChild(e)}e.appendChild(r),ho(r,t.rarity)}),uo(e),r.scrollIntoView({behavior:`smooth`,block:`nearest`})}Sl()}),n.appendChild(a)}}}function Cl(){return nc(e().filter(e=>{if($s!==`all`&&ut(e)!==$s||Qs!==`all`&&e.rarity!==Qs)return!1;if(Zs){let t=Zs.toLowerCase();if(!e.name.toLowerCase().includes(t)&&!e.desc.toLowerCase().includes(t))return!1}return!(ec&&ae(U,e.id)<=0)}))}function wl(e,t){let n=vo(U,e);return t&&(t.textContent=n.message,t.className=n.success?`deck-status ok`:`deck-status warn`),n.success&&(T(U),$(),Ys===`list`&&Il(),Ys===`edit`&&Ll()),n}function Tl(e,t){let n=vo(U,e);return n.success?(T(U),$(),K.push(e),he(U,e),T(U),Ll(),t&&(t.hidden=!1,t.textContent=`Bought and added to deck.`,t.className=`deck-editor__error deck-status ok`),!0):(t&&(t.hidden=!1,t.textContent=n.message,t.className=`deck-editor__error deck-status warn`),!1)}function El(e){return a(K,e,U).ok?(K.push(e),he(U,e),T(U),Ll(),Vs(`card-added-to-deck`,{cardId:e}),!0):!1}function Dl(e,n,r={}){let{deckEdit:o=!1,statusEl:s=null}=r,c=ae(U,n.id),l=t(n),u=c>=l,d=_o(n.rarity),f=U.gems>=d&&!u,p=o?a(K,n.id,U):{ok:!1},m=o&&i(K)[n.id]||0,h=K.length<30,g=m<l,_=c>=1&&c<=m,v=c>=1&&!u,y=o&&!p.ok&&h&&g&&_&&v,ee=()=>wl(n.id,s),x=()=>{let e=ae(U,n.id),t=o&&i(K)[n.id]||0,r=e>=l,s=U.gems>=d&&!r,c=o?a(K,n.id,U):{ok:!1};co(n,{meta:o?`Owned ${e}/${l} · In deck ${t}/${l} · ${r?`max copies`:`${d} gems per copy`}`:`Owned ${e}/${l}${r?` · max copies`:` · ${d} gems per copy`}`,buyLabel:r?`Max copies owned`:`Buy copy (${d} gems)`,buyDisabled:!s||r||e<1,onBuy:()=>{ee(),so()},addDisabled:!c.ok,onAdd:o?()=>{El(n.id)&&x()}:void 0})};if(o){let t=document.createElement(`div`);t.className=`deck-editor-tile`+(b(U,n.id)?` deck-editor-tile--new`:``);let r=no(n,{button:!0,gallery:!0,onClick:()=>x()});r.classList.add(`deck-editor-tile__card`),r.title=`${n.name} — tap for full card`;let i=c>0?`Owned ${c}/${l}`:`Not in collection`,a=document.createElement(`div`);a.className=`deck-editor-tile__meta`,a.innerHTML=`${i} · In deck ${m}/${l}${b(U,n.id)?`<span class="deck-editor-tile__new">New</span>`:``}`,a.addEventListener(`click`,()=>x());let o=document.createElement(`button`);o.type=`button`,o.className=`deck-editor-tile__action`,p.ok?(o.classList.add(`deck-editor-tile__action--add`),o.textContent=`+ Add to deck`,o.addEventListener(`click`,e=>{e.stopPropagation(),El(n.id)})):y?(o.classList.add(`deck-editor-tile__action--buy`),o.textContent=f?`Add for ${d} gems`:`Need ${d} gems`,o.disabled=!f,o.addEventListener(`click`,e=>{e.stopPropagation(),Tl(n.id,s)})):(o.classList.add(`deck-editor-tile__action--disabled`),o.disabled=!0,K.length>=30?o.textContent=`Deck full (30/30)`:m>=l?o.textContent=`Max copies in deck`:c<1?o.textContent=`Open Shop chests to unlock`:p.reason?o.textContent=p.reason:o.textContent=`Can't add`),t.append(r,a,o),e.appendChild(t);return}let S=document.createElement(`div`);S.className=`collection-card-wrap`+(c<1?` collection-card-wrap--unowned`:``);let C=no(n,{button:!0,compact:!0,disabled:c<1||u,onClick:e=>{if(e.shiftKey||c<1||u){x();return}ee()}});C.title=u?`${n.name} — max ${l} copies owned. Tap to view full card.`:c<1?`${n.name} — not owned. Tap to view full card.`:`${n.name} — tap to buy (${d} gems). Shift+click to inspect.`,S.appendChild(C);let w=document.createElement(`span`);w.className=`collection-owned-count`,w.textContent=c>0?`×${c}`:`—`,S.appendChild(w);let te=document.createElement(`span`);te.className=`collection-buy-cost`,te.textContent=u?`MAX`:`${d} ◆`,(!f||u)&&te.classList.add(`collection-buy-cost--cant`),S.appendChild(te),e.appendChild(S)}function Ol(e,t={}){if(!e)return;let{deckEdit:n=!1,statusEl:r=null}=t;e.innerHTML=``;let i=Cl();if(!i.length){e.className=`deck-editor__grid collection-grid`;let t=document.createElement(`p`);t.className=`collection-grid-empty muted`,t.textContent=n?`No spells match your filters. Try “All types”, clear search, or uncheck Owned only.`:`No cards match your filters. Open chests in the Shop to get more spells.`,e.appendChild(t);return}let a=0,o={deckEdit:n,statusEl:r};if(n||$s!==`all`){e.className=`deck-editor__grid collection-grid`;for(let t of i)try{Dl(e,t,o),a+=1}catch(e){console.error(`Failed to render card:`,t?.id,e)}}else{e.className=`deck-editor__grid collection-categories`;let t=Object.fromEntries(st.map(e=>[e,[]]));for(let e of i)t[ut(e)].push(e);for(let n of st){let r=t[n];if(!r.length)continue;let i=document.createElement(`section`);i.className=`collection-category-section`,i.dataset.category=n;let s=document.createElement(`h3`);s.className=`collection-category-title`,s.textContent=ct[n],i.appendChild(s);let c=document.createElement(`div`);c.className=`collection-grid deck-editor__grid-cards`;for(let e of r)try{Dl(c,e,o),a+=1}catch(t){console.error(`Failed to render card:`,e?.id,t)}i.appendChild(c),e.appendChild(i)}}if(i.length>0&&a===0){e.className=`deck-editor__grid collection-grid`;let t=document.createElement(`p`);t.className=`collection-grid-empty collection-grid-empty--error`,t.textContent=`Spells failed to display. Hard refresh the page (Ctrl+Shift+R).`,e.appendChild(t)}}function kl(){Xs={name:X(`deck-name-input`)?.value?.trim()??``,cardIds:[...K]}}function Al(){return Xs?(X(`deck-name-input`)?.value?.trim()??``)!==Xs.name||K.length!==Xs.cardIds.length?!0:K.some((e,t)=>e!==Xs.cardIds[t]):!1}async function jl(){return Al()?tt(`Discard unsaved changes to this deck?`,{title:`Unsaved changes`,confirmLabel:`Discard`,cancelLabel:`Keep editing`,destructive:!0}):!0}function Ml(){G=null,K=[],Xs=null}function Nl(e){let t=U.decks.find(t=>t.id===e);if(!t)return;G=t.id,K=[...t.cardIds];let n=X(`deck-name-input`);n&&(n.value=t.name),fl(`edit`),Vs(`deck-edit-opened`,{deckId:e})}function Pl(e){let t=Object.fromEntries(st.map(e=>[e,0]));for(let r of e){let e=n(r);e&&(t[ut(e)]+=1)}return t}function Fl(e){let t=Pl(e),n=[];for(let e of st){let r=t[e];if(r<=0)continue;let i=ct[e];n.push(`<span class="deck-row__cat" title="${ro(i)}: ${r}"><span class="deck-row__cat-dot deck-row__cat-dot--${e}" aria-hidden="true"></span><span class="deck-row__cat-n">${r}</span></span>`)}return n.length?`<div class="deck-row__cats">${n.join(``)}</div>`:``}function Il(){w(U)&&T(U),$();let e=X(`deck-list`);if(!e)return;e.innerHTML=``;let t=X(`deck-list-count`);if(t){let e=U.decks.length;t.textContent=e?`${e} deck${e===1?``:`s`}`:``}if(!U.decks.length){if(w(U)&&T(U),U.decks.length){Il();return}e.innerHTML=`
      ...
      <h3 class="deck-row-name">${ro(t.name)}</h3>
      <div class="deck-row__progress">
        <div class="deck-progress-bar deck-row__progress-bar" role="progressbar" aria-valuemin="0" aria-valuemax="30" aria-valuenow="${t.cardIds.length}" aria-label="${ro(t.name)} progress">
    ...
    `,a.addEventListener(`click`,()=>Nl(t.id)),e.appendChild(a)}}function Ll(){$();let e=X(`collection-grid`),t=X(`deck-slots`),n=X(`deck-status`),i=X(`edit-deck-heading`),a=X(`deck-count-badge`),o=X(`deck-progress-bar`);if(!e||!t)return;let s=X(`btn-delete-deck`);s&&(s.hidden=!(G&&G!==`new`&&G!==`deck-starter`)),i&&(i.textContent=G===`new`?`New deck`:`In your deck`);let c=r(K,U),l=`${K.length}/30`;a&&(a.textContent=l,a.classList.toggle(`deck-editor__count--ready`,c.valid));let u=X(`deck-progress-fill`),d=Math.min(100,K.length/30*100);u&&(u.style.width=`${d}%`),o&&(o.hidden=c.valid,c.valid||(o.setAttribute(`aria-valuenow`,String(K.length)),o.setAttribute(`aria-valuemax`,`30`))),n&&(c.valid?(n.textContent=``,n.hidden=!0,n.className=`deck-editor__error deck-status ok`):(n.hidden=!1,n.textContent=c.errors[0]||`${l} — keep adding spells`,n.className=`deck-editor__error deck-status warn`));let f=X(`deck-collection-hint`);f&&(f.hidden=!1,f.innerHTML=K.length>=30?`Deck is full. Remove a card from the strip above, or save when ready.`:`Tap <strong>+ Add to deck</strong> for copies you own. When all owned copies are in the deck, tap <strong>Add for X gems</strong> to buy another.`),Ol(e,{deckEdit:!0,statusEl:n}),t.innerHTML=``;let p=bc(K);if(!p.length){let e=document.createElement(`p`);e.className=`deck-editor__strip-empty`,e.textContent=`Empty deck — tap + Add to deck below`,t.appendChild(e)}for(let{def:e,count:n}of p){let r=document.createElement(`div`);r.className=`deck-slot-wrap deck-slot-wrap--strip`;let i=no(e,{button:!0,tiny:!0,onClick:()=>{co(e,{meta:n>1?`${n} copies in deck`:`In your deck`,onRemove:()=>Sc(e.id)})}});if(r.appendChild(i),n>1){let e=document.createElement(`span`);e.className=`deck-stack-count`,e.textContent=`×${n}`,r.appendChild(e)}let a=document.createElement(`button`);a.type=`button`,a.className=`deck-slot-remove deck-slot-remove--visible`,a.setAttribute(`aria-label`,`Remove one ${e.name} from deck`),a.textContent=`−`,a.addEventListener(`click`,t=>{t.stopPropagation(),xc(e.id)}),r.appendChild(a),t.appendChild(r)}}function Rl(){let e=X(`deck-name-input`)?.value?.trim()||`My Deck`,t=r(K,U);if(!t.valid){X(`deck-status`).textContent=t.errors.join(` `);return}let n;G&&G!==`new`?(n=U.decks.find(e=>e.id===G),n?(n.name=e,n.cardIds=[...K],n.updatedAt=Date.now()):n=y(e,K)):n=y(e,K),ne(U,n),U.selectedDeckId=n.id,T(U),Vs(`deck-saved`,{deckId:n.id}),Ml(),fl(`list`)}function zl(e=[]){let t=`New Deck`,n=new Set(e.map(e=>e.name?.trim()).filter(Boolean));if(!n.has(t))return t;let r=2;for(;n.has(`${t} ${r}`);)r++;return`${t} ${r}`}function Bl(){G=`new`,K=[];let e=X(`deck-name-input`);e&&(e.value=zl(U.decks)),fl(`edit`)}function Vl(){Oc(),_c=null}function Hl(){U.adventure=s(U.adventure),X(`adventure-map-view`)?.classList.remove(`hidden`),Vl(),vc=null,Jl()}function Ul(e){let t=x[e]||x.verdant,n=`map-${e}`;return`<svg class="adventure-map-scenery-svg" viewBox="0 0 100 120" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
    <defs>
  ...
  </svg>`}function Wl(e=`#e8c547`){return`<svg class="adventure-map-tile__pawn-svg" viewBox="0 0 28 36" aria-hidden="true">
    <defs>
  ...
  </svg>`}function Gl(e){let t=x[e]||x.verdant;return`<svg class="adventure-map-tile__banner-svg" viewBox="0 0 24 20" aria-hidden="true">
    <defs>
    ...
    <div class="adventure-map-canvas__bg" aria-hidden="true">
      <div class="adventure-map-scenery adventure-map-scenery--${i}" aria-hidden="true">${Ul(i)}</div>
    ...
    <div class="adventure-map-tower">
    ...
    </div>`;let d=r.querySelector(`.adventure-map-tiles`),f=r.querySelector(`.adventure-map-tower`),p=re(Y),m=v(e),h=Ec();f?.style.setProperty(`--tower-top-ratio`,`0.72`),f?.style.setProperty(`--adventure-map-scale`,String(h)),p.forEach((t,n)=>{let r=_(e,t.id),o=Se(e,t.id),s=t.id===m&&r,c=ie(e,t.id),l=(t.floorInWorld-1)/9,u=1-l*.26,f=u*h,p=(1-l*.1)*h,g=Math.sin((t.floorInWorld-1)*.62)*.32*u*h,v=document.createElement(`button`);v.type=`button`,v.className=`adventure-map-tile`,v.classList.add(`adventure-map-tile--floor-${t.floorInWorld}`),v.style.zIndex=String(n+10),v.style.setProperty(`--floor-scale`,f.toFixed(4)),v.style.setProperty(`--floor-height-scale`,p.toFixed(4)),v.style.setProperty(`--floor-offset-x`,`${g.toFixed(3)}rem`),v.dataset.level=String(t.id),r||v.classList.add(`adventure-map-tile--locked`),o&&v.classList.add(`adventure-map-tile--cleared`),s&&v.classList.add(`adventure-map-tile--next`),t.floorInWorld>=7&&t.floorInWorld<10&&v.classList.add(`adventure-map-tile--rampart`),t.floorInWorld===10&&v.classList.add(`adventure-map-tile--summit`),v.setAttribute(`aria-disabled`,r?`false`:`true`),r||(v.title=`Clear global floor ${t.id-1} to unlock`),v.setAttribute(`aria-label`,`Floor ${t.floorInWorld}: ${t.opponent}, ${t.flavor}`);let y=o?`<span class="adventure-map-tile__stars">${C(c)}</span>`:``,ee=s?`<span class="adventure-map-tile__pawn">${Wl(a.accent)}</span>`:``,b=t.floorInWorld===10?`<span class="adventure-map-tile__banner">${Gl(i)}</span>`:``,x=t.floorInWorld>1&&t.floorInWorld<10?`<span class="adventure-map-tile__windows" aria-hidden="true"></span>`:``,S=o?`<span class="adventure-map-tile__torch" aria-hidden="true"></span>`:``;v.innerHTML=`
      ${ee}
      ${b}
      <span class="adventure-map-tile__stone" aria-hidden="true">
      ...
      </span>`,r||(v.disabled=!0),v.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),nu(t.id))}),d?.appendChild(v)});let y=X(`adventure-floor-list`);if(y){y.classList.add(`adventure-floor-list--sr`),y.innerHTML=``;for(let t of p){let n=_(e,t.id),r=Se(e,t.id),i=t.id===m&&n,a=ie(e,t.id),o=document.createElement(`button`);o.type=`button`,o.className=`adventure-floor-row`,n||(o.disabled=!0),r&&o.classList.add(`adventure-floor-row--cleared`),i&&o.classList.add(`adventure-floor-row--next`),o.innerHTML=`
        ...
        ${a>0?`<span class="adventure-floor-row__stars">${C(a)}</span>`:``}`,o.addEventListener(`click`,()=>nu(t.id)),y.appendChild(o)}}let b=r.querySelector(`.adventure-map-tile--next`);Kl(r),b&&requestAnimationFrame(()=>{requestAnimationFrame(()=>b.scrollIntoView({behavior:`smooth`,block:`nearest`}))});let S=y?.querySelector(`.adventure-floor-row--next`);S&&requestAnimationFrame(()=>S.scrollIntoView({behavior:`smooth`,block:`end`})),r.querySelector(`.adventure-challenge-toggle`)?.addEventListener(`click`,t=>{t.preventDefault(),t.stopPropagation(),e.challengeMode=!e.challengeMode,U.adventure=e,T(U),rs(),Uo.tap(),Jl()})}function Yl(e){let t=ue(e);if(!t||!_(U.adventure,e))return;_c=e,Dc();let n=X(`prebattle-title`),i=X(`prebattle-flavor`),a=X(`prebattle-opponent`);n&&(n.textContent=`Tower ${t.worldId} · Floor ${t.floorInWorld}`),i&&(i.textContent=t.flavor||``),a&&(a.textContent=`Loading…`);try{vc=xe(U,e),T(U)}catch(e){console.error(`Enemy deck failed`,e),a&&(a.textContent=`Could not build enemy deck. Try again.`);return}a&&(a.textContent=`Review the enemy spell deck, then choose your grimoire below.`);let o=X(`prebattle-gem-hint`);if(o){let n=te(U.adventure,e);o.textContent=(Se(U.adventure,e)?`Repeat clear: +${n} gems`:`First clear: +${n} gems`)+(t.worldId===5&&Ce(U.adventure)?` · Challenge mode: enemy has an extra rank of pieces`:``)}let s=X(`enemy-deck-preview`);if(s){s.innerHTML=``;try{for(let{def:e,count:t}of me(vc)){if(!e)continue;let n=document.createElement(`button`);n.type=`button`,n.className=`enemy-deck-spell-btn`,n.title=`View ${e.name}`;let r=document.createElement(`span`);if(r.className=`enemy-deck-spell-btn__name`,r.textContent=e.name,n.appendChild(r),t>1){let e=document.createElement(`span`);e.className=`enemy-deck-spell-btn__count`,e.textContent=`×${t}`,n.appendChild(e)}n.addEventListener(`click`,()=>co(e,{meta:t>1?`${t} copies in enemy deck`:`Enemy deck`})),s.appendChild(n)}}catch(e){console.error(`Enemy preview failed`,e),s.innerHTML=`<p class="empty-msg">Enemy deck preview unavailable.</p>`}}w(U)&&T(U);let c=Cr(`adventure-deck-select`);if(!c){a&&(a.textContent=`Deck selector missing — hard refresh the page.`);return}c.innerHTML=``;let l=U.decks.filter(e=>r(e.cardIds,U).valid);if(!l.length){let e=document.createElement(`option`);e.value=``,e.textContent=`No complete decks — build one in Decks`,c.appendChild(e),c.disabled=!0,X(`btn-start-adventure`).disabled=!0;return}c.disabled=!1;let u=U.selectedDeckId&&l.some(e=>e.id===U.selectedDeckId)?U.selectedDeckId:l[0].id;for(let e of l){let t=document.createElement(`option`);t.value=e.id,t.textContent=e.name,e.id===u&&(t.selected=!0),c.appendChild(t)}U.selectedDeckId=u,X(`btn-start-adventure`).disabled=!1}async function Xl(e,t,n,r,i=null,a=!1,o=void 0){let s=t.opponent;Vl(),vc=null,document.querySelectorAll(`.view`).forEach(e=>e.classList.add(`hidden`)),X(`view-match`)?.classList.remove(`hidden`);let c=X(`view-match`);if(!c)return;let{MatchSession:u,getMatchHtml:d}=await Cs();c.innerHTML=d(s);let p=o??(we(r).id===5&&Ce(U.adventure)),m={levelId:r,deckId:e.id,challengeMode:p},h={aiDeckIds:n,opponentName:s,cosmetics:f(U),profile:U,challengeMode:p,buildGameOverActions:({won:e,isTie:t})=>Ql(m,{won:e,isTie:t}),onGameOverAction:e=>{$l(e,m,c)}};i&&(h.initialState=i);try{q=new u(e.cardIds,c,()=>{q=null,gr(),qo(),zo(`hub`),c.innerHTML=``,X(`view-match`)?.classList.add(`hidden`);let e=sr();e?Z(e):(Ks=`adventure`,Z(`play`)),pc&&iu(),mc&&au()},e=>{let t=se(U,r,e),{gems:n,stars:i,starsGained:a}=t;return U.gems+=n,fe(U,`adventure_floors`,1),l(U),T(U),$(),Fc(),r===1&&t.firstTime&&(pc=!0,iu()),r===5&&t.firstTime&&(mc=!0),{message:`+${n} gems! · Best: ${C(i)}`,starsGained:a}},h)}catch(e){throw q=null,c.innerHTML=``,X(`view-match`)?.classList.add(`hidden`),Z(`play`),e}mr({kind:`adventure`,deckId:e.id,deckCardIds:e.cardIds,aiDeckIds:n,opponentName:s,levelId:r,challengeMode:p}),await qo(),zo(`match`),a&&(q.winRewarded=!0),_r(q),q.setMessage(``),q.render()}async function Zl(){let e=vr();if(!e)return!1;let t=U.decks.find(t=>t.id===e.deckId)||U.decks.find(e=>e.cardIds?.length===30),n=e.levelId?ue(e.levelId):null;return!t||t.cardIds.length!==30||!n||!e.aiDeckIds?.length||!await tt(`Resume your adventure match where you left off?`,{title:`Resume match?`,confirmLabel:`Resume`,cancelLabel:`Discard`})?(hr(),!1):(_c=e.levelId,await Xl(t,n,e.aiDeckIds,e.levelId,e.state,e.winRewarded,e.challengeMode),q?.setMessage(`Match resumed — pick up where you left off.`),!0)}function Ql({levelId:e},{won:t,isTie:n}){let r=e+1,i=t&&r<=50&&_(U.adventure,r);if(n)return[{id:`backToAdventure`,label:`Back to Adventure`,primary:!0}];if(t){let e=[];return i?(e.push({id:`nextFloor`,label:`Next floor`,primary:!0}),e.push({id:`retry`,label:`Retry floor`}),e.push({id:`backToAdventure`,label:`Back to Adventure`})):(e.push({id:`backToAdventure`,label:`Back to Adventure`,primary:!0}),e.push({id:`retry`,label:`Retry floor`})),e}return[{id:`retry`,label:`Retry floor`,primary:!0},{id:`backToAdventure`,label:`Back to Adventure`}]}async function $l(e,{levelId:t,deckId:n,challengeMode:r},i){let a=U.decks.find(e=>e.id===n);if(e===`backToAdventure`){q?.onExit?.();return}if(e===`nextFloor`){let e=t+1;if(!ue(e)||!_(U.adventure,e)){q?.onExit?.();return}q?.dispose(),q=null,gr({clearCheckpoint:!0}),qo(),zo(`hub`),i&&(i.innerHTML=``),X(`view-match`)?.classList.add(`hidden`),await Z(`play`),Yl(e);return}if(e===`retry`){let e=t,n=ue(e);if(!a||a.cardIds.length!==30||!n){q?.onExit?.();return}q?.dispose(),q=null,gr(),await Xl(a,n,xe(U,e),e,null,!1,r)}}function eu(){let e=Cr(`adventure-deck-select`)?.value,t=U.decks.find(t=>t.id===e),n=_c,r=n?ue(n):null,i=vc?[...vc]:null;if(!t||t.cardIds.length!==30||!r||!i?.length){let e=X(`prebattle-opponent`);e&&(!t||t.cardIds.length!==30?e.textContent=`Build a complete 30-card deck in the Decks tab, then try again.`:e.textContent=`Could not start battle — close and pick the floor again.`);return}Xl(t,r,i,n)}function tu(){if(window.__adventureMapCaptureBound)return;window.__adventureMapCaptureBound=!0;let e=null,t=!1,n=0,r=e=>e.closest?.(`#adventure-map .adventure-map-tile, #adventure-map .adventure-map-pin`),i=e=>e?.closest?.(`.adventure-map-scene`),a=()=>{t=!0,clearTimeout(n),n=setTimeout(()=>{t=!1},280)},o=(e,t)=>{if(!e||e.disabled)return;let n=Number(e.dataset.level);!Number.isFinite(n)||n<1||(t.preventDefault(),t.stopPropagation(),nu(n))};document.addEventListener(`pointerdown`,t=>{if(t.button!==0)return;let n=r(t.target);if(!n||n.disabled)return;let a=i(n);e={pin:n,pointerId:t.pointerId,startX:t.clientX,startY:t.clientY,scrollTop:a?.scrollTop??0,scrollLeft:a?.scrollLeft??0,cancelled:!1}},!0),document.addEventListener(`pointermove`,t=>{if(!e||t.pointerId!==e.pointerId||e.cancelled)return;let n=t.clientX-e.startX,r=t.clientY-e.startY;Math.hypot(n,r)>12&&(e.cancelled=!0);let a=i(e.pin);a&&(Math.abs(a.scrollTop-e.scrollTop)>3&&(e.cancelled=!0),Math.abs(a.scrollLeft-e.scrollLeft)>3&&(e.cancelled=!0))},!0),document.addEventListener(`pointerup`,t=>{if(!e||t.pointerId!==e.pointerId)return;let{pin:n,cancelled:r}=e;if(e=null,r){a();return}o(n,t),a()},!0),document.addEventListener(`pointercancel`,t=>{!e||t.pointerId!==e.pointerId||(e=null,a())},!0),document.addEventListener(`click`,e=>{if(t){e.preventDefault(),e.stopPropagation();return}let n=r(e.target);!n||n.disabled||o(n,e)},!0)}function nu(e){let t=s(U.adventure);if(U.adventure=t,!_(t,e)){kc(`Locked — beat global floor ${e-1} first, then return here.`,`Floor locked`);return}T(U),Yl(e)}function ru(){Tc(),window.addEventListener(`orientationchange`,Tc),window.addEventListener(`resize`,Tc),Ac(),Eo(),bo(),Qo(),Vo(),Jo(),$o(),lo(),tu(),wc(),document.querySelector(`.adventure-map-scene`)?.addEventListener(`scroll`,ql,{passive:!0});let e;window.addEventListener(`resize`,()=>{clearTimeout(e),e=setTimeout(()=>{if(!document.body.classList.contains(`adventure-active`))return;let e=X(`adventure-map`);e&&Kl(e)},120)}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&Vl()}),document.querySelectorAll(`.tab-btn`).forEach(e=>{e.addEventListener(`click`,()=>{rs(),Uo.tap(),Z(e.dataset.tab)})}),document.querySelectorAll(`.play-tab`).forEach(e=>{e.addEventListener(`click`,()=>{if(fr(),W!==`play`){Ks=e.dataset.playTab,Z(`play`);return}Nc(e.dataset.playTab)})}),document.querySelectorAll(`.play-sub-back`).forEach(e=>{e.addEventListener(`click`,()=>{rs(),Uo.tap(),Mc()})}),document.querySelectorAll(`.vault-tab`).forEach(e=>{e.addEventListener(`click`,()=>{fr(),bl(e.dataset.vaultTab)})}),X(`btn-new-deck`)?.addEventListener(`click`,Bl),X(`btn-back-from-edit`)?.addEventListener(`click`,async()=>{await jl()&&(Ml(),fl(`list`))}),X(`btn-delete-deck`)?.addEventListener(`click`,async()=>{if(!G||G===`new`)return;let e=U.decks.find(e=>e.id===G);e&&await tt(`Delete "${e.name}"? This cannot be undone.`,{title:`Delete deck?`,confirmLabel:`Delete`,cancelLabel:`Keep`,destructive:!0})&&(de(U,e.id),Ml(),fl(`list`))});let t=()=>{Ys===`edit`&&Ll(),Ys===`list`&&Il()};document.querySelectorAll(`.collection-owned-only-toggle`).forEach(e=>{e.addEventListener(`change`,e=>{ec=e.target.checked,$c(),t()})}),document.querySelectorAll(`.btn-reset-collection-filters`).forEach(e=>{e.addEventListener(`click`,()=>{Qs=`all`,Zs=``,$s=`all`,ec=!0,$c(),t()})}),$c(),wr(),X(`collection-search`)?.addEventListener(`input`,e=>{Zs=e.target.value,t()}),Cr(`collection-category`)?.addEventListener(`change`,e=>{$s=e.target.value,t()}),Cr(`collection-rarity`)?.addEventListener(`change`,e=>{Qs=e.target.value,t()}),X(`btn-clear-deck`)?.addEventListener(`click`,()=>{K=[],Ll()}),X(`btn-auto-finish-deck`)?.addEventListener(`click`,Cc),X(`btn-save-deck`)?.addEventListener(`click`,Rl),X(`btn-back-adventure`)?.addEventListener(`click`,Vl),X(`adventure-floor-backdrop`)?.addEventListener(`click`,Vl),X(`btn-start-adventure`)?.addEventListener(`click`,eu),Cr(`adventure-deck-select`)?.addEventListener(`change`,e=>{U.selectedDeckId=e.target.value,T(U)});let n=document.getElementById(`auth-modal`),r=document.getElementById(`auth-header-btn`);Rc(),Zn(`play-help-btn`,`play-help-desc`),Zn(`adventure-help-btn`,`adventure-help-desc`),Zn(`shop-help-btn`,`shop-help-desc`),Zn(`deck-help-btn`,`deck-help-desc`),lc=vn({onSignIn:()=>uc?.open(`signin`,{forced:!0}),onSignUp:()=>uc?.open(`signup`,{forced:!0}),onGuest:()=>{rn(),du()}}),uc=gn({authBtn:r,modal:n,onNewAccount:()=>{U=nn()||!ge()?ye():pe(),jn(U,T)},onSignedIn:()=>{an(),Nr(),U=ye(),w(U),An(U),$(),Il(),yl(),lc?.hide(),zc().then(()=>{W===`profile`&&Vc(),W===`quests`&&Zc(),W===`play`&&sc().then(e=>e?.render({resume:!0})),W===`social`&&cc().then(e=>e?.refresh?.()??e?.render())}),sc().then(e=>e?.render({resume:!0})),lu(),uu(),cu(),su(),J||Z(W)},onSignedOut:()=>{an(),Pr(),Lc(),Q=``,Ic(),rc?.dispose?.(),q=null,gr({clearCheckpoint:!0}),fr(),U=pe(),Fc(),$(),Il(),yl(),lc?.show(),Z(`deck`)}}),yr(()=>q),w(U),$c(),Fc(),fu()}function iu(){if(!pc||hc!=null)return;let e=0,t=()=>{if(hc=null,e+=1,pc){if(ar()){e<10&&(hc=window.setTimeout(t,400));return}if(An(U),cu()){pc=!1;return}e<10&&(hc=window.setTimeout(t,500))}};hc=window.setTimeout(t,350)}function au(){if(!mc||gc!=null)return;let e=0,t=()=>{if(gc=null,e+=1,mc){if(ar()){e<10&&(gc=window.setTimeout(t,400));return}if(An(U),su()){mc=!1;return}e<10&&(gc=window.setTimeout(t,500))}};gc=window.setTimeout(t,350)}function ou(){return J||!_n()||!d(U)||!zn(U)?!1:(J=!0,Z(`play`),Rs().then(({startPvpTutorial:e})=>{e({profile:U,saveProfile:T,onComplete:()=>{J=!1,U=ye(),w(U),Fc(),Z(`play`),su()}})}),!0)}function su(){return J||!_n()||!c(U)||Pn(U)||Fn(U)||Rn(U)||zn(U)||!Vn(U)?!1:(J=!0,Z(`play`),Rs().then(({startCosmeticsTutorial:e})=>{e({profile:U,saveProfile:T,onComplete:()=>{J=!1,U=ye(),w(U),Fc(),Z(`play`)}})}),!0)}function cu(){return J||!_n()||!d(U)?!1:(An(U),Rn(U)?(J=!0,Z(`play`),Rs().then(({startQuestsTutorial:e})=>{e({profile:U,saveProfile:T,onComplete:()=>{J=!1,U=ye(),w(U),Fc(),ou(),su()}})}),!0):ou())}function lu(){return J||!_n()||!Pn(U)?!1:(J=!0,Bs().then(({startInteractiveTutorial:e})=>{e({profile:U,saveProfile:T,onComplete:()=>{J=!1,U=ye(),w(U),$(),Il(),yl(),uu()||Z(`deck`),cu(),su()}})}),!0)}function uu(){return J||!_n()||!Fn(U)?!1:(J=!0,Z(`deck`),Is().then(({startMetaTutorial:e})=>{e({profile:U,saveProfile:T,onComplete:()=>{J=!1,U=ye(),w(U),$(),Il(),yl(),Z(`deck`),cu(),su()}})}),!0)}async function du(){lc?.hide(),!lu()&&(uu()||cu()||su()||J||(await Zl()||await Z(`deck`),fr(),zo(`hub`)))}async function fu(){try{if(await Le()){Nr();try{let e=await fn();e&&(U=e)}catch(e){console.warn(`Cloud sync on load failed`,e)}w(U),$(),Il(),yl()}}catch(e){console.warn(`Auth init failed`,e)}if(An(U),await zc(),rc&&W===`play`&&(Gs===`arena`||Gs===`leaderboard`)&&rc.render(),fr(),yn()){lc?.show();return}await du()}ru(),E(async()=>{let{registerSW:e}=await import(`./virtual_pwa-register-CpSsV7JG.js`);return{registerSW:e}},[],import.meta.url).then(({registerSW:e})=>{e({immediate:!0})}),nt(),ot();export{sr as A,Ln as B,jr as C,hr as D,Cr as E,_r as F,en as G,Hn as H,Zn as I,Tt as J,Vt as K,Bn as L,gr as M,ar as N,cr as O,fr as P,Mn as R,Lr as S,Sr as T,on as U,In as V,$t as W,tt as X,vt as Y,Ye as Z,To as _,fs as a,co as b,ps as c,gs as d,vs as f,H as g,zo as h,is as i,mr as j,ur as k,ms as l,Bo as m,bs as n,cs as o,qo as p,yt as q,xs as r,ls as s,Cs as t,us as u,ho as v,Mr as w,no as x,uo as y,Nn as z};