...
import{n as e,o as t,t as n}from"./cardCatalog-AnvdLb5p.js";import{i as r,r as i,u as a}from"./deckRules-B0ev_ycV.js";import{A as o,At as s,Ct as c,D as l,Dt as u,Et as d,G as f,H as p,Ot as m,P as h,St as ee,Tt as g,_t as _,a as v,bt as te,c as y,ct as b,d as x,dt as S,f as C,ft as ne,g as re,gt as ie,ht as ae,i as oe,j as se,kt as ce,l as le,lt as ue,m as w,mt as de,o as fe,ot as pe,p as me,pt as he,r as ge,s as _e,st as ve,t as ye,u as T,ut as be,vt as xe,wt as Se,xt as Ce,yt as we,z as Te}from"./storage-D61OLkcg.js";import{l as Ee,p as De,r as Oe}from"./mageTitles-BPvsmJqw.js";import{t as E}from"./preload-helper-CV77j2BA.js";import{a as ke,c as Ae,d as je,g as Me,h as Ne,l as Pe,o as D,p as Fe,s as Ie,t as Le,v as Re}from"./auth-12TAJw7y.js";var ze=Object.defineProperty,Be=(e,t)=>{let n={};for(var r in e)ze(n,r,{get:e[r],enumerable:!0});return t||ze(n,Symbol.toStringTag,{value:`Module`}),n};function Ve(){let e=window.visualViewport;return e?Math.max(0,Math.round(e.offsetTop)):0}function He(){let e=window.visualViewport;return e?Math.max(0,Math.round(window.innerHeight-e.offsetTop-e.height)):0}function Ue(){let e=document.documentElement,t=()=>{e.style.setProperty(`--viewport-inset-top`,`${Ve()}px`),e.style.setProperty(`--viewport-inset-bottom`,`${He()}px`)};t(),window.visualViewport?.addEventListener(`resize`,t),window.visualViewport?.addEventListener(`scroll`,t),window.addEventListener(`resize`,t),window.addEventListener(`orientationchange`,t)}Ue();var We=1100,Ge=120;function Ke(){let e=document.getElementById(`app-splash`);if(!e||e.classList.contains(`app-splash--hide`))return;e.classList.add(`app-splash--hide`),document.body.classList.remove(`splash-active`);let t=()=>{e.remove()};e.addEventListener(`transitionend`,t,{once:!0}),window.setTimeout(t,600)}function qe(){Ke()}function Je(){let e=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches?Ge:We,t=performance.now(),n=()=>{let n=performance.now()-t,r=Math.max(0,e-n);window.setTimeout(Ke,r)};document.readyState===`interactive`||document.readyState===`complete`?n():document.addEventListener(`DOMContentLoaded`,n,{once:!0})}document.body.classList.add(`splash-active`),Je();var Ye=`(max-width: 768px)`,Xe=null;function Ze(){return document.getElementById(`mobile-confirm`)}function Qe(e){let t=Ze();if(!t)return;t.classList.add(`hidden`),document.body.classList.remove(`mobile-confirm-open`);let n=Xe;Xe=null,n?.(e)}function $e(e,t={}){if(!window.matchMedia(Ye).matches)return Promise.resolve(window.confirm(e));let n=Ze();if(!n)return Promise.resolve(window.confirm(e));let{title:r=`Confirm`,confirmLabel:i=`OK`,cancelLabel:a=`Cancel`,destructive:o=!1}=t;return new Promise(t=>{Xe&&Qe(!1),Xe=t,n.querySelector(`#mobile-confirm-title`).textContent=r,n.querySelector(`#mobile-confirm-body`).textContent=e;let s=n.querySelector(`#mobile-confirm-ok`),c=n.querySelector(`#mobile-confirm-cancel`);s.textContent=i,c.textContent=a,s.classList.toggle(`btn-danger`,o),s.classList.toggle(`btn-primary`,!o),n.classList.remove(`hidden`),document.body.classList.add(`mobile-confirm-open`),c.focus()})}function et(){let e=Ze();!e||e.dataset.bound||(e.dataset.bound=`1`,e.querySelector(`#mobile-confirm-ok`)?.addEventListener(`click`,()=>Qe(!0)),e.querySelector(`#mobile-confirm-cancel`)?.addEventListener(`click`,()=>Qe(!1)),e.querySelector(`[data-mobile-confirm-backdrop]`)?.addEventListener(`click`,()=>Qe(!1)))}var tt=`cc_install_banner_dismissed`;function nt(){return window.matchMedia(`(display-mode: standalone)`).matches||window.navigator.standalone===!0}function rt(){let e=window.navigator.userAgent;return/iphone|ipad|ipod/i.test(e)&&!/crios|fxios/i.test(e)}function it(){if(nt()||localStorage.getItem(tt)===`1`)return;let e=document.getElementById(`install-banner`);if(!e)return;let t=null,n=()=>{e.classList.remove(`hidden`),document.body.classList.add(`install-banner-visible`)},r=()=>{e.classList.add(`hidden`),document.body.classList.remove(`install-banner-visible`)};window.addEventListener(`beforeinstallprompt`,r=>{r.preventDefault(),t=r,e.querySelector(`#install-banner-ios-hint`)?.classList.add(`hidden`),e.querySelector(`.install-banner__hint--default`)?.classList.remove(`hidden`),e.querySelector(`#install-banner-btn`)?.classList.remove(`hidden`),n()}),rt()&&(e.querySelector(`#install-banner-ios-hint`)?.classList.remove(`hidden`),e.querySelector(`.install-banner__hint--default`)?.classList.add(`hidden`),e.querySelector(`#install-banner-btn`)?.classList.add(`hidden`),window.setTimeout(n,2500)),e.querySelector(`#install-banner-btn`)?.addEventListener(`click`,async()=>{t&&(t.prompt(),await t.userChoice,t=null,r())}),e.querySelector(`#install-banner-dismiss`)?.addEventListener(`click`,()=>{localStorage.setItem(tt,`1`),r()})}var at=[`attack`,`control`,`defense`,`movement`,`trap`,`special`],ot={attack:`Attack`,control:`Control`,defense:`Defense`,movement:`Movement`,trap:`Trap`,special:`Special`},st={aegis:`defense`,anchor:`defense`,backpedal:`control`,backstab:`attack`,backstep:`movement`,barrier:`defense`,bishops_mark:`movement`,blind:`control`,blizzard:`control`,snowball:`control`,berserk:`movement`,bomb:`attack`,shockwave:`control`,plague:`control`,bulwark:`defense`,create_foe:`special`,call_forward:`movement`,chain_lightning:`attack`,clone:`special`,coin_flip:`attack`,collapse:`special`,confusion:`control`,constitution:`defense`,counterspell:`trap`,crown:`special`,cryo_bolt:`attack`,cull:`attack`,darkness:`defense`,dash:`movement`,deep_freeze:`control`,deflect:`trap`,demote:`control`,deport:`movement`,displacement:`movement`,dominion:`special`,duel:`attack`,earthquake:`special`,execution:`attack`,extract:`control`,pyromancy:`attack`,fusion:`special`,hibernation:`special`,hostile_swap:`movement`,ignore:`special`,iron_will:`defense`,landmine:`trap`,last_king:`special`,bounty:`special`,link_fate:`special`,last_stand:`trap`,martyr:`trap`,leapfrog:`movement`,long_step:`movement`,magnet:`movement`,nudge:`movement`,offering:`special`,panic:`control`,poison:`attack`,mind_control:`special`,mulligan:`special`,zombify:`special`,press:`control`,purify:`special`,quick_march:`movement`,quicksand:`trap`,rally:`defense`,recall:`movement`,repel:`movement`,random_teleport:`movement`,retreat:`movement`,revive:`defense`,rooks_mark:`movement`,root:`control`,sacrifice:`attack`,sanctuary:`defense`,scatter:`movement`,shadow_swap:`movement`,sidestep:`movement`,shatter:`attack`,snipe:`attack`,snowball:`control`,stab:`attack`,stall:`defense`,tangle:`control`,teleport:`movement`,trickster:`special`,vengeance:`trap`,ward:`defense`};function ct(e){let t=st[e?.id];if(t)return t;let n=`${e?.id||``} ${e?.effect||``} ${e?.name||``} ${e?.desc||``}`.toLowerCase();return/trap|mine|quicksand|counterspell|vengeance|last.?stand|martyr/.test(n)?`trap`:/shield|ward|aegis|sanctuary|barrier|anchor|deflect|stall|iron_will|rally|darkness/.test(n)?`defense`:/move|nudge|teleport|recall|leap|step|displace|swap|scatter|retreat|bishop|rook|overrun|promote|pull|push|shift|earthquake|magnet|repel/.test(n)?`movement`:/freeze|blind|confusion|hex|root|panic|press|silence|paraly|control|cannot play|random|mark|poison|die in \d+ turn/.test(n)?`control`:/\bdestroy\b|\bkills?\b|fireball|bolt|stab|snipe|duel|sacrifice|execution|shatter|cull|lightning/.test(n)?`attack`:`special`}var lt=[{id:`bronze`,name:`Bronze Chest`,cost:25,cards:3,weights:{common:70,uncommon:25,rare:5,epic:0}},{id:`silver`,name:`Silver Chest`,cost:50,cards:5,weights:{common:50,uncommon:35,rare:12,epic:3}},{id:`gold`,name:`Gold Chest`,cost:100,cards:8,weights:{common:32,uncommon:38,rare:22,epic:6,legendary:2}}];function ut(e){let t=Math.random()*100,n=0;for(let r of[`common`,`uncommon`,`rare`,`epic`,`legendary`])if(n+=e[r]||0,t<=n)return r;return`common`}function dt(t){let n=e().filter(e=>e.rarity===t);return n.length?n[Math.floor(Math.random()*n.length)]:e()[0]}function ft(e,t){return dt(ut(t.weights))}function pt(e,n,r={}){let{starRefundChance:i=0}=r;if(oe(e,n.id)<t(n))return ye(e,n.id,1),{...n,duplicate:!1};let a=Te[n.rarity]||10;if(i>0&&Math.random()<i){let e=Math.random()<.5?1:2;return{...n,duplicate:!0,starRefund:e}}return{...n,duplicate:!0,gemRefund:a}}function mt(e,t){let n=lt.find(e=>e.id===t);if(!n)return{success:!1,message:`Unknown chest.`};if(e.gems<n.cost)return{success:!1,message:`Not enough gems.`};e.gems-=n.cost;let r=[],i=0;for(let t=0;t<n.cards;t++){let t=pt(e,ft(e,n));r.push(t),t.gemRefund&&(i+=t.gemRefund)}return i&&(e.gems+=i),pe(e,`boxes_opened`,1),w(e),{success:!0,pulls:r,chest:n,bonusGems:i}}var ht=[`common`,`uncommon`,`rare`,`epic`,`legendary`];function gt(e,{minPct:t=1}={}){return ht.filter(n=>(e[n]??0)>=t).map(t=>`${e[t]}% ${t}`).join(` · `)}var _t={bronze:{label:`Bronze`,tagline:`Mostly common cards`,accent:`#cd7f32`,glow:`rgba(205, 127, 50, 0.45)`},silver:{label:`Silver`,tagline:`Balanced card mix`,accent:`#a8b8d8`,glow:`rgba(168, 184, 216, 0.5)`},gold:{label:`Gold`,tagline:`Higher rare & epic odds`,accent:`#e8c547`,glow:`rgba(232, 197, 71, 0.55)`}};function vt(e){let t=_t[e]||_t.bronze;return{t,lid:e===`gold`?`#f5e6a8`:e===`silver`?`#e8eef8`:`#d4954a`,body:e===`gold`?`#7a5c12`:e===`silver`?`#4a5568`:`#5c3a1e`,trim:e===`gold`?`#ffe566`:e===`silver`?`#c8d8f0`:t.accent}}function yt(e,t){let{lid:n,body:r,trim:i}=vt(e);return`
  ...
  `,t.onClick&&l.addEventListener(`click`,n=>t.onClick(n,e)),Ra(l),l}function Ba(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function Va(e){return document.getElementById(e)}function Ha(){let e=Va(`card-preview-modal`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function Ua(e){document.body.classList.toggle(`card-preview-open`,e),window.dispatchEvent(new CustomEvent(`card-preview-change`,{detail:{open:e}}))}function Wa(){Va(`card-preview-modal`)?.classList.add(`hidden`),Va(`card-preview-mount`)?.classList.remove(`card-preview-mount--reveal-only`),Ua(!1)}function Ga(e,t={}){Ha();let n=Va(`card-preview-modal`),r=Va(`card-preview-mount`),i=Va(`card-preview-actions`);if(!(!n||!r||!e)){if(r.innerHTML=``,r.classList.toggle(`card-preview-mount--reveal-only`,!!t.hideDesc),r.appendChild(za(e,{static:!0,hideDesc:t.hideDesc})),i){if(i.innerHTML=``,t.meta){let e=document.createElement(`p`);e.className=`card-preview-meta`,e.textContent=t.meta,i.appendChild(e)}let e=document.createElement(`div`);if(e.className=`card-preview-actions-row`,t.onPlay){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=`Cast spell`,n.addEventListener(`click`,()=>{Wa(),t.onPlay()}),e.appendChild(n)}if(t.onAdd){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=`Add to deck`,n.disabled=!!t.addDisabled,n.addEventListener(`click`,()=>{t.addDisabled||t.onAdd()}),e.appendChild(n)}if(t.onBuy){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=t.buyLabel||`Buy copy`,n.disabled=!!t.buyDisabled,n.addEventListener(`click`,()=>{t.buyDisabled||t.onBuy()}),e.appendChild(n)}if(t.onRemove){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-secondary`,n.textContent=`Remove all from deck`,n.addEventListener(`click`,()=>{t.onRemove(),Wa()}),e.appendChild(n)}e.children.length&&i.appendChild(e)}n.classList.remove(`hidden`),Ua(!0)}}function Ka(){Va(`card-preview-close`)?.addEventListener(`click`,Wa),Va(`card-preview-backdrop`)?.addEventListener(`click`,Wa),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&Wa()})}function qa(e,t=`.spell-card`){e&&e.querySelectorAll(t).forEach((e,t)=>{e.classList.add(`spell-card--deal`),e.style.animationDelay=`${t*.1}s`})}function Ja(e){e&&(e.classList.add(`spell-card--rare-burst`),setTimeout(()=>e.classList.remove(`spell-card--rare-burst`),900))}function Ya(e){e&&(e.classList.add(`spell-card--epic-burst`),setTimeout(()=>e.classList.remove(`spell-card--epic-burst`),1200))}function Xa(e){e&&(e.classList.add(`spell-card--legendary-burst`),setTimeout(()=>e.classList.remove(`spell-card--legendary-burst`),1500))}function Za(e,t){t===`legendary`?Xa(e):t===`epic`?Ya(e):t===`rare`&&Ja(e)}var Qa={common:10,uncommon:20,rare:30,epic:40,legendary:50};function $a(e){return Qa[e]??30}function eo(e,r){let i=oe(e,r);if(i<1)return{success:!1,message:`Get this spell from a chest first.`};let a=n(r);if(!a)return{success:!1,message:`Unknown card.`};let o=t(r);if(i>=o)return{success:!1,message:`You already own the maximum (${o} copies).`};let s=$a(a.rarity);if(e.gems<s)return{success:!1,message:`Need ${s} gems (${e.gems} available).`};e.gems-=s;let c=ye(e,r,1);return c?{success:!0,cost:s,message:`+1 ${a.name} for ${s} gems (${i+c} owned).`}:(e.gems+=s,w(e),{success:!1,message:`You already own the maximum copies for this rarity.`})}var to={deck:`<svg class="nav-icon-svg" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    </div>`,t.style.animationDelay=`0s`,t}function ns(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function rs(e,t=``){let n=f(e),r=(t||`P`).charAt(0).toUpperCase(),i=qo(n.equipped.avatar)||`<span class="profile-avatar-fallback">${ns(r)}</span>`;return`<span class="profile-avatar-stack header-profile-btn__stack ${Zo(n.equipped.frame)}"><span class="profile-avatar-inner header-profile-btn__inner">${i}</span></span>`}async function is(e){if(!e)return``;try{return(await ke(e.id))?.username||e.user_metadata?.display_name||e.email?.split(`@`)[0]||``}catch{return e.user_metadata?.display_name||e.email?.split(`@`)[0]||``}}var as=null;function os(){return as||=Promise.all([E(()=>import(`./match-C3L36taG.js`),[],import.meta.url),E(()=>import(`./matchView-DEgIiRZw.js`),[],import.meta.url),E(()=>Promise.resolve({}),__vite__mapDeps([0]),import.meta.url),E(()=>Promise.resolve({}),__vite__mapDeps([1]),import.meta.url)]).then(([e,t])=>({MatchSession:e.MatchSession,getMatchHtml:t.getMatchHtml})),as}var ss=null;function cs(){return ss||=Promise.all([E(()=>import(`./pvpUI-iHf_pdVu.js`),[],import.meta.url),E(()=>import(`./pvp-COSuyPH_.js`),[],import.meta.url)]).then(([e,t])=>({initPvpUI:e.initPvpUI,clearAllWaitingRoomsOnce:t.clearAllWaitingRoomsOnce})),ss}var ls=null;function us(){return ls||=E(()=>import(`./profileUI-D5SOtr23.js`),[],import.meta.url),ls}function ds(){ls=null}var fs=null;function ps(){return fs||=Promise.all([E(()=>import(`./settingsUI-Cr_3sRqv.js`),[],import.meta.url),E(()=>Promise.resolve({}),__vite__mapDeps([2]),import.meta.url)]).then(([e])=>e),fs}var ms=null;function hs(){return ms||=Promise.all([E(()=>import(`./chestOpenAnimation-Cs5v_kSg.js`),[],import.meta.url),E(()=>import(`./cosmeticOpenAnimation-DrzeyAG1.js`),[],import.meta.url),E(()=>import(`./titleOpenAnimation-B6d0XcHW.js`),[],import.meta.url)]).then(([e,t,n])=>({playChestOpenAnimation:e.playChestOpenAnimation,playCosmeticOpenAnimation:t.playCosmeticOpenAnimation,playTitleOpenAnimation:n.playTitleOpenAnimation})),ms}var gs=null;function _s(){return gs||=E(()=>import(`./socialUI-Bo8Fmwra.js`),[],import.meta.url),gs}var vs=null;function ys(){return vs||=E(()=>import(`./tutorialMeta-DYmcd4e2.js`),[],import.meta.url),vs}var bs=null;function xs(){return bs||=E(()=>import(`./tutorialUnlocks-Btbczg1I.js`),[],import.meta.url),bs}var Ss=null;function Cs(){return Ss||=E(()=>import(`./tutorialMatch-CqvLGzrK.js`),[],import.meta.url),Ss}function ws(e,t){ys().then(n=>n.notifyMetaTutorial(e,t)).catch(e=>console.warn(`[Tutorial] meta notify failed`,e))}function Ts(e,t){xs().then(n=>n.notifyUnlockTutorial(e,t))}var U;try{U=T()}catch(e){console.error(`Failed to load profile, resetting save:`,e),localStorage.removeItem(`cardCheckersProfile_v7`),localStorage.removeItem(`cardCheckersProfile_v5`),U=T()}var W=`deck`,Es={deck:`Decks`,chests:`Shop`,play:`Play`,social:`Social`,quests:`Quests`,profile:`Profile`,settings:`Settings`},Ds=new Set(Object.keys(Es)),Os=`adventure`,ks=null,As=!1,js=`cards`,Ms=`list`,G=null,K=[],Ns=null,Ps=``,Fs=`all`,Is=`all`,Ls=!0,Rs={legendary:5,epic:4,rare:3,uncommon:2,common:1};function zs(e){return[...e].sort((e,t)=>{let n=Rs[e.rarity]??0,r=Rs[t.rarity]??0;return n===r?e.name.localeCompare(t.name):r-n})}var q=null,Bs=null,Vs=null,Hs=null,Us=null;function Ws(){return Bs?Promise.resolve(Bs):(Vs||=cs().then(({initPvpUI:e,clearAllWaitingRoomsOnce:t})=>(t(),Bs=e({arenaRoot:document.getElementById(`play-arena-root`),leaderboardRoot:document.getElementById(`play-leaderboard-root`),getProfile:()=>U,openAuthModal:()=>qs?.open(`signin`,{forced:!0}),onNavigateTab:X,onNavigatePlayTab:gc,onOpenDeckEdit:gl}),Bs)),Vs)}function Gs(){return Hs?Promise.resolve(Hs):(Us||=_s().then(({initSocialUI:e})=>(Hs=e({root:document.getElementById(`view-social`),getProfile:()=>U,saveProfile:w,openAuthModal:()=>qs?.open(`signin`,{forced:!0})}),Hs)),Us)}var Ks=null,qs=null,J=!1,Js=!1,Ys=!1,Xs=!1,Zs=!1,Qs=null,$s=null,ec=null,tc=1,nc=null;function rc(e){return Rs[e?.rarity]??0}function ic(e){let t=r(e);return Object.entries(t).map(([e,t])=>({def:n(e),count:t})).filter(e=>e.def).sort((e,t)=>{let n=rc(t.def)-rc(e.def);return n===0?e.def.name.localeCompare(t.def.name):n})}function ac(e){let t=K.indexOf(e);t<0||(K.splice(t,1),$(),ws(`card-removed-from-deck`,{cardId:e}))}function oc(e){let t=K.length;K=K.filter(t=>t!==e),K.length!==t&&($(),ws(`card-removed-from-deck`,{cardId:e}))}function sc(){let n=e().map(e=>({def:e,owned:oe(U,e.id)})).filter(e=>e.owned>0).sort((e,t)=>{let n=rc(t.def)-rc(e.def);return n===0?e.def.name.localeCompare(t.def.name):n});K=[];for(let{def:e,owned:r}of n){let n=Math.min(r,t(e));for(let t=0;t<n&&K.length<30;t++)K.push(e.id);if(K.length>=30)break}$()}var Y=e=>document.getElementById(e);function cc(){let e=document.getElementById(`adventure-prebattle`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function lc(){let e=document.querySelector(`nav.game-nav.tabs`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function uc(){return window.matchMedia(`(min-width: 1000px) and (max-width: 1400px)`).matches?2.5:window.matchMedia(`(min-width: 600px) and (max-width: 999px)`).matches?1.85:1}function dc(){cc(),document.getElementById(`adventure-prebattle`)?.classList.remove(`hidden`),document.body.classList.add(`adventure-floor-open`)}function fc(){document.getElementById(`adventure-prebattle`)?.classList.add(`hidden`),document.body.classList.remove(`adventure-floor-open`)}function pc(e=ue,t=`Locked`){Gn({title:t,bodyHtml:e,autoCloseMs:4500})}function mc(){document.body.classList.toggle(`main-tab-active`,Ds.has(W)),document.body.classList.toggle(`adventure-active`,W===`play`&&Os===`adventure`)}function hc(){let e=d(U);for(let t of[`arena`,`leaderboard`]){let n=document.querySelector(`.play-tab[data-play-tab="${t}"]`);n&&(n.classList.toggle(`play-tab--locked`,!e),n.setAttribute(`aria-disabled`,e?`false`:`true`),n.title=e?``:m(`PvP`))}}async function gc(e){if(!As&&(e===`arena`||e===`leaderboard`)&&!d(U)){let e=$t(),t=Zt;await $e(e?`${m(`PvP`)}\n\n${t}.`:m(`PvP`),{title:`PvP locked`,confirmLabel:`Go to Adventure`,cancelLabel:e?`Sign in`:`Not now`})?(As=!0,gc(`adventure`),As=!1):e&&qs?.open(`signin`,{forced:!0});return}Os=e,document.querySelectorAll(`.play-tab`).forEach(t=>{let n=t.dataset.playTab===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,n?`true`:`false`)}),document.querySelectorAll(`.play-tab-panel`).forEach(t=>{let n=t.id===`play-tab-${e}`;t.classList.toggle(`hidden`,!n),t.hidden=!n}),mc(),Ts(`play-tab-changed`,{tab:e}),e===`adventure`?wl():e===`arena`?Ws().then(e=>{e?.setScreen?.(`arena`),e?.render({resume:!0})}):e===`leaderboard`&&Ws().then(e=>{e?.setScreen?.(`leaderboard`),e?.render()})}function _c(e,t,n){let r=e.querySelector(`.tab-btn__sign-in-badge`);t?(r||(r=document.createElement(`span`),r.className=`tab-btn__sign-in-badge`,r.setAttribute(`aria-hidden`,`true`),e.appendChild(r)),r.textContent=n,e.classList.add(`tab-btn--sign-in-nudge`)):(r?.remove(),e.classList.remove(`tab-btn--sign-in-nudge`))}function vc(){let e=d(U),t=$t();hc();let n=document.querySelector(`.tab-btn[data-tab="quests"]`);if(n){let r=!e,i=Qt;n.classList.toggle(`tab-btn--locked`,r),n.setAttribute(`aria-disabled`,r?`true`:`false`),r?(n.title=t?`${m(`Quests`)} ${i}.`:m(`Quests`),_c(n,t,`Sign in`)):t?(n.title=i,_c(n,!1)):(n.title=``,_c(n,!1))}let r=document.querySelector(`.tab-btn[data-tab="social"]`);r&&(t?(r.title=Qt,_c(r,!0,`Sign in`)):(r.title=``,_c(r,!1)));let i=c(U),a=document.querySelector(`.vault-tab[data-vault-tab="cosmetics"]`);a&&(a.classList.toggle(`vault-tab--locked`,!i),a.title=i?``:ve,a.setAttribute(`aria-disabled`,i?`false`:`true`))}async function X(e){let t=document.getElementById(`view-match`);if(!(J&&t&&!t.classList.contains(`hidden`))){if(!Js&&e===`quests`&&!d(U)){let e=$t(),t=Qt;await $e(e?`${m(`Quests`)}\n\n${t}.`:m(`Quests`),{title:`Quests locked`,confirmLabel:`Go to Adventure`,cancelLabel:e?`Sign in`:`Not now`})?(Js=!0,X(`play`),Js=!1):e&&qs?.open(`signin`,{forced:!0});return}if(cr(),$n()&&tr()){if(e===W)return;if(!(e===`play`&&document.getElementById(`pvp-match-root`))){if(!await $e(`Leave your current match to open ${Es[e]||e}?`,{title:`Leave match?`,confirmLabel:`Leave`,cancelLabel:`Stay`,destructive:!0}))return;nr(e),e===`play`&&(ks=`arena`),ar(),document.querySelector(`#btn-leave-match`)?.click();return}}if(Ms===`edit`&&(e!==`deck`||e===`deck`&&W===`deck`)){if(!await ml())return;hl()}if(e!==`deck`&&Ms===`edit`&&(qc(),document.body.classList.remove(`deck-editing`)),W=e,mc(),Ds.has(e)&&Gc(),document.querySelectorAll(`.tab-btn`).forEach(t=>{t.classList.toggle(`active`,t.dataset.tab===e)}),document.querySelectorAll(`.view`).forEach(t=>{t.classList.toggle(`hidden`,t.id!==`view-${e}`)}),e===`chests`&&(rl(js),al()),e===`deck`&&(Ms=`list`,Yc(`list`)),e===`profile`&&wc(),e===`settings`&&Tc(),e===`quests`&&(Ac(),Pc()),e===`play`){let e=ks||Os||`adventure`;ks=null,gc(e)}e===`social`&&(Mc(),Gs().then(e=>e?.render()).catch(e=>{console.error(`[Social] init failed`,e),Nc()})),ws(`tab-changed`,{tab:e}),Ts(`tab-changed`,{tab:e}),$n()||(So(`hub`),await Ao())}}var Z=``;function yc(e=Z){e&&(Z=e);let t=document.getElementById(`header-profile-menu`),n=document.getElementById(`header-profile-btn`),r=document.getElementById(`header-username`),i=document.getElementById(`auth-header-btn`),a=!!D();if(i&&(i.classList.toggle(`hidden`,a),i.hidden=a),t&&(t.classList.toggle(`hidden`,!a),t.hidden=!a),r){let e=a&&Z;r.textContent=e?Z:``,r.classList.toggle(`hidden`,!e),r.hidden=!e}n&&a&&(n.innerHTML=rs(U,Z),n.title=Z?`Account — ${Z}`:`Account menu`)}function bc(){let e=document.getElementById(`header-profile-btn`),t=document.getElementById(`header-profile-dropdown`);!e||!t||(t.classList.add(`hidden`),t.hidden=!0,e.setAttribute(`aria-expanded`,`false`))}function xc(){let e=document.getElementById(`header-profile-menu`),t=document.getElementById(`header-profile-btn`),n=document.getElementById(`header-profile-dropdown`);if(!e||!t||!n)return;let r=e=>{n.classList.toggle(`hidden`,!e),n.hidden=!e,t.setAttribute(`aria-expanded`,e?`true`:`false`)};t.addEventListener(`click`,e=>{e.stopPropagation();let t=!n.hidden;r(!t)}),n.querySelectorAll(`[data-profile-menu-action]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.profileMenuAction;bc(),t===`settings`?X(`settings`):Cc()})}),document.addEventListener(`click`,t=>{n.hidden||e.contains(t.target)||bc()}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&!n.hidden&&bc()})}async function Sc(){let e=D();if(!e){Z=``,yc();return}Z=await is(e),yc()}function Cc(){bc(),X(`profile`),Ts(`profile-opened`)}async function wc(){let{renderProfileTab:e}=await us(),t=Y(`view-profile`);e(U,t,{onGemsChange:Fc,onTitleChanged:()=>yc()})}async function Tc(){let{renderSettingsTab:e}=await ps();e(Y(`view-settings`),{onUsernameChanged:e=>{Z=e,yc(e)}})}var Ec=`
  ...
  <section class="panel game-panel social-panel social-panel--error">
  ...
  </section>`;function Ac(){let e=Y(`view-quests`);e&&(e.innerHTML=Ec)}function jc(e=Y(`view-quests`)){e&&(e.innerHTML=Dc,e.querySelector(`.quests-retry-btn`)?.addEventListener(`click`,()=>{ds(),Ac(),Pc()}))}function Mc(){let e=Y(`view-social`);e&&(e.innerHTML=Oc)}function Nc(e=Y(`view-social`)){e&&(e.innerHTML=kc,e.querySelector(`.social-retry-btn`)?.addEventListener(`click`,()=>{Hs=null,Us=null,Mc(),Gs().then(e=>e?.render()).catch(t=>{console.error(`[Social] retry failed`,t),Nc(e)})}))}async function Pc(){let e=Y(`view-quests`);if(e)try{let{renderQuestsTab:t}=await us();t(U,e,{onTitleChanged:()=>yc(),onCurrencyChange:()=>Q()})}catch(t){console.error(`[Quests] render failed`,t),jc(e)}}function Q(){let e=Y(`header-gems`);e&&(e.textContent=String(U.gems??0));let t=Y(`header-stars`);t&&(t.textContent=String(U.stars??0)),document.querySelector(`.hud-gems`)?.classList.toggle(`hud-gems--low`,(U.gems??0)<50),document.querySelector(`.hud-stars`)?.classList.toggle(`hud-stars--low`,(U.stars??0)<10)}function Fc(){Q()}function Ic(){document.querySelectorAll(`.collection-owned-only-toggle`).forEach(e=>{e.checked=Ls});for(let e of[`collection-search`]){let t=Y(e);t&&(t.value=Ps)}for(let e of[`collection-rarity`]){let t=yr(e);t&&(t.value=Fs)}let e=yr(`collection-category`);e&&(e.value=Is)}var Lc=`(max-width: 899px)`,Rc=`(max-width: 1280px)`,zc=null;function Bc(){return window.matchMedia(Lc).matches}function Vc(){return document.body.classList.contains(`main-tab-active`)&&!document.body.classList.contains(`match-active`)&&!document.body.classList.contains(`deck-editing`)&&window.matchMedia(Rc).matches}function Hc(){return document.querySelector(`.game-main`)}function Uc(){let e=Hc();return Vc()&&e?e.scrollTop:window.scrollY||document.documentElement.scrollTop||0}function Wc(e){let t=Hc();if(Vc()&&t){t.scrollTop=e;return}window.scrollTo(0,e)}function Gc(){let e=Hc();if(Vc()&&e){e.scrollTop=0;return}window.scrollTo(0,0)}function Kc(){Bc()&&(zc=Uc(),document.body.style.position=`fixed`,document.body.style.top=`0`,document.body.style.left=`0`,document.body.style.right=`0`,document.body.style.width=`100%`)}function qc(){if(zc==null)return;let e=zc;zc=null,document.body.style.position=``,document.body.style.top=``,document.body.style.left=``,document.body.style.right=``,document.body.style.width=``,Wc(e)}function Jc(){Gc(),document.documentElement.scrollTop=0,document.body.scrollTop=0,document.querySelector(`.game-shell`)?.scrollTo?.(0,0),Hc()?.scrollTo?.(0,0),document.querySelector(`#view-deck`)?.scrollTo?.(0,0),document.querySelectorAll(`#deck-subview-edit, #deck-subview-edit .deck-editor, #deck-subview-edit .deck-editor__body, #deck-subview-edit .deck-editor__grid, #deck-subview-edit .deck-editor__grid-cards`).forEach(e=>{e.scrollTop=0})}function Yc(e){e!==`edit`&&qc(),Ms=e,document.body.classList.toggle(`deck-editing`,e===`edit`),Y(`deck-subview-list`)?.classList.toggle(`hidden`,e!==`list`),Y(`deck-subview-edit`)?.classList.toggle(`hidden`,e!==`edit`),e===`edit`&&(Kc(),C(U),w(U),Fs=`all`,Ps=``,Is=`all`,Ls=!0,Ic(),fl()),e===`list`&&yl(),e===`edit`&&($(),Jc(),requestAnimationFrame(()=>{Jc(),requestAnimationFrame(Jc)}))}function Xc({id:e,title:t,desc:n,cost:r,variant:i=`mystery`}){let a=(U.stars??0)>=r,o=i===`title`?Bt():Ht();return`
    ...
    </article>`}function Zc(e,t){e.querySelector(`[data-mystery-open]`)?.addEventListener(`click`,e=>{e.stopPropagation(),t()}),e.addEventListener(`click`,t),e.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),t())})}function Qc({bonusGems:e=0,bonusStars:t=0}={}){let n=[];return e&&n.push(`+${e} gem refund`),t&&n.push(`+${t} ★ from duplicates`),n.length?` (${n.join(`, `)})`:``}async function $c(e,t){let{playChestOpenAnimation:n,playCosmeticOpenAnimation:r,playTitleOpenAnimation:i}=await hs();e.kind===`card`?(await n({tier:`silver`,tierLabel:`Mystery Box`,pulls:e.cardPulls}),t&&(t.textContent=`Got ${e.cardPulls.length} spells.${Qc(e)}`)):e.kind===`cosmetic`?(await r({boxId:`silver`,boxLabel:`Mystery Box`,pulls:e.cosPulls}),t&&(t.textContent=e.message+Qc(e))):e.kind===`mixed`?(e.cardPulls.length&&await n({tier:`silver`,tierLabel:`Mystery Box — Spells`,pulls:e.cardPulls}),e.cosPulls.length&&await r({boxId:`silver`,boxLabel:`Mystery Box — Cosmetics`,pulls:e.cosPulls}),t&&(t.textContent=`${e.message}${Qc(e)}`)):e.kind===`title`&&(await i({boxLabel:`Title Box`,pulls:e.pulls}),t&&(t.textContent=e.message))}async function el(){let e=Y(`mystery-box-log`);if(!((U.stars??0)>=10)){e&&(e.textContent=`Need 10 ★ stars. Clear Adventure floors to earn stars.`,e.classList.add(`chest-log--error`));return}let t=Jt(U);if(!t.success){e&&(e.textContent=t.message,e.classList.add(`chest-log--error`));return}w(U),Q(),e&&e.classList.remove(`chest-log--error`),Y(`mystery-box-list`)?.querySelectorAll(`.mystery-box__btn`).forEach(e=>{e.disabled=!0});try{await $c(t,e)}catch(n){console.error(`Mystery box animation failed:`,n),e&&(e.textContent=t.message)}al({clearPulls:!1}),wc()}async function tl(){let e=Y(`mystery-box-log`);if(!((U.stars??0)>=10)){e&&(e.textContent=`Need 10 ★ stars. Clear Adventure floors to earn stars.`,e.classList.add(`chest-log--error`));return}let t=Yt(U);if(!t.success){e&&(e.textContent=t.message,e.classList.add(`chest-log--error`));return}w(U),Q(),e&&e.classList.remove(`chest-log--error`),Y(`mystery-box-list`)?.querySelectorAll(`.mystery-box__btn`).forEach(e=>{e.disabled=!0});try{await $c(t,e)}catch(n){console.error(`Title box animation failed:`,n),e&&(e.textContent=t.message)}al({clearPulls:!1}),wc()}function nl(){let e=Y(`mystery-box-list`);if(!e)return;e.innerHTML=`
    ${Xc({id:`mystery`,title:`Mystery Box`,desc:`6 random pulls — mix of spells and cosmetics (${Math.round(Ut*100)}% cosmetic per slot when unlocked).`,cost:10})}
    ${Xc({id:`title`,title:`Title Box`,desc:`Box-exclusive mage titles only — The Brave, Ruthless, Omnipotent, and more.`,cost:10,variant:`title`})}
  `;let t=e.querySelectorAll(`.mystery-box`);Zc(t[0],()=>el()),Zc(t[1],()=>tl())}function rl(e){if(!Ys&&e===`cosmetics`&&!c(U)){pc(ve,`Cosmetics locked`),Ys=!0,rl(`cards`),Ys=!1;return}js=e,document.querySelectorAll(`.vault-tab`).forEach(t=>{let n=t.dataset.vaultTab===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,n?`true`:`false`)}),document.querySelectorAll(`.vault-tab-panel`).forEach(t=>{let n=t.id===`vault-tab-${e}`;t.classList.toggle(`hidden`,!n),t.hidden=!n}),Ts(`vault-tab-changed`,{tab:e})}function il(){us().then(({renderCosmeticBoxes:e})=>{e(U,Y(`cosmetic-box-list`),{logEl:Y(`cosmetic-box-log`),onGemsChange:Fc,cosmeticsUnlocked:c(U),onOpened:()=>{W===`profile`&&wc(),W===`quests`&&Pc()}})}).catch(e=>{console.error(`[Shop] cosmetics render failed`,e);let t=Y(`cosmetic-box-log`);t&&(t.textContent=`Couldn't load cosmetic boxes — try again from the Shop tab.`,t.classList.add(`chest-log--error`))})}function al(e={}){let{clearPulls:t=!0}=e;Q(),il(),nl();let n=Y(`chest-list`),r=Y(`chest-pulls`);if(r&&t&&(r.innerHTML=``,r.classList.add(`chest-pulls--hidden`),r.classList.remove(`chest-pulls--reveal`)),n){n.innerHTML=``;for(let e of lt){let t=_t[e.id]||_t.bronze,i=U.gems>=e.cost,a=document.createElement(`article`);a.className=`chest-card chest-card--${e.id}${i?``:` chest-card--locked`}`,a.innerHTML=`
    ...
    `;let o=a.querySelector(`.chest-open`);o.disabled=!i,o.addEventListener(`click`,async()=>{if(o.disabled)return;let n=mt(U,e.id),i=Y(`chest-log`);if(!n.success){i&&(i.textContent=n.message,i.classList.add(`chest-log--error`));return}w(U),Q(),o.disabled=!0;let{playChestOpenAnimation:a}=await hs();if(await a({tier:e.id,tierLabel:t.label,pulls:n.pulls}),ws(`chest-opened`,{chestId:e.id}),i){let t=n.bonusGems?` (+${n.bonusGems} gems from duplicates)`:``;i.textContent=`Got ${n.pulls.length} spells from ${e.name}.${t}`,i.classList.remove(`chest-log--error`)}if(r){r.classList.remove(`chest-pulls--hidden`),r.classList.add(`chest-pulls--reveal`),r.innerHTML=`<p class="chest-pulls__label">Chest opened</p><div class="chest-pulls__grid"></div>`;let e=r.querySelector(`.chest-pulls__grid`);n.pulls.forEach((t,n)=>{let r=za(t,{button:!0,deal:!0,gallery:!0,onClick:()=>Ga(t)});if(r.style.animationDelay=`${n*.12}s`,t.duplicate){r.classList.add(`spell-card--duplicate-pull`);let e=document.createElement(`span`);e.className=`chest-pull-dup-badge`,e.textContent=t.starRefund?`Duplicate · +${t.starRefund} ★`:`Duplicate · +${t.gemRefund} ◆`,r.appendChild(e)}e.appendChild(r),Za(r,t.rarity)}),qa(e),r.scrollIntoView({behavior:`smooth`,block:`nearest`})}al()}),n.appendChild(a)}}}function ol(){return zs(e().filter(e=>{if(Is!==`all`&&ct(e)!==Is||Fs!==`all`&&e.rarity!==Fs)return!1;if(Ps){let t=Ps.toLowerCase();if(!e.name.toLowerCase().includes(t)&&!e.desc.toLowerCase().includes(t))return!1}return!(Ls&&oe(U,e.id)<=0)}))}function sl(e,t){let n=eo(U,e);return t&&(t.textContent=n.message,t.className=n.success?`deck-status ok`:`deck-status warn`),n.success&&(w(U),Q(),Ms===`list`&&yl(),Ms===`edit`&&$()),n}function cl(e,t){let n=eo(U,e);return n.success?(w(U),Q(),K.push(e),ge(U,e),w(U),$(),t&&(t.hidden=!1,t.textContent=`Bought and added to deck.`,t.className=`deck-editor__error deck-status ok`),!0):(t&&(t.hidden=!1,t.textContent=n.message,t.className=`deck-editor__error deck-status warn`),!1)}function ll(e){return i(K,e,U).ok?(K.push(e),ge(U,e),w(U),$(),ws(`card-added-to-deck`,{cardId:e}),!0):!1}function ul(e,n,a={}){let{deckEdit:o=!1,statusEl:s=null}=a,c=oe(U,n.id),l=t(n),u=c>=l,d=$a(n.rarity),f=U.gems>=d&&!u,p=o?i(K,n.id,U):{ok:!1},m=o&&r(K)[n.id]||0,h=K.length<30,ee=m<l,g=c>=1&&c<=m,_=c>=1&&!u,v=o&&!p.ok&&h&&ee&&g&&_,te=()=>sl(n.id,s),b=()=>{let e=oe(U,n.id),t=o&&r(K)[n.id]||0,a=e>=l,s=U.gems>=d&&!a,c=o?i(K,n.id,U):{ok:!1};Ga(n,{meta:o?`Owned ${e}/${l} · In deck ${t}/${l} · ${a?`max copies`:`${d} gems per copy`}`:`Owned ${e}/${l}${a?` · max copies`:` · ${d} gems per copy`}`,buyLabel:a?`Max copies owned`:`Buy copy (${d} gems)`,buyDisabled:!s||a||e<1,onBuy:()=>{te(),Wa()},addDisabled:!c.ok,onAdd:o?()=>{ll(n.id)&&b()}:void 0})};if(o){let t=document.createElement(`div`);t.className=`deck-editor-tile`+(y(U,n.id)?` deck-editor-tile--new`:``);let r=za(n,{button:!0,gallery:!0,onClick:()=>b()});r.classList.add(`deck-editor-tile__card`),r.title=`${n.name} — tap for full card`;let i=c>0?`Owned ${c}/${l}`:`Not in collection`,a=document.createElement(`div`);a.className=`deck-editor-tile__meta`,a.innerHTML=`${i} · In deck ${m}/${l}${y(U,n.id)?`<span class="deck-editor-tile__new">New</span>`:``}`,a.addEventListener(`click`,()=>b());let o=document.createElement(`button`);o.type=`button`,o.className=`deck-editor-tile__action`,p.ok?(o.classList.add(`deck-editor-tile__action--add`),o.textContent=`+ Add to deck`,o.addEventListener(`click`,e=>{e.stopPropagation(),ll(n.id)})):v?(o.classList.add(`deck-editor-tile__action--buy`),o.textContent=f?`Add for ${d} gems`:`Need ${d} gems`,o.disabled=!f,o.addEventListener(`click`,e=>{e.stopPropagation(),cl(n.id,s)})):(o.classList.add(`deck-editor-tile__action--disabled`),o.disabled=!0,K.length>=30?o.textContent=`Deck full (30/30)`:m>=l?o.textContent=`Max copies in deck`:c<1?o.textContent=`Open Shop chests to unlock`:p.reason?o.textContent=p.reason:o.textContent=`Can't add`),t.append(r,a,o),e.appendChild(t);return}let x=document.createElement(`div`);x.className=`collection-card-wrap`+(c<1?` collection-card-wrap--unowned`:``);let S=za(n,{button:!0,compact:!0,disabled:c<1||u,onClick:e=>{if(e.shiftKey||c<1||u){b();return}te()}});S.title=u?`${n.name} — max ${l} copies owned. Tap to view full card.`:c<1?`${n.name} — not owned. Tap to view full card.`:`${n.name} — tap to buy (${d} gems). Shift+click to inspect.`,x.appendChild(S);let C=document.createElement(`span`);C.className=`collection-owned-count`,C.textContent=c>0?`×${c}`:`—`,x.appendChild(C);let ne=document.createElement(`span`);ne.className=`collection-buy-cost`,ne.textContent=u?`MAX`:`${d} ◆`,(!f||u)&&ne.classList.add(`collection-buy-cost--cant`),x.appendChild(ne),e.appendChild(x)}function dl(e,t={}){if(!e)return;let{deckEdit:n=!1,statusEl:r=null}=t;e.innerHTML=``;let i=ol();if(!i.length){e.className=`deck-editor__grid collection-grid`;let t=document.createElement(`p`);t.className=`collection-grid-empty muted`,t.textContent=n?`No spells match your filters. Try “All types”, clear search, or uncheck Owned only.`:`No cards match your filters. Open chests in the Shop to get more spells.`,e.appendChild(t);return}let a=0,o={deckEdit:n,statusEl:r};if(n||Is!==`all`){e.className=`deck-editor__grid collection-grid`;for(let t of i)try{ul(e,t,o),a+=1}catch(e){console.error(`Failed to render card:`,t?.id,e)}}else{e.className=`deck-editor__grid collection-categories`;let t=Object.fromEntries(at.map(e=>[e,[]]));for(let e of i)t[ct(e)].push(e);for(let n of at){let r=t[n];if(!r.length)continue;let i=document.createElement(`section`);i.className=`collection-category-section`,i.dataset.category=n;let s=document.createElement(`h3`);s.className=`collection-category-title`,s.textContent=ot[n],i.appendChild(s);let c=document.createElement(`div`);c.className=`collection-grid deck-editor__grid-cards`;for(let e of r)try{ul(c,e,o),a+=1}catch(t){console.error(`Failed to render card:`,e?.id,t)}i.appendChild(c),e.appendChild(i)}}if(i.length>0&&a===0){e.className=`deck-editor__grid collection-grid`;let t=document.createElement(`p`);t.className=`collection-grid-empty collection-grid-empty--error`,t.textContent=`Spells failed to display. Hard refresh the page (Ctrl+Shift+R).`,e.appendChild(t)}}function fl(){Ns={name:Y(`deck-name-input`)?.value?.trim()??``,cardIds:[...K]}}function pl(){return Ns?(Y(`deck-name-input`)?.value?.trim()??``)!==Ns.name||K.length!==Ns.cardIds.length?!0:K.some((e,t)=>e!==Ns.cardIds[t]):!1}async function ml(){return pl()?$e(`Discard unsaved changes to this deck?`,{title:`Unsaved changes`,confirmLabel:`Discard`,cancelLabel:`Keep editing`,destructive:!0}):!0}function hl(){G=null,K=[],Ns=null}function gl(e){let t=U.decks.find(t=>t.id===e);if(!t)return;G=t.id,K=[...t.cardIds];let n=Y(`deck-name-input`);n&&(n.value=t.name),Yc(`edit`),ws(`deck-edit-opened`,{deckId:e})}function _l(e){let t=Object.fromEntries(at.map(e=>[e,0]));for(let r of e){let e=n(r);e&&(t[ct(e)]+=1)}return t}function vl(e){let t=_l(e),n=[];for(let e of at){let r=t[e];if(r<=0)continue;let i=ot[e];n.push(`<span class="deck-row__cat" title="${Ba(i)}: ${r}"><span class="deck-row__cat-dot deck-row__cat-dot--${e}" aria-hidden="true"></span><span class="deck-row__cat-n">${r}</span></span>`)}return n.length?`<div class="deck-row__cats">${n.join(``)}</div>`:``}function yl(){C(U)&&w(U),Q();let e=Y(`deck-list`);if(!e)return;e.innerHTML=``;let t=Y(`deck-list-count`);if(t){let e=U.decks.length;t.textContent=e?`${e} deck${e===1?``:`s`}`:``}if(!U.decks.length){if(C(U)&&w(U),U.decks.length){yl();return}e.innerHTML=`
    ...
    `,i.addEventListener(`click`,()=>gl(t.id)),e.appendChild(i)}}function $(){Q();let e=Y(`collection-grid`),t=Y(`deck-slots`),n=Y(`deck-status`),r=Y(`edit-deck-heading`),i=Y(`deck-count-badge`),o=Y(`deck-progress-bar`);if(!e||!t)return;let s=Y(`btn-delete-deck`);s&&(s.hidden=!(G&&G!==`new`&&G!==`deck-starter`)),r&&(r.textContent=G===`new`?`New deck`:`In your deck`);let c=a(K,U),l=`${K.length}/30`;i&&(i.textContent=l,i.classList.toggle(`deck-editor__count--ready`,c.valid));let u=Y(`deck-progress-fill`),d=Math.min(100,K.length/30*100);u&&(u.style.width=`${d}%`),o&&(o.hidden=c.valid,c.valid||(o.setAttribute(`aria-valuenow`,String(K.length)),o.setAttribute(`aria-valuemax`,`30`))),n&&(c.valid?(n.textContent=``,n.hidden=!0,n.className=`deck-editor__error deck-status ok`):(n.hidden=!1,n.textContent=c.errors[0]||`${l} — keep adding spells`,n.className=`deck-editor__error deck-status warn`));let f=Y(`deck-collection-hint`);f&&(f.hidden=!1,f.innerHTML=K.length>=30?`Deck is full. Remove a card from the strip above, or save when ready.`:`Tap <strong>+ Add to deck</strong> for copies you own. When all owned copies are in the deck, tap <strong>Add for X gems</strong> to buy another.`),dl(e,{deckEdit:!0,statusEl:n}),t.innerHTML=``;let p=ic(K);if(!p.length){let e=document.createElement(`p`);e.className=`deck-editor__strip-empty`,e.textContent=`Empty deck — tap + Add to deck below`,t.appendChild(e)}for(let{def:e,count:n}of p){let r=document.createElement(`div`);r.className=`deck-slot-wrap deck-slot-wrap--strip`;let i=za(e,{button:!0,tiny:!0,onClick:()=>{Ga(e,{meta:n>1?`${n} copies in deck`:`In your deck`,onRemove:()=>oc(e.id)})}});if(r.appendChild(i),n>1){let e=document.createElement(`span`);e.className=`deck-stack-count`,e.textContent=`×${n}`,r.appendChild(e)}let a=document.createElement(`button`);a.type=`button`,a.className=`deck-slot-remove deck-slot-remove--visible`,a.setAttribute(`aria-label`,`Remove one ${e.name} from deck`),a.textContent=`−`,a.addEventListener(`click`,t=>{t.stopPropagation(),ac(e.id)}),r.appendChild(a),t.appendChild(r)}}function bl(){let e=Y(`deck-name-input`)?.value?.trim()||`My Deck`,t=a(K,U);if(!t.valid){Y(`deck-status`).textContent=t.errors.join(` `);return}let n;G&&G!==`new`?(n=U.decks.find(e=>e.id===G),n?(n.name=e,n.cardIds=[...K],n.updatedAt=Date.now()):n=v(e,K)):n=v(e,K),re(U,n),U.selectedDeckId=n.id,w(U),ws(`deck-saved`,{deckId:n.id}),hl(),Yc(`list`)}function xl(e=[]){let t=`New Deck`,n=new Set(e.map(e=>e.name?.trim()).filter(Boolean));if(!n.has(t))return t;let r=2;for(;n.has(`${t} ${r}`);)r++;return`${t} ${r}`}function Sl(){G=`new`,K=[];let e=Y(`deck-name-input`);e&&(e.value=xl(U.decks)),Yc(`edit`)}function Cl(){fc(),ec=null}function wl(){U.adventure=s(U.adventure),Y(`adventure-map-view`)?.classList.remove(`hidden`),Cl(),nc=null,Al()}function Tl(e){let t=b[e]||b.verdant,n=`map-${e}`;return`<svg class="adventure-map-scenery-svg" viewBox="0 0 100 120" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
    <defs>
  ...
  </svg>`}function El(e=`#e8c547`){return`<svg class="adventure-map-tile__pawn-svg" viewBox="0 0 28 36" aria-hidden="true">
    <defs>
  ...
  </svg>`}function Dl(e){let t=b[e]||b.verdant;return`<svg class="adventure-map-tile__banner-svg" viewBox="0 0 24 20" aria-hidden="true">
    <defs>
    ...
    <div class="adventure-map-canvas__bg" aria-hidden="true">
      <div class="adventure-map-scenery adventure-map-scenery--${i}" aria-hidden="true">${Tl(i)}</div>
    ...
    <div class="adventure-map-tower">
      ...
      <span class="adventure-map-tile__stone" aria-hidden="true">
      ...
      </span>`,r||(_.disabled=!0),_.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),Rl(t.id))}),d?.appendChild(_)});let v=Y(`adventure-floor-list`);if(v){v.classList.add(`adventure-floor-list--sr`),v.innerHTML=``;for(let t of p){let n=g(e,t.id),r=Se(e,t.id),i=t.id===m&&n,a=ae(e,t.id),o=document.createElement(`button`);o.type=`button`,o.className=`adventure-floor-row`,n||(o.disabled=!0),r&&o.classList.add(`adventure-floor-row--cleared`),i&&o.classList.add(`adventure-floor-row--next`),o.innerHTML=`
        ...
        ${a>0?`<span class="adventure-floor-row__stars">${S(a)}</span>`:``}`,o.addEventListener(`click`,()=>Rl(t.id)),v.appendChild(o)}}let y=r.querySelector(`.adventure-map-tile--next`);Ol(r),y&&requestAnimationFrame(()=>{requestAnimationFrame(()=>y.scrollIntoView({behavior:`smooth`,block:`nearest`}))});let x=v?.querySelector(`.adventure-floor-row--next`);x&&requestAnimationFrame(()=>x.scrollIntoView({behavior:`smooth`,block:`end`})),r.querySelector(`.adventure-challenge-toggle`)?.addEventListener(`click`,t=>{t.preventDefault(),t.stopPropagation(),e.challengeMode=!e.challengeMode,U.adventure=e,w(U),Bo(),Eo.tap(),Al()})}function jl(e){let t=de(e);if(!t||!g(U.adventure,e))return;ec=e,dc();let n=Y(`prebattle-title`),r=Y(`prebattle-flavor`),i=Y(`prebattle-opponent`);n&&(n.textContent=`Tower ${t.worldId} · Floor ${t.floorInWorld}`),r&&(r.textContent=t.flavor||``),i&&(i.textContent=`Loading…`);try{nc=xe(U,e),w(U)}catch(e){console.error(`Enemy deck failed`,e),i&&(i.textContent=`Could not build enemy deck. Try again.`);return}i&&(i.textContent=`Review the enemy spell deck, then choose your grimoire below.`);let o=Y(`prebattle-gem-hint`);if(o){let n=ne(U.adventure,e);o.textContent=(Se(U.adventure,e)?`Repeat clear: +${n} gems`:`First clear: +${n} gems`)+(t.worldId===5&&Ce(U.adventure)?` · Challenge mode: enemy has an extra rank of pieces`:``)}let s=Y(`enemy-deck-preview`);if(s){s.innerHTML=``;try{for(let{def:e,count:t}of he(nc)){if(!e)continue;let n=document.createElement(`button`);n.type=`button`,n.className=`enemy-deck-spell-btn`,n.title=`View ${e.name}`;let r=document.createElement(`span`);if(r.className=`enemy-deck-spell-btn__name`,r.textContent=e.name,n.appendChild(r),t>1){let e=document.createElement(`span`);e.className=`enemy-deck-spell-btn__count`,e.textContent=`×${t}`,n.appendChild(e)}n.addEventListener(`click`,()=>Ga(e,{meta:t>1?`${t} copies in enemy deck`:`Enemy deck`})),s.appendChild(n)}}catch(e){console.error(`Enemy preview failed`,e),s.innerHTML=`<p class="empty-msg">Enemy deck preview unavailable.</p>`}}C(U)&&w(U);let c=yr(`adventure-deck-select`);if(!c){i&&(i.textContent=`Deck selector missing — hard refresh the page.`);return}c.innerHTML=``;let l=U.decks.filter(e=>a(e.cardIds,U).valid);if(!l.length){let e=document.createElement(`option`);e.value=``,e.textContent=`No complete decks — build one in Decks`,c.appendChild(e),c.disabled=!0,Y(`btn-start-adventure`).disabled=!0;return}c.disabled=!1;let u=U.selectedDeckId&&l.some(e=>e.id===U.selectedDeckId)?U.selectedDeckId:l[0].id;for(let e of l){let t=document.createElement(`option`);t.value=e.id,t.textContent=e.name,e.id===u&&(t.selected=!0),c.appendChild(t)}U.selectedDeckId=u,Y(`btn-start-adventure`).disabled=!1}async function Ml(e,t,n,r,i=null,a=!1,o=void 0){let s=t.opponent;Cl(),nc=null,document.querySelectorAll(`.view`).forEach(e=>e.classList.add(`hidden`)),Y(`view-match`)?.classList.remove(`hidden`);let c=Y(`view-match`);if(!c)return;let{MatchSession:u,getMatchHtml:d}=await os();c.innerHTML=d(s);let p=o??(we(r).id===5&&Ce(U.adventure)),m={levelId:r,deckId:e.id,challengeMode:p},h={aiDeckIds:n,opponentName:s,cosmetics:f(U),profile:U,challengeMode:p,buildGameOverActions:({won:e,isTie:t})=>Pl(m,{won:e,isTie:t}),onGameOverAction:e=>{Fl(e,m,c)}};i&&(h.initialState=i);try{q=new u(e.cardIds,c,()=>{q=null,fr(),Ao(),So(`hub`),c.innerHTML=``,Y(`view-match`)?.classList.add(`hidden`),X(rr()||`play`),Xs&&Bl(),Zs&&Vl()},e=>{let t=ce(U,r,e),{gems:n,stars:i,starsGained:a}=t;return U.gems+=n,pe(U,`adventure_floors`,1),l(U),w(U),Q(),vc(),r===1&&t.firstTime&&(Xs=!0,Bl()),r===5&&t.firstTime&&(Zs=!0),{message:`+${n} gems! · Best: ${S(i)}`,starsGained:a}},h)}catch(e){throw q=null,c.innerHTML=``,Y(`view-match`)?.classList.add(`hidden`),X(`play`),e}ur({kind:`adventure`,deckId:e.id,deckCardIds:e.cardIds,aiDeckIds:n,opponentName:s,levelId:r,challengeMode:p}),await Ao(),So(`match`),a&&(q.winRewarded=!0),pr(q),q.setMessage(``),q.render()}async function Nl(){let e=mr();if(!e)return!1;let t=U.decks.find(t=>t.id===e.deckId)||U.decks.find(e=>e.cardIds?.length===30),n=e.levelId?de(e.levelId):null;return!t||t.cardIds.length!==30||!n||!e.aiDeckIds?.length||!await $e(`Resume your adventure match where you left off?`,{title:`Resume match?`,confirmLabel:`Resume`,cancelLabel:`Discard`})?(dr(),!1):(ec=e.levelId,await Ml(t,n,e.aiDeckIds,e.levelId,e.state,e.winRewarded,e.challengeMode),q?.setMessage(`Match resumed — pick up where you left off.`),!0)}function Pl({levelId:e},{won:t,isTie:n}){let r=e+1,i=t&&r<=50&&g(U.adventure,r);if(n)return[{id:`backToAdventure`,label:`Back to Adventure`,primary:!0}];if(t){let e=[];return i?(e.push({id:`nextFloor`,label:`Next floor`,primary:!0}),e.push({id:`retry`,label:`Retry floor`}),e.push({id:`backToAdventure`,label:`Back to Adventure`})):(e.push({id:`backToAdventure`,label:`Back to Adventure`,primary:!0}),e.push({id:`retry`,label:`Retry floor`})),e}return[{id:`retry`,label:`Retry floor`,primary:!0},{id:`backToAdventure`,label:`Back to Adventure`}]}async function Fl(e,{levelId:t,deckId:n,challengeMode:r},i){let a=U.decks.find(e=>e.id===n);if(e===`backToAdventure`){q?.onExit?.();return}if(e===`nextFloor`){let e=t+1;if(!de(e)||!g(U.adventure,e)){q?.onExit?.();return}q?.dispose(),q=null,fr({clearCheckpoint:!0}),Ao(),So(`hub`),i&&(i.innerHTML=``),Y(`view-match`)?.classList.add(`hidden`),await X(`play`),jl(e);return}if(e===`retry`){let e=t,n=de(e);if(!a||a.cardIds.length!==30||!n){q?.onExit?.();return}q?.dispose(),q=null,fr(),await Ml(a,n,xe(U,e),e,null,!1,r)}}function Il(){let e=yr(`adventure-deck-select`)?.value,t=U.decks.find(t=>t.id===e),n=ec,r=n?de(n):null,i=nc?[...nc]:null;if(!t||t.cardIds.length!==30||!r||!i?.length){let e=Y(`prebattle-opponent`);e&&(!t||t.cardIds.length!==30?e.textContent=`Build a complete 30-card deck in the Decks tab, then try again.`:e.textContent=`Could not start battle — close and pick the floor again.`);return}Ml(t,r,i,n)}function Ll(){if(window.__adventureMapCaptureBound)return;window.__adventureMapCaptureBound=!0;let e=null,t=!1,n=0,r=e=>e.closest?.(`#adventure-map .adventure-map-tile, #adventure-map .adventure-map-pin`),i=e=>e?.closest?.(`.adventure-map-scene`),a=()=>{t=!0,clearTimeout(n),n=setTimeout(()=>{t=!1},280)},o=(e,t)=>{if(!e||e.disabled)return;let n=Number(e.dataset.level);!Number.isFinite(n)||n<1||(t.preventDefault(),t.stopPropagation(),Rl(n))};document.addEventListener(`pointerdown`,t=>{if(t.button!==0)return;let n=r(t.target);if(!n||n.disabled)return;let a=i(n);e={pin:n,pointerId:t.pointerId,startX:t.clientX,startY:t.clientY,scrollTop:a?.scrollTop??0,scrollLeft:a?.scrollLeft??0,cancelled:!1}},!0),document.addEventListener(`pointermove`,t=>{if(!e||t.pointerId!==e.pointerId||e.cancelled)return;let n=t.clientX-e.startX,r=t.clientY-e.startY;Math.hypot(n,r)>12&&(e.cancelled=!0);let a=i(e.pin);a&&(Math.abs(a.scrollTop-e.scrollTop)>3&&(e.cancelled=!0),Math.abs(a.scrollLeft-e.scrollLeft)>3&&(e.cancelled=!0))},!0),document.addEventListener(`pointerup`,t=>{if(!e||t.pointerId!==e.pointerId)return;let{pin:n,cancelled:r}=e;if(e=null,r){a();return}o(n,t),a()},!0),document.addEventListener(`pointercancel`,t=>{!e||t.pointerId!==e.pointerId||(e=null,a())},!0),document.addEventListener(`click`,e=>{if(t){e.preventDefault(),e.stopPropagation();return}let n=r(e.target);!n||n.disabled||o(n,e)},!0)}function Rl(e){let t=s(U.adventure);if(U.adventure=t,!g(t,e)){pc(`Locked — beat global floor ${e-1} first, then return here.`,`Floor locked`);return}w(U),jl(e)}function zl(){lc(),window.addEventListener(`orientationchange`,lc),window.addEventListener(`resize`,lc),mc(),co(),no(),Fo(),wo(),jo(),Io(),Ka(),Ll(),cc(),document.querySelector(`.adventure-map-scene`)?.addEventListener(`scroll`,kl,{passive:!0});let e;window.addEventListener(`resize`,()=>{clearTimeout(e),e=setTimeout(()=>{if(!document.body.classList.contains(`adventure-active`))return;let e=Y(`adventure-map`);e&&Ol(e)},120)}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&Cl()}),document.querySelectorAll(`.tab-btn`).forEach(e=>{e.addEventListener(`click`,()=>{Bo(),Eo.tap(),X(e.dataset.tab)})}),document.querySelectorAll(`.play-tab`).forEach(e=>{e.addEventListener(`click`,()=>{if(cr(),W!==`play`){ks=e.dataset.playTab,X(`play`);return}gc(e.dataset.playTab)})}),document.querySelectorAll(`.vault-tab`).forEach(e=>{e.addEventListener(`click`,()=>{cr(),rl(e.dataset.vaultTab)})}),Y(`btn-new-deck`)?.addEventListener(`click`,Sl),Y(`btn-back-from-edit`)?.addEventListener(`click`,async()=>{await ml()&&(hl(),Yc(`list`))}),Y(`btn-delete-deck`)?.addEventListener(`click`,async()=>{if(!G||G===`new`)return;let e=U.decks.find(e=>e.id===G);e&&await $e(`Delete "${e.name}"? This cannot be undone.`,{title:`Delete deck?`,confirmLabel:`Delete`,cancelLabel:`Keep`,destructive:!0})&&(fe(U,e.id),hl(),Yc(`list`))});let t=()=>{Ms===`edit`&&$(),Ms===`list`&&yl()};document.querySelectorAll(`.collection-owned-only-toggle`).forEach(e=>{e.addEventListener(`change`,e=>{Ls=e.target.checked,Ic(),t()})}),document.querySelectorAll(`.btn-reset-collection-filters`).forEach(e=>{e.addEventListener(`click`,()=>{Fs=`all`,Ps=``,Is=`all`,Ls=!0,Ic(),t()})}),Ic(),br(),Y(`collection-search`)?.addEventListener(`input`,e=>{Ps=e.target.value,t()}),yr(`collection-category`)?.addEventListener(`change`,e=>{Is=e.target.value,t()}),yr(`collection-rarity`)?.addEventListener(`change`,e=>{Fs=e.target.value,t()}),Y(`btn-clear-deck`)?.addEventListener(`click`,()=>{K=[],$()}),Y(`btn-auto-finish-deck`)?.addEventListener(`click`,sc),Y(`btn-save-deck`)?.addEventListener(`click`,bl),Y(`btn-back-adventure`)?.addEventListener(`click`,Cl),Y(`adventure-floor-backdrop`)?.addEventListener(`click`,Cl),Y(`btn-start-adventure`)?.addEventListener(`click`,Il),yr(`adventure-deck-select`)?.addEventListener(`change`,e=>{U.selectedDeckId=e.target.value,w(U)});let n=document.getElementById(`auth-modal`),r=document.getElementById(`auth-header-btn`);xc(),qn(`play-help-btn`,`play-help-desc`),qn(`adventure-help-btn`,`adventure-help-desc`),qn(`shop-help-btn`,`shop-help-desc`),qn(`deck-help-btn`,`deck-help-desc`),Ks=mn({onSignIn:()=>qs?.open(`signin`,{forced:!0}),onSignUp:()=>qs?.open(`signup`,{forced:!0}),onGuest:()=>{tn(),ql()}}),qs=fn({authBtn:r,modal:n,onNewAccount:()=>{U=_e()?me():T(),Dn(U,w)},onSignedIn:()=>{nn(),U=T(),C(U),En(U),Q(),yl(),nl(),Ks?.hide(),Sc().then(()=>{W===`profile`&&wc(),W===`quests`&&Pc(),W===`play`&&Ws().then(e=>e?.render({resume:!0})),W===`social`&&Gs().then(e=>e?.render())}),Ws().then(e=>e?.render({resume:!0})),Gl(),Kl(),Wl(),Ul(),J||X(W)},onSignedOut:()=>{nn(),bc(),Z=``,yc(),Bs?.dispose?.(),q=null,fr({clearCheckpoint:!0}),cr(),U=me(),vc(),Q(),yl(),nl(),Ks?.show(),X(`deck`)}}),hr(()=>q),C(U),Ic(),vc(),Jl()}function Bl(){if(!Xs||Qs!=null)return;let e=0,t=()=>{if(Qs=null,e+=1,Xs){if(tr()){e<10&&(Qs=window.setTimeout(t,400));return}if(En(U),Wl()){Xs=!1;return}e<10&&(Qs=window.setTimeout(t,500))}};Qs=window.setTimeout(t,350)}function Vl(){if(!Zs||$s!=null)return;let e=0,t=()=>{if($s=null,e+=1,Zs){if(tr()){e<10&&($s=window.setTimeout(t,400));return}if(En(U),Ul()){Zs=!1;return}e<10&&($s=window.setTimeout(t,500))}};$s=window.setTimeout(t,350)}function Hl(){return J||!pn()||!d(U)||!Fn(U)?!1:(J=!0,X(`play`),xs().then(({startPvpTutorial:e})=>{e({profile:U,saveProfile:w,onComplete:()=>{J=!1,U=T(),C(U),vc(),X(`play`),Ul()}})}),!0)}function Ul(){return J||!pn()||!c(U)||An(U)||jn(U)||Pn(U)||Fn(U)||!Ln(U)?!1:(J=!0,X(`play`),xs().then(({startCosmeticsTutorial:e})=>{e({profile:U,saveProfile:w,onComplete:()=>{J=!1,U=T(),C(U),vc(),X(`play`)}})}),!0)}function Wl(){return J||!pn()||!d(U)?!1:(En(U),Pn(U)?(J=!0,X(`play`),xs().then(({startQuestsTutorial:e})=>{e({profile:U,saveProfile:w,onComplete:()=>{J=!1,U=T(),C(U),vc(),Hl(),Ul()}})}),!0):Hl())}function Gl(){return J||!pn()||!An(U)?!1:(J=!0,Cs().then(({startInteractiveTutorial:e})=>{e({profile:U,saveProfile:w,onComplete:()=>{J=!1,U=T(),C(U),Q(),yl(),nl(),Kl()||X(`deck`),Wl(),Ul()}})}),!0)}function Kl(){return J||!pn()||!jn(U)?!1:(J=!0,X(`deck`),ys().then(({startMetaTutorial:e})=>{e({profile:U,saveProfile:w,onComplete:()=>{J=!1,U=T(),C(U),Q(),yl(),nl(),X(`deck`),Wl(),Ul()}})}),!0)}async function ql(){Ks?.hide(),!Gl()&&(Kl()||Wl()||Ul()||J||(await Nl()||await X(`deck`),cr(),So(`hub`)))}async function Jl(){try{if(await Ie()){try{let e=await ln();e&&(U=e)}catch(e){console.warn(`Cloud sync on load failed`,e)}C(U),Q(),yl(),nl()}}catch(e){console.warn(`Auth init failed`,e)}if(En(U),await Sc(),Bs&&W===`play`&&(Os===`arena`||Os===`leaderboard`)&&Bs.render(),cr(),hn()){Ks?.show();return}await ql()}zl(),E(async()=>{let{registerSW:e}=await import(`./virtual_pwa-register-CpSsV7JG.js`);return{registerSW:e}},[],import.meta.url).then(({registerSW:e})=>{e({immediate:!0})}),et(),it();export{cr as A,Zt as B,dr as C,ur as D,rr as E,kn as F,gt as G,zt as H,Nn as I,$e as K,Mn as L,qn as M,In as N,fr as O,On as P,Rn as R,vr as S,or as T,_t as U,Qt as V,Ct as W,Za as _,Go as a,za as b,Zo as c,ts as d,Ao as f,so as g,H as h,Yo as i,pr as j,tr as k,qo as l,So as m,is as n,Ko as o,Co as p,qe as q,Vo as r,Xo as s,rs as t,$o as u,qa as v,ir as w,Cr as x,Ga as y,rn as z};