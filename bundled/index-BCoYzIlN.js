...
import{n as e,o as t,t as n}from"./cardCatalog-AnvdLb5p.js";import{i as r,r as i,u as a}from"./deckRules-B0ev_ycV.js";import{A as o,Ct as s,D as c,Dt as l,Et as u,N as d,Ot as f,R as p,St as m,Tt as h,V as g,W as ee,_t as _,a as v,at as y,bt as b,c as x,ct as S,d as C,dt as te,f as w,ft as ne,g as re,gt as ie,ht as ae,i as oe,k as se,kt as ce,l as le,lt as ue,m as T,mt as de,o as fe,ot as pe,p as me,pt as he,r as ge,s as _e,st as ve,t as ye,u as be,ut as xe,vt as Se,wt as Ce,xt as we,yt as Te}from"./storage-Wcuj1HfX.js";import{l as Ee,p as De,r as Oe}from"./mageTitles-BPvsmJqw.js";import{t as E}from"./preload-helper-CV77j2BA.js";import{_ as ke,a as Ae,c as je,d as Me,f as Ne,h as Pe,l as Fe,m as Ie,o as D,s as Le,t as Re}from"./auth-Fb-3YHk1.js";var ze=Object.defineProperty,Be=(e,t)=>{let n={};for(var r in e)ze(n,r,{get:e[r],enumerable:!0});return t||ze(n,Symbol.toStringTag,{value:`Module`}),n};function Ve(){let e=window.visualViewport;return e?Math.max(0,Math.round(e.offsetTop)):0}function He(){let e=window.visualViewport;return e?Math.max(0,Math.round(window.innerHeight-e.offsetTop-e.height)):0}function Ue(){let e=document.documentElement,t=()=>{e.style.setProperty(`--viewport-inset-top`,`${Ve()}px`),e.style.setProperty(`--viewport-inset-bottom`,`${He()}px`)};t(),window.visualViewport?.addEventListener(`resize`,t),window.visualViewport?.addEventListener(`scroll`,t),window.addEventListener(`resize`,t),window.addEventListener(`orientationchange`,t)}Ue();var We=1100,Ge=120;function Ke(){let e=document.getElementById(`app-splash`);if(!e||e.classList.contains(`app-splash--hide`))return;e.classList.add(`app-splash--hide`),document.body.classList.remove(`splash-active`);let t=()=>{e.remove()};e.addEventListener(`transitionend`,t,{once:!0}),window.setTimeout(t,600)}function qe(){Ke()}function Je(){let e=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches?Ge:We,t=performance.now(),n=()=>{let n=performance.now()-t,r=Math.max(0,e-n);window.setTimeout(Ke,r)};document.readyState===`interactive`||document.readyState===`complete`?n():document.addEventListener(`DOMContentLoaded`,n,{once:!0})}document.body.classList.add(`splash-active`),Je();var Ye=`(max-width: 768px)`,Xe=null;function Ze(){return document.getElementById(`mobile-confirm`)}function Qe(e){let t=Ze();if(!t)return;t.classList.add(`hidden`),document.body.classList.remove(`mobile-confirm-open`);let n=Xe;Xe=null,n?.(e)}function $e(e,t={}){if(!window.matchMedia(Ye).matches)return Promise.resolve(window.confirm(e));let n=Ze();if(!n)return Promise.resolve(window.confirm(e));let{title:r=`Confirm`,confirmLabel:i=`OK`,cancelLabel:a=`Cancel`,destructive:o=!1}=t;return new Promise(t=>{Xe&&Qe(!1),Xe=t,n.querySelector(`#mobile-confirm-title`).textContent=r,n.querySelector(`#mobile-confirm-body`).textContent=e;let s=n.querySelector(`#mobile-confirm-ok`),c=n.querySelector(`#mobile-confirm-cancel`);s.textContent=i,c.textContent=a,s.classList.toggle(`btn-danger`,o),s.classList.toggle(`btn-primary`,!o),n.classList.remove(`hidden`),document.body.classList.add(`mobile-confirm-open`),c.focus()})}function et(){let e=Ze();!e||e.dataset.bound||(e.dataset.bound=`1`,e.querySelector(`#mobile-confirm-ok`)?.addEventListener(`click`,()=>Qe(!0)),e.querySelector(`#mobile-confirm-cancel`)?.addEventListener(`click`,()=>Qe(!1)),e.querySelector(`[data-mobile-confirm-backdrop]`)?.addEventListener(`click`,()=>Qe(!1)))}var tt=`cc_install_banner_dismissed`;function nt(){return window.matchMedia(`(display-mode: standalone)`).matches||window.navigator.standalone===!0}function rt(){let e=window.navigator.userAgent;return/iphone|ipad|ipod/i.test(e)&&!/crios|fxios/i.test(e)}function it(){if(nt()||localStorage.getItem(tt)===`1`)return;let e=document.getElementById(`install-banner`);if(!e)return;let t=null,n=()=>{e.classList.remove(`hidden`),document.body.classList.add(`install-banner-visible`)},r=()=>{e.classList.add(`hidden`),document.body.classList.remove(`install-banner-visible`)};window.addEventListener(`beforeinstallprompt`,r=>{r.preventDefault(),t=r,e.querySelector(`#install-banner-ios-hint`)?.classList.add(`hidden`),e.querySelector(`.install-banner__hint--default`)?.classList.remove(`hidden`),e.querySelector(`#install-banner-btn`)?.classList.remove(`hidden`),n()}),rt()&&(e.querySelector(`#install-banner-ios-hint`)?.classList.remove(`hidden`),e.querySelector(`.install-banner__hint--default`)?.classList.add(`hidden`),e.querySelector(`#install-banner-btn`)?.classList.add(`hidden`),window.setTimeout(n,2500)),e.querySelector(`#install-banner-btn`)?.addEventListener(`click`,async()=>{t&&(t.prompt(),await t.userChoice,t=null,r())}),e.querySelector(`#install-banner-dismiss`)?.addEventListener(`click`,()=>{localStorage.setItem(tt,`1`),r()})}var at=[`attack`,`control`,`defense`,`movement`,`trap`,`special`],ot={attack:`Attack`,control:`Control`,defense:`Defense`,movement:`Movement`,trap:`Trap`,special:`Special`},st={aegis:`defense`,anchor:`defense`,backpedal:`control`,backstab:`attack`,backstep:`movement`,barrier:`defense`,bishops_mark:`movement`,blind:`control`,blizzard:`control`,snowball:`control`,berserk:`movement`,bomb:`attack`,shockwave:`control`,plague:`control`,bulwark:`defense`,create_foe:`special`,call_forward:`movement`,chain_lightning:`attack`,clone:`special`,coin_flip:`attack`,collapse:`special`,confusion:`control`,constitution:`defense`,counterspell:`trap`,crown:`special`,cryo_bolt:`attack`,cull:`attack`,darkness:`defense`,dash:`movement`,deep_freeze:`control`,deflect:`trap`,demote:`control`,deport:`movement`,displacement:`movement`,dominion:`special`,duel:`attack`,earthquake:`special`,execution:`attack`,extract:`control`,pyromancy:`attack`,fusion:`special`,hibernation:`special`,hostile_swap:`movement`,ignore:`special`,iron_will:`defense`,landmine:`trap`,last_king:`special`,bounty:`special`,link_fate:`special`,last_stand:`trap`,martyr:`trap`,leapfrog:`movement`,long_step:`movement`,magnet:`movement`,nudge:`movement`,offering:`special`,panic:`control`,poison:`attack`,mind_control:`special`,mulligan:`special`,zombify:`special`,press:`control`,purify:`special`,quick_march:`movement`,quicksand:`trap`,rally:`defense`,recall:`movement`,repel:`movement`,random_teleport:`movement`,retreat:`movement`,revive:`defense`,rooks_mark:`movement`,root:`control`,sacrifice:`attack`,sanctuary:`defense`,scatter:`movement`,shadow_swap:`movement`,sidestep:`movement`,shatter:`attack`,snipe:`attack`,snowball:`control`,stab:`attack`,stall:`defense`,tangle:`control`,teleport:`movement`,trickster:`special`,vengeance:`trap`,ward:`defense`};function ct(e){let t=st[e?.id];if(t)return t;let n=`${e?.id||``} ${e?.effect||``} ${e?.name||``} ${e?.desc||``}`.toLowerCase();return/trap|mine|quicksand|counterspell|vengeance|last.?stand|martyr/.test(n)?`trap`:/shield|ward|aegis|sanctuary|barrier|anchor|deflect|stall|iron_will|rally|darkness/.test(n)?`defense`:/move|nudge|teleport|recall|leap|step|displace|swap|scatter|retreat|bishop|rook|overrun|promote|pull|push|shift|earthquake|magnet|repel/.test(n)?`movement`:/freeze|blind|confusion|hex|root|panic|press|silence|paraly|control|cannot play|random|mark|poison|die in \d+ turn/.test(n)?`control`:/\bdestroy\b|\bkills?\b|fireball|bolt|stab|snipe|duel|sacrifice|execution|shatter|cull|lightning/.test(n)?`attack`:`special`}var lt=[{id:`bronze`,name:`Bronze Chest`,cost:25,cards:3,weights:{common:70,uncommon:25,rare:5,epic:0}},{id:`silver`,name:`Silver Chest`,cost:50,cards:5,weights:{common:50,uncommon:35,rare:12,epic:3}},{id:`gold`,name:`Gold Chest`,cost:100,cards:8,weights:{common:32,uncommon:38,rare:22,epic:6,legendary:2}}];function ut(e){let t=Math.random()*100,n=0;for(let r of[`common`,`uncommon`,`rare`,`epic`,`legendary`])if(n+=e[r]||0,t<=n)return r;return`common`}function dt(t){let n=e().filter(e=>e.rarity===t);return n.length?n[Math.floor(Math.random()*n.length)]:e()[0]}function ft(e,t){return dt(ut(t.weights))}function pt(e,n,r={}){let{starRefundChance:i=0}=r;if(oe(e,n.id)<t(n))return ye(e,n.id,1),{...n,duplicate:!1};let a=p[n.rarity]||10;if(i>0&&Math.random()<i){let e=Math.random()<.5?1:2;return{...n,duplicate:!0,starRefund:e}}return{...n,duplicate:!0,gemRefund:a}}function mt(e,t){let n=lt.find(e=>e.id===t);if(!n)return{success:!1,message:`Unknown chest.`};if(e.gems<n.cost)return{success:!1,message:`Not enough gems.`};e.gems-=n.cost;let r=[],i=0;for(let t=0;t<n.cards;t++){let t=pt(e,ft(e,n));r.push(t),t.gemRefund&&(i+=t.gemRefund)}return i&&(e.gems+=i),y(e,`boxes_opened`,1),T(e),{success:!0,pulls:r,chest:n,bonusGems:i}}var ht=[`common`,`uncommon`,`rare`,`epic`,`legendary`];function gt(e,{minPct:t=1}={}){return ht.filter(n=>(e[n]??0)>=t).map(t=>`${e[t]}% ${t}`).join(` · `)}var _t={bronze:{label:`Bronze`,tagline:`Mostly common cards`,accent:`#cd7f32`,glow:`rgba(205, 127, 50, 0.45)`},silver:{label:`Silver`,tagline:`Balanced card mix`,accent:`#a8b8d8`,glow:`rgba(168, 184, 216, 0.5)`},gold:{label:`Gold`,tagline:`Higher rare & epic odds`,accent:`#e8c547`,glow:`rgba(232, 197, 71, 0.55)`}};function vt(e){let t=_t[e]||_t.bronze;return{t,lid:e===`gold`?`#f5e6a8`:e===`silver`?`#e8eef8`:`#d4954a`,body:e===`gold`?`#7a5c12`:e===`silver`?`#4a5568`:`#5c3a1e`,trim:e===`gold`?`#ffe566`:e===`silver`?`#c8d8f0`:t.accent}}function yt(e,t){let{lid:n,body:r,trim:i}=vt(e);return`
  ...
  `;let t=e.querySelectorAll(`.mystery-box`);Ic(t[0],()=>zc()),Ic(t[1],()=>Bc())}function Hc(e){if(!Vs&&e===`cosmetics`&&!m(U)){ic(pe,`Cosmetics locked`),Vs=!0,Hc(`cards`),Vs=!1;return}Es=e,document.querySelectorAll(`.vault-tab`).forEach(t=>{let n=t.dataset.vaultTab===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,n?`true`:`false`)}),document.querySelectorAll(`.vault-tab-panel`).forEach(t=>{let n=t.id===`vault-tab-${e}`;t.classList.toggle(`hidden`,!n),t.hidden=!n}),Cs(`vault-tab-changed`,{tab:e})}function Uc(){us().then(({renderCosmeticBoxes:e})=>{e(U,X(`cosmetic-box-list`),{logEl:X(`cosmetic-box-log`),onGemsChange:bc,cosmeticsUnlocked:m(U),onOpened:()=>{W===`profile`&&pc(),W===`quests`&&yc()}})})}function Wc(e={}){let{clearPulls:t=!0}=e;$(),Uc(),Vc();let n=X(`chest-list`),r=X(`chest-pulls`);if(r&&t&&(r.innerHTML=``,r.classList.add(`chest-pulls--hidden`),r.classList.remove(`chest-pulls--reveal`)),n){n.innerHTML=``;for(let e of lt){let t=_t[e.id]||_t.bronze,i=U.gems>=e.cost,a=document.createElement(`article`);a.className=`chest-card chest-card--${e.id}${i?``:` chest-card--locked`}`,a.innerHTML=`
  ...
  </svg>`}function pl(e){let t=ve[e]||ve.verdant;return`<svg class="adventure-map-tile__banner-svg" viewBox="0 0 24 20" aria-hidden="true">
    <defs>
    ...
    <div class="adventure-map-tower">
      ...
      <span class="adventure-map-tile__stone" aria-hidden="true">
      ...
      </span>`,r||(_.disabled=!0),_.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),wl(t.id))}),d?.appendChild(_)});let g=X(`adventure-floor-list`);if(g){g.classList.add(`adventure-floor-list--sr`),g.innerHTML=``;for(let t of p){let n=Ce(e,t.id),r=s(e,t.id),i=t.id===m&&n,a=de(e,t.id),o=document.createElement(`button`);o.type=`button`,o.className=`adventure-floor-row`,n||(o.disabled=!0),r&&o.classList.add(`adventure-floor-row--cleared`),i&&o.classList.add(`adventure-floor-row--next`),o.innerHTML=`
        ...
        ${a>0?`<span class="adventure-floor-row__stars">${xe(a)}</span>`:``}`,o.addEventListener(`click`,()=>wl(t.id)),g.appendChild(o)}}let ee=r.querySelector(`.adventure-map-tile--next`);ml(r),ee&&requestAnimationFrame(()=>{requestAnimationFrame(()=>ee.scrollIntoView({behavior:`smooth`,block:`nearest`}))});let _=g?.querySelector(`.adventure-floor-row--next`);_&&requestAnimationFrame(()=>_.scrollIntoView({behavior:`smooth`,block:`end`})),r.querySelector(`.adventure-challenge-toggle`)?.addEventListener(`click`,t=>{t.preventDefault(),t.stopPropagation(),e.challengeMode=!e.challengeMode,U.adventure=e,T(U),Bo(),Eo.tap(),gl()})}function _l(e){let t=he(e);if(!t||!Ce(U.adventure,e))return;Ks=e,nc();let n=X(`prebattle-title`),r=X(`prebattle-flavor`),i=X(`prebattle-opponent`);n&&(n.textContent=`Tower ${t.worldId} · Floor ${t.floorInWorld}`),r&&(r.textContent=t.flavor||``),i&&(i.textContent=`Loading…`);try{qs=_(U,e),T(U)}catch(e){console.error(`Enemy deck failed`,e),i&&(i.textContent=`Could not build enemy deck. Try again.`);return}i&&(i.textContent=`Review the enemy spell deck, then choose your grimoire below.`);let o=X(`prebattle-gem-hint`);if(o){let n=te(U.adventure,e);o.textContent=(s(U.adventure,e)?`Repeat clear: +${n} gems`:`First clear: +${n} gems`)+(t.worldId===5&&b(U.adventure)?` · Challenge mode: enemy has an extra rank of pieces`:``)}let c=X(`enemy-deck-preview`);if(c){c.innerHTML=``;try{for(let{def:e,count:t}of ne(qs)){if(!e)continue;let n=document.createElement(`button`);n.type=`button`,n.className=`enemy-deck-spell-btn`,n.title=`View ${e.name}`;let r=document.createElement(`span`);if(r.className=`enemy-deck-spell-btn__name`,r.textContent=e.name,n.appendChild(r),t>1){let e=document.createElement(`span`);e.className=`enemy-deck-spell-btn__count`,e.textContent=`×${t}`,n.appendChild(e)}n.addEventListener(`click`,()=>Ga(e,{meta:t>1?`${t} copies in enemy deck`:`Enemy deck`})),c.appendChild(n)}}catch(e){console.error(`Enemy preview failed`,e),c.innerHTML=`<p class="empty-msg">Enemy deck preview unavailable.</p>`}}w(U)&&T(U);let l=yr(`adventure-deck-select`);if(!l){i&&(i.textContent=`Deck selector missing — hard refresh the page.`);return}l.innerHTML=``;let u=U.decks.filter(e=>a(e.cardIds,U).valid);if(!u.length){let e=document.createElement(`option`);e.value=``,e.textContent=`No complete decks — build one in Decks`,l.appendChild(e),l.disabled=!0,X(`btn-start-adventure`).disabled=!0;return}l.disabled=!1;let d=U.selectedDeckId&&u.some(e=>e.id===U.selectedDeckId)?U.selectedDeckId:u[0].id;for(let e of u){let t=document.createElement(`option`);t.value=e.id,t.textContent=e.name,e.id===d&&(t.selected=!0),l.appendChild(t)}U.selectedDeckId=d,X(`btn-start-adventure`).disabled=!1}async function vl(e,t,n,r,i=null,a=!1,o=void 0){let s=t.opponent;ll(),qs=null,document.querySelectorAll(`.view`).forEach(e=>e.classList.add(`hidden`)),X(`view-match`)?.classList.remove(`hidden`);let l=X(`view-match`);if(!l)return;let{MatchSession:u,getMatchHtml:d}=await os();l.innerHTML=d(s);let p=o??(Se(r).id===5&&b(U.adventure)),m={levelId:r,deckId:e.id,challengeMode:p},h={aiDeckIds:n,opponentName:s,cosmetics:ee(U),profile:U,challengeMode:p,buildGameOverActions:({won:e,isTie:t})=>bl(m,{won:e,isTie:t}),onGameOverAction:e=>{xl(e,m,l)}};i&&(h.initialState=i);try{q=new u(e.cardIds,l,()=>{q=null,fr(),Ao(),So(`hub`),l.innerHTML=``,X(`view-match`)?.classList.add(`hidden`),Z(rr()||`play`),Hs&&El(),Us&&Dl()},e=>{let t=f(U,r,e),{gems:n,stars:i,starsGained:a}=t;return U.gems+=n,y(U,`adventure_floors`,1),c(U),T(U),$(),sc(),r===1&&t.firstTime&&(Hs=!0,El()),r===5&&t.firstTime&&(Us=!0),{message:`+${n} gems! · Best: ${xe(i)}`,starsGained:a}},h)}catch(e){throw q=null,l.innerHTML=``,X(`view-match`)?.classList.add(`hidden`),Z(`play`),e}ur({kind:`adventure`,deckId:e.id,deckCardIds:e.cardIds,aiDeckIds:n,opponentName:s,levelId:r,challengeMode:p}),await Ao(),So(`match`),a&&(q.winRewarded=!0),pr(q),q.setMessage(``),q.render()}async function yl(){let e=mr();if(!e)return!1;let t=U.decks.find(t=>t.id===e.deckId)||U.decks.find(e=>e.cardIds?.length===30),n=e.levelId?he(e.levelId):null;return!t||t.cardIds.length!==30||!n||!e.aiDeckIds?.length||!await $e(`Resume your adventure match where you left off?`,{title:`Resume match?`,confirmLabel:`Resume`,cancelLabel:`Discard`})?(dr(),!1):(Ks=e.levelId,await vl(t,n,e.aiDeckIds,e.levelId,e.state,e.winRewarded,e.challengeMode),q?.setMessage(`Match resumed — pick up where you left off.`),!0)}function bl({levelId:e},{won:t,isTie:n}){let r=e+1,i=t&&r<=50&&Ce(U.adventure,r);if(n)return[{id:`backToAdventure`,label:`Back to Adventure`,primary:!0}];if(t){let e=[];return i?(e.push({id:`nextFloor`,label:`Next floor`,primary:!0}),e.push({id:`retry`,label:`Retry floor`}),e.push({id:`backToAdventure`,label:`Back to Adventure`})):(e.push({id:`backToAdventure`,label:`Back to Adventure`,primary:!0}),e.push({id:`retry`,label:`Retry floor`})),e}return[{id:`retry`,label:`Retry floor`,primary:!0},{id:`backToAdventure`,label:`Back to Adventure`}]}async function xl(e,{levelId:t,deckId:n,challengeMode:r},i){let a=U.decks.find(e=>e.id===n);if(e===`backToAdventure`){q?.onExit?.();return}if(e===`nextFloor`){let e=t+1;if(!he(e)||!Ce(U.adventure,e)){q?.onExit?.();return}q?.dispose(),q=null,fr({clearCheckpoint:!0}),Ao(),So(`hub`),i&&(i.innerHTML=``),X(`view-match`)?.classList.add(`hidden`),await Z(`play`),_l(e);return}if(e===`retry`){let e=t,n=he(e);if(!a||a.cardIds.length!==30||!n){q?.onExit?.();return}q?.dispose(),q=null,fr(),await vl(a,n,_(U,e),e,null,!1,r)}}function Sl(){let e=yr(`adventure-deck-select`)?.value,t=U.decks.find(t=>t.id===e),n=Ks,r=n?he(n):null,i=qs?[...qs]:null;if(!t||t.cardIds.length!==30||!r||!i?.length){let e=X(`prebattle-opponent`);e&&(!t||t.cardIds.length!==30?e.textContent=`Build a complete 30-card deck in the Decks tab, then try again.`:e.textContent=`Could not start battle — close and pick the floor again.`);return}vl(t,r,i,n)}function Cl(){if(window.__adventureMapCaptureBound)return;window.__adventureMapCaptureBound=!0;let e=null,t=!1,n=0,r=e=>e.closest?.(`#adventure-map .adventure-map-tile, #adventure-map .adventure-map-pin`),i=e=>e?.closest?.(`.adventure-map-scene`),a=()=>{t=!0,clearTimeout(n),n=setTimeout(()=>{t=!1},280)},o=(e,t)=>{if(!e||e.disabled)return;let n=Number(e.dataset.level);!Number.isFinite(n)||n<1||(t.preventDefault(),t.stopPropagation(),wl(n))};document.addEventListener(`pointerdown`,t=>{if(t.button!==0)return;let n=r(t.target);if(!n||n.disabled)return;let a=i(n);e={pin:n,pointerId:t.pointerId,startX:t.clientX,startY:t.clientY,scrollTop:a?.scrollTop??0,scrollLeft:a?.scrollLeft??0,cancelled:!1}},!0),document.addEventListener(`pointermove`,t=>{if(!e||t.pointerId!==e.pointerId||e.cancelled)return;let n=t.clientX-e.startX,r=t.clientY-e.startY;Math.hypot(n,r)>12&&(e.cancelled=!0);let a=i(e.pin);a&&(Math.abs(a.scrollTop-e.scrollTop)>3&&(e.cancelled=!0),Math.abs(a.scrollLeft-e.scrollLeft)>3&&(e.cancelled=!0))},!0),document.addEventListener(`pointerup`,t=>{if(!e||t.pointerId!==e.pointerId)return;let{pin:n,cancelled:r}=e;if(e=null,r){a();return}o(n,t),a()},!0),document.addEventListener(`pointercancel`,t=>{!e||t.pointerId!==e.pointerId||(e=null,a())},!0),document.addEventListener(`click`,e=>{if(t){e.preventDefault(),e.stopPropagation();return}let n=r(e.target);!n||n.disabled||o(n,e)},!0)}function wl(e){let t=ce(U.adventure);if(U.adventure=t,!Ce(t,e)){ic(`Locked — beat global floor ${e-1} first, then return here.`,`Floor locked`);return}T(U),_l(e)}function Tl(){ec(),window.addEventListener(`orientationchange`,ec),window.addEventListener(`resize`,ec),ac(),co(),no(),Fo(),wo(),jo(),Io(),Ka(),Cl(),$s(),document.querySelector(`.adventure-map-scene`)?.addEventListener(`scroll`,hl,{passive:!0});let e;window.addEventListener(`resize`,()=>{clearTimeout(e),e=setTimeout(()=>{if(!document.body.classList.contains(`adventure-active`))return;let e=X(`adventure-map`);e&&ml(e)},120)}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&ll()}),document.querySelectorAll(`.tab-btn`).forEach(e=>{e.addEventListener(`click`,()=>{Bo(),Eo.tap(),Z(e.dataset.tab)})}),document.querySelectorAll(`.vault-tab`).forEach(e=>{e.addEventListener(`click`,()=>{cr(),Hc(e.dataset.vaultTab)})}),X(`btn-new-deck`)?.addEventListener(`click`,cl),X(`btn-back-from-edit`)?.addEventListener(`click`,async()=>{await $c()&&(el(),Pc(`list`))}),X(`btn-delete-deck`)?.addEventListener(`click`,async()=>{if(!G||G===`new`)return;let e=U.decks.find(e=>e.id===G);e&&await $e(`Delete "${e.name}"? This cannot be undone.`,{title:`Delete deck?`,confirmLabel:`Delete`,cancelLabel:`Keep`,destructive:!0})&&(fe(U,e.id),el(),Pc(`list`))});let t=()=>{Ds===`edit`&&al(),Ds===`list`&&il()};document.querySelectorAll(`.collection-owned-only-toggle`).forEach(e=>{e.addEventListener(`change`,e=>{Ms=e.target.checked,xc(),t()})}),document.querySelectorAll(`.btn-reset-collection-filters`).forEach(e=>{e.addEventListener(`click`,()=>{As=`all`,ks=``,js=`all`,Ms=!0,xc(),t()})}),xc(),br(),X(`collection-search`)?.addEventListener(`input`,e=>{ks=e.target.value,t()}),yr(`collection-category`)?.addEventListener(`change`,e=>{js=e.target.value,t()}),yr(`collection-rarity`)?.addEventListener(`change`,e=>{As=e.target.value,t()}),X(`btn-clear-deck`)?.addEventListener(`click`,()=>{K=[],al()}),X(`btn-auto-finish-deck`)?.addEventListener(`click`,Qs),X(`btn-save-deck`)?.addEventListener(`click`,ol),X(`btn-back-adventure`)?.addEventListener(`click`,ll),X(`adventure-floor-backdrop`)?.addEventListener(`click`,ll),X(`btn-start-adventure`)?.addEventListener(`click`,Sl),yr(`adventure-deck-select`)?.addEventListener(`change`,e=>{U.selectedDeckId=e.target.value,T(U)});let n=document.getElementById(`auth-modal`),r=document.getElementById(`auth-header-btn`);uc(),qn(`adventure-help-btn`,`adventure-help-desc`),qn(`shop-help-btn`,`shop-help-desc`),qn(`deck-help-btn`,`deck-help-desc`),Rs=mn({onSignIn:()=>zs?.open(`signin`,{forced:!0}),onSignUp:()=>zs?.open(`signup`,{forced:!0}),onGuest:()=>{tn(),Nl()}}),zs=fn({authBtn:r,modal:n,onNewAccount:()=>{U=_e()?me():be(),Dn(U,T)},onSignedIn:()=>{nn(),U=be(),w(U),En(U),$(),il(),Vc(),Rs?.hide(),dc().then(()=>{W===`profile`&&pc(),W===`quests`&&yc(),W===`pvp`&&Ls().then(e=>e?.render({resume:!0}))}),Ls().then(e=>e?.render({resume:!0})),jl(),Ml(),Al(),kl(),J||Z(W)},onSignedOut:()=>{nn(),lc(),Q=``,cc(),Fs?.dispose?.(),q=null,fr({clearCheckpoint:!0}),cr(),U=me(),sc(),$(),il(),Vc(),Rs?.show(),Z(`deck`)}}),hr(()=>q),w(U),xc(),sc(),Pl()}function El(){if(!Hs||Ws!=null)return;let e=0,t=()=>{if(Ws=null,e+=1,Hs){if(tr()){e<10&&(Ws=window.setTimeout(t,400));return}if(En(U),Al()){Hs=!1;return}e<10&&(Ws=window.setTimeout(t,500))}};Ws=window.setTimeout(t,350)}function Dl(){if(!Us||Gs!=null)return;let e=0,t=()=>{if(Gs=null,e+=1,Us){if(tr()){e<10&&(Gs=window.setTimeout(t,400));return}if(En(U),kl()){Us=!1;return}e<10&&(Gs=window.setTimeout(t,500))}};Gs=window.setTimeout(t,350)}function Ol(){return J||!pn()||!h(U)||!Fn(U)?!1:(J=!0,ys().then(({startPvpTutorial:e})=>{e({profile:U,saveProfile:T,onComplete:()=>{J=!1,U=be(),w(U),sc(),Z(`play`),kl()}})}),!0)}function kl(){return J||!pn()||!m(U)||An(U)||jn(U)||Pn(U)||Fn(U)||!Ln(U)?!1:(J=!0,Z(`play`),ys().then(({startCosmeticsTutorial:e})=>{e({profile:U,saveProfile:T,onComplete:()=>{J=!1,U=be(),w(U),sc(),Z(`play`)}})}),!0)}function Al(){return J||!pn()||!h(U)?!1:(En(U),Pn(U)?(J=!0,Z(`play`),ys().then(({startQuestsTutorial:e})=>{e({profile:U,saveProfile:T,onComplete:()=>{J=!1,U=be(),w(U),sc(),Ol(),kl()}})}),!0):Ol())}function jl(){return J||!pn()||!An(U)?!1:(J=!0,xs().then(({startInteractiveTutorial:e})=>{e({profile:U,saveProfile:T,onComplete:()=>{J=!1,U=be(),w(U),$(),il(),Vc(),Ml()||Z(`deck`),Al(),kl()}})}),!0)}function Ml(){return J||!pn()||!jn(U)?!1:(J=!0,Z(`deck`),_s().then(({startMetaTutorial:e})=>{e({profile:U,saveProfile:T,onComplete:()=>{J=!1,U=be(),w(U),$(),il(),Vc(),Z(`deck`),Al(),kl()}})}),!0)}async function Nl(){Rs?.hide(),!jl()&&(Ml()||Al()||kl()||J||(await yl()||await Z(`deck`),cr(),So(`hub`)))}async function Pl(){try{if(await Le()){try{let e=await ln();e&&(U=e)}catch(e){console.warn(`Cloud sync on load failed`,e)}w(U),$(),il(),Vc()}}catch(e){console.warn(`Auth init failed`,e)}if(En(U),await dc(),Fs&&Fs.render(),cr(),hn()){Rs?.show();return}await Nl()}Tl(),E(async()=>{let{registerSW:e}=await import(`./virtual_pwa-register-CpSsV7JG.js`);return{registerSW:e}},[],import.meta.url).then(({registerSW:e})=>{e({immediate:!0})}),et(),it();export{cr as A,Zt as B,dr as C,ur as D,rr as E,kn as F,$e as G,_t as H,Nn as I,qe as K,Mn as L,qn as M,In as N,fr as O,On as P,Rn as R,vr as S,or as T,Ct as U,zt as V,gt as W,Za as _,Go as a,za as b,Zo as c,ts as d,Ao as f,so as g,H as h,Yo as i,pr as j,tr as k,qo as l,So as m,is as n,Ko as o,Co as p,Vo as r,Xo as s,rs as t,$o as u,qa as v,ir as w,Cr as x,Ga as y,rn as z};