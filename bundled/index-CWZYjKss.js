...
import{n as e,o as t,t as n}from"./cardCatalog-bRMu4_2z.js";import{i as r,r as i,u as a}from"./deckRules-Bm_uXVGu.js";import{A as o,Ct as s,D as c,Dt as l,Et as u,N as d,Ot as f,R as p,St as m,Tt as h,V as g,W as ee,_t as _,a as v,at as y,bt as b,c as x,ct as S,d as C,dt as te,f as w,ft as ne,g as re,gt as ie,ht as ae,i as oe,k as se,kt as ce,l as le,lt as ue,m as T,mt as de,o as fe,ot as pe,p as me,pt as he,r as ge,s as _e,st as ve,t as ye,u as be,ut as xe,vt as Se,wt as Ce,xt as we,yt as Te}from"./storage-DBO1QvnW.js";import{l as Ee,p as De,r as Oe}from"./mageTitles-BPvsmJqw.js";import{t as E}from"./preload-helper-CV77j2BA.js";import{_ as ke,a as Ae,c as je,d as Me,f as Ne,h as Pe,l as Fe,m as Ie,o as D,s as Le,t as Re}from"./auth-DYrl9UeU.js";var ze=Object.defineProperty,Be=(e,t)=>{let n={};for(var r in e)ze(n,r,{get:e[r],enumerable:!0});return t||ze(n,Symbol.toStringTag,{value:`Module`}),n};function Ve(){let e=window.visualViewport;return e?Math.max(0,Math.round(e.offsetTop)):0}function He(){let e=window.visualViewport;return e?Math.max(0,Math.round(window.innerHeight-e.offsetTop-e.height)):0}function Ue(){let e=document.documentElement,t=()=>{e.style.setProperty(`--viewport-inset-top`,`${Ve()}px`),e.style.setProperty(`--viewport-inset-bottom`,`${He()}px`)};t(),window.visualViewport?.addEventListener(`resize`,t),window.visualViewport?.addEventListener(`scroll`,t),window.addEventListener(`resize`,t),window.addEventListener(`orientationchange`,t)}Ue();var We=1100,Ge=120;function Ke(){let e=document.getElementById(`app-splash`);if(!e||e.classList.contains(`app-splash--hide`))return;e.classList.add(`app-splash--hide`),document.body.classList.remove(`splash-active`);let t=()=>{e.remove()};e.addEventListener(`transitionend`,t,{once:!0}),window.setTimeout(t,600)}function qe(){Ke()}function Je(){let e=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches?Ge:We,t=performance.now(),n=()=>{let n=performance.now()-t,r=Math.max(0,e-n);window.setTimeout(Ke,r)};document.readyState===`interactive`||document.readyState===`complete`?n():document.addEventListener(`DOMContentLoaded`,n,{once:!0})}document.body.classList.add(`splash-active`),Je();var Ye=`(max-width: 768px)`,Xe=null;function Ze(){return document.getElementById(`mobile-confirm`)}function Qe(e){let t=Ze();if(!t)return;t.classList.add(`hidden`),document.body.classList.remove(`mobile-confirm-open`);let n=Xe;Xe=null,n?.(e)}function $e(e,t={}){if(!window.matchMedia(Ye).matches)return Promise.resolve(window.confirm(e));let n=Ze();if(!n)return Promise.resolve(window.confirm(e));let{title:r=`Confirm`,confirmLabel:i=`OK`,cancelLabel:a=`Cancel`,destructive:o=!1}=t;return new Promise(t=>{Xe&&Qe(!1),Xe=t,n.querySelector(`#mobile-confirm-title`).textContent=r,n.querySelector(`#mobile-confirm-body`).textContent=e;let s=n.querySelector(`#mobile-confirm-ok`),c=n.querySelector(`#mobile-confirm-cancel`);s.textContent=i,c.textContent=a,s.classList.toggle(`btn-danger`,o),s.classList.toggle(`btn-primary`,!o),n.classList.remove(`hidden`),document.body.classList.add(`mobile-confirm-open`),c.focus()})}function et(){let e=Ze();!e||e.dataset.bound||(e.dataset.bound=`1`,e.querySelector(`#mobile-confirm-ok`)?.addEventListener(`click`,()=>Qe(!0)),e.querySelector(`#mobile-confirm-cancel`)?.addEventListener(`click`,()=>Qe(!1)),e.querySelector(`[data-mobile-confirm-backdrop]`)?.addEventListener(`click`,()=>Qe(!1)))}var tt=`cc_install_banner_dismissed`;function nt(){return window.matchMedia(`(display-mode: standalone)`).matches||window.navigator.standalone===!0}function rt(){let e=window.navigator.userAgent;return/iphone|ipad|ipod/i.test(e)&&!/crios|fxios/i.test(e)}function it(){if(nt()||localStorage.getItem(tt)===`1`)return;let e=document.getElementById(`install-banner`);if(!e)return;let t=null,n=()=>{e.classList.remove(`hidden`),document.body.classList.add(`install-banner-visible`)},r=()=>{e.classList.add(`hidden`),document.body.classList.remove(`install-banner-visible`)};window.addEventListener(`beforeinstallprompt`,r=>{r.preventDefault(),t=r,e.querySelector(`#install-banner-ios-hint`)?.classList.add(`hidden`),e.querySelector(`.install-banner__hint--default`)?.classList.remove(`hidden`),e.querySelector(`#install-banner-btn`)?.classList.remove(`hidden`),n()}),rt()&&(e.querySelector(`#install-banner-ios-hint`)?.classList.remove(`hidden`),e.querySelector(`.install-banner__hint--default`)?.classList.add(`hidden`),e.querySelector(`#install-banner-btn`)?.classList.add(`hidden`),window.setTimeout(n,2500)),e.querySelector(`#install-banner-btn`)?.addEventListener(`click`,async()=>{t&&(t.prompt(),await t.userChoice,t=null,r())}),e.querySelector(`#install-banner-dismiss`)?.addEventListener(`click`,()=>{localStorage.setItem(tt,`1`),r()})}var at=[`attack`,`control`,`defense`,`movement`,`trap`,`special`],ot={attack:`Attack`,control:`Control`,defense:`Defense`,movement:`Movement`,trap:`Trap`,special:`Special`},st={aegis:`defense`,anchor:`defense`,backpedal:`control`,backstab:`attack`,backstep:`movement`,barrier:`defense`,bishops_mark:`movement`,blind:`control`,blizzard:`control`,snowball:`control`,berserk:`movement`,bomb:`attack`,shockwave:`control`,plague:`control`,bulwark:`defense`,create_foe:`special`,call_forward:`movement`,chain_lightning:`attack`,clone:`special`,coin_flip:`attack`,collapse:`special`,confusion:`control`,constitution:`defense`,counterspell:`trap`,crown:`special`,cryo_bolt:`attack`,cull:`attack`,darkness:`defense`,dash:`movement`,deep_freeze:`control`,deflect:`trap`,demote:`control`,deport:`movement`,displacement:`movement`,dominion:`special`,duel:`attack`,earthquake:`special`,execution:`attack`,extract:`control`,pyromancy:`attack`,fusion:`special`,hibernation:`special`,hostile_swap:`movement`,ignore:`special`,iron_will:`defense`,landmine:`trap`,last_king:`special`,bounty:`special`,link_fate:`special`,last_stand:`trap`,martyr:`trap`,leapfrog:`movement`,long_step:`movement`,magnet:`movement`,nudge:`movement`,offering:`special`,panic:`control`,poison:`attack`,mind_control:`special`,zombify:`special`,press:`control`,purify:`special`,quick_march:`movement`,quicksand:`trap`,rally:`defense`,recall:`movement`,repel:`movement`,random_teleport:`movement`,retreat:`movement`,revive:`defense`,rooks_mark:`movement`,root:`control`,sacrifice:`attack`,sanctuary:`defense`,scatter:`movement`,shadow_swap:`movement`,sidestep:`movement`,shatter:`attack`,snipe:`attack`,snowball:`control`,stab:`attack`,stall:`defense`,tangle:`control`,teleport:`movement`,trickster:`special`,vengeance:`trap`,ward:`defense`};function ct(e){let t=st[e?.id];if(t)return t;let n=`${e?.id||``} ${e?.effect||``} ${e?.name||``} ${e?.desc||``}`.toLowerCase();return/trap|mine|quicksand|counterspell|vengeance|last.?stand|martyr/.test(n)?`trap`:/shield|ward|aegis|sanctuary|barrier|anchor|deflect|stall|iron_will|rally|darkness/.test(n)?`defense`:/move|nudge|teleport|recall|leap|step|displace|swap|scatter|retreat|bishop|rook|overrun|promote|pull|push|shift|earthquake|magnet|repel/.test(n)?`movement`:/freeze|blind|confusion|hex|root|panic|press|silence|paraly|control|cannot play|random|mark|poison|die in \d+ turn/.test(n)?`control`:/\bdestroy\b|\bkills?\b|fireball|bolt|stab|snipe|duel|sacrifice|execution|shatter|cull|lightning/.test(n)?`attack`:`special`}var lt=[{id:`bronze`,name:`Bronze Chest`,cost:25,cards:3,weights:{common:70,uncommon:25,rare:5,epic:0}},{id:`silver`,name:`Silver Chest`,cost:50,cards:5,weights:{common:50,uncommon:35,rare:12,epic:3}},{id:`gold`,name:`Gold Chest`,cost:100,cards:8,weights:{common:32,uncommon:38,rare:22,epic:6,legendary:2}}];function ut(e){let t=Math.random()*100,n=0;for(let r of[`common`,`uncommon`,`rare`,`epic`,`legendary`])if(n+=e[r]||0,t<=n)return r;return`common`}function dt(t){let n=e().filter(e=>e.rarity===t);return n.length?n[Math.floor(Math.random()*n.length)]:e()[0]}function ft(e,t){return dt(ut(t.weights))}function pt(e,n,r={}){let{starRefundChance:i=0}=r;if(oe(e,n.id)<t(n))return ye(e,n.id,1),{...n,duplicate:!1};let a=p[n.rarity]||10;if(i>0&&Math.random()<i){let e=Math.random()<.5?1:2;return{...n,duplicate:!0,starRefund:e}}return{...n,duplicate:!0,gemRefund:a}}function mt(e,t){let n=lt.find(e=>e.id===t);if(!n)return{success:!1,message:`Unknown chest.`};if(e.gems<n.cost)return{success:!1,message:`Not enough gems.`};e.gems-=n.cost;let r=[],i=0;for(let t=0;t<n.cards;t++){let t=pt(e,ft(e,n));r.push(t),t.gemRefund&&(i+=t.gemRefund)}return i&&(e.gems+=i),y(e,`boxes_opened`,1),T(e),{success:!0,pulls:r,chest:n,bonusGems:i}}var ht=[`common`,`uncommon`,`rare`,`epic`,`legendary`];function gt(e,{minPct:t=1}={}){return ht.filter(n=>(e[n]??0)>=t).map(t=>`${e[t]}% ${t}`).join(` · `)}var _t={bronze:{label:`Bronze`,tagline:`Mostly common cards`,accent:`#cd7f32`,glow:`rgba(205, 127, 50, 0.45)`},silver:{label:`Silver`,tagline:`Balanced card mix`,accent:`#a8b8d8`,glow:`rgba(168, 184, 216, 0.5)`},gold:{label:`Gold`,tagline:`Higher rare & epic odds`,accent:`#e8c547`,glow:`rgba(232, 197, 71, 0.55)`}};function vt(e){let t=_t[e]||_t.bronze;return{t,lid:e===`gold`?`#f5e6a8`:e===`silver`?`#e8eef8`:`#d4954a`,body:e===`gold`?`#7a5c12`:e===`silver`?`#4a5568`:`#5c3a1e`,trim:e===`gold`?`#ffe566`:e===`silver`?`#c8d8f0`:t.accent}}function yt(e,t){let{lid:n,body:r,trim:i}=vt(e);return`
  ...
  ${Mr(14,50,3.2)}${Rr(50,50,3.2)}`)}`}function hi(){return`${M(24,54,20,4)}
    ...
    ${N([[18,32,.8],[28,28,.6]],`#e9d5ff`,.55)}`}function gi(){return`${M(28,54,18,4)}
    ${P(22,44,5.5)}
    ...
    ${N([[30,8,.8],[52,6,.7],[24,28,.6]],`#e9d5ff`,.6)}`}function _i(){return`${M(32,52,22,4)}
    ...
    ${N([[32,34,.9],[16,14,.7],[48,14,.7]],`#e0f2fe`,.6)}`}function vi(){return`${M(32,54,18,4)}
    ${P(32,48,5.5)}
    ...
    ${N([[12,18,.7],[52,18,.7],[32,36,.6]],`#e9d5ff`,.55)}`}function yi(){return`${M(32,54,18,4)}
    ${P(32,48,5.5)}
    ...
    ${N([[32,6,.7],[4,44,.6],[60,44,.6]],`#e9d5ff`,.55)}`}function bi(){return`${M(30,52,20,4)}
    ${F(46,20,5.5)}
    ...
    ${N([[36,26,.7],[22,38,.6]],`#fca5a5`,.5)}`}function xi(){return`${M(30,54,18,4)}
    ${P(18,50,5)}
    ${F(44,28,5)}
    ...
    ${N([[20,40,.7],[44,24,.7],[32,28,.8]],`#e9d5ff`,.55)}`}function wi(){return`${M(32,54,24,4)}
    ...
    ${N([[16,10,.7],[48,10,.7],[10,32,.6],[54,32,.6]],`#c4b5fd`,.45)}`}function Ti(){return`${M(32,56,16,4)}
    ${P(32,34,6)}
    ...
    ${N([[32,12,.8],[12,34,.6],[52,34,.6]],`#e9d5ff`,.5)}`}function Ei(){return`${M(32,56,16,4)}
    ${P(32,38,6)}
    ...
    ${N([[32,4,.8],[18,8,.6],[46,8,.6]],`#fde68a`,.55)}`}function Di(){return`${M(30,54,18,4)}
    ${P(28,36,6)}
    ...
    ${N([[12,12,.7],[46,18,.6]],`#fca5a5`,.5)}`}function Oi(){return`${M(32,54,20,4)}
    ...
    <path d="M24 50 C30 44 34 44 40 50" stroke="#fde68a" stroke-width="2" fill="none" opacity="0.7"/>
    ${j(32,14,5,`#fde68a`,`#b45309`)}
    ${N([[24,36,.7],[40,36,.7],[32,8,.9]],`#fde68a`,.6)}`}function Ai(){return`${M(32,54,18,4)}
    ${P(32,34,6)}
    ...
    ${N([[46,16,.7],[24,20,.5]],`#c4b5fd`,.45)}`}function Mi(){return`${M(32,54,24,4)}
    ...
    ${N([[8,8,.7],[56,8,.7],[8,56,.7],[56,56,.7]],`#fde68a`,.6)}`}function Ni(){return`${M(28,54,18,4)}
    ${P(18,44,5.5)}
    ${I(42,24,6,`#cbd5e1`)}
    ...
    ${N([[40,20,.7],[22,36,.5]],`#e2e8f0`,.45)}`}function Pi(){return`${M(32,54,16,4)}
    ${P(32,20,5.5)}
    ${I(32,48,6,`#cbd5e1`)}
    ...
    ${N([[32,16,.6],[32,44,.5]],`#cbd5e1`,.4)}`}function Fi(){return`${M(32,54,16,4)}
    ${P(32,26,5.5)}
    ...
    ${N([[32,22,.6]],`#93c5fd`,.4)}`}function Ii(){return`${M(32,54,20,4)}
    ...
    ${N([[32,6,.7]],`#cbd5e1`,.4)}`}function Li(){return`${M(32,54,22,4)}
    ${P(32,24,5.5)}
    ...
    ${N([[20,40,.5],[44,40,.5]],`#93c5fd`,.4)}`}function Ri(){return`${M(30,54,20,4)}
    ${P(20,36,5)}${F(40,36,5)}
    ${I(54,36,5,`#fca5a5`)}
    ...
    ${N([[48,32,.6]],`#fde68a`,.45)}`}function zi(){return`${M(28,54,20,4)}
    ...
    ${N([[30,14,.8],[20,38,.5]],`#bae6fd`,.5)}`}function Bi(){return`${M(32,54,18,4)}
    ${P(32,40,5.5)}
    ...
    ${N([[24,12,.8],[48,20,.7],[32,6,.9]],`#e9d5ff`,.55)}`}function Vi(){return`${M(32,54,22,4)}
    ...
    ${N([[32,10,.8],[16,40,.5],[48,40,.5]],`#93c5fd`,.45)}`}function Hi(){return`${M(32,54,16,4)}
    ${P(32,36,6)}
    ...
    ${N([[16,12,.6]],`#fca5a5`,.4)}`}function Ui(){return`${M(32,54,18,4)}
    ${P(32,34,6)}
    ...
    ${N([[32,20,.7]],`#e2e8f0`,.4)}`}function Wi(){return`${M(32,54,16,4)}
    ${F(32,40,6)}
    ...
    ${N([[24,4,.6],[40,4,.6]],`#fde68a`,.45)}`}function Gi(){return`${M(32,54,18,4)}
    ${Fr(32,36,32)}
    ...
    ${N([[30,36,.5]],`#d6d3d1`,.35)}`}function Ki(){return`${M(32,54,16,4)}
    ...
    ${N([[46,10,.7]],`#fca5a5`,.5)}`}function qi(){return`${M(32,54,16,4)}
    ...
    ${N([[32,20,.5],[32,40,.5]],`#cbd5e1`,.35)}`}function Ji(){return`${M(32,54,16,4)}
    ${F(32,22,6)}
    ...
    ${N([[28,16,.6],[36,16,.6]],`#fca5a5`,.45)}`}function Yi(){return`${M(32,54,20,4)}
    ...
    ${Ir(32,34,4,`#c4b5fd`)}
    ${N([[32,30,.7]],`#e9d5ff`,.45)}`}function Xi(){return`${M(28,54,18,4)}
    ${P(12,34,5.5)}
    ${I(50,34,6,`#cbd5e1`)}
    ...
    ${N([[46,30,.6]],`#e2e8f0`,.4)}`}function Zi(){return`${M(32,54,18,4)}
    ${F(32,28,6)}
    ...
    ${j(32,52,5,`#fca5a5`,`#dc2626`)}`}function Qi(){return`${M(32,56,16,4)}
    ${P(32,38,6)}
    ...
    ${N([[32,18,.7],[20,32,.5],[44,32,.5]],`#bae6fd`,.4)}`}function $i(){return`${M(32,54,18,4)}
    ${P(32,36,6)}
    ...
    ${N([[14,10,.7],[20,22,.5]],`#e0f2fe`,.5)}`}function ea(){return`${M(30,54,20,4)}
    ${P(14,50,5.5)}
    ${I(50,14,6,`#7dd3fc`)}
    ...
    ${N([[48,12,.7],[24,38,.5]],`#bae6fd`,.45)}`}function ta(){return`${M(32,56,16,4)}
    ${P(32,38,6)}
    ...
    ${N([[32,14,.8],[14,34,.5],[50,34,.5]],`#bae6fd`,.45)}`}function na(){return`${M(32,54,16,4)}
    ${F(32,34,6)}
    ...
    ${N([[32,10,.7],[28,44,.5],[36,44,.5]],`#86efac`,.45)}`}function ra(){return`${M(26,54,16,4)}
    ${P(24,38,5.5)}
    ...
    ${N([[48,10,.6]],`#fde68a`,.45)}`}function ia(){return`${M(30,54,18,4)}
    ...
    ${N([[42,20,.7]],`#fde68a`,.5)}`}function aa(){return`${M(32,56,16,4)}
    ${P(32,40,6)}
    ...
    ${N([[22,4,.7],[32,0,.8],[42,4,.7]],`#fde68a`,.6)}`}function oa(){return`${M(30,54,20,4)}
    ...
    ${N([[46,12,.8],[24,40,.5]],`#e0f2fe`,.5)}`}function sa(){return`${M(32,54,16,4)}
    ${Fr(32,36,32)}
    ...
    ${N([[32,24,.6]],`#fca5a5`,.4)}`}function ca(){return`${M(32,54,18,4)}
    ${F(32,20,6)}
    ...
    ${N([[32,44,.5]],`#fca5a5`,.4)}`}function la(){return`${M(32,54,16,4)}
    ${F(32,24,6)}
  ...
  <path d="M28 48 L24 54 M36 48 L40 54" stroke="#86efac" stroke-width="1.4" stroke-linecap="round" opacity="0.35"/>
    ${N([[20,40,.5],[44,40,.5]],`#86efac`,.4)}`}function ua(){return`${M(30,54,20,4)}
    ...
    ${j(48,22,5,`#ef4444`,`#991b1b`)}`}function da(){return`${M(32,54,18,4)}
    ...
    ${N([[32,8,.6],[56,32,.6],[32,56,.6],[8,32,.6]],`#bae6fd`,.4)}`}function fa(){return`${M(26,54,20,4)}
    ...
    ${N([[8,20,.6],[42,20,.6]],`#bae6fd`,.4)}`}function pa(){return`${M(32,54,22,4)}
    ...
    ${N([[44,10,.75],[30,28,.55],[20,46,.5]],`#e9d5ff`,.5)}`}function ma(){return`${M(32,54,24,4)}
    ...
    ${N([[32,28,.7],[12,38,.5],[52,38,.5]],`#bae6fd`,.45)}`}function ha(){return`${M(32,56,14,3)}
    ${P(32,34,6)}
    ${Pr(32,28,`#38bdf8`,`#7dd3fc`)}
    ...
    <text x="10" y="18" font-size="6" fill="#e9d5ff" opacity="0.55">?</text>`}function ga(){return`${M(30,56,16,3.5)}
    ${P(24,40,5.5)}
    ...
    ${N([[30,12,.7],[50,10,.6]],`#fecaca`,.55)}`}function _a(){return`${M(30,54,18,3.5)}
    ...
    <circle cx="42" cy="22" r="8" fill="#7dd3fc" opacity="0.12"/>`}function va(){return`${M(32,54,14,3.5)}
    ${Fr(32,36,30,!1)}
    ${Rr(32,34,4)}
    ...
    <path d="M24 38 L28 42 M36 38 L40 42" stroke="#d6d3d1" stroke-width="1.2" stroke-linecap="round" opacity="0.4"/>`}function ya(){return`${M(32,56,14,3)}
    ${P(32,38,7)}
    ...
    <circle cx="32" cy="12" r="4" fill="#fde68a" opacity="0.3"/>`}function ba(){return`${M(32,54,20,4)}
    ...
    <path d="M18 44 L22 40 M46 18 L50 14" stroke="#fbbf24" stroke-width="1.2" stroke-linecap="round" opacity="0.45"/>`}function xa(){return`${M(32,54,18,3.5)}
    ...
    <circle cx="32" cy="40" r="14" fill="none" stroke="#60a5fa" stroke-width="0.8" opacity="0.2"/>`}var Sa={nudge:()=>R(`nu`,`#94a3b8`,`#1e293b`,Ni()),backstep:()=>R(`bs`,`#9ca3af`,`#1f2937`,Pi()),retreat_3:()=>R(`ret`,`#93c5fd`,`#1e3a5f`,Fi()),leapfrog:()=>R(`lf`,`#94a3b8`,`#1e293b`,zi()),long_step:()=>z(`ls`,`#7dd3fc`,`#1e3a5f`,ea()),sidestep:()=>R(`ss`,`#9ca3af`,`#1f2937`,Xi()),blink_2:()=>z(`bl`,`#38bdf8`,`#0c4a6e`,oa()),random_teleport:()=>R(`rtp`,`#a78bfa`,`#312e81`,Bi()),recall:()=>R(`rc`,`#93c5fd`,`#1e3a5f`,Li()),repel:()=>R(`rp`,`#94a3b8`,`#1e293b`,Ri()),mass_nudge:()=>z(`mn`,`#7dd3fc`,`#1e3a5f`,fa()),displacement:()=>B(`dp`,`#b794f4`,`#553c7a`,pa()),swap_friendly:()=>R(`sw`,`#a78bfa`,`#312e81`,Yi()),dominion:()=>z(`dm`,`#60a5fa`,`#1e3a5f`,xa()),shield_1:()=>R(`s1`,`#60a5fa`,`#1e3a5f`,Qi()),shield_2:()=>z(`s2`,`#38bdf8`,`#0c4a6e`,ta()),bulwark:()=>B(`bw`,`#b794f4`,`#553c7a`,Ci()),barrier:()=>R(`br`,`#94a3b8`,`#1f2937`,qi()),last_stand:()=>B(`ls`,`#38bdf8`,`#0c4a6e`,ha()),martyr:()=>V(`my`,`#fca5a5`,`#4c0519`,ga()),fortify:()=>z(`fo`,`#a78bfa`,`#4c1d95`,Ti()),sanctuary_pulse:()=>z(`sp`,`#7dd3fc`,`#1e3a5f`,ma()),sanctuary:()=>B(`sa`,`#c4b5fd`,`#4c1d95`,Oi()),deflect_1:()=>z(`df`,`#38bdf8`,`#0c4a6e`,ra()),anchor_2:()=>R(`an`,`#94a3b8`,`#1f2937`,Ii()),iron_will:()=>R(`iw`,`#9ca3af`,`#1f2937`,Ui()),vengeance:()=>B(`vg`,`#9f7aea`,`#3b0764`,Di()),rally:()=>R(`rl`,`#60a5fa`,`#1e3a5f`,Vi()),forward_bolt:()=>z(`fb`,`#fde68a`,`#1e3a5f`,ia()),destroy_unshielded:()=>Lr(`sh`,`#4338ca`,`#1e1b4b`,Wr()),pyromancy:()=>Lr(`py`,`#ea580c`,`#431407`,Gr()),snipe:()=>z(`sn`,`#fde68a`,`#1e3a5f`,ba()),duel:()=>R(`du`,`#d4b896`,`#3d2817`,Xr()),sacrifice:()=>z(`sc`,`#fca5a5`,`#1e3a5f`,ua()),cull:()=>V(`cu`,`#a78bfa`,`#2e1065`,Yr()),execution:()=>B(`ex`,`#6ee7b7`,`#14532d`,Zr()),chain_lightning:()=>Lr(`cl`,`#2563eb`,`#0c1929`,Ur()),backstab:()=>z(`bk`,`#c4a574`,`#2d4a6e`,Vr()),cryo_bolt:()=>z(`cb`,`#7dd3fc`,`#0c4a6e`,_a()),bomb:()=>Lr(`bm`,`#f59e0b`,`#78350f`,Hr()),shockwave:()=>V(`sw`,`#c4b5fd`,`#3b1f6e`,ei()),plague:()=>V(`pg`,`#86efac`,`#14532d`,ti()),magnet:()=>V(`mg`,`#6ee7b7`,`#14532d`,Qr()),poison_3:()=>z(`po`,`#86efac`,`#14532d`,na()),root_2:()=>z(`ro`,`#86efac`,`#14532d`,la()),panic:()=>R(`pn`,`#fca5a5`,`#1f2937`,Ji()),blizzard:()=>B(`bz`,`#7dd3fc`,`#1e3a5f`,Si()),snowball:()=>R(`sb`,`#bae6fd`,`#0c4a6e`,$i()),berserk:()=>Lr(`bk`,`#991b1b`,`#450a0a`,Jr()),create_foe:()=>R(`cf`,`#78716c`,`#292524`,Ki()),deep_freeze:()=>V(`df`,`#7dd3fc`,`#0c4a6e`,si()),reverse_only_2:()=>z(`rv`,`#fca5a5`,`#1e3a5f`,ca()),press:()=>R(`pr`,`#fca5a5`,`#1f2937`,Zi()),tangle:()=>B(`tg`,`#93c5fd`,`#312e81`,_i()),blind:()=>B(`bl`,`#a78bfa`,`#4c1d95`,ji()),confusion:()=>V(`cf`,`#c4b5fd`,`#4c1d95`,ii()),extract:()=>B(`ex`,`#c4b5fd`,`#4c1d95`,ai()),fog_2:()=>Or(`${kr(32,34,6)}<ellipse cx="32" cy="24" rx="16" ry="8" fill="currentColor" opacity="0.22"/>`),crown:()=>z(`cr`,`#fbbf24`,`#451a03`,aa()),demote:()=>R(`dm`,`#fca5a5`,`#1f2937`,Wi()),fusion:()=>B(`fu`,`#8b5cf6`,`#4c1d95`,ki()),clone:()=>V(`cln`,`#93c5fd`,`#312e81`,fi()),chameleon:()=>B(`ch`,`#86efac`,`#312e81`,Ai()),hibernation:()=>V(`hi`,`#c4b5fd`,`#4c1d95`,Ei()),quicksand:()=>R(`qs`,`#a8a29e`,`#292524`,Gi()),landmine:()=>z(`lm`,`#78716c`,`#292524`,sa()),collapse:()=>R(`co`,`#78716c`,`#292524`,va()),darkness:()=>B(`dk`,`#6d28d9`,`#1e1b4b`,wi()),scatter:()=>z(`st`,`#7dd3fc`,`#1e3a5f`,da()),call_forward:()=>B(`cfw`,`#fca5a5`,`#4c1d95`,bi()),dash:()=>B(`ds`,`#c4b5fd`,`#4c1d95`,xi()),earthquake:()=>V(`eq`,`#78716c`,`#292524`,qr()),coin_flip:()=>mi(),ignore:()=>R(`ig`,`#94a3b8`,`#1f2937`,Hi()),counterspell:()=>V(`cs`,`#a78bfa`,`#2e1065`,oi()),purify:()=>V(`pu`,`#6ee7b7`,`#14532d`,li()),trickster:()=>B(`tr`,`#c4b5fd`,`#553c7a`,Mi()),offering:()=>B(`of`,`#d8b4fe`,`#553c7a`,gi()),quick_march:()=>V(`qm`,`#60a5fa`,`#1e3a5f`,$r()),constitution:()=>V(`co`,`#4ade80`,`#14532d`,pi()),last_king:()=>z(`lk`,`#fbbf24`,`#1e3a5f`,ya()),revive:()=>Lr(`rv`,`#15803d`,`#052e16`,Kr()),mind_control:()=>V(`mc`,`#c4b5fd`,`#3b0764`,ni()),zombify:()=>Lr(`zb`,`#4ade80`,`#14532d`,ri()),bounty:()=>V(`bo`,`#4ade80`,`#14532d`,ui()),link_fate:()=>V(`lf`,`#a78bfa`,`#2e1065`,di()),bishop_2:()=>z(`bp`,`#b794f4`,`#4c1d95`,vi()),rook_2:()=>z(`rk`,`#a78bfa`,`#4c1d95`,yi()),hostile_swap:()=>V(`hs`,`#93c5fd`,`#312e81`,ci()),deport:()=>B(`dp`,`#c4b5fd`,`#1e1b4b`,hi())};function Ca(e,t=0){let n=Sa[e.effect];return n?n(t):null}var wa={movement:{symbol:`↗`,label:`Motion`,anim:`movement`},combat:{symbol:`⚔`,label:`Strike`,anim:`combat`},defense:{symbol:`🛡`,label:`Ward`,anim:`defense`},debuff:{symbol:`❄`,label:`Curse`,anim:`debuff`},transform:{symbol:`✦`,label:`Morph`,anim:`transform`},board:{symbol:`◇`,label:`Terrain`,anim:`board`},crown:{symbol:`♔`,label:`Royal`,anim:`crown`},arcane:{symbol:`✧`,label:`Arcane`,anim:`arcane`}},Ta=[[`movement`,[`nudge`,`backstep`,`long_step`,`leapfrog`,`recall`,`teleport`,`random_teleport`,`displacement`,`berserk`,`dash`]],[`combat`,[`stab`,`shatter`,`destroy`,`snipe`,`duel`,`execution`,`cull`,`pyromancy`,`backstab`,`sacrifice`,`chain_lightning`,`cryo`,`bomb`,`magnet`]],[`special`,[`create_foe`,`clone`,`earthquake`]],[`defense`,[`shield`,`ward`,`aegis`,`bulwark`,`stall`,`sanctuary`,`barrier`,`anchor`,`iron_will`,`hibernation`,`constitution`]],[`debuff`,[`root`,`panic`,`backpedal`,`blizzard`,`deep_freeze`,`snowball`,`blind`,`confusion`,`extract`,`press`,`tangle`,`shockwave`]],[`board`,[`quicksand`,`landmine`,`collapse`,`darkness`,`earthquake`,`scatter`,`call_forward`]],[`meta`,[`counterspell`,`vengeance`,`last_stand`,`martyr`,`purify`,`trickster`,`ignore`,`offering`,`quick_march`,`dominion`,`last_king`,`revive`,`mind_control`,`zombify`]]];function Ea(e){let t=0;for(let n=0;n<e.length;n++)t=(t+e.charCodeAt(n)*41)%360;return t}function Da(e){let t=0;for(let n=0;n<e.length;n++)t=(t+e.charCodeAt(n)*13)%3;return t}function Oa(e){let t=`${e.id} ${e.effect} ${e.name}`.toLowerCase();for(let[e,n]of Ta)if(Array.isArray(n)&&n.some(e=>t.includes(e)))return e;return`arcane`}function ka(e){return`ca${String(e).replace(/[^a-zA-Z0-9]/g,``)}`}function Aa(e,t,n){let r=[[12,18,.35],[48,12,.5],[52,44,.25],[18,50,.4],[38,28,.55]],i=n*4;return r.map(([e,n,r],a)=>`<circle cx="${(e+i+a*7)%56+4}" cy="${(n+i*2+a*5)%52+6}" r="1.2" fill="hsl(${t} 90% 85% / ${r})"/>`).join(``)}function ja(e,t){let n=t,r={movement:`
      ...
      </g>`};return r[e]||r.arcane}function Ma(e,t,n,r){return Na(e,t,n,r)}function Na(e,t,n,r){let i=ka(n),a=(t+42)%360,o=Da(n),s=r&&Ca(r,o)||ja(e,o);return r?.effect&&Br(r.effect)&&s?`<svg class="spell-card__svg spell-card__svg--full-bleed" viewBox="0 0 70 60" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid meet">${s}</svg>`:`<svg class="spell-card__svg" viewBox="0 0 70 60" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
    ...
    <div class="spell-card__frame">
      ...
      <div class="spell-card__type-frame${s?` spell-card__type-frame--with-hint`:``}">
        ...
        ${t.meta?`<span class="spell-card__meta">${za(t.meta)}</span>`:``}
      </div>
      ${o?`<div class="spell-card__text-frame"><p class="spell-card__desc">${za(e.desc)}</p></div>`:``}
    </div>
    <div class="spell-card__tooltip" role="tooltip">
      <strong>${za(e.name)}</strong>
      ${Fa(e)}
    </div>
  `,t.onClick&&l.addEventListener(`click`,n=>t.onClick(n,e)),La(l),l}function za(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function Ba(e){return document.getElementById(e)}function Va(){let e=Ba(`card-preview-modal`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function Ha(e){document.body.classList.toggle(`card-preview-open`,e),window.dispatchEvent(new CustomEvent(`card-preview-change`,{detail:{open:e}}))}function Ua(){Ba(`card-preview-modal`)?.classList.add(`hidden`),Ba(`card-preview-mount`)?.classList.remove(`card-preview-mount--reveal-only`),Ha(!1)}function Wa(e,t={}){Va();let n=Ba(`card-preview-modal`),r=Ba(`card-preview-mount`),i=Ba(`card-preview-actions`);if(!(!n||!r||!e)){if(r.innerHTML=``,r.classList.toggle(`card-preview-mount--reveal-only`,!!t.hideDesc),r.appendChild(Ra(e,{static:!0,hideDesc:t.hideDesc})),i){if(i.innerHTML=``,t.meta){let e=document.createElement(`p`);e.className=`card-preview-meta`,e.textContent=t.meta,i.appendChild(e)}let e=document.createElement(`div`);if(e.className=`card-preview-actions-row`,t.onPlay){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=`Cast spell`,n.addEventListener(`click`,()=>{Ua(),t.onPlay()}),e.appendChild(n)}if(t.onAdd){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=`Add to deck`,n.disabled=!!t.addDisabled,n.addEventListener(`click`,()=>{t.addDisabled||t.onAdd()}),e.appendChild(n)}if(t.onBuy){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-primary`,n.textContent=t.buyLabel||`Buy copy`,n.disabled=!!t.buyDisabled,n.addEventListener(`click`,()=>{t.buyDisabled||t.onBuy()}),e.appendChild(n)}if(t.onRemove){let n=document.createElement(`button`);n.type=`button`,n.className=`btn-secondary`,n.textContent=`Remove all from deck`,n.addEventListener(`click`,()=>{t.onRemove(),Ua()}),e.appendChild(n)}e.children.length&&i.appendChild(e)}n.classList.remove(`hidden`),Ha(!0)}}function Ga(){Ba(`card-preview-close`)?.addEventListener(`click`,Ua),Ba(`card-preview-backdrop`)?.addEventListener(`click`,Ua),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&Ua()})}function Ka(e,t=`.spell-card`){e&&e.querySelectorAll(t).forEach((e,t)=>{e.classList.add(`spell-card--deal`),e.style.animationDelay=`${t*.1}s`})}function qa(e){e&&(e.classList.add(`spell-card--rare-burst`),setTimeout(()=>e.classList.remove(`spell-card--rare-burst`),900))}function Ja(e){e&&(e.classList.add(`spell-card--epic-burst`),setTimeout(()=>e.classList.remove(`spell-card--epic-burst`),1200))}function Ya(e){e&&(e.classList.add(`spell-card--legendary-burst`),setTimeout(()=>e.classList.remove(`spell-card--legendary-burst`),1500))}function Xa(e,t){t===`legendary`?Ya(e):t===`epic`?Ja(e):t===`rare`&&qa(e)}var Za={common:10,uncommon:20,rare:30,epic:40,legendary:50};function Qa(e){return Za[e]??30}function $a(e,r){let i=oe(e,r);if(i<1)return{success:!1,message:`Get this spell from a chest first.`};let a=n(r);if(!a)return{success:!1,message:`Unknown card.`};let o=t(r);if(i>=o)return{success:!1,message:`You already own the maximum (${o} copies).`};let s=Qa(a.rarity);if(e.gems<s)return{success:!1,message:`Need ${s} gems (${e.gems} available).`};e.gems-=s;let c=ye(e,r,1);return c?{success:!0,cost:s,message:`+1 ${a.name} for ${s} gems (${i+c} owned).`}:(e.gems+=s,T(e),{success:!1,message:`You already own the maximum copies for this rarity.`})}var eo={deck:`<svg class="nav-icon-svg" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  </svg>`};function to(){let e={deck:eo.deck,chests:eo.chests,play:eo.play,pvp:eo.pvp,quests:eo.quests};for(let t of document.querySelectorAll(`.game-nav .tab-btn[data-tab]`)){let n=t.querySelector(`.tab-btn__icon`),r=t.dataset.tab;n&&e[r]&&(n.innerHTML=e[r])}}var no=`arcaneCheckersSettings_v1`,ro={musicEnabled:!0,musicVolume:.45,sfxEnabled:!0,sfxVolume:.7,hapticsEnabled:!0},io={...ro};function ao(){try{let e=localStorage.getItem(no);return e?{...ro,...JSON.parse(e)}:{...ro}}catch{return{...ro}}}function H(){return{...io}}function oo(e){io={...io,...e};try{localStorage.setItem(no,JSON.stringify(io))}catch{}return window.dispatchEvent(new CustomEvent(`arcane-settings-changed`,{detail:H()})),H()}function so(){return io=ao(),H()}var co={hub:`assets/audio/background.m4a`,match:`assets/audio/background.m4a`},lo={tap:`assets/audio/sfx/tap.mp3`,spell:`assets/audio/sfx/spell.mp3`,capture:`assets/audio/sfx/capture.mp3`,win:`assets/audio/sfx/win.mp3`,chest:`assets/audio/sfx/chest.mp3`},uo=null,fo=null,po=`hub`,mo=!1;function ho(){return typeof Audio<`u`}function go(e,t){if(!(!ho()||!H().sfxEnabled))try{let n=new Audio(e);n.volume=Math.max(0,Math.min(1,t*H().sfxVolume)),n.play().catch(()=>{})}catch{}}function _o(e){let t=co[e];if(!t||!ho())return null;let n=e===`hub`?uo:fo;return n||(n=new Audio(t),n.loop=!0,n.preload=`auto`,e===`hub`?uo=n:fo=n),n}function vo(e){e&&(e.volume=Math.max(0,Math.min(1,H().musicVolume)))}function yo(){uo?.pause(),fo?.pause()}function bo(){mo||!ho()||(mo=!0,[uo,fo].forEach(e=>{e&&e.play().then(()=>e.pause()).catch(()=>{})}))}function xo(e){if(po=e,!H().musicEnabled){yo();return}let t=_o(`hub`),n=_o(`match`);e===`match`?(t?.pause(),n&&(vo(n),n.play().catch(()=>{}))):(n?.pause(),t&&(vo(t),t.play().catch(()=>{})))}function So(){if(!H().musicEnabled){yo();return}vo(uo),vo(fo),xo(po)}function Co(){if(!ho())return;window.addEventListener(`arcane-settings-changed`,()=>So());let e=()=>{bo(),H().musicEnabled&&xo(po),window.removeEventListener(`pointerdown`,e),window.removeEventListener(`keydown`,e)};window.addEventListener(`pointerdown`,e,{once:!0}),window.addEventListener(`keydown`,e,{once:!0})}function wo(e){let t=lo[e];t&&go(t,1)}var To={tap:()=>wo(`tap`),spell:()=>wo(`spell`),capture:()=>wo(`capture`),win:()=>wo(`win`),chest:()=>wo(`chest`)},Eo=null,Do=!1;async function Oo(){if(Do)return Eo;Do=!0;try{let{Capacitor:e}=await E(async()=>{let{Capacitor:e}=await import(`./dist-DM6qMOWp.js`);return{Capacitor:e}},[],import.meta.url);if(!e.isNativePlatform())return null;Eo=(await E(()=>import(`./esm-TGGH6JYM.js`),[],import.meta.url)).ScreenOrientation}catch{Eo=null}return Eo}async function ko(){document.body.classList.remove(`orientation-match`),document.body.classList.add(`orientation-portrait`);let e=await Oo();if(e)try{await e.lock({orientation:`portrait`})}catch{}}async function Ao(){await ko()}var jo=null;function Mo(){return jo||(jo=document.createElement(`div`),jo.id=`network-banner`,jo.className=`network-banner hidden`,jo.setAttribute(`role`,`status`),jo.setAttribute(`aria-live`,`polite`),document.body.appendChild(jo),jo)}function No(){let e=Mo(),t=!navigator.onLine;e.textContent=t?`No connection — some features need internet`:``,e.classList.toggle(`hidden`,!t)}function Po(){No(),window.addEventListener(`online`,No),window.addEventListener(`offline`,No)}async function Fo(){try{let{Capacitor:e}=await E(async()=>{let{Capacitor:e}=await import(`./dist-DM6qMOWp.js`);return{Capacitor:e}},[],import.meta.url);if(!e.isNativePlatform())return;let{StatusBar:t,Style:n}=await E(async()=>{let{StatusBar:e,Style:t}=await import(`./esm-C-SIlwqj.js`);return{StatusBar:e,Style:t}},[],import.meta.url);await t.setOverlaysWebView({overlay:!0}),await t.setStyle({style:n.Dark}),await t.setBackgroundColor({color:`#080a12`});let{SplashScreen:r}=await E(async()=>{let{SplashScreen:e}=await import(`./esm-Ck_AT-RK.js`);return{SplashScreen:e}},[],import.meta.url);await r.hide()}catch(e){console.warn(`Capacitor init skipped`,e)}}var Io=null,Lo=!1;async function Ro(){if(Lo)return Io;Lo=!0;try{let{Capacitor:e}=await E(async()=>{let{Capacitor:e}=await import(`./dist-DM6qMOWp.js`);return{Capacitor:e}},[],import.meta.url);if(!e.isNativePlatform())return null;let{Haptics:t,ImpactStyle:n}=await E(async()=>{let{Haptics:e,ImpactStyle:t}=await import(`./esm-D_it6P9V.js`);return{Haptics:e,ImpactStyle:t}},[],import.meta.url);Io={Haptics:t,ImpactStyle:n}}catch{Io=null}return Io}async function zo(){if(!H().hapticsEnabled)return;let e=await Ro();if(e)try{await e.Haptics.impact({style:e.ImpactStyle.Light})}catch{}}var Bo={bronze:{label:`Bronze`,tagline:`Same odds as Bronze Chest`,visual:`bronze`,accent:`#c77dff`,glow:`rgba(199, 125, 255, 0.45)`},silver:{label:`Silver`,tagline:`Same odds as Silver Chest`,visual:`silver`,accent:`#7dd3fc`,glow:`rgba(125, 211, 252, 0.5)`},gold:{label:`Gold`,tagline:`Same odds as Gold Chest`,visual:`gold`,accent:`#ffd87a`,glow:`rgba(255, 216, 122, 0.55)`}};function Vo(e){let t=Bo[e]||Bo.style_crate,n=t.visual;return{tier:t,lid:n===`gold`?`#f0e6c8`:n===`silver`?`#e4ecf8`:`#e8c4f8`,body:n===`gold`?`#5a4518`:n===`silver`?`#3d4a62`:`#4a2860`,trim:t.accent,ribbon:n===`gold`?`#ff9de2`:n===`silver`?`#a5f3fc`:`#d8b4fe`}}function Ho(e,t){let{lid:n,body:r,trim:i,ribbon:a}=Vo(e);return`
    <defs>
      <linearGradient id="${t}-body" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stop-color="${r}"/>
    ...
    </defs>`}function Uo(e,t,n){let{trim:r,ribbon:i,tier:a}=Vo(e);return`
    ${n?`<g class="chest-stage__interior">
    ...
    </g>`}function Wo(e){let t=`vanityStage-${e}`;return`<svg class="chest-stage-svg vanity-box-svg" viewBox="0 0 120 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ${Ho(e,t)}
    <ellipse class="chest-stage__shadow" cx="60" cy="90" rx="42" ry="8" fill="rgba(0,0,0,0.5)"/>
    ${Uo(e,t,!0)}
  </svg>`}function Go(e){let t=`vanityCard-${e}`;return`<svg class="chest-svg vanity-box-svg" viewBox="0 0 120 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ${Ho(e,t)}
    <ellipse cx="60" cy="90" rx="42" ry="8" fill="rgba(0,0,0,0.5)"/>
    ${Uo(e,t,!1)}
  </svg>`}function Ko(e){let t=qo[e]||qo.avatar_default,n=`av-${e.replace(/[^a-z0-9]/gi,``)}`;return`<svg viewBox="0 0 64 64" class="cosmetic-avatar-svg cosmetic-avatar-svg--${e.replace(`avatar_`,``)}" aria-hidden="true">
    <defs>
    ...
    ${t.svg}
  </svg>`}var qo={avatar_default:{bg:[`#4a5f7a`,`#1e2a3a`],glow:`#8fa4c4`,svg:`<ellipse cx="32" cy="38" rx="14" ry="16" fill="#2a3548"/>
    ...
    </div>`,t.style.animationDelay=`0s`,t}function ts(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function ns(e,t=``){let n=ee(e),r=(t||`P`).charAt(0).toUpperCase(),i=Ko(n.equipped.avatar)||`<span class="profile-avatar-fallback">${ts(r)}</span>`;return`<span class="profile-avatar-stack header-profile-btn__stack ${Xo(n.equipped.frame)}"><span class="profile-avatar-inner header-profile-btn__inner">${i}</span></span>`}async function rs(e){if(!e)return``;try{return(await Ae(e.id))?.username||e.user_metadata?.display_name||e.email?.split(`@`)[0]||``}catch{return e.user_metadata?.display_name||e.email?.split(`@`)[0]||``}}var is=null;function as(){return is||=Promise.all([E(()=>import(`./match-CsaO-YSW.js`),[],import.meta.url),E(()=>import(`./matchView-DpjHyGlf.js`),[],import.meta.url),E(()=>Promise.resolve({}),__vite__mapDeps([0]),import.meta.url),E(()=>Promise.resolve({}),__vite__mapDeps([1]),import.meta.url)]).then(([e,t])=>({MatchSession:e.MatchSession,getMatchHtml:t.getMatchHtml})),is}var os=null;function ss(){return os||=Promise.all([E(()=>import(`./pvpUI-DT7GZuBF.js`),[],import.meta.url),E(()=>import(`./pvp-CuBNaDSn.js`),[],import.meta.url)]).then(([e,t])=>({initPvpUI:e.initPvpUI,clearAllWaitingRoomsOnce:t.clearAllWaitingRoomsOnce})),os}var cs=null;function ls(){return cs||=E(()=>import(`./profileUI-CgWeuQ4Z.js`),[],import.meta.url),cs}function us(){cs=null}var ds=null;function fs(){return ds||=Promise.all([E(()=>import(`./settingsUI-s90lC-iN.js`),[],import.meta.url),E(()=>Promise.resolve({}),__vite__mapDeps([2]),import.meta.url)]).then(([e])=>e),ds}var ps=null;function ms(){return ps||=Promise.all([E(()=>import(`./chestOpenAnimation-D0FPTTLn.js`),[],import.meta.url),E(()=>import(`./cosmeticOpenAnimation-D-5qlV2U.js`),[],import.meta.url),E(()=>import(`./titleOpenAnimation-s61-c8ZV.js`),[],import.meta.url)]).then(([e,t,n])=>({playChestOpenAnimation:e.playChestOpenAnimation,playCosmeticOpenAnimation:t.playCosmeticOpenAnimation,playTitleOpenAnimation:n.playTitleOpenAnimation})),ps}var hs=null;function gs(){return hs||=E(()=>import(`./tutorialMeta-LNmraQ9q.js`),[],import.meta.url),hs}var _s=null;function vs(){return _s||=E(()=>import(`./tutorialUnlocks-fXSQ_TIS.js`),[],import.meta.url),_s}var ys=null;function bs(){return ys||=E(()=>import(`./tutorialMatch-CfI7lPcN.js`),[],import.meta.url),ys}function xs(e,t){gs().then(n=>n.notifyMetaTutorial(e,t))}function Ss(e,t){vs().then(n=>n.notifyUnlockTutorial(e,t))}var U;try{U=be()}catch(e){console.error(`Failed to load profile, resetting save:`,e),localStorage.removeItem(`cardCheckersProfile_v7`),localStorage.removeItem(`cardCheckersProfile_v5`),U=be()}var W=`deck`,Cs={deck:`Decks`,chests:`Shop`,play:`Play`,pvp:`PvP`,quests:`Quests`,profile:`Profile`,settings:`Settings`},ws=new Set(Object.keys(Cs)),Ts=`cards`,Es=`list`,G=null,K=[],Ds=null,Os=``,ks=`all`,As=`all`,js=!0,Ms={legendary:5,epic:4,rare:3,uncommon:2,common:1};function Ns(e){return[...e].sort((e,t)=>{let n=Ms[e.rarity]??0,r=Ms[t.rarity]??0;return n===r?e.name.localeCompare(t.name):r-n})}var q=null,Ps=null,Fs=null;function Is(){return Ps?Promise.resolve(Ps):(Fs||=ss().then(({initPvpUI:e,clearAllWaitingRoomsOnce:t})=>(t(),Ps=e({root:document.getElementById(`view-pvp`),getProfile:()=>U,openAuthModal:()=>Rs?.open(`signin`,{forced:!0}),onNavigateTab:Z,onOpenDeckEdit:el,onPvpViewShown:()=>{W=`pvp`,ic()}}),Ps)),Fs)}var Ls=null,Rs=null,J=!1,zs=!1,Bs=!1,Vs=!1,Hs=!1,Us=null,Ws=null,Gs=null,Y=1,Ks=null;function qs(e){return Ms[e?.rarity]??0}function Js(e){let t=r(e);return Object.entries(t).map(([e,t])=>({def:n(e),count:t})).filter(e=>e.def).sort((e,t)=>{let n=qs(t.def)-qs(e.def);return n===0?e.def.name.localeCompare(t.def.name):n})}function Ys(e){let t=K.indexOf(e);t<0||(K.splice(t,1),il(),xs(`card-removed-from-deck`,{cardId:e}))}function Xs(e){let t=K.length;K=K.filter(t=>t!==e),K.length!==t&&(il(),xs(`card-removed-from-deck`,{cardId:e}))}function Zs(){let n=e().map(e=>({def:e,owned:oe(U,e.id)})).filter(e=>e.owned>0).sort((e,t)=>{let n=qs(t.def)-qs(e.def);return n===0?e.def.name.localeCompare(t.def.name):n});K=[];for(let{def:e,owned:r}of n){let n=Math.min(r,t(e));for(let t=0;t<n&&K.length<30;t++)K.push(e.id);if(K.length>=30)break}il()}var X=e=>document.getElementById(e);function Qs(){let e=document.getElementById(`adventure-prebattle`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function $s(){let e=document.querySelector(`nav.game-nav.tabs`);e&&e.parentElement!==document.body&&document.body.appendChild(e)}function ec(){return window.matchMedia(`(min-width: 1000px) and (max-width: 1400px)`).matches?2.5:window.matchMedia(`(min-width: 600px) and (max-width: 999px)`).matches?1.85:1}function tc(){Qs(),document.getElementById(`adventure-prebattle`)?.classList.remove(`hidden`),document.body.classList.add(`adventure-floor-open`)}function nc(){document.getElementById(`adventure-prebattle`)?.classList.add(`hidden`),document.body.classList.remove(`adventure-floor-open`)}function rc(e=S,t=`Locked`){Gn({title:t,bodyHtml:e,autoCloseMs:4500})}function ic(){document.body.classList.toggle(`main-tab-active`,ws.has(W)),document.body.classList.toggle(`adventure-active`,W===`play`)}function ac(e,t,n){let r=e.querySelector(`.tab-btn__sign-in-badge`);t?(r||(r=document.createElement(`span`),r.className=`tab-btn__sign-in-badge`,r.setAttribute(`aria-hidden`,`true`),e.appendChild(r)),r.textContent=n,e.classList.add(`tab-btn--sign-in-nudge`)):(r?.remove(),e.classList.remove(`tab-btn--sign-in-nudge`))}function oc(){let e=h(U),t=$t();for(let n of[`quests`,`pvp`]){let r=document.querySelector(`.tab-btn[data-tab="${n}"]`);if(!r)continue;let i=n===`pvp`?`PvP`:`Quests`,a=!e,o=n===`pvp`?Zt:Qt;r.classList.toggle(`tab-btn--locked`,a),r.setAttribute(`aria-disabled`,a?`true`:`false`),a?(r.title=t?`${l(i)} ${o}.`:l(i),ac(r,t,`Sign in`)):t?(r.title=o,ac(r,n===`pvp`,`Sign in`)):(r.title=``,ac(r,!1))}let n=m(U),r=document.querySelector(`.vault-tab[data-vault-tab="cosmetics"]`);r&&(r.classList.toggle(`vault-tab--locked`,!n),r.title=n?``:pe,r.setAttribute(`aria-disabled`,n?`false`:`true`))}async function Z(e){let t=document.getElementById(`view-match`);if(!(J&&t&&!t.classList.contains(`hidden`))){if(!zs&&(e===`quests`||e===`pvp`)&&!h(U)){let t=e===`pvp`?`PvP`:`Quests`,n=$t(),r=e===`pvp`?Zt:Qt;await $e(n?`${l(t)}\n\n${r}.`:l(t),{title:`${t} locked`,confirmLabel:`Go to Adventure`,cancelLabel:n?`Sign in`:`Not now`})?(zs=!0,Z(`play`),zs=!1):n&&Rs?.open(`signin`,{forced:!0});return}if(cr(),$n()&&tr()){if(e===W)return;if(!(e===`pvp`&&document.getElementById(`pvp-match-root`))){if(!await $e(`Leave your current match to open ${Cs[e]||e}?`,{title:`Leave match?`,confirmLabel:`Leave`,cancelLabel:`Stay`,destructive:!0}))return;nr(e),ar(),document.querySelector(`#btn-leave-match`)?.click();return}}if(Es===`edit`&&(e!==`deck`||e===`deck`&&W===`deck`)){if(!await Qc())return;$c()}e!==`deck`&&Es===`edit`&&(jc(),document.body.classList.remove(`deck-editing`)),W=e,ic(),ws.has(e)&&kc(),document.querySelectorAll(`.tab-btn`).forEach(t=>{t.classList.toggle(`active`,t.dataset.tab===e)}),document.querySelectorAll(`.view`).forEach(t=>{t.classList.toggle(`hidden`,t.id!==`view-${e}`)}),xs(`tab-changed`,{tab:e}),Ss(`tab-changed`,{tab:e}),e===`chests`&&(Vc(Ts),Uc()),e===`deck`&&(Es=`list`,Nc(`list`)),e===`profile`&&fc(),e===`settings`&&pc(),e===`quests`&&(gc(),vc()),e===`play`&&ll(),e===`pvp`&&Is().then(e=>e?.render({resume:!0})).catch(e=>{console.error(`[PvP] init failed`,e);let t=document.getElementById(`view-pvp`);t&&!t.innerHTML.trim()&&(t.innerHTML=`<section class="panel game-panel pvp-panel"><p class="pvp-status pvp-status--error">Couldn't load PvP — please reload the page.</p></section>`)}),$n()||(xo(`hub`),await ko())}}var Q=``;function sc(e=Q){e&&(Q=e);let t=document.getElementById(`header-profile-menu`),n=document.getElementById(`header-profile-btn`),r=document.getElementById(`header-username`),i=document.getElementById(`auth-header-btn`),a=!!D();if(i&&(i.classList.toggle(`hidden`,a),i.hidden=a),t&&(t.classList.toggle(`hidden`,!a),t.hidden=!a),r){let e=a&&Q;r.textContent=e?Q:``,r.classList.toggle(`hidden`,!e),r.hidden=!e}n&&a&&(n.innerHTML=ns(U,Q),n.title=Q?`Account — ${Q}`:`Account menu`)}function cc(){let e=document.getElementById(`header-profile-btn`),t=document.getElementById(`header-profile-dropdown`);!e||!t||(t.classList.add(`hidden`),t.hidden=!0,e.setAttribute(`aria-expanded`,`false`))}function lc(){let e=document.getElementById(`header-profile-menu`),t=document.getElementById(`header-profile-btn`),n=document.getElementById(`header-profile-dropdown`);if(!e||!t||!n)return;let r=e=>{n.classList.toggle(`hidden`,!e),n.hidden=!e,t.setAttribute(`aria-expanded`,e?`true`:`false`)};t.addEventListener(`click`,e=>{e.stopPropagation();let t=!n.hidden;r(!t)}),n.querySelectorAll(`[data-profile-menu-action]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.profileMenuAction;cc(),t===`settings`?Z(`settings`):dc()})}),document.addEventListener(`click`,t=>{n.hidden||e.contains(t.target)||cc()}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&!n.hidden&&cc()})}async function uc(){let e=D();if(!e){Q=``,sc();return}Q=await rs(e),sc()}function dc(){cc(),Z(`profile`),Ss(`profile-opened`)}async function fc(){let{renderProfileTab:e}=await ls(),t=X(`view-profile`);e(U,t,{onGemsChange:yc,onTitleChanged:()=>sc()})}async function pc(){let{renderSettingsTab:e}=await fs();e(X(`view-settings`),{onUsernameChanged:e=>{Q=e,sc(e)}})}var mc=`
  ...
  <section class="panel game-panel quests-panel quests-panel--error">
  ...
  </section>`;function gc(){let e=X(`view-quests`);e&&(e.innerHTML=mc)}function _c(e=X(`view-quests`)){e&&(e.innerHTML=hc,e.querySelector(`.quests-retry-btn`)?.addEventListener(`click`,()=>{us(),gc(),vc()}))}async function vc(){let e=X(`view-quests`);if(e)try{let{renderQuestsTab:t}=await ls();t(U,e,{onTitleChanged:()=>sc(),onCurrencyChange:()=>$()})}catch(t){console.error(`[Quests] render failed`,t),_c(e)}}function $(){let e=X(`header-gems`);e&&(e.textContent=String(U.gems??0));let t=X(`header-stars`);t&&(t.textContent=String(U.stars??0)),document.querySelector(`.hud-gems`)?.classList.toggle(`hud-gems--low`,(U.gems??0)<50),document.querySelector(`.hud-stars`)?.classList.toggle(`hud-stars--low`,(U.stars??0)<10)}function yc(){$()}function bc(){document.querySelectorAll(`.collection-owned-only-toggle`).forEach(e=>{e.checked=js});for(let e of[`collection-search`]){let t=X(e);t&&(t.value=Os)}for(let e of[`collection-rarity`]){let t=yr(e);t&&(t.value=ks)}let e=yr(`collection-category`);e&&(e.value=As)}var xc=`(max-width: 899px)`,Sc=`(max-width: 1280px)`,Cc=null;function wc(){return window.matchMedia(xc).matches}function Tc(){return document.body.classList.contains(`main-tab-active`)&&!document.body.classList.contains(`match-active`)&&!document.body.classList.contains(`deck-editing`)&&window.matchMedia(Sc).matches}function Ec(){return document.querySelector(`.game-main`)}function Dc(){let e=Ec();return Tc()&&e?e.scrollTop:window.scrollY||document.documentElement.scrollTop||0}function Oc(e){let t=Ec();if(Tc()&&t){t.scrollTop=e;return}window.scrollTo(0,e)}function kc(){let e=Ec();if(Tc()&&e){e.scrollTop=0;return}window.scrollTo(0,0)}function Ac(){wc()&&(Cc=Dc(),document.body.style.position=`fixed`,document.body.style.top=`0`,document.body.style.left=`0`,document.body.style.right=`0`,document.body.style.width=`100%`)}function jc(){if(Cc==null)return;let e=Cc;Cc=null,document.body.style.position=``,document.body.style.top=``,document.body.style.left=``,document.body.style.right=``,document.body.style.width=``,Oc(e)}function Mc(){kc(),document.documentElement.scrollTop=0,document.body.scrollTop=0,document.querySelector(`.game-shell`)?.scrollTo?.(0,0),Ec()?.scrollTo?.(0,0),document.querySelector(`#view-deck`)?.scrollTo?.(0,0),document.querySelectorAll(`#deck-subview-edit, #deck-subview-edit .deck-editor, #deck-subview-edit .deck-editor__body, #deck-subview-edit .deck-editor__grid, #deck-subview-edit .deck-editor__grid-cards`).forEach(e=>{e.scrollTop=0})}function Nc(e){e!==`edit`&&jc(),Es=e,document.body.classList.toggle(`deck-editing`,e===`edit`),X(`deck-subview-list`)?.classList.toggle(`hidden`,e!==`list`),X(`deck-subview-edit`)?.classList.toggle(`hidden`,e!==`edit`),e===`edit`&&(Ac(),w(U),T(U),ks=`all`,Os=``,As=`all`,js=!0,bc(),Xc()),e===`list`&&rl(),e===`edit`&&(il(),Mc(),requestAnimationFrame(()=>{Mc(),requestAnimationFrame(Mc)}))}function Pc({id:e,title:t,desc:n,cost:r,variant:i=`mystery`}){let a=(U.stars??0)>=r,o=i===`title`?Bt():Ht();return`
    ...
    </article>`}function Fc(e,t){e.querySelector(`[data-mystery-open]`)?.addEventListener(`click`,e=>{e.stopPropagation(),t()}),e.addEventListener(`click`,t),e.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),t())})}function Ic({bonusGems:e=0,bonusStars:t=0}={}){let n=[];return e&&n.push(`+${e} gem refund`),t&&n.push(`+${t} ★ from duplicates`),n.length?` (${n.join(`, `)})`:``}async function Lc(e,t){let{playChestOpenAnimation:n,playCosmeticOpenAnimation:r,playTitleOpenAnimation:i}=await ms();e.kind===`card`?(await n({tier:`silver`,tierLabel:`Mystery Box`,pulls:e.cardPulls}),t&&(t.textContent=`Got ${e.cardPulls.length} spells.${Ic(e)}`)):e.kind===`cosmetic`?(await r({boxId:`silver`,boxLabel:`Mystery Box`,pulls:e.cosPulls}),t&&(t.textContent=e.message+Ic(e))):e.kind===`mixed`?(e.cardPulls.length&&await n({tier:`silver`,tierLabel:`Mystery Box — Spells`,pulls:e.cardPulls}),e.cosPulls.length&&await r({boxId:`silver`,boxLabel:`Mystery Box — Cosmetics`,pulls:e.cosPulls}),t&&(t.textContent=`${e.message}${Ic(e)}`)):e.kind===`title`&&(await i({boxLabel:`Title Box`,pulls:e.pulls}),t&&(t.textContent=e.message))}async function Rc(){let e=X(`mystery-box-log`);if(!((U.stars??0)>=10)){e&&(e.textContent=`Need 10 ★ stars. Clear Adventure floors to earn stars.`,e.classList.add(`chest-log--error`));return}let t=Jt(U);if(!t.success){e&&(e.textContent=t.message,e.classList.add(`chest-log--error`));return}T(U),$(),e&&e.classList.remove(`chest-log--error`),X(`mystery-box-list`)?.querySelectorAll(`.mystery-box__btn`).forEach(e=>{e.disabled=!0});try{await Lc(t,e)}catch(n){console.error(`Mystery box animation failed:`,n),e&&(e.textContent=t.message)}Uc({clearPulls:!1}),fc()}async function zc(){let e=X(`mystery-box-log`);if(!((U.stars??0)>=10)){e&&(e.textContent=`Need 10 ★ stars. Clear Adventure floors to earn stars.`,e.classList.add(`chest-log--error`));return}let t=Yt(U);if(!t.success){e&&(e.textContent=t.message,e.classList.add(`chest-log--error`));return}T(U),$(),e&&e.classList.remove(`chest-log--error`),X(`mystery-box-list`)?.querySelectorAll(`.mystery-box__btn`).forEach(e=>{e.disabled=!0});try{await Lc(t,e)}catch(n){console.error(`Title box animation failed:`,n),e&&(e.textContent=t.message)}Uc({clearPulls:!1}),fc()}function Bc(){let e=X(`mystery-box-list`);if(!e)return;e.innerHTML=`
    ${Pc({id:`mystery`,title:`Mystery Box`,desc:`6 random pulls — mix of spells and cosmetics (${Math.round(Ut*100)}% cosmetic per slot when unlocked).`,cost:10})}
    ${Pc({id:`title`,title:`Title Box`,desc:`Box-exclusive mage titles only — The Brave, Ruthless, Omnipotent, and more.`,cost:10,variant:`title`})}
  `;let t=e.querySelectorAll(`.mystery-box`);Fc(t[0],()=>Rc()),Fc(t[1],()=>zc())}function Vc(e){if(!Bs&&e===`cosmetics`&&!m(U)){rc(pe,`Cosmetics locked`),Bs=!0,Vc(`cards`),Bs=!1;return}Ts=e,document.querySelectorAll(`.vault-tab`).forEach(t=>{let n=t.dataset.vaultTab===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,n?`true`:`false`)}),document.querySelectorAll(`.vault-tab-panel`).forEach(t=>{let n=t.id===`vault-tab-${e}`;t.classList.toggle(`hidden`,!n),t.hidden=!n}),Ss(`vault-tab-changed`,{tab:e})}function Hc(){ls().then(({renderCosmeticBoxes:e})=>{e(U,X(`cosmetic-box-list`),{logEl:X(`cosmetic-box-log`),onGemsChange:yc,cosmeticsUnlocked:m(U),onOpened:()=>{W===`profile`&&fc(),W===`quests`&&vc()}})})}function Uc(e={}){let{clearPulls:t=!0}=e;$(),Hc(),Bc();let n=X(`chest-list`),r=X(`chest-pulls`);if(r&&t&&(r.innerHTML=``,r.classList.add(`chest-pulls--hidden`),r.classList.remove(`chest-pulls--reveal`)),n){n.innerHTML=``;for(let e of lt){let t=_t[e.id]||_t.bronze,i=U.gems>=e.cost,a=document.createElement(`article`);a.className=`chest-card chest-card--${e.id}${i?``:` chest-card--locked`}`,a.innerHTML=`
    ...
    `;let o=a.querySelector(`.chest-open`);o.disabled=!i,o.addEventListener(`click`,async()=>{if(o.disabled)return;let n=mt(U,e.id),i=X(`chest-log`);if(!n.success){i&&(i.textContent=n.message,i.classList.add(`chest-log--error`));return}T(U),$(),o.disabled=!0;let{playChestOpenAnimation:a}=await ms();if(await a({tier:e.id,tierLabel:t.label,pulls:n.pulls}),xs(`chest-opened`,{chestId:e.id}),i){let t=n.bonusGems?` (+${n.bonusGems} gems from duplicates)`:``;i.textContent=`Got ${n.pulls.length} spells from ${e.name}.${t}`,i.classList.remove(`chest-log--error`)}if(r){r.classList.remove(`chest-pulls--hidden`),r.classList.add(`chest-pulls--reveal`),r.innerHTML=`<p class="chest-pulls__label">Chest opened</p><div class="chest-pulls__grid"></div>`;let e=r.querySelector(`.chest-pulls__grid`);n.pulls.forEach((t,n)=>{let r=Ra(t,{button:!0,deal:!0,gallery:!0,onClick:()=>Wa(t)});if(r.style.animationDelay=`${n*.12}s`,t.duplicate){r.classList.add(`spell-card--duplicate-pull`);let e=document.createElement(`span`);e.className=`chest-pull-dup-badge`,e.textContent=t.starRefund?`Duplicate · +${t.starRefund} ★`:`Duplicate · +${t.gemRefund} ◆`,r.appendChild(e)}e.appendChild(r),Xa(r,t.rarity)}),Ka(e),r.scrollIntoView({behavior:`smooth`,block:`nearest`})}Uc()}),n.appendChild(a)}}}function Wc(){return Ns(e().filter(e=>{if(As!==`all`&&ct(e)!==As||ks!==`all`&&e.rarity!==ks)return!1;if(Os){let t=Os.toLowerCase();if(!e.name.toLowerCase().includes(t)&&!e.desc.toLowerCase().includes(t))return!1}return!(js&&oe(U,e.id)<=0)}))}function Gc(e,t){let n=$a(U,e);return t&&(t.textContent=n.message,t.className=n.success?`deck-status ok`:`deck-status warn`),n.success&&(T(U),$(),Es===`list`&&rl(),Es===`edit`&&il()),n}function Kc(e,t){let n=$a(U,e);return n.success?(T(U),$(),K.push(e),ge(U,e),T(U),il(),t&&(t.hidden=!1,t.textContent=`Bought and added to deck.`,t.className=`deck-editor__error deck-status ok`),!0):(t&&(t.hidden=!1,t.textContent=n.message,t.className=`deck-editor__error deck-status warn`),!1)}function qc(e){return i(K,e,U).ok?(K.push(e),ge(U,e),T(U),il(),xs(`card-added-to-deck`,{cardId:e}),!0):!1}function Jc(e,n,a={}){let{deckEdit:o=!1,statusEl:s=null}=a,c=oe(U,n.id),l=t(n),u=c>=l,d=Qa(n.rarity),f=U.gems>=d&&!u,p=o?i(K,n.id,U):{ok:!1},m=o&&r(K)[n.id]||0,h=K.length<30,g=m<l,ee=c>=1&&c<=m,_=c>=1&&!u,v=o&&!p.ok&&h&&g&&ee&&_,y=()=>Gc(n.id,s),b=()=>{let e=oe(U,n.id),t=o&&r(K)[n.id]||0,a=e>=l,s=U.gems>=d&&!a,c=o?i(K,n.id,U):{ok:!1};Wa(n,{meta:o?`Owned ${e}/${l} · In deck ${t}/${l} · ${a?`max copies`:`${d} gems per copy`}`:`Owned ${e}/${l}${a?` · max copies`:` · ${d} gems per copy`}`,buyLabel:a?`Max copies owned`:`Buy copy (${d} gems)`,buyDisabled:!s||a||e<1,onBuy:()=>{y(),Ua()},addDisabled:!c.ok,onAdd:o?()=>{qc(n.id)&&b()}:void 0})};if(o){let t=document.createElement(`div`);t.className=`deck-editor-tile`+(x(U,n.id)?` deck-editor-tile--new`:``);let r=Ra(n,{button:!0,gallery:!0,onClick:()=>b()});r.classList.add(`deck-editor-tile__card`),r.title=`${n.name} — tap for full card`;let i=c>0?`Owned ${c}/${l}`:`Not in collection`,a=document.createElement(`div`);a.className=`deck-editor-tile__meta`,a.innerHTML=`${i} · In deck ${m}/${l}${x(U,n.id)?`<span class="deck-editor-tile__new">New</span>`:``}`,a.addEventListener(`click`,()=>b());let o=document.createElement(`button`);o.type=`button`,o.className=`deck-editor-tile__action`,p.ok?(o.classList.add(`deck-editor-tile__action--add`),o.textContent=`+ Add to deck`,o.addEventListener(`click`,e=>{e.stopPropagation(),qc(n.id)})):v?(o.classList.add(`deck-editor-tile__action--buy`),o.textContent=f?`Add for ${d} gems`:`Need ${d} gems`,o.disabled=!f,o.addEventListener(`click`,e=>{e.stopPropagation(),Kc(n.id,s)})):(o.classList.add(`deck-editor-tile__action--disabled`),o.disabled=!0,K.length>=30?o.textContent=`Deck full (30/30)`:m>=l?o.textContent=`Max copies in deck`:c<1?o.textContent=`Open Shop chests to unlock`:p.reason?o.textContent=p.reason:o.textContent=`Can't add`),t.append(r,a,o),e.appendChild(t);return}let S=document.createElement(`div`);S.className=`collection-card-wrap`+(c<1?` collection-card-wrap--unowned`:``);let C=Ra(n,{button:!0,compact:!0,disabled:c<1||u,onClick:e=>{if(e.shiftKey||c<1||u){b();return}y()}});C.title=u?`${n.name} — max ${l} copies owned. Tap to view full card.`:c<1?`${n.name} — not owned. Tap to view full card.`:`${n.name} — tap to buy (${d} gems). Shift+click to inspect.`,S.appendChild(C);let te=document.createElement(`span`);te.className=`collection-owned-count`,te.textContent=c>0?`×${c}`:`—`,S.appendChild(te);let w=document.createElement(`span`);w.className=`collection-buy-cost`,w.textContent=u?`MAX`:`${d} ◆`,(!f||u)&&w.classList.add(`collection-buy-cost--cant`),S.appendChild(w),e.appendChild(S)}function Yc(e,t={}){if(!e)return;let{deckEdit:n=!1,statusEl:r=null}=t;e.innerHTML=``;let i=Wc();if(!i.length){e.className=`deck-editor__grid collection-grid`;let t=document.createElement(`p`);t.className=`collection-grid-empty muted`,t.textContent=n?`No spells match your filters. Try “All types”, clear search, or uncheck Owned only.`:`No cards match your filters. Open chests in the Shop to get more spells.`,e.appendChild(t);return}let a=0,o={deckEdit:n,statusEl:r};if(n||As!==`all`){e.className=`deck-editor__grid collection-grid`;for(let t of i)try{Jc(e,t,o),a+=1}catch(e){console.error(`Failed to render card:`,t?.id,e)}}else{e.className=`deck-editor__grid collection-categories`;let t=Object.fromEntries(at.map(e=>[e,[]]));for(let e of i)t[ct(e)].push(e);for(let n of at){let r=t[n];if(!r.length)continue;let i=document.createElement(`section`);i.className=`collection-category-section`,i.dataset.category=n;let s=document.createElement(`h3`);s.className=`collection-category-title`,s.textContent=ot[n],i.appendChild(s);let c=document.createElement(`div`);c.className=`collection-grid deck-editor__grid-cards`;for(let e of r)try{Jc(c,e,o),a+=1}catch(t){console.error(`Failed to render card:`,e?.id,t)}i.appendChild(c),e.appendChild(i)}}if(i.length>0&&a===0){e.className=`deck-editor__grid collection-grid`;let t=document.createElement(`p`);t.className=`collection-grid-empty collection-grid-empty--error`,t.textContent=`Spells failed to display. Hard refresh the page (Ctrl+Shift+R).`,e.appendChild(t)}}function Xc(){Ds={name:X(`deck-name-input`)?.value?.trim()??``,cardIds:[...K]}}function Zc(){return Ds?(X(`deck-name-input`)?.value?.trim()??``)!==Ds.name||K.length!==Ds.cardIds.length?!0:K.some((e,t)=>e!==Ds.cardIds[t]):!1}async function Qc(){return Zc()?$e(`Discard unsaved changes to this deck?`,{title:`Unsaved changes`,confirmLabel:`Discard`,cancelLabel:`Keep editing`,destructive:!0}):!0}function $c(){G=null,K=[],Ds=null}function el(e){let t=U.decks.find(t=>t.id===e);if(!t)return;G=t.id,K=[...t.cardIds];let n=X(`deck-name-input`);n&&(n.value=t.name),Nc(`edit`),xs(`deck-edit-opened`,{deckId:e})}function tl(e){let t=Object.fromEntries(at.map(e=>[e,0]));for(let r of e){let e=n(r);e&&(t[ct(e)]+=1)}return t}function nl(e){let t=tl(e),n=[];for(let e of at){let r=t[e];if(r<=0)continue;let i=ot[e];n.push(`<span class="deck-row__cat" title="${za(i)}: ${r}"><span class="deck-row__cat-dot deck-row__cat-dot--${e}" aria-hidden="true"></span><span class="deck-row__cat-n">${r}</span></span>`)}return n.length?`<div class="deck-row__cats">${n.join(``)}</div>`:``}function rl(){w(U)&&T(U),$();let e=X(`deck-list`);if(!e)return;e.innerHTML=``;let t=X(`deck-list-count`);if(t){let e=U.decks.length;t.textContent=e?`${e} deck${e===1?``:`s`}`:``}if(!U.decks.length){if(w(U)&&T(U),U.decks.length){rl();return}e.innerHTML=`
      ...
      <h3 class="deck-row-name">${za(t.name)}</h3>
      <div class="deck-row__progress">
        <div class="deck-progress-bar deck-row__progress-bar" role="progressbar" aria-valuemin="0" aria-valuemax="30" aria-valuenow="${t.cardIds.length}" aria-label="${za(t.name)} progress">
    ...
    `,i.addEventListener(`click`,()=>el(t.id)),e.appendChild(i)}}function il(){$();let e=X(`collection-grid`),t=X(`deck-slots`),n=X(`deck-status`),r=X(`edit-deck-heading`),i=X(`deck-count-badge`),o=X(`deck-progress-bar`);if(!e||!t)return;let s=X(`btn-delete-deck`);s&&(s.hidden=!(G&&G!==`new`&&G!==`deck-starter`)),r&&(r.textContent=G===`new`?`New deck`:`In your deck`);let c=a(K,U),l=`${K.length}/30`;i&&(i.textContent=l,i.classList.toggle(`deck-editor__count--ready`,c.valid));let u=X(`deck-progress-fill`),d=Math.min(100,K.length/30*100);u&&(u.style.width=`${d}%`),o&&(o.hidden=c.valid,c.valid||(o.setAttribute(`aria-valuenow`,String(K.length)),o.setAttribute(`aria-valuemax`,`30`))),n&&(c.valid?(n.textContent=``,n.hidden=!0,n.className=`deck-editor__error deck-status ok`):(n.hidden=!1,n.textContent=c.errors[0]||`${l} — keep adding spells`,n.className=`deck-editor__error deck-status warn`));let f=X(`deck-collection-hint`);f&&(f.hidden=!1,f.innerHTML=K.length>=30?`Deck is full. Remove a card from the strip above, or save when ready.`:`Tap <strong>+ Add to deck</strong> for copies you own. When all owned copies are in the deck, tap <strong>Add for X gems</strong> to buy another.`),Yc(e,{deckEdit:!0,statusEl:n}),t.innerHTML=``;let p=Js(K);if(!p.length){let e=document.createElement(`p`);e.className=`deck-editor__strip-empty`,e.textContent=`Empty deck — tap + Add to deck below`,t.appendChild(e)}for(let{def:e,count:n}of p){let r=document.createElement(`div`);r.className=`deck-slot-wrap deck-slot-wrap--strip`;let i=Ra(e,{button:!0,tiny:!0,onClick:()=>{Wa(e,{meta:n>1?`${n} copies in deck`:`In your deck`,onRemove:()=>Xs(e.id)})}});if(r.appendChild(i),n>1){let e=document.createElement(`span`);e.className=`deck-stack-count`,e.textContent=`×${n}`,r.appendChild(e)}let a=document.createElement(`button`);a.type=`button`,a.className=`deck-slot-remove deck-slot-remove--visible`,a.setAttribute(`aria-label`,`Remove one ${e.name} from deck`),a.textContent=`−`,a.addEventListener(`click`,t=>{t.stopPropagation(),Ys(e.id)}),r.appendChild(a),t.appendChild(r)}}function al(){let e=X(`deck-name-input`)?.value?.trim()||`My Deck`,t=a(K,U);if(!t.valid){X(`deck-status`).textContent=t.errors.join(` `);return}let n;G&&G!==`new`?(n=U.decks.find(e=>e.id===G),n?(n.name=e,n.cardIds=[...K],n.updatedAt=Date.now()):n=v(e,K)):n=v(e,K),re(U,n),U.selectedDeckId=n.id,T(U),xs(`deck-saved`,{deckId:n.id}),$c(),Nc(`list`)}function ol(e=[]){let t=`New Deck`,n=new Set(e.map(e=>e.name?.trim()).filter(Boolean));if(!n.has(t))return t;let r=2;for(;n.has(`${t} ${r}`);)r++;return`${t} ${r}`}function sl(){G=`new`,K=[];let e=X(`deck-name-input`);e&&(e.value=ol(U.decks)),Nc(`edit`)}function cl(){nc(),Gs=null}function ll(){U.adventure=ce(U.adventure),X(`adventure-map-view`)?.classList.remove(`hidden`),cl(),Ks=null,hl()}function ul(e){let t=ve[e]||ve.verdant,n=`map-${e}`;return`<svg class="adventure-map-scenery-svg" viewBox="0 0 100 120" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
    <defs>
  ...
  </svg>`}function dl(e=`#e8c547`){return`<svg class="adventure-map-tile__pawn-svg" viewBox="0 0 28 36" aria-hidden="true">
    <defs>
  ...
  </svg>`}function fl(e){let t=ve[e]||ve.verdant;return`<svg class="adventure-map-tile__banner-svg" viewBox="0 0 24 20" aria-hidden="true">
    <defs>
    ...
    <div class="adventure-map-tower">
      ...
      <span class="adventure-map-tile__stone" aria-hidden="true">
        ...
        ${a>0?`<span class="adventure-floor-row__stars">${xe(a)}</span>`:``}`,o.addEventListener(`click`,()=>Cl(t.id)),g.appendChild(o)}}let ee=r.querySelector(`.adventure-map-tile--next`);pl(r),ee&&requestAnimationFrame(()=>{requestAnimationFrame(()=>ee.scrollIntoView({behavior:`smooth`,block:`nearest`}))});let _=g?.querySelector(`.adventure-floor-row--next`);_&&requestAnimationFrame(()=>_.scrollIntoView({behavior:`smooth`,block:`end`})),r.querySelector(`.adventure-challenge-toggle`)?.addEventListener(`click`,t=>{t.preventDefault(),t.stopPropagation(),e.challengeMode=!e.challengeMode,U.adventure=e,T(U),zo(),To.tap(),hl()})}function gl(e){let t=he(e);if(!t||!Ce(U.adventure,e))return;Gs=e,tc();let n=X(`prebattle-title`),r=X(`prebattle-flavor`),i=X(`prebattle-opponent`);n&&(n.textContent=`Tower ${t.worldId} · Floor ${t.floorInWorld}`),r&&(r.textContent=t.flavor||``),i&&(i.textContent=`Loading…`);try{Ks=_(U,e),T(U)}catch(e){console.error(`Enemy deck failed`,e),i&&(i.textContent=`Could not build enemy deck. Try again.`);return}i&&(i.textContent=`Review the enemy spell deck, then choose your grimoire below.`);let o=X(`prebattle-gem-hint`);if(o){let n=te(U.adventure,e);o.textContent=(s(U.adventure,e)?`Repeat clear: +${n} gems`:`First clear: +${n} gems`)+(t.worldId===5&&b(U.adventure)?` · Challenge mode: enemy has an extra rank of pieces`:``)}let c=X(`enemy-deck-preview`);if(c){c.innerHTML=``;try{for(let{def:e,count:t}of ne(Ks)){if(!e)continue;let n=document.createElement(`button`);n.type=`button`,n.className=`enemy-deck-spell-btn`,n.title=`View ${e.name}`;let r=document.createElement(`span`);if(r.className=`enemy-deck-spell-btn__name`,r.textContent=e.name,n.appendChild(r),t>1){let e=document.createElement(`span`);e.className=`enemy-deck-spell-btn__count`,e.textContent=`×${t}`,n.appendChild(e)}n.addEventListener(`click`,()=>Wa(e,{meta:t>1?`${t} copies in enemy deck`:`Enemy deck`})),c.appendChild(n)}}catch(e){console.error(`Enemy preview failed`,e),c.innerHTML=`<p class="empty-msg">Enemy deck preview unavailable.</p>`}}w(U)&&T(U);let l=yr(`adventure-deck-select`);if(!l){i&&(i.textContent=`Deck selector missing — hard refresh the page.`);return}l.innerHTML=``;let u=U.decks.filter(e=>a(e.cardIds,U).valid);if(!u.length){let e=document.createElement(`option`);e.value=``,e.textContent=`No complete decks — build one in Decks`,l.appendChild(e),l.disabled=!0,X(`btn-start-adventure`).disabled=!0;return}l.disabled=!1;let d=U.selectedDeckId&&u.some(e=>e.id===U.selectedDeckId)?U.selectedDeckId:u[0].id;for(let e of u){let t=document.createElement(`option`);t.value=e.id,t.textContent=e.name,e.id===d&&(t.selected=!0),l.appendChild(t)}U.selectedDeckId=d,X(`btn-start-adventure`).disabled=!1}async function _l(e,t,n,r,i=null,a=!1,o=void 0){let s=t.opponent;cl(),Ks=null,document.querySelectorAll(`.view`).forEach(e=>e.classList.add(`hidden`)),X(`view-match`)?.classList.remove(`hidden`);let l=X(`view-match`);if(!l)return;let{MatchSession:u,getMatchHtml:d}=await as();l.innerHTML=d(s);let p=o??(Se(r).id===5&&b(U.adventure)),m={levelId:r,deckId:e.id,challengeMode:p},h={aiDeckIds:n,opponentName:s,cosmetics:ee(U),profile:U,challengeMode:p,buildGameOverActions:({won:e,isTie:t})=>yl(m,{won:e,isTie:t}),onGameOverAction:e=>{bl(e,m,l)}};i&&(h.initialState=i);try{q=new u(e.cardIds,l,()=>{q=null,fr(),ko(),xo(`hub`),l.innerHTML=``,X(`view-match`)?.classList.add(`hidden`),Z(rr()||`play`),Vs&&Tl(),Hs&&El()},e=>{let t=f(U,r,e),{gems:n,stars:i,starsGained:a}=t;return U.gems+=n,y(U,`adventure_floors`,1),c(U),T(U),$(),oc(),r===1&&t.firstTime&&(Vs=!0,Tl()),r===5&&t.firstTime&&(Hs=!0),{message:`+${n} gems! · Best: ${xe(i)}`,starsGained:a}},h)}catch(e){throw q=null,l.innerHTML=``,X(`view-match`)?.classList.add(`hidden`),Z(`play`),e}ur({kind:`adventure`,deckId:e.id,deckCardIds:e.cardIds,aiDeckIds:n,opponentName:s,levelId:r,challengeMode:p}),await ko(),xo(`match`),a&&(q.winRewarded=!0),pr(q),q.setMessage(``),q.render()}async function vl(){let e=mr();if(!e)return!1;let t=U.decks.find(t=>t.id===e.deckId)||U.decks.find(e=>e.cardIds?.length===30),n=e.levelId?he(e.levelId):null;return!t||t.cardIds.length!==30||!n||!e.aiDeckIds?.length||!await $e(`Resume your adventure match where you left off?`,{title:`Resume match?`,confirmLabel:`Resume`,cancelLabel:`Discard`})?(dr(),!1):(Gs=e.levelId,await _l(t,n,e.aiDeckIds,e.levelId,e.state,e.winRewarded,e.challengeMode),q?.setMessage(`Match resumed — pick up where you left off.`),!0)}function yl({levelId:e},{won:t,isTie:n}){let r=e+1,i=t&&r<=50&&Ce(U.adventure,r);if(n)return[{id:`backToAdventure`,label:`Back to Adventure`,primary:!0}];if(t){let e=[];return i?(e.push({id:`nextFloor`,label:`Next floor`,primary:!0}),e.push({id:`retry`,label:`Retry floor`}),e.push({id:`backToAdventure`,label:`Back to Adventure`})):(e.push({id:`backToAdventure`,label:`Back to Adventure`,primary:!0}),e.push({id:`retry`,label:`Retry floor`})),e}return[{id:`retry`,label:`Retry floor`,primary:!0},{id:`backToAdventure`,label:`Back to Adventure`}]}async function bl(e,{levelId:t,deckId:n,challengeMode:r},i){let a=U.decks.find(e=>e.id===n);if(e===`backToAdventure`){q?.onExit?.();return}if(e===`nextFloor`){let e=t+1;if(!he(e)||!Ce(U.adventure,e)){q?.onExit?.();return}q?.dispose(),q=null,fr({clearCheckpoint:!0}),ko(),xo(`hub`),i&&(i.innerHTML=``),X(`view-match`)?.classList.add(`hidden`),await Z(`play`),gl(e);return}if(e===`retry`){let e=t,n=he(e);if(!a||a.cardIds.length!==30||!n){q?.onExit?.();return}q?.dispose(),q=null,fr(),await _l(a,n,_(U,e),e,null,!1,r)}}function xl(){let e=yr(`adventure-deck-select`)?.value,t=U.decks.find(t=>t.id===e),n=Gs,r=n?he(n):null,i=Ks?[...Ks]:null;if(!t||t.cardIds.length!==30||!r||!i?.length){let e=X(`prebattle-opponent`);e&&(!t||t.cardIds.length!==30?e.textContent=`Build a complete 30-card deck in the Decks tab, then try again.`:e.textContent=`Could not start battle — close and pick the floor again.`);return}_l(t,r,i,n)}function Sl(){if(window.__adventureMapCaptureBound)return;window.__adventureMapCaptureBound=!0;let e=null,t=!1,n=0,r=e=>e.closest?.(`#adventure-map .adventure-map-tile, #adventure-map .adventure-map-pin`),i=e=>e?.closest?.(`.adventure-map-scene`),a=()=>{t=!0,clearTimeout(n),n=setTimeout(()=>{t=!1},280)},o=(e,t)=>{if(!e||e.disabled)return;let n=Number(e.dataset.level);!Number.isFinite(n)||n<1||(t.preventDefault(),t.stopPropagation(),Cl(n))};document.addEventListener(`pointerdown`,t=>{if(t.button!==0)return;let n=r(t.target);if(!n||n.disabled)return;let a=i(n);e={pin:n,pointerId:t.pointerId,startX:t.clientX,startY:t.clientY,scrollTop:a?.scrollTop??0,scrollLeft:a?.scrollLeft??0,cancelled:!1}},!0),document.addEventListener(`pointermove`,t=>{if(!e||t.pointerId!==e.pointerId||e.cancelled)return;let n=t.clientX-e.startX,r=t.clientY-e.startY;Math.hypot(n,r)>12&&(e.cancelled=!0);let a=i(e.pin);a&&(Math.abs(a.scrollTop-e.scrollTop)>3&&(e.cancelled=!0),Math.abs(a.scrollLeft-e.scrollLeft)>3&&(e.cancelled=!0))},!0),document.addEventListener(`pointerup`,t=>{if(!e||t.pointerId!==e.pointerId)return;let{pin:n,cancelled:r}=e;if(e=null,r){a();return}o(n,t),a()},!0),document.addEventListener(`pointercancel`,t=>{!e||t.pointerId!==e.pointerId||(e=null,a())},!0),document.addEventListener(`click`,e=>{if(t){e.preventDefault(),e.stopPropagation();return}let n=r(e.target);!n||n.disabled||o(n,e)},!0)}function Cl(e){let t=ce(U.adventure);if(U.adventure=t,!Ce(t,e)){rc(`Locked — beat global floor ${e-1} first, then return here.`,`Floor locked`);return}T(U),gl(e)}function wl(){$s(),window.addEventListener(`orientationchange`,$s),window.addEventListener(`resize`,$s),ic(),so(),to(),Po(),Co(),Ao(),Fo(),Ga(),Sl(),Qs(),document.querySelector(`.adventure-map-scene`)?.addEventListener(`scroll`,ml,{passive:!0});let e;window.addEventListener(`resize`,()=>{clearTimeout(e),e=setTimeout(()=>{if(!document.body.classList.contains(`adventure-active`))return;let e=X(`adventure-map`);e&&pl(e)},120)}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&cl()}),document.querySelectorAll(`.tab-btn`).forEach(e=>{e.addEventListener(`click`,()=>{zo(),To.tap(),Z(e.dataset.tab)})}),document.querySelectorAll(`.vault-tab`).forEach(e=>{e.addEventListener(`click`,()=>{cr(),Vc(e.dataset.vaultTab)})}),X(`btn-new-deck`)?.addEventListener(`click`,sl),X(`btn-back-from-edit`)?.addEventListener(`click`,async()=>{await Qc()&&($c(),Nc(`list`))}),X(`btn-delete-deck`)?.addEventListener(`click`,async()=>{if(!G||G===`new`)return;let e=U.decks.find(e=>e.id===G);e&&await $e(`Delete "${e.name}"? This cannot be undone.`,{title:`Delete deck?`,confirmLabel:`Delete`,cancelLabel:`Keep`,destructive:!0})&&(fe(U,e.id),$c(),Nc(`list`))});let t=()=>{Es===`edit`&&il(),Es===`list`&&rl()};document.querySelectorAll(`.collection-owned-only-toggle`).forEach(e=>{e.addEventListener(`change`,e=>{js=e.target.checked,bc(),t()})}),document.querySelectorAll(`.btn-reset-collection-filters`).forEach(e=>{e.addEventListener(`click`,()=>{ks=`all`,Os=``,As=`all`,js=!0,bc(),t()})}),bc(),br(),X(`collection-search`)?.addEventListener(`input`,e=>{Os=e.target.value,t()}),yr(`collection-category`)?.addEventListener(`change`,e=>{As=e.target.value,t()}),yr(`collection-rarity`)?.addEventListener(`change`,e=>{ks=e.target.value,t()}),X(`btn-clear-deck`)?.addEventListener(`click`,()=>{K=[],il()}),X(`btn-auto-finish-deck`)?.addEventListener(`click`,Zs),X(`btn-save-deck`)?.addEventListener(`click`,al),X(`btn-back-adventure`)?.addEventListener(`click`,cl),X(`adventure-floor-backdrop`)?.addEventListener(`click`,cl),X(`btn-start-adventure`)?.addEventListener(`click`,xl),yr(`adventure-deck-select`)?.addEventListener(`change`,e=>{U.selectedDeckId=e.target.value,T(U)});let n=document.getElementById(`auth-modal`),r=document.getElementById(`auth-header-btn`);lc(),qn(`adventure-help-btn`,`adventure-help-desc`),qn(`shop-help-btn`,`shop-help-desc`),qn(`deck-help-btn`,`deck-help-desc`),Ls=mn({onSignIn:()=>Rs?.open(`signin`,{forced:!0}),onSignUp:()=>Rs?.open(`signup`,{forced:!0}),onGuest:()=>{tn(),Ml()}}),Rs=fn({authBtn:r,modal:n,onNewAccount:()=>{U=_e()?me():be(),Dn(U,T)},onSignedIn:()=>{nn(),U=be(),w(U),En(U),$(),rl(),Bc(),Ls?.hide(),uc().then(()=>{W===`profile`&&fc(),W===`quests`&&vc(),W===`pvp`&&Is().then(e=>e?.render({resume:!0}))}),Is().then(e=>e?.render({resume:!0})),Al(),jl(),kl(),Ol(),J||Z(W)},onSignedOut:()=>{nn(),cc(),Q=``,sc(),Ps?.dispose?.(),q=null,fr({clearCheckpoint:!0}),cr(),U=me(),oc(),$(),rl(),Bc(),Ls?.show(),Z(`deck`)}}),hr(()=>q),w(U),bc(),oc(),Nl()}function Tl(){if(!Vs||Us!=null)return;let e=0,t=()=>{if(Us=null,e+=1,Vs){if(tr()){e<10&&(Us=window.setTimeout(t,400));return}if(En(U),kl()){Vs=!1;return}e<10&&(Us=window.setTimeout(t,500))}};Us=window.setTimeout(t,350)}function El(){if(!Hs||Ws!=null)return;let e=0,t=()=>{if(Ws=null,e+=1,Hs){if(tr()){e<10&&(Ws=window.setTimeout(t,400));return}if(En(U),Ol()){Hs=!1;return}e<10&&(Ws=window.setTimeout(t,500))}};Ws=window.setTimeout(t,350)}function Dl(){return J||!pn()||!h(U)||!Fn(U)?!1:(J=!0,vs().then(({startPvpTutorial:e})=>{e({profile:U,saveProfile:T,onComplete:()=>{J=!1,U=be(),w(U),oc(),Z(`play`),Ol()}})}),!0)}function Ol(){return J||!pn()||!m(U)||An(U)||jn(U)||Pn(U)||Fn(U)||!Ln(U)?!1:(J=!0,Z(`play`),vs().then(({startCosmeticsTutorial:e})=>{e({profile:U,saveProfile:T,onComplete:()=>{J=!1,U=be(),w(U),oc(),Z(`play`)}})}),!0)}function kl(){return J||!pn()||!h(U)?!1:(En(U),Pn(U)?(J=!0,Z(`play`),vs().then(({startQuestsTutorial:e})=>{e({profile:U,saveProfile:T,onComplete:()=>{J=!1,U=be(),w(U),oc(),Dl(),Ol()}})}),!0):Dl())}function Al(){return J||!pn()||!An(U)?!1:(J=!0,bs().then(({startInteractiveTutorial:e})=>{e({profile:U,saveProfile:T,onComplete:()=>{J=!1,U=be(),w(U),$(),rl(),Bc(),jl()||Z(`deck`),kl(),Ol()}})}),!0)}function jl(){return J||!pn()||!jn(U)?!1:(J=!0,Z(`deck`),gs().then(({startMetaTutorial:e})=>{e({profile:U,saveProfile:T,onComplete:()=>{J=!1,U=be(),w(U),$(),rl(),Bc(),Z(`deck`),kl(),Ol()}})}),!0)}async function Ml(){Ls?.hide(),!Al()&&(jl()||kl()||Ol()||J||(await vl()||await Z(`deck`),cr(),xo(`hub`)))}async function Nl(){try{if(await Le()){try{let e=await ln();e&&(U=e)}catch(e){console.warn(`Cloud sync on load failed`,e)}w(U),$(),rl(),Bc()}}catch(e){console.warn(`Auth init failed`,e)}if(En(U),await uc(),Ps&&Ps.render(),cr(),hn()){Ls?.show();return}await Ml()}wl(),E(async()=>{let{registerSW:e}=await import(`./virtual_pwa-register-CpSsV7JG.js`);return{registerSW:e}},[],import.meta.url).then(({registerSW:e})=>{e({immediate:!0})}),et(),it();export{cr as A,Zt as B,dr as C,ur as D,rr as E,kn as F,$e as G,_t as H,Nn as I,qe as K,Mn as L,qn as M,In as N,fr as O,On as P,Rn as R,vr as S,or as T,Ct as U,zt as V,gt as W,Xa as _,Wo as a,Ra as b,Xo as c,es as d,ko as f,oo as g,H as h,Jo as i,pr as j,tr as k,Ko as l,xo as m,rs as n,Go as o,So as p,Bo as r,Yo as s,ns as t,Qo as u,Ka as v,ir as w,Cr as x,Wa as y,rn as z};