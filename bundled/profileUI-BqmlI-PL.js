import{$ as e,C as t,F as n,G as r,I as i,J as a,L as o,O as s,Q as c,T as l,W as u,_ as d,at as f,b as p,et as m,it as h,m as g,nt as _,rt as v,st as y,tt as b,v as x,w as S,x as C,y as w}from"./storage-CmZrcoq9.js";import{a as T,c as E,d as D,l as O,o as k,t as A,u as j}from"./mageTitles-BPvsmJqw.js";import{a as ee,c as te,o as ne}from"./auth-Bovv2ldH.js";import{W as re,c as M,i as N,l as P,n as F,o as I,r as L,s as R,t as z,u as B}from"./index-DCWxXETX.js";import{playCosmeticOpenAnimation as V}from"./cosmeticOpenAnimation-ZmoYHqfj.js";import{notifyUnlockTutorial as H}from"./tutorialUnlocks-BD1z5ACJ.js";var U=null;function W(){U!=null&&(clearInterval(U),U=null)}function G(e){if(!e)return;W();let t=()=>{e.textContent=`Resets in: ${_(f())}`};t(),U=setInterval(t,1e3)}function K(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}var q={common:`rarity-common`,uncommon:`rarity-uncommon`,rare:`rarity-rare`,epic:`rarity-epic`,legendary:`rarity-legendary`};function J(e){if(e===`pieceSkin`)return`Piece skins`;if(e===`frame`)return`Frames`;let t=R(e);return t.endsWith(`s`)?t:`${t}s`}function Y(e){let t=E(e);return t?D(t):``}var ie={pvp:`<svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
