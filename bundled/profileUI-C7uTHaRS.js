import{A as e,C as t,D as n,E as r,G as i,J as a,L as o,M as s,N as c,O as l,P as u,Q as d,S as f,U as p,W as m,X as h,Y as g,Z as _,_ as v,at as y,b,ct as x,ft as S,it as C,k as w,m as T,q as E,v as ee,w as te,x as ne,y as D}from"./storage-WqIn3pmc.js";import{a as O,i as k,s as A}from"./auth-RsyUTooq.js";import{U as j,c as M,i as N,l as P,n as re,o as F,r as I,s as L,t as R,u as z}from"./index-jwHRxFWS.js";import{playCosmeticOpenAnimation as B}from"./cosmeticOpenAnimation-B-rgMEq7.js";import{notifyUnlockTutorial as V}from"./tutorialUnlocks-ByZ8TyZk.js";var H=null;function U(){H!=null&&(clearInterval(H),H=null)}function W(e){if(!e)return;U();let t=()=>{e.textContent=`Resets in: ${ne(te())}`};t(),H=setInterval(t,1e3)}function G(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}var K={common:`rarity-common`,uncommon:`rarity-uncommon`,rare:`rarity-rare`,epic:`rarity-epic`,legendary:`rarity-legendary`};function q(e){if(e===`pieceSkin`)return`Piece skins`;if(e===`frame`)return`Frames`;let t=L(e);return t.endsWith(`s`)?t:`${t}s`}function J(e){let t=E(e);return t?g(t):``}var Y={pvp:`<svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <div class="profile-hero-card">
      ...
      <span class="profile-achievement-card__status">${v}</span>`,f){let r=document.createElement(`button`);r.type=`button`,r.className=`btn-primary profile-achievement-card__claim`,r.textContent=`Claim Title`,r.addEventListener(`click`,()=>{e(t,n.id).success&&(T(t),Z(t,i,{onTitleChanged:a}),a?.())}),h.appendChild(r)}i.appendChild(h)}}function Q(e,n,{onCurrencyChange:r}={}){if(!n)return;n.innerHTML=``;let i=[...f(e)].sort((t,n)=>{let r=e=>e.canClaim?0:e.claimed?2:1,i=r(t)-r(n);return i===0?D(e,n.templateId)-D(e,t.templateId):i});for(let{template:a,templateId:o,complete:s,claimed:c,canClaim:l}of i){let i=!s&&!c,u=document.createElement(`article`);u.className=[`profile-achievement-card`,`daily-quest-card`,i?`profile-achievement-card--locked`:``,s?`profile-achievement-card--complete`:``,c?`profile-achievement-card--claimed`:``,l?`profile-achievement-card--claimable`:``].filter(Boolean).join(` `);let d=ee(e,o),f=a.target?Math.min(100,Math.round(t(e,o)/a.target*100)):0,p=b(o),m=a.reward.currency===`stars`?`daily-quest-card__reward--stars`:`daily-quest-card__reward--gems`,h=c?`Claimed`:l?`Claim reward`:s?`Complete`:`In progress`;if(u.innerHTML=`
      <div class="profile-achievement-card__head">
