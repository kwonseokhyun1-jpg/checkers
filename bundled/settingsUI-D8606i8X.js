import{_ as e,a as t,f as n,h as r,i,l as a,m as o,n as s,r as c,s as l}from"./auth-RsyUTooq.js";import{B as u,W as d,g as f,h as p,p as m}from"./index-jwHRxFWS.js";var h=`https://sites.google.com/view/arcane-checkers/home`;function g(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function _(){let e=p();return`
