...
export const CHESTS = [
  ...
  { id: "silver", name: "Silver Reliquary", cost: 50, cards: 5, weights: { common: 50, uncommon: 35, rare: 12, epic: 3 } },
  { id: "gold", name: "Gold Reliquary", cost: 100, cards: 8, weights: { common: 32, uncommon: 38, rare: 22, epic: 6, legendary: 2 } },
];
