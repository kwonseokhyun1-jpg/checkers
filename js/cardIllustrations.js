...
export const EFFECT_ILLUSTRATIONS = {
  ...
  execution: () => rareBleed("ex", "#6ee7b7", "#14532d", executionMotif()),
  ...
  zombify: () => legendaryBleed("zb", "#4ade80", "#14532d", zombifyMotif()),
  bounty: () => epicBleed("bo", "#4ade80", "#14532d", bountyMotif()),
  link_fate: () => epicBleed("lf", "#a78bfa", "#2e1065", linkFateMotif()),
  bishop_2: () => uncommonBleed("bp", "#b794f4", "#4c1d95", bishopMarkMotif()),
  rook_2: () => uncommonBleed("rk", "#a78bfa", "#4c1d95", rookMarkMotif()),
