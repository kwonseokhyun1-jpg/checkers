...
const META_EFFECTS = new Set([
  "quick_march", "trickster", "ricochet", "blind", "confusion", "extract", "counterspell", "vengeance", "dominion", "restriction_2",
  "deflect_1",
...
const BUFF_EFFECTS = new Set([
  ...
  "last_stand", "martyr", "ghost_guard", "fortify", "hibernation", "stall", "revive",
