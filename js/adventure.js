...
/** Per-world palette for isometric map scenery and tower stone. */
export const MAP_THEME_PALETTES = {
  verdant: {
    ...
    stoneSide: "#585048",
    moss: "#4a7840",
    glow: "rgba(88, 204, 2, 0.45)",
    mist: "rgba(168, 212, 168, 0.35)",
  },
  frost: {
    sky: "#88b8d8",
    skyGlow: "#d0e8f8",
  ...
  crypt: {
    ...
    stoneSide: "#221c18",
    moss: "#3a3020",
    glow: "rgba(232, 160, 80, 0.5)",
    mist: "rgba(60, 48, 36, 0.5)",
  },
  abyss: {
    sky: "#080818",
    skyGlow: "#181838",
    ...
    stoneSide: "#0c0c18",
    moss: "#282848",
    glow: "rgba(144, 128, 255, 0.55)",
    mist: "rgba(32, 24, 64, 0.55)",
  },
};
