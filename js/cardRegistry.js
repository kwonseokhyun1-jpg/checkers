...
export const CARD_REGISTRY = [
  ...
  { id: "last_stand", name: "Last Stand", desc: "Hidden trap on a friendly piece — if it would be captured or destroyed, it survives with an ultra shield for 3 turns instead (invisible until it triggers; expires after 1 of your turn cycles if unused).", rarity: "rare", weight: 3, mode: "friendly", effect: "last_stand" },
  ...
  { id: "bishops_mark", name: "Bishop's Mark", desc: "For 2 turns, a piece may slide along either diagonal over empty dark squares.", rarity: "uncommon", weight: 4, mode: "friendly", effect: "bishop_2" },
  { id: "rooks_mark", name: "Rook's Mark", desc: "For 2 turns, a piece may slide along a rank or file over empty dark squares.", rarity: "uncommon", weight: 4, mode: "friendly", effect: "rook_2" },
  { id: "magnet", name: "Magnet", desc: "Pull every enemy 2 squares away on a diagonal to an adjacent empty square next to your piece.", rarity: "rare", weight: 3, mode: "friendly", effect: "magnet" },
  { id: "call_forward", name: "Call Forward", desc: "Move an enemy up to 2 squares along a diagonal to an empty dark square with a clear path.", rarity: "epic", weight: 2, mode: "e_empty", effect: "call_forward" },
  ...
  { id: "stall", name: "Stall", desc: "Piece is immobile and invulnerable for 2 turns, then gains shield for 1 turn.", rarity: "uncommon", weight: 4, mode: "friendly", effect: "fortify" },
  { id: "hibernation", name: "Hibernation", desc: "Your piece sleeps immobile for 2 turns, then awakens with the Awoken Bear mark — it may move twice each turn forever after.", rarity: "epic", weight: 2, mode: "friendly", effect: "hibernation" },
  ...
  { id: "zombify", name: "Zombify", desc: "Curse one of your men — it sleeps in a gravestone for 1 turn, then rises as a zombie king. Any piece it captures becomes zombified.", rarity: "legendary", weight: 1, mode: "friendly", effect: "zombify" },
  ...
  { id: "mulligan", name: "Mulligan", desc: "Shuffle your hand into your deck, then draw that many cards; you may cast another spell this turn.", rarity: "rare", weight: 3, mode: "instant", effect: "mulligan" },
  ...
  { id: "martyr", name: "Martyr", desc: "Hidden trap on a friendly piece — if an enemy captures or destroys it on their turn within 2 turns, you draw 2 cards (invisible until it triggers).", rarity: "epic", weight: 2, mode: "friendly", effect: "martyr" },
