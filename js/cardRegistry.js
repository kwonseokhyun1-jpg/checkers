...
export const CARD_REGISTRY = [
  ...
  { id: "bridge", name: "Bridge", desc: "Link two empty dark squares; either can be entered from the other.", rarity: "uncommon", weight: 4, mode: "empty_empty", effect: "bridge" },
  ...
  { id: "chain_lightning", name: "Chain Lightning", desc: "From your piece, destroy up to 2 enemies that are each adjacent to your piece or to the previous strike.", rarity: "legendary", weight: 1, mode: "friendly", effect: "chain_lightning" },
  ...
  { id: "succession", name: "Succession", desc: "When your king is captured, a chosen man becomes king instantly.", rarity: "uncommon", weight: 4, mode: "friendly", effect: "succession" },
