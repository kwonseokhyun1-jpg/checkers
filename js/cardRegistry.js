...
export const CARD_REGISTRY = [
  ...
  { id: "quicksand", name: "Quicksand", desc: "Hidden trap (4 turns) on an empty dark square — the next piece to end a turn there is frozen. Only you see the sand icon.", rarity: "common", weight: 6, mode: "empty", effect: "quicksand" },
  ...
  { id: "deflect", name: "Deflect", desc: "Hidden trap — the next spell hit on your pieces reflects to a random enemy.", rarity: "uncommon", weight: 4, mode: "instant", effect: "deflect_1" },
  ...
  { id: "hunters_mark", name: "Hunter's Mark", desc: "Mark an enemy; the next debuff on it (freeze, root, etc.) destroys it.", rarity: "uncommon", weight: 4, mode: "enemy", effect: "hunters_mark" },
  ...
  { id: "offering", name: "Offering", desc: "Sacrifice one of your pieces; draw 2 cards and you may cast another spell immediately afterward.", rarity: "rare", weight: 3, mode: "friendly", effect: "offering" },
  ...
  { id: "displacement", name: "Displacement", desc: "Move up to 2 friendly pieces 1 square each (adjacent empty).", rarity: "uncommon", weight: 4, mode: "f_empty", effect: "displacement" },
  ...
  { id: "cryo_bolt", name: "Cryo Bolt", desc: "Stab on a frozen target breaks shield and destroys it.", rarity: "rare", weight: 3, mode: "diagonal", effect: "cryo_bolt" },
  ...
  { id: "pyromancy", name: "Pyromancy", desc: "Ignite an enemy piece and one empty dark square — each burns for 2 turns (like poison, but fire). Burning tiles block enemy movement.", rarity: "legendary", weight: 1, mode: "e_empty", effect: "pyromancy" },
  ...
  { id: "revive", name: "Revive", desc: "Return your most recently captured man to any empty dark square; no capture the turn it returns.", rarity: "legendary", weight: 1, mode: "empty", effect: "revive" },
  { id: "mind_control", name: "Mind Control", desc: "Take control of an enemy man this turn — move and capture enemy pieces as if it were yours.", rarity: "epic", weight: 2, mode: "enemy", effect: "mind_control" },
  ...
  { id: "deep_freeze", name: "Deep Freeze", desc: "Freeze every enemy on one diagonal through your piece for 2 turns (pick which diagonal).", rarity: "epic", weight: 2, mode: "diagonal", effect: "deep_freeze" },
  ...
  { id: "clone", name: "Clone", desc: "Duplicate one of your men on an adjacent empty square (original stays). The copy cannot be captured or sacrificed until your next turn.", rarity: "epic", weight: 2, mode: "f_empty", effect: "clone" },
