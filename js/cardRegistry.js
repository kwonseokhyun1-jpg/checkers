...
export const CARD_REGISTRY = [
  ...
  { id: "knight", name: "Knight's Sigil", desc: "Transform a piece — it moves like a chess knight until the end of the game.", rarity: "rare", weight: 4, mode: "friendly", effect: "knight_perm" },
  ...
  { id: "bishops_sigil", name: "Bishop's Sigil", desc: "Piece slides diagonally any distance over empties for 3 turns.", rarity: "rare", weight: 3, mode: "friendly", effect: "bishop_3" },
  { id: "rooks_sigil", name: "Rook's Sigil", desc: "Piece slides along rank/file over empties for 3 turns.", rarity: "rare", weight: 3, mode: "friendly", effect: "rook_3" },
  ...
  { id: "wild_magic", name: "Wild Magic", desc: "Apply a random card effect from the entire pool.", rarity: "epic", weight: 2, mode: "instant", effect: "wild_magic" },
