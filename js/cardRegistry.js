...
export const CARD_REGISTRY = [
  ...
  { id: "fireblast", name: "Fireblast", desc: "Pick one of your pieces — a fireball shoots straight forward (same file). It passes over light squares and hits the first enemy on a dark square ahead (2, 4, or more rows away; shields burn away).", rarity: "legendary", weight: 1, mode: "friendly", effect: "fireblast" },
