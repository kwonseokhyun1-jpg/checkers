...
export const CARD_REGISTRY = [
  ...
  { id: "barrier", name: "Barrier", desc: "Summon a barrier on an empty dark square; enemies cannot enter it for 1 turn.", rarity: "common", weight: 5, mode: "empty", effect: "barrier" },
  ...
  { id: "poison", name: "Poison", desc: "Mark an enemy — they die in 3 turns unless removed.", rarity: "uncommon", weight: 5, mode: "enemy", effect: "poison_3" },
  ...
  { id: "magnet", name: "Magnet", desc: "Pull an enemy 2 squares away to an adjacent empty square next to your piece.", rarity: "rare", weight: 3, mode: "friendly", effect: "magnet" },
  { id: "call_forward", name: "Call Forward", desc: "Swap an enemy with an empty square up to 3 steps away.", rarity: "rare", weight: 3, mode: "e_empty", effect: "call_forward" },
  { id: "blizzard", name: "Blizzard", desc: "Freeze all enemy men on a column of dark squares you choose.", rarity: "rare", weight: 3, mode: "column", effect: "blizzard" },
  ...
  { id: "fireblast", name: "Fireblast", desc: "Fireball straight up the same column; skips empty squares until the first enemy on a dark square is destroyed (shields burn away).", rarity: "legendary", weight: 1, mode: "friendly", effect: "fireblast" },
  ...
  { id: "possession", name: "Possession", desc: "Take control of an enemy man this turn — move it during your move phase.", rarity: "epic", weight: 2, mode: "enemy", effect: "possession" },
