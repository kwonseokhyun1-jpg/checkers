...
export const CARD_REGISTRY = [
  ...
  { id: "crown", name: "Royal Decree", desc: "Instantly crown one of your pieces (king movement).", rarity: "epic", weight: 2, mode: "friendly", effect: "crown" },
  ...
  { id: "cull", name: "Cull", desc: "Destroy the weakest enemy (non-king preferred, fewest escape squares).", rarity: "legendary", weight: 1, mode: "instant", effect: "cull" },
  ...
  { id: "venom", name: "Venom", desc: "Enemy takes 1 damage; 2 damage destroys it (shield blocks 1 tick).", rarity: "uncommon", weight: 5, mode: "enemy", effect: "venom" },
  ...
  { id: "blind", name: "Blind", desc: "Opponent cannot play cards on their next turn.", rarity: "epic", weight: 2, mode: "instant", effect: "blind" },
  ...
  { id: "possession", name: "Possession", desc: "Control an enemy piece for its owner's next move only.", rarity: "legendary", weight: 1, mode: "enemy", effect: "possession" },
  ...
  { id: "mirror_move", name: "Mirror Move", desc: "After opponent moves, copy their move pattern with your piece if legal.", rarity: "uncommon", weight: 4, mode: "instant", effect: "mirror_move" },
  { id: "time_slip", name: "Time Slip", desc: "Undo your last checkers move (once per game).", rarity: "rare", weight: 3, mode: "instant", effect: "time_slip" },
  { id: "counterspell", name: "Counterspell", desc: "Cancel the next enemy card played.", rarity: "epic", weight: 2, mode: "instant", effect: "counterspell" },
  { id: "roulette", name: "Roulette", desc: "Random card effect hits a random valid target.", rarity: "rare", weight: 3, mode: "instant", effect: "roulette" },
  ...
  { id: "coin_flip", name: "Coin Flip", desc: "50% destroy random enemy; 50% destroy random friendly.", rarity: "uncommon", weight: 4, mode: "instant", effect: "coin_flip" },
  { id: "butterfly_effect", name: "Butterfly Effect", desc: "Shuffle pieces on the 4 center dark squares randomly.", rarity: "uncommon", weight: 3, mode: "instant", effect: "butterfly" },
