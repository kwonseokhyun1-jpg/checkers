...
export const CARD_REGISTRY = [
  ...
  { id: "fireblast", name: "Fireblast", desc: "Fireball straight ahead; first enemy in path is destroyed (shields burn away).", rarity: "legendary", weight: 1, mode: "diagonal", effect: "fireblast" },
  ...
  { id: "twin_soul", name: "Twin Soul", desc: "Spawn a single linked token on an adjacent square; your man is removed.", rarity: "epic", weight: 2, mode: "friendly", effect: "twin_soul" },
