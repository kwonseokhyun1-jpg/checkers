...
export const CARD_REGISTRY = [
  ...
  { id: "flank", name: "Flank", desc: "Move your piece to any empty dark square up to 3 steps away along a diagonal.", rarity: "common", weight: 6, mode: "f_empty", effect: "flank_3" },
  ...
  { id: "venom", name: "Venom", desc: "Enemy takes 1 damage; 2 damage destroys it (shield blocks 1 tick).", rarity: "common", weight: 6, mode: "enemy", effect: "venom" },
  ...
  { id: "silence", name: "Silence", desc: "Suppress knight/retreat/bishop/rook movement on an enemy for 3 turns.", rarity: "common", weight: 6, mode: "enemy", effect: "silence_3" },
  { id: "rust", name: "Rust", desc: "Target enemy cannot be crowned for the rest of the game.", rarity: "common", weight: 6, mode: "enemy", effect: "rust" },
  ...
  { id: "obstacle", name: "Obstacle", desc: "Mark a light square as permanently impassable.", rarity: "common", weight: 6, mode: "any_square", effect: "obstacle" },
  ...
  { id: "butterfly_effect", name: "Butterfly Effect", desc: "Shuffle pieces on the 4 center dark squares randomly.", rarity: "common", weight: 6, mode: "instant", effect: "butterfly" },
  { id: "rules_lawyer", name: "Rules Lawyer", desc: "Jumps are optional for you this turn (not mandatory).", rarity: "common", weight: 6, mode: "instant", effect: "rules_lawyer" },
  ...
  { id: "conduct", name: "Conduct", desc: "If you played a movement card this turn, your checker step may be 2 squares.", rarity: "common", weight: 6, mode: "instant", effect: "conduct" },
