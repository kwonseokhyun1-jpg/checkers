...
export const CARD_REGISTRY = [
  ...
  { id: "clone", name: "Clone", desc: "Duplicate one of your men on an adjacent empty square (original stays). The copy cannot move, be captured, or be sacrificed until your next turn.", rarity: "epic", weight: 2, mode: "f_empty", effect: "clone" },
