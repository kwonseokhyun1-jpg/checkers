...
const EFFECTS = {
  ...
  vengeance(state, color, picks) { const [r,c]=p0(picks); const p=at(state,r,c); if(!p||p.color!==color) return fail(); p.vengeanceTurns=2; return ok("Vengeance armed — hidden on that piece."); },
