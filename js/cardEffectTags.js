...
const TAGS = {
  ...
  mulligan: ["Shuffle your hand into your deck", "Draw that many cards", "Cast another spell this turn"],
  ...
  dash: ["Move 1 square forward-diagonally", "Destroy enemy on landing square"],
  sidestep: ["Skip 2 columns on the same row"],
  ...
  fusion: ["Merge two adjacent men into one", "Gains Awoken Bear mark", "Extra move every turn after"],
  ...
  clone: ["Your man, then adjacent empty square — copy inherits Awoken Bear and zombie horde marks", "Copy cannot capture or be taken this turn; dies to freeze/poison/burn/plague"],
